...
! function() {
    ...
    Util.mousePosition = function(e, offsetEl) {
        ...
        console.log("ofsetEl======11111");
        console.log(offsetEl);
        offset = $(offsetEl).offset();
        return {
            top: e.pageY - offset.top,
            left: e.pageX - offset.left - 150
        }
    };
    ...
    Annotator = function(_super) {
        ...
        Annotator.prototype.html = {
            adder: '<div class="annotator-adder"><button class="annotate-btn highlight-btn">' + _t("Highlight") + "</button>" + "<button class='annotate-btn add-btn'>" + _t("Note") +"</button>"
                // +"<button class='annotate-btn'>" + _t("Translate") + "</button>"
                // +"<a  target='_blank'>Web Search</a>" +"</div>",
                + "<button class='annotate-btn google-search-btn' style=\"border-left: 1px solid rgba(68, 68, 68, 0.24);\" >" +_t("Web Search") + "</button></div>",
