...
import com.appnew.android.databinding.FragmentVideoBookMarkBinding;
...
public final class VideoBookMark extends Fragment implements NetworkCall.MyNetworkCallBack {
    ...
    public final FragmentVideoBookMarkBinding getBinding() {
        FragmentVideoBookMarkBinding fragmentVideoBookMarkBinding = this.binding;
        if (fragmentVideoBookMarkBinding != null) {
            return fragmentVideoBookMarkBinding;
        }
        Intrinsics.throwUninitializedPropertyAccessException("binding");
        return null;
    }

    public final void setBinding(FragmentVideoBookMarkBinding fragmentVideoBookMarkBinding) {
        Intrinsics.checkNotNullParameter(fragmentVideoBookMarkBinding, "<set-?>");
        this.binding = fragmentVideoBookMarkBinding;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        setBinding(FragmentVideoBookMarkBinding.inflate(inflater, container, false));
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        getBinding().videoBookmarkListRecycler.setLayoutManager(this.layoutManager);
        ...
        if (Intrinsics.areEqual(apitype, API.API_GET_BOOKMARK_LIST)) {
            try {
                ...
                if (StringsKt.equals(jsonstring.getString("status"), "true", true)) {
                    ...
                    getBinding().videoBookmarkListRecycler.setVisibility(8);
                    return;
                }
                getBinding().noDataFoundRL.setVisibility(0);
                getBinding().videoBookmarkListRecycler.setVisibility(8);
    ...
    private final void setAdapter(ArrayList<PdfData> pdfData) {
        ...
        getBinding().videoBookmarkListRecycler.setAdapter(this.bookMarkListAdapter);
    }
