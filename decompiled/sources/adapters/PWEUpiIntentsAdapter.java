...
public class PWEUpiIntentsAdapter extends ArrayAdapter<PWEUPIOptionsDataModel> {
    ...
    public PWEUpiIntentsAdapter(Activity activity, ArrayList<PWEUPIOptionsDataModel> arrayList, PWEPaymentInfoHandler pWEPaymentInfoHandler) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        uPIViewHolder.linearRoot.setOnClickListener(new View.OnClickListener() { // from class: adapters.PWEUpiIntentsAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                if (PWEUpiIntentsAdapter.this.paymentInfoHandler.getPWEDeviceType().equals("NORMAL")) {
                    PWEUpiIntentsAdapter pWEUpiIntentsAdapter = PWEUpiIntentsAdapter.this;
                    pWEUpiIntentsAdapter.setSelectedUpiOptionKey(((PWEUPIOptionsDataModel) pWEUpiIntentsAdapter.upi_option_list.get(i)).getKey());
                    PWEUpiIntentsAdapter.this.selectUpiOption(view2, i);
                }
            }
        });
        if (getIsLayoutDisable()) {
            uPIViewHolder.linearRoot.setEnabled(false);
        }
        return view;
    }
