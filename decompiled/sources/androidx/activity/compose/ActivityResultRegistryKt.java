...
public final class ActivityResultRegistryKt {
    public static final <I, O> ManagedActivityResultLauncher<I, O> rememberLauncherForActivityResult(ActivityResultContract<I, O> activityResultContract, Function1<? super O, Unit> function1, Composer composer, int i) {
        ...
        String str2 = (String) RememberSaveableKt.m5350rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<String>() { // from class: androidx.activity.compose.ActivityResultRegistryKt$rememberLauncherForActivityResult$key$1
        ...
        ComposerKt.sourceInformation(composer, "CC(remember):ActivityResultRegistry.kt#9igjgp");
        boolean zChanged = composer.changed(activityResultLauncherHolder) | composer.changed(activityResultRegistry2) | composer.changed(str2) | composer.changed(activityResultContract) | composer.changed(stateRememberUpdatedState2);
