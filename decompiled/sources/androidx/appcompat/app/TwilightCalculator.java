...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j, double d2, double d3) {
        double d4 = (0.01720197f * ((j - UTC_2000) / 8.64E7f)) + 6.24006f;
        ...
        double dRound = ((double) (Math.round(((double) (r2 - J0)) - r6) + J0)) + ((-d3) / 360.0d) + (Math.sin(d4) * 0.0053d) + (Math.sin(2.0d * dSin) * (-0.0069d));
