...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        canvas2.translate(this.mCardBounds.right - f4, this.mCardBounds.bottom - f4);
        ...
        canvas2.translate(this.mCardBounds.left + f4, this.mCardBounds.bottom - f4);
        ...
        canvas2.translate(this.mCardBounds.right - f4, this.mCardBounds.top + f4);
    ...
    private void buildShadowCorners() {
        ...
        paint2.setShader(new LinearGradient(0.0f, f9, 0.0f, f10, new int[]{i2, i2, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
