...
public final class FloatFloatPair {
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m15constructorimpl(float f2, float f3) {
        return m16constructorimpl((((long) Float.floatToRawIntBits(f3)) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
    }
