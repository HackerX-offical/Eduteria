...
public final class FloatIntMapKt {
    ...
    public static final FloatIntMap floatIntMapOf(float f2, int i) {
        MutableFloatIntMap mutableFloatIntMap = new MutableFloatIntMap(0, 1, null);
        mutableFloatIntMap.set(f2, i);
        return mutableFloatIntMap;
    }

    public static final FloatIntMap floatIntMapOf(float f2, int i, float f3, int i2) {
        MutableFloatIntMap mutableFloatIntMap = new MutableFloatIntMap(0, 1, null);
        mutableFloatIntMap.set(f2, i);
        mutableFloatIntMap.set(f3, i2);
        return mutableFloatIntMap;
    }

    public static final FloatIntMap floatIntMapOf(float f2, int i, float f3, int i2, float f4, int i3) {
        MutableFloatIntMap mutableFloatIntMap = new MutableFloatIntMap(0, 1, null);
        mutableFloatIntMap.set(f2, i);
        mutableFloatIntMap.set(f3, i2);
        mutableFloatIntMap.set(f4, i3);
        return mutableFloatIntMap;
    }

    public static final FloatIntMap floatIntMapOf(float f2, int i, float f3, int i2, float f4, int i3, float f5, int i4) {
        MutableFloatIntMap mutableFloatIntMap = new MutableFloatIntMap(0, 1, null);
        mutableFloatIntMap.set(f2, i);
        mutableFloatIntMap.set(f3, i2);
        mutableFloatIntMap.set(f4, i3);
        mutableFloatIntMap.set(f5, i4);
        return mutableFloatIntMap;
    }

    public static final FloatIntMap floatIntMapOf(float f2, int i, float f3, int i2, float f4, int i3, float f5, int i4, float f6, int i5) {
        MutableFloatIntMap mutableFloatIntMap = new MutableFloatIntMap(0, 1, null);
        mutableFloatIntMap.set(f2, i);
        mutableFloatIntMap.set(f3, i2);
        mutableFloatIntMap.set(f4, i3);
        mutableFloatIntMap.set(f5, i4);
        mutableFloatIntMap.set(f6, i5);
        return mutableFloatIntMap;
    }
    ...
    public static final MutableFloatIntMap mutableFloatIntMapOf(float f2, int i) {
        MutableFloatIntMap mutableFloatIntMap = new MutableFloatIntMap(0, 1, null);
        mutableFloatIntMap.set(f2, i);
        return mutableFloatIntMap;
    }

    public static final MutableFloatIntMap mutableFloatIntMapOf(float f2, int i, float f3, int i2) {
        MutableFloatIntMap mutableFloatIntMap = new MutableFloatIntMap(0, 1, null);
        mutableFloatIntMap.set(f2, i);
        mutableFloatIntMap.set(f3, i2);
        return mutableFloatIntMap;
    ...
    public static final MutableFloatIntMap mutableFloatIntMapOf(float f2, int i, float f3, int i2, float f4, int i3) {
        MutableFloatIntMap mutableFloatIntMap = new MutableFloatIntMap(0, 1, null);
        mutableFloatIntMap.set(f2, i);
        mutableFloatIntMap.set(f3, i2);
        mutableFloatIntMap.set(f4, i3);
    ...
    public static final MutableFloatIntMap mutableFloatIntMapOf(float f2, int i, float f3, int i2, float f4, int i3, float f5, int i4) {
        MutableFloatIntMap mutableFloatIntMap = new MutableFloatIntMap(0, 1, null);
        mutableFloatIntMap.set(f2, i);
        mutableFloatIntMap.set(f3, i2);
        mutableFloatIntMap.set(f4, i3);
    ...
    public static final MutableFloatIntMap mutableFloatIntMapOf(float f2, int i, float f3, int i2, float f4, int i3, float f5, int i4, float f6, int i5) {
        MutableFloatIntMap mutableFloatIntMap = new MutableFloatIntMap(0, 1, null);
        mutableFloatIntMap.set(f2, i);
        mutableFloatIntMap.set(f3, i2);
        mutableFloatIntMap.set(f4, i3);
