...
public final class IntFloatMapKt {
    ...
    public static final IntFloatMap intFloatMapOf(int i, float f2) {
        MutableIntFloatMap mutableIntFloatMap = new MutableIntFloatMap(0, 1, null);
        mutableIntFloatMap.set(i, f2);
        return mutableIntFloatMap;
    }

    public static final IntFloatMap intFloatMapOf(int i, float f2, int i2, float f3) {
        MutableIntFloatMap mutableIntFloatMap = new MutableIntFloatMap(0, 1, null);
        mutableIntFloatMap.set(i, f2);
        mutableIntFloatMap.set(i2, f3);
        return mutableIntFloatMap;
    }

    public static final IntFloatMap intFloatMapOf(int i, float f2, int i2, float f3, int i3, float f4) {
        MutableIntFloatMap mutableIntFloatMap = new MutableIntFloatMap(0, 1, null);
        mutableIntFloatMap.set(i, f2);
        mutableIntFloatMap.set(i2, f3);
        mutableIntFloatMap.set(i3, f4);
        return mutableIntFloatMap;
    }

    public static final IntFloatMap intFloatMapOf(int i, float f2, int i2, float f3, int i3, float f4, int i4, float f5) {
        MutableIntFloatMap mutableIntFloatMap = new MutableIntFloatMap(0, 1, null);
        mutableIntFloatMap.set(i, f2);
        mutableIntFloatMap.set(i2, f3);
        mutableIntFloatMap.set(i3, f4);
        mutableIntFloatMap.set(i4, f5);
        return mutableIntFloatMap;
    }

    public static final IntFloatMap intFloatMapOf(int i, float f2, int i2, float f3, int i3, float f4, int i4, float f5, int i5, float f6) {
        MutableIntFloatMap mutableIntFloatMap = new MutableIntFloatMap(0, 1, null);
        mutableIntFloatMap.set(i, f2);
        mutableIntFloatMap.set(i2, f3);
        mutableIntFloatMap.set(i3, f4);
        mutableIntFloatMap.set(i4, f5);
        mutableIntFloatMap.set(i5, f6);
        return mutableIntFloatMap;
    }
    ...
    public static final MutableIntFloatMap mutableIntFloatMapOf(int i, float f2) {
        MutableIntFloatMap mutableIntFloatMap = new MutableIntFloatMap(0, 1, null);
        mutableIntFloatMap.set(i, f2);
        return mutableIntFloatMap;
    }

    public static final MutableIntFloatMap mutableIntFloatMapOf(int i, float f2, int i2, float f3) {
        MutableIntFloatMap mutableIntFloatMap = new MutableIntFloatMap(0, 1, null);
        mutableIntFloatMap.set(i, f2);
        mutableIntFloatMap.set(i2, f3);
        return mutableIntFloatMap;
    ...
    public static final MutableIntFloatMap mutableIntFloatMapOf(int i, float f2, int i2, float f3, int i3, float f4) {
        MutableIntFloatMap mutableIntFloatMap = new MutableIntFloatMap(0, 1, null);
        mutableIntFloatMap.set(i, f2);
        mutableIntFloatMap.set(i2, f3);
        mutableIntFloatMap.set(i3, f4);
    ...
    public static final MutableIntFloatMap mutableIntFloatMapOf(int i, float f2, int i2, float f3, int i3, float f4, int i4, float f5) {
        MutableIntFloatMap mutableIntFloatMap = new MutableIntFloatMap(0, 1, null);
        mutableIntFloatMap.set(i, f2);
        mutableIntFloatMap.set(i2, f3);
        mutableIntFloatMap.set(i3, f4);
    ...
    public static final MutableIntFloatMap mutableIntFloatMapOf(int i, float f2, int i2, float f3, int i3, float f4, int i4, float f5, int i5, float f6) {
        MutableIntFloatMap mutableIntFloatMap = new MutableIntFloatMap(0, 1, null);
        mutableIntFloatMap.set(i, f2);
        mutableIntFloatMap.set(i2, f3);
        mutableIntFloatMap.set(i3, f4);
