...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    public final float put(float key, float value, float f2) {
        int iFindInsertIndex = findInsertIndex(key);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
        ...
        while (i5 != i) {
            ...
            if (j4 != 128 && j4 == 254) {
                ...
                if (((iFindFirstAvailableSlot - i10) & i) / 8 == ((i5 - i10) & i) / 8) {
                    ...
                    jArr[ArraysKt.getLastIndex(jArr)] = (jArr[c3] & j3) | Long.MIN_VALUE;
                    i5++;
                    c2 = c3;
                } else {
                    ...
                    if (((j5 >> i12) & 255) == 128) {
                        ...
                        j = j3;
                        jArr[i11] = (((long) (i8 & 127)) << i12) | (j5 & (~(255 << i12)));
                        float f2 = fArr[iFindFirstAvailableSlot];
                        fArr[iFindFirstAvailableSlot] = fArr[i5];
                        fArr[i5] = f2;
                        float f3 = fArr2[iFindFirstAvailableSlot];
                        fArr2[iFindFirstAvailableSlot] = fArr2[i5];
                        fArr2[i5] = f3;
                        i5--;
                    }
                    jArr[ArraysKt.getLastIndex(jArr)] = (jArr[c3] & j) | Long.MIN_VALUE;
                    i5++;
                    c2 = c3;
                    j3 = j;
                }
