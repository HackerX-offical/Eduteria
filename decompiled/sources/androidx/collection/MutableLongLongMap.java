            ...
            if (j4 != 128 && j4 == 254) {
                ...
                if (((iFindFirstAvailableSlot - i10) & i) / 8 == ((i5 - i10) & i) / 8) {
                    ...
                    if (((j5 >> i12) & 255) == 128) {
                        ...
                        jArr2[iFindFirstAvailableSlot] = jArr2[i5];
                        jArr2[i5] = j6;
                        long j7 = jArr3[iFindFirstAvailableSlot];
                        jArr3[iFindFirstAvailableSlot] = jArr3[i5];
                        jArr3[i5] = j7;
                        i5--;
                    }
