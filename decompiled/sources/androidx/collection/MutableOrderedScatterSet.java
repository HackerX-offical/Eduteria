...
public final class MutableOrderedScatterSet<E> extends OrderedScatterSet<E> {
    ...
    */
    ...
    public final void adjustStorage$collection() {
        if (this._capacity > 8 && Long.compareUnsigned(ULong.m12567constructorimpl(ULong.m12567constructorimpl(this._size) * 32), ULong.m12567constructorimpl(ULong.m12567constructorimpl(this._capacity) * 25)) <= 0) {
            ...
            if (j3 != 128 && j3 == 254) {
                ...
                if (((iFindFirstAvailableSlot - i12) & i2) / 8 == ((i7 - i12) & i2) / 8) {
                    ...
                    if (((j6 >> i14) & 255) == 128) {
                        ...
                        i = i16;
                        jArr3[iFindFirstAvailableSlot] = ((long) Integer.MAX_VALUE) | (((long) i) << 32);
                    } else {
