...
public final class ObjectFloatMapKt {
    ...
    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K k, float f2) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, null);
        mutableObjectFloatMap.set(k, f2);
        return mutableObjectFloatMap;
    }

    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K k, float f2, K k2, float f3) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, null);
        mutableObjectFloatMap.set(k, f2);
        mutableObjectFloatMap.set(k2, f3);
        return mutableObjectFloatMap;
    }

    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K k, float f2, K k2, float f3, K k3, float f4) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, null);
        mutableObjectFloatMap.set(k, f2);
        mutableObjectFloatMap.set(k2, f3);
        mutableObjectFloatMap.set(k3, f4);
        return mutableObjectFloatMap;
    }

    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K k, float f2, K k2, float f3, K k3, float f4, K k4, float f5) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, null);
        mutableObjectFloatMap.set(k, f2);
        mutableObjectFloatMap.set(k2, f3);
        mutableObjectFloatMap.set(k3, f4);
        mutableObjectFloatMap.set(k4, f5);
        return mutableObjectFloatMap;
    }

    public static final <K> ObjectFloatMap<K> objectFloatMapOf(K k, float f2, K k2, float f3, K k3, float f4, K k4, float f5, K k5, float f6) {
        MutableObjectFloatMap mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, null);
        mutableObjectFloatMap.set(k, f2);
        mutableObjectFloatMap.set(k2, f3);
        mutableObjectFloatMap.set(k3, f4);
        mutableObjectFloatMap.set(k4, f5);
        mutableObjectFloatMap.set(k5, f6);
        return mutableObjectFloatMap;
    }
    ...
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K k, float f2) {
        MutableObjectFloatMap<K> mutableObjectFloatMap = new MutableObjectFloatMap<>(0, 1, null);
        mutableObjectFloatMap.set(k, f2);
        return mutableObjectFloatMap;
    }

    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K k, float f2, K k2, float f3) {
        MutableObjectFloatMap<K> mutableObjectFloatMap = new MutableObjectFloatMap<>(0, 1, null);
        mutableObjectFloatMap.set(k, f2);
        mutableObjectFloatMap.set(k2, f3);
        return mutableObjectFloatMap;
    ...
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K k, float f2, K k2, float f3, K k3, float f4) {
        MutableObjectFloatMap<K> mutableObjectFloatMap = new MutableObjectFloatMap<>(0, 1, null);
        mutableObjectFloatMap.set(k, f2);
        mutableObjectFloatMap.set(k2, f3);
        mutableObjectFloatMap.set(k3, f4);
    ...
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K k, float f2, K k2, float f3, K k3, float f4, K k4, float f5) {
        MutableObjectFloatMap<K> mutableObjectFloatMap = new MutableObjectFloatMap<>(0, 1, null);
        mutableObjectFloatMap.set(k, f2);
        mutableObjectFloatMap.set(k2, f3);
        mutableObjectFloatMap.set(k3, f4);
    ...
    public static final <K> MutableObjectFloatMap<K> mutableObjectFloatMapOf(K k, float f2, K k2, float f3, K k3, float f4, K k4, float f5, K k5, float f6) {
        MutableObjectFloatMap<K> mutableObjectFloatMap = new MutableObjectFloatMap<>(0, 1, null);
        mutableObjectFloatMap.set(k, f2);
        mutableObjectFloatMap.set(k2, f3);
        mutableObjectFloatMap.set(k3, f4);
