...
public abstract class ObjectList<E> {
    ...
    public String toString() {
        return joinToString$default(this, null, Constants.AES_PREFIX, Constants.AES_SUFFIX, 0, null, new Function1<E, CharSequence>(this) { // from class: androidx.collection.ObjectList.toString.1
