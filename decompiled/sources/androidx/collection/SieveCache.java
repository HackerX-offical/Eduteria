...
public final class SieveCache<K, V> {
    ...
    */
    ...
    public final void adjustStorage$collection() {
        if (this._capacity > 8 && Long.compareUnsigned(ULong.m12567constructorimpl(ULong.m12567constructorimpl(get_count()) * 32), ULong.m12567constructorimpl(ULong.m12567constructorimpl(this._capacity) * 25)) <= 0) {
                ...
                if (((iFindFirstAvailableSlot - i12) & i2) / 8 == ((i7 - i12) & i2) / 8) {
                    ...
                    if (((j6 >> i17) & 255) == 128) {
                        ...
                        if (i18 != Integer.MAX_VALUE) {
                            ...
                            jArr3[i7] = (((long) Integer.MAX_VALUE) << 32) | ((long) iFindFirstAvailableSlot);
                        }
                        jArr3[iFindFirstAvailableSlot] = (((long) i7) << 32) | ((long) Integer.MAX_VALUE);
                    } else {
                        i = i2;
                        objArr = objArr2;
                        ...
                        jArr2[iFindFirstAvailableSlot] = jArr2[i7];
                        jArr2[i7] = j7;
                        int i19 = (int) ((jArr3[i7] >> 32) & 4294967295L);
