    ...
    public MeasureResult mo44measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                ...
                placeableArr[i2] = placeableMo7445measureBRTryo0;
                jM9006getZeroYbymL2g = jM8996constructorimpl;
            }
            i2++;
        }
        ...
        for (int i3 = 0; i3 < size3; i3++) {
            ...
            if (placeableArr[i3] == null) {
                placeableArr[i3] = measurable2.mo7445measureBRTryo0(j);
            }
        }
        if (measureScope.isLookingAhead()) {
            width = (int) (jM9006getZeroYbymL2g >> 32);
        } else {
            if (size == 0) {
                placeable2 = null;
            } else {
        ...
        if (measureScope.isLookingAhead()) {
            height = (int) (jM9006getZeroYbymL2g & 4294967295L);
        } else {
            if (size != 0) {
        ...
        if (!measureScope.isLookingAhead()) {
            this.rootScope.m69setMeasuredSizeozmzZPI$animation(IntSize.m8996constructorimpl((((long) width) << 32) | (((long) height) & 4294967295L)));
        }
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                while (i7 < length) {
                    ...
                    if (placeable5 != null) {
                        ...
                        long jMo5391alignKFBX0sM = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo5391alignKFBX0sM(IntSize.m8996constructorimpl((((long) placeable5.getWidth()) << 32) | (((long) placeable5.getHeight()) & 4294967295L)), IntSize.m8996constructorimpl((((long) i6) & 4294967295L) | (((long) i5) << 32)), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default(placementScope, placeable5, IntOffset.m8958getXimpl(jMo5391alignKFBX0sM), IntOffset.m8959getYimpl(jMo5391alignKFBX0sM), 0.0f, 4, null);
                    } else {
                        placeableArr2 = placeableArr3;
                    }
                    i7++;
