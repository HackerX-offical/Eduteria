        ...
        if (i == 0) {
            ...
            if (flowSnapshotFlow.collect(new FlowCollector() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedEnterExitImpl$shouldDisposeAfterExit$2$1.2
                ...
                public final Object emit(boolean z, Continuation<? super Unit> continuation) {
                    produceStateScope.setValue(Boxing.boxBoolean(z ? ((Boolean) AnimatedVisibilityKt.AnimatedEnterExitImpl$lambda$1(state).invoke(transition2.getCurrentState(), transition2.getTargetState())).booleanValue() : false));
