        ...
        public final TwoWayConverter<Color, AnimationVector4D> invoke(final ColorSpace colorSpace) {
            return VectorConvertersKt.TwoWayConverter(new Function1<Color, AnimationVector4D>() { // from class: androidx.compose.animation.ColorVectorConverterKt$ColorToVector$1.1
                ...
                public /* bridge */ /* synthetic */ AnimationVector4D invoke(Color color) {
                    return m87invoke8_81llA(color.m5978unboximpl());
                }

                /* JADX INFO: renamed from: invoke-8_81llA, reason: not valid java name */
                public final AnimationVector4D m87invoke8_81llA(long j) {
                    long jM5965convertvNxB06k = Color.m5965convertvNxB06k(j, ColorSpaces.INSTANCE.getOklab());
                    return new AnimationVector4D(Color.m5970getAlphaimpl(jM5965convertvNxB06k), Color.m5974getRedimpl(jM5965convertvNxB06k), Color.m5973getGreenimpl(jM5965convertvNxB06k), Color.m5971getBlueimpl(jM5965convertvNxB06k));
                }
                ...
                public /* bridge */ /* synthetic */ Color invoke(AnimationVector4D animationVector4D) {
                    return Color.m5958boximpl(m88invokevNxB06k(animationVector4D));
                }

                /* JADX INFO: renamed from: invoke-vNxB06k, reason: not valid java name */
                public final long m88invokevNxB06k(AnimationVector4D animationVector4D) {
                    ...
                    return Color.m5965convertvNxB06k(ColorKt.Color(v2, v3, f3, f4 <= 1.0f ? f4 : 1.0f, ColorSpaces.INSTANCE.getOklab()), colorSpace);
                }
            });
        }
    };
