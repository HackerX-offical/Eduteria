...
public final class ContentTransform {
    ...
    public ContentTransform(EnterTransition enterTransition, ExitTransition exitTransition, float f2, SizeTransform sizeTransform) {
        ...
        this.targetContentZIndex = PrimitiveSnapshotStateKt.mutableFloatStateOf(f2);
    ...
    public /* synthetic */ ContentTransform(EnterTransition enterTransition, ExitTransition exitTransition, float f2, SizeTransform sizeTransform, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(enterTransition, exitTransition, (i & 4) != 0 ? 0.0f : f2, (i & 8) != 0 ? AnimatedContentKt.SizeTransform$default(false, null, 3, null) : sizeTransform);
    }
    ...
    public final void setTargetContentZIndex(float f2) {
        this.targetContentZIndex.setFloatValue(f2);
    }
