...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    public final long m113sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                if (changeSize != null && (size = changeSize.getSize()) != null) {
                    return size.invoke(IntSize.m8993boximpl(fullSize)).m9005unboximpl();
                }
            } else {
                if (i != 3) {
                ...
                if (changeSize2 != null && (size2 = changeSize2.getSize()) != null) {
                    return size2.invoke(IntSize.m8993boximpl(fullSize)).m9005unboximpl();
                }
            }
        }
        return fullSize;
    ...
    public final long m115targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
            if (i == 1) {
                return IntOffset.INSTANCE.m8969getZeronOccac();
            }
            if (i == 2) {
                return IntOffset.INSTANCE.m8969getZeronOccac();
            }
            ...
            if (changeSize != null) {
                long jM9005unboximpl = changeSize.getSize().invoke(IntSize.m8993boximpl(fullSize)).m9005unboximpl();
                Alignment alignment = getAlignment();
                Intrinsics.checkNotNull(alignment);
                long jMo5391alignKFBX0sM = alignment.mo5391alignKFBX0sM(fullSize, jM9005unboximpl, LayoutDirection.Ltr);
                Alignment alignment2 = this.currentAlignment;
                Intrinsics.checkNotNull(alignment2);
                return IntOffset.m8961minusqkQi6aY(jMo5391alignKFBX0sM, alignment2.mo5391alignKFBX0sM(fullSize, jM9005unboximpl, LayoutDirection.Ltr));
            }
            return IntOffset.INSTANCE.m8969getZeronOccac();
        }
        return IntOffset.INSTANCE.m8969getZeronOccac();
    ...
    public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            long jM8996constructorimpl = IntSize.m8996constructorimpl((((long) placeableMo7445measureBRTryo0.getWidth()) << 32) | (((long) placeableMo7445measureBRTryo0.getHeight()) & 4294967295L));
            this.lookaheadSize = jM8996constructorimpl;
            m112setLookaheadConstraintsBRTryo0(j);
            return MeasureScope.layout$default(measureScope, (int) (jM8996constructorimpl >> 32), (int) (jM8996constructorimpl & 4294967295L), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                {
                    super(1);
                }
        ...
        if (this.isEnabled.invoke().booleanValue()) {
            ...
            final Placeable placeableMo7445measureBRTryo02 = measurable.mo7445measureBRTryo0(j);
            long jM8996constructorimpl2 = IntSize.m8996constructorimpl((((long) placeableMo7445measureBRTryo02.getWidth()) << 32) | (((long) placeableMo7445measureBRTryo02.getHeight()) & 4294967295L));
            final long j2 = AnimationModifierKt.m76isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : jM8996constructorimpl2;
            ...
            State<IntSize> stateAnimate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                    return IntSize.m8993boximpl(m116invokeYEO4UFw(enterExitState));
                }
                ...
                public final long m116invokeYEO4UFw(EnterExitState enterExitState) {
                    return this.this$0.m113sizeByStateUzc_VyU(enterExitState, j2);
                }
            }) : null;
            if (stateAnimate3 != null) {
                jM8996constructorimpl2 = stateAnimate3.getValue().m9005unboximpl();
            }
            long jM8797constrain4WqzIAM = ConstraintsKt.m8797constrain4WqzIAM(j, jM8996constructorimpl2);
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
            long jM8969getZeronOccac = (deferredAnimation2 == null || (stateAnimate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
                @Override // kotlin.jvm.functions.Function1
                public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                    return EnterExitTransitionKt.DefaultOffsetAnimationSpec;
                }
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m8949boximpl(m117invokeBjo55l4(enterExitState));
                }

                /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m117invokeBjo55l4(EnterExitState enterExitState) {
                    return this.this$0.m115targetOffsetByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m8969getZeronOccac() : stateAnimate2.getValue().m8967unboximpl();
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
            long jM8969getZeronOccac2 = (deferredAnimation3 == null || (stateAnimate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m8949boximpl(m118invokeBjo55l4(enterExitState));
                }

                /* JADX INFO: renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m118invokeBjo55l4(EnterExitState enterExitState) {
                    return this.this$0.m114slideTargetValueByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m8969getZeronOccac() : stateAnimate.getValue().m8967unboximpl();
            Alignment alignment2 = this.currentAlignment;
            final long jM8962plusqkQi6aY = IntOffset.m8962plusqkQi6aY(alignment2 != null ? alignment2.mo5391alignKFBX0sM(j2, jM8797constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.INSTANCE.m8969getZeronOccac(), jM8969getZeronOccac2);
            final long j3 = jM8969getZeronOccac;
            return MeasureScope.layout$default(measureScope, (int) (jM8797constrain4WqzIAM >> 32), (int) (jM8797constrain4WqzIAM & 4294967295L), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    placementScope.placeWithLayer(placeableMo7445measureBRTryo02, IntOffset.m8958getXimpl(j3) + IntOffset.m8958getXimpl(jM8962plusqkQi6aY), IntOffset.m8959getYimpl(j3) + IntOffset.m8959getYimpl(jM8962plusqkQi6aY), 0.0f, function1Init);
                }
            }, 4, null);
        }
        final Placeable placeableMo7445measureBRTryo03 = measurable.mo7445measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, placeableMo7445measureBRTryo03.getWidth(), placeableMo7445measureBRTryo03.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
            {
                super(1);
            }
            ...
            /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, placeableMo7445measureBRTryo03, 0, 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public final long m114slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Function1<IntSize, IntOffset> slideOffset;
        Function1<IntSize, IntOffset> slideOffset2;
        Slide slide = this.enter.getData().getSlide();
        long jM8969getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m8969getZeronOccac() : slideOffset2.invoke(IntSize.m8993boximpl(fullSize)).m8967unboximpl();
        Slide slide2 = this.exit.getData().getSlide();
        long jM8969getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m8969getZeronOccac() : slideOffset.invoke(IntSize.m8993boximpl(fullSize)).m8967unboximpl();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m8969getZeronOccac();
        }
