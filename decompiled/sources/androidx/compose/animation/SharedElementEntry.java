...
public final class SharedElementEntry implements LayerRenderer, RememberObserver {
    ...
    public SharedElementEntry(SharedElement sharedElement, BoundsAnimation boundsAnimation, SharedTransitionScope.PlaceholderSize placeholderSize, boolean z, SharedTransitionScope.OverlayClip overlayClip, boolean z2, SharedTransitionScope.SharedContentState sharedContentState, float f2) {
        this.zIndex = PrimitiveSnapshotStateKt.mutableFloatStateOf(f2);
    ...
    public final Rect calculateTargetBounds(Rect previousTargetBoundsBeforeLosingTarget) {
        return getUserState().getConfig$animation().m152alternativeTargetBoundsInTransitionScopeAfterRemovalcSwnlzA(getUserState(), previousTargetBoundsBeforeLosingTarget, IntSizeKt.m9013toSizeozmzZPI(getSharedElement().getScope().getLookaheadRoot$animation().mo7453getSizeYbymL2g()));
    }
    ...
    public void drawInOverlay(DrawScope drawScope) {
        ...
        long jM5758getTopLeftF1C5BW0 = currentBounds.m5758getTopLeftF1C5BW0();
        float fIntBitsToFloat = Float.intBitsToFloat((int) (jM5758getTopLeftF1C5BW0 >> 32));
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (jM5758getTopLeftF1C5BW0 & 4294967295L));
