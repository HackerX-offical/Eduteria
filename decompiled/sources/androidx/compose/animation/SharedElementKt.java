...
public final class SharedElementKt {
    private static final SpringSpec<Offset> DefaultMomentumSpring = AnimationSpecKt.spring$default(0.0f, 400.0f, Offset.m5712boximpl(Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(3.0f)) << 32) | (((long) Float.floatToRawIntBits(3.0f)) & 4294967295L))), 1, null);

    /* JADX INFO: renamed from: toOffset-TH1AsA0, reason: not valid java name */
    public static final long m150toOffsetTH1AsA0(long j) {
        float fM9068getXimpl = Velocity.m9068getXimpl(j);
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(Velocity.m9069getYimpl(j))) & 4294967295L) | (Float.floatToRawIntBits(fM9068getXimpl) << 32));
    }
