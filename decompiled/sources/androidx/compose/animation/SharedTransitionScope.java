...
public interface SharedTransitionScope extends LookaheadScope {
    ...
    public interface SharedContentConfig {
        ...
        default Rect m152alternativeTargetBoundsInTransitionScopeAfterRemovalcSwnlzA(SharedContentState sharedContentState, Rect rect, long j) {
            return null;
        }
    ...
    Modifier renderInSharedTransitionScopeOverlay(Modifier modifier, float f2, Function0<Boolean> function0);

    Modifier sharedBounds(Modifier modifier, SharedContentState sharedContentState, AnimatedVisibilityScope animatedVisibilityScope, EnterTransition enterTransition, ExitTransition exitTransition, BoundsTransform boundsTransform, ResizeMode resizeMode, PlaceholderSize placeholderSize, boolean z, float f2, OverlayClip overlayClip);

    Modifier sharedElement(Modifier modifier, SharedContentState sharedContentState, AnimatedVisibilityScope animatedVisibilityScope, BoundsTransform boundsTransform, PlaceholderSize placeholderSize, boolean z, float f2, OverlayClip overlayClip);

    Modifier sharedElementWithCallerManagedVisibility(Modifier modifier, SharedContentState sharedContentState, boolean z, BoundsTransform boundsTransform, PlaceholderSize placeholderSize, boolean z2, float f2, OverlayClip overlayClip);
    ...
    public interface PlaceholderSize {
        ...
        long mo151calculateSizeJyjRU_E(long contentSize, long animatedSize);
    ...
    default Modifier skipToLookaheadPosition(Modifier modifier, final Function0<Boolean> function0) {
        return LookaheadScopeKt.approachLayout(modifier, new Function1<IntSize, Boolean>() { // from class: androidx.compose.animation.SharedTransitionScope.skipToLookaheadPosition.2
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(IntSize intSize) {
                return m154invokeozmzZPI(intSize.m9005unboximpl());
            }

            /* JADX INFO: renamed from: invoke-ozmzZPI, reason: not valid java name */
            public final Boolean m154invokeozmzZPI(long j) {
                return false;
            }
            ...
            public /* bridge */ /* synthetic */ MeasureResult invoke(ApproachMeasureScope approachMeasureScope, Measurable measurable, Constraints constraints) {
                return m155invoke3p2s80s(approachMeasureScope, measurable, constraints.getValue());
            }

            /* JADX INFO: renamed from: invoke-3p2s80s, reason: not valid java name */
            public final MeasureResult m155invoke3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j) {
                ...
                return MeasureScope.layout$default(approachMeasureScope, placeableMo7445measureBRTryo0.getWidth(), placeableMo7445measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedTransitionScope$skipToLookaheadPosition$4$1$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public final void invoke2(Placeable.PlacementScope placementScope) {
                        if (function02.invoke().booleanValue()) {
                            ...
                            if (coordinates != null) {
                                ...
                                Placeable.PlacementScope.m7511place70tqf50$default(placementScope, placeableMo7445measureBRTryo0, IntOffsetKt.m8975roundk4lQ0M(Offset.m5727minusMKHz9U(coordinates.mo7454localPositionOfR5De75A(sharedTransitionScope2.getLookaheadScopeCoordinates(placementScope), Offset.m5727minusMKHz9U(LookaheadScope.m7475localLookaheadPositionOfauaQtc$default(sharedTransitionScope2, sharedTransitionScope2.getLookaheadScopeCoordinates(placementScope), coordinates, 0L, false, 6, null), LayoutCoordinates.m7452localPositionOfS_NoaFU$default(sharedTransitionScope2.getLookaheadScopeCoordinates(placementScope), coordinates, 0L, false, 6, null))), LayoutCoordinates.m7452localPositionOfS_NoaFU$default(coordinates, sharedTransitionScope2.getLookaheadScopeCoordinates(placementScope), 0L, false, 6, null))), 0.0f, 2, null);
                                return;
                            }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    static /* synthetic */ Modifier renderInSharedTransitionScopeOverlay$default(SharedTransitionScope sharedTransitionScope, Modifier modifier, float f2, Function0 function0, int i, Object obj) {
        if (obj != null) {
    ...
    static /* synthetic */ Modifier sharedElementWithCallerManagedVisibility$default(SharedTransitionScope sharedTransitionScope, Modifier modifier, SharedContentState sharedContentState, boolean z, BoundsTransform boundsTransform, PlaceholderSize placeholderSize, boolean z2, float f2, OverlayClip overlayClip, int i, Object obj) {
        ...
        return sharedTransitionScope.sharedElementWithCallerManagedVisibility(modifier, sharedContentState, z, boundsTransform2, placeholderSize, (i & 16) != 0 ? true : z2, (i & 32) != 0 ? 0.0f : f2, (i & 64) != 0 ? SharedTransitionScopeKt.ParentClip : overlayClip);
    }
    ...
    public static final class SharedContentState {
        ...
        public final void m153prepareTransitionWithInitialVelocityTH1AsA0(long initialVelocity) {
            SharedElementEntry nonNullInternalState = getNonNullInternalState();
            if (getConfig$animation().isEnabled(this)) {
                nonNullInternalState.getSharedElement().m148updateExitVelocityTH1AsA0$animation(initialVelocity);
            }
        }
