...
final class SharedTransitionScopeRootModifierNode extends Modifier.Node implements LayoutModifierNode, ObserverModifierNode, DrawModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public MeasureResult mo72measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo7445measureBRTryo0.getWidth(), placeableMo7445measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedTransitionScopeRootModifierNode$measure$1
                ...
                if (coordinates != null) {
                    if (!measureScope.isLookingAhead()) {
                        ...
                        if (IsLookaheadAnimationVisualDebuggingEnabledKt.isLookaheadAnimationVisualDebuggingEnabled() && ((LookaheadAnimationVisualDebugConfig) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalLookaheadAnimationVisualDebugConfig())).getIsEnabled()) {
                            ...
                            lookaheadAnimationVisualDebugHelper.m137updateDrawingCoordinatesCowoxoA$animation(LayoutCoordinatesKt.positionInRoot(LayoutCoordinatesKt.findRootCoordinates(coordinates)), this.getSharedScope().getLookaheadRoot$animation().mo7453getSizeYbymL2g());
                        }
                    } else {
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (IsLookaheadAnimationVisualDebuggingEnabledKt.isLookaheadAnimationVisualDebuggingEnabled()) {
            ...
            if (lookaheadAnimationVisualDebugConfig.getIsEnabled() && this.sharedScope.isTransitionActive()) {
                LookaheadAnimationVisualDebugHelper lookaheadAnimationVisualDebugHelper = this.sharedScope.getLookaheadAnimationVisualDebugHelper();
                Intrinsics.checkNotNull(lookaheadAnimationVisualDebugHelper);
                lookaheadAnimationVisualDebugHelper.m129drawOverlay4WTKRHQ$animation(contentDrawScope, lookaheadAnimationVisualDebugConfig.getOverlayColor());
            }
            this.sharedScope.drawInOverlay$animation(contentDrawScope);
            if (lookaheadAnimationVisualDebugConfig.getIsEnabled() && this.sharedScope.isTransitionActive()) {
                LookaheadAnimationVisualDebugHelper lookaheadAnimationVisualDebugHelper2 = this.sharedScope.getLookaheadAnimationVisualDebugHelper();
                Intrinsics.checkNotNull(lookaheadAnimationVisualDebugHelper2);
                lookaheadAnimationVisualDebugHelper2.drawGlobalVisualizations$animation(contentDrawScope);
                return;
            }
            return;
        }
