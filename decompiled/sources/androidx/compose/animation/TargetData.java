...
public final class TargetData {
    ...
    private TargetData(long j, long j2, long j3) {
        this.size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m5780boximpl(j), null, 2, null);
        this.initialMfrOffset = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5712boximpl(j2), null, 2, null);
        this.targetStructuralOffset = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5712boximpl(j3), null, 2, null);
        this.currentMfrOffset = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m5712boximpl(j2), null, 2, null);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getSize-NH-jbRc, reason: not valid java name */
    public final long m174getSizeNHjbRc() {
        return ((Size) this.size.getValue()).m5797unboximpl();
    }

    /* JADX INFO: renamed from: setSize-uvyYCjk, reason: not valid java name */
    public final void m178setSizeuvyYCjk(long j) {
        this.size.setValue(Size.m5780boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getInitialMfrOffset-F1C5BW0, reason: not valid java name */
    public final long m173getInitialMfrOffsetF1C5BW0() {
        return ((Offset) this.initialMfrOffset.getValue()).m5733unboximpl();
    }

    /* JADX INFO: renamed from: setInitialMfrOffset-k-4lQ0M, reason: not valid java name */
    public final void m177setInitialMfrOffsetk4lQ0M(long j) {
        this.initialMfrOffset.setValue(Offset.m5712boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getTargetStructuralOffset-F1C5BW0, reason: not valid java name */
    public final long m175getTargetStructuralOffsetF1C5BW0() {
        return ((Offset) this.targetStructuralOffset.getValue()).m5733unboximpl();
    }

    /* JADX INFO: renamed from: setTargetStructuralOffset-k-4lQ0M, reason: not valid java name */
    public final void m179setTargetStructuralOffsetk4lQ0M(long j) {
        this.targetStructuralOffset.setValue(Offset.m5712boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getCurrentMfrOffset-F1C5BW0, reason: not valid java name */
    public final long m172getCurrentMfrOffsetF1C5BW0() {
        return ((Offset) this.currentMfrOffset.getValue()).m5733unboximpl();
    }

    /* JADX INFO: renamed from: setCurrentMfrOffset-k-4lQ0M, reason: not valid java name */
    public final void m176setCurrentMfrOffsetk4lQ0M(long j) {
        this.currentMfrOffset.setValue(Offset.m5712boximpl(j));
    }
}
