    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        State<Color> stateAnimate = this.veilAnimation.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<Color>>() { // from class: androidx.compose.animation.VeilModifierNode$draw$veilColor$1
            ...
            public /* bridge */ /* synthetic */ Color invoke(EnterExitState enterExitState) {
                return Color.m5958boximpl(m188invokevNxB06k(enterExitState));
            }

            /* JADX INFO: renamed from: invoke-vNxB06k, reason: not valid java name */
            public final long m188invokevNxB06k(EnterExitState enterExitState) {
                int i = WhenMappings.$EnumSwitchMapping$0[enterExitState.ordinal()];
                if (i == 1) {
                    Veil veil = this.this$0.getEnter().getData().getVeil();
                    if (veil != null) {
                        return veil.m187getTargetColor0d7_KjU();
                    }
                    Veil veil2 = this.this$0.getExit().getData().getVeil();
                    return veil2 != null ? veil2.m186getInitialColor0d7_KjU() : Color.INSTANCE.m6003getTransparent0d7_KjU();
                }
                if (i == 2) {
                    Veil veil3 = this.this$0.getEnter().getData().getVeil();
                    return veil3 != null ? veil3.m186getInitialColor0d7_KjU() : Color.INSTANCE.m6003getTransparent0d7_KjU();
                }
                if (i != 3) {
                    throw new NoWhenBranchMatchedException();
                }
                Veil veil4 = this.this$0.getExit().getData().getVeil();
                return veil4 != null ? veil4.m187getTargetColor0d7_KjU() : Color.INSTANCE.m6003getTransparent0d7_KjU();
            }
        });
        if (Color.m5970getAlphaimpl(stateAnimate.getValue().m5978unboximpl()) == 0.0f) {
            return;
        }
        ...
        if (veil != null && veil.getMatchParentSize()) {
            ...
            if (parentLayoutCoordinates == null) {
                ...
                jM5801getZeroNHjbRc = Size.m5783constructorimpl((((long) Float.floatToRawIntBits((int) (jMo7453getSizeYbymL2g & 4294967295L))) & 4294967295L) | (Float.floatToRawIntBits((int) (jMo7453getSizeYbymL2g >> 32)) << 32));
            }
            ContentDrawScope contentDrawScope2 = contentDrawScope;
            DrawScope.m6543drawRectnJ9OG0$default(contentDrawScope2, stateAnimate.getValue().m5978unboximpl(), Offset.m5715constructorimpl(LayoutCoordinatesKt.positionInParent(layoutCoordinatesRequireLayoutCoordinates) ^ (-9223372034707292160L)), jM5801getZeroNHjbRc, 0.0f, null, null, 0, 120, null);
            return;
        }
        DrawScope.m6543drawRectnJ9OG0$default(contentDrawScope, stateAnimate.getValue().m5978unboximpl(), 0L, 0L, 0.0f, null, null, 0, 126, null);
    }
}
