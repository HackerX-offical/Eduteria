...
public final class VectorizedAnimationSpecKt {
    ...
    public static final <V extends AnimationVector> Animations createSpringAnimations(V v, float f2, float f3) {
        if (v != null) {
            return new Animations(v, f2, f3) { // from class: androidx.compose.animation.core.VectorizedAnimationSpecKt.createSpringAnimations.1
                ...
                /* JADX WARN: Incorrect types in method signature: (TV;FF)V */
                {
                    ...
                    for (int i = 0; i < size; i++) {
                        floatSpringSpecArr[i] = new FloatSpringSpec(f2, f3, v.get$animation_core(i));
                    }
        ...
        return new Animations(f2, f3) { // from class: androidx.compose.animation.core.VectorizedAnimationSpecKt.createSpringAnimations.2
