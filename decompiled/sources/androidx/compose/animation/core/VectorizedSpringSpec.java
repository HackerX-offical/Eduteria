...
public final class VectorizedSpringSpec<V extends AnimationVector> implements VectorizedFiniteAnimationSpec<V> {
    ...
    public /* synthetic */ VectorizedSpringSpec(float f2, float f3, AnimationVector animationVector, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? 1.0f : f2, (i & 2) != 0 ? 1500.0f : f3, (i & 4) != 0 ? null : animationVector);
    }

    public VectorizedSpringSpec(float f2, float f3, V v) {
        this(f2, f3, VectorizedAnimationSpecKt.createSpringAnimations(v, f2, f3));
    }
}
