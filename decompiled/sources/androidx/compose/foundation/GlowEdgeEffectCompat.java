...
final class GlowEdgeEffectCompat extends EdgeEffect {
    ...
    public GlowEdgeEffectCompat(Context context) {
        super(context);
        this.oppositeReleaseDeltaThreshold = AndroidDensity_androidKt.Density(context).mo488toPx0680j_4(Dp.m8830constructorimpl(1));
    }
    ...
    public final void releaseWithOppositeDelta(float delta) {
        float f2 = this.oppositeReleaseDelta + delta;
