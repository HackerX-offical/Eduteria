...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl mo422createnHHXs2Y(View view, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Density density, float initialZoom) {
        if (useTextDefault) {
            return new PlatformMagnifierImpl(new Magnifier(view));
        }
        long jMo489toSizeXkaWNTQ = density.mo489toSizeXkaWNTQ(size);
        float fMo488toPx0680j_4 = density.mo488toPx0680j_4(cornerRadius);
        float fMo488toPx0680j_42 = density.mo488toPx0680j_4(elevation);
        Magnifier.Builder builder = new Magnifier.Builder(view);
        if (jMo489toSizeXkaWNTQ != InlineClassHelperKt.UnspecifiedPackedFloats) {
            builder.setSize(MathKt.roundToInt(Float.intBitsToFloat((int) (jMo489toSizeXkaWNTQ >> 32))), MathKt.roundToInt(Float.intBitsToFloat((int) (jMo489toSizeXkaWNTQ & 4294967295L))));
        }
        if (!Float.isNaN(fMo488toPx0680j_4)) {
            builder.setCornerRadius(fMo488toPx0680j_4);
        }
        if (!Float.isNaN(fMo488toPx0680j_42)) {
            builder.setElevation(fMo488toPx0680j_42);
        }
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo421updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            if (!Float.isNaN(zoom)) {
