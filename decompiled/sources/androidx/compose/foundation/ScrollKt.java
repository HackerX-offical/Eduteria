...
public final class ScrollKt {
    public static final ScrollState rememberScrollState(final int i, Composer composer, int i2, int i3) {
        ...
        ScrollState scrollState = (ScrollState) RememberSaveableKt.m5351rememberSaveable(objArr, (Saver) saver, (Function0) objRememberedValue, composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    private static final Modifier scroll(Modifier modifier, ScrollState scrollState, boolean z, FlingBehavior flingBehavior, boolean z2, boolean z3, boolean z4, OverscrollEffect overscrollEffect) {
        Modifier modifierScrollableArea$default;
        Orientation orientation = z3 ? Orientation.Vertical : Orientation.Horizontal;
        if (z4) {
            modifierScrollableArea$default = ScrollableAreaKt.scrollableArea$default(modifier, scrollState, orientation, z2, z, flingBehavior, scrollState.getInternalInteractionSource(), null, 64, null);
        } else {
            modifierScrollableArea$default = ScrollableAreaKt.scrollableArea$default(modifier, scrollState, orientation, overscrollEffect, z2, z, flingBehavior, scrollState.getInternalInteractionSource(), null, 128, null);
        }
        return modifierScrollableArea$default.then(new ScrollingLayoutElement(scrollState, z, z3));
    }
}
