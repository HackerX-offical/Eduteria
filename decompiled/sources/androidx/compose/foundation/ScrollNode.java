...
public final class ScrollNode extends Modifier.Node implements LayoutModifierNode, SemanticsModifierNode {
    ...
    public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable placeableMo7445measureBRTryo0 = measurable.mo7445measureBRTryo0(Constraints.m8773copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m8783getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m8782getMaxHeightimpl(j), 5, null));
        int iCoerceAtMost = RangesKt.coerceAtMost(placeableMo7445measureBRTryo0.getWidth(), Constraints.m8783getMaxWidthimpl(j));
        int iCoerceAtMost2 = RangesKt.coerceAtMost(placeableMo7445measureBRTryo0.getHeight(), Constraints.m8782getMaxHeightimpl(j));
        final int height = placeableMo7445measureBRTryo0.getHeight() - iCoerceAtMost2;
        int width = placeableMo7445measureBRTryo0.getWidth() - iCoerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
        ...
        this.state.setContentSize$foundation(this.isVertical ? placeableMo7445measureBRTryo0.getHeight() : placeableMo7445measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measureScope, iCoerceAtMost, iCoerceAtMost2, null, new Function1() { // from class: androidx.compose.foundation.ScrollNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return ScrollNode.measure_3p2s80s$lambda$0(this.f$0, height, placeableMo7445measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        ScrollAxisRange scrollAxisRange = new ScrollAxisRange(new Function0() { // from class: androidx.compose.foundation.ScrollNode$$ExternalSyntheticLambda2
            ...
            public final Object invoke() {
                return Float.valueOf(ScrollNode.applySemantics$lambda$0(this.f$0));
            }
        }, new Function0() { // from class: androidx.compose.foundation.ScrollNode$$ExternalSyntheticLambda3
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Float.valueOf(ScrollNode.applySemantics$lambda$1(this.f$0));
            }
