...
public final class ScrollState implements ScrollableState {
    ...
    public static final float scrollableState$lambda$0(ScrollState scrollState, float f2) {
        float value = scrollState.getValue() + f2 + scrollState.accumulator;
