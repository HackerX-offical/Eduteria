...
public final class ContextMenuSpec {
    ...
    private static final float ContainerWidthMin = Dp.m8830constructorimpl(112);
    private static final float ContainerWidthMax = Dp.m8830constructorimpl(280);
    private static final float ListItemHeight = Dp.m8830constructorimpl(48);
    private static final float MenuContainerElevation = Dp.m8830constructorimpl(3);
    private static final float CornerRadius = Dp.m8830constructorimpl(4);
    private static final Alignment.Vertical LabelVerticalTextAlignment = Alignment.INSTANCE.getCenterVertically();
    private static final int LabelHorizontalTextAlignment = TextAlign.INSTANCE.m8713getStarte0LSkKk();
    private static final float HorizontalPadding = Dp.m8830constructorimpl(12);
    private static final float IconSize = Dp.m8830constructorimpl(24);
    private static final float DividerHeight = Dp.m8830constructorimpl(1);
    ...
    static {
        float f2 = 8;
        VerticalPadding = Dp.m8830constructorimpl(f2);
        DividerVerticalPadding = Dp.m8830constructorimpl(f2);
    }
}
