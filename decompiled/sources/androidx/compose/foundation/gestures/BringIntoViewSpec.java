...
@Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0002\b\n\bg\u0018\u0000 \r2\u00020\u0001:\u0001\rJ \u0010\t\u001a\u00020\u00042\u0006\u0010\n\u001a\u00020\u00042\u0006\u0010\u000b\u001a\u00020\u00042\u0006\u0010\f\u001a\u00020\u0004H\u0016R \u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u00038WX\u0097\u0004¢\u0006\f\u0012\u0004\b\u0005\u0010\u0006\u001a\u0004\b\u0007\u0010\bø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u000eÀ\u0006\u0001"}, d2 = {"Landroidx/compose/foundation/gestures/BringIntoViewSpec;", "", "scrollAnimationSpec", "Landroidx/compose/animation/core/AnimationSpec;", "", "getScrollAnimationSpec$annotations", "()V", "getScrollAnimationSpec", "()Landroidx/compose/animation/core/AnimationSpec;", "calculateScrollDistance", "offset", "size", "containerSize", "Companion", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
public interface BringIntoViewSpec {
    ...
    public static final class Companion {
        ...
        public final float defaultCalculateScrollDistance$foundation(float offset, float size, float containerSize) {
            float f2 = size + offset;
            if (offset >= 0.0f && f2 <= containerSize) {
                return 0.0f;
            }
            if (offset < 0.0f && f2 > containerSize) {
                return 0.0f;
            }
            float f3 = f2 - containerSize;
            return Math.abs(offset) < Math.abs(f3) ? offset : f3;
        }
    }
}
