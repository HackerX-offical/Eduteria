...
public final class ContentInViewNodeKt {
    ...
    private static final long UnspecifiedIntSize;

    /* JADX INFO: renamed from: takeOrElse-viCIZxY, reason: not valid java name */
    private static final long m535takeOrElseviCIZxY(long j, Function0<IntSize> function0) {
        return IntSize.m8999equalsimpl0(j, UnspecifiedIntSize) ? function0.invoke().m9005unboximpl() : j;
    }

    static {
        long j = -1;
        UnspecifiedIntSize = IntSize.m8996constructorimpl((j & 4294967295L) | (j << 32));
    }
}
