...
final class DefaultScrollable2DState implements Scrollable2DState {
    ...
    private final Scroll2DScope scrollScope = new Scroll2DScope() { // from class: androidx.compose.foundation.gestures.DefaultScrollable2DState$scrollScope$1
        ...
        public long mo540scrollByMKHz9U(long delta) {
            ...
            return this.this$0.getOnDelta().invoke(Offset.m5712boximpl(delta)).m5733unboximpl();
        }
    };
    ...
    public boolean mo538canScrollk4lQ0M(long offset) {
        return true;
    }
    ...
    public long mo539dispatchRawDeltaMKHz9U(long delta) {
        return this.onDelta.invoke(Offset.m5712boximpl(delta)).m5733unboximpl();
    }
