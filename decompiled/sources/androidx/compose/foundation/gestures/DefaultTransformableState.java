...
final class DefaultTransformableState implements TransformableState {
    ...
    private final TransformScope transformScope = new TransformScope() { // from class: androidx.compose.foundation.gestures.DefaultTransformableState$transformScope$1
        ...
        public void mo541transformByd4ec7I(float zoomChange, long panChange, float rotationChange) {
            mo542transformByWithCentroidIEwrmTk(Offset.INSTANCE.m5738getUnspecifiedF1C5BW0(), zoomChange, panChange, rotationChange);
        }

        @Override // androidx.compose.foundation.gestures.TransformScope
        /* JADX INFO: renamed from: transformByWithCentroid-IEwrmTk, reason: not valid java name */
        public void mo542transformByWithCentroidIEwrmTk(long centroid, float zoomChange, long panChange, float rotationChange) {
            this.this$0.getOnTransformation().invoke(Offset.m5712boximpl(centroid), Float.valueOf(zoomChange), Offset.m5712boximpl(panChange), Float.valueOf(rotationChange));
        }
    };
