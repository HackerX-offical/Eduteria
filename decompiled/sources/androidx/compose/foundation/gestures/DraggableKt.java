...
public final class DraggableKt {
    ...
    public static final DraggableState rememberDraggableState(Function1<? super Float, Unit> function1, Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-183245213, i, -1, "androidx.compose.foundation.gestures.rememberDraggableState (Draggable.kt:150)");
        }
        ...
        if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = DraggableState(new Function1() { // from class: androidx.compose.foundation.gestures.DraggableKt$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return DraggableKt.rememberDraggableState$lambda$0$0(stateRememberUpdatedState, ((Float) obj).floatValue());
                }
            });
    ...
    public static final Unit rememberDraggableState$lambda$0$0(State state, float f2) {
        ((Function1) state.getValue()).invoke(Float.valueOf(f2));
    ...
    public static final float m590toFloat3MmeM6k(long j, Orientation orientation) {
    ...
    public static final float m591toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m9069getYimpl(j) : Velocity.m9068getXimpl(j);
    }

    /* JADX INFO: renamed from: toValidVelocity-TH1AsA0, reason: not valid java name */
    public static final long m592toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m9068getXimpl(j)) ? 0.0f : Velocity.m9068getXimpl(j), Float.isNaN(Velocity.m9069getYimpl(j)) ? 0.0f : Velocity.m9069getYimpl(j));
    }
}
