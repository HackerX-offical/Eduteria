...
final class Scrollable2DNode$setScrollSemanticsActions$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    Scrollable2DNode$setScrollSemanticsActions$1$1(Scrollable2DNode scrollable2DNode, float f2, float f3, Continuation<? super Scrollable2DNode$setScrollSemanticsActions$1$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (Scrollable2DKt.m670semanticsScrollByd4ec7I(scrollingLogic2D, Offset.m5715constructorimpl((jFloatToRawIntBits << 32) | (jFloatToRawIntBits2 & 4294967295L)), this) == coroutine_suspended) {
