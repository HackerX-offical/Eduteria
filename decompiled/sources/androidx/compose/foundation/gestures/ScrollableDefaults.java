...
public final class ScrollableDefaults {
    ...
    public final FlingBehavior flingBehavior(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1107739818, i, -1, "androidx.compose.foundation.gestures.ScrollableDefaults.flingBehavior (Scrollable.kt:622)");
        }
    ...
    public final OverscrollEffect overscrollEffect(Composer composer, int i) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1809802212, i, -1, "androidx.compose.foundation.gestures.ScrollableDefaults.overscrollEffect (Scrollable.kt:639)");
        }
    ...
    private static final class NoOpOverscrollEffect implements OverscrollEffect {
        ...
        public long mo289applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
            return performScroll.invoke(Offset.m5712boximpl(delta)).m5733unboximpl();
        }

        @Override // androidx.compose.foundation.OverscrollEffect
        /* JADX INFO: renamed from: applyToFling-BMRW4eQ */
        public Object mo288applyToFlingBMRW4eQ(long j, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
            Object objInvoke = function2.invoke(Velocity.m9059boximpl(j), continuation);
