...
public final class ScrollableNode extends DragGestureNode implements KeyInputModifierNode, SemanticsModifierNode, OnScrollChangedDispatcher {
    ...
    public void mo509onDragStartedk4lQ0M(long startedPosition) {
    }
    ...
    public ScrollableNode(ScrollableState scrollableState, OverscrollEffect overscrollEffect, FlingBehavior flingBehavior, Orientation orientation, boolean z, boolean z2, MutableInteractionSource mutableInteractionSource, BringIntoViewSpec bringIntoViewSpec) {
        ...
        this.focusTargetModifierNode = (FocusTargetModifierNode) delegate(FocusTargetModifierNodeKt.m5635FocusTargetModifierNodePYyLHbc$default(Focusability.INSTANCE.m5658getNeverLCbbffg(), null, 2, null));
    ...
    public void mo635dispatchScrollDeltaInfok4lQ0M(long delta) {
        if (getIsAttached()) {
            DelegatableNodeKt.m7614dispatchOnScrollChangedUv8p0NA(this, delta);
        }
    }
    ...
    static final class C03041 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C03041(DragEvent.DragStopped dragStopped, ScrollableNode scrollableNode, Continuation<? super C03041> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C03041(this.$event, this.this$0, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                float f2 = this.$event.getIsIndirectPointerEvent() ? -1.0f : 1.0f;
                this.label = 1;
                if (this.this$0.scrollingLogic.m692onScrollStoppedBMRW4eQ(Velocity.m9074timesadjELrA(this.$event.getVelocity(), f2), false, this) == coroutine_suspended) {
    ...
    public void onDragStopped(DragEvent.DragStopped event) {
        BuildersKt__Builders_commonKt.launch$default(this.nestedScrollDispatcher.getCoroutineScope(), null, null, new C03041(event, this, null), 3, null);
    }

    /* JADX INFO: renamed from: onWheelScrollStopped-TH1AsA0, reason: not valid java name */
    private final void m679onWheelScrollStoppedTH1AsA0(long velocity) {
    ...
    private final void m678onTrackpadScrollStoppedTH1AsA0(long velocity) {
    ...
    static final /* synthetic */ class AnonymousClass1 extends AdaptedFunctionReference implements Function2<Velocity, Continuation<? super Unit>, Object>, SuspendFunction {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Velocity velocity, Continuation<? super Unit> continuation) {
            return m680invokesFctU(velocity.getPackedValue(), continuation);
        }

        /* JADX INFO: renamed from: invoke-sF-c-tU, reason: not valid java name */
        public final Object m680invokesFctU(long j, Continuation<? super Unit> continuation) {
            return ScrollableNode.ensureMouseWheelScrollingLogicInitialized$onWheelScrollStopped((ScrollableNode) this.receiver, j, continuation);
        }
    }
    ...
    public static final /* synthetic */ Object ensureMouseWheelScrollingLogicInitialized$onWheelScrollStopped(ScrollableNode scrollableNode, long j, Continuation continuation) {
        scrollableNode.m679onWheelScrollStoppedTH1AsA0(j);
        return Unit.INSTANCE;
    }

    private final void ensureTrackpadScrollingLogicInitialized() {
        if (this.trackpadScrollingLogic == null) {
            this.trackpadScrollingLogic = new TrackpadScrollingLogic(this.scrollingLogic, new C03031(this), DelegatableNodeKt.requireDensity(this));
        }
    ...
    /* JADX INFO: compiled from: Scrollable.kt */
    @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
    static final /* synthetic */ class C03031 extends AdaptedFunctionReference implements Function2<Velocity, Continuation<? super Unit>, Object>, SuspendFunction {
        C03031(Object obj) {
        ...
        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Velocity velocity, Continuation<? super Unit> continuation) {
            return m681invokesFctU(velocity.getPackedValue(), continuation);
        }

        /* JADX INFO: renamed from: invoke-sF-c-tU, reason: not valid java name */
        public final Object m681invokesFctU(long j, Continuation<? super Unit> continuation) {
            return ScrollableNode.ensureTrackpadScrollingLogicInitialized$onTrackpadScrollStopped((ScrollableNode) this.receiver, j, continuation);
        }
    }
    ...
    public static final /* synthetic */ Object ensureTrackpadScrollingLogicInitialized$onTrackpadScrollStopped(ScrollableNode scrollableNode, long j, Continuation continuation) {
        scrollableNode.m678onTrackpadScrollStoppedTH1AsA0(j);
        return Unit.INSTANCE;
    }
    ...
    public boolean mo279onKeyEventZmokQxo(KeyEvent event) {
        ...
        if ((!Key.m6824equalsimpl0(KeyEvent_androidKt.m7144getKeyZmokQxo(event), Key.INSTANCE.m7023getPageDownEK5gGoQ()) && !Key.m6824equalsimpl0(KeyEvent_androidKt.m7144getKeyZmokQxo(event), Key.INSTANCE.m7024getPageUpEK5gGoQ())) || !KeyEventType.m7137equalsimpl0(KeyEvent_androidKt.m7145getTypeZmokQxo(event), KeyEventType.INSTANCE.m7141getKeyDownCS__XNY()) || KeyEvent_androidKt.m7148isCtrlPressedZmokQxo(event)) {
            return false;
        }
        if (this.scrollingLogic.isVertical()) {
            int iM533getViewportSizeOrZeroYbymL2g$foundation = (int) (this.contentInViewNode.m533getViewportSizeOrZeroYbymL2g$foundation() & 4294967295L);
            jM5715constructorimpl = Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(0.0f)) << 32) | (4294967295L & ((long) Float.floatToRawIntBits(Key.m6824equalsimpl0(KeyEvent_androidKt.m7144getKeyZmokQxo(event), Key.INSTANCE.m7024getPageUpEK5gGoQ()) ? iM533getViewportSizeOrZeroYbymL2g$foundation : -iM533getViewportSizeOrZeroYbymL2g$foundation))));
        } else {
            int iM533getViewportSizeOrZeroYbymL2g$foundation2 = (int) (this.contentInViewNode.m533getViewportSizeOrZeroYbymL2g$foundation() >> 32);
            jM5715constructorimpl = Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(0.0f)) & 4294967295L) | (((long) Float.floatToRawIntBits(Key.m6824equalsimpl0(KeyEvent_androidKt.m7144getKeyZmokQxo(event), Key.INSTANCE.m7024getPageUpEK5gGoQ()) ? iM533getViewportSizeOrZeroYbymL2g$foundation2 : -iM533getViewportSizeOrZeroYbymL2g$foundation2)) << 32));
        }
        BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new ScrollableNode$onKeyEvent$1(this, jM5715constructorimpl, null), 3, null);
        return true;
    }
    ...
    public void mo280onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        while (true) {
            ...
            if (getCanDrag().invoke(PointerType.m7382boximpl(changes.get(i).getType())).booleanValue()) {
        ...
        if (getEnabled()) {
            if (pass == PointerEventPass.Initial && PointerEventType.m7252equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m7267getScroll7fucELk())) {
                ensureMouseWheelScrollingLogicInitialized();
            }
            MouseWheelScrollingLogic mouseWheelScrollingLogic = this.mouseWheelScrollingLogic;
            if (mouseWheelScrollingLogic != null) {
                mouseWheelScrollingLogic.mo627onPointerEventH0pRuoY(pointerEvent, pass, bounds);
            }
            if (pass == PointerEventPass.Initial && (PointerEventType.m7252equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m7261getPanStart7fucELk()) || PointerEventType.m7252equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m7260getPanMove7fucELk()) || PointerEventType.m7252equalsimpl0(pointerEvent.getType(), PointerEventType.INSTANCE.m7259getPanEnd7fucELk()))) {
                ensureTrackpadScrollingLogicInitialized();
            }
            TrackpadScrollingLogic trackpadScrollingLogic = this.trackpadScrollingLogic;
            if (trackpadScrollingLogic != null) {
                trackpadScrollingLogic.mo627onPointerEventH0pRuoY(pointerEvent, pass, bounds);
            }
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean setScrollSemanticsActions$lambda$0(ScrollableNode scrollableNode, float f2, float f3) {
        BuildersKt__Builders_commonKt.launch$default(scrollableNode.getCoroutineScope(), null, null, new ScrollableNode$setScrollSemanticsActions$1$1(scrollableNode, f2, f3, null), 3, null);
        return true;
    }
    ...
    /* JADX INFO: compiled from: Scrollable.kt */
    @Metadata(d1 = {"\u0000\b\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0001H\n"}, d2 = {"<anonymous>", "Landroidx/compose/ui/geometry/Offset;", "offset"}, k = 3, mv = {2, 1, 0}, xi = 48)
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<Offset, Continuation<? super Offset>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            ...
            anonymousClass2.J$0 = ((Offset) obj).m5733unboximpl();
            return anonymousClass2;
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Object invoke(Offset offset, Continuation<? super Offset> continuation) {
            return m682invoke3MmeM6k(offset.m5733unboximpl(), continuation);
        }

        /* JADX INFO: renamed from: invoke-3MmeM6k, reason: not valid java name */
        public final Object m682invoke3MmeM6k(long j, Continuation<? super Offset> continuation) {
            return ((AnonymousClass2) create(Offset.m5712boximpl(j), continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            long j = this.J$0;
            this.label = 1;
            Object objM675semanticsScrollByd4ec7I = ScrollableKt.m675semanticsScrollByd4ec7I(ScrollableNode.this.scrollingLogic, j, this);
            return objM675semanticsScrollByd4ec7I == coroutine_suspended ? coroutine_suspended : objM675semanticsScrollByd4ec7I;
        }
    }
