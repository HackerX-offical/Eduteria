...
public final class ScrollableStateKt {
    ...
    public static final float rememberScrollableState$lambda$0$0(State state, float f2) {
        return ((Number) ((Function1) state.getValue()).invoke(Float.valueOf(f2))).floatValue();
    }
}
