...
abstract class TransformEvent {
    ...
    public static final class TransformDelta extends TransformEvent {
        ...
        public /* synthetic */ TransformDelta(long j, float f2, long j2, float f3, DefaultConstructorMarker defaultConstructorMarker) {
            this(j, f2, j2, f3);
        }

        private TransformDelta(long j, float f2, long j2, float f3) {
            super(null);
            this.centroid = j;
            this.zoomChange = f2;
            this.panChange = j2;
