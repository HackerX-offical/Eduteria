...
final class SnapFlingBehavior$fling$result$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AnimationResult<Float, AnimationVector1D>>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.L$0 = floatRef;
            this.label = 1;
            objTryApproach = snapFlingBehavior.tryApproach(scrollScope, f2, f3, new Function1() { // from class: androidx.compose.foundation.gestures.snapping.SnapFlingBehavior$fling$result$1$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj2) {
                    return SnapFlingBehavior$fling$result$1.invokeSuspend$lambda$1(floatRef, function1, ((Float) obj2).floatValue());
                }
            }, this);
        ...
        this.L$0 = null;
        this.label = 2;
        Object objAnimateWithTarget = SnapFlingBehaviorKt.animateWithTarget(scrollScope2, f4, f5, animationStateCopy$default, animationSpec, new Function1() { // from class: androidx.compose.foundation.gestures.snapping.SnapFlingBehavior$fling$result$1$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj2) {
                return SnapFlingBehavior$fling$result$1.invokeSuspend$lambda$4(floatRef, function12, ((Float) obj2).floatValue());
            }
        }, this);
    ...
    public static final Unit invokeSuspend$lambda$1(Ref.FloatRef floatRef, Function1 function1, float f2) {
        floatRef.element -= f2;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit invokeSuspend$lambda$4(Ref.FloatRef floatRef, Function1 function1, float f2) {
        floatRef.element -= f2;
        function1.invoke(Float.valueOf(floatRef.element));
        return Unit.INSTANCE;
    }
