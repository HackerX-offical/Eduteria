...
public final class SnapFlingBehaviorKt {
    ...
    private static final float MinFlingVelocityDp = Dp.m8830constructorimpl(HttpStatus.SC_BAD_REQUEST);
    ...
    */
    public static final java.lang.Object animateDecay(final androidx.compose.foundation.gestures.ScrollScope r5, final float r6, androidx.compose.animation.core.AnimationState<java.lang.Float, androidx.compose.animation.core.AnimationVector1D> r7, androidx.compose.animation.core.DecayAnimationSpec<java.lang.Float> r8, final kotlin.jvm.functions.Function1<? super java.lang.Float, kotlin.Unit> r9, kotlin.coroutines.Continuation<? super androidx.compose.foundation.gestures.snapping.AnimationResult<java.lang.Float, androidx.compose.animation.core.AnimationVector1D>> r10) {
        ...
        L56:
            r2 = r2 ^ r3
            androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt$$ExternalSyntheticLambda0 r4 = new androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt$$ExternalSyntheticLambda0
            r4.<init>()
            r0.L$0 = r7
            r0.L$1 = r10
            r0.F$0 = r6
    ...
    private static final void animateDecay$consumeDelta(AnimationScope<Float, AnimationVector1D> animationScope, ScrollScope scrollScope, Function1<? super Float, Unit> function1, float f2) {
        float fScrollBy;
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit animateDecay$lambda$0(float f2, Ref.FloatRef floatRef, ScrollScope scrollScope, Function1 function1, AnimationScope animationScope) {
        if (Math.abs(((Number) animationScope.getValue()).floatValue()) >= Math.abs(f2)) {
            float fCoerceToTarget = coerceToTarget(((Number) animationScope.getValue()).floatValue(), f2);
    ...
    */
    public static final java.lang.Object animateWithTarget(final androidx.compose.foundation.gestures.ScrollScope r20, float r21, final float r22, androidx.compose.animation.core.AnimationState<java.lang.Float, androidx.compose.animation.core.AnimationVector1D> r23, androidx.compose.animation.core.AnimationSpec<java.lang.Float> r24, final kotlin.jvm.functions.Function1<? super java.lang.Float, kotlin.Unit> r25, kotlin.coroutines.Continuation<? super androidx.compose.foundation.gestures.snapping.AnimationResult<java.lang.Float, androidx.compose.animation.core.AnimationVector1D>> r26) {
        /*
            r0 = r26
            boolean r1 = r0 instanceof androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt.C03201
            if (r1 == 0) goto L16
            r1 = r0
            androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt$animateWithTarget$1 r1 = (androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt.C03201) r1
            int r2 = r1.label
        ...
        L6b:
            r5 = r4 ^ 1
            androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt$$ExternalSyntheticLambda1 r6 = new androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt$$ExternalSyntheticLambda1
            r4 = r20
            r9 = r22
            r10 = r25
            r6.<init>()
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit animateWithTarget$lambda$0(float f2, Ref.FloatRef floatRef, ScrollScope scrollScope, Function1 function1, AnimationScope animationScope) {
        float fScrollBy;
        float fCoerceToTarget = coerceToTarget(((Number) animationScope.getValue()).floatValue(), f2);
        float f3 = fCoerceToTarget - floatRef.element;
        try {
            fScrollBy = scrollScope.scrollBy(f3);
        } catch (CancellationException unused) {
            animationScope.cancelAnimation();
            fScrollBy = 0.0f;
        }
        function1.invoke(Float.valueOf(fScrollBy));
        if (Math.abs(f3 - fScrollBy) > 0.5f || fCoerceToTarget != ((Number) animationScope.getValue()).floatValue()) {
            animationScope.cancelAnimation();
        }
    ...
    private static final float coerceToTarget(float f2, float f3) {
        if (f3 == 0.0f) {
            return 0.0f;
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final float m763calculateFinalOffsetFhqu1e0(int r2, float r3, float r4) {
        /*
            ...
            int r0 = r0.m758getClosestItembbeMdSM()
            boolean r0 = androidx.compose.foundation.gestures.snapping.FinalSnappingItem.m754equalsimpl0(r2, r0)
            r1 = 0
            if (r0 == 0) goto L1a
        ...
        L1a:
            androidx.compose.foundation.gestures.snapping.FinalSnappingItem$Companion r0 = androidx.compose.foundation.gestures.snapping.FinalSnappingItem.INSTANCE
            int r0 = r0.m759getNextItembbeMdSM()
            boolean r0 = androidx.compose.foundation.gestures.snapping.FinalSnappingItem.m754equalsimpl0(r2, r0)
            if (r0 == 0) goto L28
        L26:
            r3 = r4
        ...
        L28:
            ...
            int r4 = r4.m760getPreviousItembbeMdSM()
            boolean r2 = androidx.compose.foundation.gestures.snapping.FinalSnappingItem.m754equalsimpl0(r2, r4)
            if (r2 == 0) goto L35
            goto L36
        L35:
            r3 = r1
        ...
        L3d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.snapping.SnapFlingBehaviorKt.m763calculateFinalOffsetFhqu1e0(int, float, float):float");
    }
}
