...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte != 1) {
                if (bDecodeByte != 2) {
                    if (bDecodeByte != 3) {
                        if (bDecodeByte != 4) {
                            if (bDecodeByte != 5) {
                                        ...
                                        if (bDecodeByte != 8) {
                                            if (bDecodeByte != 9) {
                                                if (bDecodeByte != 10) {
                                                    ...
                                                    mutableSpanStyle.m784setBackground8_81llA(m767decodeColor0d7_KjU());
                                                }
                                            } else {
                                                if (dataAvailable() < 8) {
                                                    break;
                                            ...
                                            mutableSpanStyle.m785setBaselineShift_isdbwI(BaselineShift.m8570boximpl(m765decodeBaselineShifty9eOQZs()));
                                        }
                                    } else {
                                        if (dataAvailable() < 5) {
                                            break;
                                        }
                                        mutableSpanStyle.m790setLetterSpacingR2X_6o(m770decodeTextUnitXSAIIZE());
                                    }
                                } else {
                                ...
                                mutableSpanStyle.m789setFontSynthesistDdu0R4(FontSynthesis.m8395boximpl(m769decodeFontSynthesisGVVA2EU()));
                            }
                        } else {
                            if (dataAvailable() < 1) {
                                break;
                            }
                            mutableSpanStyle.m788setFontStylemLjRB2g(FontStyle.m8384boximpl(m768decodeFontStyle_LCdwA()));
                        }
                    } else {
                        if (dataAvailable() < 4) {
                            break;
                    ...
                    mutableSpanStyle.m787setFontSizeR2X_6o(m770decodeTextUnitXSAIIZE());
                }
            } else {
                if (dataAvailable() < 8) {
                    break;
                }
                mutableSpanStyle.m786setColor8_81llA(m767decodeColor0d7_KjU());
            }
        }
    ...
    public final long m767decodeColor0d7_KjU() {
    ...
    public final long m770decodeTextUnitXSAIIZE() {
    ...
    public final int m768decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
    ...
    public final int m769decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
    ...
    private final float m765decodeBaselineShifty9eOQZs() {
    ...
    private final Shadow decodeShadow() {
        long jM767decodeColor0d7_KjU = m767decodeColor0d7_KjU();
        float fDecodeFloat = decodeFloat();
        return new Shadow(jM767decodeColor0d7_KjU, Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(decodeFloat())) & 4294967295L) | (Float.floatToRawIntBits(fDecodeFloat) << 32)), decodeFloat(), null);
    }
    ...
    private final long m766decodeULongsVKNKU() {
