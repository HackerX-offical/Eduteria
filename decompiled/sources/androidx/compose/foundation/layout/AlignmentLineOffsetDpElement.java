...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float f2, float f3, Function1<? super InspectorInfo, Unit> function1) {
        ...
        if (!(f2 >= 0.0f || Float.isNaN(f2)) || !(f3 >= 0.0f || Float.isNaN(f3))) {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m807setBefore0680j_4(this.before);
        node.m806setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return alignmentLineOffsetDpElement != null && Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDpElement.alignmentLine) && Dp.m8835equalsimpl0(this.before, alignmentLineOffsetDpElement.before) && Dp.m8835equalsimpl0(this.after, alignmentLineOffsetDpElement.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m8836hashCodeimpl(this.before)) * 31) + Dp.m8836hashCodeimpl(this.after);
    }
}
