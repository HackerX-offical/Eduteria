...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m813setBeforeR2X_6o(long j) {
        this.before = j;
    }
    ...
    public final void m812setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        return AlignmentLineKt.m793alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, TextUnit.m9022getRawTypeimpl(this.before) == 0 ? Dp.INSTANCE.m8850getUnspecifiedD9Ej5fM() : measureScope.mo483toDpGaN1DYA(this.before), TextUnit.m9022getRawTypeimpl(this.after) == 0 ? Dp.INSTANCE.m8850getUnspecifiedD9Ej5fM() : measureScope.mo483toDpGaN1DYA(this.after), measurable, j);
    }
}
