...
public final class Arrangement {
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m8830constructorimpl(0);
    ...
    public interface Horizontal {
        ...
        public static final class DefaultImpls {
            ...
            public static float m834getSpacingD9Ej5fM(Horizontal horizontal) {
        ...
        default float getSpacing() {
            return Dp.m8830constructorimpl(0);
        }
    }
    ...
    public interface Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* JADX INFO: renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m842getSpacingD9Ej5fM(Vertical vertical) {
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* JADX INFO: renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m836getSpacingD9Ej5fM(HorizontalOrVertical horizontalOrVertical) {
    ...
    public final HorizontalOrVertical m825spacedBy0680j_4(float space) {
    ...
    public final Horizontal m826spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
        return new SpacedAligned(space, true, new SpacingAlignmentCalculator() { // from class: androidx.compose.foundation.layout.Arrangement$$ExternalSyntheticLambda0
            @Override // androidx.compose.foundation.layout.Arrangement.SpacingAlignmentCalculator
            public final int align(int i, LayoutDirection layoutDirection) {
                return Arrangement.spacedBy_D5KLDUw$lambda$0(alignment, i, layoutDirection);
            }
        }, null);
    }
    ...
    /* JADX INFO: renamed from: spacedBy-D5KLDUw, reason: not valid java name */
    public final Vertical m827spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
        return new SpacedAligned(space, false, new SpacingAlignmentCalculator() { // from class: androidx.compose.foundation.layout.Arrangement$$ExternalSyntheticLambda1
            @Override // androidx.compose.foundation.layout.Arrangement.SpacingAlignmentCalculator
            public final int align(int i, LayoutDirection layoutDirection) {
                return Arrangement.spacedBy_D5KLDUw$lambda$1(alignment, i, layoutDirection);
            }
        }, null);
    }

    public final Horizontal aligned(final Alignment.Horizontal alignment) {
        return new SpacedAligned(Dp.m8830constructorimpl(0), true, new SpacingAlignmentCalculator() { // from class: androidx.compose.foundation.layout.Arrangement$$ExternalSyntheticLambda2
            @Override // androidx.compose.foundation.layout.Arrangement.SpacingAlignmentCalculator
            public final int align(int i, LayoutDirection layoutDirection) {
                return Arrangement.aligned$lambda$0(alignment, i, layoutDirection);
            }
        }, null);
    }
    ...
    public final Vertical aligned(final Alignment.Vertical alignment) {
        return new SpacedAligned(Dp.m8830constructorimpl(0), false, new SpacingAlignmentCalculator() { // from class: androidx.compose.foundation.layout.Arrangement$$ExternalSyntheticLambda3
            @Override // androidx.compose.foundation.layout.Arrangement.SpacingAlignmentCalculator
            public final int align(int i, LayoutDirection layoutDirection) {
                return Arrangement.aligned$lambda$1(alignment, i, layoutDirection);
            }
        }, null);
    }
    ...
    public static final class Absolute {
        ...
        /* JADX INFO: renamed from: spacedBy-0680j_4, reason: not valid java name */
        public final HorizontalOrVertical m829spacedBy0680j_4(float space) {
            return new SpacedAligned(space, false, null, 0 == true ? 1 : 0);
        }

        /* JADX INFO: renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Horizontal m830spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
            return new SpacedAligned(space, false, new SpacingAlignmentCalculator() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$$ExternalSyntheticLambda2
                @Override // androidx.compose.foundation.layout.Arrangement.SpacingAlignmentCalculator
                public final int align(int i, LayoutDirection layoutDirection) {
                    return Arrangement.Absolute.spacedBy_D5KLDUw$lambda$0(alignment, i, layoutDirection);
                }
            }, null);
        }
        ...
        /* JADX INFO: renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Vertical m831spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
            return new SpacedAligned(space, false, new SpacingAlignmentCalculator() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$$ExternalSyntheticLambda0
                @Override // androidx.compose.foundation.layout.Arrangement.SpacingAlignmentCalculator
                public final int align(int i, LayoutDirection layoutDirection) {
                    return Arrangement.Absolute.spacedBy_D5KLDUw$lambda$1(alignment, i, layoutDirection);
                }
            }, null);
        }

        public final Horizontal aligned(final Alignment.Horizontal alignment) {
            return new SpacedAligned(Dp.m8830constructorimpl(0), false, new SpacingAlignmentCalculator() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$$ExternalSyntheticLambda1
                @Override // androidx.compose.foundation.layout.Arrangement.SpacingAlignmentCalculator
                public final int align(int i, LayoutDirection layoutDirection) {
                    return Arrangement.Absolute.aligned$lambda$0(alignment, i, layoutDirection);
                }
            }, null);
        }
    ...
    public static final /* data */ class SpacedAligned implements HorizontalOrVertical {
        ...
        public /* synthetic */ SpacedAligned(float f2, boolean z, SpacingAlignmentCalculator spacingAlignmentCalculator, DefaultConstructorMarker defaultConstructorMarker) {
            this(f2, z, spacingAlignmentCalculator);
        }

        /* JADX INFO: renamed from: copy-8Feqmps$default, reason: not valid java name */
        public static /* synthetic */ SpacedAligned m837copy8Feqmps$default(SpacedAligned spacedAligned, float f2, boolean z, SpacingAlignmentCalculator spacingAlignmentCalculator, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return spacedAligned.m839copy8Feqmps(f2, z, spacingAlignmentCalculator);
        }
        ...
        public final SpacedAligned m839copy8Feqmps(float space, boolean rtlMirror, SpacingAlignmentCalculator alignment) {
        ...
        public boolean equals(Object other) {
            ...
            return Dp.m8835equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual(this.alignment, spacedAligned.alignment);
        }

        public int hashCode() {
            int iM8836hashCodeimpl = ((Dp.m8836hashCodeimpl(this.space) * 31) + Boolean.hashCode(this.rtlMirror)) * 31;
            SpacingAlignmentCalculator spacingAlignmentCalculator = this.alignment;
            return iM8836hashCodeimpl + (spacingAlignmentCalculator == null ? 0 : spacingAlignmentCalculator.hashCode());
        }

        private SpacedAligned(float f2, boolean z, SpacingAlignmentCalculator spacingAlignmentCalculator) {
            this.space = f2;
            this.rtlMirror = z;
        ...
        public final float m840getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        public void arrange(Density density, int i, int[] iArr, LayoutDirection layoutDirection, int[] iArr2) {
            ...
            int iMo482roundToPx0680j_4 = density.mo482roundToPx0680j_4(this.space);
            ...
            if (z) {
                ...
                while (i3 < length) {
                    ...
                    iArr2[i4] = iMax;
                    iMin = Math.min(iMo482roundToPx0680j_4, iMax);
                    i = iArr2[i4] - iMin;
                    i3++;
                    i4++;
                }
                ...
                while (i5 < length2) {
                    ...
                    iArr2[i8] = iMin2;
                    int iMin3 = Math.min(iMo482roundToPx0680j_4, (i - iMin2) - i9);
            ...
            int iAlign = spacingAlignmentCalculator.align(i2, layoutDirection);
            if (z) {
                iAlign -= i2;
            }
            if (iAlign != 0) {
        ...
        public String toString() {
            return (this.rtlMirror ? "" : "Absolute") + "Arrangement#spacedAligned(" + ((Object) Dp.m8841toStringimpl(this.space)) + ", " + this.alignment + ')';
        }
    }
    ...
    public final void placeSpaceEvenly$foundation_layout(int totalSize, int[] size, int[] outPosition, boolean reverseInput) {
        ...
        for (int length3 = size.length - 1; -1 < length3; length3--) {
            int i6 = size[length3];
            outPosition[length3] = Math.round(f3);
            f3 += i6 + length;
        }
    }
