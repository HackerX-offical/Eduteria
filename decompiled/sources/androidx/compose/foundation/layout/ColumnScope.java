...
public interface ColumnScope {
    ...
    Modifier weight(Modifier modifier, float f2, boolean z);
    ...
    static /* synthetic */ Modifier weight$default(ColumnScope columnScope, Modifier modifier, float f2, boolean z, int i, Object obj) {
        if (obj != null) {
