...
public interface ContextualFlowColumnScope extends ColumnScope {
    Modifier fillMaxColumnWidth(Modifier modifier, float f2);
    ...
    float mo864getMaxHeightInLineD9Ej5fM();

    /* JADX INFO: renamed from: getMaxWidth-D9Ej5fM, reason: not valid java name */
    float mo865getMaxWidthD9Ej5fM();

    static /* synthetic */ Modifier fillMaxColumnWidth$default(ContextualFlowColumnScope contextualFlowColumnScope, Modifier modifier, float f2, int i, Object obj) {
        if (obj != null) {
        ...
        return contextualFlowColumnScope.fillMaxColumnWidth(modifier, f2);
    }
}
