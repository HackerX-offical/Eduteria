...
public final class ContextualFlowRowScopeImpl implements RowScope, ContextualFlowRowScope {
    ...
    public /* synthetic */ ContextualFlowRowScopeImpl(int i, int i2, float f2, float f3, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, i2, f2, f3);
    }
    ...
    private ContextualFlowRowScopeImpl(int i, int i2, float f2, float f3) {
