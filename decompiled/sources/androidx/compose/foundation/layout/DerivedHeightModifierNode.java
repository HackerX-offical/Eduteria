...
final class DerivedHeightModifierNode extends InsetsConsumingModifierNode implements LayoutModifierNode {
    ...
    public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        int iCalculate = this.heightCalc.calculate(this.heightInsets, measureScope);
        if (iCalculate == 0) {
            return MeasureScope.layout$default(measureScope, 0, 0, null, new Function1() { // from class: androidx.compose.foundation.layout.DerivedHeightModifierNode$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj) {
                    return DerivedHeightModifierNode.measure_3p2s80s$lambda$0((Placeable.PlacementScope) obj);
                }
            }, 4, null);
        }
        final Placeable placeableMo7445measureBRTryo0 = measurable.mo7445measureBRTryo0(Constraints.m8773copyZbe2FdA$default(j, 0, 0, iCalculate, iCalculate, 3, null));
        return MeasureScope.layout$default(measureScope, placeableMo7445measureBRTryo0.getWidth(), iCalculate, null, new Function1() { // from class: androidx.compose.foundation.layout.DerivedHeightModifierNode$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return DerivedHeightModifierNode.measure_3p2s80s$lambda$1(placeableMo7445measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
