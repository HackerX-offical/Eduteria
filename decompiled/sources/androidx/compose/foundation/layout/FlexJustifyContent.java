...
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\b\u0087@\u0018\u0000 \u000e2\u00020\u0001:\u0001\u000eB\u0011\b\u0001\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u000f\u0010\u0006\u001a\u00020\u0007H\u0016¢\u0006\u0004\b\b\u0010\tJ\u0014\u0010\n\u001a\u00020\u000b2\b\u0010\f\u001a\u0004\u0018\u00010\u0001HÖ\u0083\u0004J\n\u0010\r\u001a\u00020\u0003HÖ\u0081\u0004R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000\u0088\u0001\u0002\u0092\u0001\u00020\u0003¨\u0006\u000f"}, d2 = {"Landroidx/compose/foundation/layout/FlexJustifyContent;", "", "bits", "", "constructor-impl", "(I)I", InAppPurchaseConstants.METHOD_TO_STRING, "", "toString-impl", "(I)Ljava/lang/String;", "equals", "", "other", "hashCode", "Companion", "foundation-layout"}, k = 1, mv = {2, 1, 0}, xi = 48)
@JvmInline
public final class FlexJustifyContent {
    ...
    public static final /* synthetic */ FlexJustifyContent m959boximpl(int i) {
        return new FlexJustifyContent(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m960constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m961equalsimpl(int i, Object obj) {
        return (obj instanceof FlexJustifyContent) && i == ((FlexJustifyContent) obj).getBits();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m962equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object other) {
        return m961equalsimpl(this.bits, other);
    }

    public int hashCode() {
        return m963hashCodeimpl(this.bits);
    }
    ...
    public String toString() {
        return m964toStringimpl(this.bits);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m964toStringimpl(int i) {
        if (i == 0) {
            return "Start";
        }
        if (i == 1) {
    ...
    public static final class Companion {
        ...
        public final int m971getStartGomtQF4() {
            return FlexJustifyContent.m960constructorimpl(0);
        }

        /* JADX INFO: renamed from: getEnd-GomtQF4, reason: not valid java name */
        public final int m967getEndGomtQF4() {
            return FlexJustifyContent.m960constructorimpl(1);
        }

        /* JADX INFO: renamed from: getCenter-GomtQF4, reason: not valid java name */
        public final int m966getCenterGomtQF4() {
            return FlexJustifyContent.m960constructorimpl(2);
        }

        /* JADX INFO: renamed from: getSpaceBetween-GomtQF4, reason: not valid java name */
        public final int m969getSpaceBetweenGomtQF4() {
            return FlexJustifyContent.m960constructorimpl(3);
        }

        /* JADX INFO: renamed from: getSpaceAround-GomtQF4, reason: not valid java name */
        public final int m968getSpaceAroundGomtQF4() {
            return FlexJustifyContent.m960constructorimpl(4);
        }

        /* JADX INFO: renamed from: getSpaceEvenly-GomtQF4, reason: not valid java name */
        public final int m970getSpaceEvenlyGomtQF4() {
            return FlexJustifyContent.m960constructorimpl(5);
        }
    }
}
