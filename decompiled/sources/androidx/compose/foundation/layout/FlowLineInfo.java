...
public final class FlowLineInfo {
    ...
    public /* synthetic */ FlowLineInfo(int i, int i2, float f2, float f3, DefaultConstructorMarker defaultConstructorMarker) {
        this(i, i2, f2, f3);
    }

    private FlowLineInfo(int i, int i2, float f2, float f3) {
        this.lineIndex = i;
    ...
    public final void m1004setMaxMainAxisSize0680j_4$foundation_layout(float f2) {
        this.maxMainAxisSize = f2;
    }
    ...
    public final void m1003setMaxCrossAxisSize0680j_4$foundation_layout(float f2) {
        this.maxCrossAxisSize = f2;
    }

    /* JADX INFO: renamed from: update-4j6BHR0$foundation_layout, reason: not valid java name */
    public final void m1005update4j6BHR0$foundation_layout(int lineIndex, int positionInLine, float maxMainAxisSize, float maxCrossAxisSize) {
    ...
    public /* synthetic */ FlowLineInfo(int i, int i2, float f2, float f3, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? 0 : i, (i3 & 2) != 0 ? 0 : i2, (i3 & 4) != 0 ? Dp.m8830constructorimpl(0) : f2, (i3 & 8) != 0 ? Dp.m8830constructorimpl(0) : f3, null);
    }
}
