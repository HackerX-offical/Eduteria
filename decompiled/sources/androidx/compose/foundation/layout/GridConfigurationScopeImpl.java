...
final class GridConfigurationScopeImpl implements GridConfigurationScope, Density {
    ...
    private GridConfigurationScopeImpl(Density density, long j) {
        ...
        this.flow = GridFlow.m1055constructorimpl(0);
    }
    ...
    public final void m1052setColumnGap0680j_4(float f2) {
        this.columnGap = f2;
    }
    ...
    public final void m1053setRowGap0680j_4(float f2) {
        this.rowGap = f2;
    }
    ...
    public void mo1049setFlow4t4_IgM(int i) {
        this.flow = i;
    }

    @Override // androidx.compose.foundation.layout.GridConfigurationScope
    /* JADX INFO: renamed from: column-0680j_4 */
    public void mo1033column0680j_4(float size) {
        mo1034column118E5d0(GridTrackSize.INSTANCE.m1087FixedpsSkOvk(size));
    }

    @Override // androidx.compose.foundation.layout.GridConfigurationScope
    /* JADX INFO: renamed from: column-XZblgos */
    public void mo1035columnXZblgos(float weight) {
        mo1034column118E5d0(GridTrackSize.INSTANCE.m1088FlexKGB9zo8(weight));
    }

    @Override // androidx.compose.foundation.layout.GridConfigurationScope
    public void column(float percentage) {
        mo1034column118E5d0(GridTrackSize.INSTANCE.m1090Percentage9Tp3RV8(percentage));
    }

    @Override // androidx.compose.foundation.layout.GridConfigurationScope
    /* JADX INFO: renamed from: column-118E5d0 */
    public void mo1034column118E5d0(long size) {
        this.columnSpecs.add(size);
    }

    @Override // androidx.compose.foundation.layout.GridConfigurationScope
    /* JADX INFO: renamed from: row-0680j_4 */
    public void mo1045row0680j_4(float size) {
        mo1046row118E5d0(GridTrackSize.INSTANCE.m1087FixedpsSkOvk(size));
    }

    @Override // androidx.compose.foundation.layout.GridConfigurationScope
    /* JADX INFO: renamed from: row-XZblgos */
    public void mo1047rowXZblgos(float weight) {
        mo1046row118E5d0(GridTrackSize.INSTANCE.m1088FlexKGB9zo8(weight));
    }

    @Override // androidx.compose.foundation.layout.GridConfigurationScope
    public void row(float percentage) {
        mo1046row118E5d0(GridTrackSize.INSTANCE.m1090Percentage9Tp3RV8(percentage));
    }

    @Override // androidx.compose.foundation.layout.GridConfigurationScope
    /* JADX INFO: renamed from: row-118E5d0 */
    public void mo1046row118E5d0(long size) {
        this.rowSpecs.add(size);
    }

    @Override // androidx.compose.foundation.layout.GridConfigurationScope
    /* JADX INFO: renamed from: gap-0680j_4 */
    public void mo1037gap0680j_4(float all) {
        if (all < 0.0f) {
    ...
    public void mo1038gapYgX7TsA(float row, float column) {
        if (row < 0.0f) {
    ...
    public void mo1036columnGap0680j_4(float gap) {
        if (gap < 0.0f) {
            throw new IllegalArgumentException("Column gap must be non-negative".toString());
        }
        this.columnGap = gap;
    ...
    public void mo1048rowGap0680j_4(float gap) {
        if (gap < 0.0f) {
            throw new IllegalArgumentException("Row gap must be non-negative".toString());
        }
        this.rowGap = gap;
