...
abstract class IntrinsicSizeModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public abstract long mo1099calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    public final MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        long jMo1099calculateContentConstraintsl58MMJ0 = mo1099calculateContentConstraintsl58MMJ0(measureScope, measurable, j);
        if (getEnforceIncoming()) {
            jMo1099calculateContentConstraintsl58MMJ0 = ConstraintsKt.m8798constrainN9IONVI(j, jMo1099calculateContentConstraintsl58MMJ0);
        }
        final Placeable placeableMo7445measureBRTryo0 = measurable.mo7445measureBRTryo0(jMo1099calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measureScope, placeableMo7445measureBRTryo0.getWidth(), placeableMo7445measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return IntrinsicSizeModifier.measure_3p2s80s$lambda$0(placeableMo7445measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measure_3p2s80s$lambda$0(Placeable placeable, Placeable.PlacementScope placementScope) {
        Placeable.PlacementScope.m7512placeRelative70tqf50$default(placementScope, placeable, IntOffset.INSTANCE.m8969getZeronOccac(), 0.0f, 2, null);
