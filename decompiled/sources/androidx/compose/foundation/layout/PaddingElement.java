...
final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    private PaddingElement(float f2, float f3, float f4, float f5, boolean z, Function1<? super InspectorInfo, Unit> function1) {
        ...
        float f6 = this.top;
        boolean z3 = z2 & (f6 >= 0.0f || Float.isNaN(f6));
        float f7 = this.end;
        boolean z4 = z3 & (f7 >= 0.0f || Float.isNaN(f7));
        float f8 = this.bottom;
        if (!z4 || !(f8 >= 0.0f || Float.isNaN(f8))) {
    ...
    public final void m1141setStart0680j_4(float f2) {
        this.start = f2;
    }
    ...
    public final void m1142setTop0680j_4(float f2) {
        this.top = f2;
    }
    ...
    public final void m1140setEnd0680j_4(float f2) {
        this.end = f2;
    }
    ...
    public final void m1139setBottom0680j_4(float f2) {
        this.bottom = f2;
    }
    ...
    public void update(PaddingNode node) {
        node.m1163setStart0680j_4(this.start);
        node.m1164setTop0680j_4(this.top);
        node.m1162setEnd0680j_4(this.end);
        node.m1161setBottom0680j_4(this.bottom);
        node.setRtlAware(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m8836hashCodeimpl(this.start) * 31) + Dp.m8836hashCodeimpl(this.top)) * 31) + Dp.m8836hashCodeimpl(this.end)) * 31) + Dp.m8836hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        PaddingElement paddingElement = other instanceof PaddingElement ? (PaddingElement) other : null;
        return paddingElement != null && Dp.m8835equalsimpl0(this.start, paddingElement.start) && Dp.m8835equalsimpl0(this.top, paddingElement.top) && Dp.m8835equalsimpl0(this.end, paddingElement.end) && Dp.m8835equalsimpl0(this.bottom, paddingElement.bottom) && this.rtlAware == paddingElement.rtlAware;
    }
    ...
    public /* synthetic */ PaddingElement(float f2, float f3, float f4, float f5, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m8830constructorimpl(0) : f2, (i & 2) != 0 ? Dp.m8830constructorimpl(0) : f3, (i & 4) != 0 ? Dp.m8830constructorimpl(0) : f4, (i & 8) != 0 ? Dp.m8830constructorimpl(0) : f5, z, function1, null);
    }
}
