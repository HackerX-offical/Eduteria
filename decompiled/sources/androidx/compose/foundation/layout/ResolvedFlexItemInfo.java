...
public final class ResolvedFlexItemInfo implements FlexConfigScope {
    ...
    public ResolvedFlexItemInfo() {
        ...
        this.alignSelf = FlexAlignSelf.m899constructorimpl(0);
        this.shrink = 1.0f;
        this.basis = FlexBasis.INSTANCE.m924getAutodlZNVs();
    ...
    public void mo945alignSelfaKVMlHY(int value) {
    ...
    public void alignSelf(AlignmentLine alignmentLine) {
        FlexAlignSelf.Companion companion = FlexAlignSelf.INSTANCE;
        this.alignSelf = FlexAlignSelf.m899constructorimpl(5);
    ...
    public void alignSelf(final Function1<? super Measured, Integer> alignmentLineBlock) {
        ...
        this.baselineAlignmentBlock = new AlignmentLineProviderBlock() { // from class: androidx.compose.foundation.layout.ResolvedFlexItemInfo$$ExternalSyntheticLambda0
            ...
            public final int calculateAlignmentLinePosition(Measured measured) {
                return ResolvedFlexItemInfo.alignSelf$lambda$0(alignmentLineBlock, measured);
            }
        };
    }
    ...
    public void mo947basisMFoeH6Y(long value) {
        this.basis = value;
    }
    ...
    public final void m1196setAlignSelfaKVMlHY$foundation_layout(int i) {
        this.alignSelf = i;
    }
    ...
    public final void setGrow$foundation_layout(float f2) {
        this.grow = f2;
    }
    ...
    public final void setShrink$foundation_layout(float f2) {
        this.shrink = f2;
    }
    ...
    public final void m1197setBasisMFoeH6Y$foundation_layout(long j) {
        this.basis = j;
    }

    @Override // androidx.compose.foundation.layout.FlexConfigScope
    /* JADX INFO: renamed from: basis-0680j_4 */
    public void mo946basis0680j_4(float value) {
        this.basis = FlexBasis.INSTANCE.m922DpcHuBJEI(value);
    }

    @Override // androidx.compose.foundation.layout.FlexConfigScope
    public void basis(float value) {
        this.basis = FlexBasis.INSTANCE.m923Percentuoj9tHE(value);
    }
    ...
    public final int getBaseline(Placeable placeable, ResolvedFlexBoxConfig fallback) {
        ...
        FlexAlignSelf.Companion companion = FlexAlignSelf.INSTANCE;
        if (FlexAlignSelf.m901equalsimpl0(i2, FlexAlignSelf.m899constructorimpl(5))) {
        ...
        if (FlexAlignItems.m889equalsimpl0(alignItems, FlexAlignItems.m887constructorimpl(4))) {
            int i3 = this.alignSelf;
            FlexAlignSelf.Companion companion3 = FlexAlignSelf.INSTANCE;
            if (FlexAlignSelf.m901equalsimpl0(i3, FlexAlignSelf.m899constructorimpl(0))) {
                return fallback.getBaseline$foundation_layout(placeable);
            }
        }
    ...
    public final boolean getHasBaseline() {
        ...
        FlexAlignSelf.Companion companion = FlexAlignSelf.INSTANCE;
        return FlexAlignSelf.m901equalsimpl0(i, FlexAlignSelf.m899constructorimpl(5));
    }

    /* JADX INFO: renamed from: prepare-RMq0m1M, reason: not valid java name */
    public final void m1195prepareRMq0m1M(Density density, long constraints) {
        this._density = density;
        this.flexBoxMainAxisMax = Constraints.m8783getMaxWidthimpl(constraints);
        this.flexBoxMainAxisMin = Constraints.m8785getMinWidthimpl(constraints);
        this.flexBoxCrossAxisMax = Constraints.m8782getMaxHeightimpl(constraints);
        this.flexBoxCrossAxisMin = Constraints.m8784getMinHeightimpl(constraints);
    }
    ...
    public final int getMinMainAxisSize$foundation_layout(boolean isHorizontal) {
        if (this._minMainAxisSize == -1) {
            ...
            if (isHorizontal) {
                ...
                if (measurable2 != null) {
                    iMinIntrinsicHeight = measurable2.minIntrinsicHeight(Integer.MAX_VALUE);
                }
            }
    ...
    public final int getMaxContentSize$foundation_layout(boolean isHorizontal) {
        if (this._maxContentSize == -1) {
            ...
            if (isHorizontal) {
                ...
                Measurable measurable2 = this.measurable;
                if (measurable2 != null) {
                    iMaxIntrinsicHeight = measurable2.maxIntrinsicHeight(Integer.MAX_VALUE);
                }
            }
