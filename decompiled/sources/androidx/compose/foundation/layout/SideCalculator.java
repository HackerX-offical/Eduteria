...
interface SideCalculator {
    ...
    long mo1202consumedOffsetsMKHz9U(long available);

    /* JADX INFO: renamed from: consumedVelocity-QWom1Mo, reason: not valid java name */
    long mo1203consumedVelocityQWom1Mo(long available, float remaining);
    ...
    public static final class Companion {
        ...
        private static final SideCalculator$Companion$LeftSideCalculator$1 LeftSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$LeftSideCalculator$1
            ...
            public long mo1203consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(Velocity.m9068getXimpl(available) - remaining, 0.0f);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* JADX INFO: renamed from: consumedOffsets-MK-Hz9U */
            public long mo1202consumedOffsetsMKHz9U(long available) {
                return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (available >> 32)))) << 32) | (((long) Float.floatToRawIntBits(0.0f)) & 4294967295L));
            }
        };
        private static final SideCalculator$Companion$TopSideCalculator$1 TopSideCalculator = new SideCalculator() { // from class: androidx.compose.foundation.layout.SideCalculator$Companion$TopSideCalculator$1
            ...
            /* JADX INFO: renamed from: consumedVelocity-QWom1Mo */
            public long mo1203consumedVelocityQWom1Mo(long available, float remaining) {
                return VelocityKt.Velocity(0.0f, Velocity.m9069getYimpl(available) - remaining);
            }

            @Override // androidx.compose.foundation.layout.SideCalculator
            /* JADX INFO: renamed from: consumedOffsets-MK-Hz9U */
            public long mo1202consumedOffsetsMKHz9U(long available) {
                return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (available & 4294967295L)))) & 4294967295L) | (Float.floatToRawIntBits(0.0f) << 32));
            }
        };
        ...
        public final SideCalculator m1204chooseCalculatorni1skBw(int side, LayoutDirection layoutDirection) {
            if (WindowInsetsSides.m1263equalsimpl0(side, WindowInsetsSides.INSTANCE.m1277getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m1263equalsimpl0(side, WindowInsetsSides.INSTANCE.m1280getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m1263equalsimpl0(side, WindowInsetsSides.INSTANCE.m1278getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m1263equalsimpl0(side, WindowInsetsSides.INSTANCE.m1274getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m1263equalsimpl0(side, WindowInsetsSides.INSTANCE.m1279getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m1263equalsimpl0(side, WindowInsetsSides.INSTANCE.m1275getEndJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return RightSideCalculator;
                }
                return LeftSideCalculator;
