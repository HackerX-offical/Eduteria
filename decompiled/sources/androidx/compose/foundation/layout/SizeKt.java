...
public final class SizeKt {
    ...
    public static final Modifier m1226width3ABfNKs(Modifier modifier, final float f2) {
    ...
    public static final Modifier m1207height3ABfNKs(Modifier modifier, final float f2) {
    ...
    public static final Modifier m1222size6HolHcs(Modifier modifier, long j) {
        return m1223sizeVpY3zN4(modifier, DpSize.m8928getWidthD9Ej5fM(j), DpSize.m8926getHeightD9Ej5fM(j));
    }

    /* JADX INFO: renamed from: widthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m1228widthInVpY3zN4$default(Modifier modifier, float f2, float f3, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1227widthInVpY3zN4(modifier, f2, f3);
    }

    /* JADX INFO: renamed from: widthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m1227widthInVpY3zN4(Modifier modifier, final float f2, final float f3) {
        return modifier.then(new SizeElement(f2, 0.0f, f3, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("min", Dp.m8828boximpl(f2));
                inspectorInfo.getProperties().set(Constants.PRIORITY_MAX, Dp.m8828boximpl(f3));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }

    /* JADX INFO: renamed from: heightIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m1209heightInVpY3zN4$default(Modifier modifier, float f2, float f3, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = Dp.INSTANCE.m8850getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m1208heightInVpY3zN4(modifier, f2, f3);
    }

    /* JADX INFO: renamed from: heightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m1208heightInVpY3zN4(Modifier modifier, final float f2, final float f3) {
    ...
    public static /* synthetic */ Modifier m1225sizeInqDBjuR0$default(Modifier modifier, float f2, float f3, float f4, float f5, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = Dp.INSTANCE.m8850getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        if ((i & 4) != 0) {
            f4 = Dp.INSTANCE.m8850getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f5 = Dp.INSTANCE.m8850getUnspecifiedD9Ej5fM();
        }
        return m1224sizeInqDBjuR0(modifier, f2, f3, f4, f5);
    }

    /* JADX INFO: renamed from: sizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m1224sizeInqDBjuR0(Modifier modifier, final float f2, final float f3, final float f4, final float f5) {
        return modifier.then(new SizeElement(f2, f3, f4, f5, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.getProperties().set("minWidth", Dp.m8828boximpl(f2));
                inspectorInfo.getProperties().set("minHeight", Dp.m8828boximpl(f3));
                inspectorInfo.getProperties().set("maxWidth", Dp.m8828boximpl(f4));
                inspectorInfo.getProperties().set("maxHeight", Dp.m8828boximpl(f5));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* JADX INFO: renamed from: requiredWidth-3ABfNKs, reason: not valid java name */
    public static final Modifier m1218requiredWidth3ABfNKs(Modifier modifier, final float f2) {
    ...
    public static final Modifier m1210requiredHeight3ABfNKs(Modifier modifier, final float f2) {
    ...
    public static final Modifier m1214requiredSize6HolHcs(Modifier modifier, long j) {
        return m1215requiredSizeVpY3zN4(modifier, DpSize.m8928getWidthD9Ej5fM(j), DpSize.m8926getHeightD9Ej5fM(j));
    }

    /* JADX INFO: renamed from: requiredWidthIn-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m1220requiredWidthInVpY3zN4$default(Modifier modifier, float f2, float f3, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = Dp.INSTANCE.m8850getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m1219requiredWidthInVpY3zN4(modifier, f2, f3);
    }

    /* JADX INFO: renamed from: requiredWidthIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m1219requiredWidthInVpY3zN4(Modifier modifier, final float f2, final float f3) {
    ...
    public static /* synthetic */ Modifier m1212requiredHeightInVpY3zN4$default(Modifier modifier, float f2, float f3, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = Dp.INSTANCE.m8850getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m1211requiredHeightInVpY3zN4(modifier, f2, f3);
    }

    /* JADX INFO: renamed from: requiredHeightIn-VpY3zN4, reason: not valid java name */
    public static final Modifier m1211requiredHeightInVpY3zN4(Modifier modifier, final float f2, final float f3) {
    ...
    public static /* synthetic */ Modifier m1217requiredSizeInqDBjuR0$default(Modifier modifier, float f2, float f3, float f4, float f5, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = Dp.INSTANCE.m8850getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m1216requiredSizeInqDBjuR0(modifier, f2, f3, f4, f5);
    }

    /* JADX INFO: renamed from: requiredSizeIn-qDBjuR0, reason: not valid java name */
    public static final Modifier m1216requiredSizeInqDBjuR0(Modifier modifier, final float f2, final float f3, final float f4, final float f5) {
    ...
    public static /* synthetic */ Modifier m1206defaultMinSizeVpY3zN4$default(Modifier modifier, float f2, float f3, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = Dp.INSTANCE.m8850getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
        ...
        return m1205defaultMinSizeVpY3zN4(modifier, f2, f3);
    }

    /* JADX INFO: renamed from: defaultMinSize-VpY3zN4, reason: not valid java name */
    public static final Modifier m1205defaultMinSizeVpY3zN4(Modifier modifier, float f2, float f3) {
    ...
    public static final Modifier m1221size3ABfNKs(Modifier modifier, final float f2) {
    ...
    public static final Modifier m1223sizeVpY3zN4(Modifier modifier, final float f2, final float f3) {
        return modifier.then(new SizeElement(f2, f3, f2, f3, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                inspectorInfo.setName("size");
                inspectorInfo.getProperties().set(ViewHierarchyConstants.DIMENSION_WIDTH_KEY, Dp.m8828boximpl(f2));
                inspectorInfo.getProperties().set(ViewHierarchyConstants.DIMENSION_HEIGHT_KEY, Dp.m8828boximpl(f3));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }

    /* JADX INFO: renamed from: requiredSize-3ABfNKs, reason: not valid java name */
    public static final Modifier m1213requiredSize3ABfNKs(Modifier modifier, final float f2) {
    ...
    public static final Modifier m1215requiredSizeVpY3zN4(Modifier modifier, final float f2, final float f3) {
