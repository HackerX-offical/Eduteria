...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo44measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m8781getHasFixedWidthimpl(j) ? Constraints.m8783getMaxWidthimpl(j) : 0, Constraints.m8780getHasFixedHeightimpl(j) ? Constraints.m8782getMaxHeightimpl(j) : 0, null, new Function1() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$$ExternalSyntheticLambda0
