...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public /* synthetic */ UnspecifiedConstraintsElement(float f2, float f3, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        node.m1244setMinWidth0680j_4(this.minWidth);
        node.m1243setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set("minWidth", Dp.m8828boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m8828boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m8835equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m8835equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m8836hashCodeimpl(this.minWidth) * 31) + Dp.m8836hashCodeimpl(this.minHeight);
    }
}
