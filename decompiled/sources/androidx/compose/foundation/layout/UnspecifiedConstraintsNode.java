...
final class UnspecifiedConstraintsNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ UnspecifiedConstraintsNode(float f2, float f3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.INSTANCE.m8850getUnspecifiedD9Ej5fM() : f2, (i & 2) != 0 ? Dp.INSTANCE.m8850getUnspecifiedD9Ej5fM() : f3, null);
    }
    ...
    public final void m1244setMinWidth0680j_4(float f2) {
        this.minWidth = f2;
    }
    ...
    public final void m1243setMinHeight0680j_4(float f2) {
        this.minHeight = f2;
    }
    ...
    public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (!Float.isNaN(this.minWidth) && Constraints.m8785getMinWidthimpl(j) == 0) {
            int i = measureScope.mo482roundToPx0680j_4(this.minWidth);
            iM8785getMinWidthimpl = Constraints.m8783getMaxWidthimpl(j);
            if (i < 0) {
                i = 0;
            }
            if (i <= iM8785getMinWidthimpl) {
                iM8785getMinWidthimpl = i;
            }
        } else {
            iM8785getMinWidthimpl = Constraints.m8785getMinWidthimpl(j);
        }
        int iM8783getMaxWidthimpl = Constraints.m8783getMaxWidthimpl(j);
        if (!Float.isNaN(this.minHeight) && Constraints.m8784getMinHeightimpl(j) == 0) {
            int i2 = measureScope.mo482roundToPx0680j_4(this.minHeight);
            iM8784getMinHeightimpl = Constraints.m8782getMaxHeightimpl(j);
            int i3 = i2 >= 0 ? i2 : 0;
            if (i3 <= iM8784getMinHeightimpl) {
                iM8784getMinHeightimpl = i3;
            }
        } else {
            iM8784getMinHeightimpl = Constraints.m8784getMinHeightimpl(j);
        }
        final Placeable placeableMo7445measureBRTryo0 = measurable.mo7445measureBRTryo0(ConstraintsKt.Constraints(iM8785getMinWidthimpl, iM8783getMaxWidthimpl, iM8784getMinHeightimpl, Constraints.m8782getMaxHeightimpl(j)));
        return MeasureScope.layout$default(measureScope, placeableMo7445measureBRTryo0.getWidth(), placeableMo7445measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.layout.UnspecifiedConstraintsNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return UnspecifiedConstraintsNode.measure_3p2s80s$lambda$0(placeableMo7445measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        int i2 = !Float.isNaN(this.minWidth) ? intrinsicMeasureScope.mo482roundToPx0680j_4(this.minWidth) : 0;
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        int i2 = !Float.isNaN(this.minHeight) ? intrinsicMeasureScope.mo482roundToPx0680j_4(this.minHeight) : 0;
