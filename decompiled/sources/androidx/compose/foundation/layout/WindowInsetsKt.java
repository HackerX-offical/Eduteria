...
public final class WindowInsetsKt {
    ...
    public static final WindowInsets m1250onlybOOhFvg(WindowInsets windowInsets, int i) {
    ...
    public static final WindowInsets m1248WindowInsetsa9UjIt4(float f2, float f3, float f4, float f5) {
        return new FixedDpInsets(f2, f3, f4, f5, null);
    }

    /* JADX INFO: renamed from: WindowInsets-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ WindowInsets m1249WindowInsetsa9UjIt4$default(float f2, float f3, float f4, float f5, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1248WindowInsetsa9UjIt4(f2, f3, f4, f5);
    }
}
