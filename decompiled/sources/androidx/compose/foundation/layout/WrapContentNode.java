...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo72measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo7445measureBRTryo0 = measurable.mo7445measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m8785getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m8783getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m8784getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m8782getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo7445measureBRTryo0.getWidth(), Constraints.m8785getMinWidthimpl(j), Constraints.m8783getMaxWidthimpl(j));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo7445measureBRTryo0.getHeight(), Constraints.m8784getMinHeightimpl(j), Constraints.m8782getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, iCoerceIn, iCoerceIn2, null, new Function1() { // from class: androidx.compose.foundation.layout.WrapContentNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return WrapContentNode.measure_3p2s80s$lambda$0(this.f$0, iCoerceIn, placeableMo7445measureBRTryo0, iCoerceIn2, measureScope, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measure_3p2s80s$lambda$0(WrapContentNode wrapContentNode, int i, Placeable placeable, int i2, MeasureScope measureScope, Placeable.PlacementScope placementScope) {
        Placeable.PlacementScope.m7511place70tqf50$default(placementScope, placeable, wrapContentNode.alignmentCallback.invoke(IntSize.m8993boximpl(IntSize.m8996constructorimpl((((long) (i - placeable.getWidth())) << 32) | (((long) (i2 - placeable.getHeight())) & 4294967295L))), measureScope.getLayoutDirection()).m8967unboximpl(), 0.0f, 2, null);
