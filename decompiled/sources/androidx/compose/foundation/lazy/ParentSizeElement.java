...
final class ParentSizeElement extends ModifierNodeElement<ParentSizeNode> {
    ...
    public /* synthetic */ ParentSizeElement(float f2, State state, State state2, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(f2, (i & 2) != 0 ? null : state, (i & 4) != 0 ? null : state2, str);
    }
