...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ ParentSizeNode(float f2, State state, State state2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(f2, (i & 2) != 0 ? null : state, (i & 4) != 0 ? null : state2);
    }
    ...
    public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        int iM8785getMinWidthimpl = iRound != Integer.MAX_VALUE ? iRound : Constraints.m8785getMinWidthimpl(j);
        int iM8784getMinHeightimpl = iRound2 != Integer.MAX_VALUE ? iRound2 : Constraints.m8784getMinHeightimpl(j);
        if (iRound == Integer.MAX_VALUE) {
            iRound = Constraints.m8783getMaxWidthimpl(j);
        }
        if (iRound2 == Integer.MAX_VALUE) {
            iRound2 = Constraints.m8782getMaxHeightimpl(j);
        }
        final Placeable placeableMo7445measureBRTryo0 = measurable.mo7445measureBRTryo0(ConstraintsKt.Constraints(iM8785getMinWidthimpl, iRound, iM8784getMinHeightimpl, iRound2));
        return MeasureScope.layout$default(measureScope, placeableMo7445measureBRTryo0.getWidth(), placeableMo7445measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return ParentSizeNode.measure_3p2s80s$lambda$2(placeableMo7445measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
