...
final class LazyGridKt$rememberLazyGridMeasurePolicy$1$1 implements LazyLayoutMeasurePolicy {
    ...
    public final MeasureResult mo1289measure0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
        ...
        ObservableScopeInvalidator.m1393attachToScopeimpl(this.$state.m1343getMeasurementScopeInvalidatorzYiylxw$foundation());
        boolean z = this.$state.getHasLookaheadOccurred() || lazyLayoutMeasureScope.isLookingAhead();
        CheckScrollableContainerConstraintsKt.m349checkScrollableContainerConstraintsK40F9xA(j, this.$isVertical ? Orientation.Vertical : Orientation.Horizontal);
        if (this.$isVertical) {
        ...
        int i4 = lazyLayoutMeasureScope.mo482roundToPx0680j_4(this.$contentPadding.getTop());
        int i5 = lazyLayoutMeasureScope.mo482roundToPx0680j_4(this.$contentPadding.getBottom());
        final int i6 = i4 + i5;
        final int i7 = i + i2;
        ...
        final int i9 = i8 - i3;
        long jM8802offsetNN6EwU = ConstraintsKt.m8802offsetNN6EwU(j, -i7, -i6);
        LazyGridItemProvider lazyGridItemProviderInvoke = this.$itemProviderLambda.invoke();
        final LazyGridSpanLayoutProvider spanLayoutProvider = lazyGridItemProviderInvoke.getSpanLayoutProvider();
        LazyLayoutMeasureScope lazyLayoutMeasureScope2 = lazyLayoutMeasureScope;
        final LazyGridSlots lazyGridSlotsMo1318invoke0kLqBqw = this.$slots.mo1318invoke0kLqBqw(lazyLayoutMeasureScope2, jM8802offsetNN6EwU);
        int length = lazyGridSlotsMo1318invoke0kLqBqw.getSizes().length;
        ...
        final int i10 = lazyLayoutMeasureScope.mo482roundToPx0680j_4(spacing);
        final int itemCount = lazyGridItemProviderInvoke.getItemCount();
        if (this.$isVertical) {
            iM8783getMaxWidthimpl = Constraints.m8782getMaxHeightimpl(j) - i6;
        } else {
            iM8783getMaxWidthimpl = Constraints.m8783getMaxWidthimpl(j) - i7;
        }
        int i11 = iM8783getMaxWidthimpl;
        if (this.$reverseLayout && i11 <= 0) {
            ...
            lazyGridItemProvider = lazyGridItemProviderInvoke;
            jM8952constructorimpl = IntOffset.m8952constructorimpl((((long) i) << 32) | (((long) i4) & 4294967295L));
        } else {
            lazyGridItemProvider = lazyGridItemProviderInvoke;
            jM8952constructorimpl = IntOffset.m8952constructorimpl((((long) i) << 32) | (((long) i4) & 4294967295L));
        }
        ...
        final int i12 = i3;
        final long j2 = jM8952constructorimpl;
        ...
        final ?? r27 = new LazyGridMeasuredItemProvider(lazyGridItemProvider2, lazyLayoutMeasureScope, i10, lazyGridState, z4, z5, i12, i9, j2) { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredItemProvider$1
            ...
            public LazyGridMeasuredItem mo1333createItemO3s9Psw(int index, Object key, Object contentType, int crossAxisSize, int mainAxisSpacing, List<? extends Placeable> placeables, long constraints, int lane, int span) {
        ...
        final ?? r22 = new LazyGridMeasuredLineProvider(z6, lazyGridSlotsMo1318invoke0kLqBqw, itemCount, i10, r27, spanLayoutProvider) { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1
            final /* synthetic */ boolean $isVertical;
            final /* synthetic */ LazyGridSlots $resolvedSlots;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(z6, lazyGridSlotsMo1318invoke0kLqBqw, itemCount, i10, r27, spanLayoutProvider);
                this.$isVertical = z6;
                this.$resolvedSlots = lazyGridSlotsMo1318invoke0kLqBqw;
            }
        ...
        Function1 function1 = new Function1() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return LazyGridKt$rememberLazyGridMeasurePolicy$1$1.measure_0kLqBqw$lambda$2(spanLayoutProvider, r22, ((Integer) obj).intValue());
            }
        };
        ...
        try {
            int iUpdateScrollPositionIfTheFirstItemWasMoved$foundation = lazyGridState2.updateScrollPositionIfTheFirstItemWasMoved$foundation(lazyGridItemProvider2, lazyGridState2.getFirstVisibleItemIndex());
            ...
            List<Integer> listCalculateLazyLayoutPinnedIndices = LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyGridItemProvider2, this.$state.getPinnedItems(), this.$state.getBeyondBoundsInfo());
            ...
            LazyGridMeasureResult lazyGridMeasureResultM1337measureLazyGridt1x4au0 = LazyGridMeasureKt.m1337measureLazyGridt1x4au0(itemCount, lazyGridMeasuredLineProvider, (LazyGridMeasuredItemProvider) r27, i11, i12, i9, i10, lineIndexOfItem, firstVisibleItemScrollOffset, scrollToBeConsumed, jM8802offsetNN6EwU, this.$isVertical, this.$verticalArrangement, this.$horizontalArrangement, this.$reverseLayout, lazyLayoutMeasureScope2, this.$state.getItemAnimator$foundation(), length, listCalculateLazyLayoutPinnedIndices, z, lazyLayoutMeasureScope.isLookingAhead(), this.$state.getApproachLayoutInfo(), this.$coroutineScope, this.$state.m1344getPlacementScopeInvalidatorzYiylxw$foundation(), this.$graphicsContext, function1, function12, this.$stickyItemsScrollBehavior, new Function3() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$$ExternalSyntheticLambda2
            ...
            LazyGridState.applyMeasureResult$foundation$default(this.$state, lazyGridMeasureResultM1337measureLazyGridt1x4au0, lazyLayoutMeasureScope.isLookingAhead(), false, 4, null);
            ...
            if (cacheWindowLogic != null) {
                LazyGridKt.keepAroundItems(cacheWindowLogic, lazyGridMeasureResultM1337measureLazyGridt1x4au0.getOrientation(), lazyGridMeasureResultM1337measureLazyGridt1x4au0.getVisibleItemsInfo(), lazyGridMeasuredLineProvider);
            }
            return lazyGridMeasureResultM1337measureLazyGridt1x4au0;
        } catch (Throwable th) {
            companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
            throw th;
        }
    ...
    public static final ArrayList measure_0kLqBqw$lambda$2(LazyGridSpanLayoutProvider lazyGridSpanLayoutProvider, LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1 lazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1, int i) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            int iM1314getCurrentLineSpanimpl = GridItemSpan.m1314getCurrentLineSpanimpl(spans.get(i3).getPackedValue());
            arrayList.add(TuplesKt.to(Integer.valueOf(firstItemIndex), Constraints.m8770boximpl(lazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1.m1341childConstraintsJhjzzOo$foundation(i2, iM1314getCurrentLineSpanimpl))));
            firstItemIndex++;
            i2 += iM1314getCurrentLineSpanimpl;
        }
        return arrayList;
    }
