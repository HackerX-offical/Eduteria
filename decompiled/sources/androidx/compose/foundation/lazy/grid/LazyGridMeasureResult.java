...
public final class LazyGridMeasureResult implements LazyGridLayoutInfo, MeasureResult {
    ...
    public LazyGridMeasureResult(LazyGridMeasuredLine lazyGridMeasuredLine, int i, boolean z, float f2, MeasureResult measureResult, float f3, boolean z2, CoroutineScope coroutineScope, Density density, int i2, Function1<? super Integer, ? extends List<Pair<Integer, Constraints>>> function1, Function1<? super Integer, Integer> function12, List<LazyGridMeasuredItem> list, int i3, int i4, int i5, boolean z3, Orientation orientation, int i6, int i7) {
    ...
    public long mo1334getViewportSizeYbymL2g() {
        return IntSize.m8996constructorimpl((((long) get$h()) & 4294967295L) | (((long) get$w()) << 32));
    }
