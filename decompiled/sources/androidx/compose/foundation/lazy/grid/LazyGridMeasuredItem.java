...
public final class LazyGridMeasuredItem implements LazyGridItemInfo, LazyLayoutMeasuredItem {
    ...
    private LazyGridMeasuredItem(int i, Object obj, boolean z, int i2, int i3, boolean z2, LayoutDirection layoutDirection, int i4, int i5, List<? extends Placeable> list, long j, Object obj2, LazyLayoutItemAnimator<LazyGridMeasuredItem> lazyLayoutItemAnimator, long j2, int i6, int i7) {
        ...
        if (getIsVertical()) {
            jM8996constructorimpl = IntSize.m8996constructorimpl((((long) iMax) & 4294967295L) | (((long) this.crossAxisSize) << 32));
        } else {
            jM8996constructorimpl = IntSize.m8996constructorimpl((((long) this.crossAxisSize) & 4294967295L) | (((long) iMax) << 32));
        }
    ...
    public final void position(int mainAxisOffset, int crossAxisOffset, int layoutWidth, int layoutHeight, int row, int column) {
        ...
        if (getIsVertical()) {
            jM8952constructorimpl = IntOffset.m8952constructorimpl((((long) crossAxisOffset) << 32) | (4294967295L & ((long) mainAxisOffset)));
        } else {
            jM8952constructorimpl = IntOffset.m8952constructorimpl((((long) crossAxisOffset) & 4294967295L) | (((long) mainAxisOffset) << 32));
        }
        ...
        while (i < placeablesCount) {
            ...
            if (animation != null) {
                if (isLookingAhead) {
                    ...
                    if ((m1339getMainAxisgyyYBs(offset) <= mainAxisSize && m1339getMainAxisgyyYBs(jM8962plusqkQi6aY) <= mainAxisSize) || (m1339getMainAxisgyyYBs(offset) >= i2 && m1339getMainAxisgyyYBs(jM8962plusqkQi6aY) >= i2)) {
            ...
            if (this.reverseLayout) {
                int iM8958getXimpl = getIsVertical() ? IntOffset.m8958getXimpl(offset) : (this.mainAxisLayoutSize - IntOffset.m8958getXimpl(offset)) - getMainAxisSize(placeable);
                if (getIsVertical()) {
                    iM8959getYimpl = (this.mainAxisLayoutSize - IntOffset.m8959getYimpl(offset)) - getMainAxisSize(placeable);
                } else {
            ...
            long jM8962plusqkQi6aY2 = IntOffset.m8962plusqkQi6aY(offset, this.visualOffset);
    ...
    private final int m1339getMainAxisgyyYBs(long j) {
    ...
    private final long m1338copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
