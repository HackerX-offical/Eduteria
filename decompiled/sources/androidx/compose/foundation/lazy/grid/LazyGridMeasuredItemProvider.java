...
public abstract class LazyGridMeasuredItemProvider extends LazyLayoutMeasuredItemProvider<LazyGridMeasuredItem> {
    ...
    public abstract LazyGridMeasuredItem mo1333createItemO3s9Psw(int index, Object key, Object contentType, int crossAxisSize, int mainAxisSpacing, List<? extends Placeable> placeables, long constraints, int lane, int span);
    ...
    public LazyGridMeasuredItem mo1303getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m1340getAndMeasurem8Kt_7k(index, constraints, lane, span, this.defaultMainAxisSpacing);
    }

    /* JADX INFO: renamed from: getAndMeasure-m8Kt_7k, reason: not valid java name */
    public final LazyGridMeasuredItem m1340getAndMeasurem8Kt_7k(int index, long constraints, int lane, int span, int mainAxisSpacing) {
        ...
        List<Placeable> list = m1380getPlaceables3p2s80s(this.measureScope, index, constraints);
        if (Constraints.m8781getHasFixedWidthimpl(constraints)) {
            iM8784getMinHeightimpl = Constraints.m8785getMinWidthimpl(constraints);
        } else {
            if (!Constraints.m8780getHasFixedHeightimpl(constraints)) {
        ...
        return mo1333createItemO3s9Psw(index, key, contentType, iM8784getMinHeightimpl, mainAxisSpacing, list, constraints, lane, span);
    }
