...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m1341childConstraintsJhjzzOo$foundation(int startSlot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m8795fixedWidthOenEA2s(iCoerceAtLeast);
        }
        return Constraints.INSTANCE.m8794fixedHeightOenEA2s(iCoerceAtLeast);
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int lineIndex) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            int iM1314getCurrentLineSpanimpl = GridItemSpan.m1314getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i3).getPackedValue());
            LazyGridMeasuredItem lazyGridMeasuredItemM1340getAndMeasurem8Kt_7k = this.measuredItemProvider.m1340getAndMeasurem8Kt_7k(lineConfiguration.getFirstItemIndex() + i3, m1341childConstraintsJhjzzOo$foundation(i2, iM1314getCurrentLineSpanimpl), i2, iM1314getCurrentLineSpanimpl, i);
            i2 += iM1314getCurrentLineSpanimpl;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i3] = lazyGridMeasuredItemM1340getAndMeasurem8Kt_7k;
        }
