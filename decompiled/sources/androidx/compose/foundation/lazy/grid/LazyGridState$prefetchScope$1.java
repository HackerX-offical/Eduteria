...
public final class LazyGridState$prefetchScope$1 implements LazyGridPrefetchScope {
    ...
    public List<LazyLayoutPrefetchState.PrefetchHandle> scheduleLinePrefetch(final int lineIndex, final Function1<? super LazyGridPrefetchResultScope, Unit> onPrefetchFinished) {
        ...
        try {
            ...
            final LazyGridMeasureResult lazyGridMeasureResult = approachLayoutInfo;
            if (lazyGridMeasureResult != null) {
                final Ref.IntRef intRef = new Ref.IntRef();
                intRef.element = 1;
                final List<Pair<Integer, Constraints>> listInvoke = lazyGridMeasureResult.getPrefetchInfoRetriever().invoke(Integer.valueOf(lineIndex));
                int size = listInvoke.size();
                for (int i = 0; i < size; i++) {
                    Pair<Integer, Constraints> pair = listInvoke.get(i);
                    arrayList.add(lazyGridState.getPrefetchState().m1386schedulePrecompositionAndPremeasure_EkL_Y$foundation(pair.getFirst().intValue(), pair.getSecond().getValue(), lazyGridState.executeRequestsInHighPriorityMode, new Function1() { // from class: androidx.compose.foundation.lazy.grid.LazyGridState$prefetchScope$1$$ExternalSyntheticLambda0
                        @Override // kotlin.jvm.functions.Function1
                        public final Object invoke(Object obj) {
                            return LazyGridState$prefetchScope$1.scheduleLinePrefetch$lambda$0$0$0$0(arrayList2, intRef, listInvoke, onPrefetchFinished, lineIndex, lazyGridMeasureResult, (LazyLayoutPrefetchState.PrefetchResultScope) obj);
                        }
                    }));
                }
    ...
    public static final Unit scheduleLinePrefetch$lambda$0$0$0$0(List list, Ref.IntRef intRef, List list2, Function1 function1, int i, LazyGridMeasureResult lazyGridMeasureResult, LazyLayoutPrefetchState.PrefetchResultScope prefetchResultScope) {
        ...
        for (int i3 = 0; i3 < placeablesCount; i3++) {
            if (lazyGridMeasureResult.getOrientation() == Orientation.Vertical) {
                jMo1388getSizeYEO4UFw = prefetchResultScope.mo1388getSizeYEO4UFw(i3) & 4294967295L;
            } else {
                jMo1388getSizeYEO4UFw = prefetchResultScope.mo1388getSizeYEO4UFw(i3) >> 32;
            }
            i2 += (int) jMo1388getSizeYEO4UFw;
        }
        if (list != null) {
