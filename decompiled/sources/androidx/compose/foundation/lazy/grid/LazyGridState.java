...
public final class LazyGridState implements ScrollableState {
    ...
    @DebugMetadata(c = "androidx.compose.foundation.lazy.grid.LazyGridState", f = "LazyGridState.kt", i = {0, 0}, l = {496, 498}, m = "scroll", n = {"scrollPriority", BlockContactsIQ.ELEMENT}, s = {"L$0", "L$1"}, v = 1)
    ...
    public static final float scrollableState$lambda$0(LazyGridState lazyGridState, float f2) {
        return -lazyGridState.onScroll$foundation(-f2);
    }
    ...
    public final MutableState<Unit> m1344getPlacementScopeInvalidatorzYiylxw$foundation() {
    ...
    static final class C03452 extends SuspendLambda implements Function2<ScrollScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ int $index;
        final /* synthetic */ int $scrollOffset;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03452(int i, int i2, Continuation<? super C03452> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return LazyGridState.this.new C03452(this.$index, this.$scrollOffset, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(ScrollScope scrollScope, Continuation<? super Unit> continuation) {
            return ((C03452) create(scrollScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object scrollToItem(int i, int i2, Continuation<? super Unit> continuation) {
        Object objScroll$default = ScrollableState.scroll$default(this, null, new C03452(i, i2, null), continuation, 1, null);
        return objScroll$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objScroll$default : Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: getMeasurementScopeInvalidator-zYiylxw$foundation, reason: not valid java name */
    public final MutableState<Unit> m1343getMeasurementScopeInvalidatorzYiylxw$foundation() {
    ...
    */
    public java.lang.Object scroll(androidx.compose.foundation.MutatePriority r7, kotlin.jvm.functions.Function2<? super androidx.compose.foundation.gestures.ScrollScope, ? super kotlin.coroutines.Continuation<? super kotlin.Unit>, ? extends java.lang.Object> r8, kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        /*
            r6 = this;
            boolean r0 = r9 instanceof androidx.compose.foundation.lazy.grid.LazyGridState.C03441
            if (r0 == 0) goto L14
            r0 = r9
            androidx.compose.foundation.lazy.grid.LazyGridState$scroll$1 r0 = (androidx.compose.foundation.lazy.grid.LazyGridState.C03441) r0
            int r1 = r0.label
        ...
        L44:
            kotlin.ResultKt.throwOnFailure(r9)
            androidx.compose.runtime.MutableState<androidx.compose.foundation.lazy.grid.LazyGridMeasureResult> r9 = r6.layoutInfoState
            java.lang.Object r9 = r9.getValue()
            androidx.compose.foundation.lazy.grid.LazyGridMeasureResult r2 = androidx.compose.foundation.lazy.grid.LazyGridStateKt.access$getEmptyLazyGridLayoutInfo$p()
            if (r9 != r2) goto L62
    ...
    public final float onScroll$foundation(float distance) {
        ...
        if (Math.abs(f2) > 0.5f) {
            ...
            if (lazyGridMeasureResultCopyWithScrollDeltaWithoutRemeasure != null) {
                ...
                notifyPrefetchOnScroll(f3 - this.scrollToBeConsumed, lazyGridMeasureResultCopyWithScrollDeltaWithoutRemeasure);
            } else {
                Remeasurement remeasurement = this.remeasurement;
                if (remeasurement != null) {
                    remeasurement.forceRemeasure();
