...
public final class LazyLayoutBeyondBoundsProviderModifierNode extends Modifier.Node implements LayoutModifierNode, BeyondBoundsLayoutProviderModifierNode, BeyondBoundsLayout {
    ...
    public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo7445measureBRTryo0.getWidth(), placeableMo7445measureBRTryo0.getHeight(), null, new Function1() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsProviderModifierNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return LazyLayoutBeyondBoundsProviderModifierNode.measure_3p2s80s$lambda$0(placeableMo7445measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public <T> T mo1355layouto7g1Pn8(final int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        ...
        if (m1353isForward4vf7U8o(direction)) {
        ...
        T tInvoke = null;
        int i = 0;
        while (tInvoke == null && m1352hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction) && i < iCoerceAtMost) {
            T t = (T) m1351addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
            ...
            tInvoke = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsProviderModifierNode$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    return this.this$0.m1352hasMoreContentFR3nfPY(objectRef.element, direction);
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
    ...
    private final boolean m1353isForward4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m7428equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m7434getBeforehoxUOeE())) {
            return false;
        }
        if (BeyondBoundsLayout.LayoutDirection.m7428equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m7433getAfterhoxUOeE())) {
            return true;
        }
        if (BeyondBoundsLayout.LayoutDirection.m7428equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m7432getAbovehoxUOeE())) {
            return this.reverseLayout;
        }
        if (BeyondBoundsLayout.LayoutDirection.m7428equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m7435getBelowhoxUOeE())) {
            return !this.reverseLayout;
        }
        if (BeyondBoundsLayout.LayoutDirection.m7428equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m7436getLefthoxUOeE())) {
        ...
        if (!BeyondBoundsLayout.LayoutDirection.m7428equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m7437getRighthoxUOeE())) {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m1351addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
    ...
    public final boolean m1352hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        if (m1354isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        return m1353isForward4vf7U8o(i) ? interval.getEnd() < this.state.getItemCount() - 1 : interval.getStart() > 0;
    }

    /* JADX INFO: renamed from: isOppositeToOrientation-4vf7U8o, reason: not valid java name */
    private final boolean m1354isOppositeToOrientation4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m7428equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m7432getAbovehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m7428equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m7435getBelowhoxUOeE())) {
            return this.orientation == Orientation.Horizontal;
        }
        if (BeyondBoundsLayout.LayoutDirection.m7428equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m7436getLefthoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m7428equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m7437getRighthoxUOeE())) {
            return this.orientation == Orientation.Vertical;
        }
        if (BeyondBoundsLayout.LayoutDirection.m7428equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m7434getBeforehoxUOeE()) || BeyondBoundsLayout.LayoutDirection.m7428equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m7433getAfterhoxUOeE())) {
            return false;
        }
        LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
        throw new KotlinNothingValueException();
