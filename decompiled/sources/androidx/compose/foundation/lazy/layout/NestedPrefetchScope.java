...
public interface NestedPrefetchScope {
    ...
    void mo1387schedulePrecompositionAndPremeasure0kLqBqw(int index, long constraints);
    ...
    default void m1392schedulePrefetch0kLqBqw(int index, long constraints) {
        mo1387schedulePrecompositionAndPremeasure0kLqBqw(index, constraints);
    }
}
