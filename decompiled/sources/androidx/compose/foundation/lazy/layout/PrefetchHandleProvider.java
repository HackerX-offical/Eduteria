...
public final class PrefetchHandleProvider {
    ...
    public final LazyLayoutPrefetchState.PrefetchHandle m1404schedulePremeasurem8Kt_7k(int index, long constraints, PrefetchMetrics prefetchMetrics, boolean isHighPriority, Function1<? super LazyLayoutPrefetchState.PrefetchResultScope, Unit> onItemPremeasured) {
        PrefetchScheduler prefetchScheduler = this.executor;
    ...
    public final PrefetchRequest m1403createNestedPrefetchRequestVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
        PrefetchScheduler prefetchScheduler = this.executor;
    ...
    final class HandleAndRequestImpl implements LazyLayoutPrefetchState.PrefetchHandle, PrefetchRequest, LazyLayoutPrefetchState.PrefetchResultScope {
        ...
        public HandleAndRequestImpl(int i, PrefetchMetrics prefetchMetrics, PriorityPrefetchScheduler priorityPrefetchScheduler, Function1<? super LazyLayoutPrefetchState.PrefetchResultScope, Unit> function1) {
            ...
            this.startTime = TimeSource.Monotonic.INSTANCE.m13853markNowz9LOYto();
        }
        ...
        private HandleAndRequestImpl(PrefetchHandleProvider prefetchHandleProvider, int i, long j, PrefetchMetrics prefetchMetrics, PriorityPrefetchScheduler priorityPrefetchScheduler, Function1<? super LazyLayoutPrefetchState.PrefetchResultScope, Unit> function1) {
            ...
            this.premeasureConstraints = Constraints.m8770boximpl(j);
        }
        ...
        public long mo1388getSizeYEO4UFw(int placeableIndex) {
            SubcomposeLayoutState.PrecomposedSlotHandle precomposedSlotHandle = this.precomposeHandle;
            return precomposedSlotHandle != null ? precomposedSlotHandle.mo7472getSizeYEO4UFw(placeableIndex) : IntSize.INSTANCE.m9006getZeroYbymL2g();
        }
        ...
        private final void updateElapsedAndAvailableTime() {
            long jM13853markNowz9LOYto = TimeSource.Monotonic.INSTANCE.m13853markNowz9LOYto();
            long jM13753getInWholeNanosecondsimpl = Duration.m13753getInWholeNanosecondsimpl(TimeSource.Monotonic.ValueTimeMark.m13864minus6eNON_k(jM13853markNowz9LOYto, this.startTime));
            this.elapsedTimeNanos = jM13753getInWholeNanosecondsimpl;
            long j = this.availableTimeNanos - jM13753getInWholeNanosecondsimpl;
            this.availableTimeNanos = j;
            this.startTime = jM13853markNowz9LOYto;
            ...
            if (!this.isCanceled) {
                ...
                if (index >= 0 && index < itemCount) {
                    ...
                    if (!this.isMeasured && constraints != null) {
                        ...
                        try {
                            m1405performMeasureBRTryo0(constraints.getValue());
        ...
        private final void m1405performMeasureBRTryo0(long constraints) {
            if (this.isCanceled) {
            ...
            if (precomposedSlotHandle != null) {
                ...
                for (int i = 0; i < placeablesCount; i++) {
                    precomposedSlotHandle.mo7473premeasure0kLqBqw(i, constraints);
                }
                return;
            }
