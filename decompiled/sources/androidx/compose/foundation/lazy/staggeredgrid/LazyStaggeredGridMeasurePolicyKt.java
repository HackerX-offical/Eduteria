...
public final class LazyStaggeredGridMeasurePolicyKt {
    ...
    public static final LazyLayoutMeasurePolicy m1438rememberStaggeredGridMeasurePolicyqKj4JfE(final LazyStaggeredGridState lazyStaggeredGridState, final Function0<? extends LazyStaggeredGridItemProvider> function0, final PaddingValues paddingValues, final boolean z, final Orientation orientation, final float f2, float f3, final CoroutineScope coroutineScope, final LazyGridStaggeredGridSlotsProvider lazyGridStaggeredGridSlotsProvider, final GraphicsContext graphicsContext, Composer composer, int i) {
        ...
        if (zChanged || lazyLayoutMeasurePolicyRememberedValue == Composer.INSTANCE.getEmpty()) {
            lazyLayoutMeasurePolicyRememberedValue = new LazyLayoutMeasurePolicy() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public final MeasureResult mo1289measure0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                    long jM8952constructorimpl;
                    ObservableScopeInvalidator.m1393attachToScopeimpl(lazyStaggeredGridState.m1444getMeasurementScopeInvalidatorzYiylxw$foundation());
                    boolean z2 = lazyStaggeredGridState.getHasLookaheadOccurred() || lazyLayoutMeasureScope.isLookingAhead();
                    CheckScrollableContainerConstraintsKt.m349checkScrollableContainerConstraintsK40F9xA(j, orientation);
                    LazyStaggeredGridSlots lazyStaggeredGridSlotsMo1413invoke0kLqBqw = lazyGridStaggeredGridSlotsProvider.mo1413invoke0kLqBqw(lazyLayoutMeasureScope, j);
                    ...
                    int i2 = lazyLayoutMeasureScope.mo482roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.beforePadding(paddingValues, orientation, z, lazyLayoutMeasureScope.getLayoutDirection()));
                    int i3 = lazyLayoutMeasureScope.mo482roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.afterPadding(paddingValues, orientation, z, lazyLayoutMeasureScope.getLayoutDirection()));
                    int i4 = lazyLayoutMeasureScope.mo482roundToPx0680j_4(LazyStaggeredGridMeasurePolicyKt.startPadding(paddingValues, orientation, lazyLayoutMeasureScope.getLayoutDirection()));
                    int iM8782getMaxHeightimpl = ((z3 ? Constraints.m8782getMaxHeightimpl(j) : Constraints.m8783getMaxWidthimpl(j)) - i2) - i3;
                    if (z3) {
                        jM8952constructorimpl = IntOffset.m8952constructorimpl((((long) i2) & 4294967295L) | (((long) i4) << 32));
                    } else {
                        jM8952constructorimpl = IntOffset.m8952constructorimpl((((long) i2) << 32) | (((long) i4) & 4294967295L));
                    }
                    long j2 = jM8952constructorimpl;
                    PaddingValues paddingValues2 = paddingValues;
                    int i5 = lazyLayoutMeasureScope.mo482roundToPx0680j_4(Dp.m8830constructorimpl(PaddingKt.calculateStartPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection()) + PaddingKt.calculateEndPadding(paddingValues2, lazyLayoutMeasureScope.getLayoutDirection())));
                    PaddingValues paddingValues3 = paddingValues;
                    int i6 = lazyLayoutMeasureScope.mo482roundToPx0680j_4(Dp.m8830constructorimpl(paddingValues3.getTop() + paddingValues3.getBottom()));
                    LazyStaggeredGridMeasureResult lazyStaggeredGridMeasureResultM1437measureStaggeredGridC6celF4 = LazyStaggeredGridMeasureKt.m1437measureStaggeredGridC6celF4(lazyLayoutMeasureScope, lazyStaggeredGridState, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyStaggeredGridItemProviderInvoke, lazyStaggeredGridState.getPinnedItems(), lazyStaggeredGridState.getBeyondBoundsInfo()), lazyStaggeredGridItemProviderInvoke, lazyStaggeredGridSlotsMo1413invoke0kLqBqw, Constraints.m8773copyZbe2FdA$default(j, ConstraintsKt.m8800constrainWidthK40F9xA(j, i5), 0, ConstraintsKt.m8799constrainHeightK40F9xA(j, i6), 0, 10, null), z3, z, j2, iM8782getMaxHeightimpl, lazyLayoutMeasureScope.mo482roundToPx0680j_4(f2), i2, i3, coroutineScope, z2, lazyLayoutMeasureScope.isLookingAhead(), lazyStaggeredGridState.getApproachLayoutInfo(), graphicsContext);
                    LazyStaggeredGridState.applyMeasureResult$foundation$default(lazyStaggeredGridState, lazyStaggeredGridMeasureResultM1437measureStaggeredGridC6celF4, lazyLayoutMeasureScope.isLookingAhead(), false, 4, null);
                    return lazyStaggeredGridMeasureResultM1437measureStaggeredGridC6celF4;
                }
            };
