...
public abstract class LazyStaggeredGridMeasureProvider extends LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem mo1433createItempitSLOA(int index, int lane, int span, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private final long m1439childConstraintsJhjzzOo(int slot, int span) {
        int i;
        if (span == 1) {
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m8795fixedWidthOenEA2s(i);
        }
        return Constraints.INSTANCE.m8794fixedHeightOenEA2s(i);
    }

    /* JADX INFO: renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m1440getAndMeasurejy6DScQ(int index, long span) {
        ...
        long jM1439childConstraintsJhjzzOo = m1439childConstraintsJhjzzOo(iCoerceAtMost, iCoerceAtMost2);
        return mo1433createItempitSLOA(index, iCoerceAtMost, iCoerceAtMost2, key, contentType, m1380getPlaceables3p2s80s(this.measureScope, index, jM1439childConstraintsJhjzzOo), jM1439childConstraintsJhjzzOo);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* JADX INFO: renamed from: getAndMeasure--hBUhpc */
    public LazyStaggeredGridMeasuredItem mo1303getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return mo1433createItempitSLOA(index, lane, span, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), m1380getPlaceables3p2s80s(this.measureScope, index, constraints), constraints);
    }
