...
public final class PagerLazyLayoutItemProvider implements LazyLayoutItemProvider {
    ...
    public void Item(final int i, Object obj, Composer composer, final int i2) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(Item)N(index,key)220@9657L155,220@9603L209:LazyLayoutPager.kt#g6yjnt");
        if ((i2 & 6) == 0) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i3 & 147) != 146, i3 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1201380429, i3, -1, "androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item (LazyLayoutPager.kt:219)");
            }
            i4 = i;
            obj2 = obj;
            LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(obj2, i4, this.state.getPinnedPages(), ComposableLambdaKt.rememberComposableLambda(1142237095, true, new Function2() { // from class: androidx.compose.foundation.pager.PagerLazyLayoutItemProvider$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj3, Object obj4) {
                    return PagerLazyLayoutItemProvider.Item$lambda$0(this.f$0, i, (Composer) obj3, ((Integer) obj4).intValue());
                }
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.foundation.pager.PagerLazyLayoutItemProvider$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj3, Object obj4) {
                    return PagerLazyLayoutItemProvider.Item$lambda$1(this.f$0, i4, obj2, i2, (Composer) obj3, ((Integer) obj4).intValue());
                }
            });
        }
    }
    ...
    public static final Unit Item$lambda$0(PagerLazyLayoutItemProvider pagerLazyLayoutItemProvider, int i, Composer composer, int i2) {
        ...
        if (!composer.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1142237095, i2, -1, "androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item.<anonymous> (LazyLayoutPager.kt:221)");
            }
            IntervalList.Interval interval = pagerLazyLayoutItemProvider.intervalContent.getIntervals().get(i);
            ((PagerIntervalContent) interval.getValue()).getItem().invoke(pagerLazyLayoutItemProvider.pagerScopeImpl, Integer.valueOf(i - interval.getStartIndex()), composer, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
