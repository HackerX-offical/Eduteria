...
public final class PagerScrollPosition {
    ...
    public PagerScrollPosition(int i, float f2, PagerState pagerState) {
        ...
        this.currentPageOffsetFraction = PrimitiveSnapshotStateKt.mutableFloatStateOf(f2);
        this.nearestRangeState = new LazyLayoutNearestRangeState(i, 30, 100);
    }

    public /* synthetic */ PagerScrollPosition(int i, float f2, PagerState pagerState, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 0 : i, (i2 & 2) != 0 ? 0.0f : f2, pagerState);
    }
    ...
    private final void setCurrentPageOffsetFraction(float f2) {
        this.currentPageOffsetFraction.setFloatValue(f2);
    }
