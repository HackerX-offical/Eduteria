...
public final class PagerSnapDistanceMaxPages implements PagerSnapDistance {
    ...
    public int calculateTargetPage(int startPage, int suggestedTargetPage, float velocity, int pageSize, int pageSpacing) {
        long j = startPage;
        return RangesKt.coerceIn(suggestedTargetPage, (int) RangesKt.coerceAtLeast(j - ((long) this.pagesLimit), 0L), (int) RangesKt.coerceAtMost(j + ((long) this.pagesLimit), SieveCacheKt.NodeLinkMask));
    }
