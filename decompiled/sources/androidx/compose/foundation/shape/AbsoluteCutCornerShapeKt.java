...
public final class AbsoluteCutCornerShapeKt {
    public static final AbsoluteCutCornerShape lerp(AbsoluteCutCornerShape absoluteCutCornerShape, AbsoluteCutCornerShape absoluteCutCornerShape2, float f2) {
        return new AbsoluteCutCornerShape(RoundedCornerShapeKt.lerp(absoluteCutCornerShape.getTopStart(), absoluteCutCornerShape2.getTopStart(), f2), RoundedCornerShapeKt.lerp(absoluteCutCornerShape.getTopEnd(), absoluteCutCornerShape2.getTopEnd(), f2), RoundedCornerShapeKt.lerp(absoluteCutCornerShape.getBottomEnd(), absoluteCutCornerShape2.getBottomEnd(), f2), RoundedCornerShapeKt.lerp(absoluteCutCornerShape.getBottomStart(), absoluteCutCornerShape2.getBottomStart(), f2));
    }
    ...
    public static final AbsoluteCutCornerShape m1516AbsoluteCutCornerShape0680j_4(float f2) {
        return AbsoluteCutCornerShape(CornerSizeKt.m1524CornerSize0680j_4(f2));
    }
    ...
    public static final AbsoluteCutCornerShape m1517AbsoluteCutCornerShapea9UjIt4(float f2, float f3, float f4, float f5) {
        return new AbsoluteCutCornerShape(CornerSizeKt.m1524CornerSize0680j_4(f2), CornerSizeKt.m1524CornerSize0680j_4(f3), CornerSizeKt.m1524CornerSize0680j_4(f4), CornerSizeKt.m1524CornerSize0680j_4(f5));
    }

    public static /* synthetic */ AbsoluteCutCornerShape AbsoluteCutCornerShape$default(float f2, float f3, float f4, float f5, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = 0.0f;
        }
        if ((i & 2) != 0) {
    ...
    public static /* synthetic */ AbsoluteCutCornerShape m1518AbsoluteCutCornerShapea9UjIt4$default(float f2, float f3, float f4, float f5, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1517AbsoluteCutCornerShapea9UjIt4(f2, f3, f4, f5);
    }
}
