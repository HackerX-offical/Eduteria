...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo1515createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        return new Outline.Rounded(RoundRectKt.m5775RoundRectZAM2FJo(SizeKt.m5813toRectuvyYCjk(size), CornerRadius.m5677constructorimpl((((long) Float.floatToRawIntBits(topStart)) << 32) | (((long) Float.floatToRawIntBits(topStart)) & 4294967295L)), CornerRadius.m5677constructorimpl((((long) Float.floatToRawIntBits(topEnd)) << 32) | (((long) Float.floatToRawIntBits(topEnd)) & 4294967295L)), CornerRadius.m5677constructorimpl((((long) Float.floatToRawIntBits(bottomEnd)) << 32) | (((long) Float.floatToRawIntBits(bottomEnd)) & 4294967295L)), CornerRadius.m5677constructorimpl((((long) Float.floatToRawIntBits(bottomStart)) & 4294967295L) | (Float.floatToRawIntBits(bottomStart) << 32))));
    }
    ...
    private final long m1519toRadiusBz7bX_o(float f2) {
        return CornerRadius.m5677constructorimpl((((long) Float.floatToRawIntBits(f2)) << 32) | (((long) Float.floatToRawIntBits(f2)) & 4294967295L));
    }
}
