...
public final class AbsoluteRoundedCornerShapeKt {
    public static final AbsoluteRoundedCornerShape lerp(AbsoluteRoundedCornerShape absoluteRoundedCornerShape, AbsoluteRoundedCornerShape absoluteRoundedCornerShape2, float f2) {
        return new AbsoluteRoundedCornerShape(RoundedCornerShapeKt.lerp(absoluteRoundedCornerShape.getTopStart(), absoluteRoundedCornerShape2.getTopStart(), f2), RoundedCornerShapeKt.lerp(absoluteRoundedCornerShape.getTopEnd(), absoluteRoundedCornerShape2.getTopEnd(), f2), RoundedCornerShapeKt.lerp(absoluteRoundedCornerShape.getBottomEnd(), absoluteRoundedCornerShape2.getBottomEnd(), f2), RoundedCornerShapeKt.lerp(absoluteRoundedCornerShape.getBottomStart(), absoluteRoundedCornerShape2.getBottomStart(), f2));
    }
    ...
    public static final AbsoluteRoundedCornerShape m1520AbsoluteRoundedCornerShape0680j_4(float f2) {
        return AbsoluteRoundedCornerShape(CornerSizeKt.m1524CornerSize0680j_4(f2));
    }
    ...
    public static final AbsoluteRoundedCornerShape m1521AbsoluteRoundedCornerShapea9UjIt4(float f2, float f3, float f4, float f5) {
        return new AbsoluteRoundedCornerShape(CornerSizeKt.m1524CornerSize0680j_4(f2), CornerSizeKt.m1524CornerSize0680j_4(f3), CornerSizeKt.m1524CornerSize0680j_4(f4), CornerSizeKt.m1524CornerSize0680j_4(f5));
    }

    public static /* synthetic */ AbsoluteRoundedCornerShape AbsoluteRoundedCornerShape$default(float f2, float f3, float f4, float f5, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = 0.0f;
        }
        if ((i & 2) != 0) {
    ...
    public static /* synthetic */ AbsoluteRoundedCornerShape m1522AbsoluteRoundedCornerShapea9UjIt4$default(float f2, float f3, float f4, float f5, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1521AbsoluteRoundedCornerShapea9UjIt4(f2, f3, f4, f5);
    }
}
