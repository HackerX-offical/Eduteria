...
public final class CutCornerShapeKt {
    public static final CutCornerShape lerp(CutCornerShape cutCornerShape, CutCornerShape cutCornerShape2, float f2) {
        return new CutCornerShape(RoundedCornerShapeKt.lerp(cutCornerShape.getTopStart(), cutCornerShape2.getTopStart(), f2), RoundedCornerShapeKt.lerp(cutCornerShape.getTopEnd(), cutCornerShape2.getTopEnd(), f2), RoundedCornerShapeKt.lerp(cutCornerShape.getBottomEnd(), cutCornerShape2.getBottomEnd(), f2), RoundedCornerShapeKt.lerp(cutCornerShape.getBottomStart(), cutCornerShape2.getBottomStart(), f2));
    }
    ...
    public static final CutCornerShape m1525CutCornerShape0680j_4(float f2) {
        return CutCornerShape(CornerSizeKt.m1524CornerSize0680j_4(f2));
    }
    ...
    public static final CutCornerShape m1526CutCornerShapea9UjIt4(float f2, float f3, float f4, float f5) {
        return new CutCornerShape(CornerSizeKt.m1524CornerSize0680j_4(f2), CornerSizeKt.m1524CornerSize0680j_4(f3), CornerSizeKt.m1524CornerSize0680j_4(f4), CornerSizeKt.m1524CornerSize0680j_4(f5));
    }

    public static /* synthetic */ CutCornerShape CutCornerShape$default(float f2, float f3, float f4, float f5, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = 0.0f;
        }
        if ((i & 2) != 0) {
    ...
    public static /* synthetic */ CutCornerShape m1527CutCornerShapea9UjIt4$default(float f2, float f3, float f4, float f5, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m1526CutCornerShapea9UjIt4(f2, f3, f4, f5);
    }
}
