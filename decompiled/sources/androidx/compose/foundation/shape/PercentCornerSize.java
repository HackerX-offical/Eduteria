...
final /* data */ class PercentCornerSize implements CornerSize, InspectableValue {
    ...
    public static /* synthetic */ PercentCornerSize copy$default(PercentCornerSize percentCornerSize, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public float mo1523toPxTmRCtEA(long shapeSize, Density density) {
        return Size.m5791getMinDimensionimpl(shapeSize) * (this.percent / 100.0f);
    }
