...
public final class RoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo1515createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        if (topStart + topEnd + bottomEnd + bottomStart == 0.0f) {
            return new Outline.Rectangle(SizeKt.m5813toRectuvyYCjk(size));
        }
        Rect rectM5813toRectuvyYCjk = SizeKt.m5813toRectuvyYCjk(size);
        float f2 = layoutDirection == LayoutDirection.Ltr ? topStart : topEnd;
        ...
        float f3 = layoutDirection == LayoutDirection.Ltr ? topEnd : topStart;
        long jM5677constructorimpl2 = CornerRadius.m5677constructorimpl((((long) Float.floatToRawIntBits(f3)) & 4294967295L) | (((long) Float.floatToRawIntBits(f3)) << 32));
        float f4 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        long jM5677constructorimpl3 = CornerRadius.m5677constructorimpl((((long) Float.floatToRawIntBits(f4)) << 32) | (((long) Float.floatToRawIntBits(f4)) & 4294967295L));
        float f5 = layoutDirection == LayoutDirection.Ltr ? bottomStart : bottomEnd;
        return new Outline.Rounded(RoundRectKt.m5775RoundRectZAM2FJo(rectM5813toRectuvyYCjk, jM5677constructorimpl, jM5677constructorimpl2, jM5677constructorimpl3, CornerRadius.m5677constructorimpl((4294967295L & ((long) Float.floatToRawIntBits(f5))) | (((long) Float.floatToRawIntBits(f5)) << 32))));
    }
