...
final class EmptyMeasurePolicy implements MeasurePolicy {
    ...
    private static final Function1<Placeable.PlacementScope, Unit> placementBlock = new Function1() { // from class: androidx.compose.foundation.text.EmptyMeasurePolicy$$ExternalSyntheticLambda0
        ...
        public final Object invoke(Object obj) {
            return EmptyMeasurePolicy.placementBlock$lambda$0((Placeable.PlacementScope) obj);
        }
    };
    ...
    public MeasureResult mo44measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m8783getMaxWidthimpl(j), Constraints.m8782getMaxHeightimpl(j), null, placementBlock, 4, null);
    }
}
