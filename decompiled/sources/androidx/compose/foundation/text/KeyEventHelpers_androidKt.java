...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m1716cancelsTextSelectionZmokQxo(KeyEvent keyEvent) {
        return keyEvent.getKeyCode() == 4 && KeyEventType.m7137equalsimpl0(KeyEvent_androidKt.m7145getTypeZmokQxo(keyEvent), KeyEventType.INSTANCE.m7142getKeyUpCS__XNY());
    }
}
