...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final boolean m1765runActionKlQnJC8(int imeAction) {
        ...
        if (ImeAction.m8445equalsimpl0(imeAction, ImeAction.INSTANCE.m8459getDoneeUduSuo())) {
            ...
            if (!ImeAction.m8445equalsimpl0(imeAction, ImeAction.INSTANCE.m8458getDefaulteUduSuo()) && !ImeAction.m8445equalsimpl0(imeAction, ImeAction.INSTANCE.m8462getNoneeUduSuo())) {
        ...
        return m1763defaultKeyboardActionWithResultKlQnJC8(imeAction);
    }

    /* JADX INFO: renamed from: defaultKeyboardActionWithResult-KlQnJC8, reason: not valid java name */
    private final boolean m1763defaultKeyboardActionWithResultKlQnJC8(int imeAction) {
        SoftwareKeyboardController softwareKeyboardController;
        if (ImeAction.m8445equalsimpl0(imeAction, ImeAction.INSTANCE.m8461getNexteUduSuo())) {
            getFocusManager().mo5612moveFocus3ESFkO8(FocusDirection.INSTANCE.m5606getNextdhqQ8s());
            return true;
        }
        if (ImeAction.m8445equalsimpl0(imeAction, ImeAction.INSTANCE.m8463getPreviouseUduSuo())) {
            getFocusManager().mo5612moveFocus3ESFkO8(FocusDirection.INSTANCE.m5607getPreviousdhqQ8s());
            return true;
        }
        if (!ImeAction.m8445equalsimpl0(imeAction, ImeAction.INSTANCE.m8459getDoneeUduSuo()) || (softwareKeyboardController = this.keyboardController) == null) {
            return false;
        }
    ...
    public void mo1764defaultKeyboardActionKlQnJC8(int imeAction) {
        m1763defaultKeyboardActionWithResultKlQnJC8(imeAction);
    }
}
