...
public final class LegacyTextFieldState {
    ...
    private final MutableState minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m8828boximpl(Dp.m8830constructorimpl(0)), null, 2, null);
    ...
    private final Function1<ImeAction, Boolean> onImeActionPerformedWithResult = new Function1() { // from class: androidx.compose.foundation.text.LegacyTextFieldState$$ExternalSyntheticLambda3
        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Object obj) {
            return Boolean.valueOf(LegacyTextFieldState.onImeActionPerformedWithResult$lambda$0(this.f$0, (ImeAction) obj));
        }
    };
    private final Paint highlightPaint = AndroidPaint_androidKt.Paint();
    private long selectionBackgroundColor = Color.INSTANCE.m6004getUnspecified0d7_KjU();

    /* JADX INFO: renamed from: selectionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState selectionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m8261boximpl(TextRange.INSTANCE.m8278getZerod9O1mEE()), null, 2, null);

    /* JADX INFO: renamed from: deletionPreviewHighlightRange$delegate, reason: from kotlin metadata */
    private final MutableState deletionPreviewHighlightRange = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TextRange.m8261boximpl(TextRange.INSTANCE.m8278getZerod9O1mEE()), null, 2, null);
    ...
    public final float m1783getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField.getValue()).m8844unboximpl();
    }

    /* JADX INFO: renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m1787setMinHeightForSingleLineField0680j_4(float f2) {
        this.minHeightForSingleLineField.setValue(Dp.m8828boximpl(f2));
    }
    ...
    public static final Unit onValueChange$lambda$0(LegacyTextFieldState legacyTextFieldState, TextFieldValue textFieldValue) {
        ...
        legacyTextFieldState.m1789setSelectionPreviewHighlightRange5zctL8(TextRange.INSTANCE.m8278getZerod9O1mEE());
    ...
    public static final Unit onImeActionPerformed$lambda$0(LegacyTextFieldState legacyTextFieldState, ImeAction imeAction) {
        legacyTextFieldState.keyboardActionRunner.m1765runActionKlQnJC8(imeAction.getValue());
        return Unit.INSTANCE;
    }
    ...
    public static final boolean onImeActionPerformedWithResult$lambda$0(LegacyTextFieldState legacyTextFieldState, ImeAction imeAction) {
        return legacyTextFieldState.keyboardActionRunner.m1765runActionKlQnJC8(imeAction.getValue());
    }
    ...
    public final void m1788setSelectionBackgroundColor8_81llA(long j) {
    ...
    public final long m1785getSelectionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m1789setSelectionPreviewHighlightRange5zctL8(long j) {
        this.selectionPreviewHighlightRange.setValue(TextRange.m8261boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: getDeletionPreviewHighlightRange-d9O1mEE, reason: not valid java name */
    public final long m1782getDeletionPreviewHighlightRanged9O1mEE() {
    ...
    public final void m1786setDeletionPreviewHighlightRange5zctL8(long j) {
        this.deletionPreviewHighlightRange.setValue(TextRange.m8261boximpl(j));
    }

    public final boolean hasHighlight() {
        return (TextRange.m8267getCollapsedimpl(m1785getSelectionPreviewHighlightRanged9O1mEE()) && TextRange.m8267getCollapsedimpl(m1782getDeletionPreviewHighlightRanged9O1mEE())) ? false : true;
    }

    /* JADX INFO: renamed from: update-fnh65Uc, reason: not valid java name */
    public final void m1790updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        TextDelegate textDelegateM1817updateTextDelegaterm0N8CA$default = TextDelegateKt.m1817updateTextDelegaterm0N8CA$default(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, softWrap, 0, 0, 0, CollectionsKt.emptyList(), 448, null);
        if (this.textDelegate != textDelegateM1817updateTextDelegaterm0N8CA$default) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = textDelegateM1817updateTextDelegaterm0N8CA$default;
    }
}
