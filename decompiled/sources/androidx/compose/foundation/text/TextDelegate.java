...
public final class TextDelegate {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, int i2, boolean z, int i3, Density density, FontFamily.Resolver resolver, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i4 & 4) != 0 ? Integer.MAX_VALUE : i, (i4 & 8) != 0 ? 1 : i2, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? TextOverflow.INSTANCE.m8765getClipgIe3tQ8() : i3, density, resolver, (i4 & 256) != 0 ? CollectionsKt.emptyList() : list, null);
    }
    ...
    private final MultiParagraph m1813layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        layoutIntrinsics(layoutDirection);
        int iM8785getMinWidthimpl = Constraints.m8785getMinWidthimpl(constraints);
        int iM8783getMaxWidthimpl = ((this.softWrap || TextOverflow.m8756equalsimpl0(this.overflow, TextOverflow.INSTANCE.m8766getEllipsisgIe3tQ8())) && Constraints.m8779getHasBoundedWidthimpl(constraints)) ? Constraints.m8783getMaxWidthimpl(constraints) : Integer.MAX_VALUE;
        int i = (this.softWrap || !TextOverflow.m8756equalsimpl0(this.overflow, TextOverflow.INSTANCE.m8766getEllipsisgIe3tQ8())) ? this.maxLines : 1;
        if (iM8785getMinWidthimpl != iM8783getMaxWidthimpl) {
            iM8783getMaxWidthimpl = RangesKt.coerceIn(getMaxIntrinsicWidth(), iM8785getMinWidthimpl, iM8783getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), Constraints.INSTANCE.m8792fitPrioritizingWidthZbe2FdA(0, iM8783getMaxWidthimpl, 0, Constraints.m8782getMaxHeightimpl(constraints)), i, this.overflow, (DefaultConstructorMarker) null);
    }

    /* JADX INFO: renamed from: layout-NN6Ew-U$default, reason: not valid java name */
    public static /* synthetic */ TextLayoutResult m1812layoutNN6EwU$default(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
        if ((i & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m1815layoutNN6EwU(j, layoutDirection, textLayoutResult);
    }

    /* JADX INFO: renamed from: layout-NN6Ew-U, reason: not valid java name */
    public final TextLayoutResult m1815layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        if (prevResult != null && TextLayoutHelperKt.m1858canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            return prevResult.m8242copyO0kMr_c(new TextLayoutInput(prevResult.getLayoutInput().getText(), this.style, prevResult.getLayoutInput().getPlaceholders(), prevResult.getLayoutInput().getMaxLines(), prevResult.getLayoutInput().getSoftWrap(), prevResult.getLayoutInput().getOverflow(), prevResult.getLayoutInput().getDensity(), prevResult.getLayoutInput().getLayoutDirection(), prevResult.getLayoutInput().getFontFamilyResolver(), constraints, (DefaultConstructorMarker) null), ConstraintsKt.m8797constrain4WqzIAM(constraints, IntSize.m8996constructorimpl((((long) TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getHeight())) & 4294967295L) | (((long) TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getWidth())) << 32))));
        }
        MultiParagraph multiParagraphM1813layoutTextK40F9xA = m1813layoutTextK40F9xA(constraints, layoutDirection);
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints, (DefaultConstructorMarker) null), multiParagraphM1813layoutTextK40F9xA, ConstraintsKt.m8797constrain4WqzIAM(constraints, IntSize.m8996constructorimpl((((long) TextDelegateKt.ceilToIntPx(multiParagraphM1813layoutTextK40F9xA.getHeight())) & 4294967295L) | (((long) TextDelegateKt.ceilToIntPx(multiParagraphM1813layoutTextK40F9xA.getWidth())) << 32))), null);
    }
