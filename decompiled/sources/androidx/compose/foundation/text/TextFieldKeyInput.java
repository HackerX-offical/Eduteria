...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m1839typedCommandZmokQxo(KeyEvent event) {
        Integer numM1712consumeZmokQxo;
        if (TextFieldKeyInput_androidKt.m1846isTypedEventZmokQxo(event) && (numM1712consumeZmokQxo = this.keyCombiner.m1712consumeZmokQxo(event)) != null) {
            return new CommitTextCommand(StringsHelpers_jvmAndAndroidKt.appendCodePointX(new StringBuilder(), numM1712consumeZmokQxo.intValue()).toString(), 1);
        }
        return null;
    }

    /* JADX INFO: renamed from: process-ZmokQxo, reason: not valid java name */
    public final boolean m1840processZmokQxo(KeyEvent event) {
        final KeyCommand keyCommandMo1717mapZmokQxo;
        CommitTextCommand commitTextCommandM1839typedCommandZmokQxo = m1839typedCommandZmokQxo(event);
        if (commitTextCommandM1839typedCommandZmokQxo != null) {
            if (!this.editable) {
                return false;
            }
            apply(commitTextCommandM1839typedCommandZmokQxo);
            this.preparedSelectionState.resetCachedX();
            return true;
        }
        if (!KeyEventType.m7137equalsimpl0(KeyEvent_androidKt.m7145getTypeZmokQxo(event), KeyEventType.INSTANCE.m7141getKeyDownCS__XNY()) || (keyCommandMo1717mapZmokQxo = this.keyMapping.mo1717mapZmokQxo(event)) == null || (keyCommandMo1717mapZmokQxo.getEditsText() && !this.editable)) {
            return false;
        }
        ...
        commandExecutionContext(new Function1() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return TextFieldKeyInput.process_ZmokQxo$lambda$1(keyCommandMo1717mapZmokQxo, this, booleanRef, (TextFieldPreparedSelection) obj);
            }
        });
        ...
        switch (WhenMappings.$EnumSwitchMapping$0[keyCommand.ordinal()]) {
            ...
            case 26:
                if (!textFieldKeyInput.singleLine) {
                    ...
                    booleanRef.element = textFieldKeyInput.state.getOnImeActionPerformedWithResult().invoke(ImeAction.m8442boximpl(textFieldKeyInput.imeAction)).booleanValue();
                }
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$2(TextFieldPreparedSelection textFieldPreparedSelection) {
        ...
        return new DeleteSurroundingTextCommand(TextRange.m8268getEndimpl(textFieldPreparedSelection.getSelection()) - precedingCodePointOrEmojiStartIndex, 0);
    }
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$3(TextFieldPreparedSelection textFieldPreparedSelection) {
        ...
        if (nextCharacterIndex != -1) {
            return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m8268getEndimpl(textFieldPreparedSelection.getSelection()));
        }
        return null;
    }
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$4(TextFieldPreparedSelection textFieldPreparedSelection) {
        ...
        if (previousWordOffset != null) {
            deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m8268getEndimpl(textFieldPreparedSelection.getSelection()) - previousWordOffset.intValue(), 0);
        } else {
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$5(TextFieldPreparedSelection textFieldPreparedSelection) {
        ...
        return nextWordOffset != null ? new DeleteSurroundingTextCommand(0, nextWordOffset.intValue() - TextRange.m8268getEndimpl(textFieldPreparedSelection.getSelection())) : null;
    }
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$6(TextFieldPreparedSelection textFieldPreparedSelection) {
        ...
        if (lineStartByOffset != null) {
            deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m8268getEndimpl(textFieldPreparedSelection.getSelection()) - lineStartByOffset.intValue(), 0);
        } else {
            deleteSurroundingTextCommand = null;
        }
        return deleteSurroundingTextCommand;
    ...
    public static final EditCommand process_ZmokQxo$lambda$1$7(TextFieldPreparedSelection textFieldPreparedSelection) {
        ...
        return lineEndByOffset != null ? new DeleteSurroundingTextCommand(0, lineEndByOffset.intValue() - TextRange.m8268getEndimpl(textFieldPreparedSelection.getSelection())) : null;
    }
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (TextRange.m8266equalsimpl0(textFieldPreparedSelection.getSelection(), this.value.getSelection()) && Intrinsics.areEqual(textFieldPreparedSelection.getAnnotatedString(), this.value.getAnnotatedString())) {
            return;
        }
