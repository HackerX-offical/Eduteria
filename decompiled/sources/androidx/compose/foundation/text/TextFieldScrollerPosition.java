...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f2) {
        this.offset = PrimitiveSnapshotStateKt.mutableFloatStateOf(f2);
        ...
        this.previousSelection = TextRange.INSTANCE.m8278getZerod9O1mEE();
    ...
    public final void m1853setPreviousSelection5zctL8(long j) {
    ...
    public final void coerceOffset$foundation(float cursorStart, float cursorEnd, int containerSize) {
        ...
        float f3 = offset + f2;
        setOffset(getOffset() + ((cursorEnd <= f3 && (cursorStart >= offset || cursorEnd - cursorStart <= f2)) ? (cursorStart >= offset || cursorEnd - cursorStart > f2) ? 0.0f : cursorStart - offset : cursorEnd - f3));
    }

    /* JADX INFO: renamed from: getOffsetToFollow-5zc-tL8, reason: not valid java name */
    public final int m1851getOffsetToFollow5zctL8(long selection) {
        return TextRange.m8273getStartimpl(selection) != TextRange.m8273getStartimpl(this.previousSelection) ? TextRange.m8273getStartimpl(selection) : TextRange.m8268getEndimpl(selection) != TextRange.m8268getEndimpl(this.previousSelection) ? TextRange.m8268getEndimpl(selection) : TextRange.m8271getMinimpl(selection);
    }
