...
final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo1715measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, placeableMo7445measureBRTryo0.getWidth(), iMin, null, new Function1() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return VerticalScrollLayoutModifier.measure_3p2s80s$lambda$0(this.f$0, placeableMo7445measureBRTryo0, iMin, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }
    ...
    public static final Unit measure_3p2s80s$lambda$0(VerticalScrollLayoutModifier verticalScrollLayoutModifier, Placeable placeable, int i, Placeable.PlacementScope placementScope) {
        ...
        TextLayoutResultProxy textLayoutResultProxyInvoke = verticalScrollLayoutModifier.textLayoutResultProvider.invoke();
        verticalScrollLayoutModifier.scrollerPosition.update(Orientation.Vertical, TextFieldScrollKt.getCursorRectInScroller(placementScope2, i2, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, false, placeable.getWidth()), i, placeable.getHeight());
