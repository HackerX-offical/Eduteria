...
public final class ProcessTextApi23Impl {
    ...
    public static final Unit onClickProcessTextItem$lambda$0(Context context, ResolveInfo resolveInfo, boolean z, CharSequence charSequence, TextRange textRange) {
        String string = charSequence.subSequence(TextRange.m8271getMinimpl(textRange.getPackedValue()), TextRange.m8270getMaximpl(textRange.getPackedValue())).toString();
    ...
    public final Intent createProcessTextIntentForResolveInfo(ResolveInfo info2, boolean editable) {
        return createProcessTextIntent().putExtra("android.intent.extra.PROCESS_TEXT_READONLY", editable).setClassName(info2.activityInfo.packageName, info2.activityInfo.name);
    }
