...
final class MaintainWindowPositionPopupPositionProvider implements PopupPositionProvider {
    ...
    public final void m1894setPreviousWindowSizefhxjrPA(IntSize intSize) {
    ...
    public final void m1892setPreviousPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public final void m1893setPreviousPositionfg0MpWk(IntOffset intOffset) {
    ...
    public long mo450calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (intOffset != null) {
            ...
            if ((intSize == null ? false : IntSize.m8999equalsimpl0(intSize.m9005unboximpl(), windowSize)) && this.previousLayoutDirection == layoutDirection) {
                IntSize intSize2 = this.previousPopupContentSize;
                if (intSize2 != null ? IntSize.m8999equalsimpl0(intSize2.m9005unboximpl(), popupContentSize) : false) {
                    return intOffset.m8967unboximpl();
                }
            }
        }
        long jMo450calculatePositionllwVHH4 = this.popupPositionProvider.mo450calculatePositionllwVHH4(anchorBounds, windowSize, layoutDirection, popupContentSize);
        this.previousWindowSize = IntSize.m8993boximpl(windowSize);
        this.previousLayoutDirection = layoutDirection;
        this.previousPopupContentSize = IntSize.m8993boximpl(popupContentSize);
        this.previousPosition = IntOffset.m8949boximpl(jMo450calculatePositionllwVHH4);
        return jMo450calculatePositionllwVHH4;
    }
}
