...
final class TextContextMenuGestureNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, GlobalPositionAwareModifierNode {
    ...
    public TextContextMenuGestureNode(Function2<? super Offset, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        delegate(SuspendingPointerInputFilterKt.SuspendingPointerInputModifierNode(new PointerInputEventHandler() { // from class: androidx.compose.foundation.text.contextmenu.modifier.TextContextMenuGestureNode.1
            ...
            static final /* synthetic */ class C00311 extends FunctionReferenceImpl implements Function1<Offset, Unit> {
                C00311(Object obj) {
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                    m1905invokek4lQ0M(offset.m5733unboximpl());
                    return Unit.INSTANCE;
                }

                /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
                public final void m1905invokek4lQ0M(long j) {
                    ((TextContextMenuGestureNode) this.receiver).m1904tryShowContextMenuk4lQ0M(j);
                }
            }

            @Override // androidx.compose.ui.input.pointer.PointerInputEventHandler
            public final Object invoke(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
                Object objOnRightClickDown = RightClickGesturesKt.onRightClickDown(pointerInputScope, new C00311(TextContextMenuGestureNode.this), continuation);
    ...
    public final void m1904tryShowContextMenuk4lQ0M(long localClickOffset) {
    ...
    final class ClickTextContextMenuDataProvider implements TextContextMenuDataProvider {
        ...
        public long mo1906positiontuRUvjQ(LayoutCoordinates destinationCoordinates) {
            ...
            if (localCoordinates != null) {
                return destinationCoordinates.mo7454localPositionOfR5De75A(localCoordinates, this.localClickOffset);
            }
        ...
        public Rect contentBounds(LayoutCoordinates destinationCoordinates) {
            return RectKt.m5763Recttz77jQw(mo1906positiontuRUvjQ(destinationCoordinates), Size.INSTANCE.m5801getZeroNHjbRc());
        }
