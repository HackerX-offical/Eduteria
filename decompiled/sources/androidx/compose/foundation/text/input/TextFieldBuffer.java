...
public final class TextFieldBuffer implements Appendable {
    ...
    public interface ChangeList {
        ...
        long mo1925getOriginalRangejx7JFs(int changeIndex);

        /* JADX INFO: renamed from: getRange--jx7JFs, reason: not valid java name */
        long mo1926getRangejx7JFs(int changeIndex);
    }
        ...
        if (composingAnnotations != null && !composingAnnotations.isEmpty()) {
            ...
            Function1 function1 = new Function1() { // from class: androidx.compose.foundation.text.input.TextFieldBuffer$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj) {
                    return TextFieldBuffer.composingAnnotations$lambda$0(textFieldCharSequence, ((Integer) obj).intValue());
                }
            };
    ...
    public final long m1920getOriginalSelectiond9O1mEE() {
    ...
    public final boolean hasSelection() {
        return !TextRange.m8267getCollapsedimpl(getSelectionInChars());
    }
    ...
    public final void m1923setSelection5zctL8(long j) {
        m1916requireValidRange5zctL8(j);
    ...
    private final void m1917setCompositionOEnZFl4(TextRange textRange) {
        if (textRange == null || TextRange.m8267getCollapsedimpl(textRange.getPackedValue())) {
    ...
    public final void commitComposition$foundation() {
        m1917setCompositionOEnZFl4(null);
    }
    ...
    public final void setComposition$foundation(int start, int end, List<AnnotatedString.Range<AnnotatedString.Annotation>> annotations) {
        ...
        m1917setCompositionOEnZFl4(TextRange.m8261boximpl(TextRangeKt.TextRange(start, end)));
        MutableVector<AnnotatedString.Range<AnnotatedString.Annotation>> mutableVector = this.composingAnnotations;
        if (mutableVector != null) {
            mutableVector.clear();
        }
    ...
    public final void m1922setHighlightK7f2yys$foundation(int type, int start, int end) {
        if (start >= end) {
            throw new IllegalArgumentException("Do not set reversed or empty range: " + start + " > " + end);
        }
        this.highlight = new Pair<>(TextHighlightType.m1935boximpl(type), TextRange.m8261boximpl(TextRangeKt.TextRange(RangesKt.coerceIn(start, 0, getLength()), RangesKt.coerceIn(end, 0, getLength()))));
    }
    ...
    public final void replace$foundation(int start, int end, CharSequence text, int textStart, int textEnd) {
        ...
        int iCoerceIn3 = RangesKt.coerceIn(textStart, 0, text.length());
        int iCoerceIn4 = RangesKt.coerceIn(textEnd, 0, text.length());
        onTextWillChange(iCoerceIn, iCoerceIn2, iCoerceIn4 - iCoerceIn3);
        this.buffer.replace(iCoerceIn, iCoerceIn2, text, iCoerceIn3, iCoerceIn4);
    ...
    private final void onTextWillChange(int replaceStart, int replaceEnd, int newLength) {
        ...
        this.selectionInChars = TextFieldBufferKt.m1927adjustTextRangevJH6DeI(getSelectionInChars(), replaceStart, replaceEnd, newLength);
    }
    ...
    public final void revertAllChanges() {
        ...
        m1923setSelection5zctL8(this.originalValue.getSelection());
        clearChangeList();
    }
    ...
    public static /* synthetic */ TextFieldCharSequence m1918toTextFieldCharSequencewFTz33Y$foundation$default(TextFieldBuffer textFieldBuffer, long j, TextRange textRange, List list, List list2, int i, Object obj) {
        ...
        return textFieldBuffer.m1924toTextFieldCharSequencewFTz33Y$foundation(j2, textRange2, list, (i & 8) != 0 ? null : list2);
    }

    /* JADX INFO: renamed from: toTextFieldCharSequence-wFTz33Y$foundation, reason: not valid java name */
    public final TextFieldCharSequence m1924toTextFieldCharSequencewFTz33Y$foundation(long selection, TextRange composition, List<AnnotatedString.Range<AnnotatedString.Annotation>> composingAnnotations, List<AnnotatedString.Range<AnnotatedString.Annotation>> outputAnnotations) {
    ...
    private final void m1916requireValidRange5zctL8(long range) {
        long jTextRange = TextRangeKt.TextRange(0, getLength());
        if (TextRange.m8263contains5zctL8(jTextRange, range)) {
            return;
        }
        InlineClassHelperKt.throwIllegalArgumentException("Expected " + ((Object) TextRange.m8276toStringimpl(range)) + " to be in " + ((Object) TextRange.m8276toStringimpl(jTextRange)));
    }
