...
public final class TextFieldCharSequence implements CharSequence {
    ...
    private TextFieldCharSequence(CharSequence charSequence, long j, TextRange textRange, Pair<TextHighlightType, TextRange> pair, List<AnnotatedString.Range<AnnotatedString.Annotation>> list, List<AnnotatedString.Range<AnnotatedString.Annotation>> list2) {
        ...
        this.selection = TextRangeKt.m8279coerceIn8ffj60Q(j, 0, charSequence.length());
        this.composition = textRange != null ? TextRange.m8261boximpl(TextRangeKt.m8279coerceIn8ffj60Q(textRange.getPackedValue(), 0, charSequence.length())) : null;
        this.highlight = pair != null ? Pair.copy$default(pair, null, TextRange.m8261boximpl(TextRangeKt.m8279coerceIn8ffj60Q(pair.getSecond().getPackedValue(), 0, charSequence.length())), 1, null) : null;
    }
    ...
    public /* synthetic */ TextFieldCharSequence(CharSequence charSequence, long j, TextRange textRange, Pair pair, List list, List list2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        long jM8278getZerod9O1mEE = (i & 2) != 0 ? TextRange.INSTANCE.m8278getZerod9O1mEE() : j;
        TextRange textRange2 = (i & 4) != 0 ? null : textRange;
        Pair pair2 = (i & 8) != 0 ? null : pair;
        List list3 = (i & 16) != 0 ? null : list;
        this(charSequence2, jM8278getZerod9O1mEE, textRange2, pair2, list3, (i & 32) == 0 ? list2 : null, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return TextRange.m8266equalsimpl0(this.selection, textFieldCharSequence.selection) && Intrinsics.areEqual(this.composition, textFieldCharSequence.composition) && Intrinsics.areEqual(this.highlight, textFieldCharSequence.highlight) && Intrinsics.areEqual(this.composingAnnotations, textFieldCharSequence.composingAnnotations) && contentEquals(textFieldCharSequence.text);
    }

    public int hashCode() {
        int iHashCode = ((this.text.hashCode() * 31) + TextRange.m8274hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        int iM8274hashCodeimpl = (iHashCode + (textRange != null ? TextRange.m8274hashCodeimpl(textRange.getPackedValue()) : 0)) * 31;
        Pair<TextHighlightType, TextRange> pair = this.highlight;
        int iHashCode2 = (iM8274hashCodeimpl + (pair != null ? pair.hashCode() : 0)) * 31;
