...
public final class TextFieldState {
    ...
    /* JADX INFO: compiled from: TextFieldState.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\bà\u0080\u0001\u0018\u00002\u00020\u0001J \u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\bH&ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\tÀ\u0006\u0001"}, d2 = {"Landroidx/compose/foundation/text/input/TextFieldState$NotifyImeListener;", "", "onChange", "", Constants.KEY_OLD_VALUE, "Landroidx/compose/foundation/text/input/TextFieldCharSequence;", Constants.KEY_NEW_VALUE, "restartIme", "", "foundation"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    private TextFieldState(String str, long j, TextUndoManager textUndoManager) {
        ...
        String str2 = str;
        this.mainBuffer = new TextFieldBuffer(new TextFieldCharSequence(str2, TextRangeKt.m8279coerceIn8ffj60Q(j, 0, str.length()), null, null, null, null, 60, null), null, null, null, 14, null);
    ...
    public final void setUserCommit(boolean z) {
        this.userCommit.setValue(Boolean.valueOf(z));
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final boolean getUserCommit$foundation() {
        return ((Boolean) this.userCommit.getValue()).booleanValue();
    }
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m8276toStringimpl(m1931getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean zM8266equalsimpl0 = TextRange.m8266equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.getSelectionInChars());
        boolean z2 = !zM8266equalsimpl0;
        if (!z && zM8266equalsimpl0) {
            newValue.setCanCallAddStyle$foundation(true);
        }
        if (z) {
            textFieldBuffer = newValue;
            recordEditForUndo(getValue$foundation(), TextFieldBuffer.m1918toTextFieldCharSequencewFTz33Y$foundation$default(textFieldBuffer, 0L, null, null, null, 15, null), textFieldBuffer.getChanges(), TextFieldEditUndoBehavior.NeverMerge);
        } else {
            textFieldBuffer = newValue;
        }
    ...
    public final void editWithNoSideEffects$foundation(Function1<? super TextFieldBuffer, Unit> block) {
        getMainBuffer().getChangeTracker$foundation().clearChanges();
        block.invoke(getMainBuffer());
        updateValueAndNotifyListeners(getValue$foundation(), TextFieldBuffer.m1918toTextFieldCharSequencewFTz33Y$foundation$default(getMainBuffer(), 0L, null, null, null, 15, null), true);
    }
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        ...
        if (this.mainBuffer.getChangeTracker$foundation().getChangeCount() == 0 && TextRange.m8266equalsimpl0(value$foundation.getSelection(), this.mainBuffer.getSelectionInChars())) {
            ...
            updateValueAndNotifyListeners(getValue$foundation(), new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.getSelectionInChars(), this.mainBuffer.getComposition(), this.mainBuffer.getHighlight$foundation(), TextFieldStateKt.m1933finalizeComposingAnnotationsitr0ztk(this.mainBuffer.getComposition(), this.mainBuffer.getComposingAnnotations$foundation()), null, 32, null), restartImeIfContentChanges);
            return;
        }
        boolean z = false;
        boolean z2 = this.mainBuffer.getChangeTracker$foundation().getChangeCount() != 0;
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.getSelectionInChars(), this.mainBuffer.getComposition(), this.mainBuffer.getHighlight$foundation(), TextFieldStateKt.m1933finalizeComposingAnnotationsitr0ztk(this.mainBuffer.getComposition(), this.mainBuffer.getComposingAnnotations$foundation()), null, 32, null);
        ...
        boolean zM8266equalsimpl0 = TextRange.m8266equalsimpl0(textFieldBuffer.getSelectionInChars(), textFieldCharSequence.getSelection());
        boolean z4 = !zM8266equalsimpl0;
        if (!zContentEquals || !zM8266equalsimpl0) {
            syncMainBufferToTemporaryBuffer$foundation(textFieldBuffer, z3, z4);
        } else {
            updateValueAndNotifyListeners(value$foundation, TextFieldBuffer.m1918toTextFieldCharSequencewFTz33Y$foundation$default(textFieldBuffer, 0L, textFieldCharSequence.getComposition(), null, null, 13, null), restartImeIfContentChanges);
        }
    ...
    public final void syncMainBufferToTemporaryBuffer$foundation(TextFieldBuffer temporaryBuffer, boolean textChanged, boolean selectionChanged) {
        TextFieldCharSequence textFieldCharSequenceM1918toTextFieldCharSequencewFTz33Y$foundation$default = TextFieldBuffer.m1918toTextFieldCharSequencewFTz33Y$foundation$default(this.mainBuffer, 0L, null, null, null, 15, null);
        if (textChanged) {
            ...
            this.mainBuffer.m1923setSelection5zctL8(TextRangeKt.TextRange(TextRange.m8273getStartimpl(temporaryBuffer.getSelectionInChars()), TextRange.m8268getEndimpl(temporaryBuffer.getSelectionInChars())));
        }
        if (textChanged || selectionChanged || !Intrinsics.areEqual(textFieldCharSequenceM1918toTextFieldCharSequencewFTz33Y$foundation$default.getComposition(), temporaryBuffer.getComposition())) {
            this.mainBuffer.commitComposition$foundation();
        }
        updateValueAndNotifyListeners(textFieldCharSequenceM1918toTextFieldCharSequencewFTz33Y$foundation$default, TextFieldBuffer.m1918toTextFieldCharSequencewFTz33Y$foundation$default(this.mainBuffer, 0L, null, null, null, 15, null), true);
    }
    ...
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope saverScope, TextFieldState textFieldState) {
            return CollectionsKt.listOf(textFieldState.getText().toString(), Integer.valueOf(TextRange.m8273getStartimpl(textFieldState.m1931getSelectiond9O1mEE())), Integer.valueOf(TextRange.m8268getEndimpl(textFieldState.m1931getSelectiond9O1mEE())), TextUndoManager.Companion.Saver.INSTANCE.save(saverScope, textFieldState.getTextUndoManager()));
        }
