...
public final class TextFieldStateKt {
    ...
    public static final TextFieldState m1934rememberTextFieldStateLepunE(final String str, final long j, Composer composer, int i, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1125389485, i, -1, "androidx.compose.foundation.text.input.rememberTextFieldState (TextFieldState.kt:673)");
        }
        ...
        TextFieldState textFieldState = (TextFieldState) RememberSaveableKt.m5351rememberSaveable(objArr, (Saver) saver, (Function0) objRememberedValue, composer, 48);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final List<AnnotatedString.Range<AnnotatedString.Annotation>> m1933finalizeComposingAnnotationsitr0ztk(TextRange textRange, MutableVector<AnnotatedString.Range<AnnotatedString.Annotation>> mutableVector) {
