...
public final class TextUndoManagerKt {
    ...
    public static final void recordChanges(TextUndoManager textUndoManager, TextFieldCharSequence textFieldCharSequence, TextFieldCharSequence textFieldCharSequence2, TextFieldBuffer.ChangeList changeList, boolean z) {
        ...
        if (changeList.getChangeCount() == 1) {
            long jMo1925getOriginalRangejx7JFs = changeList.mo1925getOriginalRangejx7JFs(0);
            long jMo1926getRangejx7JFs = changeList.mo1926getRangejx7JFs(0);
            if (TextRange.m8267getCollapsedimpl(jMo1925getOriginalRangejx7JFs) && TextRange.m8267getCollapsedimpl(jMo1926getRangejx7JFs)) {
                return;
            }
            textUndoManager.record(new TextUndoOperation(TextRange.m8271getMinimpl(jMo1925getOriginalRangejx7JFs), TextRangeKt.m8280substringFDrldGo(textFieldCharSequence, jMo1925getOriginalRangejx7JFs), TextRangeKt.m8280substringFDrldGo(textFieldCharSequence2, jMo1926getRangejx7JFs), textFieldCharSequence.getSelection(), textFieldCharSequence2.getSelection(), 0L, z, 32, null));
        }
    }
