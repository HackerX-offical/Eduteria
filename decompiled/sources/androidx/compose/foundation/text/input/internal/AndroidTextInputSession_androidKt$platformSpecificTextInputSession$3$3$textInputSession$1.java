...
public final class AndroidTextInputSession_androidKt$platformSpecificTextInputSession$3$3$textInputSession$1 implements TextInputSession, ImeEditCommandScope {
    ...
    public long mo1958mapFromTransformedGEjPoXI(long range) {
        return this.$$delegate_0.mo1958mapFromTransformedGEjPoXI(range);
    }
    ...
    public long mo1959mapToTransformedGEjPoXI(long range) {
        return this.$$delegate_0.mo1959mapToTransformedGEjPoXI(range);
    }
    ...
    public void mo1960onImeActionKlQnJC8(int imeAction) {
        Function1<ImeAction, Unit> function1 = this.$onImeAction;
        if (function1 != null) {
            function1.invoke(ImeAction.m8442boximpl(imeAction));
        }
    }
