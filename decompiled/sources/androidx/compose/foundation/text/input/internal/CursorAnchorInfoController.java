...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m6214constructorimpl$default(null, 1, null);
    ...
    public static final /* synthetic */ CursorAnchorInfo access$calculateCursorAnchorInfo(CursorAnchorInfoController cursorAnchorInfoController) {
            ...
            if (i == 0) {
                ...
                Flow flowFilterNotNull = FlowKt.filterNotNull(FlowKt.drop(SnapshotStateKt.snapshotFlow(new Function0() { // from class: androidx.compose.foundation.text.input.internal.CursorAnchorInfoController$startOrStopMonitoring$1$$ExternalSyntheticLambda0
                    ...
                    public final Object invoke() {
                        return CursorAnchorInfoController.access$calculateCursorAnchorInfo(cursorAnchorInfoController);
                    }
                }), 1));
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null && (coreNodeCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreNodeCoordinates != null && (decoratorNodeCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    Matrix.m6223resetimpl(this.matrix);
                    textLayoutNodeCoordinates.mo7461transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m5835setFromEL8BTi8(this.androidMatrix, this.matrix);
                    return CursorAnchorInfoBuilder_androidKt.m1973buildvxqZcH0(this.builder, visualText, visualText.getSelection(), visualText.getComposition(), layoutResult, this.androidMatrix, SelectionManagerKt.visibleBounds(coreNodeCoordinates).m5760translatek4lQ0M(textLayoutNodeCoordinates.mo7454localPositionOfR5De75A(coreNodeCoordinates, Offset.INSTANCE.m5739getZeroF1C5BW0())), SelectionManagerKt.visibleBounds(decoratorNodeCoordinates).m5760translatek4lQ0M(textLayoutNodeCoordinates.mo7454localPositionOfR5De75A(decoratorNodeCoordinates, Offset.INSTANCE.m5739getZeroF1C5BW0())), this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
            }
        }
        return null;
