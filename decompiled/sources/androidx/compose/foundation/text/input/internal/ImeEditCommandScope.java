...
public interface ImeEditCommandScope {
    ...
    long mo1958mapFromTransformedGEjPoXI(long range);

    /* JADX INFO: renamed from: mapToTransformed-GEjPoXI */
    long mo1959mapToTransformedGEjPoXI(long range);
}
