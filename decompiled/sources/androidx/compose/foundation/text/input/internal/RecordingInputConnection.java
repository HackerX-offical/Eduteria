...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        if (this.isActive) {
            ...
            int iM8271getMinimpl = composition != null ? TextRange.m8271getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m8271getMinimpl(state.getSelection()), TextRange.m8270getMaximpl(state.getSelection()), iM8271getMinimpl, composition2 != null ? TextRange.m8270getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m8267getCollapsedimpl(this.textFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.textFieldValue.getText(), TextRange.m8271getMinimpl(this.textFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        int iM8458getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            iM8458getDefaulteUduSuo = ImeAction.INSTANCE.m8458getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    iM8458getDefaulteUduSuo = ImeAction.INSTANCE.m8460getGoeUduSuo();
                    break;
                case 3:
                    iM8458getDefaulteUduSuo = ImeAction.INSTANCE.m8464getSearcheUduSuo();
                    break;
                case 4:
                    iM8458getDefaulteUduSuo = ImeAction.INSTANCE.m8465getSendeUduSuo();
                    break;
                case 5:
                    iM8458getDefaulteUduSuo = ImeAction.INSTANCE.m8461getNexteUduSuo();
                    break;
                case 6:
                    iM8458getDefaulteUduSuo = ImeAction.INSTANCE.m8459getDoneeUduSuo();
                    break;
                case 7:
                    iM8458getDefaulteUduSuo = ImeAction.INSTANCE.m8463getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo2007onImeActionKlQnJC8(iM8458getDefaulteUduSuo);
        return true;
    }
