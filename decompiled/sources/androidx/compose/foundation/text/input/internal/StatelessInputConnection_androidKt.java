...
public final class StatelessInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldCharSequence textFieldCharSequence) {
        ...
        extractedText.selectionStart = TextRange.m8271getMinimpl(textFieldCharSequence.getSelection());
        extractedText.selectionEnd = TextRange.m8270getMaximpl(textFieldCharSequence.getSelection());
    ...
    public static final TransferableContent toTransferableContent(InputContentInfoCompat inputContentInfoCompat, Bundle bundle) {
        ...
        int iM441getKeyboardkB6V9T0 = TransferableContent.Source.INSTANCE.m441getKeyboardkB6V9T0();
        ...
        return new TransferableContent(clipEntry, clipMetadata, iM441getKeyboardkB6V9T0, new PlatformTransferableContent(linkUri, bundle), null);
    }
