...
public final class TextFieldKeyEventHandler_androidKt {
    ...
    public static final boolean m2100isFromSoftKeyboardZmokQxo(KeyEvent keyEvent) {
        return (keyEvent.getFlags() & 2) == 2;
    }

    /* JADX INFO: renamed from: isKeyCode-YhN2O0w, reason: not valid java name */
    private static final boolean m2101isKeyCodeYhN2O0w(KeyEvent keyEvent, int i) {
