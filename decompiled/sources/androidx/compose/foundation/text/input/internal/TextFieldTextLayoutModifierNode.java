...
public final class TextFieldTextLayoutModifierNode extends DelegatingNode implements LayoutModifierNode, GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        TextLayoutResult textLayoutResultM2114layoutWithNewMeasureInputshBUhpc = this.textLayoutState.m2114layoutWithNewMeasureInputshBUhpc(measureScope, measureScope.getLayoutDirection(), (FontFamily.Resolver) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFontFamilyResolver()), j);
        final Placeable placeableMo7445measureBRTryo0 = measurable.mo7445measureBRTryo0(Constraints.INSTANCE.m8792fitPrioritizingWidthZbe2FdA((int) (textLayoutResultM2114layoutWithNewMeasureInputshBUhpc.getSize() >> 32), (int) (textLayoutResultM2114layoutWithNewMeasureInputshBUhpc.getSize() >> 32), (int) (textLayoutResultM2114layoutWithNewMeasureInputshBUhpc.getSize() & 4294967295L), (int) (textLayoutResultM2114layoutWithNewMeasureInputshBUhpc.getSize() & 4294967295L)));
        TextLayoutState textLayoutState = this.textLayoutState;
        if (this.singleLine) {
            fM8830constructorimpl = measureScope.mo485toDpu2uoSUM(TextDelegateKt.ceilToIntPx(textLayoutResultM2114layoutWithNewMeasureInputshBUhpc.getLineBottom(0)));
        } else {
            fM8830constructorimpl = Dp.m8830constructorimpl(0);
        }
        textLayoutState.m2115setMinHeightForSingleLineField0680j_4(fM8830constructorimpl);
        LinkedHashMap linkedHashMap = this.baselineCache;
        if (linkedHashMap == null) {
            linkedHashMap = new LinkedHashMap(2);
        }
        linkedHashMap.put(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(Math.round(textLayoutResultM2114layoutWithNewMeasureInputshBUhpc.getFirstBaseline())));
        linkedHashMap.put(AlignmentLineKt.getLastBaseline(), Integer.valueOf(Math.round(textLayoutResultM2114layoutWithNewMeasureInputshBUhpc.getLastBaseline())));
        this.baselineCache = linkedHashMap;
        int size = (int) (textLayoutResultM2114layoutWithNewMeasureInputshBUhpc.getSize() >> 32);
        int size2 = (int) (textLayoutResultM2114layoutWithNewMeasureInputshBUhpc.getSize() & 4294967295L);
        ...
        return measureScope.layout(size, size2, map, new Function1() { // from class: androidx.compose.foundation.text.input.internal.TextFieldTextLayoutModifierNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return TextFieldTextLayoutModifierNode.measure_3p2s80s$lambda$0(placeableMo7445measureBRTryo0, (Placeable.PlacementScope) obj);
            }
        });
    }
