...
public final class SelectionMovementDeletionContext {
    ...
    public SelectionMovementDeletionContext(TransformedTextFieldState transformedTextFieldState, TextLayoutResult textLayoutResult, boolean z, float f2, TextFieldPreparedSelectionState textFieldPreparedSelectionState) {
    ...
    public final void m2153setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m8268getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m8268getEndimpl(this.selection));
    }
    ...
    public final SelectionMovementDeletionContext moveCursorUpByLine() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(RangesKt.coerceAtLeast(iJumpByLinesOffset, 0), iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
            }
            if (wedgeAffinityM2141component2impl != null) {
                setWedgeAffinity(wedgeAffinityM2141component2impl);
            }
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext moveCursorDownByLine() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(RangesKt.coerceAtMost(iJumpByLinesOffset, this.text.length()), iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    private final boolean isLtr() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        return textLayoutResult == null || (paragraphDirection = textLayoutResult.getParagraphDirection(TextRange.m8268getEndimpl(this.selection))) == null || paragraphDirection == ResolvedTextDirection.Ltr;
    }
    ...
    static /* synthetic */ int getNextWordOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m8268getEndimpl(selectionMovementDeletionContext.selection);
        }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.initialValue.length()) {
            long jM8245getWordBoundaryjx7JFs = textLayoutResult.m8245getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m8268getEndimpl(jM8245getWordBoundaryjx7JFs) > i) {
                return TextRange.m8268getEndimpl(jM8245getWordBoundaryjx7JFs);
            }
            i++;
        }
    ...
    private final int getPrevWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            long jM8245getWordBoundaryjx7JFs = textLayoutResult.m8245getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m8273getStartimpl(jM8245getWordBoundaryjx7JFs) < i) {
                return TextRange.m8273getStartimpl(jM8245getWordBoundaryjx7JFs);
            }
            i--;
        }
        return 0;
    ...
    static /* synthetic */ int getLineStartByOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m8271getMinimpl(selectionMovementDeletionContext.selection);
        }
    ...
    static /* synthetic */ int getLineEndByOffsetForLayout$default(SelectionMovementDeletionContext selectionMovementDeletionContext, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m8270getMaximpl(selectionMovementDeletionContext.selection);
        }
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        int iM8268getEndimpl = TextRange.m8268getEndimpl(this.selection);
        if (Float.isNaN(this.textPreparedSelectionState.getCachedX())) {
            this.textPreparedSelectionState.setCachedX(textLayoutResult.getCursorRect(iM8268getEndimpl).getLeft());
        }
        int lineForOffset = textLayoutResult.getLineForOffset(iM8268getEndimpl) + i;
        if (lineForOffset < 0) {
        ...
        return textLayoutResult.m8243getOffsetForPositionk4lQ0M(Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(cachedX)) << 32) | (((long) Float.floatToRawIntBits(lineBottom)) & 4294967295L)));
    }

    private final int jumpByPagesOffset(int pagesAmount) {
        int iM8268getEndimpl = TextRange.m8268getEndimpl(this.initialValue.getSelection());
        if (this.textLayoutResult == null || Float.isNaN(this.visibleTextLayoutHeight)) {
            return iM8268getEndimpl;
        }
        Rect rectTranslate = this.textLayoutResult.getCursorRect(iM8268getEndimpl).translate(0.0f, this.visibleTextLayoutHeight * pagesAmount);
        ...
        if (Math.abs(rectTranslate.getTop() - lineBottom) > Math.abs(rectTranslate.getBottom() - lineBottom)) {
            return this.textLayoutResult.m8243getOffsetForPositionk4lQ0M(rectTranslate.m5758getTopLeftF1C5BW0());
        }
        return this.textLayoutResult.m8243getOffsetForPositionk4lQ0M(rectTranslate.m5751getBottomLeftF1C5BW0());
    }
    ...
    public final SelectionMovementDeletionContext deselect() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m8268getEndimpl(this.selection));
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext collapseLeftOr(Function1<? super SelectionMovementDeletionContext, Unit> or) {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            if (TextRange.m8267getCollapsedimpl(this.selection)) {
                or.invoke(this);
                return this;
            }
            if (isLtr()) {
                this.selection = TextRangeKt.TextRange(TextRange.m8271getMinimpl(this.selection));
                return this;
            }
            this.selection = TextRangeKt.TextRange(TextRange.m8270getMaximpl(this.selection));
        }
        return this;
    }
    ...
    private final SelectionMovementDeletionContext moveCursorTo(boolean resetCachedX, Function0<Integer> proposedCursorMovement) {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(proposedCursorMovement.invoke().intValue(), iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    static /* synthetic */ SelectionMovementDeletionContext moveCursorTo$default(SelectionMovementDeletionContext selectionMovementDeletionContext, boolean z, Function0 function0, int i, Object obj) {
        ...
        if (selectionMovementDeletionContext.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(selectionMovementDeletionContext.getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(((Number) function0.invoke()).intValue(), iM8268getEndimpl, selectionMovementDeletionContext.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(selectionMovementDeletionContext.getSelection())) {
                selectionMovementDeletionContext.m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
            }
            if (wedgeAffinityM2141component2impl != null) {
                selectionMovementDeletionContext.setWedgeAffinity(wedgeAffinityM2141component2impl);
            }
        }
        return selectionMovementDeletionContext;
    }
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByCodePointOrEmoji() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findCodePointOrEmojiStartBefore(this.text, TextRange.m8268getEndimpl(this.selection), -1), iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByChar() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m8268getEndimpl(this.selection)), iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByChar() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m8268getEndimpl(this.selection)), iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToHome() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(0, iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToEnd() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(this.text.length(), iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByWord() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getNextWordOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : this.text.length(), iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByWord() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getPrevWordOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : 0, iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorPrevByParagraph() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            int iFindParagraphStart = StringHelpersKt.findParagraphStart(this.text, TextRange.m8271getMinimpl(this.selection));
            if (iFindParagraphStart == TextRange.m8271getMinimpl(this.selection) && iFindParagraphStart != 0) {
                iFindParagraphStart = StringHelpersKt.findParagraphStart(this.text, iFindParagraphStart - 1);
            }
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(iFindParagraphStart, iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorNextByParagraph() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            int iFindParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, TextRange.m8270getMaximpl(this.selection));
            if (iFindParagraphEnd == TextRange.m8270getMaximpl(this.selection) && iFindParagraphEnd != this.text.length()) {
                iFindParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, iFindParagraphEnd + 1);
            }
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(iFindParagraphEnd, iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToLineStart() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getLineStartByOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : 0, iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorToLineEnd() {
        ...
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            TextLayoutResult textLayoutResult = this.textLayoutResult;
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(textLayoutResult != null ? getLineEndByOffsetForLayout$default(this, textLayoutResult, 0, 1, null) : this.text.length(), iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    public final SelectionMovementDeletionContext moveCursorUpByPage() {
        if (this.text.length() > 0) {
            int iM8268getEndimpl = TextRange.m8268getEndimpl(getSelection());
            long jCalculateNextCursorPositionAndWedgeAffinity = TextPreparedSelectionKt.calculateNextCursorPositionAndWedgeAffinity(jumpByPagesOffset(-1), iM8268getEndimpl, this.state);
            int iM2140component1impl = CursorAndWedgeAffinity.m2140component1impl(jCalculateNextCursorPositionAndWedgeAffinity);
            WedgeAffinity wedgeAffinityM2141component2impl = CursorAndWedgeAffinity.m2141component2impl(jCalculateNextCursorPositionAndWedgeAffinity);
            if (iM2140component1impl != iM8268getEndimpl || !TextRange.m8267getCollapsedimpl(getSelection())) {
                m2153setSelection5zctL8(TextRangeKt.TextRange(iM2140component1impl));
    ...
    public final SelectionMovementDeletionContext selectMovement() {
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m8273getStartimpl(this.initialValue.getSelection()), TextRange.m8268getEndimpl(this.selection));
        }
        return this;
    }
    ...
    public final SelectionMovementDeletionContext deleteMovement() {
        if (this.text.length() > 0) {
            if (!TextRange.m8267getCollapsedimpl(this.initialValue.getSelection())) {
                this.state.deleteSelectedText();
            } else {
                TransformedTextFieldState.m2124replaceTextM8tDOmk$default(this.state, "", TextRangeKt.TextRange(TextRange.m8273getStartimpl(this.initialValue.getSelection()), TextRange.m8268getEndimpl(this.selection)), null, !this.isFromSoftKeyboard, 4, null);
            }
