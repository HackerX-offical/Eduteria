...
public final class TextUndoOperationKt {
    public static final void undo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        TextFieldBufferKt.setSelectionCoerced(mainBuffer, TextRange.m8273getStartimpl(textUndoOperation.getPreSelection()), TextRange.m8268getEndimpl(textUndoOperation.getPreSelection()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation(), TextFieldBuffer.m1918toTextFieldCharSequencewFTz33Y$foundation$default(textFieldState.getMainBuffer(), 0L, null, null, null, 15, null), true);
    }
    ...
    public static final void redo(TextFieldState textFieldState, TextUndoOperation textUndoOperation) {
        ...
        TextFieldBufferKt.setSelectionCoerced(mainBuffer, TextRange.m8273getStartimpl(textUndoOperation.getPostSelection()), TextRange.m8268getEndimpl(textUndoOperation.getPostSelection()));
        textFieldState.updateValueAndNotifyListeners(textFieldState.getValue$foundation(), TextFieldBuffer.m1918toTextFieldCharSequencewFTz33Y$foundation$default(textFieldState.getMainBuffer(), 0L, null, null, null, 15, null), true);
    }
}
