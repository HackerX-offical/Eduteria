...
public final class MinLinesConstrainer {
    ...
    public final long m2223coerceMinLinesOh53vG4$foundation(long inConstraints, int minLines) {
        ...
        if (Float.isNaN(height) || Float.isNaN(height2)) {
            height = ParagraphKt.m8126ParagraphUl8oQg4(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 1, (64 & 256) != 0 ? TextOverflow.INSTANCE.m8765getClipgIe3tQ8() : TextOverflow.INSTANCE.m8765getClipgIe3tQ8()).getHeight();
            height2 = ParagraphKt.m8126ParagraphUl8oQg4(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (64 & 32) != 0 ? CollectionsKt.emptyList() : null, (64 & 64) != 0 ? CollectionsKt.emptyList() : null, (64 & 128) != 0 ? Integer.MAX_VALUE : 2, (64 & 256) != 0 ? TextOverflow.INSTANCE.m8765getClipgIe3tQ8() : TextOverflow.INSTANCE.m8765getClipgIe3tQ8()).getHeight() - height;
            this.oneLineHeightCache = height;
            this.lineHeightCache = height2;
        }
        if (minLines != 1) {
            iM8784getMinHeightimpl = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(Math.round(height + (height2 * (minLines - 1))), 0), Constraints.m8782getMaxHeightimpl(inConstraints));
        } else {
            iM8784getMinHeightimpl = Constraints.m8784getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m8785getMinWidthimpl(inConstraints), Constraints.m8783getMaxWidthimpl(inConstraints), iM8784getMinHeightimpl, Constraints.m8782getMaxHeightimpl(inConstraints));
    }
}
