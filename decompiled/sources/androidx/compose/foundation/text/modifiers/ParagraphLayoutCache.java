...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3) {
        ...
        long j = 0;
        this.layoutSize = IntSize.m8996constructorimpl((j & 4294967295L) | (j << 32));
        this.prevConstraints = Constraints.INSTANCE.m8793fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m8765getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final void setDensity$foundation(Density density) {
        ...
        if (density2 == null) {
            ...
            this.density = density;
            this.lastDensity = jM2199constructorimpl;
            m2239recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m2216getMarkDirtyDensityDEKiAbY());
            markDirty();
        }
    }
    ...
    public final void m2245setLayoutSizeozmzZPI$foundation(long j) {
        this.layoutSize = j;
    }
    ...
    private final void m2239recordHistory4ETZmGE(long op) {
        this.historyFlag = op | (this.historyFlag << 2);
    }

    /* JADX INFO: renamed from: layoutWithConstraints-K40F9xA, reason: not valid java name */
    public final boolean m2244layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphLayoutCache paragraphLayoutCache;
        LayoutDirection layoutDirection2;
        m2239recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m2215getLayoutWithConstraintsDEKiAbY());
        boolean z = true;
        if (this.minLines > 1) {
            paragraphLayoutCache = this;
            layoutDirection2 = layoutDirection;
            constraints = m2241useMinLinesConstrainereuUD3Qg$default(paragraphLayoutCache, constraints, layoutDirection2, null, 4, null);
        } else {
            paragraphLayoutCache = this;
            layoutDirection2 = layoutDirection;
        }
        boolean z2 = false;
        if (!m2238newLayoutWillBeDifferentK40F9xA(constraints, layoutDirection2)) {
            if (!Constraints.m8776equalsimpl0(constraints, paragraphLayoutCache.prevConstraints)) {
                Paragraph paragraph = paragraphLayoutCache.paragraph;
                Intrinsics.checkNotNull(paragraph);
                paragraphLayoutCache.layoutSize = ConstraintsKt.m8797constrain4WqzIAM(constraints, IntSize.m8996constructorimpl((((long) TextDelegateKt.ceilToIntPx(Math.min(paragraph.getMaxIntrinsicWidth(), paragraph.getWidth()))) << 32) | (((long) TextDelegateKt.ceilToIntPx(paragraph.getHeight())) & 4294967295L)));
                if (TextOverflow.m8756equalsimpl0(paragraphLayoutCache.overflow, TextOverflow.INSTANCE.m8769getVisiblegIe3tQ8()) || (((int) (r7 >> 32)) >= paragraph.getWidth() && ((int) (4294967295L & r7)) >= paragraph.getHeight())) {
                    z = false;
                }
        ...
        Paragraph paragraphM2243layoutTextK40F9xA$foundation = m2243layoutTextK40F9xA$foundation(constraints, layoutDirection2);
        paragraphLayoutCache.prevConstraints = constraints;
        paragraphLayoutCache.layoutSize = ConstraintsKt.m8797constrain4WqzIAM(constraints, IntSize.m8996constructorimpl((((long) TextDelegateKt.ceilToIntPx(paragraphM2243layoutTextK40F9xA$foundation.getWidth())) << 32) | (((long) TextDelegateKt.ceilToIntPx(paragraphM2243layoutTextK40F9xA$foundation.getHeight())) & 4294967295L)));
        if (!TextOverflow.m8756equalsimpl0(paragraphLayoutCache.overflow, TextOverflow.INSTANCE.m8769getVisiblegIe3tQ8()) && (((int) (r13 >> 32)) < paragraphM2243layoutTextK40F9xA$foundation.getWidth() || ((int) (r13 & 4294967295L)) < paragraphM2243layoutTextK40F9xA$foundation.getHeight())) {
            z2 = true;
        }
        paragraphLayoutCache.didOverflow = z2;
        paragraphLayoutCache.paragraph = paragraphM2243layoutTextK40F9xA$foundation;
        return true;
    }

    /* JADX INFO: renamed from: useMinLinesConstrainer-euUD3Qg$default, reason: not valid java name */
    static /* synthetic */ long m2241useMinLinesConstrainereuUD3Qg$default(ParagraphLayoutCache paragraphLayoutCache, long j, LayoutDirection layoutDirection, TextStyle textStyle, int i, Object obj) {
        if ((i & 4) != 0) {
            textStyle = paragraphLayoutCache.style;
        }
        return paragraphLayoutCache.m2240useMinLinesConstrainereuUD3Qg(j, layoutDirection, textStyle);
    }

    /* JADX INFO: renamed from: useMinLinesConstrainer-euUD3Qg, reason: not valid java name */
    private final long m2240useMinLinesConstrainereuUD3Qg(long constraints, LayoutDirection layoutDirection, TextStyle style) {
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            paragraphLayoutCache = this;
            layoutDirection2 = layoutDirection;
            jConstraints = m2241useMinLinesConstrainereuUD3Qg$default(paragraphLayoutCache, jConstraints, layoutDirection2, null, 4, null);
        } else {
            paragraphLayoutCache = this;
            layoutDirection2 = layoutDirection;
        }
        int iCoerceAtLeast = RangesKt.coerceAtLeast(TextDelegateKt.ceilToIntPx(m2243layoutTextK40F9xA$foundation(jConstraints, layoutDirection2).getHeight()), Constraints.m8784getMinHeightimpl(jConstraints));
    ...
    public final void m2246updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        this.text = text;
        this.style = style;
        ...
        m2239recordHistory4ETZmGE(LayoutCacheOperation.INSTANCE.m2217getMarkDirtyNodeDEKiAbY());
        markDirty();
    }
    ...
    public final Paragraph m2243layoutTextK40F9xA$foundation(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return ParagraphKt.m8130ParagraphczeNHc(layoutDirection2, LayoutUtilsKt.m2219finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m2220finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), this.overflow);
    }

    /* JADX INFO: renamed from: newLayoutWillBeDifferent-K40F9xA, reason: not valid java name */
    private final boolean m2238newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m8776equalsimpl0(constraints, this.prevConstraints)) {
            return false;
        }
        return Constraints.m8783getMaxWidthimpl(constraints) != Constraints.m8783getMaxWidthimpl(this.prevConstraints) || Constraints.m8785getMinWidthimpl(constraints) != Constraints.m8785getMinWidthimpl(this.prevConstraints) || ((float) Constraints.m8782getMaxHeightimpl(constraints)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull(TextStyle style) {
        ...
        long jM8771constructorimpl = Constraints.m8771constructorimpl(this.prevConstraints & ConstraintsKt.MaxDimensionsAndFocusMask);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, jM8771constructorimpl, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), density, this.fontFamilyResolver), jM8771constructorimpl, this.maxLines, this.overflow, (DefaultConstructorMarker) null), this.layoutSize, null);
    }
    ...
    public String toString() {
        return "ParagraphLayoutCache(paragraph=" + (this.paragraph != null ? "<paragraph>" : Constants.NULL_VERSION_ID) + ", lastDensity=" + ((Object) InlineDensity.m2205toStringimpl(this.lastDensity)) + ", history=" + this.historyFlag + ", constraints=$)";
    }
}
