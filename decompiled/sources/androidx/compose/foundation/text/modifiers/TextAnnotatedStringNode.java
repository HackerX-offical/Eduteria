...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final boolean m2264updateLayoutRelatedArgsy0kMQk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow, TextAutoSize autoSize) {
        ...
        if (!TextOverflow.m8756equalsimpl0(this.overflow, overflow)) {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m2234updateJ2qo7bo(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders, this.autoSize);
        }
        if (getIsAttached()) {
    ...
    private final boolean setSubstitution(AnnotatedString updatedText) {
        ...
        if (textSubstitutionValue != null) {
            ...
            layoutCache.m2234updateJ2qo7bo(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, CollectionsKt.emptyList(), this.autoSize);
            return true;
        }
    ...
    */
    public static final boolean applySemantics$lambda$0(androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode r37, java.util.List r38) {
        /*
            r0 = r37
        ...
        L27:
            ...
            r33 = 0
            r34 = 0
            androidx.compose.ui.text.TextStyle r5 = androidx.compose.ui.text.TextStyle.m8293mergedA7vx0o$default(r5, r6, r8, r10, r11, r12, r13, r14, r15, r17, r18, r19, r20, r22, r23, r24, r25, r26, r27, r29, r30, r31, r32, r33, r34, r35, r36)
            ...
            r7 = 0
            r4 = 0
            androidx.compose.ui.text.TextLayoutResult r0 = androidx.compose.ui.text.TextLayoutResult.m8241copyO0kMr_c$default(r2, r3, r4, r6, r7)
            if (r0 == 0) goto Lae
            r1 = r38
            r1.add(r0)
            goto Laf
    ...
    public final MeasureResult m2263measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        return mo72measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        try {
            ...
            boolean zM2233layoutWithConstraintsK40F9xA = layoutCache.m2233layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
            ...
            if (zM2233layoutWithConstraintsK40F9xA) {
            ...
            final Placeable placeableMo7445measureBRTryo0 = measurable.mo7445measureBRTryo0(Constraints.INSTANCE.m8792fitPrioritizingWidthZbe2FdA((int) (textLayoutResult.getSize() >> 32), (int) (textLayoutResult.getSize() >> 32), (int) (textLayoutResult.getSize() & 4294967295L), (int) (textLayoutResult.getSize() & 4294967295L)));
            ...
            return measureScope.layout(size, size2, map, new Function1() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return TextAnnotatedStringNode.measure_3p2s80s$lambda$0$0(placeableMo7445measureBRTryo0, (Placeable.PlacementScope) obj);
                }
            });
        } finally {
            Trace.endSection();
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        if (getIsAttached()) {
            ...
            boolean z = true;
            boolean z2 = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m8756equalsimpl0(this.overflow, TextOverflow.INSTANCE.m8769getVisiblegIe3tQ8());
            if (z2) {
                Rect rectM5763Recttz77jQw = RectKt.m5763Recttz77jQw(Offset.INSTANCE.m5739getZeroF1C5BW0(), Size.m5783constructorimpl((((long) Float.floatToRawIntBits((int) (textLayoutResult.getSize() >> 32))) << 32) | (((long) Float.floatToRawIntBits((int) (textLayoutResult.getSize() & 4294967295L))) & 4294967295L)));
                canvas.save();
                Canvas.m5941clipRectmtrdDE$default(canvas, rectM5763Recttz77jQw, 0, 2, null);
            }
            try {
                ...
                if (brush != null) {
                    MultiParagraph.m8105painthn5TExg$default(multiParagraph, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
                } else {
                    ColorProducer colorProducer = this.overrideColor;
                    long jMo2834invoke0d7_KjU = colorProducer != null ? colorProducer.mo2834invoke0d7_KjU() : Color.INSTANCE.m6004getUnspecified0d7_KjU();
                    if (jMo2834invoke0d7_KjU == 16) {
                        if (this.style.m8303getColor0d7_KjU() != 16) {
                            jMo2834invoke0d7_KjU = this.style.m8303getColor0d7_KjU();
                        } else {
                            jMo2834invoke0d7_KjU = Color.INSTANCE.m5994getBlack0d7_KjU();
                        }
                    }
                    multiParagraph.m8110paintLG529CI(canvas, (30 & 2) != 0 ? Color.INSTANCE.m6004getUnspecified0d7_KjU() : jMo2834invoke0d7_KjU, (30 & 4) != 0 ? null : shadow2, (30 & 8) != 0 ? null : textDecoration2, (30 & 16) == 0 ? drawStyle2 : null, (30 & 32) != 0 ? DrawScope.INSTANCE.m6551getDefaultBlendMode0nO6VwU() : 0);
                }
                TextSubstitutionValue textSubstitutionValue = this.textSubstitution;
