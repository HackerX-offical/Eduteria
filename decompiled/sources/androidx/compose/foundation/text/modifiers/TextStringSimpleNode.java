...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m8765getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
    ...
    private final ParagraphLayoutCache getLayoutCache() {
        ...
        if (this._layoutCache == null) {
            this._layoutCache = new ParagraphLayoutCache(this.text, textStyle2, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, null);
        }
    ...
    private final ParagraphLayoutCache getLayoutCacheForMeasure(IntrinsicMeasureScope intrinsicMeasureScope) {
        if (ComposeFoundationFlags.isInheritedTextStyleEnabled && m2266resolveInheritedStyleuwmK9pY(StylePhase.INSTANCE.m2259getLayoutoWBPZag())) {
            TextStyle textStyle = this.resolvedInheritedStyle;
            if (textStyle == null) {
                textStyle = this.style;
            }
            getLayoutCache().m2246updateL6sJoHM(this.text, textStyle, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
        }
    ...
    private final boolean m2266resolveInheritedStyleuwmK9pY(int phase) {
        TextStyle textStyle = this.resolvedInheritedStyle;
        this.resolvedInheritedStyle = TextStyleProviderNodeKt.m2269inheritedTextStyleBh5OqGs(this, phase, this.style);
        if (textStyle == null) {
            return false;
        }
        return !Intrinsics.areEqual(textStyle, r4);
    }
    ...
    public final boolean m2267updateLayoutRelatedArgsHuAbxIM(TextStyle style, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged) {
        ...
        if (textChanged || layoutChanged) {
            getLayoutCache().m2246updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
        }
        if (getIsAttached()) {
    ...
    private final boolean setSubstitution(String updatedText) {
        ...
        if (textSubstitutionValue != null) {
            ...
            layoutCache.m2246updateL6sJoHM(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
            return true;
        }
    ...
    public static final boolean applySemantics$lambda$0(TextStringSimpleNode textStringSimpleNode, List list) {
        ...
        TextLayoutResult textLayoutResultSlowCreateTextLayoutResultOrNull = layoutCache.slowCreateTextLayoutResultOrNull(TextStyle.m8293mergedA7vx0o$default(textStyle, colorProducer != null ? colorProducer.mo2834invoke0d7_KjU() : Color.INSTANCE.m6004getUnspecified0d7_KjU(), 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, 0, 0, null, null, 16777214, null));
    ...
    public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        try {
            ...
            boolean zM2244layoutWithConstraintsK40F9xA = layoutCacheForMeasure.m2244layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
            ...
            if (zM2244layoutWithConstraintsK40F9xA) {
            ...
            final Placeable placeableMo7445measureBRTryo0 = measurable.mo7445measureBRTryo0(Constraints.INSTANCE.m8792fitPrioritizingWidthZbe2FdA(i, i, i2, i2));
            ...
            return measureScope.layout(i, i2, map2, new Function1() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$$ExternalSyntheticLambda4
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return TextStringSimpleNode.measure_3p2s80s$lambda$0$0(placeableMo7445measureBRTryo0, (Placeable.PlacementScope) obj);
                }
            });
        } finally {
            Trace.endSection();
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (getIsAttached()) {
            ...
            if (didOverflow) {
                ...
                canvas.save();
                Canvas.m5940clipRectN_I0leg$default(canvas, 0.0f, 0.0f, layoutSize, layoutSize2, 0, 16, null);
            }
            try {
                if (ComposeFoundationFlags.isInheritedTextStyleEnabled) {
                    m2266resolveInheritedStyleuwmK9pY(StylePhase.INSTANCE.m2258getDrawoWBPZag());
                ...
                Fill drawStyle = textStyle.getDrawStyle();
                if (drawStyle == null) {
                ...
                if (brush != null) {
                    Paragraph.m8117painthn5TExg$default(paragraph, canvas, brush, textStyle.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
                } else {
                    ...
                    if (jMo2834invoke0d7_KjU == 16) {
                        if (textStyle.m8303getColor0d7_KjU() != 16) {
                            jMo2834invoke0d7_KjU = textStyle.m8303getColor0d7_KjU();
                        } else {
                            jMo2834invoke0d7_KjU = Color.INSTANCE.m5994getBlack0d7_KjU();
                        }
                    }
                    Paragraph.m8115paintLG529CI$default(paragraph, canvas, jMo2834invoke0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
                }
            } finally {
                if (didOverflow) {
                    canvas.restore();
