...
final class MultiSelectionLayout implements SelectionLayout {
    ...
    public String toString() {
        boolean z = true;
        float f2 = 2;
        StringBuilder sbAppend = new StringBuilder("MultiSelectionLayout(isStartHandle=").append(getIsStartHandle()).append(", startPosition=").append((getStartSlot() + 1) / f2).append(", endPosition=").append((getEndSlot() + 1) / f2).append(", crossed=").append(getCrossStatus()).append(", infos=");
        ...
        sb.append("\n]");
        return sbAppend.append(sb.toString()).append(')').toString();
    }
