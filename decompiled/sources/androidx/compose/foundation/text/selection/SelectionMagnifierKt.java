...
public final class SelectionMagnifierKt {
    ...
    static {
        long jM5715constructorimpl = Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(0.01f)) << 32) | (((long) Float.floatToRawIntBits(0.01f)) & 4294967295L));
        OffsetDisplacementThreshold = jM5715constructorimpl;
        MagnifierSpringSpec = new SpringSpec<>(0.0f, 0.0f, Offset.m5712boximpl(jM5715constructorimpl), 3, null);
    }
    ...
    public static final AnimationVector2D UnspecifiedSafeOffsetVectorConverter$lambda$0(Offset offset) {
        if ((offset.m5733unboximpl() & 9223372034707292159L) != InlineClassHelperKt.UnspecifiedPackedFloats) {
            return new AnimationVector2D(Float.intBitsToFloat((int) (offset.m5733unboximpl() >> 32)), Float.intBitsToFloat((int) (offset.m5733unboximpl() & 4294967295L)));
        }
    ...
    public static final Offset UnspecifiedSafeOffsetVectorConverter$lambda$1(AnimationVector2D animationVector2D) {
        ...
        return Offset.m5712boximpl(Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(v1)) << 32) | (((long) Float.floatToRawIntBits(v2)) & 4294967295L)));
    }
    ...
    public static final Offset animatedSelectionMagnifier$lambda$0$1$0(State state) {
        return Offset.m5712boximpl(animatedSelectionMagnifier$lambda$0$0(state));
    }
    ...
    private static final State<Offset> rememberAnimatedMagnifierPosition(Function0<Offset> function0, Composer composer, int i) {
        ...
        if (objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
            Object animatable = new Animatable(Offset.m5712boximpl(rememberAnimatedMagnifierPosition$lambda$1(state)), UnspecifiedSafeOffsetVectorConverter, Offset.m5712boximpl(OffsetDisplacementThreshold), null, 8, null);
    ...
    private static final long animatedSelectionMagnifier$lambda$0$0(State<Offset> state) {
        return state.getValue().m5733unboximpl();
    }
