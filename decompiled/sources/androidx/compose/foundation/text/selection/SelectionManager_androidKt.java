...
public final class SelectionManager_androidKt {
    ...
    public static final boolean m2345isCopyKeyEventZmokQxo(KeyEvent keyEvent) {
        return KeyMapping_androidKt.getPlatformDefaultKeyMapping().mo1717mapZmokQxo(keyEvent) == KeyCommand.COPY;
    }
    ...
    public static final Offset selectionMagnifier$lambda$0$3$0(SelectionManager selectionManager, MutableState mutableState) {
        return Offset.m5712boximpl(SelectionManagerKt.m2339calculateSelectionMagnifierCenterAndroidO0kMr_c(selectionManager, selectionMagnifier$lambda$0$1(mutableState)));
    }
    ...
    public static final Modifier selectionMagnifier$lambda$0$4$0(final Density density, final MutableState mutableState, final Function0 function0) {
        return Magnifier_androidKt.m398magnifierjPUL71Q$default(Modifier.INSTANCE, new Function1() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$$ExternalSyntheticLambda10
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final Unit selectionMagnifier$lambda$0$4$0$1(Density density, MutableState mutableState, DpSize dpSize) {
        selectionMagnifier$lambda$0$2(mutableState, IntSize.m8996constructorimpl((((long) density.mo482roundToPx0680j_4(DpSize.m8928getWidthD9Ej5fM(dpSize.getPackedValue()))) << 32) | (((long) density.mo482roundToPx0680j_4(DpSize.m8926getHeightD9Ej5fM(dpSize.getPackedValue()))) & 4294967295L)));
