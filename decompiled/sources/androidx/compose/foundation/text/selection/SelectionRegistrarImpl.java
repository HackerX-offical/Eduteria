...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
        ...
        if (!this.sorted) {
            ...
            CollectionsKt.sortWith(list, new Comparator() { // from class: androidx.compose.foundation.text.selection.SelectionRegistrarImpl$$ExternalSyntheticLambda3
                ...
                public final int compare(Object obj, Object obj2) {
                    return SelectionRegistrarImpl.sort$lambda$1(function2, obj, obj2);
                }
            });
            this.sorted = true;
        }
    ...
    public static final int sort$lambda$0(LayoutCoordinates layoutCoordinates, Selectable selectable, Selectable selectable2) {
        ...
        long jM5739getZeroF1C5BW02;
        long jM5739getZeroF1C5BW03;
        long jM5739getZeroF1C5BW04;
        ...
        if (layoutCoordinates2 != null) {
            jM5739getZeroF1C5BW0 = layoutCoordinates.mo7454localPositionOfR5De75A(layoutCoordinates2, Offset.INSTANCE.m5739getZeroF1C5BW0());
            float fIntBitsToFloat = Float.intBitsToFloat((int) (jM5739getZeroF1C5BW0 >> 32)) + ((int) (layoutCoordinates2.mo7453getSizeYbymL2g() >> 32));
            jM5739getZeroF1C5BW02 = Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (jM5739getZeroF1C5BW0 & 4294967295L)) + ((int) (layoutCoordinates2.mo7453getSizeYbymL2g() & 4294967295L)))) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat) << 32));
        } else {
            jM5739getZeroF1C5BW0 = Offset.INSTANCE.m5739getZeroF1C5BW0();
            jM5739getZeroF1C5BW02 = Offset.INSTANCE.m5739getZeroF1C5BW0();
        }
        long j = jM5739getZeroF1C5BW0;
        long j2 = jM5739getZeroF1C5BW02;
        if (layoutCoordinates3 != null) {
            jM5739getZeroF1C5BW03 = layoutCoordinates.mo7454localPositionOfR5De75A(layoutCoordinates3, Offset.INSTANCE.m5739getZeroF1C5BW0());
            float fIntBitsToFloat2 = Float.intBitsToFloat((int) (jM5739getZeroF1C5BW03 >> 32)) + ((int) (layoutCoordinates3.mo7453getSizeYbymL2g() >> 32));
            jM5739getZeroF1C5BW04 = Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (jM5739getZeroF1C5BW03 & 4294967295L)) + ((int) (layoutCoordinates3.mo7453getSizeYbymL2g() & 4294967295L)))) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat2) << 32));
        } else {
            jM5739getZeroF1C5BW03 = Offset.INSTANCE.m5739getZeroF1C5BW0();
            jM5739getZeroF1C5BW04 = Offset.INSTANCE.m5739getZeroF1C5BW0();
        }
        long j3 = jM5739getZeroF1C5BW03;
        if (SelectionRegistrarImplKt.m2351inARowzwwh4xc(j, j2, j3, jM5739getZeroF1C5BW04)) {
    ...
    public void mo2350notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m5712boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo2349notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function6 != null) {
            return function6.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m5712boximpl(newPosition), Offset.m5712boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }
