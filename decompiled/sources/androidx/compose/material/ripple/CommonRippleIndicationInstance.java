...
final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        float fM2392getRippleEndRadiuscSwnlzA;
        if (Float.isNaN(this.radius)) {
            fM2392getRippleEndRadiuscSwnlzA = RippleAnimationKt.m2392getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo6549getSizeNHjbRc());
        } else {
            fM2392getRippleEndRadiuscSwnlzA = contentDrawScope.mo488toPx0680j_4(this.radius);
        }
        this.targetRadius = fM2392getRippleEndRadiuscSwnlzA;
        ...
        m2389drawRipples4WTKRHQ(contentDrawScope2, jM5978unboximpl);
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(this.bounded ? Offset.m5712boximpl(interaction.getPressPosition()) : null, this.targetRadius, this.bounded, null);
    ...
    private final void m2389drawRipples4WTKRHQ(DrawScope drawScope, long j) {
        long j2;
        Iterator<Map.Entry<PressInteraction.Press, RippleAnimation>> it = this.ripples.entrySet().iterator();
        while (it.hasNext()) {
            ...
            if (pressedAlpha == 0.0f) {
                ...
                j2 = j;
                value.m2391draw4WTKRHQ(drawScope, Color.m5967copywmQWz5c$default(j2, pressedAlpha, 0.0f, 0.0f, 0.0f, 14, null));
            }
            j = j2;
        }
    }
