...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo2390defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long jM2403defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m2403defaultRippleColor5vOe2sY(Color.INSTANCE.m5994getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return jM2403defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha rippleAlphaM2402defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m2402defaultRippleAlphaDxMtmZc(Color.INSTANCE.m5994getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return rippleAlphaM2402defaultRippleAlphaDxMtmZc;
    }
}
