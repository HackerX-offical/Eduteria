...
public abstract class Ripple implements Indication {
    ...
    public abstract RippleIndicationInstance mo2388rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z, float f2, State<Color> state, State<RippleAlpha> state2, Composer composer, int i);
    ...
    public final IndicationInstance rememberUpdatedInstance(InteractionSource interactionSource, Composer composer, int i) {
        long jMo2390defaultColorWaAFU9c;
        ...
        if (this.color.getValue().m5978unboximpl() != 16) {
            composer.startReplaceGroup(-303557454);
            composer.endReplaceGroup();
            jMo2390defaultColorWaAFU9c = this.color.getValue().m5978unboximpl();
        } else {
            composer.startReplaceGroup(-303499670);
            ComposerKt.sourceInformation(composer, "197@9735L14");
            jMo2390defaultColorWaAFU9c = rippleTheme.mo2390defaultColorWaAFU9c(composer, 0);
            composer.endReplaceGroup();
        }
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m5958boximpl(jMo2390defaultColorWaAFU9c), composer, 0);
        ...
        int i2 = i & 14;
        RippleIndicationInstance rippleIndicationInstanceMo2388rememberUpdatedRippleInstance942rkJo = mo2388rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, stateRememberUpdatedState, stateRememberUpdatedState2, composer, i2 | ((i << 12) & 458752));
        ComposerKt.sourceInformationMarkerStart(composer, -9777752, "CC(remember):Ripple.kt#9igjgp");
        boolean zChangedInstance = composer.changedInstance(rippleIndicationInstanceMo2388rememberUpdatedRippleInstance942rkJo) | (((i2 ^ 6) > 4 && composer.changed(interactionSource)) || (i & 6) == 4);
        ...
        if (zChangedInstance || ripple$rememberUpdatedInstance$1$1RememberedValue == Composer.INSTANCE.getEmpty()) {
            ripple$rememberUpdatedInstance$1$1RememberedValue = new Ripple$rememberUpdatedInstance$1$1(interactionSource, rippleIndicationInstanceMo2388rememberUpdatedRippleInstance942rkJo, null);
            composer.updateRememberedValue(ripple$rememberUpdatedInstance$1$1RememberedValue);
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(rippleIndicationInstanceMo2388rememberUpdatedRippleInstance942rkJo, interactionSource, (Function2) ripple$rememberUpdatedInstance$1$1RememberedValue, composer, (i << 3) & 112);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return rippleIndicationInstanceMo2388rememberUpdatedRippleInstance942rkJo;
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.bounded == ripple.bounded && Dp.m8835equalsimpl0(this.radius, ripple.radius) && Intrinsics.areEqual(this.color, ripple.color);
    }

    public int hashCode() {
        return (((Boolean.hashCode(this.bounded) * 31) + Dp.m8836hashCodeimpl(this.radius)) * 31) + this.color.hashCode();
    }
}
