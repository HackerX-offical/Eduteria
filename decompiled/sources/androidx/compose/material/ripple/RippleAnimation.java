...
public final class RippleAnimation {
    ...
    */
    ...
    static final class C03812 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03812 c03812 = RippleAnimation.this.new C03812(continuation);
            c03812.L$0 = obj;
            return c03812;
        }
    ...
    public final Object fadeOut(Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C03812(null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    public final void m2391draw4WTKRHQ(DrawScope drawScope, long j) {
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m2393getRippleStartRadiusuvyYCjk(drawScope.mo6549getSizeNHjbRc()));
        }
        if (this.origin == null) {
            this.origin = Offset.m5712boximpl(drawScope.mo6548getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m5712boximpl(OffsetKt.Offset(Size.m5792getWidthimpl(drawScope.mo6549getSizeNHjbRc()) / 2.0f, Size.m5789getHeightimpl(drawScope.mo6549getSizeNHjbRc()) / 2.0f));
        }
        ...
        float fM5723getXimpl = Offset.m5723getXimpl(offset.m5733unboximpl());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float fLerp2 = MathHelpersKt.lerp(fM5723getXimpl, Offset.m5723getXimpl(offset2.m5733unboximpl()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float fM5724getYimpl = Offset.m5724getYimpl(offset3.m5733unboximpl());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long jOffset = OffsetKt.Offset(fLerp2, MathHelpersKt.lerp(fM5724getYimpl, Offset.m5724getYimpl(offset4.m5733unboximpl()), this.animatedCenterPercent.getValue().floatValue()));
        long jM5967copywmQWz5c$default = Color.m5967copywmQWz5c$default(j, Color.m5970getAlphaimpl(j) * fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.m6530drawCircleVaOC9Bg$default(drawScope, jM5967copywmQWz5c$default, fLerp, jOffset, 0.0f, null, null, 0, 120, null);
            return;
        }
        float fM5792getWidthimpl = Size.m5792getWidthimpl(drawScope.mo6549getSizeNHjbRc());
        float fM5789getHeightimpl = Size.m5789getHeightimpl(drawScope.mo6549getSizeNHjbRc());
        ...
        try {
            drawContext.getTransform().mo6473clipRectN_I0leg(0.0f, 0.0f, fM5792getWidthimpl, fM5789getHeightimpl, iM5957getIntersectrtfAjoo);
            DrawScope.m6530drawCircleVaOC9Bg$default(drawScope, jM5967copywmQWz5c$default, fLerp, jOffset, 0.0f, null, null, 0, 120, null);
        } finally {
