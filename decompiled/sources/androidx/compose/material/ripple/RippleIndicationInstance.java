...
public abstract class RippleIndicationInstance implements IndicationInstance {
    ...
    public final void m2397drawStateLayerH2RKhps(DrawScope drawScope, float f2, long j) throws Throwable {
        float fM2392getRippleEndRadiuscSwnlzA;
        StateLayer stateLayer = this.stateLayer;
        if (Float.isNaN(f2)) {
            fM2392getRippleEndRadiuscSwnlzA = RippleAnimationKt.m2392getRippleEndRadiuscSwnlzA(drawScope, this.bounded, drawScope.mo6549getSizeNHjbRc());
        } else {
            fM2392getRippleEndRadiuscSwnlzA = drawScope.mo488toPx0680j_4(f2);
        }
        stateLayer.m2405drawStateLayermxwnekA(drawScope, fM2392getRippleEndRadiuscSwnlzA, j);
    }
}
