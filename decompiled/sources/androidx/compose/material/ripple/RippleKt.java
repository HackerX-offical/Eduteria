...
public final class RippleKt {
    ...
    public static final DelegatableNode m2398createRippleModifierNodeTDGSqEk(InteractionSource interactionSource, boolean z, float f2, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        return Ripple_androidKt.m2404createPlatformRippleNodeTDGSqEk(interactionSource, z, f2, colorProducer, function0);
    }
    ...
    public static final Indication m2399rememberRipple9IZ8Weo(boolean z, float f2, long j, Composer composer, int i, int i2) {
        ...
        State stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m5958boximpl(j), composer, (i >> 6) & 14);
