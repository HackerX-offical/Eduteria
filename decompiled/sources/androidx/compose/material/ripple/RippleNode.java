...
public abstract class RippleNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, DrawModifierNode, LayoutAwareModifierNode {
    ...
    public abstract void mo2387addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius);
    ...
    protected final void setTargetRadius(float f2) {
    ...
    public final long m2400getRippleColor0d7_KjU() {
        return this.color.mo2834invoke0d7_KjU();
    }
    ...
    public void mo477onRemeasuredozmzZPI(long size) {
        float fMo488toPx0680j_4;
        this.hasValidSize = true;
        Density densityRequireDensity = DelegatableNodeKt.requireDensity(this);
        this.rippleSize = IntSizeKt.m9013toSizeozmzZPI(size);
        if (Float.isNaN(this.radius)) {
            fMo488toPx0680j_4 = RippleAnimationKt.m2392getRippleEndRadiuscSwnlzA(densityRequireDensity, this.bounded, this.rippleSize);
        } else {
            fMo488toPx0680j_4 = densityRequireDensity.mo488toPx0680j_4(this.radius);
        }
        this.targetRadius = fMo488toPx0680j_4;
    ...
    public final void handlePressInteraction(PressInteraction pressInteraction) {
        if (pressInteraction instanceof PressInteraction.Press) {
            mo2387addRipple12SF9DM((PressInteraction.Press) pressInteraction, this.rippleSize, this.targetRadius);
    ...
    public void draw(ContentDrawScope contentDrawScope) throws Throwable {
        ...
        if (stateLayer != null) {
            stateLayer.m2405drawStateLayermxwnekA(contentDrawScope, this.targetRadius, m2400getRippleColor0d7_KjU());
        }
