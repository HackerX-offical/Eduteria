...
public interface RippleTheme {
    ...
    long mo2390defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m2403defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m6020luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m6005getWhite0d7_KjU();
        }
        ...
        public final RippleAlpha m2402defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            if (lightTheme) {
                return ((double) ColorKt.m6020luminance8_81llA(contentColor)) > 0.5d ? RippleThemeKt.LightThemeHighContrastRippleAlpha : RippleThemeKt.LightThemeLowContrastRippleAlpha;
            }
