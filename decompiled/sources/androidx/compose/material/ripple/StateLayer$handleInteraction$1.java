...
@DebugMetadata(c = "androidx.compose.material.ripple.StateLayer$handleInteraction$1", f = "Ripple.kt", i = {}, l = {WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND}, m = "invokeSuspend", n = {}, s = {})
final class StateLayer$handleInteraction$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    StateLayer$handleInteraction$1(StateLayer stateLayer, float f2, AnimationSpec<Float> animationSpec, Continuation<? super StateLayer$handleInteraction$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (Animatable.animateTo$default(this.this$0.animatedAlpha, Boxing.boxFloat(this.$targetAlpha), this.$incomingAnimationSpec, null, null, this, 12, null) == coroutine_suspended) {
