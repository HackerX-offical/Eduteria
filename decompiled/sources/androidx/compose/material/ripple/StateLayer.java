...
final class StateLayer {
    ...
    public final void m2405drawStateLayermxwnekA(DrawScope drawScope, float f2, long j) throws Throwable {
        long j2;
        float fFloatValue = this.animatedAlpha.getValue().floatValue();
        if (fFloatValue <= 0.0f) {
            return;
        }
        long jM5967copywmQWz5c$default = Color.m5967copywmQWz5c$default(j, fFloatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.m6530drawCircleVaOC9Bg$default(drawScope, jM5967copywmQWz5c$default, f2, 0L, 0.0f, null, null, 0, 124, null);
            return;
        }
