...
final class AppBarKt$BottomAppBarLayout$appBarDragModifier$2$1 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, float f2, Continuation<? super Unit> continuation) {
        ...
        appBarKt$BottomAppBarLayout$appBarDragModifier$2$1.F$0 = f2;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            float f2 = this.F$0;
            this.label = 1;
            if (AppBarKt.settleAppBarBottom(this.$activeScrollBehavior.getState(), f2, this.$activeScrollBehavior.getFlingAnimationSpec(), this.$activeScrollBehavior.getSnapAnimationSpec(), this) == coroutine_suspended) {
