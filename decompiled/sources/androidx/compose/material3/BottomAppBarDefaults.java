...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = Dp.m8830constructorimpl(0);
    private static final PaddingValues ContentPadding = PaddingKt.m1148PaddingValuesa9UjIt4$default(AppBarKt.BottomAppBarHorizontalPadding, AppBarKt.getBottomAppBarVerticalPadding(), AppBarKt.BottomAppBarHorizontalPadding, 0.0f, 8, null);
    private static final PaddingValues FlexibleContentPadding = PaddingKt.m1148PaddingValuesa9UjIt4$default(DockedToolbarTokens.INSTANCE.m4397getContainerLeadingSpaceD9Ej5fM(), 0.0f, DockedToolbarTokens.INSTANCE.m4400getContainerTrailingSpaceD9Ej5fM(), 0.0f, 10, null);
    private static final float FlexibleBottomAppBarHeight = DockedToolbarTokens.INSTANCE.m4396getContainerHeightD9Ej5fM();
    private static final Arrangement.Horizontal FlexibleHorizontalArrangement = Arrangement.INSTANCE.getSpaceBetween();
    private static final Arrangement.Horizontal FlexibleFixedHorizontalArrangement = Arrangement.INSTANCE.m826spacedByD5KLDUw(DockedToolbarTokens.INSTANCE.m4398getContainerMaxSpacingD9Ej5fM(), Alignment.INSTANCE.getCenterHorizontally());
    ...
    public final float m2485getFlexibleBottomAppBarHeightD9Ej5fM$material3() {
