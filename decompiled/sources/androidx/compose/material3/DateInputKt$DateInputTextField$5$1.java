    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (l != null) {
            ...
            if (withPattern.length() == 0) {
                jTextRange = TextRange.INSTANCE.m8278getZerod9O1mEE();
            } else {
                jTextRange = TextRangeKt.TextRange(withPattern.length(), withPattern.length());
            }
            mutableState.setValue(new TextFieldValue(withPattern, jTextRange, (TextRange) null, 4, (DefaultConstructorMarker) null));
        }
