        ...
        if (!composerStartRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            SurfaceKt.m3531SurfaceT9BRK9s(navigationBarOverrideScope.getModifier(), null, navigationBarOverrideScope.getContainerColor(), navigationBarOverrideScope.getContentColor(), navigationBarOverrideScope.getTonalElevation(), 0.0f, null, ComposableLambdaKt.rememberComposableLambda(1991263321, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DefaultNavigationBarOverride.NavigationBar.1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    Modifier modifierSelectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m1206defaultMinSizeVpY3zN4$default(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.INSTANCE, 0.0f, 1, null), navigationBarOverrideScope.getWindowInsets()), 0.0f, NavigationBarKt.NavigationBarHeight, 1, null));
                    Arrangement.HorizontalOrVertical horizontalOrVerticalM825spacedBy0680j_4 = Arrangement.INSTANCE.m825spacedBy0680j_4(NavigationBarKt.getNavigationBarItemHorizontalPadding());
                    ...
                    MeasurePolicy measurePolicyRowMeasurePolicy = RowKt.rowMeasurePolicy(horizontalOrVerticalM825spacedBy0680j_4, centerVertically, composer2, 54);
