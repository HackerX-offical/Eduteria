...
final class DefaultSingleRowTopAppBarOverride$SingleRowTopAppBar$appBarDragModifier$2$1 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, float f2, Continuation<? super Unit> continuation) {
        ...
        defaultSingleRowTopAppBarOverride$SingleRowTopAppBar$appBarDragModifier$2$1.F$0 = f2;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            float f2 = this.F$0;
            this.label = 1;
            if (AppBarKt.settleAppBar(this.$this_SingleRowTopAppBar.getScrollBehavior().getState(), f2, this.$this_SingleRowTopAppBar.getScrollBehavior().getFlingAnimationSpec(), this.$this_SingleRowTopAppBar.getScrollBehavior().getSnapAnimationSpec(), this) == coroutine_suspended) {
