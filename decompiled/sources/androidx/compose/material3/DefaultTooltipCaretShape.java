...
public final class DefaultTooltipCaretShape implements Shape {
    ...
    public /* synthetic */ DefaultTooltipCaretShape(long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? TooltipDefaults.INSTANCE.m3895getCaretSizeMYxV2XQ() : j, null);
    }
    ...
    public Outline mo382createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        float fMo488toPx0680j_4 = density.mo488toPx0680j_4(DpSize.m8928getWidthD9Ej5fM(this.caretSize));
        float fMo488toPx0680j_42 = density.mo488toPx0680j_4(DpSize.m8926getHeightD9Ej5fM(this.caretSize));
        Path.moveTo(0.0f, 0.0f);
        float f2 = 2;
        Path.lineTo(fMo488toPx0680j_4 / f2, 0.0f);
        Path.lineTo(0.0f, fMo488toPx0680j_42);
        Path.lineTo((-fMo488toPx0680j_4) / f2, 0.0f);
        Path.close();
