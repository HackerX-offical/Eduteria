...
public final class DisplayMode {
    ...
    private static final int Picker = m2836constructorimpl(0);
    private static final int Input = m2836constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ DisplayMode m2835boximpl(int i) {
        return new DisplayMode(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m2836constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m2837equalsimpl(int i, Object obj) {
        return (obj instanceof DisplayMode) && i == ((DisplayMode) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2838equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m2839hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object other) {
        return m2837equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m2839hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m2843getPickerjFl4v0() {
            return DisplayMode.Picker;
        }

        /* JADX INFO: renamed from: getInput-jFl-4v0, reason: not valid java name */
        public final int m2842getInputjFl4v0() {
            return DisplayMode.Input;
        }
    }

    public String toString() {
        return m2840toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m2840toStringimpl(int i) {
        return m2838equalsimpl0(i, Picker) ? "Picker" : m2838equalsimpl0(i, Input) ? "Input" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
