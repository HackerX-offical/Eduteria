...
public final class DrawerState {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final float anchoredDraggableState$lambda$1(float f2) {
        return f2 * NavigationDrawerKt.DrawerPositionalThreshold;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final float anchoredDraggableState$lambda$3(DrawerState drawerState) {
        return drawerState.requireDensity().mo488toPx0680j_4(NavigationDrawerKt.DrawerVelocityThreshold);
    }
    ...
    static /* synthetic */ Object animateTo$default(DrawerState drawerState, DrawerValue drawerValue, AnimationSpec animationSpec, float f2, Continuation continuation, int i, Object obj) {
        if ((i & 4) != 0) {
