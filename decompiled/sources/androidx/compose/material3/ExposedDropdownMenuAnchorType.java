...
public final class ExposedDropdownMenuAnchorType {
    ...
    private static final String PrimaryNotEditable = m2873constructorimpl("PrimaryNotEditable");
    private static final String PrimaryEditable = m2873constructorimpl("PrimaryEditable");
    private static final String SecondaryEditable = m2873constructorimpl("SecondaryEditable");

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ExposedDropdownMenuAnchorType m2872boximpl(String str) {
        return new ExposedDropdownMenuAnchorType(str);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static String m2873constructorimpl(String str) {
        return str;
    }
    ...
    public boolean equals(Object other) {
        return m2874equalsimpl(this.name, other);
    }

    public int hashCode() {
        return m2876hashCodeimpl(this.name);
    }
    ...
    public static final class Companion {
        ...
        public final String m2880getPrimaryNotEditableoYjWRB4() {
        ...
        public final String m2879getPrimaryEditableoYjWRB4() {
        ...
        public final String m2881getSecondaryEditableoYjWRB4() {
    ...
    public String toString() {
        return m2877toStringimpl(this.name);
    }
}
