...
public final /* data */ class IndicatorLineElement extends ModifierNodeElement<IndicatorLineNode> {
    ...
    public /* synthetic */ IndicatorLineElement(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, Shape shape, float f2, float f3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static /* synthetic */ IndicatorLineElement m3007copygv0btCI$default(IndicatorLineElement indicatorLineElement, boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, Shape shape, float f2, float f3, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        if ((i & 32) != 0) {
            f2 = indicatorLineElement.focusedIndicatorLineThickness;
        }
        if ((i & 64) != 0) {
            f3 = indicatorLineElement.unfocusedIndicatorLineThickness;
        }
        float f4 = f2;
        float f5 = f3;
        Shape shape2 = shape;
        InteractionSource interactionSource2 = interactionSource;
        return indicatorLineElement.m3010copygv0btCI(z, z2, interactionSource2, textFieldColors, shape2, f4, f5);
    }
    ...
    public final IndicatorLineElement m3010copygv0btCI(boolean enabled, boolean isError, InteractionSource interactionSource, TextFieldColors colors, Shape textFieldShape, float focusedIndicatorLineThickness, float unfocusedIndicatorLineThickness) {
    ...
    public int hashCode() {
        ...
        return ((((iHashCode2 + (shape != null ? shape.hashCode() : 0)) * 31) + Dp.m8836hashCodeimpl(this.focusedIndicatorLineThickness)) * 31) + Dp.m8836hashCodeimpl(this.unfocusedIndicatorLineThickness);
    }

    public String toString() {
        return "IndicatorLineElement(enabled=" + this.enabled + ", isError=" + this.isError + ", interactionSource=" + this.interactionSource + ", colors=" + this.colors + ", textFieldShape=" + this.textFieldShape + ", focusedIndicatorLineThickness=" + ((Object) Dp.m8841toStringimpl(this.focusedIndicatorLineThickness)) + ", unfocusedIndicatorLineThickness=" + ((Object) Dp.m8841toStringimpl(this.unfocusedIndicatorLineThickness)) + ')';
    }
    ...
    public final float m3011getFocusedIndicatorLineThicknessD9Ej5fM() {
        return this.focusedIndicatorLineThickness;
    }

    /* JADX INFO: renamed from: getUnfocusedIndicatorLineThickness-D9Ej5fM, reason: not valid java name */
    public final float m3012getUnfocusedIndicatorLineThicknessD9Ej5fM() {
        return this.unfocusedIndicatorLineThickness;
    }

    private IndicatorLineElement(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, Shape shape, float f2, float f3) {
        this.enabled = z;
        this.isError = z2;
    ...
    public void update(IndicatorLineNode node) {
        node.m3014updategv0btCI(this.enabled, this.isError, this.interactionSource, this.colors, this.textFieldShape, this.focusedIndicatorLineThickness, this.unfocusedIndicatorLineThickness);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("indicatorLine");
        inspectorInfo.getProperties().set(StreamManagement.Enabled.ELEMENT, Boolean.valueOf(this.enabled));
        ...
        inspectorInfo.getProperties().set("focusedIndicatorLineThickness", Dp.m8828boximpl(this.focusedIndicatorLineThickness));
        inspectorInfo.getProperties().set("unfocusedIndicatorLineThickness", Dp.m8828boximpl(this.unfocusedIndicatorLineThickness));
    }
}
