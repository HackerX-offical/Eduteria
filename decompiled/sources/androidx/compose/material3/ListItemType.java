...
final class ListItemType implements Comparable<ListItemType> {
    ...
    private static final int OneLine = m3067constructorimpl(1);
    private static final int TwoLine = m3067constructorimpl(2);
    private static final int ThreeLine = m3067constructorimpl(3);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ListItemType m3065boximpl(int i) {
        return new ListItemType(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m3067constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3068equalsimpl(int i, Object obj) {
        return (obj instanceof ListItemType) && i == ((ListItemType) obj).getLines();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3069equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m3070hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3071toStringimpl(int i) {
        return "ListItemType(lines=" + i + ')';
    }

    public boolean equals(Object other) {
        return m3068equalsimpl(this.lines, other);
    }

    public int hashCode() {
        return m3070hashCodeimpl(this.lines);
    }

    public String toString() {
        return m3071toStringimpl(this.lines);
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(ListItemType listItemType) {
        return m3072compareToyh95HIg(listItemType.getLines());
    }
    ...
    public static int m3066compareToyh95HIg(int i, int i2) {
        return Intrinsics.compare(i, i2);
    }

    /* JADX INFO: renamed from: compareTo-yh95HIg, reason: not valid java name */
    public int m3072compareToyh95HIg(int i) {
        return m3066compareToyh95HIg(this.lines, i);
    }
