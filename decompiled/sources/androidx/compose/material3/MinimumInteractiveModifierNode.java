...
public final class MinimumInteractiveModifierNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, LayoutModifierNode {
    ...
    public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final int height;
        float f2 = 0;
        float fM8830constructorimpl = Dp.m8830constructorimpl(RangesKt.coerceAtLeast(((Dp) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, InteractiveComponentSizeKt.getLocalMinimumInteractiveComponentSize())).m8844unboximpl(), Dp.m8830constructorimpl(f2)));
        final Placeable placeableMo7445measureBRTryo0 = measurable.mo7445measureBRTryo0(j);
        boolean z = getIsAttached() && !Float.isNaN(fM8830constructorimpl) && Dp.m8829compareTo0680j_4(fM8830constructorimpl, Dp.m8830constructorimpl(f2)) > 0;
        int i = Float.isNaN(fM8830constructorimpl) ? 0 : measureScope.mo482roundToPx0680j_4(fM8830constructorimpl);
        if (z) {
            width = Math.max(placeableMo7445measureBRTryo0.getWidth(), i);
        } else {
            width = placeableMo7445measureBRTryo0.getWidth();
        }
        if (z) {
            height = Math.max(placeableMo7445measureBRTryo0.getHeight(), i);
        } else {
            height = placeableMo7445measureBRTryo0.getHeight();
        }
        if (z) {
            updateAlignmentLines(i, placeableMo7445measureBRTryo0);
        }
        Map<AlignmentLine, Integer> mapEmptyMap = this.alignmentLinesCache;
        if (mapEmptyMap == null) {
            mapEmptyMap = MapsKt.emptyMap();
        }
        return measureScope.layout(width, height, mapEmptyMap, new Function1() { // from class: androidx.compose.material3.MinimumInteractiveModifierNode$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return MinimumInteractiveModifierNode.measure_3p2s80s$lambda$0(width, placeableMo7445measureBRTryo0, height, (Placeable.PlacementScope) obj);
            }
        });
    }
