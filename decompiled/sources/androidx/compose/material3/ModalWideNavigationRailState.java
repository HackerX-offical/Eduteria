...
public final class ModalWideNavigationRailState implements WideNavigationRailState {
    ...
    public static final float anchoredDraggableState$lambda$0(float f2) {
        return f2 * 0.5f;
    }
    ...
    public ModalWideNavigationRailState(WideNavigationRailState wideNavigationRailState, final Density density, AnimationSpec<Float> animationSpec) {
        ...
        this.anchoredDraggableState = new AnchoredDraggableState<>(wideNavigationRailState.getTargetValue(), new Function1() { // from class: androidx.compose.material3.ModalWideNavigationRailState$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return Float.valueOf(ModalWideNavigationRailState.anchoredDraggableState$lambda$2(density));
            }
    ...
    static /* synthetic */ Object animateTo$default(ModalWideNavigationRailState modalWideNavigationRailState, WideNavigationRailValue wideNavigationRailValue, AnimationSpec animationSpec, float f2, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            animationSpec = modalWideNavigationRailState.animationSpec;
        }
        if ((i & 4) != 0) {
            f2 = modalWideNavigationRailState.anchoredDraggableState.getLastVelocity();
        }
        return modalWideNavigationRailState.animateTo(wideNavigationRailValue, animationSpec, f2, continuation);
    }
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function4<AnchoredDragScope, DraggableAnchors<WideNavigationRailValue>, WideNavigationRailValue, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final Unit invokeSuspend$lambda$0(AnchoredDragScope anchoredDragScope, Ref.FloatRef floatRef, float f2, float f3) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final Object animateTo(WideNavigationRailValue wideNavigationRailValue, AnimationSpec<Float> animationSpec, float f2, Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(this.anchoredDraggableState, wideNavigationRailValue, null, new AnonymousClass2(f2, animationSpec, null), continuation, 2, null);
    ...
    public static final float anchoredDraggableState$lambda$2(Density density) {
        return density.mo488toPx0680j_4(Dp.m8830constructorimpl(HttpStatus.SC_BAD_REQUEST));
    }
}
