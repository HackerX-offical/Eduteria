...
final class NavigationBarKt$NavigationBarItem$styledIcon$1 implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        State<Color> stateM162animateColorAsStateeuL9pac = SingleValueAnimationKt.m162animateColorAsStateeuL9pac(this.$colors.m3132iconColorWaAFU9c$material3(this.$selected, this.$enabled), this.$colorAnimationSpec, null, null, composer, 0, 12);
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = new Function1() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItem$styledIcon$1$$ExternalSyntheticLambda0
                    ...
                    public final Object invoke(Object obj) {
                        return NavigationBarKt$NavigationBarItem$styledIcon$1.invoke$lambda$2$lambda$1((SemanticsPropertyReceiver) obj);
                    }
                };
