...
final class NavigationDrawerKt$ModalDrawerSheet$2 implements Function3<DrawerPredictiveBackState, Composer, Integer, Unit> {
    ...
    NavigationDrawerKt$ModalDrawerSheet$2(WindowInsets windowInsets, Modifier modifier, Shape shape, long j, long j2, float f2, DrawerState drawerState, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new FloatProducer() { // from class: androidx.compose.material3.NavigationDrawerKt$ModalDrawerSheet$2$$ExternalSyntheticLambda0
                ...
                public final float invoke() {
                    return NavigationDrawerKt$ModalDrawerSheet$2.invoke$lambda$1$lambda$0(drawerState);
                }
            };
