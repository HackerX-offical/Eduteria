...
public final class NavigationItemIconPosition {
    ...
    private static final int Top = m3185constructorimpl(0);
    private static final int Start = m3185constructorimpl(1);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NavigationItemIconPosition m3184boximpl(int i) {
        return new NavigationItemIconPosition(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    private static int m3185constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object other) {
        return m3186equalsimpl(this.value, other);
    }
    ...
    public static String m3189toStringimpl(int i) {
        return m3187equalsimpl0(i, Top) ? "Top" : m3187equalsimpl0(i, Start) ? "Start" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
