...
public final class ScaffoldKt$ScaffoldLayout$contentPadding$1$1 implements PaddingValues {
    ...
    private final MutableState paddingHolder = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(PaddingKt.m1144PaddingValues0680j_4(Dp.m8830constructorimpl(0)), null, 2, null);
    ...
    public float mo1096calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        return getPaddingHolder().mo1096calculateLeftPaddingu2uoSUM(layoutDirection);
    }
    ...
    public float mo1097calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        return getPaddingHolder().mo1097calculateRightPaddingu2uoSUM(layoutDirection);
    }
