...
public final class SegmentedButtonContentMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    public MeasureResult mo1016measure3p2s80s(final MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j) {
        Object obj;
        Object obj2;
        Object obj3;
        ...
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(list2.get(i2).mo7445measureBRTryo0(j));
        }
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            arrayList3.add(list3.get(i4).mo7445measureBRTryo0(j));
        }
        ...
        int iMax = Math.max(measureScope.mo482roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m3394getIconSizeD9Ej5fM()), width3) + measureScope.mo482roundToPx0680j_4(SegmentedButtonKt.IconSpacing) + (numValueOf != null ? numValueOf.intValue() : 0);
        int i6 = width3 == 0 ? (-(measureScope.mo482roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m3394getIconSizeD9Ej5fM()) + measureScope.mo482roundToPx0680j_4(SegmentedButtonKt.IconSpacing))) / 2 : 0;
    ...
    public static final Unit measure_3p2s80s$lambda$8(List list, MeasureScope measureScope, SegmentedButtonContentMeasurePolicy segmentedButtonContentMeasurePolicy, int i, List list2, int i2, Placeable.PlacementScope placementScope) {
        ...
        int i4 = measureScope.mo482roundToPx0680j_4(SegmentedButtonDefaults.INSTANCE.m3394getIconSizeD9Ej5fM()) + measureScope.mo482roundToPx0680j_4(SegmentedButtonKt.IconSpacing);
