...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (!z) {
            ...
            f2 = interaction instanceof DragInteraction.Start ? this.draggedElevation : this.elevation;
        }
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(dpM8828boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) objRememberedValue5, composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m8835equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m8835equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m8835equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m8835equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m8835equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m8836hashCodeimpl(this.elevation) * 31) + Dp.m8836hashCodeimpl(this.pressedElevation)) * 31) + Dp.m8836hashCodeimpl(this.focusedElevation)) * 31) + Dp.m8836hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m8836hashCodeimpl(this.disabledElevation);
    }
}
