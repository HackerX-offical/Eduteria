...
public final class SelectedRangeInfo {
    ...
    public static final class Companion {
        ...
        public final SelectedRangeInfo calculateRangeInfo(CalendarMonth month, CalendarDate startDate, CalendarDate endDate) {
            ...
            return new SelectedRangeInfo(IntOffset.m8952constructorimpl((((long) (daysFromStartOfWeekToFirstOfMonth % 7)) << 32) | (((long) (daysFromStartOfWeekToFirstOfMonth / 7)) & 4294967295L)), IntOffset.m8952constructorimpl((((long) (daysFromStartOfWeekToFirstOfMonth2 % 7)) << 32) | (((long) (daysFromStartOfWeekToFirstOfMonth2 / 7)) & 4294967295L)), z, z2, null);
        }
    }
}
