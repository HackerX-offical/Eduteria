...
public final class SheetState {
    ...
    public final Object expand(Continuation<? super Unit> continuation) {
        ...
        Object objAnimateTo$material3$default = animateTo$material3$default(this, SheetValue.Expanded, this.showMotionSpec, 0.0f, continuation, 4, null);
        return objAnimateTo$material3$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnimateTo$material3$default : Unit.INSTANCE;
    }
    ...
    public final Object partialExpand(Continuation<? super Unit> continuation) {
        ...
        Object objAnimateTo$material3$default = animateTo$material3$default(this, SheetValue.PartiallyExpanded, this.hideMotionSpec, 0.0f, continuation, 4, null);
        return objAnimateTo$material3$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnimateTo$material3$default : Unit.INSTANCE;
    }
    ...
    public final Object show(Continuation<? super Unit> continuation) {
        ...
        Object objAnimateTo$material3$default = animateTo$material3$default(this, sheetValue, this.showMotionSpec, 0.0f, continuation, 4, null);
        return objAnimateTo$material3$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnimateTo$material3$default : Unit.INSTANCE;
    }
    ...
    public final Object hide(Continuation<? super Unit> continuation) {
        ...
        Object objAnimateTo$material3$default = animateTo$material3$default(this, SheetValue.Hidden, this.hideMotionSpec, 0.0f, continuation, 4, null);
        return objAnimateTo$material3$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnimateTo$material3$default : Unit.INSTANCE;
    }

    public static /* synthetic */ Object animateTo$material3$default(SheetState sheetState, SheetValue sheetValue, FiniteAnimationSpec finiteAnimationSpec, float f2, Continuation continuation, int i, Object obj) {
        if ((i & 4) != 0) {
            f2 = sheetState.anchoredDraggableState.getLastVelocity();
        }
        return sheetState.animateTo$material3(sheetValue, finiteAnimationSpec, f2, continuation);
    }

    public final Object animateTo$material3(SheetValue sheetValue, FiniteAnimationSpec<Float> finiteAnimationSpec, float f2, Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(this.anchoredDraggableState, sheetValue, null, new SheetState$animateTo$2(this, f2, finiteAnimationSpec, null), continuation, 2, null);
    ...
    public final Object settle$material3(float f2, Continuation<? super Unit> continuation) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final float anchoredDraggableState$lambda$5(Function0 function0, float f2) {
    ...
    public static final class Companion {
        ...
        public final /* synthetic */ Saver Saver(boolean skipPartiallyExpanded, Function1 confirmValueChange, final Density density, boolean skipHiddenState) {
            return Saver(skipPartiallyExpanded, new Function0() { // from class: androidx.compose.material3.SheetState$Companion$$ExternalSyntheticLambda2
                ...
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return Float.valueOf(SheetState.Companion.Saver$lambda$5(density));
                }
        ...
        public static final float Saver$lambda$3(Density density) {
            return density.mo488toPx0680j_4(BottomSheetDefaults.INSTANCE.m2489getPositionalThresholdD9Ej5fM$material3());
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final float Saver$lambda$5(Density density) {
            return density.mo488toPx0680j_4(BottomSheetDefaults.INSTANCE.m2492getVelocityThresholdD9Ej5fM$material3());
        }
    }
    ...
    public /* synthetic */ SheetState(boolean z, final Density density, SheetValue sheetValue, Function1 function1, boolean z2) {
        this(z, new Function0() { // from class: androidx.compose.material3.SheetState$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Float.valueOf(SheetState._init_$lambda$9(density));
            }
        }, new Function0() { // from class: androidx.compose.material3.SheetState$$ExternalSyntheticLambda5
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return Float.valueOf(SheetState._init_$lambda$11(density));
            }
