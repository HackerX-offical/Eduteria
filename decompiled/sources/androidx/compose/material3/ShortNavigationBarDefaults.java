...
public final class ShortNavigationBarDefaults {
    ...
    public final long getContentColor(Composer composer, int i) {
        ...
        long jM2664contentColorForek8zF_U = ColorSchemeKt.m2664contentColorForek8zF_U(getContainerColor(composer, i & 14), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return jM2664contentColorForek8zF_U;
    }

    /* JADX INFO: renamed from: getArrangement-LnnQw40, reason: not valid java name */
    public final int m3429getArrangementLnnQw40() {
        return ShortNavigationBarArrangement.INSTANCE.m3428getEqualWeightLnnQw40();
    }
