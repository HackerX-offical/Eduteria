...
public final class SliderRange {
    ...
    public static final /* synthetic */ SliderRange m3500boximpl(long j) {
        return new SliderRange(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m3501constructorimpl(long j) {
        return j;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3502equalsimpl(long j, Object obj) {
        return (obj instanceof SliderRange) && j == ((SliderRange) obj).m3508unboximpl();
    }
    ...
    public boolean equals(Object other) {
        return m3502equalsimpl(this.packedValue, other);
    }
    ...
    public final /* synthetic */ long m3508unboximpl() {
    ...
    public static final float m3505getStartimpl(long j) {
        if (j == Unspecified) {
    ...
    public static final float m3504getEndInclusiveimpl(long j) {
        if (j == Unspecified) {
            throw new IllegalStateException("SliderRange is unspecified".toString());
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m3509getUnspecifiedFYbKRX4$annotations() {
        }
        ...
        public final long m3510getUnspecifiedFYbKRX4() {
            return SliderRange.Unspecified;
        }
    }

    public String toString() {
        return m3507toStringimpl(this.packedValue);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3507toStringimpl(long j) {
        if (SliderKt.m3494isSpecifiedIf1S1O4(j)) {
            return m3505getStartimpl(j) + ".." + m3504getEndInclusiveimpl(j);
        }
