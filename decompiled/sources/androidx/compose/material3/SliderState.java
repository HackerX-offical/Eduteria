...
public final class SliderState implements DraggableState {
    ...
    public SliderState(float f2, int i, Function0<Unit> function0, ClosedFloatingPointRange<Float> closedFloatingPointRange) {
        this.steps = i;
        this.onValueChangeFinished = function0;
        this.valueRange = closedFloatingPointRange;
        this.valueState = PrimitiveSnapshotStateKt.mutableFloatStateOf(f2);
        ...
        this.rawOffset = PrimitiveSnapshotStateKt.mutableFloatStateOf(scaleToOffset(0.0f, 0.0f, f2));
    ...
    public /* synthetic */ SliderState(float f2, int i, Function0 function0, ClosedFloatingPointRange closedFloatingPointRange, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 0.0f : f2, (i2 & 2) != 0 ? 0 : i, (i2 & 4) != 0 ? null : function0, (i2 & 8) != 0 ? RangesKt.rangeTo(0.0f, 1.0f) : closedFloatingPointRange);
    }
    ...
    private final void setValueState(float f2) {
        this.valueState.setFloatValue(f2);
    }

    public final void setValue(float f2) {
        if (this.shouldAutoSnap) {
            f2 = calculateSnappedValue(f2);
        }
        setValueState(f2);
    }
    ...
    public final void m3511onPressk4lQ0M$material3(long pos) {
        ...
        if (this.orientation == Orientation.Vertical) {
            if (this.reverseVerticalDirection) {
                ...
                fIntBitsToFloat2 = Float.intBitsToFloat((int) (pos & 4294967295L));
                fIntBitsToFloat = totalWidth - fIntBitsToFloat2;
            } else {
                fIntBitsToFloat = Float.intBitsToFloat((int) (pos & 4294967295L));
            }
        } else if (this.isRtl) {
    ...
    private final void setRawOffset(float f2) {
        this.rawOffset.setFloatValue(f2);
    }
    ...
    private final void setPressOffset(float f2) {
        this.pressOffset.setFloatValue(f2);
    }
