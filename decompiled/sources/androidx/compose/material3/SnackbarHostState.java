    ...
    */
    public final java.lang.Object showSnackbar(androidx.compose.material3.SnackbarVisuals r8, kotlin.coroutines.Continuation<? super androidx.compose.material3.SnackbarResult> r9) {
        ...
        L65:
            ...
            r0.L$2 = r0     // Catch: java.lang.Throwable -> La5
            r0.label = r3     // Catch: java.lang.Throwable -> La5
            r2 = r0
            kotlin.coroutines.Continuation r2 = (kotlin.coroutines.Continuation) r2     // Catch: java.lang.Throwable -> La5
            kotlinx.coroutines.CancellableContinuationImpl r3 = new kotlinx.coroutines.CancellableContinuationImpl     // Catch: java.lang.Throwable -> La5
            kotlin.coroutines.Continuation r2 = kotlin.coroutines.intrinsics.IntrinsicsKt.intercepted(r2)     // Catch: java.lang.Throwable -> La5
            r3.<init>(r2, r4)     // Catch: java.lang.Throwable -> La5
            r3.initCancellability()     // Catch: java.lang.Throwable -> La5
            r2 = r3
            kotlinx.coroutines.CancellableContinuation r2 = (kotlinx.coroutines.CancellableContinuation) r2     // Catch: java.lang.Throwable -> La5
            androidx.compose.material3.SnackbarHostState$SnackbarDataImpl r4 = new androidx.compose.material3.SnackbarHostState$SnackbarDataImpl     // Catch: java.lang.Throwable -> La5
            r4.<init>(r8, r2)     // Catch: java.lang.Throwable -> La5
            androidx.compose.material3.SnackbarData r4 = (androidx.compose.material3.SnackbarData) r4     // Catch: java.lang.Throwable -> La5
            access$setCurrentSnackbarData(r7, r4)     // Catch: java.lang.Throwable -> La5
            java.lang.Object r8 = r3.getResult()     // Catch: java.lang.Throwable -> La5
            java.lang.Object r2 = kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()     // Catch: java.lang.Throwable -> La5
            if (r8 != r2) goto L98
            kotlin.coroutines.Continuation r0 = (kotlin.coroutines.Continuation) r0     // Catch: java.lang.Throwable -> La5
            kotlin.coroutines.jvm.internal.DebugProbesKt.probeCoroutineSuspended(r0)     // Catch: java.lang.Throwable -> La5
        L98:
            if (r8 != r1) goto L9b
        L9a:
            return r1
        L9b:
            ...
            r8 = r6
        L9e:
            r7.setCurrentSnackbarData(r5)     // Catch: java.lang.Throwable -> Lad
            r8.unlock(r5)
            return r9
        La5:
            r8 = move-exception
    ...
    private static final class SnackbarDataImpl implements SnackbarData {
        ...
        public void performAction() {
            if (this.continuation.isActive()) {
                ...
                cancellableContinuation.resumeWith(Result.m12393constructorimpl(SnackbarResult.ActionPerformed));
            }
        }
        ...
        public void dismiss() {
            if (this.continuation.isActive()) {
                CancellableContinuation<SnackbarResult> cancellableContinuation = this.continuation;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m12393constructorimpl(SnackbarResult.Dismissed));
            }
        }
