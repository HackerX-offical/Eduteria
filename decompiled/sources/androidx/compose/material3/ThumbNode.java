...
final class ThumbNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        float thumbDiameter;
        boolean z = (measurable.maxIntrinsicHeight(Constraints.m8783getMaxWidthimpl(j)) == 0 || measurable.maxIntrinsicWidth(Constraints.m8782getMaxHeightimpl(j)) == 0) ? false : true;
        if (this.isPressed) {
            thumbDiameter = SwitchTokens.INSTANCE.m4858getPressedHandleWidthD9Ej5fM();
        } else if (z || this.checked) {
            thumbDiameter = SwitchKt.getThumbDiameter();
        } else {
            thumbDiameter = SwitchKt.getUncheckedThumbDiameter();
        }
        float f2 = measureScope.mo488toPx0680j_4(thumbDiameter);
        ...
        final Placeable placeableMo7445measureBRTryo0 = measurable.mo7445measureBRTryo0(Constraints.INSTANCE.m8793fixedJhjzzOo(iFloatValue, iFloatValue));
        final float f3 = measureScope.mo488toPx0680j_4(Dp.m8830constructorimpl(Dp.m8830constructorimpl(SwitchKt.SwitchHeight - measureScope.mo484toDpu2uoSUM(f2)) / 2.0f));
        float f4 = measureScope.mo488toPx0680j_4(Dp.m8830constructorimpl(Dp.m8830constructorimpl(SwitchKt.SwitchWidth - SwitchKt.getThumbDiameter()) - SwitchKt.ThumbPadding));
        boolean z2 = this.isPressed;
        if (z2 && this.checked) {
            f3 = f4 - measureScope.mo488toPx0680j_4(SwitchTokens.INSTANCE.m4864getTrackOutlineWidthD9Ej5fM());
        } else if (z2 && !this.checked) {
            f3 = measureScope.mo488toPx0680j_4(SwitchTokens.INSTANCE.m4864getTrackOutlineWidthD9Ej5fM());
        ...
        return MeasureScope.layout$default(measureScope, iFloatValue, iFloatValue, null, new Function1() { // from class: androidx.compose.material3.ThumbNode$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return ThumbNode.measure_3p2s80s$lambda$0(placeableMo7445measureBRTryo0, this, f3, (Placeable.PlacementScope) obj);
            }
        }, 4, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit measure_3p2s80s$lambda$0(Placeable placeable, ThumbNode thumbNode, float f2, Placeable.PlacementScope placementScope) {
        Animatable<Float, AnimationVector1D> animatable = thumbNode.offsetAnim;
        Placeable.PlacementScope.placeRelative$default(placementScope, placeable, animatable != null ? (int) animatable.getValue().floatValue() : (int) f2, 0, 0.0f, 4, null);
        return Unit.INSTANCE;
    }
