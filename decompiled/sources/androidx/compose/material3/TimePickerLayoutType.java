...
public final class TimePickerLayoutType {
    ...
    private static final int Horizontal = m3775constructorimpl(0);
    private static final int Vertical = m3775constructorimpl(1);
    private final int value;

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m3774boximpl(int i) {
    ...
    public boolean equals(Object other) {
        return m3776equalsimpl(this.value, other);
    }
    ...
    public static String m3779toStringimpl(int i) {
        return m3777equalsimpl0(i, Horizontal) ? "Horizontal" : m3777equalsimpl0(i, Vertical) ? "Vertical" : AnalyticsEvents.PARAMETER_DIALOG_OUTCOME_VALUE_UNKNOWN;
    }
}
