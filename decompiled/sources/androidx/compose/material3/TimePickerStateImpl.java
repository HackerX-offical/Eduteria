...
final class TimePickerStateImpl implements TimePickerState {
    ...
    public TimePickerStateImpl(int i, int i2, boolean z) {
        ...
        this.is24hour = z;
        this.selection = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TimePickerSelectionMode.m3783boximpl(TimePickerSelectionMode.INSTANCE.m3790getHouryecRtBI()), null, 2, null);
    ...
    public int mo2417getSelectionyecRtBI() {
        return ((TimePickerSelectionMode) this.selection.getValue()).m3789unboximpl();
    }

    @Override // androidx.compose.material3.TimePickerState
    /* JADX INFO: renamed from: setSelection-6_8s6DQ */
    public void mo2419setSelection6_8s6DQ(int i) {
        this.selection.setValue(TimePickerSelectionMode.m3783boximpl(i));
    }
        ...
        public final Saver<TimePickerStateImpl, ?> Saver() {
            return SaverKt.Saver(new Function2() { // from class: androidx.compose.material3.TimePickerStateImpl$Companion$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return TimePickerStateImpl.Companion.Saver$lambda$0((SaverScope) obj, (TimePickerStateImpl) obj2);
                }
