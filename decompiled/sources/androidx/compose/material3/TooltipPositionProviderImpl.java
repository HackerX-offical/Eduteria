...
final class TooltipPositionProviderImpl implements PopupPositionProvider {
    ...
    public long mo450calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        int i = this.type;
        if (TooltipAnchorPosition.m3883equalsimpl0(i, TooltipAnchorPosition.INSTANCE.m3890getLeftlOKsHw4())) {
            return m3917leftPositioningoFUgxo0(anchorBounds, popupContentSize);
        }
        if (TooltipAnchorPosition.m3883equalsimpl0(i, TooltipAnchorPosition.INSTANCE.m3891getRightlOKsHw4())) {
            return m3918rightPositioninguHY26d4(anchorBounds, popupContentSize, windowSize);
        }
        if (TooltipAnchorPosition.m3883equalsimpl0(i, TooltipAnchorPosition.INSTANCE.m3887getAbovelOKsHw4())) {
            return m3913abovePositioninguHY26d4(anchorBounds, popupContentSize, windowSize);
        }
        if (TooltipAnchorPosition.m3883equalsimpl0(i, TooltipAnchorPosition.INSTANCE.m3888getBelowlOKsHw4())) {
            return m3914belowPositioninguHY26d4(anchorBounds, popupContentSize, windowSize);
        }
        if (TooltipAnchorPosition.m3883equalsimpl0(i, TooltipAnchorPosition.INSTANCE.m3892getStartlOKsHw4())) {
            return m3919startPositioning_JLpSYE(layoutDirection, anchorBounds, popupContentSize, windowSize);
        }
        if (TooltipAnchorPosition.m3883equalsimpl0(i, TooltipAnchorPosition.INSTANCE.m3889getEndlOKsHw4())) {
            return m3915endPositioning_JLpSYE(layoutDirection, anchorBounds, popupContentSize, windowSize);
        }
        return m3913abovePositioninguHY26d4(anchorBounds, popupContentSize, windowSize);
    }

    /* JADX INFO: renamed from: leftPositioning-oFUgxo0, reason: not valid java name */
    public final long m3917leftPositioningoFUgxo0(IntRect anchorBounds, long popupContentSize) {
        ...
        return IntOffset.m8952constructorimpl((((long) left) << 32) | (((long) (((anchorBounds.getTop() + anchorBounds.getBottom()) - ((int) (popupContentSize & 4294967295L))) / 2)) & 4294967295L));
    }

    /* JADX INFO: renamed from: rightPositioning-uHY26d4, reason: not valid java name */
    public final long m3918rightPositioninguHY26d4(IntRect anchorBounds, long popupContentSize, long windowSize) {
        ...
        return IntOffset.m8952constructorimpl((((long) right) << 32) | (((long) (((anchorBounds.getTop() + anchorBounds.getBottom()) - ((int) (popupContentSize & 4294967295L))) / 2)) & 4294967295L));
    }

    /* JADX INFO: renamed from: abovePositioning-uHY26d4, reason: not valid java name */
    public final long m3913abovePositioninguHY26d4(IntRect anchorBounds, long popupContentSize, long windowSize) {
        int i = (int) (popupContentSize >> 32);
    ...
    public final long m3914belowPositioninguHY26d4(IntRect anchorBounds, long popupContentSize, long windowSize) {
        int i = (int) (popupContentSize >> 32);
        int left = anchorBounds.getLeft() + ((anchorBounds.getWidth() - i) / 2);
        if (left < 0) {
            left = anchorBounds.getLeft();
        ...
        return IntOffset.m8952constructorimpl((((long) left) << 32) | (((long) bottom) & 4294967295L));
    }

    /* JADX INFO: renamed from: startPositioning-_JLpSYE, reason: not valid java name */
    public final long m3919startPositioning_JLpSYE(LayoutDirection layoutDirection, IntRect anchorBounds, long popupContentSize, long windowSize) {
    ...
    public final long m3915endPositioning_JLpSYE(LayoutDirection layoutDirection, IntRect anchorBounds, long popupContentSize, long windowSize) {
        if (layoutDirection == LayoutDirection.Ltr) {
            return m3918rightPositioninguHY26d4(anchorBounds, popupContentSize, windowSize);
        }
        return m3917leftPositioningoFUgxo0(anchorBounds, popupContentSize);
