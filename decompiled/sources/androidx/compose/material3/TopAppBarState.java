...
public final class TopAppBarState {
    ...
    public TopAppBarState(float f2, float f3, float f4) {
        this.heightOffsetLimit = f2;
        this.contentOffset = PrimitiveSnapshotStateKt.mutableFloatStateOf(f4);
    ...
    public final void setHeightOffset(float f2) {
        this._heightOffset.setFloatValue(RangesKt.coerceIn(f2, this.heightOffsetLimit, 0.0f));
    }
    ...
    public final void setContentOffset(float f2) {
        this.contentOffset.setFloatValue(f2);
    }
    ...
    public final float getOverlappedFraction() {
        float f2 = this.heightOffsetLimit;
        if (f2 == 0.0f) {
            return 0.0f;
        }
        return 1 - (RangesKt.coerceIn(f2 - getContentOffset(), this.heightOffsetLimit, 0.0f) / this.heightOffsetLimit);
    }
