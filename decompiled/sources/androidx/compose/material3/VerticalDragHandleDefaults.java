...
public final class VerticalDragHandleDefaults {
    ...
    private static final DragHandleSizes sizes = new DragHandleSizes(DpKt.m8852DpSizeYgX7TsA(DragHandleTokens.INSTANCE.m4410getWidthD9Ej5fM(), DragHandleTokens.INSTANCE.m4406getHeightD9Ej5fM()), DpKt.m8852DpSizeYgX7TsA(DragHandleTokens.INSTANCE.m4409getPressedWidthD9Ej5fM(), DragHandleTokens.INSTANCE.m4408getPressedHeightD9Ej5fM()), DpKt.m8852DpSizeYgX7TsA(DragHandleTokens.INSTANCE.m4404getDraggedWidthD9Ej5fM(), DragHandleTokens.INSTANCE.m4403getDraggedHeightD9Ej5fM()), null);
    ...
    public final DragHandleColors m3956colorsRGew2ao(long j, long j2, long j3, Composer composer, int i, int i2) {
        ...
        DragHandleColors colors = getColors(MaterialTheme.INSTANCE.getColorScheme(composer, 6));
        if (jM6004getUnspecified0d7_KjU == 16) {
            jM6004getUnspecified0d7_KjU = colors.getColor();
        }
        long j4 = jM6004getUnspecified0d7_KjU;
        if (jM6004getUnspecified0d7_KjU2 == 16) {
            jM6004getUnspecified0d7_KjU2 = colors.getPressedColor();
        }
        long j5 = jM6004getUnspecified0d7_KjU2;
        if (jM6004getUnspecified0d7_KjU3 == 16) {
            jM6004getUnspecified0d7_KjU3 = colors.getDraggedColor();
        }
        DragHandleColors dragHandleColors = new DragHandleColors(j4, j5, jM6004getUnspecified0d7_KjU3, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static /* synthetic */ DragHandleSizes m3955sizesL9TjZb0$default(VerticalDragHandleDefaults verticalDragHandleDefaults, long j, long j2, long j3, int i, Object obj) {
        if ((i & 1) != 0) {
            j = DpSize.INSTANCE.m8937getUnspecifiedMYxV2XQ();
        }
        long j4 = j;
        if ((i & 2) != 0) {
            j2 = DpSize.INSTANCE.m8937getUnspecifiedMYxV2XQ();
        }
        long j5 = j2;
        if ((i & 4) != 0) {
            j3 = DpSize.INSTANCE.m8937getUnspecifiedMYxV2XQ();
        }
        return verticalDragHandleDefaults.m3957sizesL9TjZb0(j4, j5, j3);
    }

    /* JADX INFO: renamed from: sizes-L9TjZb0, reason: not valid java name */
    public final DragHandleSizes m3957sizesL9TjZb0(long size, long pressedSize, long draggedSize) {
