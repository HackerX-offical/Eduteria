...
public final class CarouselItemScopeImpl implements CarouselItemScope {
    ...
    public static final Unit rememberMaskShape$lambda$1$lambda$0(CarouselItemScopeImpl carouselItemScopeImpl, Shape shape, Density density, Path path, Size size, LayoutDirection layoutDirection) {
        Rect rectIntersect = carouselItemScopeImpl.getItemInfo().getMaskRect().intersect(SizeKt.m5813toRectuvyYCjk(size.m5797unboximpl()));
        OutlineKt.addOutline(path, shape.mo382createOutlinePq9zytI(rectIntersect.m5756getSizeNHjbRc(), layoutDirection, density));
        float left = rectIntersect.getLeft();
        float top = rectIntersect.getTop();
        path.mo5860translatek4lQ0M(Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(left)) << 32) | (((long) Float.floatToRawIntBits(top)) & 4294967295L)));
