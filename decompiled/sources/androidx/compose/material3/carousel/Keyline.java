...
public final /* data */ class Keyline {
    ...
    public static /* synthetic */ Keyline copy$default(Keyline keyline, float f2, float f3, float f4, boolean z, boolean z2, boolean z3, float f5, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = keyline.size;
        }
        if ((i & 2) != 0) {
        ...
        boolean z5 = z2;
        float f7 = f4;
        return keyline.copy(f2, f3, f7, z, z5, z4, f6);
    }
