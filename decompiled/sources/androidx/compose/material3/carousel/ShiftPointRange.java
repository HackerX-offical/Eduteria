...
final /* data */ class ShiftPointRange {
    ...
    public static /* synthetic */ ShiftPointRange copy$default(ShiftPointRange shiftPointRange, int i, int i2, float f2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        return shiftPointRange.copy(i, i2, f2);
    }
    ...
    public ShiftPointRange(int i, int i2, float f2) {
