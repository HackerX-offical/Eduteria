...
public final class AnimatedShapeState {
    ...
    private long size = Size.INSTANCE.m5801getZeroNHjbRc();
    ...
    public final void m4036setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public static /* synthetic */ float m4032topStartTmRCtEA$default(AnimatedShapeState animatedShapeState, long j, Density density, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return animatedShapeState.m4038topStartTmRCtEA(j, density);
    }

    /* JADX INFO: renamed from: topStart-TmRCtEA, reason: not valid java name */
    public final float m4038topStartTmRCtEA(long size, Density density) {
        Animatable<Float, AnimationVector1D> animatableAnimatable$default = this.topStart;
        if (animatableAnimatable$default == null) {
            animatableAnimatable$default = AnimatableKt.Animatable$default(this.shape.getTopStart().mo1523toPxTmRCtEA(size, density), 0.0f, 2, null);
    ...
    public static /* synthetic */ float m4031topEndTmRCtEA$default(AnimatedShapeState animatedShapeState, long j, Density density, int i, Object obj) {
        if ((i & 1) != 0) {
            j = animatedShapeState.size;
        }
        if ((i & 2) != 0) {
        ...
        return animatedShapeState.m4037topEndTmRCtEA(j, density);
    }

    /* JADX INFO: renamed from: topEnd-TmRCtEA, reason: not valid java name */
    public final float m4037topEndTmRCtEA(long size, Density density) {
        Animatable<Float, AnimationVector1D> animatableAnimatable$default = this.topEnd;
        if (animatableAnimatable$default == null) {
            animatableAnimatable$default = AnimatableKt.Animatable$default(this.shape.getTopEnd().mo1523toPxTmRCtEA(size, density), 0.0f, 2, null);
    ...
    public static /* synthetic */ float m4030bottomStartTmRCtEA$default(AnimatedShapeState animatedShapeState, long j, Density density, int i, Object obj) {
        if ((i & 1) != 0) {
            j = animatedShapeState.size;
        }
        if ((i & 2) != 0) {
        ...
        return animatedShapeState.m4034bottomStartTmRCtEA(j, density);
    }

    /* JADX INFO: renamed from: bottomStart-TmRCtEA, reason: not valid java name */
    public final float m4034bottomStartTmRCtEA(long size, Density density) {
        Animatable<Float, AnimationVector1D> animatableAnimatable$default = this.bottomStart;
        if (animatableAnimatable$default == null) {
            animatableAnimatable$default = AnimatableKt.Animatable$default(this.shape.getBottomStart().mo1523toPxTmRCtEA(size, density), 0.0f, 2, null);
    ...
    public static /* synthetic */ float m4029bottomEndTmRCtEA$default(AnimatedShapeState animatedShapeState, long j, Density density, int i, Object obj) {
        if ((i & 1) != 0) {
            j = animatedShapeState.size;
        }
        if ((i & 2) != 0) {
        ...
        return animatedShapeState.m4033bottomEndTmRCtEA(j, density);
    }

    /* JADX INFO: renamed from: bottomEnd-TmRCtEA, reason: not valid java name */
    public final float m4033bottomEndTmRCtEA(long size, Density density) {
        Animatable<Float, AnimationVector1D> animatableAnimatable$default = this.bottomEnd;
        if (animatableAnimatable$default == null) {
            animatableAnimatable$default = AnimatableKt.Animatable$default(this.shape.getBottomEnd().mo1523toPxTmRCtEA(size, density), 0.0f, 2, null);
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    if (animatable != null) {
                        this.label = 1;
                        obj = Animatable.animateTo$default(animatable, Boxing.boxFloat(this.$shape.getTopStart().mo1523toPxTmRCtEA(this.this$0.getSize(), this.this$0.getDensity())), this.this$0.getSpec(), null, null, this, 12, null);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new C00612(AnimatedShapeState.this, this.$shape, null), 3, null);
        ...
        static final class C00612 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00612(AnimatedShapeState animatedShapeState, CornerBasedShape cornerBasedShape, Continuation<? super C00612> continuation) {
                super(2, continuation);
                this.this$0 = animatedShapeState;
                this.$shape = cornerBasedShape;
            }
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                return new C00612(this.this$0, this.$shape, continuation);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    if (animatable != null) {
                        this.label = 1;
                        obj = Animatable.animateTo$default(animatable, Boxing.boxFloat(this.$shape.getTopEnd().mo1523toPxTmRCtEA(this.this$0.getSize(), this.this$0.getDensity())), this.this$0.getSpec(), null, null, this, 12, null);
                        if (obj == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
        ...
        static final class AnonymousClass3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    if (animatable != null) {
                        this.label = 1;
                        obj = Animatable.animateTo$default(animatable, Boxing.boxFloat(this.$shape.getBottomStart().mo1523toPxTmRCtEA(this.this$0.getSize(), this.this$0.getDensity())), this.this$0.getSpec(), null, null, this, 12, null);
                        if (obj == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
        ...
        static final class AnonymousClass4 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i == 0) {
                    ...
                    if (animatable != null) {
                        this.label = 1;
                        obj = Animatable.animateTo$default(animatable, Boxing.boxFloat(this.$shape.getBottomEnd().mo1523toPxTmRCtEA(this.this$0.getSize(), this.this$0.getDensity())), this.this$0.getSpec(), null, null, this, 12, null);
                        if (obj == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    }
