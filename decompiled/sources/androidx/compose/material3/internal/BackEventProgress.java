...
public interface BackEventProgress {
    ...
    public static final /* data */ class InProgress implements BackEventProgress {
        ...
        public static /* synthetic */ InProgress copy$default(InProgress inProgress, float f2, float f3, float f4, SwipeEdge swipeEdge, int i, Object obj) {
            if ((i & 1) != 0) {
                f2 = inProgress.touchX;
            }
            if ((i & 2) != 0) {
                f3 = inProgress.touchY;
            }
            if ((i & 4) != 0) {
                f4 = inProgress.progress;
            }
            if ((i & 8) != 0) {
                swipeEdge = inProgress.swipeEdge;
            }
            return inProgress.copy(f2, f3, f4, swipeEdge);
        }
