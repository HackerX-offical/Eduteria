...
final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public void Content(Composer composer, final int i) {
        int i2;
        Composer composerStartRestartGroup = composer.startRestartGroup(-2017021053);
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(Content)330@12553L9:BasicEdgeToEdgeDialog.android.kt#mqatfk");
        if ((i & 6) == 0) {
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2() { // from class: androidx.compose.material3.internal.DialogLayout$$ExternalSyntheticLambda0
                ...
                public final Object invoke(Object obj, Object obj2) {
                    return DialogLayout.Content$lambda$0(this.f$0, i, (Composer) obj, ((Integer) obj2).intValue());
                }
            });
        }
    }
