...
public final class PullToRefreshStateImpl implements PullToRefreshState {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final PullToRefreshStateImpl Saver$lambda$1(float f2) {
        return new PullToRefreshStateImpl(new Animatable(Float.valueOf(f2), VectorConvertersKt.getVectorConverter(FloatCompanionObject.INSTANCE), null, null, 12, null));
    }
}
