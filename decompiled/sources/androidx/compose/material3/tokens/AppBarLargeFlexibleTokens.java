...
public final class AppBarLargeFlexibleTokens {
    ...
    private static final float ContainerHeight = Dp.m8830constructorimpl((float) 120.0d);
    ...
    private static final float LargeContainerHeight = Dp.m8830constructorimpl((float) 152.0d);

    private AppBarLargeFlexibleTokens() {
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4176getContainerHeightD9Ej5fM() {
    ...
    public final float m4177getLargeContainerHeightD9Ej5fM() {
