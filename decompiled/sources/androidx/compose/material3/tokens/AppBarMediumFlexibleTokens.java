...
public final class AppBarMediumFlexibleTokens {
    ...
    private static final float ContainerHeight = Dp.m8830constructorimpl((float) 112.0d);
    ...
    private static final float LargeContainerHeight = Dp.m8830constructorimpl((float) 136.0d);

    private AppBarMediumFlexibleTokens() {
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4179getContainerHeightD9Ej5fM() {
    ...
    public final float m4180getLargeContainerHeightD9Ej5fM() {
