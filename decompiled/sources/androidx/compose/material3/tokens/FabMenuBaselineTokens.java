...
public final class FabMenuBaselineTokens {
    ...
    private static final float CloseButtonContainerElevation = ElevationTokens.INSTANCE.m4426getLevel3D9Ej5fM();
    private static final ShapeKeyTokens CloseButtonContainerShape = ShapeKeyTokens.CornerFull;
    private static final float CloseButtonIconSize = Dp.m8830constructorimpl((float) 20.0d);
    private static final float ListItemBetweenSpace = Dp.m8830constructorimpl((float) 4.0d);
    private static final float ListItemContainerElevation = ElevationTokens.INSTANCE.m4426getLevel3D9Ej5fM();
    ...
    public final float m4463getCloseButtonBetweenSpaceD9Ej5fM() {
        return CloseButtonBetweenSpace;
    }

    /* JADX INFO: renamed from: getCloseButtonContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m4464getCloseButtonContainerElevationD9Ej5fM() {
    ...
    public final float m4465getCloseButtonContainerHeightD9Ej5fM() {
    ...
    public final float m4471getListItemIconLabelSpaceD9Ej5fM() {
        return ListItemIconLabelSpace;
    }

    /* JADX INFO: renamed from: getListItemIconSize-D9Ej5fM, reason: not valid java name */
    public final float m4472getListItemIconSizeD9Ej5fM() {
        return ListItemIconSize;
    }

    /* JADX INFO: renamed from: getListItemLeadingSpace-D9Ej5fM, reason: not valid java name */
    public final float m4473getListItemLeadingSpaceD9Ej5fM() {
        return ListItemLeadingSpace;
    }

    /* JADX INFO: renamed from: getListItemTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m4474getListItemTrailingSpaceD9Ej5fM() {
        return ListItemTrailingSpace;
    }

    static {
        float f2 = (float) 8.0d;
        CloseButtonBetweenSpace = Dp.m8830constructorimpl(f2);
        float f3 = (float) 56.0d;
        CloseButtonContainerHeight = Dp.m8830constructorimpl(f3);
        CloseButtonContainerWidth = Dp.m8830constructorimpl(f3);
        ListItemContainerHeight = Dp.m8830constructorimpl(f3);
        ListItemIconLabelSpace = Dp.m8830constructorimpl(f2);
        float f4 = (float) 24.0d;
        ListItemIconSize = Dp.m8830constructorimpl(f4);
        ListItemLeadingSpace = Dp.m8830constructorimpl(f4);
        ListItemTrailingSpace = Dp.m8830constructorimpl(f4);
    }
}
