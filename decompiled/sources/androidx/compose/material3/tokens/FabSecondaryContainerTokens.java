...
public final class FabSecondaryContainerTokens {
    ...
    private static final float FocusedContainerElevation = ElevationTokens.INSTANCE.m4426getLevel3D9Ej5fM();
    private static final ColorSchemeKeyTokens FocusedIconColor = ColorSchemeKeyTokens.OnSecondaryContainer;
    private static final float HoveredContainerElevation = ElevationTokens.INSTANCE.m4427getLevel4D9Ej5fM();
    ...
    public final float m4479getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getFocusedContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m4480getFocusedContainerElevationD9Ej5fM() {
    ...
    public final float m4481getHoveredContainerElevationD9Ej5fM() {
    ...
    public final float m4482getPressedContainerElevationD9Ej5fM() {
