...
public final class MediumIconButtonTokens {
    ...
    private static final float OutlinedOutlineWidth = Dp.m8830constructorimpl((float) 1.0d);
    ...
    public final float m4587getContainerHeightD9Ej5fM() {
    ...
    public final float m4594getWideLeadingSpaceD9Ej5fM() {
        return WideLeadingSpace;
    }

    /* JADX INFO: renamed from: getWideTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m4595getWideTrailingSpaceD9Ej5fM() {
        return WideTrailingSpace;
    }

    static {
        float f2 = (float) 16.0d;
        DefaultLeadingSpace = Dp.m8830constructorimpl(f2);
        DefaultTrailingSpace = Dp.m8830constructorimpl(f2);
        float f3 = (float) 24.0d;
        IconSize = Dp.m8830constructorimpl(f3);
        float f4 = (float) 12.0d;
        NarrowLeadingSpace = Dp.m8830constructorimpl(f4);
        NarrowTrailingSpace = Dp.m8830constructorimpl(f4);
        WideLeadingSpace = Dp.m8830constructorimpl(f3);
        WideTrailingSpace = Dp.m8830constructorimpl(f3);
    }
}
