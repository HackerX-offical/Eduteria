...
public final class PaletteTokens {
    ...
    private static final long Error40 = ColorKt.Color$default(ByteCode.PUTSTATIC, 38, 30, 0, 8, null);
    ...
    private static final long Error80 = ColorKt.Color$default(242, ByteCode.INVOKESTATIC, ByteCode.PUTFIELD, 0, 8, null);
    private static final long Error90 = ColorKt.Color$default(249, Constants.EASY_PAY_MAXIMIZE_ASSIST, 220, 0, 8, null);
    ...
    private static final long Neutral70 = ColorKt.Color$default(ByteCode.FRETURN, ByteCode.RET, ByteCode.RETURN, 0, 8, null);
    private static final long Neutral80 = ColorKt.Color$default(202, ByteCode.MULTIANEWARRAY, HttpStatus.SC_RESET_CONTENT, 0, 8, null);
    private static final long Neutral87 = ColorKt.Color$default(Constants.EASY_PAY_MAXIMIZE_ASSIST, 216, 225, 0, 8, null);
    ...
    private static final long NeutralVariant70 = ColorKt.Color$default(ByteCode.FRETURN, ByteCode.RET, 180, 0, 8, null);
    private static final long NeutralVariant80 = ColorKt.Color$default(202, ByteCode.WIDE, 208, 0, 8, null);
    ...
    private static final long Primary70 = ColorKt.Color$default(ByteCode.INVOKEVIRTUAL, 157, 248, 0, 8, null);
    private static final long Primary80 = ColorKt.Color$default(208, 188, 255, 0, 8, null);
    private static final long Primary90 = ColorKt.Color$default(234, Constants.EASY_PAY_MINIMIZE_ASSIST, 255, 0, 8, null);
    ...
    private static final long Secondary70 = ColorKt.Color$default(ByteCode.ARETURN, ByteCode.GOTO, 192, 0, 8, null);
    private static final long Secondary80 = ColorKt.Color$default(204, ByteCode.MONITORENTER, 220, 0, 8, null);
    private static final long Secondary90 = ColorKt.Color$default(232, Constants.EASY_PAY_MAXIMIZE_ASSIST, 248, 0, 8, null);
    ...
    private static final long Tertiary60 = ColorKt.Color$default(ByteCode.PUTFIELD, 131, 146, 0, 8, null);
    private static final long Tertiary70 = ColorKt.Color$default(210, 157, 172, 0, 8, null);
    private static final long Tertiary80 = ColorKt.Color$default(239, ByteCode.INVOKESTATIC, 200, 0, 8, null);
