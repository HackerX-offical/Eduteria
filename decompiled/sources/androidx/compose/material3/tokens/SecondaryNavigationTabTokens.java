...
public final class SecondaryNavigationTabTokens {
    ...
    private static final float DividerHeight = Dp.m8830constructorimpl((float) 1.0d);
    ...
    public final float m4773getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4774getContainerHeightD9Ej5fM() {
    ...
    public final float m4775getDividerHeightD9Ej5fM() {
    ...
    public final float m4776getIconSizeD9Ej5fM() {
        return IconSize;
    }
