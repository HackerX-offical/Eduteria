...
public final class SheetBottomTokens {
    ...
    private static final float DockedDragHandleHeight = Dp.m8830constructorimpl((float) 4.0d);
    private static final float DockedDragHandleWidth = Dp.m8830constructorimpl((float) 32.0d);
    private static final ShapeKeyTokens DockedMinimizedContainerShape = ShapeKeyTokens.CornerNone;
    private static final float DockedModalContainerElevation = ElevationTokens.INSTANCE.m4424getLevel1D9Ej5fM();
    private static final float DockedStandardContainerElevation = ElevationTokens.INSTANCE.m4424getLevel1D9Ej5fM();
    ...
    public final float m4777getDockedDragHandleHeightD9Ej5fM() {
        return DockedDragHandleHeight;
    }

    /* JADX INFO: renamed from: getDockedDragHandleWidth-D9Ej5fM, reason: not valid java name */
    public final float m4778getDockedDragHandleWidthD9Ej5fM() {
    ...
    public final float m4779getDockedModalContainerElevationD9Ej5fM() {
    ...
    public final float m4780getDockedStandardContainerElevationD9Ej5fM() {
