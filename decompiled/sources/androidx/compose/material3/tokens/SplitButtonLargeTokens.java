...
public final class SplitButtonLargeTokens {
    ...
    private static final float TrailingIconSize = Dp.m8830constructorimpl((float) 38.0d);
    ...
    public final float m4810getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4811getContainerHeightD9Ej5fM() {
    ...
    public final float m4814getTrailingButtonLeadingSpaceD9Ej5fM() {
    ...
    public final float m4815getTrailingButtonTrailingSpaceD9Ej5fM() {
