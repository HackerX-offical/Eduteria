...
public final class SplitButtonMediumTokens {
    ...
    private static final float TrailingIconSize = Dp.m8830constructorimpl((float) 26.0d);
    ...
    public final float m4817getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4818getContainerHeightD9Ej5fM() {
    ...
    public final float m4821getTrailingButtonLeadingSpaceD9Ej5fM() {
    ...
    public final float m4822getTrailingButtonTrailingSpaceD9Ej5fM() {
