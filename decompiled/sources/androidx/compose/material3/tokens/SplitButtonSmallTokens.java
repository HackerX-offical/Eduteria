...
public final class SplitButtonSmallTokens {
    ...
    private static final float BetweenSpace = Dp.m8830constructorimpl((float) 2.0d);
    ...
    private static final float LeadingButtonLeadingSpace = Dp.m8830constructorimpl((float) 16.0d);
    private static final float LeadingButtonTrailingSpace = Dp.m8830constructorimpl((float) 12.0d);
    private static final float TrailingIconSize = Dp.m8830constructorimpl((float) 22.0d);
    ...
    public final float m4824getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }

    /* JADX INFO: renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m4825getContainerHeightD9Ej5fM() {
    ...
    public final float m4828getTrailingButtonLeadingSpaceD9Ej5fM() {
    ...
    public final float m4829getTrailingButtonTrailingSpaceD9Ej5fM() {
        return TrailingButtonTrailingSpace;
    }

    static {
        float f2 = (float) 13.0d;
        TrailingButtonLeadingSpace = Dp.m8830constructorimpl(f2);
        TrailingButtonTrailingSpace = Dp.m8830constructorimpl(f2);
    }
}
