...
public final class SplitButtonXLargeTokens {
    ...
    private static final float ContainerHeight = Dp.m8830constructorimpl((float) 136.0d);
    ...
    private static final float TrailingIconSize = Dp.m8830constructorimpl((float) 50.0d);
    ...
    public final float m4831getBetweenSpaceD9Ej5fM() {
        return BetweenSpace;
    }
    ...
    public final float m4835getTrailingButtonLeadingSpaceD9Ej5fM() {
    ...
    public final float m4836getTrailingButtonTrailingSpaceD9Ej5fM() {
        return TrailingButtonTrailingSpace;
    }

    static {
        float f2 = (float) 64.0d;
        LeadingButtonLeadingSpace = Dp.m8830constructorimpl(f2);
        LeadingButtonTrailingSpace = Dp.m8830constructorimpl(f2);
        float f3 = (float) 43.0d;
        TrailingButtonLeadingSpace = Dp.m8830constructorimpl(f3);
        TrailingButtonTrailingSpace = Dp.m8830constructorimpl(f3);
    }
}
