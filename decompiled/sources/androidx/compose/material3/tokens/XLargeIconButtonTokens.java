...
public final class XLargeIconButtonTokens {
    ...
    private static final float IconSize = Dp.m8830constructorimpl((float) 40.0d);
    private static final float OutlinedOutlineWidth = Dp.m8830constructorimpl((float) 3.0d);
    ...
    public final float m4991getWideLeadingSpaceD9Ej5fM() {
        return WideLeadingSpace;
    }

    /* JADX INFO: renamed from: getWideTrailingSpace-D9Ej5fM, reason: not valid java name */
    public final float m4992getWideTrailingSpaceD9Ej5fM() {
