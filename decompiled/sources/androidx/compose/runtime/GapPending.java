...
final class GapPending {
    ...
    public GapPending(List<KeyInfo> list, int i) {
        this.keyInfos = list;
        this.startIndex = i;
        if (!(i >= 0)) {
        ...
        this.keyMap = LazyKt.lazy(new Function0<MultiValueMap<Object, KeyInfo>>() { // from class: androidx.compose.runtime.GapPending$keyMap$2
            ...
            public /* bridge */ /* synthetic */ MultiValueMap<Object, KeyInfo> invoke() {
                return MultiValueMap.m5083boximpl(m5020invokefVlnmYg());
            }

            /* JADX INFO: renamed from: invoke-fVlnmYg, reason: not valid java name */
            public final MutableScatterMap<Object, Object> m5020invokefVlnmYg() {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    KeyInfo keyInfo2 = gapPending.getKeyInfos().get(i3);
                    MultiValueMap.m5082addimpl(mutableScatterMapMultiMap, GapComposerKt.getJoinedKey(keyInfo2), keyInfo2);
                }
    ...
    public final MutableScatterMap<Object, Object> m5019getKeyMapfVlnmYg() {
        return ((MultiValueMap) this.keyMap.getValue()).getMap();
    }

    public final KeyInfo getNext(int key, Object dataKey) {
        return (KeyInfo) MultiValueMap.m5096removeFirstimpl(m5019getKeyMapfVlnmYg(), dataKey != null ? new JoinedKey(Integer.valueOf(key), dataKey) : Integer.valueOf(key));
    }
