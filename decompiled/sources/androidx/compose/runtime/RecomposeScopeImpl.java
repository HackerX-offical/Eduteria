...
public final class RecomposeScopeImpl implements ScopeUpdateScope, RecomposeScope, IdentifiableRecomposeScope {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final kotlin.Unit end$lambda$0$1(androidx.compose.runtime.RecomposeScopeImpl r18, int r19, androidx.collection.MutableObjectIntMap r20, androidx.compose.runtime.Composition r21) {
        /*
            r0 = r18
            r1 = r19
            r2 = r20
    ...
    public static final class Companion {
        ...
        public final boolean hasAnchoredRecomposeScopes$runtime(SlotTable slots, List<GapAnchor> anchors) {
            ...
            if (!list.isEmpty()) {
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    GapAnchor gapAnchor = anchors.get(i);
                    if (slots.ownsAnchor(gapAnchor) && (slots.slot$runtime(slots.anchorIndex(gapAnchor), 0) instanceof RecomposeScopeImpl)) {
                        return true;
                    }
                }
            }
