...
public final class SlotReader {
    ...
    public final void startGroup() {
        ...
        if (this.emptyCount <= 0) {
            ...
            if (map != null && (gapGroupSourceInformation = map.get(anchor(i))) != null) {
                gapGroupSourceInformation.reportGroup(this.table, i2);
            }
    ...
    public final GapAnchor anchor(int index) {
        ...
        if (iSearch < 0) {
            ...
            anchors$runtime.add(-(iSearch + 1), gapAnchor);
            return gapAnchor;
        }
