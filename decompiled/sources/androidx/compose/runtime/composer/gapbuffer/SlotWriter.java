...
public final class SlotWriter {
    ...
    private final GapGroupSourceInformation groupSourceInformationFor(int parent, String sourceInformation) {
        ...
        HashMap<GapAnchor, GapGroupSourceInformation> map2 = map;
        GapAnchor gapAnchorAnchor = anchor(parent);
        GapGroupSourceInformation gapGroupSourceInformation = map2.get(gapAnchorAnchor);
        if (gapGroupSourceInformation == null) {
            ...
            if (sourceInformation == null) {
                ...
                int i = this.currentGroup;
                while (iGroupSize < i) {
                    gapGroupSourceInformation.reportGroup(this, iGroupSize);
                    iGroupSize += SlotTableKt.groupSize(this.groups, iGroupSize);
                }
            }
            map2.put(gapAnchorAnchor, gapGroupSourceInformation);
        }
    ...
    private final void startGroup(int key, Object objectKey, boolean isNode, Object aux) {
        ...
        if (objArr != false) {
            ...
            if (i >= 0 && (gapGroupSourceInformationSourceInformationOf$runtime = sourceInformationOf$runtime(i)) != null) {
                gapGroupSourceInformationSourceInformationOf$runtime.reportGroup(this, i2);
            }
        } else {
    ...
    public final boolean removeGroup() {
        ...
        GapGroupSourceInformation gapGroupSourceInformationSourceInformationOf$runtime = sourceInformationOf$runtime(this.parent);
        if (gapGroupSourceInformationSourceInformationOf$runtime != null && (gapAnchorTryAnchor$runtime = tryAnchor$runtime(i)) != null) {
            gapGroupSourceInformationSourceInformationOf$runtime.removeAnchor(gapAnchorTryAnchor$runtime);
        }
        MutableIntList mutableIntList = this.pendingRecalculateMarks;
        if (mutableIntList != null) {
            while (PrioritySet.m5149isNotEmptyimpl(mutableIntList) && PrioritySet.m5150peekimpl(mutableIntList) >= i) {
                PrioritySet.m5151takeMaximpl(mutableIntList);
            }
        }
    ...
    /* JADX INFO: compiled from: SlotTable.kt */
    @Metadata(d1 = {"\u0000\u001f\n\u0000\n\u0002\u0010(\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001J\t\u0010\t\u001a\u00020\nH\u0096\u0002J\u000b\u0010\u000b\u001a\u0004\u0018\u00010\u0002H\u0096\u0002R\u001a\u0010\u0003\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\b¨\u0006\f"}, d2 = {"androidx/compose/runtime/composer/gapbuffer/SlotWriter$groupSlots$1", "", "", "current", "", "getCurrent", "()I", "setCurrent", "(I)V", "hasNext", "", ES6Iterator.NEXT_METHOD, "runtime"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public static final class Companion {
        ...
        public final List<GapAnchor> moveGroup(SlotWriter fromWriter, int fromIndex, SlotWriter toWriter, boolean updateFromCursor, boolean updateToCursor, boolean removeSourceGroup) {
            ...
            List<GapAnchor> list = arrayListEmptyList;
            if (!list.isEmpty()) {
                ...
                if (map != null && map2 != null) {
                    ...
                    for (int i14 = 0; i14 < size; i14++) {
                        GapAnchor gapAnchor2 = arrayListEmptyList.get(i14);
                        GapGroupSourceInformation gapGroupSourceInformation = (GapGroupSourceInformation) map.get(gapAnchor2);
                        if (gapGroupSourceInformation != null) {
                            map.remove(gapAnchor2);
                            map2.put(gapAnchor2, gapGroupSourceInformation);
                        }
                    }
                }
            }
            int parent2 = toWriter.getParent();
            GapGroupSourceInformation gapGroupSourceInformationSourceInformationOf$runtime = toWriter.sourceInformationOf$runtime(parent);
            if (gapGroupSourceInformationSourceInformationOf$runtime != null) {
                ...
                gapGroupSourceInformationSourceInformationOf$runtime.addGroupAfter(toWriter, i15, currentGroup2);
            }
    ...
    public final List<GapAnchor> moveTo(GapAnchor anchor, int offset, SlotWriter writer) {
        ...
        List<GapAnchor> listMoveGroup$default = Companion.moveGroup$default(INSTANCE, this, iAnchorIndex, writer, false, false, false, 32, null);
    ...
    public final List<GapAnchor> moveFrom(SlotTable table, int index, boolean removeSourceGroup) {
        ...
        if (index == 0 && this.currentGroup == 0 && this.table.getGroupsSize() == 0 && SlotTableKt.groupSize(table.getGroups(), index) == table.getGroupsSize()) {
            ...
            Object[] objArrM5155getSlots = table.getSlots();
            ...
            this.groups = groups;
            this.slots = objArrM5155getSlots;
            this.anchors = table.getAnchors$runtime();
            this.groupGapStart = groupsSize;
            this.groupGapLen = (groups.length / 5) - groupsSize;
            this.slotsGapStart = slotsSize;
            this.slotsGapLen = objArrM5155getSlots.length - slotsSize;
        ...
        try {
            List<GapAnchor> listMoveGroup = INSTANCE.moveGroup(slotWriterOpenWriter, index, this, true, true, removeSourceGroup);
    ...
    public final List<GapAnchor> moveIntoGroupFrom(int offset, SlotTable table, int index) {
        ...
        SlotWriter slotWriterOpenWriter = table.openWriter();
        try {
            List<GapAnchor> listMoveGroup$default = Companion.moveGroup$default(INSTANCE, slotWriterOpenWriter, index, this, false, true, false, 32, null);
            slotWriterOpenWriter.close(true);
            endInsert();
            endGroup();
            this.currentGroup = i;
    ...
    private final void recalculateMarks() {
        MutableIntList mutableIntList = this.pendingRecalculateMarks;
        if (mutableIntList != null) {
            while (PrioritySet.m5149isNotEmptyimpl(mutableIntList)) {
                m5156updateContainsMarkNowqrM0pCk(PrioritySet.m5151takeMaximpl(mutableIntList), mutableIntList);
            }
        }
    }
    ...
    public final void updateContainsMark(int group) {
        if (group >= 0) {
            MutableIntList mutableIntListM5144constructorimpl$default = this.pendingRecalculateMarks;
            if (mutableIntListM5144constructorimpl$default == null) {
                mutableIntListM5144constructorimpl$default = PrioritySet.m5144constructorimpl$default(null, 1, null);
                this.pendingRecalculateMarks = mutableIntListM5144constructorimpl$default;
            }
            PrioritySet.m5141addimpl(mutableIntListM5144constructorimpl$default, group);
        }
    }

    /* JADX INFO: renamed from: updateContainsMarkNow-qrM0pCk, reason: not valid java name */
    private final void m5156updateContainsMarkNowqrM0pCk(int group, MutableIntList set) {
        int iGroupIndexToAddress = groupIndexToAddress(group);
        ...
        if (((iArr[(iGroupIndexToAddress * 5) + 1] & 67108864) != 0) != zChildContainsAnyMarks) {
            ...
            int iParent = parent(group);
            if (iParent >= 0) {
                PrioritySet.m5141addimpl(set, iParent);
            }
        }
    }
    ...
    public final GapGroupSourceInformation sourceInformationOf$runtime(int group) {
        GapAnchor gapAnchorTryAnchor$runtime;
        HashMap<GapAnchor, GapGroupSourceInformation> map = this.sourceInformationMap;
        if (map == null || (gapAnchorTryAnchor$runtime = tryAnchor$runtime(group)) == null) {
            return null;
        }
        return map.get(gapAnchorTryAnchor$runtime);
    }
    ...
    */
    private final void updateNodeOfGroup(int r5, java.lang.Object r6) {
        ...
        L30:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.composer.gapbuffer.SlotWriter.updateNodeOfGroup(int, java.lang.Object):void");
    }
    ...
    private final void updateAnchors(int previousGapStart, int newGapStart) {
        ...
        if (previousGapStart < newGapStart) {
            for (int iLocationOf = SlotTableKt.locationOf(this.anchors, previousGapStart, capacity); iLocationOf < this.anchors.size() && (location$runtime2 = (gapAnchor2 = this.anchors.get(iLocationOf)).getLocation()) < 0 && (i = location$runtime2 + capacity) < newGapStart; iLocationOf++) {
                gapAnchor2.setLocation$runtime(i);
            }
            return;
        }
        for (int iLocationOf2 = SlotTableKt.locationOf(this.anchors, newGapStart, capacity); iLocationOf2 < this.anchors.size() && (location$runtime = (gapAnchor = this.anchors.get(iLocationOf2)).getLocation()) >= 0; iLocationOf2++) {
            gapAnchor.setLocation$runtime(-(capacity - location$runtime));
        }
    }
    ...
    private final boolean removeAnchors(int gapStart, int size, HashMap<GapAnchor, GapGroupSourceInformation> sourceInformationMap) {
        ...
        int i3 = 0;
        while (iLocationOf >= 0) {
            GapAnchor gapAnchor = this.anchors.get(iLocationOf);
    ...
    private final void moveAnchors(int originalLocation, int newLocation, int size) {
        ...
        if (iLocationOf >= 0) {
            while (iLocationOf < this.anchors.size() && (iAnchorIndex = anchorIndex((gapAnchor = this.anchors.get(iLocationOf)))) >= originalLocation && iAnchorIndex < i) {
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            ...
            int iAnchorIndex2 = anchorIndex(gapAnchor2) + i2;
            if (iAnchorIndex2 >= this.groupGapStart) {
                gapAnchor2.setLocation$runtime(-(size$runtime - iAnchorIndex2));
            } else {
                gapAnchor2.setLocation$runtime(iAnchorIndex2);
            }
            this.anchors.add(SlotTableKt.locationOf(this.anchors, iAnchorIndex2, size$runtime), gapAnchor2);
        }
    }
    ...
    public final String toDebugString() {
        ...
        sb.append("  current:   " + this.currentGroup).append('\n');
        sb.append("  group gap: " + this.groupGapStart + '-' + (this.groupGapStart + this.groupGapLen) + '(' + this.groupGapLen + ')').append('\n');
        sb.append("  slots gap: " + this.slotsGapStart + '-' + (this.slotsGapStart + this.slotsGapLen) + '(' + this.slotsGapLen + ')').append('\n');
        sb.append("  gap owner: " + this.slotsGapOwner).append('\n');
        int size$runtime = getSize$runtime();
