...
public final class ComposerChangeListWriter {
    ...
    public final void recordSlotEditing() {
        ...
        ensureRootStarted();
        if (parent > 0) {
            GapAnchor gapAnchorAnchor = reader.anchor(parent);
            this.startedGroups.push(parent);
            ensureGroupStarted(gapAnchorAnchor);
        }
    }
