...
public final class Operations extends DebugStringFormattable {
    ...
    public final void push(Operation operation, Function1<? super WriteScope, Unit> args) {
        pushOp(operation);
        args.invoke(WriteScope.m5270boximpl(WriteScope.m5271constructorimpl(this)));
    ...
    private final String exceptionMessageForOperationPushWithScope(Operation operation) {
        ...
        for (int i4 = 0; i4 < objects; i4++) {
            if (((1 << i4) & this.pushedObjectMask) == 0) {
                ...
                sb2.append(operation.mo5221objectParamNamegvac4VY(Operation.ObjectParameter.m5244constructorimpl(i4)));
                i3++;
            }
        }
    ...
    public static final class WriteScope {
        ...
        public static final void m5277setIntimpl(Operations operations, int i, int i2) {
        ...
        public static final void m5278setIntsimpl(Operations operations, int i, int i2, int i3, int i4) {
        ...
        /* JADX INFO: renamed from: setInts-impl, reason: not valid java name */
        public static final void m5279setIntsimpl(Operations operations, int i, int i2, int i3, int i4, int i5, int i6) {
            int ints = operations.intArgsSize - operations.opCodes[operations.opCodesSize - 1].getInts();
            int[] iArr = operations.intArgs;
            iArr[i + ints] = i2;
            iArr[i3 + ints] = i4;
        ...
        public static final <T> void m5281setObjectaWHcuVo(Operations operations, int i, T t) {
        ...
        public static final <T, U> void m5282setObjectsEykTJF8(Operations operations, int i, T t, int i2, U u) {
        ...
        public static final <T, U, V> void m5283setObjectsGn0XI2A(Operations operations, int i, T t, int i2, U u, int i3, V v) {
            int objects = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objArr = operations.objectArgs;
            objArr[i + objects] = t;
            objArr[i2 + objects] = u;
        ...
        public static final <T, U, V, W> void m5284setObjectsUOUgNZM(Operations operations, int i, T t, int i2, U u, int i3, V v, int i4, W w) {
            int objects = operations.objectArgsSize - operations.opCodes[operations.opCodesSize - 1].getObjects();
            Object[] objArr = operations.objectArgs;
            objArr[i + objects] = t;
            objArr[i2 + objects] = u;
        ...
        public static final void m5276requireApplicationimpl(Operations operations) {
            operations.requiresApplication = true;
        }

        /* JADX INFO: renamed from: getOperation-impl, reason: not valid java name */
        public static final Operation m5274getOperationimpl(Operations operations) {
            return operations.opCodes[operations.opCodesSize - 1];
        }

        /* JADX INFO: renamed from: setLong-impl, reason: not valid java name */
        public static final void m5280setLongimpl(Operations operations, int i, int i2, long j) {
    ...
    public final class OpIterator implements OperationArgContainer {
        ...
        public <T> T mo5267getObjectgvac4VY(int parameter) {
    ...
    public final String currentOpToDebugString(OpIterator opIterator, String str) {
        ...
        int objects = operation.getObjects();
        for (int i2 = 0; i2 < objects; i2++) {
            int iM5244constructorimpl = Operation.ObjectParameter.m5244constructorimpl(i2);
            String strMo5221objectParamNamegvac4VY = operation.mo5221objectParamNamegvac4VY(iM5244constructorimpl);
            if (z) {
                z = false;
            } else {
                sb.append(", ");
            ...
            sb.append('\n');
            sb.append(strIndent);
            sb.append(strMo5221objectParamNamegvac4VY);
            sb.append(" = ");
            sb.append(formatOpArgumentToString(opIterator.mo5267getObjectgvac4VY(iM5244constructorimpl), strIndent));
        }
        sb.append('\n');
        sb.append(str);
        sb.append(")");
    ...
    private final <T> String toCollectionString(Iterable<? extends T> iterable, final String str) {
        return CollectionsKt.joinToString$default(iterable, ", ", com.clevertap.android.sdk.Constants.AES_PREFIX, com.clevertap.android.sdk.Constants.AES_SUFFIX, 0, null, new Function1() { // from class: androidx.compose.runtime.composer.linkbuffer.changelist.Operations$$ExternalSyntheticLambda0
