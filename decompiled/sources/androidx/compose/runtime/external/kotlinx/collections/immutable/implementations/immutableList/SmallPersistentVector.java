...
public final class SmallPersistentVector<E> extends AbstractPersistentList<E> implements ImmutableList<E> {
    ...
    public SmallPersistentVector(Object[] objArr) {
        this.buffer = objArr;
        CommonFunctionsKt.m5287assert(objArr.length <= 32);
    }
    ...
    public PersistentList<E> addAll(int index, Collection<? extends E> c2) {
        ...
        if (size() + c2.size() <= 32) {
            Object[] objArrBufferOfSize = bufferOfSize(size() + c2.size());
            int i = index;
            ArraysKt.copyInto$default(this.buffer, objArrBufferOfSize, 0, 0, i, 6, (Object) null);
            ArraysKt.copyInto(this.buffer, objArrBufferOfSize, c2.size() + i, i, size());
            Iterator<? extends E> it = c2.iterator();
            while (it.hasNext()) {
