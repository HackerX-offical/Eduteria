...
public final class RememberEventDispatcher implements RememberManager {
    ...
    public void startResumingScope(RecomposeScopeImpl scope) {
        ...
        if (pausedCompositionRemembers != null) {
            ArrayList<MutableVector<RememberObserverHolder>> arrayListM5052constructorimpl$default = this.nestedRemembersLists;
            if (arrayListM5052constructorimpl$default == null) {
                arrayListM5052constructorimpl$default = Stack.m5052constructorimpl$default(null, 1, null);
                this.nestedRemembersLists = arrayListM5052constructorimpl$default;
            }
            Stack.m5062pushimpl(arrayListM5052constructorimpl$default, this.currentRememberingList);
    ...
    public void endResumingScope(RecomposeScopeImpl scope) {
        ...
        if (arrayList != null && (mutableVector = (MutableVector) Stack.m5061popimpl(arrayList)) != null) {
            this.currentRememberingList = mutableVector;
        }
