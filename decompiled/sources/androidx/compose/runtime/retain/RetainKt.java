...
public final class RetainKt {
    ...
    private static final <T> T retainImpl(RetainKeys retainKeys, Function0<? extends T> function0, Composer composer, int i) {
        ...
        if (z || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            ...
            if (objConsumeExitedValueOrDefault != obj) {
                objRememberedValue = new RetainedValueHolder(retainKeys, objConsumeExitedValueOrDefault, retainedValuesStore, false);
            } else {
                objRememberedValue = new RetainedValueHolder(retainKeys, function0.invoke(), retainedValuesStore, true);
            }
