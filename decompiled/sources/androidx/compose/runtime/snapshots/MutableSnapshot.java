...
public class MutableSnapshot extends Snapshot {
    ...
    */
    ...
    public void dispose() {
        ...
        super.dispose();
        MutableSnapshot mutableSnapshot = this;
        mo5359nestedDeactivated$runtime(mutableSnapshot);
    ...
    public void mo5358nestedActivated$runtime(Snapshot snapshot) {
        this.snapshots++;
    }

    @Override // androidx.compose.runtime.snapshots.Snapshot
    /* JADX INFO: renamed from: nestedDeactivated$runtime */
    public void mo5359nestedDeactivated$runtime(Snapshot snapshot) {
        if (!(this.snapshots > 0)) {
    ...
    */
    ...
    public void mo5360recordModified$runtime(StateObject state) {
        MutableScatterSet<StateObject> modified$runtime = getModified$runtime();
