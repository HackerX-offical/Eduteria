...
public final class SnapshotWeakSet<T> {
    ...
    public final void removeIf(Function1<? super T, Boolean> block) {
        ...
        while (true) {
            ...
            QuestionBookMark questionBookMark = weakReference != null ? (Object) weakReference.get() : null;
            if (questionBookMark != null && !block.invoke(questionBookMark).booleanValue()) {
                if (i2 != i) {
