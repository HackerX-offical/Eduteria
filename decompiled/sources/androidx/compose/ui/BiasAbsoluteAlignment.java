...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo5391alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        long jM8996constructorimpl = IntSize.m8996constructorimpl((((long) (((int) (space >> 32)) - ((int) (size >> 32)))) << 32) | (((long) (((int) (space & 4294967295L)) - ((int) (size & 4294967295L)))) & 4294967295L));
        float f2 = 1;
        return IntOffset.m8952constructorimpl((((long) Math.round((((int) (jM8996constructorimpl >> 32)) / 2.0f) * (this.horizontalBias + f2))) << 32) | (((long) Math.round((((int) (jM8996constructorimpl & 4294967295L)) / 2.0f) * (f2 + this.verticalBias))) & 4294967295L));
    }
}
