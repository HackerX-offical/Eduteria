...
public final class CombinedModifier implements Modifier {
    ...
    public String toString() {
        return Constants.AES_PREFIX + ((String) foldIn("", new Function2<String, Modifier.Element, String>() { // from class: androidx.compose.ui.CombinedModifier.toString.1
