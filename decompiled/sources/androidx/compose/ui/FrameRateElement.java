...
final /* data */ class FrameRateElement extends ModifierNodeElement<FrameRateModifierNode> {
    ...
    public FrameRateElement(float f2) {
        this.frameRate = f2;
    }
