...
public final class ComposeDragShadowBuilder extends View.DragShadowBuilder {
    ...
    public void onProvideShadowMetrics(Point outShadowSize, Point outShadowTouchPoint) {
        ...
        outShadowSize.set(density.mo482roundToPx0680j_4(density.mo484toDpu2uoSUM(Float.intBitsToFloat((int) (this.decorationSize >> 32)))), density.mo482roundToPx0680j_4(density.mo484toDpu2uoSUM(Float.intBitsToFloat((int) (this.decorationSize & 4294967295L)))));
    ...
    public void onDrawShadow(Canvas canvas) {
        ...
        drawParams2.m6469setSizeuvyYCjk(j);
        Canvas.save();
