...
public final class DragAndDropNode extends Modifier.Node implements TraversableNode, DragAndDropModifierNode, DragAndDropSourceModifierNode, DragAndDropTargetModifierNode, DragAndDropTarget {
    ...
    public final void m5477setSizeozmzZPI$ui(long j) {
        this.size = j;
    }
    ...
    public void mo5476requestDragAndDropTransferk4lQ0M(long offset) {
        if (!(this.onStartTransfer != null)) {
            InlineClassHelperKt.throwIllegalStateException("Check failed.");
        }
        getDragAndDropManager().mo5472requestDragAndDropTransferUv8p0NA(this, offset);
    }

    /* JADX INFO: renamed from: startDragAndDropTransfer-d-4ec7I, reason: not valid java name */
    public final void m5478startDragAndDropTransferd4ec7I(final DragAndDropStartTransferScope dragAndDropStartTransferScope, final long j, final Function0<Boolean> function0) {
        ...
        DragAndDropNodeKt.traverseSelfAndDescendants(this, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$startDragAndDropTransfer$1
            ...
            public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode dragAndDropNode) {
                if (dragAndDropNode.getIsAttached()) {
                    ...
                    if (!Offset.m5720equalsimpl0(j, Offset.INSTANCE.m5738getUnspecifiedF1C5BW0())) {
                        long jMo7454localPositionOfR5De75A = DelegatableNodeKt.requireLayoutNode(dragAndDropNode).getCoordinates().mo7454localPositionOfR5De75A(coordinates, j);
                        if (!SizeKt.m5813toRectuvyYCjk(IntSizeKt.m9013toSizeozmzZPI(dragAndDropNode.getSize())).m5749containsk4lQ0M(jMo7454localPositionOfR5De75A)) {
                            return TraversableNode.Companion.TraverseDescendantsAction.ContinueTraversal;
                        }
                        function2.invoke(dragAndDropStartTransferScope, Offset.m5712boximpl(jMo7454localPositionOfR5De75A));
                    } else {
                        function2.invoke(dragAndDropStartTransferScope, Offset.m5712boximpl(Offset.INSTANCE.m5738getUnspecifiedF1C5BW0()));
                    }
    ...
    public void mo5474drag12SF9DM(final DragAndDropTransferData transferData, final long decorationSize, final Function1<? super DrawScope, Unit> drawDragDecoration) {
        if (!(this.onStartTransfer == null)) {
            InlineClassHelperKt.throwIllegalStateException("Check failed.");
        }
        this.onStartTransfer = new Function2<DragAndDropStartTransferScope, Offset, Unit>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$drag$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(DragAndDropStartTransferScope dragAndDropStartTransferScope, Offset offset) {
                m5479invokeUv8p0NA(dragAndDropStartTransferScope, offset.m5733unboximpl());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-Uv8p0NA, reason: not valid java name */
            public final void m5479invokeUv8p0NA(DragAndDropStartTransferScope dragAndDropStartTransferScope, long j) {
                dragAndDropStartTransferScope.mo5473startDragAndDropTransfer12SF9DM(transferData, decorationSize, drawDragDecoration);
            }
        };
        getDragAndDropManager().mo5472requestDragAndDropTransferUv8p0NA(this, Offset.INSTANCE.m5738getUnspecifiedF1C5BW0());
    ...
    public void onMoved(final DragAndDropEvent event) {
        ...
        if (dragAndDropNode2 == null || !DragAndDropNodeKt.m5481containsUv8p0NA(dragAndDropNode2, DragAndDrop_androidKt.getPositionInRoot(event))) {
            ...
            if (dragAndDropNode3.getNode().getIsAttached()) {
                ...
                TraversableNodeKt.traverseDescendants(dragAndDropNode3, new Function1<DragAndDropNode, TraversableNode.Companion.TraverseDescendantsAction>() { // from class: androidx.compose.ui.draganddrop.DragAndDropNode$onMoved$$inlined$firstDescendantOrNull$1
                    ...
                    public final TraversableNode.Companion.TraverseDescendantsAction invoke(DragAndDropNode dragAndDropNode4) {
                        ...
                        if (this.getDragAndDropManager().isInterestedTarget(dragAndDropNode5) && DragAndDropNodeKt.m5481containsUv8p0NA(dragAndDropNode5, DragAndDrop_androidKt.getPositionInRoot(event))) {
