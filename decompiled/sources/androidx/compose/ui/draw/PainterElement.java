...
final /* data */ class PainterElement extends ModifierNodeElement<PainterNode> {
    ...
    public static /* synthetic */ PainterElement copy$default(PainterElement painterElement, Painter painter, boolean z, Alignment alignment, ContentScale contentScale, float f2, ColorFilter colorFilter, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public void update(PainterNode node) {
        ...
        boolean z2 = sizeToIntrinsics != z || (z && !Size.m5788equalsimpl0(node.getPainter().mo6669getIntrinsicSizeNHjbRc(), this.painter.mo6669getIntrinsicSizeNHjbRc()));
