...
public final class ShadowKt {
    ...
    public static final /* synthetic */ Modifier m5567shadowziNgDLE(Modifier modifier, float f2, Shape shape, boolean z) {
        return m5565shadows4CzXII(modifier, f2, shape, z, GraphicsLayerScopeKt.getDefaultShadowColor(), GraphicsLayerScopeKt.getDefaultShadowColor());
    }

    /* JADX INFO: renamed from: shadow-s4CzXII$default, reason: not valid java name */
    public static /* synthetic */ Modifier m5566shadows4CzXII$default(Modifier modifier, float f2, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        boolean z2;
        ...
        return m5565shadows4CzXII(modifier, f2, rectangleShape, z2, (i & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j, (i & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j2);
    }
    ...
    public static final void resetShadow(ShadowScope shadowScope) {
        ...
        shadowScope.mo5487setOffsetk4lQ0M(Offset.INSTANCE.m5739getZeroF1C5BW0());
        shadowScope.mo5486setColor8_81llA(Color.INSTANCE.m5994getBlack0d7_KjU());
        shadowScope.setBrush(null);
        shadowScope.setAlpha(1.0f);
        shadowScope.mo5485setBlendModes9anfk8(BlendMode.INSTANCE.m5908getSrcOver0nO6VwU());
    }

    /* JADX INFO: renamed from: shadow-s4CzXII, reason: not valid java name */
    public static final Modifier m5565shadows4CzXII(Modifier modifier, float f2, Shape shape, boolean z, long j, long j2) {
        return (Dp.m8829compareTo0680j_4(f2, Dp.m8830constructorimpl((float) 0)) > 0 || z) ? modifier.then(new ShadowGraphicsLayerElement(f2, shape, z, j, j2, null)) : modifier;
    }
}
