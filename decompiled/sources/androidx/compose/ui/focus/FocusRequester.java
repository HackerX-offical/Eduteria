...
public final class FocusRequester {
    ...
    public final /* synthetic */ void requestFocus() {
        m5629requestFocus3ESFkO8(FocusDirection.INSTANCE.m5603getEnterdhqQ8s());
    }

    /* JADX INFO: renamed from: requestFocus-3ESFkO8$default, reason: not valid java name */
    public static /* synthetic */ boolean m5628requestFocus3ESFkO8$default(FocusRequester focusRequester, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = FocusDirection.INSTANCE.m5603getEnterdhqQ8s();
        }
        return focusRequester.m5629requestFocus3ESFkO8(i);
    }
    ...
    public final boolean m5629requestFocus3ESFkO8(int focusDirection) {
        Companion companion = INSTANCE;
        if (this == companion.getDefault()) {
            throw new IllegalStateException("\n    Please check whether the focusRequester is FocusRequester.Cancel or FocusRequester.Default\n    before invoking any functions on the focusRequester.\n".toString());
        }
                    ...
                    if ((nodePop.getAggregateChildKindSet() & iM7763constructorimpl) == 0) {
                        ...
                        while (true) {
                            ...
                            if ((nodePop.getKindSet() & iM7763constructorimpl) != 0) {
                                ...
                                while (nodePop != null) {
                                    if (nodePop instanceof FocusTargetNode) {
                                        if (((FocusTargetNode) nodePop).mo5632requestFocus3ESFkO8(focusDirection)) {
                                            z = true;
                                            break;
                                        }
                                    } else if ((nodePop.getKindSet() & iM7763constructorimpl) != 0 && (nodePop instanceof DelegatingNode)) {
