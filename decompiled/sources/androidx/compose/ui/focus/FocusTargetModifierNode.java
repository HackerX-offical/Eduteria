...
public interface FocusTargetModifierNode extends DelegatableNode {
    ...
    int mo5631getFocusabilityLCbbffg();
    ...
    boolean mo5632requestFocus3ESFkO8(int focusDirection);

    /* JADX INFO: renamed from: setFocusability-josRg5g, reason: not valid java name */
    void mo5633setFocusabilityjosRg5g(int i);

    /* JADX INFO: renamed from: requestFocus-3ESFkO8$default, reason: not valid java name */
    static /* synthetic */ boolean m5630requestFocus3ESFkO8$default(FocusTargetModifierNode focusTargetModifierNode, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        return focusTargetModifierNode.mo5632requestFocus3ESFkO8(i);
    }
}
