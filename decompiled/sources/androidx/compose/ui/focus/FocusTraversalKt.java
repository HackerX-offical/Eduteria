...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m5647customFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5603getEnterdhqQ8s()) || FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5604getExitdhqQ8s())) {
    ...
    public static final Boolean m5648focusSearch0X8WOeE(FocusTargetNode focusTargetNode, int i, LayoutDirection layoutDirection, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int iM5608getRightdhqQ8s;
        if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5606getNextdhqQ8s()) || FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5607getPreviousdhqQ8s())) {
            return Boolean.valueOf(OneDimensionalFocusSearchKt.m5662oneDimensionalFocusSearchOMvw8(focusTargetNode, i, function1));
        }
        if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5605getLeftdhqQ8s()) || FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5608getRightdhqQ8s()) || FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5609getUpdhqQ8s()) || FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5602getDowndhqQ8s())) {
            return TwoDimensionalFocusSearchKt.m5673twoDimensionalFocusSearchsMXa3k8(focusTargetNode, i, rect, function1);
        }
        if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5603getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                iM5608getRightdhqQ8s = FocusDirection.INSTANCE.m5608getRightdhqQ8s();
            } else {
                if (i2 != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                iM5608getRightdhqQ8s = FocusDirection.INSTANCE.m5605getLeftdhqQ8s();
            }
            FocusTargetNode focusTargetNodeFindActiveFocusNode = findActiveFocusNode(focusTargetNode);
            if (focusTargetNodeFindActiveFocusNode != null) {
                return TwoDimensionalFocusSearchKt.m5673twoDimensionalFocusSearchsMXa3k8(focusTargetNodeFindActiveFocusNode, iM5608getRightdhqQ8s, rect, function1);
            }
            return null;
        }
        if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5604getExitdhqQ8s())) {
        ...
        throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m5600toStringimpl(i))).toString());
    }
