...
public interface PlatformFocusOwner {
    ...
    boolean mo5664moveFocusInChildren3ESFkO8(int focusDirection);

    /* JADX INFO: renamed from: requestOwnerFocus-7o62pno, reason: not valid java name */
    boolean mo5665requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect);
}
