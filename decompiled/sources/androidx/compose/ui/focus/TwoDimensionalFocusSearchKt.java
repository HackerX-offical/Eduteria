...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m5673twoDimensionalFocusSearchsMXa3k8(FocusTargetNode focusTargetNode, int i, Rect rect, Function1<? super FocusTargetNode, Boolean> function1) {
        int i2 = WhenMappings.$EnumSwitchMapping$0[focusTargetNode.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m5669findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, i, function1));
            }
            if (i2 != 4) {
            ...
            return Boolean.valueOf(m5672searchChildren4C6V_qg(focusTargetNode, rect, i, function1));
        }
        ...
        if (i3 == 1) {
            Boolean boolM5673twoDimensionalFocusSearchsMXa3k8 = m5673twoDimensionalFocusSearchsMXa3k8(activeChild, i, rect, function1);
            if (!Intrinsics.areEqual((Object) boolM5673twoDimensionalFocusSearchsMXa3k8, (Object) false)) {
                return boolM5673twoDimensionalFocusSearchsMXa3k8;
            }
            if (rect == null) {
                rect = FocusTraversalKt.focusRect(activeNode(activeChild));
            }
            return Boolean.valueOf(m5670generateAndSearchChildren4C6V_qg(focusTargetNode, rect, i, function1));
        }
        if (i3 == 2 || i3 == 3) {
            if (rect == null) {
    ...
    private static final boolean m5670generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final Rect rect, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m5672searchChildren4C6V_qg(focusTargetNode, rect, i, function1)) {
            return true;
        }
        ...
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m5593searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                if (activeFocusTargetNode == DelegatableNodeKt.requireOwner(focusTargetNode).getFocusOwner().getActiveFocusTargetNode()) {
                    Boolean boolValueOf = Boolean.valueOf(TwoDimensionalFocusSearchKt.m5672searchChildren4C6V_qg(focusTargetNode, rect, i, function1));
    ...
    private static final FocusTargetNode m5668findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect rect, int i) {
        Rect rectTranslate;
        if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5605getLeftdhqQ8s())) {
            ...
            rectTranslate = rect.translate(-((rect.getRight() - rect.getLeft()) + 1), 0.0f);
        } else if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5609getUpdhqQ8s())) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                ...
                if (m5671isBetterCandidateI7lrPNg(rectFocusRect, rectTranslate, rect, i)) {
    ...
    */
    private static final float isBetterCandidate_I7lrPNg$majorAxisDistance(androidx.compose.ui.geometry.Rect r1, int r2, androidx.compose.ui.geometry.Rect r3) {
        /*
            ...
            int r0 = r0.m5605getLeftdhqQ8s()
            boolean r0 = androidx.compose.ui.focus.FocusDirection.m5598equalsimpl0(r2, r0)
            if (r0 == 0) goto L16
            float r2 = r3.getLeft()
        ...
        L42:
            androidx.compose.ui.focus.FocusDirection$Companion r0 = androidx.compose.ui.focus.FocusDirection.INSTANCE
            int r0 = r0.m5602getDowndhqQ8s()
            boolean r2 = androidx.compose.ui.focus.FocusDirection.m5598equalsimpl0(r2, r0)
            if (r2 == 0) goto L5e
            float r1 = r1.getTop()
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float bottom;
        float top2;
        if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5605getLeftdhqQ8s()) || FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5608getRightdhqQ8s())) {
            ...
            top2 = rect.getTop();
        } else if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5609getUpdhqQ8s()) || FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5602getDowndhqQ8s())) {
    ...
    public static final boolean m5671isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (!isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return false;
        }
        if (isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) && !m5667beamBeatsI7lrPNg(rect3, rect, rect2, i)) {
            return !m5667beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2);
        }
        return true;
    }
    ...
    private static final boolean beamBeats_I7lrPNg$inSourceBeam(Rect rect, int i, Rect rect2) {
        ...
        if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5609getUpdhqQ8s()) || FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5602getDowndhqQ8s())) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static final float beamBeats_I7lrPNg$majorAxisDistance(androidx.compose.ui.geometry.Rect r1, int r2, androidx.compose.ui.geometry.Rect r3) {
        /*
            androidx.compose.ui.focus.FocusDirection$Companion r0 = androidx.compose.ui.focus.FocusDirection.INSTANCE
            int r0 = r0.m5605getLeftdhqQ8s()
            boolean r0 = androidx.compose.ui.focus.FocusDirection.m5598equalsimpl0(r2, r0)
        ...
        L5e:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt.beamBeats_I7lrPNg$majorAxisDistance(androidx.compose.ui.geometry.Rect, int, androidx.compose.ui.geometry.Rect):float");
    }
    ...
    */
    ...
    private static final boolean m5667beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (beamBeats_I7lrPNg$inSourceBeam(rect3, i, rect) || !beamBeats_I7lrPNg$inSourceBeam(rect2, i, rect)) {
            return false;
        }
        return !beamBeats_I7lrPNg$isInDirectionOfSearch(rect3, i, rect) || FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5605getLeftdhqQ8s()) || FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5608getRightdhqQ8s()) || beamBeats_I7lrPNg$majorAxisDistance(rect2, i, rect) < beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i, rect);
    }
    ...
    public static final boolean m5669findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5603getEnterdhqQ8s())) {
            i = FocusDirection.INSTANCE.m5608getRightdhqQ8s();
        }
        if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5608getRightdhqQ8s()) || FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5602getDowndhqQ8s())) {
            rectBottomRight = topLeft(FocusTraversalKt.focusRect(focusTargetNode));
        } else if (FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5605getLeftdhqQ8s()) || FocusDirection.m5598equalsimpl0(i, FocusDirection.INSTANCE.m5609getUpdhqQ8s())) {
            rectBottomRight = bottomRight(FocusTraversalKt.focusRect(focusTargetNode));
        } else {
            throw new IllegalStateException(InvalidFocusDirection.toString());
        }
        FocusTargetNode focusTargetNodeM5668findBestCandidate4WY_MpI = m5668findBestCandidate4WY_MpI(mutableVector, rectBottomRight, i);
        if (focusTargetNodeM5668findBestCandidate4WY_MpI != null) {
            return function1.invoke(focusTargetNodeM5668findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }
    ...
    public static final boolean m5672searchChildren4C6V_qg(FocusTargetNode focusTargetNode, Rect rect, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        FocusTargetNode focusTargetNodeM5668findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        ...
        while (mutableVector2.getSize() != 0) {
            ...
            if ((nodePop.getAggregateChildKindSet() & iM7763constructorimpl) == 0) {
                ...
                while (true) {
                    ...
                    if ((nodePop.getKindSet() & iM7763constructorimpl) != 0) {
        ...
        while (mutableVector.getSize() != 0 && (focusTargetNodeM5668findBestCandidate4WY_MpI = m5668findBestCandidate4WY_MpI(mutableVector, rect, i)) != null) {
            if (focusTargetNodeM5668findBestCandidate4WY_MpI.fetchFocusProperties$ui().getCanFocus()) {
                return function1.invoke(focusTargetNodeM5668findBestCandidate4WY_MpI).booleanValue();
            }
            if (m5670generateAndSearchChildren4C6V_qg(focusTargetNodeM5668findBestCandidate4WY_MpI, rect, i, function1)) {
                return true;
            }
            mutableVector.remove(focusTargetNodeM5668findBestCandidate4WY_MpI);
        }
        return false;
    }
