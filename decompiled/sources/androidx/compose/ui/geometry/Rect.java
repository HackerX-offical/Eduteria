...
public final /* data */ class Rect {
    ...
    public static /* synthetic */ Rect copy$default(Rect rect, float f2, float f3, float f4, float f5, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = rect.left;
        }
        if ((i & 2) != 0) {
    ...
    public static /* synthetic */ void m5748getSizeNHjbRc$annotations() {
    }
    ...
    public final Rect m5760translatek4lQ0M(long offset) {
        int i = (int) (offset >> 32);
    ...
    public final long m5758getTopLeftF1C5BW0() {
        float f2 = this.left;
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(this.top)) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
    }

    /* JADX INFO: renamed from: getTopCenter-F1C5BW0, reason: not valid java name */
    public final long m5757getTopCenterF1C5BW0() {
        float right = this.left + ((getRight() - getLeft()) / 2.0f);
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(this.top)) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    }

    /* JADX INFO: renamed from: getTopRight-F1C5BW0, reason: not valid java name */
    public final long m5759getTopRightF1C5BW0() {
        float f2 = this.right;
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(this.top)) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
    }

    /* JADX INFO: renamed from: getCenterLeft-F1C5BW0, reason: not valid java name */
    public final long m5754getCenterLeftF1C5BW0() {
        float f2 = this.left;
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(this.top + ((getBottom() - getTop()) / 2.0f))) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
    }

    /* JADX INFO: renamed from: getCenter-F1C5BW0, reason: not valid java name */
    public final long m5753getCenterF1C5BW0() {
        float right = this.left + ((getRight() - getLeft()) / 2.0f);
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(this.top + ((getBottom() - getTop()) / 2.0f))) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    }

    /* JADX INFO: renamed from: getCenterRight-F1C5BW0, reason: not valid java name */
    public final long m5755getCenterRightF1C5BW0() {
        float f2 = this.right;
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(this.top + ((getBottom() - getTop()) / 2.0f))) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
    }

    /* JADX INFO: renamed from: getBottomLeft-F1C5BW0, reason: not valid java name */
    public final long m5751getBottomLeftF1C5BW0() {
        float f2 = this.left;
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(this.bottom)) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
    }

    /* JADX INFO: renamed from: getBottomCenter-F1C5BW0, reason: not valid java name */
    public final long m5750getBottomCenterF1C5BW0() {
        float right = this.left + ((getRight() - getLeft()) / 2.0f);
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(this.bottom)) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    }

    /* JADX INFO: renamed from: getBottomRight-F1C5BW0, reason: not valid java name */
    public final long m5752getBottomRightF1C5BW0() {
        float f2 = this.right;
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(this.bottom)) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
    }
    ...
    public final long m5756getSizeNHjbRc() {
        float right = getRight() - getLeft();
        return Size.m5783constructorimpl((((long) Float.floatToRawIntBits(getBottom() - getTop())) & 4294967295L) | (Float.floatToRawIntBits(right) << 32));
    }
    ...
    public final boolean m5749containsk4lQ0M(long offset) {
