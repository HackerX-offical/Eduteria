...
public final class AndroidColorFilter_androidKt {
    ...
    public static final android.graphics.ColorFilter m5830actualTintColorFilterxETnrds(long j, int i) {
        if (Build.VERSION.SDK_INT >= 29) {
            return BlendModeColorFilterHelper.INSTANCE.m5912BlendModeColorFilterxETnrds(j, i);
        }
        return new PorterDuffColorFilter(ColorKt.m6022toArgb8_81llA(j), AndroidBlendMode_androidKt.m5816toPorterDuffModes9anfk8(i));
    }

    /* JADX INFO: renamed from: actualColorMatrixColorFilter-jHG-Opc, reason: not valid java name */
    public static final android.graphics.ColorFilter m5828actualColorMatrixColorFilterjHGOpc(float[] fArr) {
    ...
    public static final android.graphics.ColorFilter m5829actualLightingColorFilterOWjLjI(long j, long j2) {
        return new android.graphics.LightingColorFilter(ColorKt.m6022toArgb8_81llA(j), ColorKt.m6022toArgb8_81llA(j2));
    }

    public static final float[] actualColorMatrixFromFilter(android.graphics.ColorFilter colorFilter) {
        if ((colorFilter instanceof android.graphics.ColorMatrixColorFilter) && supportsColorMatrixQuery()) {
            return ColorMatrixFilterHelper.INSTANCE.m6047getColorMatrix8unuwjk((android.graphics.ColorMatrixColorFilter) colorFilter);
        }
