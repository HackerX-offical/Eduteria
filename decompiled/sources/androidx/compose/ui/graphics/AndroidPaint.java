...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m5908getSrcOver0nO6VwU();
    }
    ...
    public long mo5838getColor0d7_KjU() {
    ...
    public void mo5844setColor8_81llA(long j) {
        AndroidPaint_androidKt.m5850setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo5843setBlendModes9anfk8(int i) {
        if (BlendMode.m5877equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m5849setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo5842getStyleTiuSbCo() {
    ...
    public void mo5848setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m5854setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo5840getStrokeCapKaPHkGw() {
    ...
    public void mo5846setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m5852setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo5841getStrokeJoinLxFBmk8() {
    ...
    public void mo5847setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m5853setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo5839getFilterQualityfv9h1I() {
    ...
    public void mo5845setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m5851setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
