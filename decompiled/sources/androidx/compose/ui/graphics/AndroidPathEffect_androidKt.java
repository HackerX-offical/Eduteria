...
public final class AndroidPathEffect_androidKt {
    ...
    public static final PathEffect m5861actualStampedPathEffect7aD1DOk(Path path, float f2, float f3, int i) {
        if (path instanceof AndroidPath) {
            return new AndroidPathEffect(new PathDashPathEffect(((AndroidPath) path).getInternalPath(), f2, f3, m5862toAndroidPathDashPathEffectStyleoQv6xUo(i)));
        }
        throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
    }

    /* JADX INFO: renamed from: toAndroidPathDashPathEffectStyle-oQv6xUo, reason: not valid java name */
    public static final PathDashPathEffect.Style m5862toAndroidPathDashPathEffectStyleoQv6xUo(int i) {
        return StampedPathEffectStyle.m6330equalsimpl0(i, StampedPathEffectStyle.INSTANCE.m6334getMorphYpspkwk()) ? PathDashPathEffect.Style.MORPH : StampedPathEffectStyle.m6330equalsimpl0(i, StampedPathEffectStyle.INSTANCE.m6335getRotateYpspkwk()) ? PathDashPathEffect.Style.ROTATE : StampedPathEffectStyle.m6330equalsimpl0(i, StampedPathEffectStyle.INSTANCE.m6336getTranslateYpspkwk()) ? PathDashPathEffect.Style.TRANSLATE : PathDashPathEffect.Style.TRANSLATE;
    }
}
