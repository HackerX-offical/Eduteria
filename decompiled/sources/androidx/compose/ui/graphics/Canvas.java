...
public interface Canvas {
    ...
    void mo5820drawCircle9KIMszo(long center, float radius, Paint paint);

    /* JADX INFO: renamed from: drawImage-d-4ec7I */
    void mo5821drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* JADX INFO: renamed from: drawImageRect-HPBpro0 */
    void mo5822drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* JADX INFO: renamed from: drawLine-Wko1d7g */
    void mo5823drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo5824drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* JADX INFO: renamed from: drawRawPoints-O7TthRY */
    void mo5825drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo5826drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m5946clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Canvas.super.m5943clipRectmtrdDE(rect, i);
        }
        ...
        @Deprecated
        public static void drawArc(Canvas canvas, Rect rect, float f2, float f3, boolean z, Paint paint) {
            Canvas.super.drawArc(rect, f2, f3, z, paint);
        }

        @Deprecated
        public static void drawArcRad(Canvas canvas, Rect rect, float f2, float f3, boolean z, Paint paint) {
            Canvas.super.drawArcRad(rect, f2, f3, z, paint);
        }
    }

    static /* synthetic */ void scale$default(Canvas canvas, float f2, float f3, int i, Object obj) {
        if (obj != null) {
    ...
    static /* synthetic */ void m5941clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.m5943clipRectmtrdDE(rect, i);
    }

    /* JADX INFO: renamed from: clipRect-mtrdD-E, reason: not valid java name */
    default void m5943clipRectmtrdDE(Rect rect, int clipOp) {
        mo5818clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* JADX INFO: renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m5940clipRectN_I0leg$default(Canvas canvas, float f2, float f3, float f4, float f5, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo5818clipRectN_I0leg(f2, f3, f4, f5, i);
    }

    /* JADX INFO: renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m5939clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo5817clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m5942drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long jM8969getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m8969getZeronOccac() : j;
        long jM8996constructorimpl = (i & 4) != 0 ? IntSize.m8996constructorimpl((((long) imageBitmap.getHeight()) & 4294967295L) | (((long) imageBitmap.getWidth()) << 32)) : j2;
        canvas.mo5822drawImageRectHPBpro0(imageBitmap, jM8969getZeronOccac, jM8996constructorimpl, (i & 8) != 0 ? IntOffset.INSTANCE.m8969getZeronOccac() : j3, (i & 16) != 0 ? jM8996constructorimpl : j4, paint);
    }
}
