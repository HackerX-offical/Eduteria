...
public class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m6009tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.INSTANCE.m5906getSrcIn0nO6VwU();
            }
            return companion.m6012tintxETnrds(j, i);
        }

        /* JADX INFO: renamed from: tint-xETnrds, reason: not valid java name */
        public final ColorFilter m6012tintxETnrds(long color, int blendMode) {
        ...
        public final ColorFilter m6010colorMatrixjHGOpc(float[] colorMatrix) {
        ...
        public final ColorFilter m6011lightingOWjLjI(long multiply, long add) {
