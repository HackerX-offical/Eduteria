...
final class ColorMatrixFilterHelper {
    ...
    public final float[] m6047getColorMatrix8unuwjk(android.graphics.ColorMatrixColorFilter colorFilter) {
        android.graphics.ColorMatrix colorMatrix = new android.graphics.ColorMatrix();
        colorFilter.getColorMatrix(colorMatrix);
        return ColorMatrix.m6024constructorimpl(colorMatrix.getArray());
    }
}
