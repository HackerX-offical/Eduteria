...
public class Interval<T> {
    ...
    public Interval(float f2, float f3, T t) {
        this.start = f2;
        this.end = f3;
        this.data = t;
    }

    public /* synthetic */ Interval(float f2, float f3, Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(f2, f3, (i & 4) != 0 ? null : obj);
    }
