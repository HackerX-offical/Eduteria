...
public final class IntervalTree<T> {
    ...
    public static /* synthetic */ Interval findFirstOverlap$default(IntervalTree intervalTree, float f2, float f3, int i, Object obj) {
        if ((i & 2) != 0) {
            f3 = f2;
        }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ List findOverlaps$default(IntervalTree intervalTree, float f2, float f3, List list, int i, Object obj) {
        if ((i & 2) != 0) {
            f3 = f2;
        }
        if ((i & 4) != 0) {
    ...
    public static /* synthetic */ void forEach$ui_graphics$default(IntervalTree intervalTree, float f2, float f3, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            f3 = f2;
        }
        ...
        if (node != intervalTree.terminator) {
            ...
            while (arrayList.size() > 0) {
                IntervalTree<T>.Node nodeRemove = arrayList.remove(arrayList.size() - 1);
                if (nodeRemove.overlaps(f2, f3)) {
                    function1.invoke(nodeRemove);
                }
                if (nodeRemove.getLeft() != intervalTree.terminator && nodeRemove.getLeft().getMax() >= f2) {
                    arrayList.add(nodeRemove.getLeft());
                }
                if (nodeRemove.getRight() != intervalTree.terminator && nodeRemove.getRight().getMin() <= f3) {
                    arrayList.add(nodeRemove.getRight());
                }
            }
            arrayList.clear();
    ...
    /* JADX INFO: compiled from: IntervalTree.kt */
    @Metadata(d1 = {"\u0000\u001f\n\u0000\n\u0002\u0010(\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000*\u0001\u0000\b\n\u0018\u00002\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u00020\u0001J\t\u0010\u0006\u001a\u00020\u0007H\u0096\u0002J\u000f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00000\u0002H\u0096\u0002R\u0018\u0010\u0003\u001a\f0\u0004R\b\u0012\u0004\u0012\u00028\u00000\u0005X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\b"}, d2 = {"androidx/compose/ui/graphics/IntervalTree$iterator$1", "", "Landroidx/compose/ui/graphics/Interval;", ES6Iterator.NEXT_METHOD, "Landroidx/compose/ui/graphics/IntervalTree$Node;", "Landroidx/compose/ui/graphics/IntervalTree;", "hasNext", "", "ui-graphics"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public final class Node extends Interval<T> {
        ...
        public Node(float f2, float f3, T t, int i) {
            super(f2, f3, t);
            this.color = i;
            this.min = f2;
            this.max = f3;
