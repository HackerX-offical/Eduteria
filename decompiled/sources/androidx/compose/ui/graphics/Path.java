...
public interface Path {
    ...
    void mo5855addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo5857opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo5858setFillTypeoQ8Xj4U(int i);

    /* JADX INFO: renamed from: transform-58bKbWc */
    default void mo5859transform58bKbWc(float[] matrix) {
    }

    /* JADX INFO: renamed from: translate-k-4lQ0M */
    void mo5860translatek4lQ0M(long offset);
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated
        public static void arcToRad(Path path, Rect rect, float f2, float f3, boolean z) {
            Path.super.arcToRad(rect, f2, f3, z);
        }
        ...
        public static void m6257transform58bKbWc(Path path, float[] fArr) {
            Path.super.mo5859transform58bKbWc(fArr);
        }
    ...
    static /* synthetic */ void m6254addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj != null) {
        ...
        path.mo5855addPathUv8p0NA(path2, j);
    }
    ...
    static /* synthetic */ PathIterator iterator$default(Path path, PathIterator.ConicEvaluation conicEvaluation, float f2, int i, Object obj) {
        if (obj != null) {
    ...
    default Path plus(Path path) {
        ...
        Path.mo5857opN5in7k0(this, path, PathOperation.INSTANCE.m6279getUnionb3I0S0c());
        return Path;
    }

    default Path minus(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo5857opN5in7k0(this, path, PathOperation.INSTANCE.m6276getDifferenceb3I0S0c());
        return Path;
    }
    ...
    default Path and(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo5857opN5in7k0(this, path, PathOperation.INSTANCE.m6277getIntersectb3I0S0c());
        return Path;
    }

    default Path xor(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.mo5857opN5in7k0(this, path, PathOperation.INSTANCE.m6280getXorb3I0S0c());
        return Path;
    }
    ...
    public static final class Companion {
        ...
        public final Path m6255combinexh6zSI8(int operation, Path path1, Path path2) {
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo5857opN5in7k0(path1, path2, operation)) {
                return Path;
            }
