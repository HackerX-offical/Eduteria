...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ PathEffect dashPathEffect$default(Companion companion, float[] fArr, float f2, int i, Object obj) {
            if ((i & 2) != 0) {
                f2 = 0.0f;
            }
        ...
        public final PathEffect m6258stampedPathEffect7aD1DOk(Path shape, float advance, float phase, int style) {
            return AndroidPathEffect_androidKt.m5861actualStampedPathEffect7aD1DOk(shape, advance, phase, style);
        }
    }
}
