...
public final class PathHitTester {
    ...
    public static /* synthetic */ void updatePath$default(PathHitTester pathHitTester, Path path, float f2, int i, Object obj) {
        if ((i & 2) != 0) {
            f2 = 0.5f;
        }
    ...
    public final boolean m6268containsk4lQ0M(long position) {
        int i;
        int iLineWinding;
        if (!this.path.isEmpty() && this.bounds.m5749containsk4lQ0M(position)) {
            ...
            if (PathFillType.m6262equalsimpl0(this.path.mo5856getFillTypeRgk1Os(), PathFillType.INSTANCE.m6266getEvenOddRgk1Os())) {
                i &= 1;
            }
            if (i != 0) {
                return true;
