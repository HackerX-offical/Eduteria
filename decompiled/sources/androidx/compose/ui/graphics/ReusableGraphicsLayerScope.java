...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m6059getAutoNrFUSI();
    private long size = Size.INSTANCE.m5800getUnspecifiedNHjbRc();
    ...
    public void mo6167setAmbientShadowColor8_81llA(long j) {
        if (Color.m5969equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public void mo6170setSpotShadowColor8_81llA(long j) {
        if (Color.m5969equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public void mo6171setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m6377equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public void mo6169setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m6055equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public void m6298setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public void mo6168setBlendModes9anfk8(int i) {
    ...
    public final void reset() {
        ...
        mo6167setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo6170setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo6171setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m6383getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        setColorFilter(null);
        mo6168setBlendModes9anfk8(BlendMode.INSTANCE.m5908getSrcOver0nO6VwU());
        mo6169setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m6059getAutoNrFUSI());
        m6298setSizeuvyYCjk(Size.INSTANCE.m5800getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui() {
        this.outline = getShape().mo382createOutlinePq9zytI(getSize(), this.layoutDirection, this.graphicsDensity);
    }
}
