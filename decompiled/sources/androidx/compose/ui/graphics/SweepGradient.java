...
public final class SweepGradient extends ShaderBrush implements Interpolatable {
    ...
    public Shader mo5937createShaderuvyYCjk(long size) {
        ...
        if ((9223372034707292159L & j) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            jM5715constructorimpl = SizeKt.m5802getCenteruvyYCjk(size);
        } else {
            ...
            jM5715constructorimpl = Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (size & 4294967295L)))) & 4294967295L) | (((long) Float.floatToRawIntBits(fIntBitsToFloat)) << 32));
        }
        return ShaderKt.m6308SweepGradientShader9KIMszo(jM5715constructorimpl, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m5720equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int iM5725hashCodeimpl = ((Offset.m5725hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return iM5725hashCodeimpl + (list != null ? list.hashCode() : 0);
    }

    public String toString() {
        return "SweepGradient(" + ((this.center & 9223372034707292159L) != androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats ? "center=" + ((Object) Offset.m5731toStringimpl(this.center)) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
    ...
    public Object lerp(Object other, float t) {
        ...
        SweepGradient sweepGradient = (SweepGradient) other;
        return new SweepGradient(OffsetKt.m5746lerpWko1d7g(this.center, sweepGradient.center, t), BrushKt.lerpColorList(this.colors, sweepGradient.colors, t), BrushKt.lerpNullableFloatList(this.stops, sweepGradient.stops, t), null);
    }
}
