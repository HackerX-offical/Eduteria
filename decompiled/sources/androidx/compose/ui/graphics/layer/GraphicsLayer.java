...
public final class GraphicsLayer {
    ...
    private final Function1<DrawScope, Unit> clipDrawBlock = new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.graphics.layer.GraphicsLayer$clipDrawBlock$1
        ...
        public final void invoke2(DrawScope drawScope) {
            ...
            try {
                drawContext.getTransform().mo6472clipPathmtrdDE(path, iM5957getIntersectrtfAjoo);
    ...
    private long roundRectOutlineTopLeft = Offset.INSTANCE.m5739getZeroF1C5BW0();
    private long roundRectOutlineSize = Size.INSTANCE.m5800getUnspecifiedNHjbRc();
    ...
    public GraphicsLayer(GraphicsLayerImpl graphicsLayerImpl) {
        ...
        this.topLeft = IntOffset.INSTANCE.m8969getZeronOccac();
        this.size = IntSize.INSTANCE.m9006getZeroYbymL2g();
        this.pivotOffset = Offset.INSTANCE.m5738getUnspecifiedF1C5BW0();
    }
    ...
    public final int m6638getCompositingStrategyke2Ky5w() {
        return this.impl.getCompositingStrategy();
    }

    /* JADX INFO: renamed from: setCompositingStrategy-Wpw9cng, reason: not valid java name */
    public final void m6646setCompositingStrategyWpw9cng(int i) {
        if (CompositingStrategy.m6625equalsimpl0(this.impl.getCompositingStrategy(), i)) {
            return;
        }
        this.impl.mo6659setCompositingStrategyWpw9cng(i);
    }
    ...
    public final void m6651setTopLeftgyyYBs(long j) {
        if (IntOffset.m8957equalsimpl0(this.topLeft, j)) {
            return;
        }
        this.topLeft = j;
        m6632setPositionVbeCjmY(j, this.size);
    }
    ...
    private final void m6635setSizeozmzZPI(long j) {
        if (IntSize.m8999equalsimpl0(this.size, j)) {
            return;
        }
        this.size = j;
        m6632setPositionVbeCjmY(this.topLeft, j);
    ...
    public final int m6637getBlendMode0nO6VwU() {
        return this.impl.getBlendMode();
    }

    /* JADX INFO: renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public final void m6645setBlendModes9anfk8(int i) {
        if (BlendMode.m5877equalsimpl0(this.impl.getBlendMode(), i)) {
            return;
        }
        this.impl.mo6658setBlendModes9anfk8(i);
    }
    ...
    public final void m6647setPivotOffsetk4lQ0M(long j) {
        if (Offset.m5720equalsimpl0(this.pivotOffset, j)) {
            return;
        }
        this.pivotOffset = j;
        this.impl.mo6661setPivotOffsetk4lQ0M(j);
    }
    ...
    public static /* synthetic */ void m6634setRoundRectOutlineTNW_H78$default(GraphicsLayer graphicsLayer, long j, long j2, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Offset.INSTANCE.m5739getZeroF1C5BW0();
        }
        long j3 = j;
        if ((i & 2) != 0) {
            j2 = Size.INSTANCE.m5800getUnspecifiedNHjbRc();
        }
        long j4 = j2;
        if ((i & 4) != 0) {
            f2 = 0.0f;
        }
        graphicsLayer.m6649setRoundRectOutlineTNW_H78(j3, j4, f2);
    }
    ...
    public static /* synthetic */ void m6633setRectOutlinetz77jQw$default(GraphicsLayer graphicsLayer, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Offset.INSTANCE.m5739getZeroF1C5BW0();
        }
        if ((i & 2) != 0) {
        ...
        graphicsLayer.m6648setRectOutlinetz77jQw(j, j2);
    }
    ...
    private final void m6632setPositionVbeCjmY(long topLeft, long size) {
        this.impl.mo6662setPositionH0pRuoY(IntOffset.m8958getXimpl(topLeft), IntOffset.m8959getYimpl(topLeft), size);
    }

    /* JADX INFO: renamed from: record-mL-hObY, reason: not valid java name */
    public final void m6643recordmLhObY(Density density, LayoutDirection layoutDirection, long size, Function1<? super DrawScope, Unit> block) {
        m6635setSizeozmzZPI(size);
    ...
    */
    ...
    private final void transformCanvas(Canvas androidCanvas) {
        Canvas canvas;
        float fM8958getXimpl = IntOffset.m8958getXimpl(this.topLeft);
        float fM8959getYimpl = IntOffset.m8959getYimpl(this.topLeft);
        float fM8958getXimpl2 = IntOffset.m8958getXimpl(this.topLeft) + ((int) (this.size >> 32));
        float fM8959getYimpl2 = IntOffset.m8959getYimpl(this.topLeft) + ((int) (this.size & 4294967295L));
        float alpha = getAlpha();
        ColorFilter colorFilter = getColorFilter();
        int iM6637getBlendMode0nO6VwU = m6637getBlendMode0nO6VwU();
        if (alpha < 1.0f || !BlendMode.m5877equalsimpl0(iM6637getBlendMode0nO6VwU, BlendMode.INSTANCE.m5908getSrcOver0nO6VwU()) || colorFilter != null || CompositingStrategy.m6625equalsimpl0(m6638getCompositingStrategyke2Ky5w(), CompositingStrategy.INSTANCE.m6631getOffscreenke2Ky5w())) {
            ...
            Paint.mo5843setBlendModes9anfk8(iM6637getBlendMode0nO6VwU);
            Paint.setColorFilter(colorFilter);
            canvas = androidCanvas;
            canvas.saveLayer(fM8958getXimpl, fM8959getYimpl, fM8958getXimpl2, fM8959getYimpl2, AndroidPaint_androidKt.getNativePaint(Paint));
        } else {
            androidCanvas.save();
            canvas = androidCanvas;
        }
    ...
    public final void draw$ui_graphics(androidx.compose.ui.graphics.Canvas canvas, GraphicsLayer parentLayer) {
        ...
        if (z4) {
            ...
            if (outline instanceof Outline.Rectangle) {
                androidx.compose.ui.graphics.Canvas.m5941clipRectmtrdDE$default(canvas, ((Outline.Rectangle) outline).getRect(), 0, 2, null);
                ...
                androidx.compose.ui.graphics.Canvas.m5939clipPathmtrdDE$default(canvas, Path, 0, 2, null);
            } else {
                if (!(outline instanceof Outline.Generic)) {
                    throw new NoWhenBranchMatchedException();
                }
                androidx.compose.ui.graphics.Canvas.m5939clipPathmtrdDE$default(canvas, ((Outline.Generic) outline).getPath(), 0, 2, null);
            }
        }
        if (parentLayer != null) {
        ...
        if (AndroidCanvas_androidKt.getNativeCanvas(canvas).isHardwareAccelerated() || this.impl.getSupportsSoftwareRendering()) {
            ...
            long jM9013toSizeozmzZPI = IntSizeKt.m9013toSizeozmzZPI(this.size);
            ...
            long jMo6470getSizeNHjbRc = canvasDrawScope2.getDrawContext().mo6470getSizeNHjbRc();
            z = z3;
            ...
            drawContext.mo6471setSizeuvyYCjk(jM9013toSizeozmzZPI);
    ...
    private final void configureOutlineAndClip() {
        if (this.outlineDirty) {
            ...
            if (!this.clip && getShadowElevation() <= 0.0f) {
                ...
                this.impl.mo6660setOutlineO0kMr_c(null, IntSize.INSTANCE.m9006getZeroYbymL2g());
            } else {
                ...
                if (path != null) {
                    ...
                    if (path instanceof AndroidPath) {
                        ...
                        this.impl.mo6660setOutlineO0kMr_c(outline, IntSize.m8996constructorimpl((4294967295L & ((long) Math.round(rectFObtainPathBounds.height()))) | (((long) Math.round(rectFObtainPathBounds.width())) << 32)));
                    ...
                    this.impl.setClip(this.clip);
                    Size.INSTANCE.m5801getZeroNHjbRc();
                    ...
                    long j3 = j2 == InlineClassHelperKt.UnspecifiedPackedFloats ? jM9013toSizeozmzZPI : j2;
                    int i = (int) (j >> 32);
                    ...
                    this.impl.mo6660setOutlineO0kMr_c(outlineObtainAndroidOutline, IntSizeKt.m9009roundToIntSizeuvyYCjk(j3));
                }
            }
        }
    ...
    private final <T> T resolveOutlinePosition(Function2<? super Offset, ? super Size, ? extends T> block) {
        ...
        if (j2 != InlineClassHelperKt.UnspecifiedPackedFloats) {
            jM9013toSizeozmzZPI = j2;
        }
        return block.invoke(Offset.m5712boximpl(j), Size.m5780boximpl(jM9013toSizeozmzZPI));
    }
    ...
    */
    ...
    public final androidx.compose.ui.graphics.Outline getOutline() {
        ...
        float fIntBitsToFloat3 = Float.intBitsToFloat((int) (jM9013toSizeozmzZPI >> 32)) + fIntBitsToFloat;
        float fIntBitsToFloat4 = fIntBitsToFloat2 + Float.intBitsToFloat((int) (jM9013toSizeozmzZPI & 4294967295L));
        ...
        if (f2 <= 0.0f) {
            ...
            rectangle = new Outline.Rounded(RoundRectKt.m5777RoundRectgG7oq9Y(fIntBitsToFloat, fIntBitsToFloat2, fIntBitsToFloat3, fIntBitsToFloat4, CornerRadius.m5677constructorimpl((((long) Float.floatToRawIntBits(f2)) << 32) | (4294967295L & ((long) Float.floatToRawIntBits(f2))))));
        }
    ...
    private final void resetOutlineParams() {
        ...
        this.roundRectOutlineSize = Size.INSTANCE.m5800getUnspecifiedNHjbRc();
        this.roundRectOutlineTopLeft = Offset.INSTANCE.m5739getZeroF1C5BW0();
    ...
    public final void m6649setRoundRectOutlineTNW_H78(long topLeft, long size, float cornerRadius) {
        if (Offset.m5720equalsimpl0(this.roundRectOutlineTopLeft, topLeft) && Size.m5788equalsimpl0(this.roundRectOutlineSize, size) && this.roundRectCornerRadius == cornerRadius && this.outlinePath == null) {
            return;
        }
        resetOutlineParams();
    ...
    public final void m6648setRectOutlinetz77jQw(long topLeft, long size) {
        m6649setRoundRectOutlineTNW_H78(topLeft, size, 0.0f);
    }

    /* JADX INFO: renamed from: getAmbientShadowColor-0d7_KjU, reason: not valid java name */
    public final long m6636getAmbientShadowColor0d7_KjU() {
        return this.impl.getAmbientShadowColor();
    }

    /* JADX INFO: renamed from: setAmbientShadowColor-8_81llA, reason: not valid java name */
    public final void m6644setAmbientShadowColor8_81llA(long j) {
        if (Color.m5969equalsimpl0(j, this.impl.getAmbientShadowColor())) {
            return;
        }
        this.impl.mo6657setAmbientShadowColor8_81llA(j);
    }

    /* JADX INFO: renamed from: getSpotShadowColor-0d7_KjU, reason: not valid java name */
    public final long m6641getSpotShadowColor0d7_KjU() {
        return this.impl.getSpotShadowColor();
    }

    /* JADX INFO: renamed from: setSpotShadowColor-8_81llA, reason: not valid java name */
    public final void m6650setSpotShadowColor8_81llA(long j) {
        if (Color.m5969equalsimpl0(j, this.impl.getSpotShadowColor())) {
            return;
        }
        this.impl.mo6663setSpotShadowColor8_81llA(j);
    }
