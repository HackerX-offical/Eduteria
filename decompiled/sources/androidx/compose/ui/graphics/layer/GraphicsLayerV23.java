...
public final class GraphicsLayerV23 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV23(View view, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.outlineSize = IntSize.INSTANCE.m9006getZeroYbymL2g();
        ...
        renderNodeCreate.setClipToBounds(false);
        m6664applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m6629getAutoke2Ky5w());
        this.compositingStrategy = CompositingStrategy.INSTANCE.m6629getAutoke2Ky5w();
        this.blendMode = BlendMode.INSTANCE.m5908getSrcOver0nO6VwU();
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m5738getUnspecifiedF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
        this.ambientShadowColor = Color.INSTANCE.m5994getBlack0d7_KjU();
        this.spotShadowColor = Color.INSTANCE.m5994getBlack0d7_KjU();
    ...
    public void mo6659setCompositingStrategyWpw9cng(int i) {
        this.compositingStrategy = i;
        updateLayerProperties();
    }

    /* JADX INFO: renamed from: applyCompositingStrategy-Wpw9cng, reason: not valid java name */
    private final void m6664applyCompositingStrategyWpw9cng(int compositingStrategy) {
        RenderNode renderNode = this.renderNode;
        if (CompositingStrategy.m6625equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m6631getOffscreenke2Ky5w())) {
            renderNode.setLayerType(2);
            renderNode.setLayerPaint(this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m6625equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m6630getModulateAlphake2Ky5w())) {
    ...
    public void mo6658setBlendModes9anfk8(int i) {
        if (BlendMode.m5877equalsimpl0(this.blendMode, i)) {
            return;
        }
        this.blendMode = i;
        obtainLayerPaint().setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m5816toPorterDuffModes9anfk8(i)));
        updateLayerProperties();
    }

    private final boolean requiresCompositingLayer() {
        return (!CompositingStrategy.m6625equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m6631getOffscreenke2Ky5w()) && BlendMode.m5877equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m5908getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }

    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m6664applyCompositingStrategyWpw9cng(CompositingStrategy.INSTANCE.m6631getOffscreenke2Ky5w());
        } else {
            m6664applyCompositingStrategyWpw9cng(getCompositingStrategy());
        }
    }
    ...
    public void mo6661setPivotOffsetk4lQ0M(long j) {
        this.pivotOffset = j;
    ...
    public void mo6657setAmbientShadowColor8_81llA(long j) {
        this.ambientShadowColor = j;
        RenderNodeVerificationHelper28.INSTANCE.setAmbientShadowColor(this.renderNode, ColorKt.m6022toArgb8_81llA(j));
    }
    ...
    public void mo6663setSpotShadowColor8_81llA(long j) {
        this.spotShadowColor = j;
        RenderNodeVerificationHelper28.INSTANCE.setSpotShadowColor(this.renderNode, ColorKt.m6022toArgb8_81llA(j));
    }
    ...
    public void mo6662setPositionH0pRuoY(int x, int y, long size) {
        int i = (int) (size >> 32);
        int i2 = (int) (4294967295L & size);
        this.renderNode.setLeftTopRightBottom(x, y, x + i, y + i2);
        if (IntSize.m8999equalsimpl0(this.size, size)) {
            return;
        }
    ...
    public void mo6660setOutlineO0kMr_c(Outline outline, long outlineSize) {
