...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.INSTANCE.m5801getZeroNHjbRc();
        renderNode.setClipToBounds(false);
        m6665applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.INSTANCE.m6629getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo6658setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m5815toAndroidBlendModes9anfk8(i));
    ...
    public void mo6657setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m6022toArgb8_81llA(j));
    }
    ...
    public void mo6663setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m6022toArgb8_81llA(j));
    }
    ...
    private final void m6665applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        if (CompositingStrategy.m6625equalsimpl0(i, CompositingStrategy.INSTANCE.m6631getOffscreenke2Ky5w())) {
            renderNode.setUseCompositingLayer(true, this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m6625equalsimpl0(i, CompositingStrategy.INSTANCE.m6630getModulateAlphake2Ky5w())) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m6665applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m6631getOffscreenke2Ky5w());
        } else {
            m6665applyCompositingStrategyZ1X6vPc(this.renderNode, getCompositingStrategy());
        }
    }
    ...
    public void mo6662setPositionH0pRuoY(int x, int y, long size) {
        ...
        this.size = IntSizeKt.m9013toSizeozmzZPI(size);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            drawContext.mo6471setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m6625equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m6631getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
