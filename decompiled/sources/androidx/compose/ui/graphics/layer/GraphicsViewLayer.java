...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer drawChildContainer, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m5739getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
    ...
    private final void m6666applyCompositingLayerWpw9cng(int compositingStrategy) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m6666applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m6631getOffscreenke2Ky5w());
        } else {
            m6666applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m6625equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m6631getOffscreenke2Ky5w()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m5877equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m5908getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    public void mo6657setAmbientShadowColor8_81llA(long j) {
        ...
        ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m6022toArgb8_81llA(j));
    }
    ...
    public void mo6663setSpotShadowColor8_81llA(long j) {
        ...
        ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m6022toArgb8_81llA(j));
    }
