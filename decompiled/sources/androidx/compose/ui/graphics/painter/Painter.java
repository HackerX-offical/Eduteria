...
public abstract class Painter {
    ...
    public abstract long mo6669getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m6674drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f2, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m6675drawx_KDEd0(drawScope, j, f3, colorFilter);
    }

    /* JADX INFO: renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m6675drawx_KDEd0(DrawScope drawScope, long j, float f2, ColorFilter colorFilter) {
        configureAlpha(f2);
        configureColorFilter(colorFilter);
        configureLayoutDirection(drawScope.getLayoutDirection());
        int i = (int) (j >> 32);
        float fIntBitsToFloat = Float.intBitsToFloat((int) (drawScope.mo6549getSizeNHjbRc() >> 32)) - Float.intBitsToFloat(i);
        int i2 = (int) (j & 4294967295L);
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (drawScope.mo6549getSizeNHjbRc() & 4294967295L)) - Float.intBitsToFloat(i2);
            ...
            try {
                if (Float.intBitsToFloat(i) > 0.0f && Float.intBitsToFloat(i2) > 0.0f) {
                    if (this.useLayer) {
                        ...
                        Rect rectM5763Recttz77jQw = RectKt.m5763Recttz77jQw(jM5739getZeroF1C5BW0, Size.m5783constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat(i2))) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat3) << 32)));
                        Canvas canvas = drawScope.getDrawContext().getCanvas();
                        try {
                            canvas.saveLayer(rectM5763Recttz77jQw, obtainPaint());
                            onDraw(drawScope);
                            canvas.restore();
                        } catch (Throwable th) {
                            canvas.restore();
