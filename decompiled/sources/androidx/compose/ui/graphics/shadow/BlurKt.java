...
public final class BlurKt {
    ...
    public static /* synthetic */ Paint m6684configureShadowFoewPVk$default(Paint paint, long j, int i, BlurMaskFilter blurMaskFilter, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            j = Color.INSTANCE.m5994getBlack0d7_KjU();
        }
        long j2 = j;
        if ((i3 & 2) != 0) {
            i = BlendMode.INSTANCE.m5908getSrcOver0nO6VwU();
        }
        int i4 = i;
        if ((i3 & 4) != 0) {
            blurMaskFilter = null;
        ...
        if ((i3 & 8) != 0) {
            i2 = PaintingStyle.INSTANCE.m6251getFillTiuSbCo();
        }
        return m6683configureShadowFoewPVk(paint, j2, i4, blurMaskFilter2, i2);
    }

    /* JADX INFO: renamed from: configureShadow-FoewPVk, reason: not valid java name */
    public static final Paint m6683configureShadowFoewPVk(Paint paint, long j, int i, BlurMaskFilter blurMaskFilter, int i2) {
        paint.mo5844setColor8_81llA(j);
        paint.mo5843setBlendModes9anfk8(i);
        paint.mo5848setStylek9PVt8s(i2);
