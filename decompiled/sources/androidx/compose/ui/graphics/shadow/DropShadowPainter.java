...
public final class DropShadowPainter extends Painter {
    ...
    protected void onDraw(DrawScope drawScope) {
        DropShadowRenderer dropShadowRendererMo6676obtainDropShadowRenderereZhPAX0 = this.renderCreator.mo6676obtainDropShadowRenderereZhPAX0(this.shape, drawScope.mo6549getSizeNHjbRc(), drawScope.getLayoutDirection(), drawScope, this.shadow);
        float f2 = drawScope.mo488toPx0680j_4(DpOffset.m8891getXD9Ej5fM(this.shadow.getOffset()));
        float f3 = drawScope.mo488toPx0680j_4(DpOffset.m8893getYD9Ej5fM(this.shadow.getOffset()));
        drawScope.getDrawContext().getTransform().translate(f2, f3);
        try {
            dropShadowRendererMo6676obtainDropShadowRenderereZhPAX0.m6698drawShadowerFMhIw(drawScope, this.colorFilter, drawScope.mo6549getSizeNHjbRc(), dropShadowRendererMo6676obtainDropShadowRenderereZhPAX0.getShadow().getColor(), dropShadowRendererMo6676obtainDropShadowRenderereZhPAX0.getShadow().getBrush(), RangesKt.coerceIn(this.alpha * dropShadowRendererMo6676obtainDropShadowRenderereZhPAX0.getShadow().getAlpha(), 0.0f, 1.0f), dropShadowRendererMo6676obtainDropShadowRenderereZhPAX0.getShadow().getBlendMode());
        } finally {
            drawScope.getDrawContext().getTransform().translate(-f2, -f3);
        }
    }
