...
public final class ImageVector {
    ...
    public /* synthetic */ ImageVector(String str, float f2, float f3, float f4, float f5, VectorGroup vectorGroup, long j, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, f2, f3, f4, f5, vectorGroup, j, i, z, i2);
    }

    private ImageVector(String str, float f2, float f3, float f4, float f5, VectorGroup vectorGroup, long j, int i, boolean z, int i2) {
        this.name = str;
    ...
    public /* synthetic */ ImageVector(String str, float f2, float f3, float f4, float f5, VectorGroup vectorGroup, long j, int i, boolean z, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, f2, f3, f4, f5, vectorGroup, j, i, z, (i3 & 512) != 0 ? INSTANCE.generateImageVectorId$ui() : i2, null);
    }
    ...
    public static final class Builder {
        ...
        public /* synthetic */ Builder(String str, float f2, float f3, float f4, float f5, long j, int i, boolean z, DefaultConstructorMarker defaultConstructorMarker) {
            this(str, f2, f3, f4, f5, j, i, z);
        }

        private Builder(String str, float f2, float f3, float f4, float f5, long j, int i, boolean z) {
            this.name = str;
            this.defaultWidth = f2;
            this.defaultHeight = f3;
            this.viewportWidth = f4;
        ...
        public /* synthetic */ Builder(String str, float f2, float f3, float f4, float f5, long j, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f2, f3, f4, f5, (i2 & 32) != 0 ? Color.INSTANCE.m6004getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.INSTANCE.m5906getSrcIn0nO6VwU() : i, (i2 & 128) != 0 ? false : z, (DefaultConstructorMarker) null);
        }
        ...
        public /* synthetic */ Builder(String str, float f2, float f3, float f4, float f5, long j, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this((i2 & 1) != 0 ? "" : str, f2, f3, f4, f5, (i2 & 32) != 0 ? Color.INSTANCE.m6004getUnspecified0d7_KjU() : j, (i2 & 64) != 0 ? BlendMode.INSTANCE.m5906getSrcIn0nO6VwU() : i, (DefaultConstructorMarker) null);
        }

        private Builder(String str, float f2, float f3, float f4, float f5, long j, int i) {
            this(str, f2, f3, f4, f5, j, i, false, (DefaultConstructorMarker) null);
        }
        ...
        public static /* synthetic */ Builder addGroup$default(Builder builder, String str, float f2, float f3, float f4, float f5, float f6, float f7, float f8, List list, int i, Object obj) {
            if ((i & 1) != 0) {
                str = "";
            }
            if ((i & 2) != 0) {
        ...
        public static /* synthetic */ Builder m6706addPathoIyEayM$default(Builder builder, List list, int i, String str, Brush brush, float f2, Brush brush2, float f3, float f4, int i2, int i3, float f5, float f6, float f7, float f8, int i4, Object obj) {
            return builder.m6707addPathoIyEayM(list, (i4 & 2) != 0 ? VectorKt.getDefaultFillType() : i, (i4 & 4) != 0 ? "" : str, (i4 & 8) != 0 ? null : brush, (i4 & 16) != 0 ? 1.0f : f2, (i4 & 32) == 0 ? brush2 : null, (i4 & 64) != 0 ? 1.0f : f3, (i4 & 128) != 0 ? 0.0f : f4, (i4 & 256) != 0 ? VectorKt.getDefaultStrokeLineCap() : i2, (i4 & 512) != 0 ? VectorKt.getDefaultStrokeLineJoin() : i3, (i4 & 1024) != 0 ? 4.0f : f5, (i4 & 2048) != 0 ? 0.0f : f6, (i4 & 4096) == 0 ? f7 : 1.0f, (i4 & 8192) != 0 ? 0.0f : f8);
        }

        /* JADX INFO: renamed from: addPath-oIyEayM, reason: not valid java name */
        public final Builder m6707addPathoIyEayM(List<? extends PathNode> pathData, int pathFillType, String name, Brush fill, float fillAlpha, Brush stroke, float strokeAlpha, float strokeLineWidth, int strokeLineCap, int strokeLineJoin, float strokeLineMiter, float trimPathStart, float trimPathEnd, float trimPathOffset) {
            ensureNotConsumed();
        ...
        private static final class GroupParams {
            ...
            public /* synthetic */ GroupParams(String str, float f2, float f3, float f4, float f5, float f6, float f7, float f8, List list, ArrayList arrayList, int i, DefaultConstructorMarker defaultConstructorMarker) {
                this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? 0.0f : f2, (i & 4) != 0 ? 0.0f : f3, (i & 8) != 0 ? 0.0f : f4, (i & 16) != 0 ? 1.0f : f5, (i & 32) != 0 ? 1.0f : f6, (i & 64) != 0 ? 0.0f : f7, (i & 128) != 0 ? 0.0f : f8, (i & 256) != 0 ? VectorKt.getEmptyPath() : list, (i & 512) != 0 ? new ArrayList() : arrayList);
            }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.name, imageVector.name) && Dp.m8835equalsimpl0(this.defaultWidth, imageVector.defaultWidth) && Dp.m8835equalsimpl0(this.defaultHeight, imageVector.defaultHeight) && this.viewportWidth == imageVector.viewportWidth && this.viewportHeight == imageVector.viewportHeight && Intrinsics.areEqual(this.root, imageVector.root) && Color.m5969equalsimpl0(this.tintColor, imageVector.tintColor) && BlendMode.m5877equalsimpl0(this.tintBlendMode, imageVector.tintBlendMode) && this.autoMirror == imageVector.autoMirror;
    }

    public int hashCode() {
        return (((((((((((((((this.name.hashCode() * 31) + Dp.m8836hashCodeimpl(this.defaultWidth)) * 31) + Dp.m8836hashCodeimpl(this.defaultHeight)) * 31) + Float.hashCode(this.viewportWidth)) * 31) + Float.hashCode(this.viewportHeight)) * 31) + this.root.hashCode()) * 31) + Color.m5975hashCodeimpl(this.tintColor)) * 31) + BlendMode.m5878hashCodeimpl(this.tintBlendMode)) * 31) + Boolean.hashCode(this.autoMirror);
    }
}
