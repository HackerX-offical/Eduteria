...
public final class PathBuilder {
    ...
    public final PathBuilder arcToRelative(float a2, float b2, float theta, boolean isMoreThanHalf, boolean isPositiveArc, float dx1, float dy1) {
        this._nodes.add(new PathNode.RelativeArcTo(a2, b2, theta, isMoreThanHalf, isPositiveArc, dx1, dy1));
        return this;
    }
}
