...
public final class PathComponent extends VNode {
    ...
    public final void m6713setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo5858setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m6714setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m6715setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int iMo5856getFillTypeRgk1Os = this.renderPath.mo5856getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo5858setFillTypeoQ8Xj4U(iMo5856getFillTypeRgk1Os);
        }
        ...
        if (f4 > f5) {
            ...
            tmpPath.reset();
            getPathMeasure().getSegment(f4, length, tmpPath, true);
            Path.m6254addPathUv8p0NA$default(this.renderPath, tmpPath, 0L, 2, null);
            tmpPath.reset();
            getPathMeasure().getSegment(0.0f, f5, tmpPath, true);
            Path.m6254addPathUv8p0NA$default(this.renderPath, tmpPath, 0L, 2, null);
            return;
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m6538drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m6538drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
