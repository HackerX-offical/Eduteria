        ...
        while (i2 < length) {
            ...
            if (cCharAt != 0) {
                ...
                if (i5 != 122) {
                    ...
                    do {
                        if (z && 3 <= i6 && i6 < 5) {
                            jNextFloat = FastFloatParserKt.nextFloat(pathData, i, Math.min(i + 1, length));
                        } else {
                            jNextFloat = FastFloatParserKt.nextFloat(pathData, i, length);
                        }
                        i = (int) (jNextFloat >>> 32);
