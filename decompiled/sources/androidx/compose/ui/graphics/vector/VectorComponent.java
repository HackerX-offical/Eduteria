...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent(GroupComponent groupComponent) {
        ...
        this.viewportSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m5780boximpl(Size.INSTANCE.m5801getZeroNHjbRc()), null, 2, null);
        this.previousDrawSize = Size.INSTANCE.m5800getUnspecifiedNHjbRc();
        ...
        this.drawVectorBlock = new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComponent$drawVectorBlock$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                try {
                    drawContext.getTransform().mo6477scale0AR0LA0(f2, f3, jM5739getZeroF1C5BW0);
                    root.draw(drawScope);
                } finally {
    ...
    public final int m6716getCacheBitmapConfig_sVssgQ$ui() {
        ImageBitmap mCachedImage = this.cacheDrawScope.getMCachedImage();
        return mCachedImage != null ? mCachedImage.mo5832getConfig_sVssgQ() : ImageBitmapConfig.INSTANCE.m6201getArgb8888_sVssgQ();
    }
    ...
    public final long m6717getViewportSizeNHjbRc$ui() {
        return ((Size) this.viewportSize.getValue()).m5797unboximpl();
    }

    /* JADX INFO: renamed from: setViewportSize-uvyYCjk$ui, reason: not valid java name */
    public final void m6718setViewportSizeuvyYCjk$ui(long j) {
        this.viewportSize.setValue(Size.m5780boximpl(j));
    }

    public final void draw(DrawScope drawScope, float f2, ColorFilter colorFilter) {
        int iM6201getArgb8888_sVssgQ;
        if (this.root.getIsTintable() && this.root.getTintColor() != 16 && VectorKt.tintableWithAlphaMask(getIntrinsicColorFilter$ui()) && VectorKt.tintableWithAlphaMask(colorFilter)) {
            iM6201getArgb8888_sVssgQ = ImageBitmapConfig.INSTANCE.m6200getAlpha8_sVssgQ();
        } else {
            iM6201getArgb8888_sVssgQ = ImageBitmapConfig.INSTANCE.m6201getArgb8888_sVssgQ();
        }
        int i = iM6201getArgb8888_sVssgQ;
        if (this.isDirty || !Size.m5788equalsimpl0(this.previousDrawSize, drawScope.mo6549getSizeNHjbRc()) || !ImageBitmapConfig.m6196equalsimpl0(i, m6716getCacheBitmapConfig_sVssgQ$ui())) {
            this.tintFilter = ImageBitmapConfig.m6196equalsimpl0(i, ImageBitmapConfig.INSTANCE.m6200getAlpha8_sVssgQ()) ? ColorFilter.Companion.m6009tintxETnrds$default(ColorFilter.INSTANCE, VectorKt.m6724toOpaque8_81llA(this.root.getTintColor()), 0, 2, null) : null;
            this.rootScaleX = Float.intBitsToFloat((int) (drawScope.mo6549getSizeNHjbRc() >> 32)) / Float.intBitsToFloat((int) (m6717getViewportSizeNHjbRc$ui() >> 32));
            this.rootScaleY = Float.intBitsToFloat((int) (drawScope.mo6549getSizeNHjbRc() & 4294967295L)) / Float.intBitsToFloat((int) (m6717getViewportSizeNHjbRc$ui() & 4294967295L));
            this.cacheDrawScope.m6699drawCachedImageFqjB98A(i, IntSize.m8996constructorimpl((((long) ((int) Math.ceil(Float.intBitsToFloat((int) (drawScope.mo6549getSizeNHjbRc() & 4294967295L))))) & 4294967295L) | (((long) ((int) Math.ceil(Float.intBitsToFloat((int) (drawScope.mo6549getSizeNHjbRc() >> 32))))) << 32)), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo6549getSizeNHjbRc();
        }
        if (colorFilter == null) {
    ...
    public String toString() {
        ...
        sb.append(Float.intBitsToFloat((int) (m6717getViewportSizeNHjbRc$ui() >> 32))).append("\n\tviewportHeight: ");
        sb.append(Float.intBitsToFloat((int) (m6717getViewportSizeNHjbRc$ui() & 4294967295L))).append("\n");
        return sb.toString();
    }
}
