...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m6344getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m6355getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m5906getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m6003getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m6267getNonZeroRgk1Os();
    ...
    public static final boolean m6723rgbEqualOWjLjI(long j, long j2) {
        return Color.m5974getRedimpl(j) == Color.m5974getRedimpl(j2) && Color.m5973getGreenimpl(j) == Color.m5973getGreenimpl(j2) && Color.m5971getBlueimpl(j) == Color.m5971getBlueimpl(j2);
    }

    /* JADX INFO: renamed from: toOpaque-8_81llA, reason: not valid java name */
    public static final long m6724toOpaque8_81llA(long j) {
        return Color.m5970getAlphaimpl(j) == 1.0f ? j : Color.m5967copywmQWz5c$default(j, 1.0f, 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        ...
        return BlendMode.m5877equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m5906getSrcIn0nO6VwU()) || BlendMode.m5877equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m5908getSrcOver0nO6VwU());
    }
}
