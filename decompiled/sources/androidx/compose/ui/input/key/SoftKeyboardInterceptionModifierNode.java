...
public interface SoftKeyboardInterceptionModifierNode extends DelegatableNode {
    ...
    boolean mo6819onInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event);

    /* JADX INFO: renamed from: onPreInterceptKeyBeforeSoftKeyboard-ZmokQxo */
    boolean mo6820onPreInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event);
}
