...
public final class PointerIdArray {
    ...
    public final long m7415get_I2yYro(int index) {
        return PointerId.m7289constructorimpl(this.internalArray[index]);
    }

    /* JADX INFO: renamed from: remove-0FcD4WY, reason: not valid java name */
    public final boolean m7416remove0FcD4WY(long pointerId) {
    ...
    public final boolean m7413add0FcD4WY(long pointerId) {
    ...
    public final void m7417setDmW0f2w(int index, long pointerId) {
        set(index, pointerId);
    }
    ...
    public final boolean m7414contains0FcD4WY(long pointerId) {
