...
public final class VelocityTracker {
    ...
    public final void m7418addPositionUv8p0NA(long timeMillis, long position) {
        this.platformVelocityTracker.mo7409addPositionUv8p0NA(timeMillis, position);
    }

    /* JADX INFO: renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m7419calculateVelocity9UxMQ8M() {
        return m7420calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* JADX INFO: renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m7420calculateVelocityAH228Gc(long maximumVelocity) {
        return this.platformVelocityTracker.mo7410calculateVelocityAH228Gc(maximumVelocity);
    }
