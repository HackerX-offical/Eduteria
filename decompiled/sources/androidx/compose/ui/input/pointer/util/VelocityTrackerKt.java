...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        m7421addPointerInputChange0AR0LA0(velocityTracker, pointerInputChange, Offset.INSTANCE.m5739getZeroF1C5BW0());
    }

    /* JADX INFO: renamed from: addPointerInputChange-0AR0LA0, reason: not valid java name */
    public static final void m7421addPointerInputChange0AR0LA0(VelocityTracker velocityTracker, PointerInputChange pointerInputChange, long j) {
        velocityTracker.getPlatformVelocityTracker().mo7408addPointerInputChangeUv8p0NA(pointerInputChange, j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void set(DataPointAtTime[] dataPointAtTimeArr, int i, long j, float f2) {
        DataPointAtTime dataPointAtTime = dataPointAtTimeArr[i];
        if (dataPointAtTime == null) {
            dataPointAtTimeArr[i] = new DataPointAtTime(j, f2);
        } else {
    ...
    public static final float calculateImpulseVelocity(float[] fArr, float[] fArr2, int i, boolean z) {
        ...
        while (i3 > 0) {
            ...
            float f3 = fArr2[i4];
            if (f2 != f3) {
                float f4 = (z ? -fArr[i4] : fArr[i3] - fArr[i4]) / (f2 - f3);
    ...
    private static final void set(float[][] fArr, int i, int i2, float f2) {
        fArr[i][i2] = f2;
    }
