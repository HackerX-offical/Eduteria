...
public interface ContentScale {
    ...
    long mo7438computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo7438computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM7442computeFillMaxDimensioniLBOSCw = ContentScaleKt.m7442computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactor.m7555constructorimpl((((long) Float.floatToRawIntBits(fM7442computeFillMaxDimensioniLBOSCw)) << 32) | (4294967295L & ((long) Float.floatToRawIntBits(fM7442computeFillMaxDimensioniLBOSCw))));
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo7438computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM7443computeFillMinDimensioniLBOSCw = ContentScaleKt.m7443computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactor.m7555constructorimpl((((long) Float.floatToRawIntBits(fM7443computeFillMinDimensioniLBOSCw)) << 32) | (4294967295L & ((long) Float.floatToRawIntBits(fM7443computeFillMinDimensioniLBOSCw))));
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            public long mo7438computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                return ScaleFactor.m7555constructorimpl((((long) Float.floatToRawIntBits(fIntBitsToFloat)) << 32) | (((long) Float.floatToRawIntBits(fIntBitsToFloat)) & 4294967295L));
            }
        };
        ...
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            public long mo7438computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                if (Float.intBitsToFloat((int) (srcSize >> 32)) > Float.intBitsToFloat((int) (dstSize >> 32)) || Float.intBitsToFloat((int) (srcSize & 4294967295L)) > Float.intBitsToFloat((int) (dstSize & 4294967295L))) {
                    float fM7443computeFillMinDimensioniLBOSCw = ContentScaleKt.m7443computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactor.m7555constructorimpl((((long) Float.floatToRawIntBits(fM7443computeFillMinDimensioniLBOSCw)) << 32) | (((long) Float.floatToRawIntBits(fM7443computeFillMinDimensioniLBOSCw)) & 4294967295L));
                }
                return ScaleFactor.m7555constructorimpl((((long) Float.floatToRawIntBits(1.0f)) << 32) | (((long) Float.floatToRawIntBits(1.0f)) & 4294967295L));
            }
        };
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            public long mo7438computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                ...
                return ScaleFactor.m7555constructorimpl((((long) Float.floatToRawIntBits(fIntBitsToFloat)) << 32) | (((long) Float.floatToRawIntBits(fIntBitsToFloat2)) & 4294967295L));
            }
        };
