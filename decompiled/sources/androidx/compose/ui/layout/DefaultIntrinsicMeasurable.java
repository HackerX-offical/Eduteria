...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo7445measureBRTryo0(long constraints) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(iMinIntrinsicWidth, Constraints.m8778getHasBoundedHeightimpl(constraints) ? Constraints.m8782getMaxHeightimpl(constraints) : 32767);
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m8779getHasBoundedWidthimpl(constraints) ? Constraints.m8783getMaxWidthimpl(constraints) : 32767, iMinIntrinsicHeight);
    }
