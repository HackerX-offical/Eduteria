...
public final class HorizontalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Float.intBitsToFloat((int) (targetCoordinates.mo7454localPositionOfR5De75A(sourceCoordinates, Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(((int) (sourceCoordinates.mo7453getSizeYbymL2g() >> 32)) / 2.0f)) << 32) | (((long) Float.floatToRawIntBits(coordinate)) & 4294967295L))) & 4294967295L));
    }
    ...
    public static final class Companion {
        ...
        public final HorizontalRuler maxOf(final HorizontalRuler... rulers) {
            return new HorizontalRuler(new Function2<Placeable.PlacementScope, Float, Float>() { // from class: androidx.compose.ui.layout.HorizontalRuler$Companion$maxOf$1
                ...
                public /* bridge */ /* synthetic */ Float invoke(Placeable.PlacementScope placementScope, Float f2) {
                    return invoke(placementScope, f2.floatValue());
                }

                public final Float invoke(Placeable.PlacementScope placementScope, float f2) {
                    return Float.valueOf(RulerKt.mergeRulerValues(placementScope, true, rulers, f2));
                }
            }, null);
        }
        ...
        public final HorizontalRuler minOf(final HorizontalRuler... rulers) {
            return new HorizontalRuler(new Function2<Placeable.PlacementScope, Float, Float>() { // from class: androidx.compose.ui.layout.HorizontalRuler$Companion$minOf$1
                ...
                public final Float invoke(Placeable.PlacementScope placementScope, float f2) {
                    return Float.valueOf(RulerKt.mergeRulerValues(placementScope, false, rulers, f2));
                }
            }, null);
        }
