...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m7489roundToPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo481roundToPxR2X_6o(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m7490roundToPx0680j_4(MeasureScope measureScope, float f2) {
            return MeasureScope.super.mo482roundToPx0680j_4(f2);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m7491toDpGaN1DYA(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo483toDpGaN1DYA(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m7492toDpu2uoSUM(MeasureScope measureScope, float f2) {
            return MeasureScope.super.mo484toDpu2uoSUM(f2);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m7493toDpu2uoSUM(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo485toDpu2uoSUM(i);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m7494toDpSizekrfVVM(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo486toDpSizekrfVVM(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m7495toPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo487toPxR2X_6o(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m7496toPx0680j_4(MeasureScope measureScope, float f2) {
            return MeasureScope.super.mo488toPx0680j_4(f2);
        }
        ...
        public static long m7497toSizeXkaWNTQ(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo489toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* JADX INFO: renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m7498toSp0xMU5do(MeasureScope measureScope, float f2) {
            return MeasureScope.super.mo490toSp0xMU5do(f2);
        }

        @Deprecated
        /* JADX INFO: renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m7499toSpkPz2Gy4(MeasureScope measureScope, float f2) {
            return MeasureScope.super.mo491toSpkPz2Gy4(f2);
        }

        @Deprecated
        /* JADX INFO: renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m7500toSpkPz2Gy4(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo492toSpkPz2Gy4(i);
        }
