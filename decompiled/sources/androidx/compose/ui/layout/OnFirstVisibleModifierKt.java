...
public final class OnFirstVisibleModifierKt {
    public static /* synthetic */ Modifier onFirstVisible$default(Modifier modifier, long j, float f2, LayoutBoundsHolder layoutBoundsHolder, Function0 function0, int i, Object obj) {
        if ((i & 1) != 0) {
            j = 0;
        }
        long j2 = j;
        ...
        return onFirstVisible(modifier, j2, f3, layoutBoundsHolder, function0);
    }
    ...
    public static final Modifier onFirstVisible(Modifier modifier, long j, float f2, LayoutBoundsHolder layoutBoundsHolder, Function0<Unit> function0) {
        return modifier.then(new OnFirstVisibleElement(j, f2, layoutBoundsHolder, function0));
    }
}
