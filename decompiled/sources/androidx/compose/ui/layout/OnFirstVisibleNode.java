...
final class OnFirstVisibleNode extends Modifier.Node implements ObserverModifierNode {
    ...
    public OnFirstVisibleNode(long j, float f2, LayoutBoundsHolder layoutBoundsHolder, Function0<Unit> function0) {
        this.minDurationMs = j;
        this.minFractionVisible = f2;
    ...
    public final void setMinFractionVisible(float f2) {
        this.minFractionVisible = f2;
    }
    ...
    @DebugMetadata(c = "androidx.compose.ui.layout.OnFirstVisibleNode$startTimer$1", f = "OnFirstVisibleModifier.kt", i = {}, l = {ByteCode.MONITOREXIT}, m = "invokeSuspend", n = {}, s = {}, v = 1)
