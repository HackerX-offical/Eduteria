...
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0083@\u0018\u0000 \u000e2\u00020\u0001:\u0001\u000eB\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0014\u0010\b\u001a\u00020\t2\b\u0010\n\u001a\u0004\u0018\u00010\u0001HÖ\u0083\u0004J\n\u0010\u000b\u001a\u00020\u0003HÖ\u0081\u0004J\n\u0010\f\u001a\u00020\rHÖ\u0081\u0004R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007\u0088\u0001\u0002¨\u0006\u000f"}, d2 = {"Landroidx/compose/ui/layout/SLOperation;", "", "value", "", "constructor-impl", "(I)I", "getValue", "()I", "equals", "", "other", "hashCode", InAppPurchaseConstants.METHOD_TO_STRING, "", "Companion", "ui"}, k = 1, mv = {2, 1, 0}, xi = 48)
@JvmInline
final class SLOperation {
    ...
    private static final int CancelPausedPrecomposition = m7528constructorimpl(0);
    private static final int ReuseForceSyncDeactivation = m7528constructorimpl(1);
    private static final int ReuseScheduleOutOfFrameDeactivation = m7528constructorimpl(2);
    private static final int ReuseSyncDeactivation = m7528constructorimpl(3);
    private static final int ReuseDeactivationViaHost = m7528constructorimpl(4);
    private static final int TookFromPrecomposeMap = m7528constructorimpl(5);
    private static final int Subcompose = m7528constructorimpl(6);
    private static final int SubcomposeNew = m7528constructorimpl(7);
    private static final int SubcomposePausable = m7528constructorimpl(8);
    private static final int SubcomposeForceReuse = m7528constructorimpl(9);
    private static final int DeactivateOutOfFrame = m7528constructorimpl(10);
    private static final int DeactivateOutOfFrameCancelled = m7528constructorimpl(11);
    private static final int SlotToReusedFromOnDeactivate = m7528constructorimpl(12);
    private static final int SlotToReusedFromOnReuse = m7528constructorimpl(13);
    private static final int Reused = m7528constructorimpl(14);
    private static final int ResumePaused = m7528constructorimpl(15);
    private static final int PausePaused = m7528constructorimpl(16);
    private static final int ApplyPaused = m7528constructorimpl(17);

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ SLOperation m7527boximpl(int i) {
        return new SLOperation(i);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int m7528constructorimpl(int i) {
        return i;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m7529equalsimpl(int i, Object obj) {
        return (obj instanceof SLOperation) && i == ((SLOperation) obj).m7533unboximpl();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m7530equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m7531hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m7532toStringimpl(int i) {
        return "SLOperation(value=" + i + ')';
    }

    public boolean equals(Object other) {
        return m7529equalsimpl(this.value, other);
    }

    public int hashCode() {
        return m7531hashCodeimpl(this.value);
    }

    public String toString() {
        return m7532toStringimpl(this.value);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ int m7533unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m7535getCancelPausedPrecompositionNjRlDlw() {
        ...
        public final int m7541getReuseForceSyncDeactivationNjRlDlw() {
        ...
        public final int m7542getReuseScheduleOutOfFrameDeactivationNjRlDlw() {
        ...
        public final int m7543getReuseSyncDeactivationNjRlDlw() {
        ...
        public final int m7540getReuseDeactivationViaHostNjRlDlw() {
        ...
        public final int m7537getDeactivateOutOfFrameCancelledNjRlDlw() {
        ...
        public final int m7545getSlotToReusedFromOnDeactivateNjRlDlw() {
