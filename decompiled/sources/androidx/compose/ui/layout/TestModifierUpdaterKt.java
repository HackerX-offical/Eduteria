...
public final class TestModifierUpdaterKt {
    ...
    public static final void TestModifierUpdaterLayout(final Function1<? super TestModifierUpdater, Unit> function1, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(TestModifierUpdaterLayout)N(onAttached)49@1770L27,50@1833L102,53@1940L279:TestModifierUpdater.kt#80mrfh");
        if ((i & 6) == 0) {
        ...
        if (!composerStartRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            if (testModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1$1RememberedValue == Composer.INSTANCE.getEmpty()) {
                testModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1$1RememberedValue = new MeasurePolicy() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1$1
                    ...
                    public final MeasureResult mo44measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                        return MeasureScope.layout$default(measureScope, Constraints.m8783getMaxWidthimpl(j), Constraints.m8782getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1$1.1
            ...
            Updater.m5074initimpl(composerM5069constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$1$1
