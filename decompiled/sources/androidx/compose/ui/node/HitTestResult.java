...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ Object m7659removeFirst() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public /* bridge */ /* synthetic */ Object m7660removeLast() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final boolean hasHit() {
        long jM7658findBestHitDistancefn2tFes = m7658findBestHitDistancefn2tFes();
        return DistanceAndFlags.m7639getDistanceimpl(jM7658findBestHitDistancefn2tFes) < 0.0f && DistanceAndFlags.m7642isInLayerimpl(jM7658findBestHitDistancefn2tFes) && !DistanceAndFlags.m7641isInExpandedBoundsimpl(jM7658findBestHitDistancefn2tFes);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float distanceFromEdge, boolean isInLayer) {
        ...
        return DistanceAndFlags.m7635compareTo9YPOF3E(m7658findBestHitDistancefn2tFes(), HitTestResultKt.DistanceAndFlags$default(distanceFromEdge, isInLayer, false, 4, null)) > 0;
    }

    /* JADX INFO: renamed from: findBestHitDistance-fn2tFes, reason: not valid java name */
    private final long m7658findBestHitDistancefn2tFes() {
        ...
        if (i <= lastIndex) {
            while (true) {
                long jM7636constructorimpl = DistanceAndFlags.m7636constructorimpl(this.distanceFromEdgeAndFlags.get(i));
                if (DistanceAndFlags.m7635compareTo9YPOF3E(jM7636constructorimpl, jDistanceAndFlags$default) < 0) {
                    jDistanceAndFlags$default = jM7636constructorimpl;
                }
                if ((DistanceAndFlags.m7639getDistanceimpl(jDistanceAndFlags$default) < 0.0f && DistanceAndFlags.m7642isInLayerimpl(jDistanceAndFlags$default)) || i == lastIndex) {
                    break;
                }
                i++;
            }
    ...
    public final void hitExpandedTouchBounds(Modifier.Node node, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        if (!DistanceAndFlags.m7641isInExpandedBoundsimpl(jM7658findBestHitDistancefn2tFes)) {
            if (DistanceAndFlags.m7639getDistanceimpl(jM7658findBestHitDistancefn2tFes) > 0.0f) {
        ...
        childHitTest.invoke();
        this.hitDepth = i4;
        if (DistanceAndFlags.m7639getDistanceimpl(m7658findBestHitDistancefn2tFes()) < 0.0f) {
    ...
    public final void speculativeHit(Modifier.Node node, float distanceFromEdge, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        if (this.hitDepth == CollectionsKt.getLastIndex(hitTestResult)) {
            ...
            childHitTest.invoke();
            this.hitDepth = i2;
            if (this.hitDepth + 1 == CollectionsKt.getLastIndex(hitTestResult) || DistanceAndFlags.m7641isInExpandedBoundsimpl(m7658findBestHitDistancefn2tFes())) {
        ...
        childHitTest.invoke();
        this.hitDepth = i4;
        long jM7658findBestHitDistancefn2tFes2 = m7658findBestHitDistancefn2tFes();
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(hitTestResult) && DistanceAndFlags.m7635compareTo9YPOF3E(jM7658findBestHitDistancefn2tFes, jM7658findBestHitDistancefn2tFes2) > 0) {
            int i5 = i3 + 1;
            if (DistanceAndFlags.m7641isInExpandedBoundsimpl(jM7658findBestHitDistancefn2tFes2)) {
                i = this.hitDepth + 2;
            } else {
                i = this.hitDepth + 1;
            }
    ...
    private final class HitTestResultIterator implements ListIterator<Modifier.Node>, KMappedMarker {
        ...
        public Modifier.Node next() {
            ...
            int i = this.index;
            this.index = i + 1;
            E e2 = mutableObjectList.get(i);
            Intrinsics.checkNotNull(e2, "null cannot be cast to non-null type androidx.compose.ui.Modifier.Node");
            return (Modifier.Node) e2;
        }
    ...
    private final class SubList implements List<Modifier.Node>, KMappedMarker {
        ...
        /* JADX INFO: renamed from: removeFirst, reason: collision with other method in class */
        public /* bridge */ /* synthetic */ Object m7661removeFirst() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
        ...
        /* JADX INFO: renamed from: removeLast, reason: collision with other method in class */
        public /* bridge */ /* synthetic */ Object m7662removeLast() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
        ...
        @Override // java.util.List
        public Modifier.Node get(int index) {
            E e2 = HitTestResult.this.values.get(index + this.minIndex);
            Intrinsics.checkNotNull(e2, "null cannot be cast to non-null type androidx.compose.ui.Modifier.Node");
            return (Modifier.Node) e2;
        }
