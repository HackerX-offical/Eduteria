...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo7445measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateImpl.m7510setMeasurementConstraintsBRTryo0(constraints);
            ...
            lookaheadDelegateImpl.set_measureResult(getLayoutNode().getMeasurePolicy().mo44measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui(), constraints));
    ...
    public Placeable mo7445measureBRTryo0(long constraints) {
        if (getForceMeasureWithLookaheadConstraints()) {
            ...
            constraints = lookaheadDelegate.m7698getConstraintsmsEJaDk$ui();
        }
        ...
        setMeasureResult$ui(getLayoutNode().getMeasurePolicy().mo44measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui(), constraints));
        onMeasured();
        return this;
    }
    ...
    */
    public void mo7663hitTestChildqzLsGqo(androidx.compose.ui.node.NodeCoordinator.HitTestSource r11, long r12, androidx.compose.ui.node.HitTestResult r14, int r15, boolean r16) {
        /*
            r10 = this;
            androidx.compose.ui.node.LayoutNode r1 = r10.getLayoutNode()
            boolean r1 = r11.shouldHitTestChildren(r1)
            r4 = 1
            r5 = 0
            if (r1 == 0) goto L39
            boolean r1 = r10.m7757withinLayerBoundsk4lQ0M(r12)
            if (r1 == 0) goto L17
            r6 = r15
            r5 = r16
        L15:
        ...
        L17:
            ...
            int r1 = r1.m7392getTouchT8wyACA()
            r6 = r15
            boolean r1 = androidx.compose.ui.input.pointer.PointerType.m7385equalsimpl0(r15, r1)
            if (r1 == 0) goto L3a
            long r7 = r10.m7748getMinimumTouchTargetSizeNHjbRc()
            float r1 = r10.m7745distanceInMinimumTouchTargettz77jQw(r12, r7)
        ...
        L53:
            ...
            r2 = r12
            r4 = r14
            r0.mo7758childHitTestqzLsGqo(r1, r2, r4, r5, r6)
            boolean r2 = r14.hasHit()
            boolean r3 = androidx.compose.ui.ComposeUiFlags.isSkipNonImportantSemanticsNodesHitTestEnabled
            if (r3 == 0) goto L79
            if (r2 == 0) goto L8b
            boolean r1 = r11.shareWithSiblings(r14, r1)
            if (r1 == 0) goto L90
            goto L8b
        L79:
            if (r2 != 0) goto L7c
            goto L8b
        L7c:
            androidx.compose.ui.node.NodeCoordinator r1 = r1.getOuterCoordinator$ui()
        ...
        L93:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.InnerNodeCoordinator.mo7663hitTestChildqzLsGqo(androidx.compose.ui.node.NodeCoordinator$HitTestSource, long, androidx.compose.ui.node.HitTestResult, int, boolean):void");
    }
    ...
    static {
        ...
        Paint.mo5844setColor8_81llA(Color.INSTANCE.m6002getRed0d7_KjU());
