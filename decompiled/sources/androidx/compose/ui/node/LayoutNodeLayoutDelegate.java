...
public final class LayoutNodeLayoutDelegate {
    ...
    public final Constraints m7686getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m7715getLastConstraintsDWUhwKw();
    }

    /* JADX INFO: renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m7687getLastLookaheadConstraintsDWUhwKw() {
    ...
    public final void m7688performLookaheadMeasureBRTryo0$ui(long constraints) {
        LookaheadPassDelegate lookaheadPassDelegate = this.lookaheadPassDelegate;
        if (lookaheadPassDelegate != null) {
            lookaheadPassDelegate.m7706performMeasureBRTryo0$ui(constraints);
        }
    }
