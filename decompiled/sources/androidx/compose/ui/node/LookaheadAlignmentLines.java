...
public final class LookaheadAlignmentLines extends AlignmentLines {
    ...
    protected long mo7599calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j) {
        LookaheadDelegate lookaheadDelegate = nodeCoordinator.getLookaheadDelegate();
        Intrinsics.checkNotNull(lookaheadDelegate);
        long position = lookaheadDelegate.getPosition();
        return Offset.m5728plusMKHz9U(Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(IntOffset.m8958getXimpl(position))) << 32) | (((long) Float.floatToRawIntBits(IntOffset.m8959getYimpl(position))) & 4294967295L)), j);
    }
}
