...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m7703setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final long m7699getSizeYbymL2g$ui() {
        return IntSize.m8996constructorimpl((((long) getHeight()) & 4294967295L) | (((long) getWidth()) << 32));
    }

    /* JADX INFO: renamed from: getConstraints-msEJaDk$ui, reason: not valid java name */
    public final long m7698getConstraintsmsEJaDk$ui() {
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m7509setMeasuredSizeozmzZPI(IntSize.m8996constructorimpl((((long) measureResult.getHeight()) & 4294967295L) | (((long) measureResult.getWidth()) << 32)));
        } else {
            m7509setMeasuredSizeozmzZPI(IntSize.INSTANCE.m9006getZeroYbymL2g());
        }
    ...
    public void replace$ui() {
        mo7446placeAtf8xVGno(getPosition(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* JADX INFO: renamed from: placeAt-f8xVGno */
    public final void mo7446placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m7697placeSelfgyyYBs(position);
    ...
    private final void m7697placeSelfgyyYBs(long position) {
        if (!IntOffset.m8957equalsimpl0(getPosition(), position)) {
            m7703setPositiongyyYBs(position);
    ...
    public final void m7701placeSelfApparentToRealOffsetgyyYBs$ui(long position) {
        m7697placeSelfgyyYBs(IntOffset.m8962plusqkQi6aY(position, getApparentToRealOffset()));
    }
    ...
    public final Placeable m7700performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m7702positionIniSbpLlY$ui(LookaheadDelegate ancestor, boolean excludingAgnosticOffset) {
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            if (!lookaheadDelegate.getIsPlacedUnderMotionFrameOfReference() || !excludingAgnosticOffset) {
                jM8969getZeronOccac = IntOffset.m8962plusqkQi6aY(jM8969getZeronOccac, lookaheadDelegate.getPosition());
            }
