...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m7711updateRootConstraintsBRTryo0(long constraints) {
        ...
        this.rootConstraints = Constraints.m8770boximpl(constraints);
    ...
    private final boolean m7708doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM7670lookaheadRemeasure_Sx5XlM$ui$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            zM7670lookaheadRemeasure_Sx5XlM$ui$default = layoutNode.m7675lookaheadRemeasure_Sx5XlM$ui(constraints);
        } else {
            zM7670lookaheadRemeasure_Sx5XlM$ui$default = LayoutNode.m7670lookaheadRemeasure_Sx5XlM$ui$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui = layoutNode.getParent$ui();
        if (zM7670lookaheadRemeasure_Sx5XlM$ui$default && parent$ui != null) {
            if (parent$ui.getLookaheadRoot() == null) {
                LayoutNode.requestRemeasure$ui$default(parent$ui, false, false, false, 3, null);
                return zM7670lookaheadRemeasure_Sx5XlM$ui$default;
            }
    ...
    private final boolean m7709doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM7671remeasure_Sx5XlM$ui$default;
        if (constraints != null) {
            zM7671remeasure_Sx5XlM$ui$default = layoutNode.m7676remeasure_Sx5XlM$ui(constraints);
        } else {
            zM7671remeasure_Sx5XlM$ui$default = LayoutNode.m7671remeasure_Sx5XlM$ui$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui = layoutNode.getParent$ui();
        if (zM7671remeasure_Sx5XlM$ui$default && parent$ui != null) {
            if (layoutNode.getMeasuredByParent$ui() == LayoutNode.UsageByParent.InMeasureBlock) {
                LayoutNode.requestRemeasure$ui$default(parent$ui, false, false, false, 3, null);
                return zM7671remeasure_Sx5XlM$ui$default;
            }
    ...
    public final void m7710measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                if ((m7708doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m8770boximpl(constraints)) || layoutNode.getLookaheadLayoutPending$ui()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
                    layoutNode.lookaheadReplace$ui();
                }
                ensureSubtreeLookaheadReplaced(layoutNode);
                m7709doRemeasuresdFAvZA(layoutNode, Constraints.m8770boximpl(constraints));
    ...
    public final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        boolean zM7709doRemeasuresdFAvZA;
        LayoutNode parent$ui;
        boolean zM7708doLookaheadRemeasuresdFAvZA;
        boolean z = false;
        if (layoutNode.getIsDeactivated()) {
            return false;
        }
        if (isUsedInMeasureOrLayout(layoutNode)) {
            ...
            if (affectsLookahead) {
                if (layoutNode.getLookaheadMeasurePending$ui()) {
                    if (!ComposeToolingFlags.isVerboseTracingEnabled) {
                        zM7708doLookaheadRemeasuresdFAvZA = m7708doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
                    } else {
                    ...
                    z = zM7708doLookaheadRemeasuresdFAvZA;
                }
                if ((z || layoutNode.getLookaheadLayoutPending$ui()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
                    if (!ComposeToolingFlags.isVerboseTracingEnabled) {
                        layoutNode.lookaheadReplace$ui();
                    } else {
                ...
                if (!layoutNode.getMeasurePending$ui()) {
                    zM7709doRemeasuresdFAvZA = false;
                } else if (!ComposeToolingFlags.isVerboseTracingEnabled) {
                    zM7709doRemeasuresdFAvZA = m7709doRemeasuresdFAvZA(layoutNode, constraints);
                } else {
            ...
            if (affectsLookahead) {
                if (layoutNode.getLookaheadMeasurePending$ui()) {
                    if (!ComposeToolingFlags.isVerboseTracingEnabled || !shouldTraceMeasure) {
                        zM7709doRemeasuresdFAvZA = m7708doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
                    } else {
                        Trace.beginSection("Compose:lookaheadMeasure");
                        try {
                            zM7709doRemeasuresdFAvZA = m7708doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m7708doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m7709doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
    ...
    /* JADX INFO: compiled from: MeasureAndLayoutDelegate.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0007\b\u0007\u0018\u00002\u00020\u0001B\u001f\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0005¢\u0006\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\nR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0004\u0010\u000bR\u0011\u0010\u0006\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u000b¨\u0006\f"}, d2 = {"Landroidx/compose/ui/node/MeasureAndLayoutDelegate$PostponedRequest;", "", NodeElement.ELEMENT, "Landroidx/compose/ui/node/LayoutNode;", "isLookahead", "", "isForced", "<init>", "(Landroidx/compose/ui/node/LayoutNode;ZZ)V", "getNode", "()Landroidx/compose/ui/node/LayoutNode;", "()Z", "ui"}, k = 1, mv = {2, 1, 0}, xi = 48)
