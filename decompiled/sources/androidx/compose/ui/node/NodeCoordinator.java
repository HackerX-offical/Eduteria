...
public abstract class NodeCoordinator extends LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, OwnerScope {
    ...
    private static final float[] tmpMatrix = Matrix.m6214constructorimpl$default(null, 1, null);
    private static final HitTestSource PointerInputSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$PointerInputSource$1
        ...
        public void mo7758childHitTestqzLsGqo(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
            layoutNode.m7673hitTest6fMxITs$ui(pointerPosition, hitTestResult, pointerType, isInLayer);
        }
        ...
        public int mo7759entityTypeOLwlOKw() {
            return NodeKind.m7763constructorimpl(16);
        }
        ...
        public boolean interceptOutOfBoundsChildEvents(Modifier.Node node) {
            int iM7763constructorimpl = NodeKind.m7763constructorimpl(16);
            ...
            while (node != 0) {
                ...
                } else if ((node.getKindSet() & iM7763constructorimpl) != 0 && (node instanceof DelegatingNode)) {
    ...
    private static final HitTestSource SemanticsSource = new HitTestSource() { // from class: androidx.compose.ui.node.NodeCoordinator$Companion$SemanticsSource$1
        ...
        public void mo7758childHitTestqzLsGqo(LayoutNode layoutNode, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
            layoutNode.m7674hitTestSemantics6fMxITs$ui(pointerPosition, hitTestResult, pointerType, isInLayer);
        }
        ...
        public int mo7759entityTypeOLwlOKw() {
            return NodeKind.m7763constructorimpl(8);
        }
    };
    private Density layerDensity = getLayoutNode().getDensity();
    private LayoutDirection layerLayoutDirection = getLayoutNode().getLayoutDirection();
    private float lastLayerAlpha = 0.8f;
    private long position = IntOffset.INSTANCE.m8969getZeronOccac();
    ...
    public final /* synthetic */ <T> void m7756visitNodesaLcG6gQ(int type, Function1<? super T, Unit> block) {
        boolean zM7772getIncludeSelfInTraversalH91voCI = NodeKindKt.m7772getIncludeSelfInTraversalH91voCI(type);
        Modifier.Node tail = getTail();
        if (!zM7772getIncludeSelfInTraversalH91voCI && (tail = tail.getParent()) == null) {
            return;
        }
        for (Modifier.Node nodeHeadNode = headNode(zM7772getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet() & type) != 0; nodeHeadNode = nodeHeadNode.getChild()) {
    ...
    private final boolean m7732hasNodeH91voCI(int type) {
        Modifier.Node nodeHeadNode = headNode(NodeKindKt.m7772getIncludeSelfInTraversalH91voCI(type));
        return nodeHeadNode != null && DelegatableNodeKt.m7615has64DMado(nodeHeadNode, type);
    }

    /* JADX INFO: renamed from: head-H91voCI, reason: not valid java name */
    public final Modifier.Node m7749headH91voCI(int type) {
        boolean zM7772getIncludeSelfInTraversalH91voCI = NodeKindKt.m7772getIncludeSelfInTraversalH91voCI(type);
        Modifier.Node tail = getTail();
        if (!zM7772getIncludeSelfInTraversalH91voCI && (tail = tail.getParent()) == null) {
            return null;
    ...
    public final long mo7453getSizeYbymL2g() {
    ...
    public void replace$ui() {
        ...
        if (graphicsLayer != null) {
            mo7508placeAtf8xVGno(getPosition(), this.zIndex, graphicsLayer);
        } else {
            mo7446placeAtf8xVGno(getPosition(), this.zIndex, this.layerBlock);
        }
    }
    ...
    */
    public void setMeasureResult$ui(androidx.compose.ui.layout.MeasureResult r4) {
        /*
            r3 = this;
    ...
    public Set<AlignmentLine> getProvidedAlignmentLines() {
        ...
        for (NodeCoordinator nodeCoordinator = this; nodeCoordinator != null; nodeCoordinator = nodeCoordinator.wrapped) {
            ...
            if (alignmentLines != null && (!alignmentLines.isEmpty())) {
                ...
                mutableScatterSetMutableScatterSetOf.addAll(alignmentLines.keySet());
            }
        }
        return (mutableScatterSetMutableScatterSetOf == null || (setAsSet = mutableScatterSetMutableScatterSetOf.asSet()) == null) ? SetsKt.emptySet() : setAsSet;
    }
    ...
    protected void onMeasureResultChanged(int width, int height) {
        ...
        if (ownedLayer != null) {
            ownedLayer.mo7825resizeozmzZPI(IntSize.m8996constructorimpl((((long) width) << 32) | (((long) height) & 4294967295L)));
        } else if (getLayoutNode().isPlaced() && (nodeCoordinator = this.wrappedBy) != null) {
            nodeCoordinator.invalidateLayer();
        }
        m7509setMeasuredSizeozmzZPI(IntSize.m8996constructorimpl((((long) height) & 4294967295L) | (((long) width) << 32)));
        if (this.layerBlock != null) {
            updateLayerParameters(false);
        }
        int iM7763constructorimpl = NodeKind.m7763constructorimpl(4);
        boolean zM7772getIncludeSelfInTraversalH91voCI = NodeKindKt.m7772getIncludeSelfInTraversalH91voCI(iM7763constructorimpl);
        Modifier.Node tail = getTail();
        if (zM7772getIncludeSelfInTraversalH91voCI || (tail = tail.getParent()) != null) {
            for (Modifier.Node nodeHeadNode = headNode(zM7772getIncludeSelfInTraversalH91voCI); nodeHeadNode != null && (nodeHeadNode.getAggregateChildKindSet() & iM7763constructorimpl) != 0; nodeHeadNode = nodeHeadNode.getChild()) {
                if ((nodeHeadNode.getKindSet() & iM7763constructorimpl) != 0) {
                    Modifier.Node nodePop = nodeHeadNode;
                    MutableVector mutableVector = null;
                    while (nodePop != 0) {
                        if (nodePop instanceof DrawModifierNode) {
                            ...
                            while (delegate$ui != null) {
                                if ((delegate$ui.getKindSet() & iM7763constructorimpl) != 0) {
                                    i++;
                                    if (i == 1) {
                                        nodePop = delegate$ui;
                                    } else {
    ...
    protected void m7754setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public Object getParentData() {
        if (!getLayoutNode().getNodes().m7723hasH91voCI$ui(NodeKind.m7763constructorimpl(64))) {
            return null;
        }
        getTail();
        Ref.ObjectRef objectRef = new Ref.ObjectRef();
        for (Modifier.Node tail = getLayoutNode().getNodes().getTail(); tail != null; tail = tail.getParent()) {
            if ((NodeKind.m7763constructorimpl(64) & tail.getKindSet()) != 0) {
                int iM7763constructorimpl = NodeKind.m7763constructorimpl(64);
                MutableVector mutableVector = null;
    ...
    public final long m7747getLastMeasurementConstraintsmsEJaDk$ui() {
    ...
    protected final Placeable m7752performingMeasureK40F9xA(long constraints, Function0<? extends Placeable> block) {
        m7510setMeasurementConstraintsBRTryo0(constraints);
        return block.invoke();
    }
    ...
    protected void mo7446placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (this.forcePlaceWithLookaheadOffset) {
            ...
            m7738placeSelfMLgxB_4(lookaheadDelegate.getPosition(), zIndex, layerBlock, null);
            return;
        }
        m7738placeSelfMLgxB_4(position, zIndex, layerBlock, null);
    }
    ...
    protected void mo7508placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        if (this.forcePlaceWithLookaheadOffset) {
            LookaheadDelegate lookaheadDelegate = getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            m7738placeSelfMLgxB_4(lookaheadDelegate.getPosition(), zIndex, null, layer);
            return;
        }
        m7738placeSelfMLgxB_4(position, zIndex, null, layer);
    }

    /* JADX INFO: renamed from: placeSelf-MLgxB_4, reason: not valid java name */
    private final void m7738placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer explicitLayer) {
        if (explicitLayer != null) {
            ...
            if (this.layer == null) {
                ...
                ownedLayerCreateLayer.mo7825resizeozmzZPI(getMeasuredSize());
                ownedLayerCreateLayer.mo7824movegyyYBs(position);
        ...
        if (!IntOffset.m8957equalsimpl0(getPosition(), position)) {
            LayoutNodeKt.requireOwner(getLayoutNode()).voteFrameRate(FrameRateCategory.INSTANCE.m5400getHighNSsRyOo());
            m7754setPositiongyyYBs(position);
            OwnedLayer ownedLayer = this.layer;
            if (ownedLayer != null) {
                ownedLayer.mo7824movegyyYBs(position);
            } else {
                NodeCoordinator nodeCoordinator = this.wrappedBy;
                if (nodeCoordinator != null) {
                    nodeCoordinator.invalidateLayer();
    ...
    public final void m7753placeSelfApparentToRealOffsetMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
        m7738placeSelfMLgxB_4(IntOffset.m8962plusqkQi6aY(position, getApparentToRealOffset()), zIndex, layerBlock, layer);
    }
    ...
    public final void draw(Canvas canvas, GraphicsLayer graphicsLayer) {
        ...
        float fM8958getXimpl = IntOffset.m8958getXimpl(getPosition());
        float fM8959getYimpl = IntOffset.m8959getYimpl(getPosition());
        canvas.translate(fM8958getXimpl, fM8959getYimpl);
    ...
    public final void updateLayerBlock(Function1<? super GraphicsLayerScope, Unit> layerBlock, boolean forceUpdateLayerParameters) {
        ...
        if (layoutNode.isAttached() && layerBlock != null) {
            ...
            ownedLayerCreateLayer$default.mo7825resizeozmzZPI(getMeasuredSize());
            ownedLayerCreateLayer$default.mo7824movegyyYBs(getPosition());
        ...
        OwnedLayer ownedLayer = this.layer;
        if (ownedLayer != null) {
            if (!MatrixKt.m6239isIdentity58bKbWc(ownedLayer.mo7820getUnderlyingMatrixsQKQjiQ())) {
    ...
    private final void updateLayerParameters(boolean invokeOnLayoutChange) {
        ...
        if (ownedLayer != null) {
            ...
            if (function1 != null) {
                ...
                reusableGraphicsLayerScope.m6298setSizeuvyYCjk(IntSizeKt.m9013toSizeozmzZPI(mo7453getSizeYbymL2g()));
                getSnapshotObserver().observer.observeReads(this, onCommitAffectingLayerParams, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator.updateLayerParameters.1
                    ...
                    public final void invoke2() {
                        ...
                        boolean zAreEqual = Intrinsics.areEqual(this.getLastShape(), NodeCoordinator.graphicsLayerScope.getShape());
                        boolean z = this.getLastClip() != NodeCoordinator.graphicsLayerScope.getClip();
                        if (!zAreEqual || z) {
                            ...
                            if (this.getWasLayerBlockInvoked() && (z || (this.getLastClip() && !zAreEqual))) {
    ...
    public final long m7748getMinimumTouchTargetSizeNHjbRc() {
        return this.layerDensity.mo489toSizeXkaWNTQ(getLayoutNode().getViewConfiguration().mo7678getMinimumTouchTargetSizeMYxV2XQ());
    }

    /* JADX INFO: renamed from: hitTest-qzLsGqo, reason: not valid java name */
    public final void m7750hitTestqzLsGqo(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
        boolean z;
        Modifier.Node nodeM7749headH91voCI = m7749headH91voCI(hitTestSource.mo7759entityTypeOLwlOKw());
        boolean z2 = false;
        if (!m7757withinLayerBoundsk4lQ0M(pointerPosition)) {
            if (PointerType.m7385equalsimpl0(pointerType, PointerType.INSTANCE.m7392getTouchT8wyACA())) {
                float fM7745distanceInMinimumTouchTargettz77jQw = m7745distanceInMinimumTouchTargettz77jQw(pointerPosition, m7748getMinimumTouchTargetSizeNHjbRc());
                if ((Float.floatToRawIntBits(fM7745distanceInMinimumTouchTargettz77jQw) & Integer.MAX_VALUE) >= 2139095040 || !hitTestResult.isHitInMinimumTouchTargetBetter(fM7745distanceInMinimumTouchTargettz77jQw, false)) {
                    return;
                }
                m7734hitNearFh5PU_I(nodeM7749headH91voCI, hitTestSource, pointerPosition, hitTestResult, pointerType, false, fM7745distanceInMinimumTouchTargettz77jQw);
                return;
            }
            return;
        }
        if (nodeM7749headH91voCI == null) {
            mo7663hitTestChildqzLsGqo(hitTestSource, pointerPosition, hitTestResult, pointerType, isInLayer);
            return;
        }
        if (m7751isPointerInBoundsk4lQ0M(pointerPosition)) {
            m7733hit5ShdDok(nodeM7749headH91voCI, hitTestSource, pointerPosition, hitTestResult, pointerType, isInLayer);
            return;
        }
        float fM7745distanceInMinimumTouchTargettz77jQw2 = !PointerType.m7385equalsimpl0(pointerType, PointerType.INSTANCE.m7392getTouchT8wyACA()) ? Float.POSITIVE_INFINITY : m7745distanceInMinimumTouchTargettz77jQw(pointerPosition, m7748getMinimumTouchTargetSizeNHjbRc());
        if ((Float.floatToRawIntBits(fM7745distanceInMinimumTouchTargettz77jQw2) & Integer.MAX_VALUE) < 2139095040) {
            z = isInLayer;
            if (hitTestResult.isHitInMinimumTouchTargetBetter(fM7745distanceInMinimumTouchTargettz77jQw2, z)) {
                z2 = true;
            }
        } else {
            z = isInLayer;
        }
        m7737outOfBoundsHit8NAm7pk(nodeM7749headH91voCI, hitTestSource, pointerPosition, hitTestResult, pointerType, z, fM7745distanceInMinimumTouchTargettz77jQw2, z2);
    }

    /* JADX INFO: renamed from: hit-5ShdDok, reason: not valid java name */
    private final void m7733hit5ShdDok(Modifier.Node node, HitTestSource hitTestSource, long j, HitTestResult hitTestResult, int i, boolean z) {
        if (node == null) {
            mo7663hitTestChildqzLsGqo(hitTestSource, j, hitTestResult, i, z);
            return;
        }
        if (hitTestSource.shouldHitTest(node)) {
            ...
            m7733hit5ShdDok(NodeCoordinatorKt.m7761nextUntilhw7D004(node, hitTestSource.mo7759entityTypeOLwlOKw(), NodeKind.m7763constructorimpl(2)), hitTestSource, j, hitTestResult, i, z);
    ...
    public final void m7737outOfBoundsHit8NAm7pk(final Modifier.Node node, final HitTestSource hitTestSource, final long j, final HitTestResult hitTestResult, final int i, final boolean z, final float f2, final boolean z2) {
        if (node == null) {
            mo7663hitTestChildqzLsGqo(hitTestSource, j, hitTestResult, i, z);
            return;
        }
        if (!hitTestSource.shouldHitTest(node)) {
            m7737outOfBoundsHit8NAm7pk(NodeCoordinatorKt.m7761nextUntilhw7D004(node, hitTestSource.mo7759entityTypeOLwlOKw(), NodeKind.m7763constructorimpl(2)), hitTestSource, j, hitTestResult, i, z, f2, z2);
            return;
        }
        if (m7735isInExpandedTouchBoundsThDn1k(node, j, i)) {
            hitTestResult.hitExpandedTouchBounds(node, z, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$outOfBoundsHit$1
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m7737outOfBoundsHit8NAm7pk(NodeCoordinatorKt.m7761nextUntilhw7D004(node, hitTestSource.mo7759entityTypeOLwlOKw(), NodeKind.m7763constructorimpl(2)), hitTestSource, j, hitTestResult, i, z, f2, z2);
                }
            });
        } else if (z2) {
            m7734hitNearFh5PU_I(node, hitTestSource, j, hitTestResult, i, z, f2);
        } else {
            m7739speculativeHitFh5PU_I(node, hitTestSource, j, hitTestResult, i, z, f2);
        }
    }

    /* JADX INFO: renamed from: hitNear-Fh5PU_I, reason: not valid java name */
    private final void m7734hitNearFh5PU_I(Modifier.Node node, HitTestSource hitTestSource, long j, HitTestResult hitTestResult, int i, boolean z, float f2) {
        if (node == null) {
            mo7663hitTestChildqzLsGqo(hitTestSource, j, hitTestResult, i, z);
            return;
        }
        if (hitTestSource.shouldHitTest(node)) {
            ...
            hitTestResult.hitDepth++;
            hitTestResult.values.add(node);
            hitTestResult.distanceFromEdgeAndFlags.add(HitTestResultKt.DistanceAndFlags(f2, z, false));
            m7737outOfBoundsHit8NAm7pk(NodeCoordinatorKt.m7761nextUntilhw7D004(node, hitTestSource.mo7759entityTypeOLwlOKw(), NodeKind.m7763constructorimpl(2)), hitTestSource, j, hitTestResult, i, z, f2, true);
            hitTestResult.hitDepth = i2;
            return;
        }
        m7734hitNearFh5PU_I(NodeCoordinatorKt.m7761nextUntilhw7D004(node, hitTestSource.mo7759entityTypeOLwlOKw(), NodeKind.m7763constructorimpl(2)), hitTestSource, j, hitTestResult, i, z, f2);
    }

    /* JADX INFO: renamed from: speculativeHit-Fh5PU_I, reason: not valid java name */
    private final void m7739speculativeHitFh5PU_I(final Modifier.Node node, final HitTestSource hitTestSource, final long j, final HitTestResult hitTestResult, final int i, final boolean z, final float f2) {
        if (node == null) {
            mo7663hitTestChildqzLsGqo(hitTestSource, j, hitTestResult, i, z);
            return;
        }
        if (!hitTestSource.shouldHitTest(node)) {
            m7739speculativeHitFh5PU_I(NodeCoordinatorKt.m7761nextUntilhw7D004(node, hitTestSource.mo7759entityTypeOLwlOKw(), NodeKind.m7763constructorimpl(2)), hitTestSource, j, hitTestResult, i, z, f2);
        } else if (hitTestSource.interceptOutOfBoundsChildEvents(node)) {
            hitTestResult.speculativeHit(node, f2, z, new Function0<Unit>() { // from class: androidx.compose.ui.node.NodeCoordinator$speculativeHit$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
                ...
                /* JADX INFO: renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2() {
                    this.this$0.m7737outOfBoundsHit8NAm7pk(NodeCoordinatorKt.m7761nextUntilhw7D004(node, hitTestSource.mo7759entityTypeOLwlOKw(), NodeKind.m7763constructorimpl(2)), hitTestSource, j, hitTestResult, i, z, f2, false);
                }
            });
        } else {
            m7737outOfBoundsHit8NAm7pk(NodeCoordinatorKt.m7761nextUntilhw7D004(node, hitTestSource.mo7759entityTypeOLwlOKw(), NodeKind.m7763constructorimpl(2)), hitTestSource, j, hitTestResult, i, z, f2, false);
        }
    }
    ...
    private final boolean m7735isInExpandedTouchBoundsThDn1k(Modifier.Node node, long j, int i) {
        if (node == 0) {
            return false;
        }
        if (!PointerType.m7385equalsimpl0(i, PointerType.INSTANCE.m7391getStylusT8wyACA()) && !PointerType.m7385equalsimpl0(i, PointerType.INSTANCE.m7389getEraserT8wyACA())) {
            return false;
        }
        int iM7763constructorimpl = NodeKind.m7763constructorimpl(16);
        MutableVector mutableVector = null;
        while (node != 0) {
            if (node instanceof PointerInputModifierNode) {
                long jMo1913getTouchBoundsExpansionRZrCHBk = ((PointerInputModifierNode) node).mo1913getTouchBoundsExpansionRZrCHBk();
                int i2 = (int) (j >> 32);
                if (Float.intBitsToFloat(i2) >= (-TouchBoundsExpansion.m7849computeLeftimpl$ui(jMo1913getTouchBoundsExpansionRZrCHBk, getLayoutDirection())) && Float.intBitsToFloat(i2) < getMeasuredWidth() + TouchBoundsExpansion.m7850computeRightimpl$ui(jMo1913getTouchBoundsExpansionRZrCHBk, getLayoutDirection())) {
                    int i3 = (int) (j & 4294967295L);
                    if (Float.intBitsToFloat(i3) >= (-TouchBoundsExpansion.m7857getTopimpl(jMo1913getTouchBoundsExpansionRZrCHBk)) && Float.intBitsToFloat(i3) < getMeasuredHeight() + TouchBoundsExpansion.m7854getBottomimpl(jMo1913getTouchBoundsExpansionRZrCHBk)) {
                        return true;
                    }
                }
                return false;
            }
            if ((node.getKindSet() & iM7763constructorimpl) != 0 && (node instanceof DelegatingNode)) {
    ...
    public void mo7663hitTestChildqzLsGqo(HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
        NodeCoordinator nodeCoordinator = this.wrapped;
        if (nodeCoordinator != null) {
            nodeCoordinator.m7750hitTestqzLsGqo(hitTestSource, m7731fromParentPosition8S9VItk$default(nodeCoordinator, pointerPosition, false, 2, null), hitTestResult, pointerType, isInLayer);
        }
    }
    ...
    public final Rect touchBoundsInRoot() {
        ...
        long jM7744calculateMinimumTouchTargetPaddingE7KxVPU = m7744calculateMinimumTouchTargetPaddingE7KxVPU(m7748getMinimumTouchTargetSizeNHjbRc());
        int i = (int) (jM7744calculateMinimumTouchTargetPaddingE7KxVPU >> 32);
        rectCache.setLeft(-Float.intBitsToFloat(i));
        int i2 = (int) (jM7744calculateMinimumTouchTargetPaddingE7KxVPU & 4294967295L);
    ...
    public long mo7459screenToLocalMKHz9U(long relativeToScreen) {
        if (!isAttached()) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        return mo7454localPositionOfR5De75A(LayoutCoordinatesKt.findRootCoordinates(this), LayoutNodeKt.requireOwner(getLayoutNode()).mo7395screenToLocalMKHz9U(relativeToScreen));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: localToScreen-MK-Hz9U */
    public long mo7457localToScreenMKHz9U(long relativeToLocal) {
        if (!isAttached()) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        return LayoutNodeKt.requireOwner(getLayoutNode()).mo7394localToScreenMKHz9U(mo7456localToRootMKHz9U(relativeToLocal));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: windowToLocal-MK-Hz9U */
    public long mo7462windowToLocalMKHz9U(long relativeToWindow) {
        if (!isAttached()) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        LayoutCoordinates layoutCoordinatesFindRootCoordinates = LayoutCoordinatesKt.findRootCoordinates(this);
        return mo7454localPositionOfR5De75A(layoutCoordinatesFindRootCoordinates, Offset.m5727minusMKHz9U(LayoutNodeKt.requireOwner(getLayoutNode()).mo7827calculateLocalPositionMKHz9U(relativeToWindow), LayoutCoordinatesKt.positionInRoot(layoutCoordinatesFindRootCoordinates)));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: localToWindow-MK-Hz9U */
    public long mo7458localToWindowMKHz9U(long relativeToLocal) {
        return LayoutNodeKt.requireOwner(getLayoutNode()).mo7828calculatePositionInWindowMKHz9U(mo7456localToRootMKHz9U(relativeToLocal));
    }
    ...
    public long mo7454localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource) {
        return mo7455localPositionOfS_NoaFU(sourceCoordinates, relativeToSource, true);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: localPositionOf-S_NoaFU */
    public long mo7455localPositionOfS_NoaFU(LayoutCoordinates sourceCoordinates, long relativeToSource, boolean includeMotionFrameOfReference) {
        if (sourceCoordinates instanceof LookaheadLayoutCoordinates) {
            ...
            return Offset.m5715constructorimpl(lookaheadLayoutCoordinates.mo7455localPositionOfS_NoaFU(this, Offset.m5715constructorimpl(relativeToSource ^ (-9223372034707292160L)), includeMotionFrameOfReference) ^ (-9223372034707292160L));
        }
        ...
        while (coordinator != nodeCoordinatorFindCommonAncestor$ui) {
            relativeToSource = coordinator.m7755toParentPosition8S9VItk(relativeToSource, includeMotionFrameOfReference);
            coordinator = coordinator.wrappedBy;
            Intrinsics.checkNotNull(coordinator);
        }
        return m7730ancestorToLocalS_NoaFU(nodeCoordinatorFindCommonAncestor$ui, relativeToSource, includeMotionFrameOfReference);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: transformFrom-EL8BTi8 */
    public void mo7460transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        NodeCoordinator coordinator = toCoordinator(sourceCoordinates);
        coordinator.onCoordinatesUsed$ui();
        NodeCoordinator nodeCoordinatorFindCommonAncestor$ui = findCommonAncestor$ui(coordinator);
        Matrix.m6223resetimpl(matrix);
        coordinator.m7742transformToAncestorEL8BTi8(nodeCoordinatorFindCommonAncestor$ui, matrix);
        m7741transformFromAncestorEL8BTi8(nodeCoordinatorFindCommonAncestor$ui, matrix);
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* JADX INFO: renamed from: transformToScreen-58bKbWc */
    public void mo7461transformToScreen58bKbWc(float[] matrix) {
        ...
        m7742transformToAncestorEL8BTi8(coordinator, matrix);
        if (ownerRequireOwner instanceof MatrixPositionCalculator) {
            ((MatrixPositionCalculator) ownerRequireOwner).mo7218localToScreen58bKbWc(matrix);
            return;
        }
        ...
        if ((9223372034707292159L & jPositionOnScreen) != androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            Matrix.m6235translateimpl(matrix, Float.intBitsToFloat((int) (jPositionOnScreen >> 32)), Float.intBitsToFloat((int) (jPositionOnScreen & 4294967295L)), 0.0f);
        }
    }

    /* JADX INFO: renamed from: transformToAncestor-EL8BTi8, reason: not valid java name */
    private final void m7742transformToAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        NodeCoordinator nodeCoordinator = this;
        while (!Intrinsics.areEqual(nodeCoordinator, ancestor)) {
            OwnedLayer ownedLayer = nodeCoordinator.layer;
            if (ownedLayer != null) {
                ownedLayer.mo7826transform58bKbWc(matrix);
            }
            if (!IntOffset.m8957equalsimpl0(nodeCoordinator.getPosition(), IntOffset.INSTANCE.m8969getZeronOccac())) {
                float[] fArr = tmpMatrix;
                Matrix.m6223resetimpl(fArr);
                Matrix.m6236translateimpl$default(fArr, IntOffset.m8958getXimpl(r1), IntOffset.m8959getYimpl(r1), 0.0f, 4, null);
                Matrix.m6233timesAssign58bKbWc(matrix, fArr);
            }
            nodeCoordinator = nodeCoordinator.wrappedBy;
            Intrinsics.checkNotNull(nodeCoordinator);
        }
    ...
    private final void m7741transformFromAncestorEL8BTi8(NodeCoordinator ancestor, float[] matrix) {
        if (Intrinsics.areEqual(ancestor, this)) {
            return;
        }
        NodeCoordinator nodeCoordinator = this.wrappedBy;
        Intrinsics.checkNotNull(nodeCoordinator);
        nodeCoordinator.m7741transformFromAncestorEL8BTi8(ancestor, matrix);
        if (!IntOffset.m8957equalsimpl0(getPosition(), IntOffset.INSTANCE.m8969getZeronOccac())) {
            float[] fArr = tmpMatrix;
            Matrix.m6223resetimpl(fArr);
            Matrix.m6236translateimpl$default(fArr, -IntOffset.m8958getXimpl(getPosition()), -IntOffset.m8959getYimpl(getPosition()), 0.0f, 4, null);
            Matrix.m6233timesAssign58bKbWc(matrix, fArr);
        }
        OwnedLayer ownedLayer = this.layer;
        if (ownedLayer != null) {
            ownedLayer.mo7821inverseTransform58bKbWc(matrix);
        }
    }
    ...
    public Rect localBoundingBoxOf(LayoutCoordinates sourceCoordinates, boolean clipBounds) {
        ...
        rectCache.setRight((int) (sourceCoordinates.mo7453getSizeYbymL2g() >> 32));
        rectCache.setBottom((int) (sourceCoordinates.mo7453getSizeYbymL2g() & 4294967295L));
    ...
    private final long m7730ancestorToLocalS_NoaFU(NodeCoordinator ancestor, long offset, boolean includeMotionFrameOfReference) {
        if (ancestor == this) {
            return offset;
        }
        NodeCoordinator nodeCoordinator = this.wrappedBy;
        if (nodeCoordinator == null || Intrinsics.areEqual(ancestor, nodeCoordinator)) {
            return m7746fromParentPosition8S9VItk(offset, includeMotionFrameOfReference);
        }
        return m7746fromParentPosition8S9VItk(nodeCoordinator.m7730ancestorToLocalS_NoaFU(ancestor, offset, includeMotionFrameOfReference), includeMotionFrameOfReference);
    }
    ...
    public long mo7456localToRootMKHz9U(long relativeToLocal) {
        if (!isAttached()) {
            InlineClassHelperKt.throwIllegalStateException(ExpectAttachedLayoutCoordinates);
        }
        onCoordinatesUsed$ui();
        long jM7740toParentPosition8S9VItk$default = relativeToLocal;
        for (NodeCoordinator nodeCoordinator = this; nodeCoordinator != null; nodeCoordinator = nodeCoordinator.wrappedBy) {
            ...
            if (nodeCoordinator == layoutNode.getOuterCoordinator$ui() && !layoutNode.getHasPositionalLayerTransformationsInOffsetFromRoot()) {
                long jM8036getOffsetFromRectListForBjo55l4 = LayoutNodeKt.requireOwner(layoutNode).getRectManager().m8036getOffsetFromRectListForBjo55l4(layoutNode);
                if (!IntOffset.m8957equalsimpl0(jM8036getOffsetFromRectListForBjo55l4, IntOffset.INSTANCE.m8968getMaxnOccac())) {
                    return IntOffsetKt.m8973plusNvtHpc(jM7740toParentPosition8S9VItk$default, jM8036getOffsetFromRectListForBjo55l4);
                }
            }
            jM7740toParentPosition8S9VItk$default = m7740toParentPosition8S9VItk$default(nodeCoordinator, jM7740toParentPosition8S9VItk$default, false, 2, null);
        }
        return jM7740toParentPosition8S9VItk$default;
    }
    ...
    public static /* synthetic */ long m7740toParentPosition8S9VItk$default(NodeCoordinator nodeCoordinator, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return nodeCoordinator.m7755toParentPosition8S9VItk(j, z);
    }

    /* JADX INFO: renamed from: toParentPosition-8S9VItk, reason: not valid java name */
    public long m7755toParentPosition8S9VItk(long position, boolean includeMotionFrameOfReference) {
        OwnedLayer ownedLayer = this.layer;
        if (ownedLayer != null) {
            position = ownedLayer.mo7823mapOffset8S9VItk(position, false);
        }
        return (includeMotionFrameOfReference || !getIsPlacedUnderMotionFrameOfReference()) ? IntOffsetKt.m8973plusNvtHpc(position, getPosition()) : position;
    }

    /* JADX INFO: renamed from: fromParentPosition-8S9VItk$default, reason: not valid java name */
    public static /* synthetic */ long m7731fromParentPosition8S9VItk$default(NodeCoordinator nodeCoordinator, long j, boolean z, int i, Object obj) {
        if (obj != null) {
        ...
        return nodeCoordinator.m7746fromParentPosition8S9VItk(j, z);
    }

    /* JADX INFO: renamed from: fromParentPosition-8S9VItk, reason: not valid java name */
    public long m7746fromParentPosition8S9VItk(long position, boolean includeMotionFrameOfReference) {
        if (includeMotionFrameOfReference || !getIsPlacedUnderMotionFrameOfReference()) {
            position = IntOffsetKt.m8971minusNvtHpc(position, getPosition());
        }
        OwnedLayer ownedLayer = this.layer;
        return ownedLayer != null ? ownedLayer.mo7823mapOffset8S9VItk(position, true) : position;
    }
    ...
    public final void rectInParent$ui(MutableRect bounds, boolean clipBounds, boolean clipToMinimumTouchTargetSize) {
        ...
        if (ownedLayer != null) {
            if (this.isClipping) {
                if (clipToMinimumTouchTargetSize) {
                    long jM7748getMinimumTouchTargetSizeNHjbRc = m7748getMinimumTouchTargetSizeNHjbRc();
                    long jM7743calculateMinimumTouchTargetOffsetC6jSQ5I = m7743calculateMinimumTouchTargetOffsetC6jSQ5I(bounds, jM7748getMinimumTouchTargetSizeNHjbRc);
                    float fIntBitsToFloat = Float.intBitsToFloat((int) (jM7743calculateMinimumTouchTargetOffsetC6jSQ5I >> 32));
                    float fIntBitsToFloat2 = Float.intBitsToFloat((int) (jM7743calculateMinimumTouchTargetOffsetC6jSQ5I & 4294967295L));
                    long jMo7453getSizeYbymL2g = mo7453getSizeYbymL2g();
                    float f2 = (int) (jMo7453getSizeYbymL2g >> 32);
                    int i = (int) (jM7748getMinimumTouchTargetSizeNHjbRc >> 32);
                    float fMin = Math.min(Float.intBitsToFloat(i) + f2, Math.max(f2, Float.intBitsToFloat(i) + fIntBitsToFloat));
                    float f3 = (int) (jMo7453getSizeYbymL2g & 4294967295L);
                    int i2 = (int) (jM7748getMinimumTouchTargetSizeNHjbRc & 4294967295L);
                    bounds.intersect(fIntBitsToFloat, fIntBitsToFloat2, fMin, Math.min(Float.intBitsToFloat(i2) + f3, Math.max(f3, Float.intBitsToFloat(i2) + fIntBitsToFloat2)));
                } else if (clipBounds) {
                    bounds.intersect(0.0f, 0.0f, (int) (mo7453getSizeYbymL2g() >> 32), (int) (4294967295L & mo7453getSizeYbymL2g()));
                }
                if (bounds.isEmpty()) {
                    return;
                }
        ...
        float fM8958getXimpl = IntOffset.m8958getXimpl(getPosition());
        bounds.setLeft(bounds.getLeft() + fM8958getXimpl);
        bounds.setRight(bounds.getRight() + fM8958getXimpl);
        float fM8959getYimpl = IntOffset.m8959getYimpl(getPosition());
        bounds.setTop(bounds.getTop() + fM8959getYimpl);
        bounds.setBottom(bounds.getBottom() + fM8959getYimpl);
    }
    ...
    private final void fromParentRect(MutableRect bounds, boolean clipBounds) {
        ...
        if (ownedLayer != null) {
            ...
            if (this.isClipping && clipBounds) {
                bounds.intersect(0.0f, 0.0f, (int) (mo7453getSizeYbymL2g() >> 32), (int) (mo7453getSizeYbymL2g() & 4294967295L));
                bounds.isEmpty();
            }
        }
    }
    ...
    protected final boolean m7757withinLayerBoundsk4lQ0M(long pointerPosition) {
        ...
        OwnedLayer ownedLayer = this.layer;
        return ownedLayer == null || !this.isClipping || ownedLayer.mo7822isInLayerk4lQ0M(pointerPosition);
    }
    ...
    public final NodeCoordinator findCommonAncestor$ui(NodeCoordinator other) {
        ...
        if (layoutNode == layoutNode2) {
            ...
            int iM7763constructorimpl = NodeKind.m7763constructorimpl(2);
            if (!tail2.getNode().getIsAttached()) {
                InlineClassHelperKt.throwIllegalStateException("visitLocalAncestors called on an unattached node");
            }
            for (Modifier.Node parent = tail2.getNode().getParent(); parent != null; parent = parent.getParent()) {
                if ((parent.getKindSet() & iM7763constructorimpl) != 0 && parent == tail) {
                    return other;
                }
            }
            return this;
    ...
    protected final long m7743calculateMinimumTouchTargetOffsetC6jSQ5I(MutableRect childRect, long minimumTouchTargetSize) {
        float left = childRect.getLeft();
        float top = childRect.getTop();
        if (childRect.getRight() < 0.0f || left > ((int) (mo7453getSizeYbymL2g() >> 32)) || childRect.getBottom() < 0.0f || top > ((int) (mo7453getSizeYbymL2g() & 4294967295L))) {
        ...
        float fCoerceAtLeast = right > 0.0f ? left - right : RangesKt.coerceAtLeast(left, (-fIntBitsToFloat) / 2.0f);
        float bottom = (fIntBitsToFloat2 - (childRect.getBottom() - childRect.getTop())) / 2.0f;
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(fCoerceAtLeast)) << 32) | (((long) Float.floatToRawIntBits(bottom > 0.0f ? top - bottom : RangesKt.coerceAtLeast(top, (-fIntBitsToFloat2) / 2.0f))) & 4294967295L));
    }

    /* JADX INFO: renamed from: distanceInMinimumTouchTarget-tz77jQw, reason: not valid java name */
    protected final float m7745distanceInMinimumTouchTargettz77jQw(long pointerPosition, long minimumTouchTargetSize) {
        ...
        long jM7744calculateMinimumTouchTargetPaddingE7KxVPU = m7744calculateMinimumTouchTargetPaddingE7KxVPU(minimumTouchTargetSize);
        float fIntBitsToFloat = Float.intBitsToFloat((int) (jM7744calculateMinimumTouchTargetPaddingE7KxVPU >> 32));
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (jM7744calculateMinimumTouchTargetPaddingE7KxVPU & 4294967295L));
        long jM7736offsetFromEdgeMKHz9U = m7736offsetFromEdgeMKHz9U(pointerPosition);
        if ((fIntBitsToFloat > 0.0f || fIntBitsToFloat2 > 0.0f) && Float.intBitsToFloat((int) (jM7736offsetFromEdgeMKHz9U >> 32)) <= fIntBitsToFloat && Float.intBitsToFloat((int) (jM7736offsetFromEdgeMKHz9U & 4294967295L)) <= fIntBitsToFloat2) {
            return Offset.m5722getDistanceSquaredimpl(jM7736offsetFromEdgeMKHz9U);
        }
        return Float.POSITIVE_INFINITY;
    }
    ...
    public final void onMeasured() {
        ...
        if (m7732hasNodeH91voCI(NodeKind.m7763constructorimpl(128))) {
            Snapshot.Companion companion = Snapshot.INSTANCE;
            Snapshot currentThreadSnapshot = companion.getCurrentThreadSnapshot();
            Function1<Object, Unit> readObserver = currentThreadSnapshot != null ? currentThreadSnapshot.getReadObserver() : null;
            Snapshot snapshotMakeCurrentNonObservable = companion.makeCurrentNonObservable(currentThreadSnapshot);
            try {
                int iM7763constructorimpl = NodeKind.m7763constructorimpl(128);
                boolean zM7772getIncludeSelfInTraversalH91voCI = NodeKindKt.m7772getIncludeSelfInTraversalH91voCI(iM7763constructorimpl);
                if (!zM7772getIncludeSelfInTraversalH91voCI) {
                    ...
                    if ((nodeHeadNode.getKindSet() & iM7763constructorimpl) != 0) {
                        ...
                        while (nodePop != 0) {
                            if (nodePop instanceof MeasuredSizeAwareModifierNode) {
                                ((MeasuredSizeAwareModifierNode) nodePop).mo477onRemeasuredozmzZPI(getMeasuredSize());
                            } else if ((nodePop.getKindSet() & iM7763constructorimpl) != 0 && (nodePop instanceof DelegatingNode)) {
                                Modifier.Node delegate$ui = ((DelegatingNode) nodePop).getDelegate();
                                int i = 0;
                                nodePop = nodePop;
    ...
    public final void onUnplaced() {
        if (m7732hasNodeH91voCI(NodeKind.m7763constructorimpl(1048576))) {
            int iM7763constructorimpl = NodeKind.m7763constructorimpl(1048576);
            boolean zM7772getIncludeSelfInTraversalH91voCI = NodeKindKt.m7772getIncludeSelfInTraversalH91voCI(iM7763constructorimpl);
            Modifier.Node tail = getTail();
            if (!zM7772getIncludeSelfInTraversalH91voCI && (tail = tail.getParent()) == null) {
                return;
    ...
    public final void drawContainedDrawModifiers(Canvas canvas, GraphicsLayer graphicsLayer) {
        Modifier.Node nodeM7749headH91voCI = m7749headH91voCI(NodeKind.m7763constructorimpl(4));
        if (nodeM7749headH91voCI == null) {
            performDraw(canvas, graphicsLayer);
        } else {
            getLayoutNode().getMDrawScope$ui().m7684draweZhPAX0$ui(canvas, IntSizeKt.m9013toSizeozmzZPI(mo7453getSizeYbymL2g()), this, nodeM7749headH91voCI, graphicsLayer);
        }
    }
    ...
    public final void onPlaced() {
        int iM7763constructorimpl = NodeKind.m7763constructorimpl(4194304);
        boolean zM7772getIncludeSelfInTraversalH91voCI = NodeKindKt.m7772getIncludeSelfInTraversalH91voCI(iM7763constructorimpl);
        Modifier.Node tail = getTail();
        if (!zM7772getIncludeSelfInTraversalH91voCI && (tail = tail.getParent()) == null) {
            return;
    ...
    protected final boolean m7751isPointerInBoundsk4lQ0M(long pointerPosition) {
    ...
    public final boolean shouldSharePointerInputWithSiblings() {
        Modifier.Node nodeHeadNode = headNode(NodeKindKt.m7772getIncludeSelfInTraversalH91voCI(NodeKind.m7763constructorimpl(16)));
        if (nodeHeadNode != null && nodeHeadNode.getIsAttached()) {
            ...
            if ((node2.getAggregateChildKindSet() & iM7763constructorimpl) != 0) {
                while (node2 != null) {
                    if ((node2.getKindSet() & iM7763constructorimpl) != 0) {
    ...
    private final long m7736offsetFromEdgeMKHz9U(long pointerPosition) {
        float fIntBitsToFloat = Float.intBitsToFloat((int) (pointerPosition >> 32));
        float fMax = Math.max(0.0f, fIntBitsToFloat < 0.0f ? -fIntBitsToFloat : fIntBitsToFloat - getMeasuredWidth());
        float fIntBitsToFloat2 = Float.intBitsToFloat((int) (pointerPosition & 4294967295L));
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(Math.max(0.0f, fIntBitsToFloat2 < 0.0f ? -fIntBitsToFloat2 : fIntBitsToFloat2 - getMeasuredHeight()))) & 4294967295L) | (((long) Float.floatToRawIntBits(fMax)) << 32));
    }

    /* JADX INFO: renamed from: calculateMinimumTouchTargetPadding-E7KxVPU, reason: not valid java name */
    protected final long m7744calculateMinimumTouchTargetPaddingE7KxVPU(long minimumTouchTargetSize) {
        ...
        return Size.m5783constructorimpl((((long) Float.floatToRawIntBits(Math.max(0.0f, fIntBitsToFloat2 / 2.0f))) & 4294967295L) | (Float.floatToRawIntBits(fMax) << 32));
    }
}
