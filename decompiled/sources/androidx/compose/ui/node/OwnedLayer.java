...
public interface OwnedLayer {
    ...
    float[] mo7820getUnderlyingMatrixsQKQjiQ();

    void invalidate();

    /* JADX INFO: renamed from: inverseTransform-58bKbWc, reason: not valid java name */
    void mo7821inverseTransform58bKbWc(float[] matrix);
    ...
    void mo7826transform58bKbWc(float[] matrix);
