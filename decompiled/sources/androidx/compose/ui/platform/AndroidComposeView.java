...
public final class AndroidComposeView extends ViewGroup implements Owner, PlatformFocusOwner, ViewRootForTest, MatrixPositionCalculator, DefaultLifecycleObserver, OutOfFrameExecutor, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, ViewTreeObserver.OnTouchModeChangeListener, FocusListener, ExecuteDelayed {
    ...
    public static /* synthetic */ void m7877getPrimaryDirectionalMotionAxisOverridedqNNBbU$ui$annotations() {
    }
    ...
    public AndroidComposeView(Context context, ComposeViewContext composeViewContext) {
        ...
        this.lastDownPointerPosition = Offset.INSTANCE.m5738getUnspecifiedF1C5BW0();
        int i = 1;
        this.superclassInitComplete = true;
        if (AndroidComposeUiFlags.isSharedDrawingEnabled) {
            layoutNodeDrawScope = composeViewContext.getSharedDrawScope();
        } else {
            layoutNodeDrawScope = new LayoutNodeDrawScope(null == true ? 1 : 0, i, null == true ? 1 : 0);
        }
        ...
        this.localeList = SnapshotStateKt.derivedStateOf(new Function0<LocaleList>() { // from class: androidx.compose.ui.platform.AndroidComposeView$localeList$2
            ...
            public final LocaleList invoke() {
                LocaleListCompat locales = ConfigurationCompat.getLocales(this.this$0.getConfiguration());
                if (locales.isEmpty()) {
        ...
        this.globalPosition = IntOffset.m8952constructorimpl((j & 4294967295L) | (j << 32));
        this.tmpPositionArray = new int[]{0, 0};
        float[] fArrM6214constructorimpl$default = Matrix.m6214constructorimpl$default(null, 1, null);
        this.tmpMatrix = fArrM6214constructorimpl$default;
        this.viewToWindowMatrix = Matrix.m6214constructorimpl$default(null, 1, null);
        this.windowToViewMatrix = Matrix.m6214constructorimpl$default(null, 1, null);
        this.lastMatrixRecalculationAnimationTime = -1L;
        this.windowPosition = Offset.INSTANCE.m5737getInfiniteF1C5BW0();
        ...
        this.textInputSessionMutex = SessionMutex.m5405constructorimpl();
        ...
        this._inputModeManager = new InputModeManagerImpl(isInTouchMode() ? InputMode.INSTANCE.m6786getTouchaOaMEAU() : InputMode.INSTANCE.m6785getKeyboardaOaMEAU(), new InputModeChangeRequester() { // from class: androidx.compose.ui.platform.AndroidComposeView$_inputModeManager$1
            @Override // androidx.compose.ui.input.InputModeChangeRequester
            /* JADX INFO: renamed from: request-iuPiT84 */
            public final boolean mo6787requestiuPiT84(int i2) {
                if (InputMode.m6781equalsimpl0(i2, InputMode.INSTANCE.m6786getTouchaOaMEAU())) {
                    return this.this$0.isInTouchMode();
                }
                if (!InputMode.m6781equalsimpl0(i2, InputMode.INSTANCE.m6785getKeyboardaOaMEAU())) {
                    return false;
                }
        ...
        this.resendMotionEventRunnable = new Runnable() { // from class: androidx.compose.ui.platform.AndroidComposeView$resendMotionEventRunnable$1
            ...
            public void run() {
                ...
                androidComposeView3.sendSimulatedEvent(motionEvent, i3, androidComposeView3.relayoutTime, false);
            }
        };
        ...
        this.indirectPointerNavigationGestureDetector = new IndirectPointerNavigationGestureDetector(context, new Function1<FocusDirection, Unit>() { // from class: androidx.compose.ui.platform.AndroidComposeView$indirectPointerNavigationGestureDetector$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(FocusDirection focusDirection) {
                m7890invoke3ESFkO8(focusDirection.getValue());
                return Unit.INSTANCE;
            }

            /* JADX INFO: renamed from: invoke-3ESFkO8, reason: not valid java name */
            public final void m7890invoke3ESFkO8(int i2) {
                this.this$0.getFocusOwner().mo5618moveFocusaToIllA(i2, false);
            }
        });
        ...
        this.matrixToWindow = Build.VERSION.SDK_INT < 29 ? new CalculateMatrixToWindowApi21(fArrM6214constructorimpl$default, null == true ? 1 : 0) : new CalculateMatrixToWindowApi29();
    ...
    private final ComposeViewContext get_composeViewContext() {
        return (ComposeViewContext) this._composeViewContext.getValue();
    }

    private final void set_composeViewContext(ComposeViewContext composeViewContext) {
        this._composeViewContext.setValue(composeViewContext);
    }
    ...
    public final void setComposeViewContext(ComposeViewContext composeViewContext) {
        if (!(getCoroutineContext() == composeViewContext.getCompositionContext().getEffectCoroutineContext() || getRoot().getChildren$ui().isEmpty())) {
        ...
        try {
            ...
            setCoroutineContext(composeViewContext.getCompositionContext().getEffectCoroutineContext());
        } catch (Throwable th) {
            companion.restoreNonObservable(currentThreadSnapshot, snapshotMakeCurrentNonObservable, readObserver);
            throw th;
        }
    ...
    public final void m7886setPrimaryDirectionalMotionAxisOverrider2epLt8$ui(IndirectPointerEventPrimaryDirectionalMotionAxis indirectPointerEventPrimaryDirectionalMotionAxis) {
    ...
    private final boolean getDerivedIsAttached() {
        return ((Boolean) this.derivedIsAttached.getValue()).booleanValue();
    }

    /* JADX INFO: renamed from: moveFocusInChildrenCurrent-3ESFkO8, reason: not valid java name */
    private final boolean m7880moveFocusInChildrenCurrent3ESFkO8(int focusDirection) {
        View viewFindNextFocusFromRect;
        if (FocusDirection.m5598equalsimpl0(focusDirection, FocusDirection.INSTANCE.m5603getEnterdhqQ8s()) || FocusDirection.m5598equalsimpl0(focusDirection, FocusDirection.INSTANCE.m5604getExitdhqQ8s())) {
            return false;
        }
        Integer numM5610toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m5610toAndroidFocusDirection3ESFkO8(focusDirection);
        if (numM5610toAndroidFocusDirection3ESFkO8 != null) {
            int iIntValue = numM5610toAndroidFocusDirection3ESFkO8.intValue();
    ...
    private final boolean m7881moveFocusInChildrenViewFocusFix3ESFkO8(int focusDirection) {
        AndroidViewsHandler androidViewsHandler;
        if (FocusDirection.m5598equalsimpl0(focusDirection, FocusDirection.INSTANCE.m5603getEnterdhqQ8s()) || FocusDirection.m5598equalsimpl0(focusDirection, FocusDirection.INSTANCE.m5604getExitdhqQ8s()) || !hasFocus() || (androidViewsHandler = this._androidViewsHandler) == null) {
            return false;
        }
        Integer numM5610toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m5610toAndroidFocusDirection3ESFkO8(focusDirection);
        if (numM5610toAndroidFocusDirection3ESFkO8 != null) {
            ...
            if (!FocusOwnerImplKt.m5625is1dFocusSearch3ESFkO8(focusDirection) || !androidViewsHandler.hasFocus()) {
                Rect embeddedViewFocusRect = getEmbeddedViewFocusRect();
    ...
    private final boolean m7879moveFocusInChildrenBypassUnfocusableComposeView3ESFkO8(int focusDirection) {
        if (FocusDirection.m5598equalsimpl0(focusDirection, FocusDirection.INSTANCE.m5603getEnterdhqQ8s()) || FocusDirection.m5598equalsimpl0(focusDirection, FocusDirection.INSTANCE.m5604getExitdhqQ8s())) {
            return false;
        }
        Integer numM5610toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m5610toAndroidFocusDirection3ESFkO8(focusDirection);
        if (numM5610toAndroidFocusDirection3ESFkO8 != null) {
            int iIntValue = numM5610toAndroidFocusDirection3ESFkO8.intValue();
            View viewM7876findNextViewInEmbeddedView3ESFkO8 = m7876findNextViewInEmbeddedView3ESFkO8(focusDirection);
            if (viewM7876findNextViewInEmbeddedView3ESFkO8 != null) {
                return FocusInteropUtils_androidKt.requestInteropFocus(viewM7876findNextViewInEmbeddedView3ESFkO8, Integer.valueOf(iIntValue), null);
            }
            return false;
        }
        InlineClassHelperKt.throwIllegalStateExceptionForNullCheck("Invalid focus direction");
    ...
    public boolean mo5664moveFocusInChildren3ESFkO8(int focusDirection) {
        if (ComposeUiFlags.isViewFocusFixEnabled) {
            return m7881moveFocusInChildrenViewFocusFix3ESFkO8(focusDirection);
        }
        if (ComposeUiFlags.isBypassUnfocusableComposeViewEnabled) {
            return m7879moveFocusInChildrenBypassUnfocusableComposeView3ESFkO8(focusDirection);
        }
        return m7880moveFocusInChildrenCurrent3ESFkO8(focusDirection);
    }

    /* JADX INFO: renamed from: findNextViewInEmbeddedView-3ESFkO8, reason: not valid java name */
    private final View m7876findNextViewInEmbeddedView3ESFkO8(int focusDirection) {
    ...
    public LocaleList getLocaleList() {
        return (LocaleList) this.localeList.getValue();
    }
    ...
    */
    public java.lang.Object textInputSession(kotlin.jvm.functions.Function2<? super androidx.compose.ui.platform.PlatformTextInputSessionScope, ? super kotlin.coroutines.Continuation<?>, ? extends java.lang.Object> r5, kotlin.coroutines.Continuation<?> r6) {
        /*
            r4 = this;
            boolean r0 = r6 instanceof androidx.compose.ui.platform.AndroidComposeView.C04521
            if (r0 == 0) goto L14
            r0 = r6
            androidx.compose.ui.platform.AndroidComposeView$textInputSession$1 r0 = (androidx.compose.ui.platform.AndroidComposeView.C04521) r0
            int r1 = r0.label
        ...
        L32:
            kotlin.ResultKt.throwOnFailure(r6)
            java.util.concurrent.atomic.AtomicReference<androidx.compose.ui.SessionMutex$Session<androidx.compose.ui.platform.AndroidPlatformTextInputSession>> r6 = r4.textInputSessionMutex
            androidx.compose.ui.platform.AndroidComposeView$textInputSession$2 r2 = new androidx.compose.ui.platform.AndroidComposeView$textInputSession$2
            r2.<init>()
            kotlin.jvm.functions.Function1 r2 = (kotlin.jvm.functions.Function1) r2
            r0.label = r3
            java.lang.Object r5 = androidx.compose.ui.SessionMutex.m5412withSessionCancellingPreviousimpl(r6, r2, r5, r0)
            if (r5 != r1) goto L47
            return r1
        L47:
    ...
    public static final void sendHoverExitEvent$lambda$0(AndroidComposeView androidComposeView) {
        ...
        androidComposeView.m7883sendMotionEvent8iAsVTc(motionEvent);
    }
    ...
    public void getFocusedRect(android.graphics.Rect rect) {
        ...
        if (!Intrinsics.areEqual((Object) getFocusOwner().mo5617focusSearchULY8qGw(FocusDirection.INSTANCE.m5602getDowndhqQ8s(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.getFocusedRect.1
            @Override // kotlin.jvm.functions.Function1
    ...
    public View focusSearch(View focused, int direction) {
        ...
        int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m5602getDowndhqQ8s();
        final Ref.ObjectRef objectRef = new Ref.ObjectRef();
        if (getFocusOwner().mo5617focusSearchULY8qGw(value, rectCalculateFocusRectRelativeTo, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$focusSearch$searchResult$1
        ...
        if (objectRef.element == 0) {
            ...
            if (FocusOwnerImplKt.m5625is1dFocusSearch3ESFkO8(value)) {
                if (ComposeUiFlags.isBypassUnfocusableComposeViewEnabled) {
                    return this;
                }
                return super.focusSearch(focused, direction);
            ...
            AndroidComposeView androidComposeView = this;
            if (TwoDimensionalFocusSearchKt.m5671isBetterCandidateI7lrPNg(FocusTraversalKt.focusRect((FocusTargetNode) objectRef.element), FocusInteropUtils_androidKt.calculateFocusRectRelativeTo(viewFindNextFocus, androidComposeView), rectCalculateFocusRectRelativeTo, value)) {
    ...
    public final boolean requestFocusCurrent(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(direction);
        final int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m5603getEnterdhqQ8s();
        return Intrinsics.areEqual((Object) getFocusOwner().mo5617focusSearchULY8qGw(value, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.requestFocusCurrent.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Boolean invoke(FocusTargetNode focusTargetNode) {
                return Boolean.valueOf(focusTargetNode.mo5632requestFocus3ESFkO8(value));
            }
        }), (Object) true);
    }
    ...
    public final boolean requestFocusViewFocusFix(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(direction);
        final int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m5603getEnterdhqQ8s();
        if (hasFocus() && mo5664moveFocusInChildren3ESFkO8(value)) {
            return true;
        }
        final Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        Boolean boolMo5617focusSearchULY8qGw = getFocusOwner().mo5617focusSearchULY8qGw(value, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocusViewFocusFix$focusSearchResult$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        if (boolMo5617focusSearchULY8qGw.booleanValue()) {
            return true;
        }
        if (booleanRef.element) {
            return false;
        }
        if ((previouslyFocusedRect != null && !hasFocus() && Intrinsics.areEqual((Object) getFocusOwner().mo5617focusSearchULY8qGw(value, null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocusViewFocusFix$altFocus$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public final boolean requestFocusBypassUnfocusableComposeView(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        FocusDirection focusDirection = FocusInteropUtils_androidKt.toFocusDirection(direction);
        final int value = focusDirection != null ? focusDirection.getValue() : FocusDirection.INSTANCE.m5603getEnterdhqQ8s();
        if (Intrinsics.areEqual((Object) getFocusOwner().mo5617focusSearchULY8qGw(value, previouslyFocusedRect != null ? RectHelper_androidKt.toComposeRect(previouslyFocusedRect) : null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocusBypassUnfocusableComposeView$requestFocusWithPrevRect$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        }), (Object) true) || Intrinsics.areEqual((Object) getFocusOwner().mo5617focusSearchULY8qGw(value, null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$requestFocusBypassUnfocusableComposeView$requestFocusWithoutPrevRect$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        if (hasFocus() && FocusOwnerImplKt.m5625is1dFocusSearch3ESFkO8(value)) {
            return getFocusOwner().mo5620resetFocus3ESFkO8(value);
        }
        return false;
    }
    ...
    public boolean mo5665requestOwnerFocus7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect) {
        Integer numM5610toAndroidFocusDirection3ESFkO8;
        if (ComposeUiFlags.isBypassUnfocusableComposeViewEnabled) {
            if (isFocused()) {
                return true;
            }
        ...
        return super.requestFocus((focusDirection == null || (numM5610toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m5610toAndroidFocusDirection3ESFkO8(focusDirection.getValue())) == null) ? 130 : numM5610toAndroidFocusDirection3ESFkO8.intValue(), previouslyFocusedRect != null ? RectHelper_androidKt.toAndroidRect(previouslyFocusedRect) : null);
    }
        ...
        if (current != null) {
            ...
            while (layoutNodeRequireLayoutNode2 != null) {
                if ((layoutNodeRequireLayoutNode2.getNodes().getHead().getAggregateChildKindSet() & iM7763constructorimpl2) != 0) {
                    while (node2 != null) {
                        if ((node2.getKindSet() & iM7763constructorimpl2) != 0) {
                            ...
                            while (nodePop2 != null) {
                                if (nodePop2 instanceof IndirectPointerInputModifierNode) {
                                    ...
                                    mutableScatterSetMutableScatterSetOf.add(nodePop2);
                                    z = false;
                                } else {
                                    z = true;
                                }
                                if (z) {
                                    if (((nodePop2.getKindSet() & iM7763constructorimpl2) != 0) && (nodePop2 instanceof DelegatingNode)) {
                                        int i2 = 0;
                                        for (Modifier.Node delegate$ui2 = ((DelegatingNode) nodePop2).getDelegate(); delegate$ui2 != null; delegate$ui2 = delegate$ui2.getChild()) {
                                            if ((delegate$ui2.getKindSet() & iM7763constructorimpl2) != 0) {
                                                i2++;
                                                if (i2 == 1) {
    ...
    public boolean mo7831sendKeyEventZmokQxo(KeyEvent keyEvent) {
        return getFocusOwner().mo5615dispatchInterceptedSoftKeyboardEventZmokQxo(keyEvent) || FocusOwner.m5613dispatchKeyEventYhN2O0w$default(getFocusOwner(), keyEvent, null, 2, null);
    }
    ...
    public boolean dispatchKeyEvent(final KeyEvent event) {
        if (isFocused()) {
            if (AndroidComposeUiFlags.isSharedWindowInfoEnabled) {
                getComposeViewContext().getWindowInfo().m7960setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m7376constructorimpl(event.getMetaState()));
            } else {
                this._windowInfo.m7960setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m7376constructorimpl(event.getMetaState()));
            }
            return FocusOwner.m5613dispatchKeyEventYhN2O0w$default(getFocusOwner(), androidx.compose.ui.input.key.KeyEvent.m7128constructorimpl(event), null, 2, null) || super.dispatchKeyEvent(event);
        }
        return getFocusOwner().mo5616dispatchKeyEventYhN2O0w(androidx.compose.ui.input.key.KeyEvent.m7128constructorimpl(event), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.dispatchKeyEvent.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    public boolean dispatchKeyEventPreIme(KeyEvent event) {
        return (isFocused() && getFocusOwner().mo5615dispatchInterceptedSoftKeyboardEventZmokQxo(androidx.compose.ui.input.key.KeyEvent.m7128constructorimpl(event))) || super.dispatchKeyEventPreIme(event);
    }
    ...
    public final boolean m7884startDrag12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void addExtraDataToAccessibilityNodeInfoHelper(int virtualViewId, AccessibilityNodeInfo info2, String extraDataKey) {
        int orDefault;
    ...
    public void mo7830measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Trace.beginSection("AndroidOwner:measureAndLayout");
        try {
            this.measureAndLayoutDelegate.m7710measureAndLayout0kLqBqw(layoutNode, constraints);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        try {
            ...
            long jM7875convertMeasureSpecI7RO_PI = m7875convertMeasureSpecI7RO_PI(widthMeasureSpec);
            int iM12567constructorimpl = (int) ULong.m12567constructorimpl(jM7875convertMeasureSpecI7RO_PI >>> 32);
            int iM12567constructorimpl2 = (int) ULong.m12567constructorimpl(jM7875convertMeasureSpecI7RO_PI & 4294967295L);
            long jM7875convertMeasureSpecI7RO_PI2 = m7875convertMeasureSpecI7RO_PI(heightMeasureSpec);
            long jM8791fitPrioritizingHeightZbe2FdA = Constraints.INSTANCE.m8791fitPrioritizingHeightZbe2FdA(iM12567constructorimpl, iM12567constructorimpl2, (int) ULong.m12567constructorimpl(jM7875convertMeasureSpecI7RO_PI2 >>> 32), (int) ULong.m12567constructorimpl(4294967295L & jM7875convertMeasureSpecI7RO_PI2));
            Constraints constraints = this.onMeasureConstraints;
            boolean zM8776equalsimpl0 = false;
            if (constraints == null) {
                this.onMeasureConstraints = Constraints.m8770boximpl(jM8791fitPrioritizingHeightZbe2FdA);
                this.wasMeasuredWithMultipleConstraints = false;
            } else {
                if (constraints != null) {
                    zM8776equalsimpl0 = Constraints.m8776equalsimpl0(constraints.getValue(), jM8791fitPrioritizingHeightZbe2FdA);
                }
                if (!zM8776equalsimpl0) {
                    this.wasMeasuredWithMultipleConstraints = true;
                }
            }
            this.measureAndLayoutDelegate.m7711updateRootConstraintsBRTryo0(jM8791fitPrioritizingHeightZbe2FdA);
    ...
    private final int m7873component1VKZWuLQ(long j) {
        return (int) ULong.m12567constructorimpl(j >>> 32);
    }

    /* JADX INFO: renamed from: component2-VKZWuLQ, reason: not valid java name */
    private final int m7874component2VKZWuLQ(long j) {
        return (int) ULong.m12567constructorimpl(j & 4294967295L);
    }

    /* JADX INFO: renamed from: pack-ZIaKswc, reason: not valid java name */
    private final long m7882packZIaKswc(int a2, int b2) {
        return ULong.m12567constructorimpl(ULong.m12567constructorimpl(b2) | ULong.m12567constructorimpl(ULong.m12567constructorimpl(a2) << 32));
    }

    /* JADX INFO: renamed from: convertMeasureSpec-I7RO_PI, reason: not valid java name */
    private final long m7875convertMeasureSpecI7RO_PI(int measureSpec) {
        int mode = View.MeasureSpec.getMode(measureSpec);
        int size = View.MeasureSpec.getSize(measureSpec);
        if (mode == Integer.MIN_VALUE) {
            return m7882packZIaKswc(0, size);
        }
        if (mode == 0) {
            return m7882packZIaKswc(0, Integer.MAX_VALUE);
        }
        if (mode == 1073741824) {
            return m7882packZIaKswc(size, size);
        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b2) {
        ...
        try {
            ...
            if (this._androidViewsHandler != null) {
                ...
                getAndroidViewsHandler$ui().layout(0, 0, r - l, b2 - t);
                Unit unit = Unit.INSTANCE;
                Trace.endSection();
            }
            Unit unit2 = Unit.INSTANCE;
    ...
    private final void updatePositionCacheAndDispatch() {
        ...
        int iM8959getYimpl = IntOffset.m8959getYimpl(j);
        int[] iArr = this.tmpPositionArray;
        boolean z = false;
        z = false;
        z = false;
        int i = iArr[0];
        if (iM8958getXimpl != i || iM8959getYimpl != iArr[1] || this.lastMatrixRecalculationAnimationTime < 0) {
            this.globalPosition = IntOffset.m8952constructorimpl((((long) i) << 32) | (((long) iArr[1]) & 4294967295L));
            if (iM8958getXimpl != Integer.MAX_VALUE && iM8959getYimpl != Integer.MAX_VALUE) {
        ...
        getRectManager().m8037updateOffsetsgTq6Wqs(this.globalPosition, IntOffsetKt.m8975roundk4lQ0M(this.windowPosition), this.viewToWindowMatrix, rootView.getWidth(), rootView.getHeight());
    ...
    protected void onAttachedToWindow() {
        ...
        if (AndroidComposeUiFlags.isSharedWindowInfoEnabled) {
            ...
            lifecycle2 = getComposeViewContext().getLifecycleOwner().getLifecycle();
        } else {
            AndroidComposeView androidComposeView = this;
        ...
        this._inputModeManager.m6790setInputModeiuPiT84(isInTouchMode() ? InputMode.INSTANCE.m6786getTouchaOaMEAU() : InputMode.INSTANCE.m6785getKeyboardaOaMEAU());
    ...
    protected void onDetachedFromWindow() {
        ...
        if (AndroidComposeUiFlags.isSharedWindowInfoEnabled) {
            lifecycle = getComposeViewContext().getLifecycleOwner().getLifecycle();
        } else {
    ...
    public boolean dispatchGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getActionMasked() == 8) {
            ...
            return (m7878handleMotionEvent8iAsVTc(motionEvent) & 4) != 0;
        }
        if (motionEvent.isFromSource(2097152)) {
            AndroidIndirectPointerEvent androidIndirectPointerEventM7222convertToIndirectPointerEventk92h6UU$ui = this.motionEventAdapter.m7222convertToIndirectPointerEventk92h6UU$ui(motionEvent, this.primaryDirectionalMotionAxisOverride);
            if (androidIndirectPointerEventM7222convertToIndirectPointerEventk92h6UU$ui != null) {
                if (handleIndirectPointerEvent(androidIndirectPointerEventM7222convertToIndirectPointerEventk92h6UU$ui)) {
                    return true;
                }
            } else {
                getFocusOwner().dispatchIndirectPointerCancel();
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        int iM7878handleMotionEvent8iAsVTc = m7878handleMotionEvent8iAsVTc(motionEvent);
        if ((iM7878handleMotionEvent8iAsVTc & 2) != 0) {
        ...
        if (z && z2) {
            ...
            if (view == null || (objM7902boximpl = view.getTag(R.id.auto_clear_focus_behavior_tag)) == null) {
                objM7902boximpl = AutoClearFocusBehavior.m7902boximpl(AutoClearFocusBehavior.INSTANCE.m7910getDefault4UtRPd4());
            }
            if (Intrinsics.areEqual(objM7902boximpl, AutoClearFocusBehavior.m7902boximpl(AutoClearFocusBehavior.INSTANCE.m7909getCursorBased4UtRPd4())) && (activeFocusTargetNode = getFocusOwner().getActiveFocusTargetNode()) != null) {
                if (!LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.requireLayoutCoordinates(activeFocusTargetNode)).m5749containsk4lQ0M(Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(motionEvent.getX())) << 32) | (((long) Float.floatToRawIntBits(motionEvent.getY())) & 4294967295L)))) {
                    FocusManager.clearFocus$default(getFocusOwner(), false, 1, null);
                }
            }
        }
        return (iM7878handleMotionEvent8iAsVTc & 1) != 0;
    }

    private final boolean handleRotaryEvent(final MotionEvent event) {
        android.view.ViewConfiguration viewConfiguration = android.view.ViewConfiguration.get(getContext());
        float f2 = -event.getAxisValue(26);
        return getFocusOwner().dispatchRotaryEvent(new RotaryScrollEvent(ViewConfigurationCompat.getScaledVerticalScrollFactor(viewConfiguration, getContext()) * f2, f2 * ViewConfigurationCompat.getScaledHorizontalScrollFactor(viewConfiguration, getContext()), event.getEventTime(), event.getDeviceId()), new Function0<Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView.handleRotaryEvent.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private final int m7878handleMotionEvent8iAsVTc(android.view.MotionEvent r17) {
        /*
            Method dump skipped, instruction units count: 299
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.platform.AndroidComposeView.m7878handleMotionEvent8iAsVTc(android.view.MotionEvent):int");
    }
    ...
    private final int m7883sendMotionEvent8iAsVTc(MotionEvent motionEvent) {
        PointerInputEventData pointerInputEventData;
        if (this.keyboardModifiersRequireUpdate) {
            this.keyboardModifiersRequireUpdate = false;
            if (AndroidComposeUiFlags.isSharedWindowInfoEnabled) {
                getComposeViewContext().getWindowInfo().m7960setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m7376constructorimpl(motionEvent.getMetaState()));
            } else {
                this._windowInfo.m7960setKeyboardModifiers5xRPYO0(PointerKeyboardModifiers.m7376constructorimpl(motionEvent.getMetaState()));
            }
        }
        AndroidComposeView androidComposeView = this;
        ...
        if (pointerInputEventConvertToPointerInputEvent$ui != null) {
            ...
            if (pointerInputEventData2 != null) {
                this.lastDownPointerPosition = pointerInputEventData2.m7330getPositionF1C5BW0();
            }
            int iM7335processBIzXfog = this.pointerInputEventProcessor.m7335processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui, androidComposeView, isInBounds(motionEvent));
            pointerInputEventConvertToPointerInputEvent$ui.setMotionEvent(null);
            if ((actionMasked != 0 && actionMasked != 5) || (iM7335processBIzXfog & 1) != 0) {
                return iM7335processBIzXfog;
            }
    ...
    public final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i3 < pointerCount) {
            ...
            long jMo7394localToScreenMKHz9U = mo7394localToScreenMKHz9U(Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(pointerCoords.y)) & 4294967295L) | (((long) Float.floatToRawIntBits(f2)) << 32)));
            pointerCoords.x = Float.intBitsToFloat((int) (jMo7394localToScreenMKHz9U >> 32));
            pointerCoords.y = Float.intBitsToFloat((int) (jMo7394localToScreenMKHz9U & 4294967295L));
            i3++;
        }
        ...
        this.pointerInputEventProcessor.m7335processBIzXfog(pointerInputEventConvertToPointerInputEvent$ui, androidComposeView, true);
        motionEventObtain.recycle();
    }

    @Override // android.view.View
    public boolean canScrollHorizontally(int direction) {
        return this.composeAccessibilityDelegate.m7896canScroll0AR0LA0$ui(false, direction, this.lastDownPointerPosition);
    }

    @Override // android.view.View
    public boolean canScrollVertically(int direction) {
        return this.composeAccessibilityDelegate.m7896canScroll0AR0LA0$ui(true, direction, this.lastDownPointerPosition);
    }
    ...
    public long mo7394localToScreenMKHz9U(long localPosition) {
        recalculateWindowPosition();
        long jM6220mapMKHz9U = Matrix.m6220mapMKHz9U(this.viewToWindowMatrix, localPosition);
        float fIntBitsToFloat = Float.intBitsToFloat((int) (jM6220mapMKHz9U >> 32)) + Float.intBitsToFloat((int) (this.windowPosition >> 32));
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (jM6220mapMKHz9U & 4294967295L)) + Float.intBitsToFloat((int) (this.windowPosition & 4294967295L)))) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat) << 32));
    }

    @Override // androidx.compose.ui.input.pointer.MatrixPositionCalculator
    /* JADX INFO: renamed from: localToScreen-58bKbWc */
    public void mo7218localToScreen58bKbWc(float[] localTransform) {
        recalculateWindowPosition();
        Matrix.m6233timesAssign58bKbWc(localTransform, this.viewToWindowMatrix);
        AndroidComposeView_androidKt.m7901preTranslatecG2Xzmc(localTransform, Float.intBitsToFloat((int) (this.windowPosition >> 32)), Float.intBitsToFloat((int) (this.windowPosition & 4294967295L)), this.tmpMatrix);
    }

    @Override // androidx.compose.ui.input.pointer.PositionCalculator
    /* JADX INFO: renamed from: screenToLocal-MK-Hz9U */
    public long mo7395screenToLocalMKHz9U(long positionOnScreen) {
        recalculateWindowPosition();
        ...
        return Matrix.m6220mapMKHz9U(this.windowToViewMatrix, Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(fIntBitsToFloat)) << 32) | (4294967295L & ((long) Float.floatToRawIntBits(fIntBitsToFloat2)))));
    }
    ...
    private final void recalculateWindowPosition() {
        ...
        if (jCurrentAnimationTimeMillis != this.lastMatrixRecalculationAnimationTime) {
            ...
            this.windowPosition = Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(f2 - this.tmpPositionArray[0])) << 32) | (((long) Float.floatToRawIntBits(f3 - r0[1])) & 4294967295L));
        }
    }
    ...
    private final void recalculateWindowPosition(MotionEvent motionEvent) {
        ...
        float x = motionEvent.getX();
        long jM6220mapMKHz9U = Matrix.m6220mapMKHz9U(fArr, Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(motionEvent.getY())) & 4294967295L) | (Float.floatToRawIntBits(x) << 32)));
        this.windowPosition = Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(motionEvent.getRawX() - Float.intBitsToFloat((int) (jM6220mapMKHz9U >> 32)))) << 32) | (((long) Float.floatToRawIntBits(motionEvent.getRawY() - Float.intBitsToFloat((int) (jM6220mapMKHz9U & 4294967295L)))) & 4294967295L));
    }

    private final void recalculateWindowViewTransforms() {
        this.matrixToWindow.mo7912calculateMatrixToWindowEL8BTi8(this, this.viewToWindowMatrix);
        InvertMatrixKt.m7951invertToJiSxe2E(this.viewToWindowMatrix, this.windowToViewMatrix);
    }
    ...
    public boolean onCheckIsTextEditor() {
        AndroidPlatformTextInputSession androidPlatformTextInputSession = (AndroidPlatformTextInputSession) SessionMutex.m5409getCurrentSessionimpl(this.textInputSessionMutex);
    ...
    public long mo7827calculateLocalPositionMKHz9U(long positionInWindow) {
        recalculateWindowPosition();
        return Matrix.m6220mapMKHz9U(this.windowToViewMatrix, positionInWindow);
    }

    @Override // androidx.compose.ui.node.Owner
    /* JADX INFO: renamed from: calculatePositionInWindow-MK-Hz9U */
    public long mo7828calculatePositionInWindowMKHz9U(long localPosition) {
        recalculateWindowPosition();
        return Matrix.m6220mapMKHz9U(this.viewToWindowMatrix, localPosition);
    }
    ...
    private final void updateConfiguration(Configuration newConfig) {
        ...
        if (AndroidComposeUiFlags.isSharedFontEnabled || getFontWeightAdjustmentCompat(configuration) == getFontWeightAdjustmentCompat(newConfig)) {
            return;
        }
    ...
    public boolean dispatchHoverEvent(MotionEvent event) {
        ...
        if (!isBadMotionEvent(event) && isAttachedToWindow()) {
            ...
            if ((m7878handleMotionEvent8iAsVTc(event) & 1) != 0) {
                return true;
            }
        }
        return false;
    ...
    public android.view.PointerIcon onResolvePointerIcon(MotionEvent event, int pointerIndex) {
        ...
        if (!event.isFromSource(8194) && event.isFromSource(InputDeviceCompat.SOURCE_STYLUS) && ((toolType == 2 || toolType == 4) && (stylusHoverIcon = getPointerIconService().getCurrentStylusHoverIcon()) != null)) {
    ...
    public void mo7829dispatchOnScrollChangedk4lQ0M(long delta) {
    ...
    final class RootModifierNode extends Modifier.Node implements BringIntoViewModifierNode, SemanticsModifierNode, RotaryInputModifierNode, KeyInputModifierNode, LayoutModifierNode, TraversableNode, WindowInsetsRulerProvider {
        ...
        public MeasureResult mo72measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            ...
            return MeasureScope.layout$default(measureScope, placeableMo7445measureBRTryo0.getWidth(), placeableMo7445measureBRTryo0.getHeight(), null, this.rulerLambda, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.platform.AndroidComposeView$RootModifierNode$measure$1
                {
                    super(1);
                }
        ...
        public Object bringIntoView(LayoutCoordinates layoutCoordinates, Function0<Rect> function0, Continuation<? super Unit> continuation) {
            ...
            Rect rectM5760translatek4lQ0M = rectInvoke != null ? rectInvoke.m5760translatek4lQ0M(jPositionInRoot) : null;
            if (rectM5760translatek4lQ0M != null) {
                AndroidComposeView.this.requestRectangleOnScreen(RectHelper_androidKt.toAndroidRect(rectM5760translatek4lQ0M), false);
            }
            return Unit.INSTANCE;
        }
        ...
        public boolean mo279onKeyEventZmokQxo(KeyEvent event) {
            Boolean boolMo5617focusSearchULY8qGw;
            final FocusDirection focusDirectionM5611toFocusDirectionZmokQxo = FocusInteropUtils_androidKt.m5611toFocusDirectionZmokQxo(event);
            if (focusDirectionM5611toFocusDirectionZmokQxo == null || !KeyEventType.m7137equalsimpl0(KeyEvent_androidKt.m7145getTypeZmokQxo(event), KeyEventType.INSTANCE.m7141getKeyDownCS__XNY())) {
                return false;
            }
            if (ComposeUiFlags.isBypassUnfocusableComposeViewEnabled) {
                FocusTargetNode activeFocusTargetNode = AndroidComposeView.this.getFocusOwner().getActiveFocusTargetNode();
                if (activeFocusTargetNode != null && activeFocusTargetNode.getIsInteropViewHost() && AndroidComposeView.this.mo5664moveFocusInChildren3ESFkO8(focusDirectionM5611toFocusDirectionZmokQxo.getValue())) {
                    return true;
                }
                Boolean boolMo5617focusSearchULY8qGw2 = AndroidComposeView.this.getFocusOwner().mo5617focusSearchULY8qGw(focusDirectionM5611toFocusDirectionZmokQxo.getValue(), AndroidComposeView.this.getEmbeddedViewFocusRect(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$RootModifierNode$onKeyEvent$focusWasMovedOrCancelled$1
                    {
                        super(1);
                    }
                    ...
                    @Override // kotlin.jvm.functions.Function1
                    public final Boolean invoke(FocusTargetNode focusTargetNode) {
                        return Boolean.valueOf(focusTargetNode.mo5632requestFocus3ESFkO8(focusDirectionM5611toFocusDirectionZmokQxo.getValue()));
                    }
                });
                if (boolMo5617focusSearchULY8qGw2 != null ? boolMo5617focusSearchULY8qGw2.booleanValue() : true) {
                    return true;
                }
                if (FocusOwnerImplKt.m5625is1dFocusSearch3ESFkO8(focusDirectionM5611toFocusDirectionZmokQxo.getValue())) {
                    Integer numM5610toAndroidFocusDirection3ESFkO8 = FocusInteropUtils_androidKt.m5610toAndroidFocusDirection3ESFkO8(focusDirectionM5611toFocusDirectionZmokQxo.getValue());
                    int iIntValue = numM5610toAndroidFocusDirection3ESFkO8 != null ? numM5610toAndroidFocusDirection3ESFkO8.intValue() : 2;
                    FocusFinder focusFinder = FocusFinder.getInstance();
                    ...
                    if (viewFindNextFocus == null || Intrinsics.areEqual(viewFindNextFocus, AndroidComposeView.this)) {
                        return AndroidComposeView.this.getFocusOwner().mo5620resetFocus3ESFkO8(focusDirectionM5611toFocusDirectionZmokQxo.getValue());
                    }
                }
                return false;
            }
            Integer numM5610toAndroidFocusDirection3ESFkO82 = FocusInteropUtils_androidKt.m5610toAndroidFocusDirection3ESFkO8(focusDirectionM5611toFocusDirectionZmokQxo.getValue());
            if (ComposeUiFlags.isViewFocusFixEnabled && AndroidComposeView.this.hasFocus() && numM5610toAndroidFocusDirection3ESFkO82 != null && AndroidComposeView.this.mo5664moveFocusInChildren3ESFkO8(focusDirectionM5611toFocusDirectionZmokQxo.getValue())) {
                return true;
            }
            Rect embeddedViewFocusRect = AndroidComposeView.this.getEmbeddedViewFocusRect();
            Boolean boolMo5617focusSearchULY8qGw3 = AndroidComposeView.this.getFocusOwner().mo5617focusSearchULY8qGw(focusDirectionM5611toFocusDirectionZmokQxo.getValue(), embeddedViewFocusRect, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$RootModifierNode$onKeyEvent$focusWasMovedOrCancelled$2
                {
                    super(1);
                }
            ...
            if (boolMo5617focusSearchULY8qGw3 != null ? boolMo5617focusSearchULY8qGw3.booleanValue() : true) {
                return true;
            }
            if (!FocusOwnerImplKt.m5625is1dFocusSearch3ESFkO8(focusDirectionM5611toFocusDirectionZmokQxo.getValue())) {
                return false;
            }
            if (numM5610toAndroidFocusDirection3ESFkO82 != null) {
                View viewFindNextNonChildView = AndroidComposeView.this.findNextNonChildView(numM5610toAndroidFocusDirection3ESFkO82.intValue());
                ...
                if (viewFindNextNonChildView != null) {
                    ...
                    if (androidRect != null) {
                        ...
                        if (FocusInteropUtils_androidKt.requestInteropFocus(viewFindNextNonChildView, numM5610toAndroidFocusDirection3ESFkO82, androidRect)) {
                            return true;
                        }
                    } else {
            ...
            if (AndroidComposeView.this.getFocusOwner().mo5614clearFocusI7lrPNg(false, true, false, focusDirectionM5611toFocusDirectionZmokQxo.getValue()) && (boolMo5617focusSearchULY8qGw = AndroidComposeView.this.getFocusOwner().mo5617focusSearchULY8qGw(focusDirectionM5611toFocusDirectionZmokQxo.getValue(), null, new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.platform.AndroidComposeView$RootModifierNode$onKeyEvent$1
                {
                    super(1);
                }
