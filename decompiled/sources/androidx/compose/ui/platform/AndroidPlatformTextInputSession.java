...
public final class AndroidPlatformTextInputSession implements PlatformTextInputSessionScope, CoroutineScope {
    ...
    private final AtomicReference<SessionMutex.Session<InputMethodSession>> methodSessionMutex = SessionMutex.m5405constructorimpl();
    ...
    public final boolean isReadyForConnection() {
        InputMethodSession inputMethodSession = (InputMethodSession) SessionMutex.m5409getCurrentSessionimpl(this.methodSessionMutex);
    ...
    */
    public java.lang.Object startInputMethod(final androidx.compose.ui.platform.PlatformTextInputMethodRequest r6, kotlin.coroutines.Continuation<?> r7) {
        ...
        L32:
            kotlin.ResultKt.throwOnFailure(r7)
            java.util.concurrent.atomic.AtomicReference<androidx.compose.ui.SessionMutex$Session<androidx.compose.ui.platform.InputMethodSession>> r7 = r5.methodSessionMutex
            ...
            r0.label = r3
            java.lang.Object r6 = androidx.compose.ui.SessionMutex.m5412withSessionCancellingPreviousimpl(r7, r2, r6, r0)
            if (r6 != r1) goto L4f
            return r1
        L4f:
    ...
    @DebugMetadata(c = "androidx.compose.ui.platform.AndroidPlatformTextInputSession$startInputMethod$3", f = "AndroidPlatformTextInputSession.android.kt", i = {0}, l = {ByteCode.INVOKESTATIC}, m = "invokeSuspend", n = {"methodSession"}, s = {"L$0"}, v = 1)
