...
public final class CompositionLocalsKt {
    ...
    private static final CompositionLocal<Locale> LocalLocale = CompositionLocalKt.compositionLocalWithComputedDefaultOf(new Function1<CompositionLocalAccessorScope, Locale>() { // from class: androidx.compose.ui.platform.CompositionLocalsKt$LocalLocale$1
        ...
        public final Locale invoke(CompositionLocalAccessorScope compositionLocalAccessorScope) {
            return (Locale) CollectionsKt.first((Iterable) compositionLocalAccessorScope.getCurrentValue(CompositionLocalsKt.getLocalLocaleList()));
        }
    });
    ...
    public static final void ProvideCommonCompositionLocals(final Owner owner, final UriHandler uriHandler, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(composerStartRestartGroup, "C(ProvideCommonCompositionLocals)N(owner,uriHandler,content)236@10049L1497:CompositionLocals.kt#itgzvw");
        if ((i & 6) == 0) {
