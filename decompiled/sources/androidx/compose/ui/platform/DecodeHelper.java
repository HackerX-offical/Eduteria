...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (bDecodeByte != 1) {
                if (bDecodeByte != 2) {
                    if (bDecodeByte != 3) {
                        if (bDecodeByte != 4) {
                            if (bDecodeByte != 5) {
                                        ...
                                        if (bDecodeByte != 8) {
                                            if (bDecodeByte != 9) {
                                                if (bDecodeByte != 10) {
                                                    ...
                                                    mutableSpanStyle.m7968setBackground8_81llA(m7921decodeColor0d7_KjU());
                                                }
                                            } else {
                                                if (dataAvailable() < 8) {
                                                    break;
                                            ...
                                            mutableSpanStyle.m7969setBaselineShift_isdbwI(BaselineShift.m8570boximpl(m7919decodeBaselineShifty9eOQZs()));
                                        }
                                    } else {
                                        if (dataAvailable() < 5) {
                                            break;
                                        }
                                        mutableSpanStyle.m7974setLetterSpacingR2X_6o(m7924decodeTextUnitXSAIIZE());
                                    }
                                } else {
                                ...
                                mutableSpanStyle.m7973setFontSynthesistDdu0R4(FontSynthesis.m8395boximpl(m7923decodeFontSynthesisGVVA2EU()));
                            }
                        } else {
                            if (dataAvailable() < 1) {
                                break;
                            }
                            mutableSpanStyle.m7972setFontStylemLjRB2g(FontStyle.m8384boximpl(m7922decodeFontStyle_LCdwA()));
                        }
                    } else {
                        if (dataAvailable() < 4) {
                            break;
                    ...
                    mutableSpanStyle.m7971setFontSizeR2X_6o(m7924decodeTextUnitXSAIIZE());
                }
            } else {
                if (dataAvailable() < 8) {
                    break;
                }
                mutableSpanStyle.m7970setColor8_81llA(m7921decodeColor0d7_KjU());
            }
        }
    ...
    public final long m7921decodeColor0d7_KjU() {
    ...
    public final long m7924decodeTextUnitXSAIIZE() {
        long jM9058getUnspecifiedUIouoOA;
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 1) {
            jM9058getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m9057getSpUIouoOA();
        } else if (bDecodeByte == 2) {
            jM9058getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m9056getEmUIouoOA();
        } else {
            jM9058getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m9058getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m9052equalsimpl0(jM9058getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m9058getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m9036TextUnitanM5pPY(decodeFloat(), jM9058getUnspecifiedUIouoOA);
    }
    ...
    public final int m7922decodeFontStyle_LCdwA() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
    ...
    public final int m7923decodeFontSynthesisGVVA2EU() {
        byte bDecodeByte = decodeByte();
        if (bDecodeByte == 0) {
            return FontSynthesis.INSTANCE.m8405getNoneGVVA2EU();
        }
        if (bDecodeByte == 1) {
            return FontSynthesis.INSTANCE.m8404getAllGVVA2EU();
        }
        if (bDecodeByte == 3) {
            return FontSynthesis.INSTANCE.m8406getStyleGVVA2EU();
        }
        if (bDecodeByte == 2) {
            return FontSynthesis.INSTANCE.m8407getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m8405getNoneGVVA2EU();
    }

    /* JADX INFO: renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m7919decodeBaselineShifty9eOQZs() {
        return BaselineShift.m8571constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        long jM7921decodeColor0d7_KjU = m7921decodeColor0d7_KjU();
        float fDecodeFloat = decodeFloat();
        return new Shadow(jM7921decodeColor0d7_KjU, Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(decodeFloat())) & 4294967295L) | (Float.floatToRawIntBits(fDecodeFloat) << 32)), decodeFloat(), null);
    }
    ...
    private final long m7920decodeULongsVKNKU() {
        return ULong.m12567constructorimpl(this.parcel.readLong());
    }
