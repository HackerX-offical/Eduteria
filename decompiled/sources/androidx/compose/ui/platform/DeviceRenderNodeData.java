...
public final /* data */ class DeviceRenderNodeData {
    ...
    public /* synthetic */ DeviceRenderNodeData(long j, int i, int i2, int i3, int i4, int i5, int i6, float f2, float f3, float f4, float f5, float f6, int i7, int i8, float f7, float f8, float f9, float f10, float f11, float f12, boolean z, boolean z2, float f13, RenderEffect renderEffect, int i9, ColorFilter colorFilter, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, i, i2, i3, i4, i5, i6, f2, f3, f4, f5, f6, i7, i8, f7, f8, f9, f10, f11, f12, z, z2, f13, renderEffect, i9, colorFilter, i10);
    }

    /* JADX INFO: renamed from: copy-qCc9W8c$default, reason: not valid java name */
    public static /* synthetic */ DeviceRenderNodeData m7933copyqCc9W8c$default(DeviceRenderNodeData deviceRenderNodeData, long j, int i, int i2, int i3, int i4, int i5, int i6, float f2, float f3, float f4, float f5, float f6, int i7, int i8, float f7, float f8, float f9, float f10, float f11, float f12, boolean z, boolean z2, float f13, RenderEffect renderEffect, int i9, ColorFilter colorFilter, int i10, int i11, Object obj) {
        int i12;
        ...
        return deviceRenderNodeData.m7936copyqCc9W8c(j3, i13, i14, i15, i16, i17, i18, f14, f15, f16, f17, f18, i19, i20, f19, f20, f21, f22, f23, f24, z3, z4, f25, renderEffect2, i21, colorFilter2, i12);
    }
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (((iHashCode + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + BlendMode.m5878hashCodeimpl(this.blendMode)) * 31;
        ColorFilter colorFilter = this.colorFilter;
        return ((iHashCode2 + (colorFilter != null ? colorFilter.hashCode() : 0)) * 31) + CompositingStrategy.m6056hashCodeimpl(this.compositingStrategy);
    }
    ...
    public String toString() {
        ...
        sb.append(", renderEffect=").append(this.renderEffect).append(", blendMode=").append((Object) BlendMode.m5879toStringimpl(this.blendMode)).append(", colorFilter=").append(this.colorFilter).append(", compositingStrategy=").append((Object) CompositingStrategy.m6057toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }

    private DeviceRenderNodeData(long j, int i, int i2, int i3, int i4, int i5, int i6, float f2, float f3, float f4, float f5, float f6, int i7, int i8, float f7, float f8, float f9, float f10, float f11, float f12, boolean z, boolean z2, float f13, RenderEffect renderEffect, int i9, ColorFilter colorFilter, int i10) {
        this.uniqueId = j;
        this.left = i;
        this.top = i2;
        this.right = i3;
    ...
    public final int m7937getBlendMode0nO6VwU() {
        return this.blendMode;
    }

    /* JADX INFO: renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public final void m7939setBlendModes9anfk8(int i) {
        this.blendMode = i;
    }
    ...
    public final int m7938getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* JADX INFO: renamed from: setCompositingStrategy-aDBOjCE, reason: not valid java name */
    public final void m7940setCompositingStrategyaDBOjCE(int i) {
