...
public final class EncodeHelper {
    ...
    public final void encode(SpanStyle spanStyle) {
        ...
        if (fontStyle != null) {
            ...
            encode((byte) 4);
            m7946encodenzbMABs(iM8390unboximpl);
        }
        FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
        if (fontSynthesis != null) {
            int iM8403unboximpl = fontSynthesis.m8403unboximpl();
            encode((byte) 5);
            m7943encode6p3vJLY(iM8403unboximpl);
        }
        ...
        if (!TextUnit.m9021equalsimpl0(spanStyle.getLetterSpacing(), TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE())) {
            encode((byte) 7);
            m7941encodeR2X_6o(spanStyle.getLetterSpacing());
        }
        BaselineShift baselineShift = spanStyle.getBaselineShift();
        if (baselineShift != null) {
            float fM8576unboximpl = baselineShift.m8576unboximpl();
            encode((byte) 8);
            m7942encode4Dl_Bck(fM8576unboximpl);
        }
        ...
        if (!Color.m5969equalsimpl0(spanStyle.getBackground(), Color.INSTANCE.m6004getUnspecified0d7_KjU())) {
            encode((byte) 10);
            m7944encode8_81llA(spanStyle.getBackground());
        }
    ...
    public final void m7944encode8_81llA(long color) {
        m7945encodeVKZWuLQ(ULong.m12567constructorimpl(AndroidColor_androidKt.m5831toColorLong8_81llA(color)));
    }

    /* JADX INFO: renamed from: encode--R2X_6o, reason: not valid java name */
    public final void m7941encodeR2X_6o(long textUnit) {
    ...
    public final void m7946encodenzbMABs(int fontStyle) {
        byte b2 = 0;
    ...
    public final void m7943encode6p3vJLY(int fontSynthesis) {
        byte b2 = 0;
    ...
    public final void m7942encode4Dl_Bck(float baselineShift) {
    ...
    public final void encode(Shadow shadow) {
        m7944encode8_81llA(shadow.getColor());
    ...
    public final void m7945encodeVKZWuLQ(long uLong) {
