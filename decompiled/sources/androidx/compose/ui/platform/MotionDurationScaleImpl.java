...
final class MotionDurationScaleImpl implements MotionDurationScale {
    ...
    private final float get_scaleFactor() {
        return this._scaleFactor.getFloatValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void set_scaleFactor(float f2) {
        this._scaleFactor.setFloatValue(f2);
    }
    ...
    private final Job startObservingSystemScaleFactor() {
        ...
        if (coroutineScope != null) {
            return BuildersKt__Builders_commonKt.launch$default(coroutineScope, null, null, new AnonymousClass1(animationScaleFlowFor, this, null), 3, null);
        }
            ...
            if (i == 0) {
                ...
                if (stateFlow.collect(new FlowCollector() { // from class: androidx.compose.ui.platform.MotionDurationScaleImpl.startObservingSystemScaleFactor.1.1
                    public final Object emit(float f2, Continuation<? super Unit> continuation) {
                        motionDurationScaleImpl.set_scaleFactor(f2);
