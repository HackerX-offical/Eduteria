...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m6059getAutoNrFUSI();
    ...
    public void mo7931setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().mo5843setBlendModes9anfk8(i);
    ...
    public void mo7932setCompositingStrategyaDBOjCE(int i) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m7985applyCompositingStrategyQu9p0E8(this.renderNode, CompositingStrategy.INSTANCE.m6061getOffscreenNrFUSI());
        } else {
            m7985applyCompositingStrategyQu9p0E8(this.renderNode, this.internalCompositingStrategy);
        }
    }

    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m6055equalsimpl0(getInternalCompositingStrategy(), CompositingStrategy.INSTANCE.m6061getOffscreenNrFUSI()) || requiresLayerPaint();
    }
    ...
    private final void m7985applyCompositingStrategyQu9p0E8(RenderNode renderNode, int i) {
        if (CompositingStrategy.m6055equalsimpl0(i, CompositingStrategy.INSTANCE.m6061getOffscreenNrFUSI())) {
        ...
        if (CompositingStrategy.m6055equalsimpl0(i, CompositingStrategy.INSTANCE.m6060getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui() {
        return CompositingStrategy.m6055equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m6061getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m5939clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
