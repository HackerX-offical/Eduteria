...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    /* JADX INFO: compiled from: RenderNodeLayer.android.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u0007¨\u0006\b"}, d2 = {"Landroidx/compose/ui/platform/RenderNodeLayer$UniqueDrawingIdApi29;", "", "<init>", "()V", "getUniqueDrawingId", "", ViewHierarchyConstants.VIEW_KEY, "Landroid/view/View;", "ui"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        ...
        if ((mutatedFields & 64) != 0) {
            this.renderNode.setAmbientShadowColor(ColorKt.m6022toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields & 128) != 0) {
            this.renderNode.setSpotShadowColor(ColorKt.m6022toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if (i != 0) {
            this.renderNode.setPivotX(TransformOrigin.m6378getPivotFractionXimpl(this.transformOrigin) * this.renderNode.getWidth());
            this.renderNode.setPivotY(TransformOrigin.m6379getPivotFractionYimpl(this.transformOrigin) * this.renderNode.getHeight());
        }
        ...
        if ((524288 & mutatedFields) != 0) {
            this.renderNode.mo7931setBlendModes9anfk8(scope.getBlendMode());
        }
        if ((32768 & mutatedFields) != 0) {
            this.renderNode.mo7932setCompositingStrategyaDBOjCE(scope.getCompositingStrategy());
        }
    ...
    public void mo7825resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m6378getPivotFractionXimpl(this.transformOrigin) * i);
        this.renderNode.setPivotY(TransformOrigin.m6379getPivotFractionYimpl(this.transformOrigin) * i2);
    ...
    public void mo7824movegyyYBs(long position) {
        ...
        if (left == iM8958getXimpl && top == iM8959getYimpl) {
            return;
        }
        if (left != iM8958getXimpl) {
            this.renderNode.offsetLeftAndRight(iM8958getXimpl - left);
        }
        if (top != iM8959getYimpl) {
            this.renderNode.offsetTopAndBottom(iM8959getYimpl - top);
        }
        triggerRepaint();
        this.matrixCache.invalidate();
    }
    ...
    public void drawLayer(Canvas canvas, GraphicsLayer parentLayer) {
        ...
        canvas.mo5819concat58bKbWc(this.matrixCache.m7954calculateMatrixGrdbGEg(this.renderNode));
    ...
    public float[] mo7820getUnderlyingMatrixsQKQjiQ() {
        return this.matrixCache.m7954calculateMatrixGrdbGEg(this.renderNode);
    }
    ...
    public long mo7823mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            return this.matrixCache.m7956mapInverseR5De75A(this.renderNode, point);
        }
        return this.matrixCache.m7955mapR5De75A(this.renderNode, point);
    }
    ...
    public void mo7826transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m6233timesAssign58bKbWc(matrix, this.matrixCache.m7954calculateMatrixGrdbGEg(this.renderNode));
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* JADX INFO: renamed from: inverseTransform-58bKbWc */
    public void mo7821inverseTransform58bKbWc(float[] matrix) {
        float[] fArrM7953calculateInverseMatrixbWbORWo = this.matrixCache.m7953calculateInverseMatrixbWbORWo(this.renderNode);
