...
public final class SemanticsUtils_androidKt {
    ...
    public static final String m7987toLegacyClassNameV4PA4sw(int i) {
        if (Role.m8009equalsimpl0(i, Role.INSTANCE.m8013getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m8009equalsimpl0(i, Role.INSTANCE.m8015getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m8009equalsimpl0(i, Role.INSTANCE.m8018getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m8009equalsimpl0(i, Role.INSTANCE.m8017getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m8009equalsimpl0(i, Role.INSTANCE.m8016getDropdownListo7Vup1c())) {
            return "android.widget.Spinner";
        }
        if (Role.m8009equalsimpl0(i, Role.INSTANCE.m8021getValuePickero7Vup1c())) {
