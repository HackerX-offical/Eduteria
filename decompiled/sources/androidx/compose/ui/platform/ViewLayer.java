...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public ViewLayer(AndroidComposeView androidComposeView, DrawChildContainer drawChildContainer, Function2<? super Canvas, ? super GraphicsLayer, Unit> function2, Function0<Unit> function0) {
        ...
        this.mTransformOrigin = TransformOrigin.INSTANCE.m6383getCenterSzJe1aQ();
    ...
    public float[] mo7820getUnderlyingMatrixsQKQjiQ() {
        return this.matrixCache.m7954calculateMatrixGrdbGEg(this);
    }
    ...
    /* JADX INFO: compiled from: ViewLayer.android.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u0007¨\u0006\b"}, d2 = {"Landroidx/compose/ui/platform/ViewLayer$UniqueDrawingIdApi29;", "", "<init>", "()V", "getUniqueDrawingId", "", ViewHierarchyConstants.VIEW_KEY, "Landroid/view/View;", "ui"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope scope) {
        int iMo6163getCompositingStrategyNrFUSI;
        Function0<Unit> function0;
        int mutatedFields$ui = scope.getMutatedFields() | this.mutatedFields;
        if ((mutatedFields$ui & 4096) != 0) {
            long jMo6166getTransformOriginSzJe1aQ = scope.getTransformOrigin();
            this.mTransformOrigin = jMo6166getTransformOriginSzJe1aQ;
            setPivotX(TransformOrigin.m6378getPivotFractionXimpl(jMo6166getTransformOriginSzJe1aQ) * getWidth());
            setPivotY(TransformOrigin.m6379getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        }
        ...
        boolean zM7984updateS_szKao = this.outlineResolver.m7984updateS_szKao(scope.getOutline(), scope.getAlpha(), z3, scope.getShadowElevation(), scope.getSize());
        if (this.outlineResolver.getCacheIsDirty()) {
            updateOutlineResolver();
        }
        boolean z4 = getManualClipPath() != null;
        if (z2 != z4 || (z4 && zM7984updateS_szKao)) {
            invalidate();
        }
        ...
        if ((mutatedFields$ui & 64) != 0) {
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m6022toArgb8_81llA(scope.getAmbientShadowColor()));
        }
        if ((mutatedFields$ui & 128) != 0) {
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m6022toArgb8_81llA(scope.getSpotShadowColor()));
        }
        ...
        if ((mutatedFields$ui & 32768) != 0 || z5) {
            if (z5) {
                iMo6163getCompositingStrategyNrFUSI = CompositingStrategy.INSTANCE.m6061getOffscreenNrFUSI();
            } else {
                iMo6163getCompositingStrategyNrFUSI = scope.getCompositingStrategy();
            }
            android.graphics.Paint nativePaint = null;
            if (CompositingStrategy.m6055equalsimpl0(iMo6163getCompositingStrategyNrFUSI, CompositingStrategy.INSTANCE.m6061getOffscreenNrFUSI())) {
                if (z5) {
                    Paint paintObtainLayerPaint = obtainLayerPaint();
                    paintObtainLayerPaint.setColorFilter(scope.getColorFilter());
                    paintObtainLayerPaint.mo5843setBlendModes9anfk8(scope.getBlendMode());
                    nativePaint = AndroidPaint_androidKt.getNativePaint(paintObtainLayerPaint);
                }
                setLayerType(2, nativePaint);
            } else if (CompositingStrategy.m6055equalsimpl0(iMo6163getCompositingStrategyNrFUSI, CompositingStrategy.INSTANCE.m6060getModulateAlphaNrFUSI())) {
                setLayerType(0, null);
    ...
    public void mo7825resizeozmzZPI(long size) {
        ...
        setPivotX(TransformOrigin.m6378getPivotFractionXimpl(this.mTransformOrigin) * i);
        setPivotY(TransformOrigin.m6379getPivotFractionYimpl(this.mTransformOrigin) * i2);
        updateOutlineResolver();
    ...
    public void mo7824movegyyYBs(long position) {
        int iM8958getXimpl = IntOffset.m8958getXimpl(position);
        if (iM8958getXimpl != getLeft()) {
            offsetLeftAndRight(iM8958getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int iM8959getYimpl = IntOffset.m8959getYimpl(position);
        if (iM8959getYimpl != getTop()) {
            offsetTopAndBottom(iM8959getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public long mo7823mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            return this.matrixCache.m7956mapInverseR5De75A(this, point);
        }
        return this.matrixCache.m7955mapR5De75A(this, point);
    }
    ...
    public void mo7826transform58bKbWc(float[] matrix) {
        androidx.compose.ui.graphics.Matrix.m6233timesAssign58bKbWc(matrix, this.matrixCache.m7954calculateMatrixGrdbGEg(this));
    }

    @Override // androidx.compose.ui.node.OwnedLayer
    /* JADX INFO: renamed from: inverseTransform-58bKbWc */
    public void mo7821inverseTransform58bKbWc(float[] matrix) {
        float[] fArrM7953calculateInverseMatrixbWbORWo = this.matrixCache.m7953calculateInverseMatrixbWbORWo(this);
        if (fArrM7953calculateInverseMatrixbWbORWo != null) {
            androidx.compose.ui.graphics.Matrix.m6233timesAssign58bKbWc(matrix, fArrM7953calculateInverseMatrixbWbORWo);
        }
    }
    ...
    public boolean mo7822isInLayerk4lQ0M(long position) {
        ...
        if (getClipToOutline()) {
            return this.outlineResolver.m7983isInOutlinek4lQ0M(position);
        }
        return true;
    }
}
