...
public final class WindowInfoImpl implements WindowInfo {
    ...
    private static final MutableState<PointerKeyboardModifiers> GlobalKeyboardModifiers = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(PointerKeyboardModifiers.m7375boximpl(PointerEvent_androidKt.EmptyPointerKeyboardModifiers()), null, 2, null);
    private final MutableState<IntSize> _containerSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m8993boximpl(IntSize.INSTANCE.m9006getZeroYbymL2g()), null, 2, null);
    private final MutableState<DpSize> _containerDpSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(DpSize.m8916boximpl(DpSize.INSTANCE.m8938getZeroMYxV2XQ()), null, 2, null);
    ...
    public int mo7959getKeyboardModifiersk7X9c1A() {
    ...
    public void m7996setKeyboardModifiers5xRPYO0(int i) {
        GlobalKeyboardModifiers.setValue(PointerKeyboardModifiers.m7375boximpl(i));
    }

    @Override // androidx.compose.ui.platform.WindowInfo
    /* JADX INFO: renamed from: getContainerSize-YbymL2g */
    public long mo7958getContainerSizeYbymL2g() {
        return this._containerSize.getValue().m9005unboximpl();
    }

    /* JADX INFO: renamed from: setContainerSize-ozmzZPI, reason: not valid java name */
    public void m7995setContainerSizeozmzZPI(long j) {
        this._containerSize.setValue(IntSize.m8993boximpl(j));
    }

    @Override // androidx.compose.ui.platform.WindowInfo
    /* JADX INFO: renamed from: getContainerDpSize-MYxV2XQ */
    public long mo7957getContainerDpSizeMYxV2XQ() {
    ...
    public void m7994setContainerDpSizeEaSLcWc(long j) {
        this._containerDpSize.setValue(DpSize.m8916boximpl(j));
    }
