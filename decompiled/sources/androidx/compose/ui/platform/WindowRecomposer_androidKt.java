...
public final class WindowRecomposer_androidKt {
    ...
    public static final StateFlow<Float> getAnimationScaleFlowFor(Context context) {
        ...
        synchronized (mutableScatterMap) {
            StateFlow<Float> stateFlowStateIn = mutableScatterMap.get(context);
            if (stateFlowStateIn == null) {
                ...
                stateFlowStateIn = FlowKt.stateIn(FlowKt.flow(new WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$1(contentResolver, uriFor, new ContentObserver(handlerCreateAsync) { // from class: androidx.compose.ui.platform.WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$contentObserver$1
                    ...
                    public void onChange(boolean selfChange, Uri uri) {
                        channelChannel$default.mo13895trySendJP2dKIU(Unit.INSTANCE);
                    }
                }, channelChannel$default, context, null)), CoroutineScopeKt.MainScope(), SharingStarted.Companion.WhileSubscribed$default(SharingStarted.INSTANCE, 0L, 0L, 3, null), Float.valueOf(readAnimationScale(context)));
                mutableScatterMap.set(context, stateFlowStateIn);
            }
    ...
    /* JADX WARN: Type inference failed for: r3v7, types: [T, androidx.compose.ui.platform.MotionDurationScaleImpl] */
            ...
            lifecycle.addObserver(new LifecycleEventObserver() { // from class: androidx.compose.ui.platform.WindowRecomposer_androidKt.createLifecycleAwareWindowRecomposer.2
                ...
                public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                    switch (WhenMappings.$EnumSwitchMapping$0[event.ordinal()]) {
                        case 1:
                            BuildersKt__Builders_commonKt.launch$default(CoroutineScope, null, CoroutineStart.UNDISPATCHED, new WindowRecomposer_androidKt$createLifecycleAwareWindowRecomposer$2$onStateChanged$1(objectRef, recomposer, source, this, null), 1, null);
                            return;
                        case 2:
