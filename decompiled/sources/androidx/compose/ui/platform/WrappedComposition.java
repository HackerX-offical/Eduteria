...
final class WrappedComposition implements Composition, LifecycleEventObserver, CompositionServices {
    ...
    private Function2<? super Composer, ? super Integer, Unit> lastContent = ComposableSingletons$Wrapper_androidKt.INSTANCE.m7916getLambda$1759434350$ui();
            ...
            if (lifecycle.getState().isAtLeast(Lifecycle.State.CREATED)) {
                ...
                original.setContent(ComposableLambdaKt.composableLambdaInstance(-1723985096, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.platform.WrappedComposition.setContent.1.2
                    ...
                    public final void invoke(Composer composer, int i) {
                        ...
                        boolean zChangedInstance = composer.changedInstance(wrappedComposition2);
                        WrappedComposition wrappedComposition3 = wrappedComposition2;
                        WrappedComposition$setContent$1$2$1$1 wrappedComposition$setContent$1$2$1$1RememberedValue = composer.rememberedValue();
                        if (zChangedInstance || wrappedComposition$setContent$1$2$1$1RememberedValue == Composer.INSTANCE.getEmpty()) {
                            wrappedComposition$setContent$1$2$1$1RememberedValue = new WrappedComposition$setContent$1$2$1$1(wrappedComposition3, null);
                            composer.updateRememberedValue(wrappedComposition$setContent$1$2$1$1RememberedValue);
                        }
                        ComposerKt.sourceInformationMarkerEnd(composer);
                        EffectsKt.LaunchedEffect(owner, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) wrappedComposition$setContent$1$2$1$1RememberedValue, composer, 0);
                        AndroidComposeView owner2 = wrappedComposition2.getOwner();
                        ComposerKt.sourceInformationMarkerStart(composer, 1107706824, "CC(remember):Wrapper.android.kt#9igjgp");
                        boolean zChangedInstance2 = composer.changedInstance(wrappedComposition2);
                        WrappedComposition wrappedComposition4 = wrappedComposition2;
                        WrappedComposition$setContent$1$2$2$1 wrappedComposition$setContent$1$2$2$1RememberedValue = composer.rememberedValue();
                        if (zChangedInstance2 || wrappedComposition$setContent$1$2$2$1RememberedValue == Composer.INSTANCE.getEmpty()) {
                            wrappedComposition$setContent$1$2$2$1RememberedValue = new WrappedComposition$setContent$1$2$2$1(wrappedComposition4, null);
                            composer.updateRememberedValue(wrappedComposition$setContent$1$2$2$1RememberedValue);
                        }
                        ComposerKt.sourceInformationMarkerEnd(composer);
                        EffectsKt.LaunchedEffect(owner2, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) wrappedComposition$setContent$1$2$2$1RememberedValue, composer, 0);
                        composeViewContext.ProvideCompositionLocals$ui(wrappedComposition2.getOwner(), function2, composer, 0);
                        if (ComposerKt.isTraceInProgress()) {
