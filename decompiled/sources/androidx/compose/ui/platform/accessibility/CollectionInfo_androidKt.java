    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() <= 1) {
            ...
            while (i < lastIndex) {
                ...
                arrayList.add(Offset.m5712boximpl(Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(Math.abs(Float.intBitsToFloat((int) (semanticsNode4.getBoundsInRoot().m5753getCenterF1C5BW0() >> 32)) - Float.intBitsToFloat((int) (semanticsNode3.getBoundsInRoot().m5753getCenterF1C5BW0() >> 32))))) << 32) | (((long) Float.floatToRawIntBits(Math.abs(Float.intBitsToFloat((int) (semanticsNode4.getBoundsInRoot().m5753getCenterF1C5BW0() & 4294967295L)) - Float.intBitsToFloat((int) (semanticsNode3.getBoundsInRoot().m5753getCenterF1C5BW0() & 4294967295L))))) & 4294967295L))));
                semanticsNode = semanticsNode2;
            }
            listEmptyList = arrayList;
        }
        if (listEmptyList.size() == 1) {
            jM5733unboximpl = ((Offset) CollectionsKt.first(listEmptyList)).m5733unboximpl();
        } else {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    objFirst = Offset.m5712boximpl(Offset.m5728plusMKHz9U(((Offset) objFirst).m5733unboximpl(), ((Offset) listEmptyList.get(i2)).m5733unboximpl()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
            ...
            jM5733unboximpl = ((Offset) objFirst).m5733unboximpl();
        }
        return Float.intBitsToFloat((int) (4294967295L & jM5733unboximpl)) < Float.intBitsToFloat((int) (jM5733unboximpl >> 32));
    }
