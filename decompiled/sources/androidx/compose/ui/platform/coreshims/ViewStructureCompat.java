...
public class ViewStructureCompat {
    ...
    public void setTextStyle(float f2, int i, int i2, int i3) {
        Api23Impl.setTextStyle((ViewStructure) this.mWrappedObj, f2, i, i2, i3);
    }
    ...
    private static class Api23Impl {
        ...
        static void setTextStyle(ViewStructure viewStructure, float f2, int i, int i2, int i3) {
            viewStructure.setTextStyle(f2, i, i2, i3);
        }
