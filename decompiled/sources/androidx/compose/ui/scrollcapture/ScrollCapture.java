...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> targets) {
        ...
        long jM8987getTopLeftnOccac = scrollCaptureCandidate.getViewportBoundsInWindow().m8987getTopLeftnOccac();
        ScrollCaptureTarget scrollCaptureTarget = new ScrollCaptureTarget(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(rectBoundsInRoot)), new Point(IntOffset.m8958getXimpl(jM8987getTopLeftnOccac), IntOffset.m8959getYimpl(jM8987getTopLeftnOccac)), composeScrollCaptureCallback);
