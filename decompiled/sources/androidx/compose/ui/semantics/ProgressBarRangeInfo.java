...
public final class ProgressBarRangeInfo {
    ...
    public ProgressBarRangeInfo(float f2, ClosedFloatingPointRange<Float> closedFloatingPointRange, int i) {
        this.current = f2;
    ...
    public /* synthetic */ ProgressBarRangeInfo(float f2, ClosedFloatingPointRange closedFloatingPointRange, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
