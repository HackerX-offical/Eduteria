...
public final class SemanticsProperties {
    ...
    private static final SemanticsPropertyKey<Unit> Disabled = new SemanticsPropertyKey<>(BucketLifecycleConfiguration.DISABLED, true);
    ...
    private static final SemanticsPropertyKey<Role> Role = new SemanticsPropertyKey<>("Role", true, new Function2<Role, Role, Role>() { // from class: androidx.compose.ui.semantics.SemanticsProperties$Role$1
        ...
        public final Role m8027invokeqtAw6s(Role role, int i) {
            return role;
        }

        @Override // kotlin.jvm.functions.Function2
        public /* bridge */ /* synthetic */ Role invoke(Role role, Role role2) {
            return m8027invokeqtAw6s(role, role2.getValue());
        }
    }, null, 8, null);
    ...
    private static final SemanticsPropertyKey<String> Error = new SemanticsPropertyKey<>(Constants.EVENT_ACTION_ERROR, true);
