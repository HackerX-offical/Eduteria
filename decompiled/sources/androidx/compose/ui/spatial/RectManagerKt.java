...
public final class RectManagerKt {
    ...
    public static final boolean m8041isSetgyyYBs(long j) {
        return !IntOffset.m8957equalsimpl0(j, IntOffset.INSTANCE.m8968getMaxnOccac());
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: analyzeComponents-58bKbWc, reason: not valid java name */
    public static final int m8040analyzeComponents58bKbWc(float[] fArr) {
        int i = 0;
        if (fArr.length < 16) {
            return 0;
        }
