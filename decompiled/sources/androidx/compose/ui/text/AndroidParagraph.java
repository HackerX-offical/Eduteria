...
public final class AndroidParagraph implements Paragraph {
    ...
    /* JADX WARN: Type inference failed for: r0v12, types: [androidx.compose.ui.text.AndroidParagraph] */
    ...
    /* JADX WARN: Type inference failed for: r22v0, types: [androidx.compose.ui.text.AndroidParagraph] */
    ...
    */
    ...
    public float getWidth() {
        return Constraints.m8783getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo8059getOffsetForPositionk4lQ0M(long position) {
    ...
    public long mo8061getRangeForRect86BmAI(Rect rect, int granularity, final TextInclusionStrategy inclusionStrategy) {
        int[] rangeForRect = this.layout.getRangeForRect(RectHelper_androidKt.toAndroidRectF(rect), AndroidParagraph_androidKt.m8077toLayoutTextGranularityduNsdkg(granularity), new Function2() { // from class: androidx.compose.ui.text.AndroidParagraph$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return Boolean.valueOf(AndroidParagraph.getRangeForRect_8_6BmAI$lambda$0(inclusionStrategy, (RectF) obj, (RectF) obj2));
            }
        });
    ...
    public void mo8057fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        this.layout.fillBoundingBoxes(TextRange.m8271getMinimpl(range), TextRange.m8270getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo8062getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo8064paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint textPaint$ui_text = getTextPaint$ui_text();
        textPaint$ui_text.m8547setColor8_81llA(color);
    ...
    public void mo8063paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        ...
        textPaint$ui_text.m8544setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text().m8544setBlendModes9anfk8(backingBlendMode);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* JADX INFO: renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo8065painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        int backingBlendMode = getTextPaint$ui_text().getBackingBlendMode();
        AndroidTextPaint textPaint$ui_text = getTextPaint$ui_text();
        float width = getWidth();
        textPaint$ui_text.m8545setBrush12SF9DM(brush, Size.m5783constructorimpl((((long) Float.floatToRawIntBits(getHeight())) & 4294967295L) | (Float.floatToRawIntBits(width) << 32)), alpha);
        textPaint$ui_text.setShadow(shadow);
        textPaint$ui_text.setTextDecoration(textDecoration);
        textPaint$ui_text.setDrawStyle(drawStyle);
        textPaint$ui_text.m8544setBlendModes9anfk8(blendMode);
