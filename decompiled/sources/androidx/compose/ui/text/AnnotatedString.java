...
public final class AnnotatedString implements CharSequence {
    ...
    public final AnnotatedString m8078subSequence5zctL8(long range) {
        return subSequence(TextRange.m8271getMinimpl(range), TextRange.m8270getMaximpl(range));
    }
    ...
    public static final class Builder implements Appendable {
        ...
        private static final /* data */ class MutableRange<T> {
            ...
            /* JADX INFO: compiled from: AnnotatedString.kt */
            @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J \u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00060\u0005\"\u0004\b\u0001\u0010\u00062\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u0002H\u00060\b¨\u0006\t"}, d2 = {"Landroidx/compose/ui/text/AnnotatedString$Builder$MutableRange$Companion;", "", "<init>", "()V", "fromRange", "Landroidx/compose/ui/text/AnnotatedString$Builder$MutableRange;", ExifInterface.GPS_DIRECTION_TRUE, "range", "Landroidx/compose/ui/text/AnnotatedString$Range;", "ui-text"}, k = 1, mv = {2, 1, 0}, xi = 48)
        ...
        public final void addStringAnnotation(String tag, String annotation, int start, int end) {
            this.annotations.add(new MutableRange<>(StringAnnotation.m8220boximpl(StringAnnotation.m8221constructorimpl(annotation)), start, end, tag));
        }
        ...
        public final void m8080addBulletr9BaKPg(Bullet bullet, long indentation, int start, int end) {
        ...
        public static /* synthetic */ Object m8079withBulletListo2QH7mI$default(Builder builder, long j, Bullet bullet, Function1 function1, int i, Object obj) {
            if ((i & 1) != 0) {
                j = Bullet.INSTANCE.m8090getDefaultIndentationXSAIIZE();
            }
            if ((i & 2) != 0) {
                bullet = Bullet.INSTANCE.getDefault();
            }
            return builder.m8081withBulletListo2QH7mI(j, bullet, function1);
        }

        /* JADX INFO: renamed from: withBulletList-o2QH7mI, reason: not valid java name */
        public final <R> R m8081withBulletListo2QH7mI(long indentation, Bullet bullet, Function1<? super BulletScope, ? extends R> block) {
            long sp;
            ...
            if (pair != null) {
                ...
                if (!TextUnitType.m9052equalsimpl0(TextUnit.m9023getTypeUIouoOA(packedValue), TextUnit.m9023getTypeUIouoOA(indentation))) {
                    InlineClassHelperKt.throwIllegalStateException("Indentation unit types of nested bullet lists must match. Current " + ((Object) TextUnit.m9031toStringimpl(packedValue)) + " and previous is " + ((Object) TextUnit.m9031toStringimpl(indentation)));
                }
                long jM9023getTypeUIouoOA = TextUnit.m9023getTypeUIouoOA(indentation);
                sp = TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9057getSpUIouoOA()) ? TextUnitKt.getSp(TextUnit.m9024getValueimpl(indentation) + TextUnit.m9024getValueimpl(packedValue)) : TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9056getEmUIouoOA()) ? TextUnitKt.getEm(TextUnit.m9024getValueimpl(indentation) + TextUnit.m9024getValueimpl(packedValue)) : indentation;
            } else {
                sp = indentation;
            }
            int iPushStyle = pushStyle(new ParagraphStyle(0, 0, 0L, new TextIndent(sp, sp, null), (PlatformParagraphStyle) null, (LineHeightStyle) null, 0, 0, (TextMotion) null, 503, (DefaultConstructorMarker) null));
            this.bulletScope.getBulletListSettingStack$ui_text().add(new Pair<>(TextUnit.m9014boximpl(sp), bullet));
            try {
        ...
        public final <R> R withBulletListItem(BulletScope bulletScope, Bullet bullet, Function1<? super Builder, ? extends R> function1) {
            ...
            long packedValue = pair != null ? ((TextUnit) pair.getFirst()).getPackedValue() : Bullet.INSTANCE.m8090getDefaultIndentationXSAIIZE();
            if (bullet != null) {
                bullet2 = bullet;
            } else if (pair == null || (bullet2 = (Bullet) pair.getSecond()) == null) {
                bullet2 = Bullet.INSTANCE.getDefault();
            }
            int iPushStyle = bulletScope.getBuilder().pushStyle(new ParagraphStyle(0, 0, 0L, new TextIndent(packedValue, packedValue, null), (PlatformParagraphStyle) null, (LineHeightStyle) null, 0, 0, (TextMotion) null, 503, (DefaultConstructorMarker) null));
        ...
        public final int pushStringAnnotation(String tag, String annotation) {
            MutableRange<? extends Annotation> mutableRange = new MutableRange<>(StringAnnotation.m8220boximpl(StringAnnotation.m8221constructorimpl(annotation)), this.text.length(), 0, tag, 4, null);
            this.styleStack.add(mutableRange);
            this.annotations.add(mutableRange);
            return this.styleStack.size() - 1;
        }
