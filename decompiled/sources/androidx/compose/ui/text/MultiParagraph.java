...
public final class MultiParagraph {
    ...
    private MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, int i2) {
        ...
        this.maxLines = i;
        boolean z = true;
        if (!(Constraints.m8785getMinWidthimpl(j) == 0 && Constraints.m8784getMinHeightimpl(j) == 0)) {
        ...
        while (i4 < size) {
            ...
            if (Constraints.m8778getHasBoundedHeightimpl(j)) {
                iM8782getMaxHeightimpl = RangesKt.coerceAtLeast(Constraints.m8782getMaxHeightimpl(j) - ParagraphKt.ceilToInt(f2), 0);
            } else {
                iM8782getMaxHeightimpl = Constraints.m8782getMaxHeightimpl(j);
            }
            Paragraph paragraphM8130ParagraphczeNHc = ParagraphKt.m8130ParagraphczeNHc(intrinsics, ConstraintsKt.Constraints$default(0, iM8783getMaxWidthimpl, 0, iM8782getMaxHeightimpl, 5, null), this.maxLines - i3, i2);
            float height = f2 + paragraphM8130ParagraphczeNHc.getHeight();
            int lineCount = i3 + paragraphM8130ParagraphczeNHc.getLineCount();
            arrayList.add(new ParagraphInfo(paragraphM8130ParagraphczeNHc, paragraphIntrinsicInfo.getStartIndex(), paragraphIntrinsicInfo.getEndIndex(), i3, lineCount, f2, height));
            if (paragraphM8130ParagraphczeNHc.getDidExceedMaxLines() || (lineCount == this.maxLines && i4 != CollectionsKt.getLastIndex(this.intrinsics.getInfoList$ui_text()))) {
                i3 = lineCount;
                f2 = height;
                break;
            } else {
        ...
        this.width = Constraints.m8783getMaxWidthimpl(j);
    ...
    public /* synthetic */ MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(multiParagraphIntrinsics, j, (i3 & 4) != 0 ? Integer.MAX_VALUE : i, (i3 & 8) != 0 ? TextOverflow.INSTANCE.m8765getClipgIe3tQ8() : i2, (DefaultConstructorMarker) null);
    }
    ...
    private MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j, int i, boolean z) {
        this(multiParagraphIntrinsics, j, i, z ? TextOverflow.INSTANCE.m8766getEllipsisgIe3tQ8() : TextOverflow.INSTANCE.m8765getClipgIe3tQ8(), (DefaultConstructorMarker) null);
    }
    ...
    public MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, int i, boolean z, float f2) {
        long jConstraints$default = ConstraintsKt.Constraints$default(0, ParagraphKt.ceilToInt(f2), 0, 0, 13, null);
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        this(multiParagraphIntrinsics, jConstraints$default, i, z ? companion.m8766getEllipsisgIe3tQ8() : companion.m8765getClipgIe3tQ8(), (DefaultConstructorMarker) null);
    }

    public /* synthetic */ MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, List list, int i, boolean z, float f2, Density density, Font.ResourceLoader resourceLoader, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (List<AnnotatedString.Range<Placeholder>>) ((i2 & 4) != 0 ? CollectionsKt.emptyList() : list), (i2 & 8) != 0 ? Integer.MAX_VALUE : i, (i2 & 16) != 0 ? false : z, f2, density, resourceLoader);
    }
    ...
    public MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, int i, boolean z, float f2, Density density, Font.ResourceLoader resourceLoader) {
        ...
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        this(multiParagraphIntrinsics, ConstraintsKt.Constraints$default(0, ParagraphKt.ceilToInt(f2), 0, 0, 13, null), i, z ? companion.m8766getEllipsisgIe3tQ8() : companion.m8765getClipgIe3tQ8(), (DefaultConstructorMarker) null);
    }

    public /* synthetic */ MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, float f2, Density density, FontFamily.Resolver resolver, List list, int i, boolean z, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, f2, density, resolver, (List<AnnotatedString.Range<Placeholder>>) ((i2 & 32) != 0 ? CollectionsKt.emptyList() : list), (i2 & 64) != 0 ? Integer.MAX_VALUE : i, (i2 & 128) != 0 ? false : z);
    }
    ...
    public MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, float f2, Density density, FontFamily.Resolver resolver, List<AnnotatedString.Range<Placeholder>> list, int i, boolean z) {
    ...
    private MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, long j, Density density, FontFamily.Resolver resolver, List<AnnotatedString.Range<Placeholder>> list, int i, boolean z) {
        MultiParagraphIntrinsics multiParagraphIntrinsics = new MultiParagraphIntrinsics(annotatedString, textStyle, list, density, resolver);
        TextOverflow.Companion companion = TextOverflow.INSTANCE;
        this(multiParagraphIntrinsics, j, i, z ? companion.m8766getEllipsisgIe3tQ8() : companion.m8765getClipgIe3tQ8(), (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, long j, Density density, FontFamily.Resolver resolver, List list, int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, j, density, resolver, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list, (i3 & 64) != 0 ? Integer.MAX_VALUE : i, (i3 & 128) != 0 ? TextOverflow.INSTANCE.m8765getClipgIe3tQ8() : i2, (DefaultConstructorMarker) null);
    }
    ...
    public static /* synthetic */ void m8104paintRPmYEkk$default(MultiParagraph multiParagraph, Canvas canvas, long j, Shadow shadow, TextDecoration textDecoration, int i, Object obj) {
        if ((i & 2) != 0) {
            j = Color.INSTANCE.m6004getUnspecified0d7_KjU();
        }
        multiParagraph.m8111paintRPmYEkk(canvas, j, (i & 4) != 0 ? null : shadow, (i & 8) != 0 ? null : textDecoration);
    }
    ...
    public final /* synthetic */ void m8111paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration decoration) {
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i = 0; i < size; i++) {
            ParagraphInfo paragraphInfo = list.get(i);
            Paragraph.m8115paintLG529CI$default(paragraphInfo.getParagraph(), canvas, color, shadow, decoration, null, 0, 48, null);
    ...
    public final void m8110paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i = 0; i < size; i++) {
            ParagraphInfo paragraphInfo = list.get(i);
            paragraphInfo.getParagraph().mo8063paintLG529CI(canvas, color, shadow, decoration, drawStyle, blendMode);
            canvas.translate(0.0f, paragraphInfo.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public static /* synthetic */ void m8105painthn5TExg$default(MultiParagraph multiParagraph, Canvas canvas, Brush brush, float f2, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            f2 = Float.NaN;
        }
        multiParagraph.m8112painthn5TExg(canvas, brush, f2, (i2 & 8) != 0 ? null : shadow, (i2 & 16) != 0 ? null : textDecoration, (i2 & 32) != 0 ? null : drawStyle, (i2 & 64) != 0 ? DrawScope.INSTANCE.m6551getDefaultBlendMode0nO6VwU() : i);
    }

    /* JADX INFO: renamed from: paint-hn5TExg, reason: not valid java name */
    public final void m8112painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration decoration, DrawStyle drawStyle, int blendMode) {
        AndroidMultiParagraphDraw_androidKt.m8533drawMultiParagraph7AXcY_I(this, canvas, brush, alpha, shadow, decoration, drawStyle, blendMode);
    }
    ...
    public final Path getPathForRange(final int start, final int end) {
        ...
        MultiParagraphKt.m8114findParagraphsByRangeSbBc2M(this.paragraphInfoList, TextRangeKt.TextRange(start, end), new Function1() { // from class: androidx.compose.ui.text.MultiParagraph$$ExternalSyntheticLambda1
    ...
    public static final Unit getPathForRange$lambda$1(Path path, int i, int i2, ParagraphInfo paragraphInfo) {
        Path.m6254addPathUv8p0NA$default(path, paragraphInfo.toGlobal(paragraphInfo.getParagraph().getPathForRange(paragraphInfo.toLocalIndex(i), paragraphInfo.toLocalIndex(i2))), 0L, 2, null);
    ...
    public final int m8107getOffsetForPositionk4lQ0M(long position) {
        ...
        return paragraphInfo.toGlobalIndex(paragraphInfo.getParagraph().mo8059getOffsetForPositionk4lQ0M(paragraphInfo.m8123toLocalMKHz9U(position)));
    }

    /* JADX INFO: renamed from: getRangeForRect-8-6BmAI, reason: not valid java name */
    public final long m8108getRangeForRect86BmAI(Rect rect, int granularity, TextInclusionStrategy inclusionStrategy) {
        ...
        if (this.paragraphInfoList.get(iFindParagraphByY).getBottom() >= rect.getBottom() || iFindParagraphByY == CollectionsKt.getLastIndex(this.paragraphInfoList)) {
            ...
            return ParagraphInfo.m8121toGlobalxdX6G0$default(paragraphInfo, paragraphInfo.getParagraph().mo8061getRangeForRect86BmAI(paragraphInfo.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
        }
        int iFindParagraphByY2 = MultiParagraphKt.findParagraphByY(this.paragraphInfoList, rect.getBottom());
        long jM8278getZerod9O1mEE = TextRange.INSTANCE.m8278getZerod9O1mEE();
        while (TextRange.m8266equalsimpl0(jM8278getZerod9O1mEE, TextRange.INSTANCE.m8278getZerod9O1mEE()) && iFindParagraphByY <= iFindParagraphByY2) {
            ParagraphInfo paragraphInfo2 = this.paragraphInfoList.get(iFindParagraphByY);
            jM8278getZerod9O1mEE = ParagraphInfo.m8121toGlobalxdX6G0$default(paragraphInfo2, paragraphInfo2.getParagraph().mo8061getRangeForRect86BmAI(paragraphInfo2.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            iFindParagraphByY++;
        }
        if (TextRange.m8266equalsimpl0(jM8278getZerod9O1mEE, TextRange.INSTANCE.m8278getZerod9O1mEE())) {
            return TextRange.INSTANCE.m8278getZerod9O1mEE();
        }
        long jM8278getZerod9O1mEE2 = TextRange.INSTANCE.m8278getZerod9O1mEE();
        while (TextRange.m8266equalsimpl0(jM8278getZerod9O1mEE2, TextRange.INSTANCE.m8278getZerod9O1mEE()) && iFindParagraphByY <= iFindParagraphByY2) {
            ParagraphInfo paragraphInfo3 = this.paragraphInfoList.get(iFindParagraphByY2);
            jM8278getZerod9O1mEE2 = ParagraphInfo.m8121toGlobalxdX6G0$default(paragraphInfo3, paragraphInfo3.getParagraph().mo8061getRangeForRect86BmAI(paragraphInfo3.toLocal(rect), granularity, inclusionStrategy), false, 1, null);
            iFindParagraphByY2--;
        }
        return TextRange.m8266equalsimpl0(jM8278getZerod9O1mEE2, TextRange.INSTANCE.m8278getZerod9O1mEE()) ? jM8278getZerod9O1mEE : TextRangeKt.TextRange(TextRange.m8273getStartimpl(jM8278getZerod9O1mEE), TextRange.m8268getEndimpl(jM8278getZerod9O1mEE2));
    }
    ...
    public final float[] m8106fillBoundingBoxes8ffj60Q(final long range, final float[] array, int arrayStart) {
        requireIndexInRange(TextRange.m8271getMinimpl(range));
        requireIndexInRangeInclusiveEnd(TextRange.m8270getMaximpl(range));
        final Ref.IntRef intRef = new Ref.IntRef();
        intRef.element = arrayStart;
        final Ref.FloatRef floatRef = new Ref.FloatRef();
        MultiParagraphKt.m8114findParagraphsByRangeSbBc2M(this.paragraphInfoList, range, new Function1() { // from class: androidx.compose.ui.text.MultiParagraph$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public static final Unit fillBoundingBoxes_8ffj60Q$lambda$0(long j, float[] fArr, Ref.IntRef intRef, Ref.FloatRef floatRef, ParagraphInfo paragraphInfo) {
        long jTextRange = TextRangeKt.TextRange(paragraphInfo.toLocalIndex(paragraphInfo.getStartIndex() > TextRange.m8271getMinimpl(j) ? paragraphInfo.getStartIndex() : TextRange.m8271getMinimpl(j)), paragraphInfo.toLocalIndex(paragraphInfo.getEndIndex() < TextRange.m8270getMaximpl(j) ? paragraphInfo.getEndIndex() : TextRange.m8270getMaximpl(j)));
        paragraphInfo.getParagraph().mo8057fillBoundingBoxes8ffj60Q(jTextRange, fArr, intRef.element);
        int iM8269getLengthimpl = intRef.element + (TextRange.m8269getLengthimpl(jTextRange) * 4);
        for (int i = intRef.element; i < iM8269getLengthimpl; i += 4) {
            int i2 = i + 1;
            fArr[i2] = fArr[i2] + floatRef.element;
            int i3 = i + 3;
            fArr[i3] = fArr[i3] + floatRef.element;
        }
        intRef.element = iM8269getLengthimpl;
    ...
    public final long m8109getWordBoundaryjx7JFs(int offset) {
        int iFindParagraphByIndex;
        requireIndexInRangeInclusiveEnd(offset);
        if (offset == getAnnotatedString().length()) {
            iFindParagraphByIndex = CollectionsKt.getLastIndex(this.paragraphInfoList);
        ...
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(iFindParagraphByIndex);
        return paragraphInfo.m8122toGlobalxdX6G0(paragraphInfo.getParagraph().mo8062getWordBoundaryjx7JFs(paragraphInfo.toLocalIndex(offset)), false);
    }
