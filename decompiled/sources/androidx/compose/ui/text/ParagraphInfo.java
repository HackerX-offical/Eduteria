...
public final /* data */ class ParagraphInfo {
    ...
    public static /* synthetic */ ParagraphInfo copy$default(ParagraphInfo paragraphInfo, Paragraph paragraph, int i, int i2, int i3, int i4, float f2, float f3, int i5, Object obj) {
        if ((i5 & 1) != 0) {
        ...
        int i6 = i4;
        int i7 = i2;
        return paragraphInfo.copy(paragraph, i, i7, i3, i6, f4, f5);
    }
    ...
    public ParagraphInfo(Paragraph paragraph, int i, int i2, int i3, int i4, float f2, float f3) {
    ...
    public final Rect toGlobal(Rect rect) {
        float f2 = this.top;
        return rect.m5760translatek4lQ0M(Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(0.0f)) << 32) | (((long) Float.floatToRawIntBits(f2)) & 4294967295L)));
    }
    ...
    public final Path toGlobal(Path path) {
        float f2 = this.top;
        path.mo5860translatek4lQ0M(Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(0.0f)) << 32) | (((long) Float.floatToRawIntBits(f2)) & 4294967295L)));
        return path;
    }

    /* JADX INFO: renamed from: toGlobal-xdX6-G0$default, reason: not valid java name */
    public static /* synthetic */ long m8121toGlobalxdX6G0$default(ParagraphInfo paragraphInfo, long j, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        return paragraphInfo.m8122toGlobalxdX6G0(j, z);
    }

    /* JADX INFO: renamed from: toGlobal-xdX6-G0, reason: not valid java name */
    public final long m8122toGlobalxdX6G0(long j, boolean z) {
        if (z && TextRange.m8266equalsimpl0(j, TextRange.INSTANCE.m8278getZerod9O1mEE())) {
            return TextRange.INSTANCE.m8278getZerod9O1mEE();
        }
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m8273getStartimpl(j)), toGlobalIndex(TextRange.m8268getEndimpl(j)));
    }

    /* JADX INFO: renamed from: toLocal-MK-Hz9U, reason: not valid java name */
    public final long m8123toLocalMKHz9U(long j) {
        float fIntBitsToFloat = Float.intBitsToFloat((int) (j >> 32));
        return Offset.m5715constructorimpl((((long) Float.floatToRawIntBits(Float.intBitsToFloat((int) (j & 4294967295L)) - this.top)) & 4294967295L) | (Float.floatToRawIntBits(fIntBitsToFloat) << 32));
    }
}
