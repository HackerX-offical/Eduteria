...
public final class TextStyle {
    ...
    public /* synthetic */ TextStyle(Brush brush, float f2, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, int i, int i2, long j4, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, int i3, int i4, TextMotion textMotion, DefaultConstructorMarker defaultConstructorMarker) {
        this(brush, f2, j, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j2, baselineShift, textGeometricTransform, localeList, j3, textDecoration, shadow, drawStyle, i, i2, j4, textIndent, platformTextStyle, lineHeightStyle, i3, i4, textMotion);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "TextStyle constructors that take nullable TextAlign, TextDirection, LineBreak, and Hyphens are deprecated. Please use a new constructor where these parameters are non-nullable. Null value has been replaced by a special Unspecified object for performance reason.")
    public /* synthetic */ TextStyle(Brush brush, float f2, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long j4, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion, DefaultConstructorMarker defaultConstructorMarker) {
        this(brush, f2, j, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j2, baselineShift, textGeometricTransform, localeList, j3, textDecoration, shadow, drawStyle, textAlign, textDirection, j4, textIndent, platformTextStyle, lineHeightStyle, lineBreak, hyphens, textMotion);
    }
    ...
    public static /* synthetic */ void m8288getHyphensEaSxIns$annotations() {
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Kept for backwards compatibility.")
    /* JADX INFO: renamed from: getLineBreak-LgCVezo$annotations, reason: not valid java name */
    public static /* synthetic */ void m8289getLineBreakLgCVezo$annotations() {
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Kept for backwards compatibility.")
    /* JADX INFO: renamed from: getTextAlign-buA522U$annotations, reason: not valid java name */
    public static /* synthetic */ void m8290getTextAlignbuA522U$annotations() {
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Kept for backwards compatibility.")
    /* JADX INFO: renamed from: getTextDirection-mmuk1to$annotations, reason: not valid java name */
    public static /* synthetic */ void m8291getTextDirectionmmuk1to$annotations() {
    }
    ...
    public /* synthetic */ TextStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, int i, DefaultConstructorMarker defaultConstructorMarker) {
        long jM6004getUnspecified0d7_KjU = (i & 1) != 0 ? Color.INSTANCE.m6004getUnspecified0d7_KjU() : j;
        long jM9035getUnspecifiedXSAIIZE = (i & 2) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j2;
        ...
        long jM9035getUnspecifiedXSAIIZE2 = (i & 128) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j3;
        ...
        long jM6004getUnspecified0d7_KjU2 = (i & 2048) != 0 ? Color.INSTANCE.m6004getUnspecified0d7_KjU() : j4;
        TextDecoration textDecoration2 = (i & 4096) != 0 ? null : textDecoration;
        long j6 = jM6004getUnspecified0d7_KjU;
        ...
        long jM9035getUnspecifiedXSAIIZE3 = (i & 65536) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j5;
        long j7 = jM9035getUnspecifiedXSAIIZE;
        ...
        String str3 = str2;
        long j8 = jM9035getUnspecifiedXSAIIZE2;
        ...
        long j9 = jM6004getUnspecified0d7_KjU2;
        this(j6, j7, fontWeight3, fontStyle3, fontSynthesis3, fontFamily3, str3, j8, baselineShift3, textGeometricTransform3, localeList3, j9, textDecoration3, shadow2, textAlign2, textDirection2, jM9035getUnspecifiedXSAIIZE3, (i & 131072) != 0 ? null : textIndent, null);
    }
    ...
    private TextStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent) {
        ...
        this(spanStyle, new ParagraphStyle(textAlign != null ? textAlign.m8707unboximpl() : TextAlign.INSTANCE.m8714getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m8724unboximpl() : TextDirection.INSTANCE.m8730getUnspecifieds_7Xco(), j5, textIndent, (PlatformParagraphStyle) null, (LineHeightStyle) null, LineBreak.INSTANCE.m8626getUnspecifiedrAG3T2k(), Hyphens.INSTANCE.m8602getUnspecifiedvmbZdU8(), (TextMotion) null, (DefaultConstructorMarker) null), null);
    }
    ...
    public /* synthetic */ TextStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        LocaleList localeList3 = localeList2;
        long j9 = jM6004getUnspecified0d7_KjU2;
        this(j6, j7, fontWeight3, fontStyle3, fontSynthesis3, fontFamily3, str3, j8, baselineShift3, textGeometricTransform3, localeList3, j9, textDecoration3, shadow2, textAlign2, textDirection2, jM9035getUnspecifiedXSAIIZE3, textIndent2, platformTextStyle2, (i & 524288) != 0 ? null : lineHeightStyle, null);
    }

    private TextStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle) {
        this(new SpanStyle(j, j2, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j3, baselineShift, textGeometricTransform, localeList, j4, textDecoration, shadow, platformTextStyle != null ? platformTextStyle.getSpanStyle() : null, (DrawStyle) null, (DefaultConstructorMarker) null), new ParagraphStyle(textAlign != null ? textAlign.m8707unboximpl() : TextAlign.INSTANCE.m8714getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m8724unboximpl() : TextDirection.INSTANCE.m8730getUnspecifieds_7Xco(), j5, textIndent, platformTextStyle != null ? platformTextStyle.getParagraphStyle() : null, lineHeightStyle, LineBreak.INSTANCE.m8626getUnspecifiedrAG3T2k(), Hyphens.INSTANCE.m8602getUnspecifiedvmbZdU8(), (TextMotion) null, (DefaultConstructorMarker) null), platformTextStyle);
    }
    ...
    public /* synthetic */ TextStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        LocaleList localeList3 = localeList2;
        long j9 = jM6004getUnspecified0d7_KjU2;
        this(j6, j7, fontWeight3, fontStyle3, fontSynthesis3, fontFamily3, str3, j8, baselineShift3, textGeometricTransform3, localeList3, j9, textDecoration3, shadow2, textAlign2, textDirection2, jM9035getUnspecifiedXSAIIZE3, textIndent2, platformTextStyle2, lineHeightStyle2, lineBreak2, (i & 2097152) != 0 ? null : hyphens, null);
    }
    ...
    private TextStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens) {
        ...
        int iM8707unboximpl = textAlign != null ? textAlign.m8707unboximpl() : TextAlign.INSTANCE.m8714getUnspecifiede0LSkKk();
        int iM8724unboximpl = textDirection != null ? textDirection.m8724unboximpl() : TextDirection.INSTANCE.m8730getUnspecifieds_7Xco();
        PlatformParagraphStyle paragraphStyle = platformTextStyle != null ? platformTextStyle.getParagraphStyle() : null;
        this(spanStyle, new ParagraphStyle(iM8707unboximpl, iM8724unboximpl, j5, textIndent, paragraphStyle, lineHeightStyle, lineBreak != null ? lineBreak.getMask() : LineBreak.INSTANCE.m8626getUnspecifiedrAG3T2k(), hyphens != null ? hyphens.m8599unboximpl() : Hyphens.INSTANCE.m8602getUnspecifiedvmbZdU8(), (TextMotion) null, 256, (DefaultConstructorMarker) null), platformTextStyle);
    }
    ...
    public /* synthetic */ TextStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        long jM9035getUnspecifiedXSAIIZE3 = (i & 131072) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j5;
        ...
        LocaleList localeList3 = localeList2;
        long j9 = jM6004getUnspecified0d7_KjU2;
        this(j6, j7, fontWeight3, fontStyle3, fontSynthesis3, fontFamily3, str3, j8, baselineShift3, textGeometricTransform3, localeList3, j9, textDecoration3, shadow2, drawStyle2, textAlign2, textDirection2, jM9035getUnspecifiedXSAIIZE3, textIndent2, platformTextStyle2, lineHeightStyle2, lineBreak2, hyphens2, (i & 8388608) != 0 ? null : textMotion, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ TextStyle(long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, int i, int i2, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, int i3, int i4, TextMotion textMotion, int i5, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        long jM9035getUnspecifiedXSAIIZE2 = (i5 & 128) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j3;
        ...
        long jM6004getUnspecified0d7_KjU2 = (i5 & 2048) != 0 ? Color.INSTANCE.m6004getUnspecified0d7_KjU() : j4;
        ...
        int iM8714getUnspecifiede0LSkKk = (i5 & 32768) != 0 ? TextAlign.INSTANCE.m8714getUnspecifiede0LSkKk() : i;
        int iM8730getUnspecifieds_7Xco = (i5 & 65536) != 0 ? TextDirection.INSTANCE.m8730getUnspecifieds_7Xco() : i2;
        long jM9035getUnspecifiedXSAIIZE3 = (i5 & 131072) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j5;
        ...
        int iM8626getUnspecifiedrAG3T2k = (i5 & 2097152) != 0 ? LineBreak.INSTANCE.m8626getUnspecifiedrAG3T2k() : i3;
        int iM8602getUnspecifiedvmbZdU8 = (i5 & 4194304) != 0 ? Hyphens.INSTANCE.m8602getUnspecifiedvmbZdU8() : i4;
        long j7 = jM9035getUnspecifiedXSAIIZE;
        FontWeight fontWeight3 = fontWeight2;
        TextDecoration textDecoration3 = textDecoration2;
        FontStyle fontStyle3 = fontStyle2;
        ...
        LocaleList localeList3 = localeList2;
        long j9 = jM6004getUnspecified0d7_KjU2;
        this(j6, j7, fontWeight3, fontStyle3, fontSynthesis3, fontFamily3, str3, j8, baselineShift3, textGeometricTransform3, localeList3, j9, textDecoration3, shadow2, drawStyle2, iM8714getUnspecifiede0LSkKk, iM8730getUnspecifieds_7Xco, jM9035getUnspecifiedXSAIIZE3, textIndent2, platformTextStyle2, lineHeightStyle2, iM8626getUnspecifiedrAG3T2k, iM8602getUnspecifiedvmbZdU8, (i5 & 8388608) != 0 ? null : textMotion, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ TextStyle(Brush brush, float f2, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, int i, int i2, long j4, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, int i3, int i4, TextMotion textMotion, int i5, DefaultConstructorMarker defaultConstructorMarker) {
        this(brush, (i5 & 2) != 0 ? Float.NaN : f2, (i5 & 4) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j, (i5 & 8) != 0 ? null : fontWeight, (i5 & 16) != 0 ? null : fontStyle, (i5 & 32) != 0 ? null : fontSynthesis, (i5 & 64) != 0 ? null : fontFamily, (i5 & 128) != 0 ? null : str, (i5 & 256) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j2, (i5 & 512) != 0 ? null : baselineShift, (i5 & 1024) != 0 ? null : textGeometricTransform, (i5 & 2048) != 0 ? null : localeList, (i5 & 4096) != 0 ? Color.INSTANCE.m6004getUnspecified0d7_KjU() : j3, (i5 & 8192) != 0 ? null : textDecoration, (i5 & 16384) != 0 ? null : shadow, (32768 & i5) != 0 ? null : drawStyle, (65536 & i5) != 0 ? TextAlign.INSTANCE.m8714getUnspecifiede0LSkKk() : i, (131072 & i5) != 0 ? TextDirection.INSTANCE.m8730getUnspecifieds_7Xco() : i2, (262144 & i5) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j4, (524288 & i5) != 0 ? null : textIndent, (1048576 & i5) != 0 ? null : platformTextStyle, (2097152 & i5) != 0 ? null : lineHeightStyle, (4194304 & i5) != 0 ? LineBreak.INSTANCE.m8626getUnspecifiedrAG3T2k() : i3, (8388608 & i5) != 0 ? Hyphens.INSTANCE.m8602getUnspecifiedvmbZdU8() : i4, (i5 & 16777216) != 0 ? null : textMotion, (DefaultConstructorMarker) null);
    }

    private TextStyle(Brush brush, float f2, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, int i, int i2, long j4, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, int i3, int i4, TextMotion textMotion) {
        this(new SpanStyle(brush, f2, j, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j2, baselineShift, textGeometricTransform, localeList, j3, textDecoration, shadow, platformTextStyle != null ? platformTextStyle.getSpanStyle() : null, drawStyle, (DefaultConstructorMarker) null), new ParagraphStyle(i, i2, j4, textIndent, platformTextStyle != null ? platformTextStyle.getParagraphStyle() : null, lineHeightStyle, i3, i4, textMotion, (DefaultConstructorMarker) null), platformTextStyle);
    }

    public /* synthetic */ TextStyle(Brush brush, float f2, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long j4, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(brush, (i & 2) != 0 ? Float.NaN : f2, (i & 4) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j, (i & 8) != 0 ? null : fontWeight, (i & 16) != 0 ? null : fontStyle, (i & 32) != 0 ? null : fontSynthesis, (i & 64) != 0 ? null : fontFamily, (i & 128) != 0 ? null : str, (i & 256) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j2, (i & 512) != 0 ? null : baselineShift, (i & 1024) != 0 ? null : textGeometricTransform, (i & 2048) != 0 ? null : localeList, (i & 4096) != 0 ? Color.INSTANCE.m6004getUnspecified0d7_KjU() : j3, (i & 8192) != 0 ? null : textDecoration, (i & 16384) != 0 ? null : shadow, (32768 & i) != 0 ? null : drawStyle, (65536 & i) != 0 ? null : textAlign, (131072 & i) != 0 ? null : textDirection, (262144 & i) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j4, (524288 & i) != 0 ? null : textIndent, (1048576 & i) != 0 ? null : platformTextStyle, (2097152 & i) != 0 ? null : lineHeightStyle, (4194304 & i) != 0 ? null : lineBreak, (8388608 & i) != 0 ? null : hyphens, (i & 16777216) != 0 ? null : textMotion, (DefaultConstructorMarker) null);
    }

    private TextStyle(Brush brush, float f2, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long j4, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion) {
        this(new SpanStyle(brush, f2, j, fontWeight, fontStyle, fontSynthesis, fontFamily, str, j2, baselineShift, textGeometricTransform, localeList, j3, textDecoration, shadow, platformTextStyle != null ? platformTextStyle.getSpanStyle() : null, drawStyle, (DefaultConstructorMarker) null), new ParagraphStyle(textAlign != null ? textAlign.m8707unboximpl() : TextAlign.INSTANCE.m8714getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m8724unboximpl() : TextDirection.INSTANCE.m8730getUnspecifieds_7Xco(), j4, textIndent, platformTextStyle != null ? platformTextStyle.getParagraphStyle() : null, lineHeightStyle, lineBreak != null ? lineBreak.getMask() : LineBreak.INSTANCE.m8626getUnspecifiedrAG3T2k(), hyphens != null ? hyphens.m8599unboximpl() : Hyphens.INSTANCE.m8602getUnspecifiedvmbZdU8(), textMotion, (DefaultConstructorMarker) null), platformTextStyle);
    }
    ...
    public static /* synthetic */ TextStyle m8293mergedA7vx0o$default(TextStyle textStyle, long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, int i, int i2, long j5, TextIndent textIndent, LineHeightStyle lineHeightStyle, int i3, int i4, PlatformTextStyle platformTextStyle, TextMotion textMotion, int i5, Object obj) {
        long jM6004getUnspecified0d7_KjU = (i5 & 1) != 0 ? Color.INSTANCE.m6004getUnspecified0d7_KjU() : j;
        return textStyle.m8318mergedA7vx0o(jM6004getUnspecified0d7_KjU, (i5 & 2) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j2, (i5 & 4) != 0 ? null : fontWeight, (i5 & 8) != 0 ? null : fontStyle, (i5 & 16) != 0 ? null : fontSynthesis, (i5 & 32) != 0 ? null : fontFamily, (i5 & 64) != 0 ? null : str, (i5 & 128) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j3, (i5 & 256) != 0 ? null : baselineShift, (i5 & 512) != 0 ? null : textGeometricTransform, (i5 & 1024) != 0 ? null : localeList, (i5 & 2048) != 0 ? Color.INSTANCE.m6004getUnspecified0d7_KjU() : j4, (i5 & 4096) != 0 ? null : textDecoration, (i5 & 8192) != 0 ? null : shadow, (i5 & 16384) != 0 ? null : drawStyle, (i5 & 32768) != 0 ? TextAlign.INSTANCE.m8714getUnspecifiede0LSkKk() : i, (i5 & 65536) != 0 ? TextDirection.INSTANCE.m8730getUnspecifieds_7Xco() : i2, (i5 & 131072) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j5, (i5 & 262144) != 0 ? null : textIndent, (i5 & 524288) != 0 ? null : lineHeightStyle, (i5 & 1048576) != 0 ? LineBreak.INSTANCE.m8626getUnspecifiedrAG3T2k() : i3, (i5 & 2097152) != 0 ? Hyphens.INSTANCE.m8602getUnspecifiedvmbZdU8() : i4, (i5 & 4194304) != 0 ? null : platformTextStyle, (i5 & 8388608) != 0 ? null : textMotion);
    }

    /* JADX INFO: renamed from: merge-dA7vx0o, reason: not valid java name */
    public final TextStyle m8318mergedA7vx0o(long color, long fontSize, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String fontFeatureSettings, long letterSpacing, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, int textAlign, int textDirection, long lineHeight, TextIndent textIndent, LineHeightStyle lineHeightStyle, int lineBreak, int hyphens, PlatformTextStyle platformStyle, TextMotion textMotion) {
        SpanStyle spanStyleM8218fastMergedSHsh3o = SpanStyleKt.m8218fastMergedSHsh3o(this.spanStyle, color, null, Float.NaN, fontSize, fontWeight, fontStyle, fontSynthesis, fontFamily, fontFeatureSettings, letterSpacing, baselineShift, textGeometricTransform, localeList, background, textDecoration, shadow, platformStyle != null ? platformStyle.getSpanStyle() : null, drawStyle);
        ParagraphStyle paragraphStyleM8155fastMergej5T8yCg = ParagraphStyleKt.m8155fastMergej5T8yCg(this.paragraphStyle, textAlign, textDirection, lineHeight, textIndent, platformStyle != null ? platformStyle.getParagraphStyle() : null, lineHeightStyle, lineBreak, hyphens, textMotion);
        return (this.spanStyle == spanStyleM8218fastMergedSHsh3o && this.paragraphStyle == paragraphStyleM8155fastMergej5T8yCg) ? this : new TextStyle(spanStyleM8218fastMergedSHsh3o, paragraphStyleM8155fastMergej5T8yCg);
    }

    /* JADX INFO: renamed from: merge-Z1GrekI$default, reason: not valid java name */
    public static /* synthetic */ TextStyle m8292mergeZ1GrekI$default(TextStyle textStyle, long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, PlatformTextStyle platformTextStyle, TextMotion textMotion, int i, Object obj) {
        long jM6004getUnspecified0d7_KjU = (i & 1) != 0 ? Color.INSTANCE.m6004getUnspecified0d7_KjU() : j;
        return textStyle.m8317mergeZ1GrekI(jM6004getUnspecified0d7_KjU, (i & 2) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j2, (i & 4) != 0 ? null : fontWeight, (i & 8) != 0 ? null : fontStyle, (i & 16) != 0 ? null : fontSynthesis, (i & 32) != 0 ? null : fontFamily, (i & 64) != 0 ? null : str, (i & 128) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j3, (i & 256) != 0 ? null : baselineShift, (i & 512) != 0 ? null : textGeometricTransform, (i & 1024) != 0 ? null : localeList, (i & 2048) != 0 ? Color.INSTANCE.m6004getUnspecified0d7_KjU() : j4, (i & 4096) != 0 ? null : textDecoration, (i & 8192) != 0 ? null : shadow, (i & 16384) != 0 ? null : drawStyle, (i & 32768) != 0 ? null : textAlign, (i & 65536) != 0 ? null : textDirection, (i & 131072) != 0 ? TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE() : j5, (i & 262144) != 0 ? null : textIndent, (i & 524288) != 0 ? null : lineHeightStyle, (i & 1048576) != 0 ? null : lineBreak, (i & 2097152) != 0 ? null : hyphens, (i & 4194304) != 0 ? null : platformTextStyle, (i & 8388608) != 0 ? null : textMotion);
    }
    ...
    public final /* synthetic */ TextStyle m8317mergeZ1GrekI(long color, long fontSize, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String fontFeatureSettings, long letterSpacing, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, PlatformTextStyle platformStyle, TextMotion textMotion) {
        SpanStyle spanStyleM8218fastMergedSHsh3o = SpanStyleKt.m8218fastMergedSHsh3o(this.spanStyle, color, null, Float.NaN, fontSize, fontWeight, fontStyle, fontSynthesis, fontFamily, fontFeatureSettings, letterSpacing, baselineShift, textGeometricTransform, localeList, background, textDecoration, shadow, platformStyle != null ? platformStyle.getSpanStyle() : null, drawStyle);
        ParagraphStyle paragraphStyleM8155fastMergej5T8yCg = ParagraphStyleKt.m8155fastMergej5T8yCg(this.paragraphStyle, textAlign != null ? textAlign.m8707unboximpl() : TextAlign.INSTANCE.m8714getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m8724unboximpl() : TextDirection.INSTANCE.m8730getUnspecifieds_7Xco(), lineHeight, textIndent, platformStyle != null ? platformStyle.getParagraphStyle() : null, lineHeightStyle, lineBreak != null ? lineBreak.getMask() : LineBreak.INSTANCE.m8626getUnspecifiedrAG3T2k(), hyphens != null ? hyphens.m8599unboximpl() : Hyphens.INSTANCE.m8602getUnspecifiedvmbZdU8(), textMotion);
        return (this.spanStyle == spanStyleM8218fastMergedSHsh3o && this.paragraphStyle == paragraphStyleM8155fastMergej5T8yCg) ? this : new TextStyle(spanStyleM8218fastMergedSHsh3o, paragraphStyleM8155fastMergej5T8yCg);
    }
    ...
    public static /* synthetic */ TextStyle m8282copyHL5avdY$default(TextStyle textStyle, long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, int i, Object obj) {
        ...
        long jM8217getLetterSpacingXSAIIZE = (i & 128) != 0 ? textStyle.spanStyle.getLetterSpacing() : j3;
        BaselineShift baselineShiftM8212getBaselineShift5SSeXJ0 = (i & 256) != 0 ? textStyle.spanStyle.getBaselineShift() : baselineShift;
        ...
        long j6 = jM8213getColor0d7_KjU;
        long jM8211getBackground0d7_KjU = (i & 2048) != 0 ? textStyle.spanStyle.getBackground() : j4;
        TextDecoration textDecoration2 = (i & 4096) != 0 ? textStyle.spanStyle.getTextDecoration() : textDecoration;
        return textStyle.m8295copyHL5avdY(j6, jM8214getFontSizeXSAIIZE, fontWeight2, fontStyleM8215getFontStyle4Lr2A7w, fontSynthesisM8216getFontSynthesisZQGJjVo, fontFamily2, fontFeatureSettings, jM8217getLetterSpacingXSAIIZE, baselineShiftM8212getBaselineShift5SSeXJ0, textGeometricTransform2, localeList2, jM8211getBackground0d7_KjU, textDecoration2, (i & 8192) != 0 ? textStyle.spanStyle.getShadow() : shadow, (i & 16384) != 0 ? TextAlign.m8701boximpl(textStyle.paragraphStyle.getTextAlign()) : textAlign, (i & 32768) != 0 ? TextDirection.m8718boximpl(textStyle.paragraphStyle.getTextDirection()) : textDirection, (i & 65536) != 0 ? textStyle.paragraphStyle.getLineHeight() : j5, (i & 131072) != 0 ? textStyle.paragraphStyle.getTextIndent() : textIndent);
    }
    ...
    public final /* synthetic */ TextStyle m8295copyHL5avdY(long color, long fontSize, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String fontFeatureSettings, long letterSpacing, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent) {
        TextForegroundStyle textForegroundStyleM8735from8_81llA;
        if (Color.m5969equalsimpl0(color, this.spanStyle.m8213getColor0d7_KjU())) {
            textForegroundStyleM8735from8_81llA = this.spanStyle.getTextForegroundStyle();
        } else {
            textForegroundStyleM8735from8_81llA = TextForegroundStyle.INSTANCE.m8735from8_81llA(color);
        }
        return new TextStyle(new SpanStyle(textForegroundStyleM8735from8_81llA, fontSize, fontWeight, fontStyle, fontSynthesis, fontFamily, fontFeatureSettings, letterSpacing, baselineShift, textGeometricTransform, localeList, background, textDecoration, shadow, this.spanStyle.getPlatformStyle(), this.spanStyle.getDrawStyle(), (DefaultConstructorMarker) null), new ParagraphStyle(textAlign != null ? textAlign.m8707unboximpl() : TextAlign.INSTANCE.m8714getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m8724unboximpl() : TextDirection.INSTANCE.m8730getUnspecifieds_7Xco(), lineHeight, textIndent, this.paragraphStyle.getPlatformStyle(), getLineHeightStyle(), m8311getLineBreakrAG3T2k(), m8308getHyphensvmbZdU8(), getTextMotion(), (DefaultConstructorMarker) null), this.platformStyle);
    }

    /* JADX INFO: renamed from: copy-NOaFTUo$default, reason: not valid java name */
    public static /* synthetic */ TextStyle m8283copyNOaFTUo$default(TextStyle textStyle, long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, int i, Object obj) {
        ...
        TextDecoration textDecoration3 = textDecoration2;
        TextAlign textAlignM8701boximpl = (i & 16384) != 0 ? TextAlign.m8701boximpl(textStyle.paragraphStyle.getTextAlign()) : textAlign;
        TextDirection textDirectionM8718boximpl = (i & 32768) != 0 ? TextDirection.m8718boximpl(textStyle.paragraphStyle.getTextDirection()) : textDirection;
        long jM8150getLineHeightXSAIIZE = (i & 65536) != 0 ? textStyle.paragraphStyle.getLineHeight() : j5;
        ...
        return textStyle.m8296copyNOaFTUo(j6, jM8214getFontSizeXSAIIZE, fontWeight2, fontStyleM8215getFontStyle4Lr2A7w, fontSynthesisM8216getFontSynthesisZQGJjVo, fontFamily2, fontFeatureSettings, jM8217getLetterSpacingXSAIIZE, baselineShiftM8212getBaselineShift5SSeXJ0, textGeometricTransform2, localeList2, jM8211getBackground0d7_KjU, textDecoration3, shadow2, textAlignM8701boximpl, textDirectionM8718boximpl, jM8150getLineHeightXSAIIZE, textIndent2, platformTextStyle2, lineHeightStyle2);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "TextStyle copy constructors that do not take new stable parameters like LineHeightStyle, LineBreak, Hyphens are deprecated. Please use the new stable copy constructor.")
    /* JADX INFO: renamed from: copy-NOaFTUo, reason: not valid java name */
    public final /* synthetic */ TextStyle m8296copyNOaFTUo(long color, long fontSize, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String fontFeatureSettings, long letterSpacing, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent, PlatformTextStyle platformStyle, LineHeightStyle lineHeightStyle) {
        TextForegroundStyle textForegroundStyleM8735from8_81llA;
        if (Color.m5969equalsimpl0(color, this.spanStyle.m8213getColor0d7_KjU())) {
            textForegroundStyleM8735from8_81llA = this.spanStyle.getTextForegroundStyle();
        } else {
        ...
        return new TextStyle(new SpanStyle(textForegroundStyleM8735from8_81llA, fontSize, fontWeight, fontStyle, fontSynthesis, fontFamily, fontFeatureSettings, letterSpacing, baselineShift, textGeometricTransform, localeList, background, textDecoration, shadow, platformStyle != null ? platformStyle.getSpanStyle() : null, this.spanStyle.getDrawStyle(), (DefaultConstructorMarker) null), new ParagraphStyle(textAlign != null ? textAlign.m8707unboximpl() : TextAlign.INSTANCE.m8714getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m8724unboximpl() : TextDirection.INSTANCE.m8730getUnspecifieds_7Xco(), lineHeight, textIndent, platformStyle != null ? platformStyle.getParagraphStyle() : null, lineHeightStyle, m8311getLineBreakrAG3T2k(), m8308getHyphensvmbZdU8(), getTextMotion(), (DefaultConstructorMarker) null), platformStyle);
    }

    /* JADX INFO: renamed from: copy-CXVQc50$default, reason: not valid java name */
    public static /* synthetic */ TextStyle m8281copyCXVQc50$default(TextStyle textStyle, long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, int i, Object obj) {
        Hyphens hyphensM8593boximpl;
        ...
        LineBreak lineBreakM8606boximpl = (i & 1048576) != 0 ? LineBreak.m8606boximpl(textStyle.paragraphStyle.getLineBreak()) : lineBreak;
        if ((i & 2097152) != 0) {
            lineBreak2 = lineBreakM8606boximpl;
            hyphensM8593boximpl = Hyphens.m8593boximpl(textStyle.paragraphStyle.getHyphens());
        } else {
            hyphensM8593boximpl = hyphens;
            lineBreak2 = lineBreakM8606boximpl;
        }
        return textStyle.m8294copyCXVQc50(j6, jM8214getFontSizeXSAIIZE, fontWeight2, fontStyleM8215getFontStyle4Lr2A7w, fontSynthesisM8216getFontSynthesisZQGJjVo, fontFamily2, fontFeatureSettings, jM8217getLetterSpacingXSAIIZE, baselineShiftM8212getBaselineShift5SSeXJ0, textGeometricTransform2, localeList2, jM8211getBackground0d7_KjU, textDecoration3, shadow2, textAlignM8701boximpl, textDirectionM8718boximpl, jM8150getLineHeightXSAIIZE, textIndent2, platformTextStyle2, lineHeightStyle2, lineBreak2, hyphensM8593boximpl);
    }
    ...
    public final /* synthetic */ TextStyle m8294copyCXVQc50(long color, long fontSize, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String fontFeatureSettings, long letterSpacing, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, TextDecoration textDecoration, Shadow shadow, TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent, PlatformTextStyle platformStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens) {
        TextForegroundStyle textForegroundStyleM8735from8_81llA;
        if (Color.m5969equalsimpl0(color, this.spanStyle.m8213getColor0d7_KjU())) {
            textForegroundStyleM8735from8_81llA = this.spanStyle.getTextForegroundStyle();
        } else {
        ...
        return new TextStyle(new SpanStyle(textForegroundStyleM8735from8_81llA, fontSize, fontWeight, fontStyle, fontSynthesis, fontFamily, fontFeatureSettings, letterSpacing, baselineShift, textGeometricTransform, localeList, background, textDecoration, shadow, platformStyle != null ? platformStyle.getSpanStyle() : null, getDrawStyle(), (DefaultConstructorMarker) null), new ParagraphStyle(textAlign != null ? textAlign.m8707unboximpl() : TextAlign.INSTANCE.m8714getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m8724unboximpl() : TextDirection.INSTANCE.m8730getUnspecifieds_7Xco(), lineHeight, textIndent, platformStyle != null ? platformStyle.getParagraphStyle() : null, lineHeightStyle, lineBreak != null ? lineBreak.getMask() : LineBreak.INSTANCE.m8626getUnspecifiedrAG3T2k(), hyphens != null ? hyphens.m8599unboximpl() : Hyphens.INSTANCE.m8602getUnspecifiedvmbZdU8(), getTextMotion(), (DefaultConstructorMarker) null), platformStyle);
    }

    /* JADX INFO: renamed from: copy-v2rsoow$default, reason: not valid java name */
    public static /* synthetic */ TextStyle m8287copyv2rsoow$default(TextStyle textStyle, long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion, int i, Object obj) {
        ...
        TextAlign textAlignM8701boximpl = (i & 32768) != 0 ? TextAlign.m8701boximpl(textStyle.paragraphStyle.getTextAlign()) : textAlign;
        TextDirection textDirectionM8718boximpl = (i & 65536) != 0 ? TextDirection.m8718boximpl(textStyle.paragraphStyle.getTextDirection()) : textDirection;
        long jM8150getLineHeightXSAIIZE = (i & 131072) != 0 ? textStyle.paragraphStyle.getLineHeight() : j5;
        ...
        LineBreak lineBreakM8606boximpl = (i & 2097152) != 0 ? LineBreak.m8606boximpl(textStyle.paragraphStyle.getLineBreak()) : lineBreak;
        Hyphens hyphensM8593boximpl = (i & 4194304) != 0 ? Hyphens.m8593boximpl(textStyle.paragraphStyle.getHyphens()) : hyphens;
        if ((i & 8388608) != 0) {
            hyphens2 = hyphensM8593boximpl;
            textMotion2 = textStyle.paragraphStyle.getTextMotion();
        } else {
            textMotion2 = textMotion;
            hyphens2 = hyphensM8593boximpl;
        }
        return textStyle.m8300copyv2rsoow(j6, jM8214getFontSizeXSAIIZE, fontWeight2, fontStyleM8215getFontStyle4Lr2A7w, fontSynthesisM8216getFontSynthesisZQGJjVo, fontFamily2, fontFeatureSettings, jM8217getLetterSpacingXSAIIZE, baselineShiftM8212getBaselineShift5SSeXJ0, textGeometricTransform2, localeList2, jM8211getBackground0d7_KjU, textDecoration3, shadow2, drawStyle2, textAlignM8701boximpl, textDirectionM8718boximpl, jM8150getLineHeightXSAIIZE, textIndent2, platformTextStyle2, lineHeightStyle2, lineBreakM8606boximpl, hyphens2, textMotion2);
    }
    ...
    public final /* synthetic */ TextStyle m8300copyv2rsoow(long color, long fontSize, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String fontFeatureSettings, long letterSpacing, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent, PlatformTextStyle platformStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion) {
        ...
        return new TextStyle(new SpanStyle(textForegroundStyleM8735from8_81llA, fontSize, fontWeight, fontStyle, fontSynthesis, fontFamily, fontFeatureSettings, letterSpacing, baselineShift, textGeometricTransform, localeList, background, textDecoration, shadow, platformStyle != null ? platformStyle.getSpanStyle() : null, drawStyle, (DefaultConstructorMarker) null), new ParagraphStyle(textAlign != null ? textAlign.m8707unboximpl() : TextAlign.INSTANCE.m8714getUnspecifiede0LSkKk(), textDirection != null ? textDirection.m8724unboximpl() : TextDirection.INSTANCE.m8730getUnspecifieds_7Xco(), lineHeight, textIndent, platformStyle != null ? platformStyle.getParagraphStyle() : null, lineHeightStyle, lineBreak != null ? lineBreak.getMask() : LineBreak.INSTANCE.m8626getUnspecifiedrAG3T2k(), hyphens != null ? hyphens.m8599unboximpl() : Hyphens.INSTANCE.m8602getUnspecifiedvmbZdU8(), textMotion, (DefaultConstructorMarker) null), platformStyle);
    }

    /* JADX INFO: renamed from: copy-p1EtxEg$default, reason: not valid java name */
    public static /* synthetic */ TextStyle m8286copyp1EtxEg$default(TextStyle textStyle, long j, long j2, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j3, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j4, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, int i, int i2, long j5, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, int i3, int i4, TextMotion textMotion, int i5, Object obj) {
        TextMotion textMotion2;
        int i6;
        long jM8213getColor0d7_KjU = (i5 & 1) != 0 ? textStyle.spanStyle.m8213getColor0d7_KjU() : j;
        long jM8214getFontSizeXSAIIZE = (i5 & 2) != 0 ? textStyle.spanStyle.getFontSize() : j2;
        FontWeight fontWeight2 = (i5 & 4) != 0 ? textStyle.spanStyle.getFontWeight() : fontWeight;
        FontStyle fontStyleM8215getFontStyle4Lr2A7w = (i5 & 8) != 0 ? textStyle.spanStyle.getFontStyle() : fontStyle;
        FontSynthesis fontSynthesisM8216getFontSynthesisZQGJjVo = (i5 & 16) != 0 ? textStyle.spanStyle.getFontSynthesis() : fontSynthesis;
        ...
        long jM8217getLetterSpacingXSAIIZE = (i5 & 128) != 0 ? textStyle.spanStyle.getLetterSpacing() : j3;
        BaselineShift baselineShiftM8212getBaselineShift5SSeXJ0 = (i5 & 256) != 0 ? textStyle.spanStyle.getBaselineShift() : baselineShift;
        ...
        long j6 = jM8213getColor0d7_KjU;
        long jM8211getBackground0d7_KjU = (i5 & 2048) != 0 ? textStyle.spanStyle.getBackground() : j4;
        ...
        int iM8152getTextAligne0LSkKk = (i5 & 32768) != 0 ? textStyle.paragraphStyle.getTextAlign() : i;
        int iM8154getTextDirections_7Xco = (i5 & 65536) != 0 ? textStyle.paragraphStyle.getTextDirection() : i2;
        long jM8150getLineHeightXSAIIZE = (i5 & 131072) != 0 ? textStyle.paragraphStyle.getLineHeight() : j5;
        ...
        int iM8149getLineBreakrAG3T2k = (i5 & 2097152) != 0 ? textStyle.paragraphStyle.getLineBreak() : i3;
        int iM8147getHyphensvmbZdU8 = (i5 & 4194304) != 0 ? textStyle.paragraphStyle.getHyphens() : i4;
        if ((i5 & 8388608) != 0) {
            i6 = iM8147getHyphensvmbZdU8;
            textMotion2 = textStyle.paragraphStyle.getTextMotion();
        } else {
            textMotion2 = textMotion;
            i6 = iM8147getHyphensvmbZdU8;
        }
        return textStyle.m8299copyp1EtxEg(j6, jM8214getFontSizeXSAIIZE, fontWeight2, fontStyleM8215getFontStyle4Lr2A7w, fontSynthesisM8216getFontSynthesisZQGJjVo, fontFamily2, fontFeatureSettings, jM8217getLetterSpacingXSAIIZE, baselineShiftM8212getBaselineShift5SSeXJ0, textGeometricTransform2, localeList2, jM8211getBackground0d7_KjU, textDecoration3, shadow2, drawStyle2, iM8152getTextAligne0LSkKk, iM8154getTextDirections_7Xco, jM8150getLineHeightXSAIIZE, textIndent2, platformTextStyle2, lineHeightStyle2, iM8149getLineBreakrAG3T2k, i6, textMotion2);
    }

    /* JADX INFO: renamed from: copy-p1EtxEg, reason: not valid java name */
    public final TextStyle m8299copyp1EtxEg(long color, long fontSize, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String fontFeatureSettings, long letterSpacing, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, int textAlign, int textDirection, long lineHeight, TextIndent textIndent, PlatformTextStyle platformStyle, LineHeightStyle lineHeightStyle, int lineBreak, int hyphens, TextMotion textMotion) {
        TextForegroundStyle textForegroundStyleM8735from8_81llA;
        if (Color.m5969equalsimpl0(color, this.spanStyle.m8213getColor0d7_KjU())) {
            textForegroundStyleM8735from8_81llA = this.spanStyle.getTextForegroundStyle();
        } else {
        ...
        return new TextStyle(new SpanStyle(textForegroundStyleM8735from8_81llA, fontSize, fontWeight, fontStyle, fontSynthesis, fontFamily, fontFeatureSettings, letterSpacing, baselineShift, textGeometricTransform, localeList, background, textDecoration, shadow, platformStyle != null ? platformStyle.getSpanStyle() : null, drawStyle, (DefaultConstructorMarker) null), new ParagraphStyle(textAlign, textDirection, lineHeight, textIndent, platformStyle != null ? platformStyle.getParagraphStyle() : null, lineHeightStyle, lineBreak, hyphens, textMotion, (DefaultConstructorMarker) null), platformStyle);
    }

    /* JADX INFO: renamed from: copy-aIRg9q4$default, reason: not valid java name */
    public static /* synthetic */ TextStyle m8285copyaIRg9q4$default(TextStyle textStyle, Brush brush, float f2, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long j4, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion, int i, Object obj) {
        TextMotion textMotion2;
        Hyphens hyphens2;
        ...
        float alpha = (i & 2) != 0 ? textStyle.spanStyle.getAlpha() : f2;
        long jM8214getFontSizeXSAIIZE = (i & 4) != 0 ? textStyle.spanStyle.getFontSize() : j;
        FontWeight fontWeight3 = (i & 8) != 0 ? textStyle.spanStyle.getFontWeight() : fontWeight;
        FontStyle fontStyleM8215getFontStyle4Lr2A7w = (i & 16) != 0 ? textStyle.spanStyle.getFontStyle() : fontStyle;
        FontSynthesis fontSynthesisM8216getFontSynthesisZQGJjVo = (i & 32) != 0 ? textStyle.spanStyle.getFontSynthesis() : fontSynthesis;
        ...
        long jM8217getLetterSpacingXSAIIZE = (i & 256) != 0 ? textStyle.spanStyle.getLetterSpacing() : j2;
        BaselineShift baselineShiftM8212getBaselineShift5SSeXJ0 = (i & 512) != 0 ? textStyle.spanStyle.getBaselineShift() : baselineShift;
        ...
        long jM8211getBackground0d7_KjU = (i & 4096) != 0 ? textStyle.spanStyle.getBackground() : j3;
        float f4 = alpha;
        ...
        TextAlign textAlignM8701boximpl = (i & 65536) != 0 ? TextAlign.m8701boximpl(textStyle.paragraphStyle.getTextAlign()) : textAlign;
        TextDirection textDirectionM8718boximpl = (i & 131072) != 0 ? TextDirection.m8718boximpl(textStyle.paragraphStyle.getTextDirection()) : textDirection;
        long jM8150getLineHeightXSAIIZE = (i & 262144) != 0 ? textStyle.paragraphStyle.getLineHeight() : j4;
        ...
        LineBreak lineBreakM8606boximpl = (i & 4194304) != 0 ? LineBreak.m8606boximpl(textStyle.paragraphStyle.getLineBreak()) : lineBreak;
        Hyphens hyphensM8593boximpl = (i & 8388608) != 0 ? Hyphens.m8593boximpl(textStyle.paragraphStyle.getHyphens()) : hyphens;
        if ((i & 16777216) != 0) {
            hyphens2 = hyphensM8593boximpl;
            textMotion2 = textStyle.paragraphStyle.getTextMotion();
            textDecoration2 = textDecoration3;
            drawStyle2 = drawStyle3;
            textAlign2 = textAlignM8701boximpl;
            textDirection2 = textDirectionM8718boximpl;
            textIndent2 = textIndent3;
            platformTextStyle2 = platformTextStyle3;
            lineHeightStyle2 = lineHeightStyle3;
            lineBreak2 = lineBreakM8606boximpl;
            shadow2 = shadow3;
            j5 = jM8214getFontSizeXSAIIZE;
            fontWeight2 = fontWeight3;
            fontStyle2 = fontStyleM8215getFontStyle4Lr2A7w;
            fontSynthesis2 = fontSynthesisM8216getFontSynthesisZQGJjVo;
            fontFamily2 = fontFamily3;
            str2 = fontFeatureSettings;
            j6 = jM8217getLetterSpacingXSAIIZE;
            baselineShift2 = baselineShiftM8212getBaselineShift5SSeXJ0;
            textGeometricTransform2 = textGeometricTransform3;
            localeList2 = localeList3;
            j7 = jM8211getBackground0d7_KjU;
            j8 = jM8150getLineHeightXSAIIZE;
            brush2 = brush;
            f3 = f4;
        ...
        return textStyle2.m8298copyaIRg9q4(brush2, f3, j5, fontWeight2, fontStyle2, fontSynthesis2, fontFamily2, str2, j6, baselineShift2, textGeometricTransform2, localeList2, j7, textDecoration2, shadow2, drawStyle2, textAlign2, textDirection2, j8, textIndent2, platformTextStyle2, lineHeightStyle2, lineBreak2, hyphens2, textMotion2);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "copy constructors that take nullable TextAlign, TextDirection, LineBreak, and Hyphens are deprecated. Please use a new constructor where these parameters are non-nullable. Null value has been replaced by a special Unspecified object for performance reason.")
    /* JADX INFO: renamed from: copy-aIRg9q4, reason: not valid java name */
    public final /* synthetic */ TextStyle m8298copyaIRg9q4(Brush brush, float alpha, long fontSize, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String fontFeatureSettings, long letterSpacing, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, TextAlign textAlign, TextDirection textDirection, long lineHeight, TextIndent textIndent, PlatformTextStyle platformStyle, LineHeightStyle lineHeightStyle, LineBreak lineBreak, Hyphens hyphens, TextMotion textMotion) {
    ...
    public static /* synthetic */ TextStyle m8284copyNs73l9s$default(TextStyle textStyle, Brush brush, float f2, long j, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String str, long j2, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long j3, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, int i, int i2, long j4, TextIndent textIndent, PlatformTextStyle platformTextStyle, LineHeightStyle lineHeightStyle, int i3, int i4, TextMotion textMotion, int i5, Object obj) {
        TextMotion textMotion2;
        int i6;
        TextDecoration textDecoration2;
        DrawStyle drawStyle2;
        ...
        TextStyle textStyle2;
        FontFamily fontFamily2;
        float alpha = (i5 & 2) != 0 ? textStyle.spanStyle.getAlpha() : f2;
        long jM8214getFontSizeXSAIIZE = (i5 & 4) != 0 ? textStyle.spanStyle.getFontSize() : j;
        FontWeight fontWeight3 = (i5 & 8) != 0 ? textStyle.spanStyle.getFontWeight() : fontWeight;
        FontStyle fontStyleM8215getFontStyle4Lr2A7w = (i5 & 16) != 0 ? textStyle.spanStyle.getFontStyle() : fontStyle;
        FontSynthesis fontSynthesisM8216getFontSynthesisZQGJjVo = (i5 & 32) != 0 ? textStyle.spanStyle.getFontSynthesis() : fontSynthesis;
        ...
        long jM8217getLetterSpacingXSAIIZE = (i5 & 256) != 0 ? textStyle.spanStyle.getLetterSpacing() : j2;
        BaselineShift baselineShiftM8212getBaselineShift5SSeXJ0 = (i5 & 512) != 0 ? textStyle.spanStyle.getBaselineShift() : baselineShift;
        ...
        long jM8211getBackground0d7_KjU = (i5 & 4096) != 0 ? textStyle.spanStyle.getBackground() : j3;
        float f4 = alpha;
        ...
        int iM8152getTextAligne0LSkKk = (i5 & 65536) != 0 ? textStyle.paragraphStyle.getTextAlign() : i;
        int iM8154getTextDirections_7Xco = (i5 & 131072) != 0 ? textStyle.paragraphStyle.getTextDirection() : i2;
        long jM8150getLineHeightXSAIIZE = (i5 & 262144) != 0 ? textStyle.paragraphStyle.getLineHeight() : j4;
        ...
        int iM8149getLineBreakrAG3T2k = (i5 & 4194304) != 0 ? textStyle.paragraphStyle.getLineBreak() : i3;
        int iM8147getHyphensvmbZdU8 = (i5 & 8388608) != 0 ? textStyle.paragraphStyle.getHyphens() : i4;
        if ((i5 & 16777216) != 0) {
            i6 = iM8147getHyphensvmbZdU8;
            textMotion2 = textStyle.paragraphStyle.getTextMotion();
            textDecoration2 = textDecoration3;
            drawStyle2 = drawStyle3;
            i7 = iM8152getTextAligne0LSkKk;
            i8 = iM8154getTextDirections_7Xco;
            textIndent2 = textIndent3;
            platformTextStyle2 = platformTextStyle3;
            lineHeightStyle2 = lineHeightStyle3;
            i9 = iM8149getLineBreakrAG3T2k;
            shadow2 = shadow3;
            j5 = jM8214getFontSizeXSAIIZE;
            fontWeight2 = fontWeight3;
            fontStyle2 = fontStyleM8215getFontStyle4Lr2A7w;
        ...
        return textStyle2.m8297copyNs73l9s(brush2, f3, j5, fontWeight2, fontStyle2, fontSynthesis2, fontFamily2, str2, j6, baselineShift2, textGeometricTransform2, localeList2, j7, textDecoration2, shadow2, drawStyle2, i7, i8, j8, textIndent2, platformTextStyle2, lineHeightStyle2, i9, i6, textMotion2);
    }

    /* JADX INFO: renamed from: copy-Ns73l9s, reason: not valid java name */
    public final TextStyle m8297copyNs73l9s(Brush brush, float alpha, long fontSize, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String fontFeatureSettings, long letterSpacing, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, TextDecoration textDecoration, Shadow shadow, DrawStyle drawStyle, int textAlign, int textDirection, long lineHeight, TextIndent textIndent, PlatformTextStyle platformStyle, LineHeightStyle lineHeightStyle, int lineBreak, int hyphens, TextMotion textMotion) {
    ...
    public final long m8303getColor0d7_KjU() {
        return this.spanStyle.m8213getColor0d7_KjU();
    }
    ...
    public final long m8304getFontSizeXSAIIZE() {
    ...
    public final FontStyle m8305getFontStyle4Lr2A7w() {
        return this.spanStyle.getFontStyle();
    }

    /* JADX INFO: renamed from: getFontSynthesis-ZQGJjVo, reason: not valid java name */
    public final FontSynthesis m8306getFontSynthesisZQGJjVo() {
    ...
    public final long m8309getLetterSpacingXSAIIZE() {
        return this.spanStyle.getLetterSpacing();
    }

    /* JADX INFO: renamed from: getBaselineShift-5SSeXJ0, reason: not valid java name */
    public final BaselineShift m8302getBaselineShift5SSeXJ0() {
    ...
    public final long m8301getBackground0d7_KjU() {
    ...
    public final int m8314getTextAligne0LSkKk() {
        return this.paragraphStyle.getTextAlign();
    }

    /* JADX INFO: renamed from: getTextAlign-buA522U, reason: not valid java name */
    public final TextAlign m8313getTextAlignbuA522U() {
        return TextAlign.m8701boximpl(m8314getTextAligne0LSkKk());
    }

    /* JADX INFO: renamed from: getTextDirection-s_7X-co, reason: not valid java name */
    public final int m8316getTextDirections_7Xco() {
        return this.paragraphStyle.getTextDirection();
    }

    /* JADX INFO: renamed from: getTextDirection-mmuk1to, reason: not valid java name */
    public final TextDirection m8315getTextDirectionmmuk1to() {
        return TextDirection.m8718boximpl(m8316getTextDirections_7Xco());
    }

    /* JADX INFO: renamed from: getLineHeight-XSAIIZE, reason: not valid java name */
    public final long m8312getLineHeightXSAIIZE() {
    ...
    public String toString() {
        ...
        sb.append((Object) Color.m5976toStringimpl(m8303getColor0d7_KjU())).append(", brush=").append(getBrush()).append(", alpha=").append(getAlpha()).append(", fontSize=").append((Object) TextUnit.m9031toStringimpl(m8304getFontSizeXSAIIZE())).append(", fontWeight=").append(getFontWeight()).append(", fontStyle=").append(m8305getFontStyle4Lr2A7w()).append(", fontSynthesis=").append(m8306getFontSynthesisZQGJjVo()).append(", fontFamily=").append(getFontFamily()).append(", fontFeatureSettings=").append(getFontFeatureSettings()).append(", letterSpacing=").append((Object) TextUnit.m9031toStringimpl(m8309getLetterSpacingXSAIIZE())).append(", baselineShift=").append(m8302getBaselineShift5SSeXJ0()).append(", textGeometricTransform=");
        sb.append(getTextGeometricTransform()).append(", localeList=").append(getLocaleList()).append(", background=").append((Object) Color.m5976toStringimpl(m8301getBackground0d7_KjU())).append(", textDecoration=").append(getTextDecoration()).append(", shadow=").append(getShadow()).append(", drawStyle=").append(getDrawStyle()).append(", textAlign=").append((Object) TextAlign.m8706toStringimpl(m8314getTextAligne0LSkKk())).append(", textDirection=").append((Object) TextDirection.m8723toStringimpl(m8316getTextDirections_7Xco())).append(", lineHeight=").append((Object) TextUnit.m9031toStringimpl(m8312getLineHeightXSAIIZE())).append(", textIndent=").append(getTextIndent()).append(", platformStyle=").append(this.platformStyle).append(", lineHeightStyle=").append(getLineHeightStyle());
        sb.append(", lineBreak=").append((Object) LineBreak.m8617toStringimpl(m8311getLineBreakrAG3T2k())).append(", hyphens=").append((Object) Hyphens.m8598toStringimpl(m8308getHyphensvmbZdU8())).append(", textMotion=").append(getTextMotion()).append(')');
        return sb.toString();
    }
