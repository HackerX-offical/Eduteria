...
public final class TextStyleKt {
    ...
    public static final int m8319resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int i) {
        if (TextDirection.m8721equalsimpl0(i, TextDirection.INSTANCE.m8725getContents_7Xco())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                return TextDirection.INSTANCE.m8726getContentOrLtrs_7Xco();
            }
            if (i2 != 2) {
                throw new NoWhenBranchMatchedException();
            }
            return TextDirection.INSTANCE.m8727getContentOrRtls_7Xco();
        }
        if (!TextDirection.m8721equalsimpl0(i, TextDirection.INSTANCE.m8730getUnspecifieds_7Xco())) {
            return i;
        }
