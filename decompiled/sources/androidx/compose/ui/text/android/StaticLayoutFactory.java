...
public final class StaticLayoutFactory {
    ...
    public static /* synthetic */ StaticLayout create$default(StaticLayoutFactory staticLayoutFactory, CharSequence charSequence, TextPaint textPaint, int i, int i2, int i3, TextDirectionHeuristic textDirectionHeuristic, Layout.Alignment alignment, int i4, TextUtils.TruncateAt truncateAt, int i5, float f2, float f3, int i6, boolean z, boolean z2, int i7, int i8, int i9, int i10, int[] iArr, int[] iArr2, int i11, Object obj) {
        ...
        float f4 = (i11 & 1024) != 0 ? 1.0f : f2;
        float f5 = (i11 & 2048) != 0 ? 0.0f : f3;
        ...
        return staticLayoutFactory2.create(charSequence2, textPaint2, i12, i13, length, dEFAULT_TEXT_DIRECTION_HEURISTIC$ui_text, dEFAULT_LAYOUT_ALIGNMENT$ui_text, i14, truncateAt2, i15, f4, f5, i16, z3, z4, i17, i18, i19, i20, iArr4, iArr3);
    }
