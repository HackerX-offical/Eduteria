...
public final class TextAndroidCanvas extends Canvas {
    ...
    @Override // android.graphics.Canvas
    public void drawARGB(int a2, int r, int g2, int b2) {
        getNativeCanvas().drawARGB(a2, r, g2, b2);
    }
    ...
    @Override // android.graphics.Canvas
    public void drawRGB(int r, int g2, int b2) {
        getNativeCanvas().drawRGB(r, g2, b2);
    }
