...
public final class TextLayout {
    ...
    public TextLayout(CharSequence charSequence, float f2, TextPaint textPaint, int i, TextUtils.TruncateAt truncateAt, int i2, float f3, float f4, boolean z, boolean z2, int i3, int i4, int i5, int i6, int i7, int i8, int[] iArr, int[] iArr2, LayoutIntrinsics layoutIntrinsics) {
        boolean z3;
        int i9;
        boolean z4;
        ...
        try {
            ...
            if (boringMetrics != null && layoutIntrinsics.getMaxIntrinsicWidth() <= f2 && !z6) {
                z3 = true;
                ...
                textDirectionHeuristic = textDirectionHeuristic2;
                textPaint2 = textPaint;
                staticLayoutCreate = StaticLayoutFactory.INSTANCE.create(charSequence, textPaint2, iCeil, 0, charSequence.length(), textDirectionHeuristic, alignment, i9, truncateAt, (int) Math.ceil(d2), f3, f4, i8, z, z2, i4, i5, i6, i7, iArr, iArr2);
            }
            ...
            this.lineCount = iMin;
            int i10 = iMin - 1;
            this.didExceedMaxLines = (iMin >= i9 && (staticLayoutCreate.getEllipsisCount(i10) > 0 || staticLayoutCreate.getLineEnd(i10) != charSequence.length())) ? z3 : z4;
            ...
            if (lineHeightSpans == null || (lineHeightStyleSpan2 = (LineHeightStyleSpan) ArraysKt.firstOrNull(lineHeightSpans)) == null) {
                ...
                z5 = (lineHeightStyleSpan2.getTrimFirstLineTop() && LineHeightStyle.Mode.m8681equalsimpl0(lineHeightStyleSpan2.getMode(), LineHeightStyle.Mode.INSTANCE.m8687getTightlzQqcRY())) ? z3 : z4;
            }
            boolean z7 = (lineHeightSpans == null || (lineHeightStyleSpan = (LineHeightStyleSpan) ArraysKt.firstOrNull(lineHeightSpans)) == null || !lineHeightStyleSpan.getTrimLastLineBottom() || !LineHeightStyle.Mode.m8681equalsimpl0(lineHeightStyleSpan.getMode(), LineHeightStyle.Mode.INSTANCE.m8687getTightlzQqcRY())) ? z4 : z3;
            if (!z5 || !z7) {
                long verticalPaddings = TextLayout_androidKt.getVerticalPaddings(this);
                jVerticalPaddings = TextLayout_androidKt.VerticalPaddings(z5 ? z4 : VerticalPaddings.m8326getTopPaddingimpl(verticalPaddings), z7 ? z4 : VerticalPaddings.m8325getBottomPaddingimpl(verticalPaddings));
            } else {
            ...
            this.topPadding = Math.max(VerticalPaddings.m8326getTopPaddingimpl(jVerticalPaddings), VerticalPaddings.m8326getTopPaddingimpl(lineHeightPaddings));
            this.bottomPadding = Math.max(VerticalPaddings.m8325getBottomPaddingimpl(jVerticalPaddings), VerticalPaddings.m8325getBottomPaddingimpl(lineHeightPaddings));
            ...
            this.lastLineExtra = lastLineMetrics != null ? lastLineMetrics.bottom - ((int) getLineHeight(i10)) : z4;
    ...
    public /* synthetic */ TextLayout(CharSequence charSequence, float f2, TextPaint textPaint, int i, TextUtils.TruncateAt truncateAt, int i2, float f3, float f4, boolean z, boolean z2, int i3, int i4, int i5, int i6, int i7, int i8, int[] iArr, int[] iArr2, LayoutIntrinsics layoutIntrinsics, int i9, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        float f5 = (i9 & 64) != 0 ? 1.0f : f3;
        float f6 = (i9 & 128) != 0 ? 0.0f : f4;
        ...
        this(charSequence2, f2, textPaint2, i10, truncateAt2, i11, f5, f6, z3, z4, i12, i13, i14, i15, i16, i17, iArr3, iArr4, layoutIntrinsics2);
    }
