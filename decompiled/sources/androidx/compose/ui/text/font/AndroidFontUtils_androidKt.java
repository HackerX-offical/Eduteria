...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m8338getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m8387equalsimpl0(i, FontStyle.INSTANCE.m8393getItalic_LCdwA()));
    }
}
