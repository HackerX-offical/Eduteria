...
public final class FontFamilyResolver_androidKt {
    ...
    public static final FontFamily.Resolver emptyCacheFontFamilyResolver(Context context) {
        PlatformFontFamilyTypefaceAdapter platformFontFamilyTypefaceAdapter = null;
        return new FontFamilyResolverImpl(new AndroidFontLoader(context), 0 == true ? 1 : 0, new TypefaceRequestCache(), new FontListFontFamilyTypefaceAdapter(new AsyncTypefaceCache(), null, 2, 0 == true ? 1 : 0), platformFontFamilyTypefaceAdapter, 18, null);
    }

    /* JADX INFO: renamed from: resolveAsTypeface-Wqqsr6A$default, reason: not valid java name */
    public static /* synthetic */ State m8362resolveAsTypefaceWqqsr6A$default(FontFamily.Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            fontFamily = null;
        }
        if ((i3 & 2) != 0) {
        ...
        if ((i3 & 8) != 0) {
            i2 = FontSynthesis.INSTANCE.m8404getAllGVVA2EU();
        }
        return m8361resolveAsTypefaceWqqsr6A(resolver, fontFamily, fontWeight, i, i2);
    }

    /* JADX INFO: renamed from: resolveAsTypeface-Wqqsr6A, reason: not valid java name */
    public static final State<android.graphics.Typeface> m8361resolveAsTypefaceWqqsr6A(FontFamily.Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
        State stateMo8359resolveDPcqOEQ = resolver.mo8359resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
        Intrinsics.checkNotNull(stateMo8359resolveDPcqOEQ, "null cannot be cast to non-null type androidx.compose.runtime.State<android.graphics.Typeface>");
        return stateMo8359resolveDPcqOEQ;
    }
}
