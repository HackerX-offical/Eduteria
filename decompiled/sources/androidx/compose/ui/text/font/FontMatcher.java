...
public final class FontMatcher {
    ...
    public final List<Font> m8381matchFontRetOiIg(FontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        if (!(fontFamily instanceof FontListFontFamily)) {
            throw new IllegalArgumentException("Only FontFamily instances that presents a list of Fonts can be used");
        }
        return m8382matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, fontStyle);
    }

    /* JADX INFO: renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m8382matchFontRetOiIg(FontListFontFamily fontFamily, FontWeight fontWeight, int fontStyle) {
        return m8383matchFontRetOiIg(fontFamily.getFonts(), fontWeight, fontStyle);
    }

    /* JADX INFO: renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m8383matchFontRetOiIg(List<? extends Font> fontList, FontWeight fontWeight, int fontStyle) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            Font font2 = font;
            if (Intrinsics.areEqual(font2.getWeight(), fontWeight) && FontStyle.m8387equalsimpl0(font2.getStyle(), fontStyle)) {
                arrayList.add(font);
            }
        }
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            ...
            if (FontStyle.m8387equalsimpl0(font3.getStyle(), fontStyle)) {
        ...
        if (fontWeight.compareTo(FontWeight.INSTANCE.getW400()) >= 0) {
            if (fontWeight.compareTo(FontWeight.INSTANCE.getW500()) <= 0) {
                ...
                for (int i5 = 0; i5 < size4; i5++) {
                    ...
                    if (Intrinsics.areEqual(((Font) obj).getWeight(), fontWeight3)) {
                        arrayList5.add(obj);
                    }
                }
