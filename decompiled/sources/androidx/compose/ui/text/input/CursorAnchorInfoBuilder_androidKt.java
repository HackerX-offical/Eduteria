...
public final class CursorAnchorInfoBuilder_androidKt {
    ...
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        int iM8271getMinimpl = TextRange.m8271getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(iM8271getMinimpl, TextRange.m8270getMaximpl(textFieldValue.getSelection()));
        if (z) {
            setInsertionMarker(builder, iM8271getMinimpl, offsetMapping, textLayoutResult, rect);
        }
        if (z2) {
            ...
            int iM8270getMaximpl = composition2 != null ? TextRange.m8270getMaximpl(composition2.getPackedValue()) : -1;
            if (iM8271getMinimpl2 >= 0 && iM8271getMinimpl2 < iM8270getMaximpl) {
                builder.setComposingText(iM8271getMinimpl2, textFieldValue.getText().subSequence(iM8271getMinimpl2, iM8270getMaximpl));
                addCharacterBounds(builder, iM8271getMinimpl2, iM8270getMaximpl, offsetMapping, textLayoutResult, rect);
            }
        }
    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder addCharacterBounds(android.view.inputmethod.CursorAnchorInfo.Builder r17, int r18, int r19, androidx.compose.ui.text.input.OffsetMapping r20, androidx.compose.ui.text.TextLayoutResult r21, androidx.compose.ui.geometry.Rect r22) {
        /*
            ...
            r5 = 0
            r7.m8106fillBoundingBoxes8ffj60Q(r8, r6, r5)
            r11 = r2
        L23:
            if (r11 >= r0) goto L88
