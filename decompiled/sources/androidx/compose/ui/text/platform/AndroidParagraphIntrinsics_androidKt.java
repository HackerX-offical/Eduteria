...
public final class AndroidParagraphIntrinsics_androidKt {
    ...
    public static /* synthetic */ int m8537resolveTextDirectionHeuristicsHklW4sA$default(int i, LocaleList localeList, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            localeList = null;
        }
        return m8536resolveTextDirectionHeuristicsHklW4sA(i, localeList);
    }

    /* JADX INFO: renamed from: resolveTextDirectionHeuristics-HklW4sA, reason: not valid java name */
    public static final int m8536resolveTextDirectionHeuristicsHklW4sA(int i, LocaleList localeList) {
        Locale platformLocale;
        if (TextDirection.m8721equalsimpl0(i, TextDirection.INSTANCE.m8726getContentOrLtrs_7Xco())) {
            return 2;
        }
        if (TextDirection.m8721equalsimpl0(i, TextDirection.INSTANCE.m8727getContentOrRtls_7Xco())) {
            return 3;
        }
        if (TextDirection.m8721equalsimpl0(i, TextDirection.INSTANCE.m8728getLtrs_7Xco())) {
            return 0;
        }
        if (TextDirection.m8721equalsimpl0(i, TextDirection.INSTANCE.m8729getRtls_7Xco())) {
            return 1;
        }
        if (TextDirection.m8721equalsimpl0(i, TextDirection.INSTANCE.m8725getContents_7Xco()) || TextDirection.m8721equalsimpl0(i, TextDirection.INSTANCE.m8730getUnspecifieds_7Xco())) {
    ...
    public static final boolean getHasEmojiCompat(TextStyle textStyle) {
        ...
        return !(((platformStyle == null || (paragraphStyle = platformStyle.getParagraphStyle()) == null) ? null : EmojiSupportMatch.m8093boximpl(paragraphStyle.getEmojiSupportMatch())) == null ? false : EmojiSupportMatch.m8096equalsimpl0(r1.getValue(), EmojiSupportMatch.INSTANCE.m8102getNone_3YsG6Y()));
    }
}
