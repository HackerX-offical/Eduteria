...
public final class PlaceholderExtensions_androidKt {
    ...
    private static /* synthetic */ void m8550getSpanUnitR2X_6o$annotations(long j) {
    }

    /* JADX INFO: renamed from: getSpanVerticalAlign-do9X-Gg$annotations, reason: not valid java name */
    private static /* synthetic */ void m8552getSpanVerticalAligndo9XGg$annotations(int i) {
    }
    ...
    private static final void setPlaceholder(Spannable spannable, Placeholder placeholder, int i, int i2, Density density) {
        ...
        SpannableExtensions_androidKt.setSpan(spannable, new PlaceholderSpan(TextUnit.m9024getValueimpl(placeholder.getWidth()), m8549getSpanUnitR2X_6o(placeholder.getWidth()), TextUnit.m9024getValueimpl(placeholder.getHeight()), m8549getSpanUnitR2X_6o(placeholder.getHeight()), density, m8551getSpanVerticalAligndo9XGg(placeholder.getPlaceholderVerticalAlign())), i, i2);
    }

    /* JADX INFO: renamed from: getSpanUnit--R2X_6o, reason: not valid java name */
    private static final int m8549getSpanUnitR2X_6o(long j) {
        ...
        return TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9056getEmUIouoOA()) ? 1 : 2;
    }

    /* JADX INFO: renamed from: getSpanVerticalAlign-do9X-Gg, reason: not valid java name */
    private static final int m8551getSpanVerticalAligndo9XGg(int i) {
        if (PlaceholderVerticalAlign.m8164equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m8168getAboveBaselineJ6kI3mc())) {
            return 0;
        }
        if (PlaceholderVerticalAlign.m8164equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m8174getTopJ6kI3mc())) {
            return 1;
        }
        if (PlaceholderVerticalAlign.m8164equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m8169getBottomJ6kI3mc())) {
            return 2;
        }
        if (PlaceholderVerticalAlign.m8164equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m8170getCenterJ6kI3mc())) {
            return 3;
        }
        if (PlaceholderVerticalAlign.m8164equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m8173getTextTopJ6kI3mc())) {
            return 4;
        }
        if (PlaceholderVerticalAlign.m8164equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m8171getTextBottomJ6kI3mc())) {
            return 5;
        }
        if (PlaceholderVerticalAlign.m8164equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m8172getTextCenterJ6kI3mc())) {
            return 6;
        }
