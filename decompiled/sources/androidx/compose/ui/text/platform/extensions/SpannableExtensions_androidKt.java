...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f2, Density density) {
        float fM9024getValueimpl;
        if (textIndent != null) {
            if ((TextUnit.m9021equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m9021equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnit.m9022getRawTypeimpl(textIndent.getFirstLine()) == 0 || TextUnit.m9022getRawTypeimpl(textIndent.getRestLine()) == 0) {
                return;
            }
            long jM9023getTypeUIouoOA = TextUnit.m9023getTypeUIouoOA(textIndent.getFirstLine());
            float fM9024getValueimpl2 = 0.0f;
            if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9057getSpUIouoOA())) {
                fM9024getValueimpl = density.mo487toPxR2X_6o(textIndent.getFirstLine());
            } else {
                fM9024getValueimpl = TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9056getEmUIouoOA()) ? TextUnit.m9024getValueimpl(textIndent.getFirstLine()) * f2 : 0.0f;
            }
            long jM9023getTypeUIouoOA2 = TextUnit.m9023getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA2, TextUnitType.INSTANCE.m9057getSpUIouoOA())) {
                fM9024getValueimpl2 = density.mo487toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA2, TextUnitType.INSTANCE.m9056getEmUIouoOA())) {
                fM9024getValueimpl2 = TextUnit.m9024getValueimpl(textIndent.getRestLine()) * f2;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(fM9024getValueimpl), (int) Math.ceil(fM9024getValueimpl2)), 0, spannable.length());
        }
    }

    public static final void setBulletSpans(Spannable spannable, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, float f2, Density density, TextIndent textIndent) {
        Density density2 = density;
        float fM9024getValueimpl = 0.0f;
        if (textIndent != null) {
            long jM9023getTypeUIouoOA = TextUnit.m9023getTypeUIouoOA(textIndent.getFirstLine());
            if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9057getSpUIouoOA())) {
                fM9024getValueimpl = density2.mo487toPxR2X_6o(textIndent.getFirstLine());
            } else if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9056getEmUIouoOA())) {
                fM9024getValueimpl = TextUnit.m9024getValueimpl(textIndent.getFirstLine()) * f2;
            }
        }
        float f3 = fM9024getValueimpl;
        int size = list.size();
        int i = 0;
        while (i < size) {
            ...
            if (bullet != null) {
                float fM8554resolveBulletTextUnitToPxo2QH7mI = m8554resolveBulletTextUnitToPxo2QH7mI(bullet.getWidth(), f2, density2);
                float fM8554resolveBulletTextUnitToPxo2QH7mI2 = m8554resolveBulletTextUnitToPxo2QH7mI(bullet.getHeight(), f2, density2);
                float fM8554resolveBulletTextUnitToPxo2QH7mI3 = m8554resolveBulletTextUnitToPxo2QH7mI(bullet.getPadding(), f2, density2);
                if (!Float.isNaN(fM8554resolveBulletTextUnitToPxo2QH7mI) && !Float.isNaN(fM8554resolveBulletTextUnitToPxo2QH7mI2) && !Float.isNaN(fM8554resolveBulletTextUnitToPxo2QH7mI3)) {
                    setSpan(spannable, new CustomBulletSpan(bullet.getShape(), fM8554resolveBulletTextUnitToPxo2QH7mI, fM8554resolveBulletTextUnitToPxo2QH7mI2, fM8554resolveBulletTextUnitToPxo2QH7mI3, bullet.getBrush(), bullet.getAlpha(), bullet.getDrawStyle(), density2, f3), range.getStart(), range.getEnd());
                }
            }
            i++;
            density2 = density;
    ...
    private static final float m8554resolveBulletTextUnitToPxo2QH7mI(long j, float f2, Density density) {
        if (TextUnit.m9021equalsimpl0(j, TextUnit.INSTANCE.m9035getUnspecifiedXSAIIZE())) {
            return f2;
        }
        long jM9023getTypeUIouoOA = TextUnit.m9023getTypeUIouoOA(j);
        if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9057getSpUIouoOA())) {
            return density.mo487toPxR2X_6o(j);
        }
        if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9056getEmUIouoOA())) {
            return TextUnit.m9024getValueimpl(j) * f2;
        }
        return Float.NaN;
    }

    /* JADX INFO: renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m8560setLineHeightKmRG4DE(Spannable spannable, long j, float f2, Density density, LineHeightStyle lineHeightStyle) {
        float fM8555resolveLineHeightInPxo2QH7mI = m8555resolveLineHeightInPxo2QH7mI(j, f2, density);
        if (Float.isNaN(fM8555resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        Spannable spannable2 = spannable;
        setSpan(spannable, new LineHeightStyleSpan(fM8555resolveLineHeightInPxo2QH7mI, 0, (spannable2.length() == 0 || StringsKt.last(spannable2) == '\n') ? spannable.length() + 1 : spannable.length(), LineHeightStyle.Trim.m8693isTrimFirstLineTopimpl$ui_text(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m8694isTrimLastLineBottomimpl$ui_text(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment(), lineHeightStyle.getMode(), null), 0, spannable.length());
    }

    /* JADX INFO: renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m8561setLineHeightr9BaKPg(Spannable spannable, long j, float f2, Density density) {
        float fM8555resolveLineHeightInPxo2QH7mI = m8555resolveLineHeightInPxo2QH7mI(j, f2, density);
        if (Float.isNaN(fM8555resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        setSpan(spannable, new LineHeightSpan(fM8555resolveLineHeightInPxo2QH7mI), 0, spannable.length());
    }

    /* JADX INFO: renamed from: resolveLineHeightInPx-o2QH7mI, reason: not valid java name */
    private static final float m8555resolveLineHeightInPxo2QH7mI(long j, float f2, Density density) {
        float fM9024getValueimpl;
        long jM9023getTypeUIouoOA = TextUnit.m9023getTypeUIouoOA(j);
        if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9057getSpUIouoOA())) {
            ...
            fM9024getValueimpl = TextUnit.m9024getValueimpl(j) / TextUnit.m9024getValueimpl(density.mo491toSpkPz2Gy4(f2));
        } else {
            if (!TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9056getEmUIouoOA())) {
                return Float.NaN;
            }
            fM9024getValueimpl = TextUnit.m9024getValueimpl(j);
        }
        return fM9024getValueimpl * f2;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle textStyle, List<? extends AnnotatedString.Range<? extends AnnotatedString.Annotation>> list, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        MetricAffectingSpan metricAffectingSpanM8553createLetterSpacingSpaneAf_CNQ;
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (item instanceof SpanStyle) {
                    ...
                    if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (metricAffectingSpanM8553createLetterSpacingSpaneAf_CNQ = m8553createLetterSpacingSpaneAf_CNQ(((SpanStyle) item).getLetterSpacing(), density)) != null) {
                        setSpan(spannable, metricAffectingSpanM8553createLetterSpacingSpaneAf_CNQ, start2, end2);
                    }
                }
            }
        }
    ...
    private static final void setSpanStyle(Spannable spannable, SpanStyle spanStyle, int i, int i2, Density density) {
        m8557setBaselineShift0ocSgnM(spannable, spanStyle.getBaselineShift(), i, i2);
        m8558setColorRPmYEkk(spannable, spanStyle.m8213getColor0d7_KjU(), i, i2);
        ...
        m8559setFontSizeKmRG4DE(spannable, spanStyle.getFontSize(), density, i, i2);
        ...
        m8556setBackgroundRPmYEkk(spannable, spanStyle.getBackground(), i, i2);
    ...
    public static final Unit setFontAttributes$lambda$2(Spannable spannable, Function4 function4, SpanStyle spanStyle, int i, int i2) {
        ...
        FontStyle fontStyleM8384boximpl = FontStyle.m8384boximpl(fontStyle != null ? fontStyle.m8390unboximpl() : FontStyle.INSTANCE.m8394getNormal_LCdwA());
        FontSynthesis fontSynthesis = spanStyle.getFontSynthesis();
        spannable.setSpan(new TypefaceSpan((Typeface) function4.invoke(fontFamily, fontWeight, fontStyleM8384boximpl, FontSynthesis.m8395boximpl(fontSynthesis != null ? fontSynthesis.m8403unboximpl() : FontSynthesis.INSTANCE.m8404getAllGVVA2EU()))), i, i2, 33);
    ...
    private static final MetricAffectingSpan m8553createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long jM9023getTypeUIouoOA = TextUnit.m9023getTypeUIouoOA(j);
        if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9057getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo487toPxR2X_6o(j));
        }
        if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9056getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m9024getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        return TextUnitType.m9052equalsimpl0(TextUnit.m9023getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m9057getSpUIouoOA()) || TextUnitType.m9052equalsimpl0(TextUnit.m9023getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m9056getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m6022toArgb8_81llA(shadow.getColor()), Float.intBitsToFloat((int) (shadow.getOffset() >> 32)), Float.intBitsToFloat((int) (shadow.getOffset() & 4294967295L)), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m8556setBackgroundRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new BackgroundColorSpan(ColorKt.m6022toArgb8_81llA(j)), i, i2);
        }
    }
    ...
    public static final void m8559setFontSizeKmRG4DE(Spannable spannable, long j, Density density, int i, int i2) {
        long jM9023getTypeUIouoOA = TextUnit.m9023getTypeUIouoOA(j);
        if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9057getSpUIouoOA())) {
            setSpan(spannable, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo487toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9056getEmUIouoOA())) {
            setSpan(spannable, new RelativeSizeSpan(TextUnit.m9024getValueimpl(j)), i, i2);
        }
    }
    ...
    public static final void m8558setColorRPmYEkk(Spannable spannable, long j, int i, int i2) {
        if (j != 16) {
            setSpan(spannable, new ForegroundColorSpan(ColorKt.m6022toArgb8_81llA(j)), i, i2);
        }
    }

    /* JADX INFO: renamed from: setBaselineShift-0ocSgnM, reason: not valid java name */
    private static final void m8557setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m8576unboximpl()), i, i2);
        }
    }

    private static final void setBrush(Spannable spannable, Brush brush, float f2, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m8558setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
            } else {
                if (!(brush instanceof ShaderBrush)) {
                    throw new NoWhenBranchMatchedException();
                }
                setSpan(spannable, new ShaderBrushSpan((ShaderBrush) brush, f2), i, i2);
            }
        }
    }

    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m8306getFontSynthesisZQGJjVo() != null;
    }
