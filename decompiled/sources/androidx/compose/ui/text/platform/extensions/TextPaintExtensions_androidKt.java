...
public final class TextPaintExtensions_androidKt {
    ...
    public static final SpanStyle applySpanStyle(AndroidTextPaint androidTextPaint, SpanStyle spanStyle, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4, Density density, boolean z) {
        long jM9023getTypeUIouoOA = TextUnit.m9023getTypeUIouoOA(spanStyle.getFontSize());
        if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9057getSpUIouoOA())) {
            androidTextPaint.setTextSize(density.mo487toPxR2X_6o(spanStyle.getFontSize()));
        } else if (TextUnitType.m9052equalsimpl0(jM9023getTypeUIouoOA, TextUnitType.INSTANCE.m9056getEmUIouoOA())) {
            androidTextPaint.setTextSize(androidTextPaint.getTextSize() * TextUnit.m9024getValueimpl(spanStyle.getFontSize()));
        }
        if (hasFontAttributes(spanStyle)) {
            ...
            androidTextPaint.setTypeface(function4.invoke(fontFamily, fontWeight, fontStyleM8384boximpl, FontSynthesis.m8395boximpl(fontSynthesis != null ? fontSynthesis.m8403unboximpl() : FontSynthesis.INSTANCE.m8404getAllGVVA2EU())));
        }
        ...
        androidTextPaint.m8547setColor8_81llA(spanStyle.m8213getColor0d7_KjU());
        androidTextPaint.m8545setBrush12SF9DM(spanStyle.getBrush(), Size.INSTANCE.m5800getUnspecifiedNHjbRc(), spanStyle.getAlpha());
        androidTextPaint.setShadow(spanStyle.getShadow());
        androidTextPaint.setTextDecoration(spanStyle.getTextDecoration());
        androidTextPaint.setDrawStyle(spanStyle.getDrawStyle());
        if (TextUnitType.m9052equalsimpl0(TextUnit.m9023getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m9057getSpUIouoOA()) && TextUnit.m9024getValueimpl(spanStyle.getLetterSpacing()) != 0.0f) {
            float textSize = androidTextPaint.getTextSize() * androidTextPaint.getTextScaleX();
            float fMo487toPxR2X_6o = density.mo487toPxR2X_6o(spanStyle.getLetterSpacing());
            if (textSize != 0.0f) {
                androidTextPaint.setLetterSpacing(fMo487toPxR2X_6o / textSize);
            }
        } else if (TextUnitType.m9052equalsimpl0(TextUnit.m9023getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m9056getEmUIouoOA())) {
            androidTextPaint.setLetterSpacing(TextUnit.m9024getValueimpl(spanStyle.getLetterSpacing()));
        }
        return m8562generateFallbackSpanStyle62GTOB8(spanStyle.getLetterSpacing(), z, spanStyle.getBackground(), spanStyle.getBaselineShift());
    }
    ...
    */
    private static final androidx.compose.ui.text.SpanStyle m8562generateFallbackSpanStyle62GTOB8(long r31, boolean r33, long r34, androidx.compose.ui.text.style.BaselineShift r36) {
        /*
            r0 = r34
            r2 = 1
            r3 = 0
            if (r33 == 0) goto L22
            long r4 = androidx.compose.ui.unit.TextUnit.m9023getTypeUIouoOA(r31)
            androidx.compose.ui.unit.TextUnitType$Companion r6 = androidx.compose.ui.unit.TextUnitType.INSTANCE
            long r6 = r6.m9057getSpUIouoOA()
            boolean r4 = androidx.compose.ui.unit.TextUnitType.m9052equalsimpl0(r4, r6)
            if (r4 == 0) goto L22
            float r4 = androidx.compose.ui.unit.TextUnit.m9024getValueimpl(r31)
            r5 = 0
        ...
        L23:
            ...
            long r5 = r5.m6004getUnspecified0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m5969equalsimpl0(r0, r5)
            if (r5 != 0) goto L3d
            androidx.compose.ui.graphics.Color$Companion r5 = androidx.compose.ui.graphics.Color.INSTANCE
            long r5 = r5.m6003getTransparent0d7_KjU()
            boolean r5 = androidx.compose.ui.graphics.Color.m5969equalsimpl0(r0, r5)
            if (r5 != 0) goto L3d
            r5 = r2
            goto L3e
        ...
        L3e:
            ...
            float r6 = r6.m8581getNoney9eOQZs()
            float r7 = r36.m8576unboximpl()
            boolean r6 = androidx.compose.ui.text.style.BaselineShift.m8573equalsimpl0(r7, r6)
            if (r6 != 0) goto L51
            goto L52
        L51:
            r2 = r3
        ...
        L5f:
            ...
            long r6 = r4.m9035getUnspecifiedXSAIIZE()
            r18 = r6
        L67:
            if (r5 == 0) goto L6a
            goto L70
        ...
        L79:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.extensions.TextPaintExtensions_androidKt.m8562generateFallbackSpanStyle62GTOB8(long, boolean, long, androidx.compose.ui.text.style.BaselineShift):androidx.compose.ui.text.SpanStyle");
    }
    ...
    public static final void setTextMotion(AndroidTextPaint androidTextPaint, TextMotion textMotion) {
        ...
        if (TextMotion.Linearity.m8746equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m8751getLinear4e0Vf04())) {
            androidTextPaint.setFlags(androidTextPaint.getFlags() | 64);
            androidTextPaint.setHinting(0);
        } else if (TextMotion.Linearity.m8746equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m8750getFontHinting4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(1);
        } else if (TextMotion.Linearity.m8746equalsimpl0(linearity, TextMotion.Linearity.INSTANCE.m8752getNone4e0Vf04())) {
            androidTextPaint.getFlags();
            androidTextPaint.setHinting(0);
        } else {
            androidTextPaint.getFlags();
