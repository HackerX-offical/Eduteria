...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m5780boximpl(Size.INSTANCE.m5800getUnspecifiedNHjbRc()), null, 2, null);
    ...
    public static final Shader shaderState$lambda$0(ShaderBrushSpan shaderBrushSpan) {
        if (shaderBrushSpan.m8568getSizeNHjbRc() == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m5794isEmptyimpl(shaderBrushSpan.m8568getSizeNHjbRc())) {
            return null;
        }
        return shaderBrushSpan.shaderBrush.mo5937createShaderuvyYCjk(shaderBrushSpan.m8568getSizeNHjbRc());
    }
