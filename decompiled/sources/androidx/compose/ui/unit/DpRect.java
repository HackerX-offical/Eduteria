...
public final /* data */ class DpRect {
    ...
    public static /* synthetic */ DpRect m8902copya9UjIt4$default(DpRect dpRect, float f2, float f3, float f4, float f5, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = dpRect.left;
        }
        if ((i & 2) != 0) {
    ...
    public final DpRect m8911copya9UjIt4(float left, float top, float right, float bottom) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m8835equalsimpl0(this.left, dpRect.left) && Dp.m8835equalsimpl0(this.top, dpRect.top) && Dp.m8835equalsimpl0(this.right, dpRect.right) && Dp.m8835equalsimpl0(this.bottom, dpRect.bottom);
    }

    public int hashCode() {
        return (((((Dp.m8836hashCodeimpl(this.left) * 31) + Dp.m8836hashCodeimpl(this.top)) * 31) + Dp.m8836hashCodeimpl(this.right)) * 31) + Dp.m8836hashCodeimpl(this.bottom);
    }

    public String toString() {
        return "DpRect(left=" + ((Object) Dp.m8841toStringimpl(this.left)) + ", top=" + ((Object) Dp.m8841toStringimpl(this.top)) + ", right=" + ((Object) Dp.m8841toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m8841toStringimpl(this.bottom)) + ')';
    }
    ...
    public final float m8913getLeftD9Ej5fM() {
        return this.left;
    }

    /* JADX INFO: renamed from: getTop-D9Ej5fM, reason: not valid java name */
    public final float m8915getTopD9Ej5fM() {
        return this.top;
    }

    /* JADX INFO: renamed from: getRight-D9Ej5fM, reason: not valid java name */
    public final float m8914getRightD9Ej5fM() {
        return this.right;
    }

    /* JADX INFO: renamed from: getBottom-D9Ej5fM, reason: not valid java name */
    public final float m8912getBottomD9Ej5fM() {
        return this.bottom;
    }

    private DpRect(long j, long j2) {
        this(DpOffset.m8891getXD9Ej5fM(j), DpOffset.m8893getYD9Ej5fM(j), Dp.m8830constructorimpl(DpOffset.m8891getXD9Ej5fM(j) + DpSize.m8928getWidthD9Ej5fM(j2)), Dp.m8830constructorimpl(DpOffset.m8893getYD9Ej5fM(j) + DpSize.m8926getHeightD9Ej5fM(j2)), null);
    }
}
