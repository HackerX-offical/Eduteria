...
public interface FontScalingLinear {
    ...
    public static final class DefaultImpls {
        ...
        public static long m8948toSp0xMU5do(FontScalingLinear fontScalingLinear, float f2) {
            return FontScalingLinear.super.m8946toSp0xMU5do(f2);
        }

        @Deprecated
        /* JADX INFO: renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m8947toDpGaN1DYA(FontScalingLinear fontScalingLinear, long j) {
            return FontScalingLinear.super.m8945toDpGaN1DYA(j);
        }
    }

    /* JADX INFO: renamed from: toSp-0xMU5do, reason: not valid java name */
    default long m8946toSp0xMU5do(float f2) {
        return TextUnitKt.getSp(f2 / getFontScale());
    }

    /* JADX INFO: renamed from: toDp-GaN1DYA, reason: not valid java name */
    default float m8945toDpGaN1DYA(long j) {
