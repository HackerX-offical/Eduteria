...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m8977getSizeYbymL2g$annotations() {
    }
    ...
    public final long m8985getSizeYbymL2g() {
    ...
    public final IntRect m8989translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m8958getXimpl(offset), this.top + IntOffset.m8959getYimpl(offset), this.right + IntOffset.m8958getXimpl(offset), this.bottom + IntOffset.m8959getYimpl(offset));
    }
    ...
    public final long m8987getTopLeftnOccac() {
        return IntOffset.m8952constructorimpl((((long) this.top) & 4294967295L) | (((long) this.left) << 32));
    }

    /* JADX INFO: renamed from: getTopCenter-nOcc-ac, reason: not valid java name */
    public final long m8986getTopCenternOccac() {
        return IntOffset.m8952constructorimpl((((long) this.top) & 4294967295L) | (((long) (this.left + (getWidth() / 2))) << 32));
    }

    /* JADX INFO: renamed from: getTopRight-nOcc-ac, reason: not valid java name */
    public final long m8988getTopRightnOccac() {
        return IntOffset.m8952constructorimpl((((long) this.top) & 4294967295L) | (((long) this.right) << 32));
    }

    /* JADX INFO: renamed from: getCenterLeft-nOcc-ac, reason: not valid java name */
    public final long m8983getCenterLeftnOccac() {
        int i = this.left;
        return IntOffset.m8952constructorimpl((((long) (this.top + (getHeight() / 2))) & 4294967295L) | (((long) i) << 32));
    }

    /* JADX INFO: renamed from: getCenter-nOcc-ac, reason: not valid java name */
    public final long m8982getCenternOccac() {
        int width = this.left + (getWidth() / 2);
        return IntOffset.m8952constructorimpl((((long) (this.top + (getHeight() / 2))) & 4294967295L) | (((long) width) << 32));
    }

    /* JADX INFO: renamed from: getCenterRight-nOcc-ac, reason: not valid java name */
    public final long m8984getCenterRightnOccac() {
        int i = this.right;
        return IntOffset.m8952constructorimpl((((long) (this.top + (getHeight() / 2))) & 4294967295L) | (((long) i) << 32));
    }

    /* JADX INFO: renamed from: getBottomLeft-nOcc-ac, reason: not valid java name */
    public final long m8980getBottomLeftnOccac() {
        return IntOffset.m8952constructorimpl((((long) this.bottom) & 4294967295L) | (((long) this.left) << 32));
    }

    /* JADX INFO: renamed from: getBottomCenter-nOcc-ac, reason: not valid java name */
    public final long m8979getBottomCenternOccac() {
        return IntOffset.m8952constructorimpl((((long) this.bottom) & 4294967295L) | (((long) (this.left + (getWidth() / 2))) << 32));
    }

    /* JADX INFO: renamed from: getBottomRight-nOcc-ac, reason: not valid java name */
    public final long m8981getBottomRightnOccac() {
        return IntOffset.m8952constructorimpl((((long) this.bottom) & 4294967295L) | (((long) this.right) << 32));
    }

    /* JADX INFO: renamed from: contains--gyyYBs, reason: not valid java name */
    public final boolean m8978containsgyyYBs(long offset) {
        return IntOffset.m8958getXimpl(offset) >= this.left && IntOffset.m8958getXimpl(offset) < this.right && IntOffset.m8959getYimpl(offset) >= this.top && IntOffset.m8959getYimpl(offset) < this.bottom;
    }
