...
public class LinearSystem {
    ...
    */
                ...
                if (this.mRows[i].constantValue < 0.0f) {
                    ...
                    while (!z) {
                        ...
                        while (true) {
                            ...
                            if (arrayRow.variable.mType == SolverVariable.Type.UNRESTRICTED || arrayRow.isSimpleDefinition || arrayRow.constantValue >= f3) {
                                f2 = f3;
                                j = j2;
                                ...
                                while (i7 < currentSize) {
                                    ...
                                    if (f6 > f5) {
                                        for (int i8 = 0; i8 < 9; i8++) {
                                            float f7 = variable.strengthVector[i8] / f6;
                                            if ((f7 < f4 && i8 == i6) || i8 > i6) {
                                                i5 = variable.id;
                                                f4 = f7;
                                                i6 = i8;
                                                i4 = i3;
                                ...
                                for (int i9 = 1; i9 < this.mNumColumns; i9++) {
                                    ...
                                    if (f8 > f2) {
                                        for (int i10 = 0; i10 < 9; i10++) {
                                            float f9 = solverVariable.strengthVector[i10] / f8;
                                            if ((f9 < f4 && i10 == i6) || i10 > i6) {
                                                i6 = i10;
                                                f4 = f9;
                                                i4 = i3;
                                                i5 = i9;
    ...
    void displaySystemInformation() {
        ...
        printStream.println(sbAppend.append(getDisplaySize(i3 * i3)).append(") -- row sizes: ").append(getDisplaySize(iSizeInBytes)).append(", actual size: ").append(getDisplaySize(iSizeInBytes2)).append(" rows: ").append(this.mNumRows).append(MqttTopic.TOPIC_LEVEL_SEPARATOR).append(this.mMaxRows).append(" cols: ").append(this.mNumColumns).append(MqttTopic.TOPIC_LEVEL_SEPARATOR).append(this.mMaxColumns).append(" 0 occupied cells, ").append(getDisplaySize(0)).toString());
    }
    ...
    public void addCentering(SolverVariable solverVariable, SolverVariable solverVariable2, int i, float f2, SolverVariable solverVariable3, SolverVariable solverVariable4, int i2, int i3) {
        ArrayRow arrayRowCreateRow = createRow();
        arrayRowCreateRow.createRowCentering(solverVariable, solverVariable2, i, f2, solverVariable3, solverVariable4, i2);
        if (i3 != 8) {
