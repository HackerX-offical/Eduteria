...
public class Motion implements TypedValues {
    ...
    MotionKeyPosition getPositionKeyframe(int i, int i2, float f2, float f3) {
        ...
        for (MotionKey motionKey : this.mKeyList) {
            if (motionKey instanceof MotionKeyPosition) {
                ...
                f4 = f2;
                f5 = f3;
                if (motionKeyPosition.intersects(i3, i4, floatRect, floatRect2, f4, f5)) {
        ...
        if (hashSet2.isEmpty()) {
            ...
            for (String str : hashSet2) {
                if (str.startsWith("CUSTOM,")) {
                    ...
                    String str2 = str.split(Constants.SEPARATOR_COMMA)[i6];
                    i4 = i6;
            ...
            for (String str4 : hashSet) {
                if (!this.mTimeCycleAttributesMap.containsKey(str4)) {
                    if (str4.startsWith("CUSTOM,")) {
                        ...
                        String str5 = str4.split(Constants.SEPARATOR_COMMA)[i3];
    ...
    void getPostLayoutDvDp(float f2, int i, int i2, float f3, float f4, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            float f6 = this.mEndMotionPath.x - this.mStartMotionPath.x;
            float f7 = this.mEndMotionPath.y - this.mStartMotionPath.y;
            float f8 = f6 + (this.mEndMotionPath.width - this.mStartMotionPath.width);
            float f9 = (this.mEndMotionPath.height - this.mStartMotionPath.height) + f7;
            fArr[0] = (f6 * (1.0f - f3)) + (f8 * f3);
            fArr[1] = (f7 * (1.0f - f4)) + (f9 * f4);
            velocityMatrix.clear();
