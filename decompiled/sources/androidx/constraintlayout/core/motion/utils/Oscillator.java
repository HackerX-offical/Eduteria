...
public class Oscillator {
    ...
    public void normalize() {
        ...
        while (true) {
            ...
            int i3 = i2 - 1;
            float f2 = (fArr2[i3] + fArr2[i2]) / 2.0f;
            double[] dArr = this.mPosition;
            d3 += (dArr[i2] - dArr[i3]) * ((double) f2);
            i2++;
        }
        int i4 = 0;
        while (true) {
        ...
        while (true) {
            ...
            if (i5 < fArr4.length) {
                int i6 = i5 - 1;
                float f3 = (fArr4[i6] + fArr4[i5]) / 2.0f;
                double[] dArr2 = this.mPosition;
                double d4 = dArr2[i5] - dArr2[i6];
                double[] dArr3 = this.mArea;
                dArr3[i5] = dArr3[i6] + (d4 * ((double) f3));
                i5++;
            } else {
    ...
    double getP(double d2) {
        ...
        return this.mArea[i3] + ((((double) f3) - (d5 * d4)) * (d2 - d4)) + ((d5 * ((d2 * d2) - (d4 * d4))) / 2.0d);
    }
