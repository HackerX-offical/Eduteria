...
public class State {
    ...
    public HelperReference helper(Object obj, Helper helper2) {
        if (obj == null) {
            obj = createHelperKey();
        }
        HelperReference horizontalChainReference = this.mHelperReferences.get(obj);
        if (horizontalChainReference == null) {
            int i = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[helper2.ordinal()];
            if (i == 1) {
                ...
                horizontalChainReference = new HelperReference(this, helper2);
            }
