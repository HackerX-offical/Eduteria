...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f2) {
        ...
        float f7 = widgetFrame2.visibility == 4 ? 0.0f : f5;
        int i25 = i18;
        ...
        int i28 = (int) (i9 + ((i8 - i9) * f3));
        widgetFrame.left = i28;
        int i29 = (int) (i7 + (f3 * (i10 - i7)));
        widgetFrame.top = i29;
        float f9 = 1.0f - f2;
        widgetFrame.right = i28 + ((int) ((i3 * f9) + (i22 * f2)));
        widgetFrame.bottom = i29 + ((int) ((f9 * i23) + (i6 * f2)));
            ...
            if (widgetFrame2.mCustom.containsKey(str)) {
                ...
                if (customVariable.numberOfInterpolatedValues() == 1) {
                    ...
                    for (int i30 = 0; i30 < iNumberOfInterpolatedValues; i30++) {
                        fArr[i30] = interpolate(fArr[i30], fArr2[i30], 0.0f, f2);
