...
class RunGroup {
    ...
    public long computeWrapSize(ConstraintWidgetContainer constraintWidgetContainer, int i) {
        ...
        if (!zContains || !zContains2) {
            if (zContains) {
                return Math.max(traverseStart(this.firstRun.start, this.firstRun.start.margin), ((long) this.firstRun.start.margin) + wrapDimension);
            }
            if (zContains2) {
                return Math.max(-traverseEnd(this.firstRun.end, this.firstRun.end.margin), ((long) (-this.firstRun.end.margin)) + wrapDimension);
            }
        ...
        return (((long) this.firstRun.start.margin) + ((((long) ((f2 * biasPercent) + 0.5f)) + wrapDimension) + ((long) ((f2 * (1.0f - biasPercent)) + 0.5f)))) - ((long) this.firstRun.end.margin);
    }
