...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    private static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f201me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f201me.tracker = VelocityTracker.obtain();
            return f201me;
        }
    ...
    */
    ...
    class Model {
        ...
        private void setupConstraintWidget(ConstraintWidgetContainer base, ConstraintSet cSet) {
            ...
            for (ConstraintWidget constraintWidget3 : base.getChildren()) {
                if (constraintWidget3 instanceof VirtualLayout) {
                    ...
                    Helper helper2 = (Helper) constraintWidget3;
                    constraintHelper.updatePreLayout(base, helper2, sparseArray);
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams params) {
            Log.v(MotionLayout.TAG, str + (((((((((((" ".concat(params.startToStart != -1 ? InAppStore.SERVER_SIDE_MODE : "__") + (params.startToEnd != -1 ? "|SE" : "|__")) + (params.endToStart != -1 ? "|ES" : "|__")) + (params.endToEnd != -1 ? "|EE" : "|__")) + (params.leftToLeft != -1 ? "|LL" : "|__")) + (params.leftToRight != -1 ? "|LR" : "|__")) + (params.rightToLeft != -1 ? "|RL" : "|__")) + (params.rightToRight != -1 ? "|RR" : "|__")) + (params.topToTop != -1 ? "|TT" : "|__")) + (params.topToBottom != -1 ? "|TB" : "|__")) + (params.bottomToTop != -1 ? "|BT" : "|__")) + (params.bottomToBottom != -1 ? "|BB" : "|__")));
        }
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            Log.v(MotionLayout.TAG, str + sbAppend3.append(strConcat4).toString() + " ---  " + child);
        }
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c2) {
            ...
            for (int i = 0; i < size; i++) {
                String str2 = str + Constants.AES_PREFIX + i + "] ";
                ConstraintWidget constraintWidget = c2.getChildren().get(i);
                String str3 = (((constraintWidget.mTop.mTarget != null ? ExifInterface.GPS_DIRECTION_TRUE : "_") + (constraintWidget.mBottom.mTarget != null ? "B" : "_")) + (constraintWidget.mLeft.mTarget != null ? "L" : "_")) + (constraintWidget.mRight.mTarget != null ? "R" : "_");
    ...
    private class DevModeDraw {
        ...
        private void drawPathRelativeTicks(Canvas canvas, float x, float y) {
            ...
            float f6 = f4 - f2;
            float f7 = f5 - f3;
            float f8 = (((x - f2) * f6) + ((y - f3) * f7)) / (fHypot * fHypot);
            float f9 = f2 + (f6 * f8);
            float f10 = f3 + (f8 * f7);
            Path path = new Path();
            path.moveTo(x, y);
            path.lineTo(f9, f10);
            float fHypot2 = (float) Math.hypot(f9 - x, f10 - y);
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            float fMin2 = x - Math.min(f2, f4);
            float fMax2 = Math.max(f3, f5) - y;
