...
public class ViewTransition {
    ...
    /* JADX WARN: Removed duplicated region for block: B:32:0x0091 A[Catch: IOException -> 0x00d3, XmlPullParserException -> 0x00d8, TryCatch #2 {IOException -> 0x00d3, XmlPullParserException -> 0x00d8, blocks: (B:3:0x0026, B:11:0x0037, B:33:0x00cd, B:14:0x0043, B:15:0x004b, B:32:0x0091, B:17:0x004f, B:22:0x0060, B:20:0x0058, B:23:0x0068, B:25:0x006e, B:26:0x0072, B:28:0x007a, B:29:0x0082, B:31:0x008a), top: B:40:0x0026 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ViewTransition(android.content.Context r5, org.xmlpull.v1.XmlPullParser r6) {
        /*
    ...
    static class Animate {
        ...
        void mutateReverse() {
            ...
            this.mLastRender = jNanoTime;
            float f2 = this.mPosition - (((float) (j * 1.0E-6d)) * this.mDpositionDt);
            this.mPosition = f2;
            if (f2 < 0.0f) {
                this.mPosition = 0.0f;
            }
    ...
    /* synthetic */ void m9090x14d7500(View[] viewArr) {
        if (this.mSetsTag != -1) {
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (keyFrames != null) {
            ...
            while (it.hasNext()) {
                keyFrames2.addKey(it.next().mo9089clone().setViewId(id));
            }
