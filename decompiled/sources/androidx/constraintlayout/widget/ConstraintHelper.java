...
public abstract class ConstraintHelper extends View {
    ...
    public void updatePreLayout(ConstraintWidgetContainer container, Helper helper2, SparseArray<ConstraintWidget> map) {
        helper2.removeAllIds();
        for (int i = 0; i < this.mCount; i++) {
            helper2.add(map.get(this.mIds[i]));
        }
    }
