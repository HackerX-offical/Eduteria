...
public class ConstraintLayout extends ViewGroup {
    ...
    */
    ...
    public void resolveMeasuredDimension(int widthMeasureSpec, int heightMeasureSpec, int measuredWidth, int measuredHeight, boolean isWidthMeasuredTooSmall, boolean isHeightMeasuredTooSmall) {
        ...
        int iResolveSizeAndState2 = resolveSizeAndState(measuredHeight + i, heightMeasureSpec, 0) & 16777215;
    ...
    */
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c2, AttributeSet attrs) {
            ...
            this.widget = new ConstraintWidget();
            this.helped = false;
            TypedArray typedArrayObtainStyledAttributes = c2.obtainStyledAttributes(attrs, R.styleable.ConstraintLayout_Layout);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
    ...
    public String getSceneString() {
        ...
        if (this.mLayoutWidget.stringId == null) {
            ...
            if (id2 != -1) {
                ...
                this.mLayoutWidget.stringId = Message.Thread.PARENT_ATTRIBUTE_NAME;
            }
        }
