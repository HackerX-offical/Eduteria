...
public class ConstraintSet {
    ...
    */
    ...
    public static class Constraint {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void fillFromConstraints(ConstraintHelper helper2, int viewId, Constraints.LayoutParams param) {
            fillFromConstraints(viewId, param);
            if (helper2 instanceof Barrier) {
                this.layout.mHelperType = 1;
                Barrier barrier = (Barrier) helper2;
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer num : set.mConstraints.keySet()) {
            Constraint constraint = set.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m9091clone());
            }
        }
    }
    ...
    public void applyToHelper(ConstraintHelper helper2, ConstraintWidget child, ConstraintLayout.LayoutParams layoutParams, SparseArray<ConstraintWidget> mapIdToWidget) {
        Constraint constraint;
        int id = helper2.getId();
        if (this.mConstraints.containsKey(Integer.valueOf(id)) && (constraint = this.mConstraints.get(Integer.valueOf(id))) != null && (child instanceof HelperWidget)) {
            helper2.loadParameters(constraint, (HelperWidget) child, layoutParams, mapIdToWidget);
        }
    }
    ...
    */
    ...
    public void parseIntAttributes(Constraint set, String attributes) {
        String[] strArrSplit = attributes.split(Constants.SEPARATOR_COMMA);
    ...
    /* JADX WARN: Removed duplicated region for block: B:43:0x00a2 A[Catch: IOException -> 0x01b6, XmlPullParserException -> 0x01bb, TryCatch #2 {IOException -> 0x01b6, XmlPullParserException -> 0x01bb, blocks: (B:2:0x0000, B:77:0x01b0, B:11:0x0013, B:12:0x0021, B:14:0x0026, B:17:0x002f, B:25:0x0049, B:20:0x0038, B:23:0x0041, B:26:0x0057, B:30:0x0067, B:32:0x006f, B:34:0x007a, B:43:0x00a2, B:44:0x00a9, B:45:0x00c3, B:37:0x0083, B:39:0x008b, B:40:0x0098, B:46:0x00c4, B:48:0x00cc, B:49:0x00dd, B:52:0x00e7, B:53:0x00f2, B:54:0x010c, B:55:0x010d, B:58:0x0117, B:59:0x0122, B:60:0x013c, B:61:0x013d, B:63:0x0145, B:64:0x014f, B:67:0x0159, B:68:0x0163, B:69:0x017d, B:70:0x017e, B:73:0x0188, B:74:0x0192, B:75:0x01ac, B:76:0x01ad), top: B:84:0x0000 }] */
    /* JADX WARN: Removed duplicated region for block: B:87:0x00a9 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    private int[] convertReferenceString(View view, String referenceIdString) {
        ...
        String[] strArrSplit = referenceIdString.split(Constants.SEPARATOR_COMMA);
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout.mBarrierDirection, new String[]{"left", "right", ViewHierarchyConstants.DIMENSION_TOP_KEY, "bottom", "start", "end"}, -1);
        ...
        void writeCircle(int circleConstraint, float circleAngle, int circleRadius) throws IOException {
            ...
            this.writer.write(circleRadius + Constants.AES_SUFFIX);
        }
        ...
        void writeVariable(String name, int[] value) throws IOException {
            ...
            while (i < value.length) {
                this.writer.write((i == 0 ? Constants.AES_PREFIX : ", ") + getName(value[i]));
                i++;
            }
            this.writer.write("],\n");
        }
