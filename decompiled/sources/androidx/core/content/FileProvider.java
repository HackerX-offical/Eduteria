...
public class FileProvider extends ContentProvider {
    ...
    private static int modeToMode(String str) {
        ...
        if (Constants.INAPP_WINDOW.equals(str) || "wt".equals(str)) {
            return 738197504;
        }
        if ("wa".equals(str)) {
            return 704643072;
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(strSubstring, MqttTopic.TOPIC_LEVEL_SEPARATOR)).build();
