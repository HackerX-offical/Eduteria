...
public final class ColorStateListInflaterCompat {
    ...
    private static ColorStateList inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                ...
                iArrAppend = GrowingArrayUtils.append(iArrAppend, i2, modulateColorAlpha(color, f3, f2));
    ...
    private static int modulateColorAlpha(int i, float f2, float f3) {
        ...
        int iClamp = MathUtils.clamp((int) ((Color.alpha(i) * f2) + 0.5f), 0, 255);
        if (z) {
            CamColor camColorFromColor = CamColor.fromColor(i);
            i = CamColor.toColor(camColorFromColor.getHue(), camColorFromColor.getChroma(), f3);
        }
