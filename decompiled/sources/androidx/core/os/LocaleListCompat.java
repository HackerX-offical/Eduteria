...
public final class LocaleListCompat {
    ...
    static Locale forLanguageTagCompat(String str) {
        ...
        throw new IllegalArgumentException("Can not parse language tag: [" + str + Constants.AES_SUFFIX);
    }
    ...
    static class Api21Impl {
        private static final Locale[] PSEUDO_LOCALE = {new Locale(Const.ENGLISH, "XA"), new Locale("ar", "XB")};
