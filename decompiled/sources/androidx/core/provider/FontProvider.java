...
class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        try {
            ...
            try {
                int i = 0;
                String[] strArr = {"_id", "file_id", FontsContractCompat.Columns.TTC_INDEX, FontsContractCompat.Columns.VARIATION_SETTINGS, FontsContractCompat.Columns.WEIGHT, FontsContractCompat.Columns.ITALIC, FontsContractCompat.Columns.RESULT_CODE};
                    ...
                    try {
                        if (cursorQuery != null && cursorQuery.getCount() > 0) {
                            ...
                            while (cursorQuery.moveToNext()) {
                                ...
                                arrayList2.add(FontsContractCompat.FontInfo.create(uriWithAppendedId, i3, columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : HttpStatus.SC_BAD_REQUEST, columnIndex6 != -1 && cursorQuery.getInt(columnIndex6) == 1, i2));
                                i = 0;
                            }
                        }
                        if (cursorQuery != null) {
