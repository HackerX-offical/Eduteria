...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        public FontInfo(String str, String str2) {
            ...
            this.mTtcIndex = 0;
            this.mWeight = HttpStatus.SC_BAD_REQUEST;
            this.mItalic = false;
    ...
    public static Typeface getFontSync(Context context, FontRequest fontRequest, ResourcesCompat.FontCallback fontCallback, Handler handler, boolean z, int i, int i2) {
        ...
        return requestFont(context, (List<FontRequest>) FontRequestWorker$$ExternalSyntheticBackport0.m(new Object[]{fontRequest}), i2, z, i, ResourcesCompat.FontCallback.getHandler(handler), resourcesCallbackAdapter);
    }
