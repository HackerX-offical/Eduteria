...
public final class MenuItemCompat {
    ...
    public static void setShortcut(MenuItem menuItem, char c2, char c3, int i, int i2) {
        if (menuItem instanceof SupportMenuItem) {
            ...
            Api26Impl.setShortcut(menuItem, c2, c3, i, i2);
        }
    }
    ...
    static class Api26Impl {
        ...
        static MenuItem setShortcut(MenuItem menuItem, char c2, char c3, int i, int i2) {
            return menuItem.setShortcut(c2, c3, i, i2);
        }

        static MenuItem setNumericShortcut(MenuItem menuItem, char c2, int i) {
        ...
        static MenuItem setAlphabeticShortcut(MenuItem menuItem, char c2, int i) {
