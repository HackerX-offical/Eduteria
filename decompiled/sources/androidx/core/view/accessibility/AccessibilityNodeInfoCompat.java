...
public class AccessibilityNodeInfoCompat {
        ...
        public boolean perform(View view, Bundle bundle) {
            ...
            if (cls != null) {
                ...
                try {
                    ...
                    Log.e(TAG, "Failed to execute command with argument class ViewCommandArgument: " + (cls2 == null ? Constants.NULL_VERSION_ID : cls2.getName()), e);
                }
            }
    ...
    public static class RangeInfoCompat {
        ...
        public RangeInfoCompat(int i, float f2, float f3, float f4) {
            if (Build.VERSION.SDK_INT >= 30) {
                this.mInfo = Api30Impl.createRangeInfo(i, f2, f3, f4);
            } else {
                this.mInfo = AccessibilityNodeInfo.RangeInfo.obtain(i, f2, f3, f4);
            }
        }
    ...
    private static class Api30Impl {
        ...
        public static Object createRangeInfo(int i, float f2, float f3, float f4) {
