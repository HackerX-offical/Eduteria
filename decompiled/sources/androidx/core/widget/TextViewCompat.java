...
public final class TextViewCompat {
    ...
    public static void setLineHeight(TextView textView, int i, float f2) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setLineHeight(textView, i, f2);
        } else {
            setLineHeight(textView, Math.round(TypedValue.applyDimension(i, f2, textView.getResources().getDisplayMetrics())));
        }
    }
