...
public class ViewDragHelper {
    ...
    private int computeSettleDuration(View view, int i, int i2, int i3, int i4) {
        ...
        return (int) ((computeAxisDuration(i, iClampMag, this.mCallback.getViewHorizontalDragRange(view)) * f6) + (computeAxisDuration(i2, iClampMag2, this.mCallback.getViewVerticalDragRange(view)) * (f4 / f5)));
    }
    ...
    private int computeAxisDuration(int i, int i2, int i3) {
        ...
        float f2 = width / 2;
        float fDistanceInfluenceForSnapDuration = f2 + (distanceInfluenceForSnapDuration(Math.min(1.0f, Math.abs(i) / width)) * f2);
        int iAbs2 = Math.abs(i2);
        if (iAbs2 > 0) {
    ...
    */
    ...
    private void reportNewEdgeDrags(float f2, float f3, int i) {
        boolean zCheckNewEdgeDrag = checkNewEdgeDrag(f2, f3, i, 1);
