...
public class FlexBuffers {
    ...
    public static Reference getRoot(ReadBuf readBuf) {
        ...
        int i = iLimit - 2;
        return new Reference(readBuf, i - b2, b2, Unsigned.byteToUnsignedInt(readBuf.get(i)));
    }
    ...
    public static class Reference {
        ...
        StringBuilder toString(StringBuilder sb) {
            ...
            if (i != 36) {
                switch (i) {
                    case 0:
                        return sb.append(com.amazonaws.services.s3.internal.Constants.NULL_VERSION_ID);
                    case 1:
                    case 6:
    ...
    public static class KeyVector {
        ...
        public String toString() {
            ...
            return sb.append(com.clevertap.android.sdk.Constants.AES_SUFFIX).toString();
        }
    }
