    ...
    public static String decodeUtf8Array(byte[] bArr, int i, int i2) {
        ...
        while (i < i3) {
            ...
            if (Utf8.DecodeUtil.isOneByte(b3)) {
                ...
                int i9 = i + 2;
                i += 3;
                Utf8.DecodeUtil.handleThreeBytes(b3, bArr[i6], bArr[i9], cArr, i5);
                i5++;
            } else {
                if (i6 >= i3 - 2) {
                    throw new IllegalArgumentException("Invalid UTF-8");
                ...
                byte b6 = bArr[i + 2];
                i += 4;
                Utf8.DecodeUtil.handleFourBytes(b3, b5, b6, bArr[i10], cArr, i5);
                i5 += 2;
            }
        }
    ...
    public static String decodeUtf8Buffer(ByteBuffer byteBuffer, int i, int i2) {
        ...
        while (i < i3) {
            ...
            if (Utf8.DecodeUtil.isOneByte(b3)) {
                ...
                int i9 = i + 2;
                i += 3;
                Utf8.DecodeUtil.handleThreeBytes(b3, byteBuffer.get(i6), byteBuffer.get(i9), cArr, i5);
                i5++;
            } else {
                if (i6 >= i3 - 2) {
                    throw new IllegalArgumentException("Invalid UTF-8");
                ...
                i += 4;
                Utf8.DecodeUtil.handleFourBytes(b3, b5, b6, byteBuffer.get(i10), cArr, i5);
                i5 += 2;
            }
        }
        return new String(cArr, 0, i5);
    ...
    private static void encodeUtf8Buffer(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i < length) {
            ...
            if (cCharAt2 < 128) {
                ...
                int i3 = iPosition + 1;
                byteBuffer.put(iPosition, (byte) ((cCharAt2 >>> CsvReader.Letters.FORM_FEED) | 224));
                iPosition += 2;
    ...
    private static int encodeUtf8Array(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i6 < length) {
            ...
            if (cCharAt2 < 128 && i7 < i5) {
                ...
                bArr[i7] = (byte) ((cCharAt2 >>> CsvReader.Letters.FORM_FEED) | WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND);
                int i11 = i7 + 2;
