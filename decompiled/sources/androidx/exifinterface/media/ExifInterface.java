...
public class ExifInterface {
    ...
    private static class Rational {
        ...
        public String toString() {
            return this.numerator + MqttTopic.TOPIC_LEVEL_SEPARATOR + this.denominator;
        }
                    ...
                    switch (i) {
                        ...
                        case 5:
                            ...
                            while (i10 < strArrSplit3.length) {
                                String[] strArrSplit4 = strArrSplit3[i10].split(MqttTopic.TOPIC_LEVEL_SEPARATOR, -1);
                                int i11 = i10;
                        ...
                        case 10:
                            ...
                            while (i13 < strArrSplit6.length) {
                                String[] strArrSplit7 = strArrSplit6[i13].split(MqttTopic.TOPIC_LEVEL_SEPARATOR, -1);
    ...
    */
        ...
        if (str != null && NON_ZERO_TIME_PATTERN.matcher(str).matches()) {
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if ((MqttTopic.SINGLE_LEVEL_WILDCARD.equals(strSubstring) || "-".equals(strSubstring)) && ":".equals(str3.substring(3, 4)) && i2 <= 14) {
                        int i4 = ((i2 * 60) + i3) * DateTimeConstants.MILLIS_PER_MINUTE;
    ...
    private static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            ...
            String[] strArrSplit2 = strArrSplit[0].split(MqttTopic.TOPIC_LEVEL_SEPARATOR, -1);
            double d2 = Double.parseDouble(strArrSplit2[0].trim()) / Double.parseDouble(strArrSplit2[1].trim());
            String[] strArrSplit3 = strArrSplit[1].split(MqttTopic.TOPIC_LEVEL_SEPARATOR, -1);
            double d3 = Double.parseDouble(strArrSplit3[0].trim()) / Double.parseDouble(strArrSplit3[1].trim());
            String[] strArrSplit4 = strArrSplit[2].split(MqttTopic.TOPIC_LEVEL_SEPARATOR, -1);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:65:0x0187, code lost:
        ...
        return;
     */
    /* JADX WARN: Removed duplicated region for block: B:59:0x016c A[LOOP:0: B:10:0x0035->B:59:0x016c, LOOP_END] */
    ...
    */
    ...
    private int writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream) throws IOException {
        ...
        if (!this.mAttributes[c2].isEmpty()) {
            this.mAttributes[0].put(EXIF_POINTER_TAGS[c2].name, ExifAttribute.createULong(iArr[c2], this.mExifByteOrder));
        }
    ...
    private static Pair<Integer, Integer> guessDataFormat(String str) {
        ...
        if (str.contains(MqttTopic.TOPIC_LEVEL_SEPARATOR)) {
            String[] strArrSplit2 = str.split(MqttTopic.TOPIC_LEVEL_SEPARATOR, -1);
