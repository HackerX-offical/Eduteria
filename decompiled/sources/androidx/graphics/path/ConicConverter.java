...
public final class ConicConverter {
    ...
    public static /* synthetic */ void convert$default(ConicConverter conicConverter, float[] fArr, float f2, float f3, int i, int i2, Object obj) {
        if ((i2 & 8) != 0) {
            i = 0;
        }
        conicConverter.convert(fArr, f2, f3, i);
    }
