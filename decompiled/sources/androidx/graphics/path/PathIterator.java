...
public final class PathIterator implements Iterator<PathSegment>, KMappedMarker {
    ...
    public /* synthetic */ PathIterator(Path path, ConicEvaluation conicEvaluation, float f2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(path, (i & 2) != 0 ? ConicEvaluation.AsQuadratics : conicEvaluation, (i & 4) != 0 ? 0.25f : f2);
    }
