...
public abstract class AsyncTaskLoader<D> extends Loader<D> {
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (this.mUpdateThrottle != 0) {
            ...
            printWriter.print(this.mLastLoadCompleteTime == -10000 ? "--" : "-" + DateUtils.formatElapsedTime(TimeUnit.MILLISECONDS.toSeconds(SystemClock.uptimeMillis() - this.mLastLoadCompleteTime)));
            printWriter.println();
        }
    }
}
