...
public final class FileTypes {
    ...
    public static int inferFileTypeFromMimeType(String str) {
        ...
        switch (strNormalizeMimeType.hashCode()) {
            case -2123537834:
                b2 = !strNormalizeMimeType.equals("audio/eac3-joc") ? (byte) -1 : (byte) 0;
                break;
            case -1662384011:
                b2 = !strNormalizeMimeType.equals("video/mp2p") ? (byte) -1 : (byte) 1;
                break;
            case -1662384007:
                b2 = !strNormalizeMimeType.equals("video/mp2t") ? (byte) -1 : (byte) 2;
                break;
            case -1662095187:
                b2 = !strNormalizeMimeType.equals("video/webm") ? (byte) -1 : (byte) 3;
                break;
            case -1606874997:
                b2 = !strNormalizeMimeType.equals("audio/amr-wb") ? (byte) -1 : (byte) 4;
                break;
            case -1487656890:
            ...
            case -1487464690:
                ...
                break;
            case -1487394660:
                b2 = !strNormalizeMimeType.equals("image/jpeg") ? (byte) -1 : (byte) 8;
                break;
            case -1487018032:
                b2 = !strNormalizeMimeType.equals(MimeTypes.IMAGE_WEBP) ? (byte) -1 : (byte) 9;
                break;
            case -1248337486:
                b2 = !strNormalizeMimeType.equals("application/mp4") ? (byte) -1 : (byte) 10;
                break;
            case -1079884372:
                b2 = !strNormalizeMimeType.equals(MimeTypes.VIDEO_AVI) ? (byte) -1 : (byte) 11;
                break;
            case -1004728940:
                b2 = !strNormalizeMimeType.equals("text/vtt") ? (byte) -1 : (byte) 12;
                break;
            case -879272239:
            ...
            case -879258763:
                ...
                break;
            case -387023398:
                b2 = !strNormalizeMimeType.equals("audio/x-matroska") ? (byte) -1 : (byte) 15;
                break;
            case -43467528:
                b2 = !strNormalizeMimeType.equals("application/webm") ? (byte) -1 : (byte) 16;
                break;
            case 13915911:
                b2 = !strNormalizeMimeType.equals("video/x-flv") ? (byte) -1 : (byte) 17;
                break;
            case 187078296:
                b2 = !strNormalizeMimeType.equals("audio/ac3") ? (byte) -1 : (byte) 18;
                break;
            case 187078297:
                b2 = !strNormalizeMimeType.equals("audio/ac4") ? (byte) -1 : (byte) 19;
                break;
            case 187078669:
                b2 = !strNormalizeMimeType.equals("audio/amr") ? (byte) -1 : (byte) 20;
                break;
            case 187090232:
                b2 = !strNormalizeMimeType.equals("audio/mp4") ? (byte) -1 : (byte) 21;
                break;
            case 187091926:
                b2 = !strNormalizeMimeType.equals("audio/ogg") ? (byte) -1 : Ascii.SYN;
                break;
            case 187099443:
                b2 = !strNormalizeMimeType.equals("audio/wav") ? (byte) -1 : Ascii.ETB;
                break;
            case 1331848029:
                b2 = !strNormalizeMimeType.equals("video/mp4") ? (byte) -1 : Ascii.CAN;
                break;
            case 1503095341:
                b2 = !strNormalizeMimeType.equals("audio/3gpp") ? (byte) -1 : Ascii.EM;
                break;
            case 1504578661:
                b2 = !strNormalizeMimeType.equals("audio/eac3") ? (byte) -1 : Ascii.SUB;
                break;
            case 1504619009:
                b2 = !strNormalizeMimeType.equals("audio/flac") ? (byte) -1 : Ascii.ESC;
                break;
            case 1504824762:
                b2 = !strNormalizeMimeType.equals(MimeTypes.AUDIO_MIDI) ? (byte) -1 : Ascii.FS;
                break;
            case 1504831518:
                b2 = !strNormalizeMimeType.equals("audio/mpeg") ? (byte) -1 : Ascii.GS;
                break;
            case 1505118770:
                b2 = !strNormalizeMimeType.equals("audio/webm") ? (byte) -1 : Ascii.RS;
                break;
            case 2039520277:
                b2 = !strNormalizeMimeType.equals("video/x-matroska") ? (byte) -1 : Ascii.US;
                break;
            default:
                b2 = -1;
                break;
