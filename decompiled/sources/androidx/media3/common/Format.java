...
public final class Format {
    ...
    public static String toLogString(Format format) {
        ...
        Joiner joinerOn = Joiner.on(CsvReader.Letters.COMMA);
        ...
        if (format.drmInitData != null) {
            ...
            sb.append(", drm=[");
            joinerOn.appendTo(sb, (Iterable<? extends Object>) linkedHashSet);
            sb.append(']');
        }
        ...
        if (!format.labels.isEmpty()) {
            sb.append(", labels=[");
            joinerOn.appendTo(sb, (Iterable<? extends Object>) Lists.transform(format.labels, new Function() { // from class: androidx.media3.common.Format$$ExternalSyntheticLambda2
        ...
        if (format.selectionFlags != 0) {
            ...
            joinerOn.appendTo(sb, (Iterable<? extends Object>) Util.getSelectionFlagStrings(format.selectionFlags));
            sb.append(com.clevertap.android.sdk.Constants.AES_SUFFIX);
        }
        if (format.roleFlags != 0) {
            sb.append(", roleFlags=[");
            joinerOn.appendTo(sb, (Iterable<? extends Object>) Util.getRoleFlagStrings(format.roleFlags));
            sb.append(com.clevertap.android.sdk.Constants.AES_SUFFIX);
        }
    ...
    static /* synthetic */ String lambda$toLogString$0(Label label) {
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        builder.setLabels(immutableListFromBundleList).setLanguage((String) defaultIfNull(bundle.getString(FIELD_LANGUAGE), format.language)).setSelectionFlags(bundle.getInt(FIELD_SELECTION_FLAGS, format.selectionFlags)).setRoleFlags(bundle.getInt(FIELD_ROLE_FLAGS, format.roleFlags)).setAuxiliaryTrackType(bundle.getInt(FIELD_AUXILIARY_TRACK_TYPE, format.auxiliaryTrackType)).setAverageBitrate(bundle.getInt(FIELD_AVERAGE_BITRATE, format.averageBitrate)).setPeakBitrate(bundle.getInt(FIELD_PEAK_BITRATE, format.peakBitrate)).setCodecs((String) defaultIfNull(bundle.getString(FIELD_CODECS), format.codecs)).setMetadata((Metadata) defaultIfNull((Metadata) bundle.getParcelable(FIELD_METADATA), format.metadata)).setContainerMimeType((String) defaultIfNull(bundle.getString(FIELD_CONTAINER_MIME_TYPE), format.containerMimeType)).setSampleMimeType((String) defaultIfNull(bundle.getString(FIELD_SAMPLE_MIME_TYPE), format.sampleMimeType)).setMaxInputSize(bundle.getInt(FIELD_MAX_INPUT_SIZE, format.maxInputSize));
