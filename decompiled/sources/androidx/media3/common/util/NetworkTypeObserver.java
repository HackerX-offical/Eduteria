...
public final class NetworkTypeObserver {
    ...
    private final CopyOnWriteArrayList<WeakReference<Listener>> f216listeners = new CopyOnWriteArrayList<>();
    ...
    public void register(final Listener listener) {
        ...
        this.f216listeners.add(new WeakReference<>(listener));
    ...
    private void removeClearedReferences() {
        for (WeakReference<Listener> weakReference : this.f216listeners) {
            if (weakReference.get() == null) {
                this.f216listeners.remove(weakReference);
            }
        }
    }
