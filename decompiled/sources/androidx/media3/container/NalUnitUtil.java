...
public final class NalUnitUtil {
    ...
    public static final class SpsData {
        ...
        public SpsData(int i, int i2, int i3, int i4, int i5, int i6, int i7, float f2, int i8, int i9, boolean z, boolean z2, int i10, int i11, int i12, boolean z3, int i13, int i14, int i15, int i16) {
            this.profileIdc = i;
    ...
    public static final class H265SpsData {
        ...
        public H265SpsData(H265NalHeader h265NalHeader, H265ProfileTierLevel h265ProfileTierLevel, int i, int i2, int i3, int i4, int i5, int i6, float f2, int i7, int i8, int i9, int i10) {
            this.nalHeader = h265NalHeader;
    ...
    public static boolean isNalUnitSei(Format format, byte b2) {
        return ((Objects.equals(format.sampleMimeType, "video/avc") || MimeTypes.containsCodecsCorrespondingToMimeType(format.codecs, "video/avc")) && (b2 & Ascii.US) == 6) || ((Objects.equals(format.sampleMimeType, "video/hevc") || MimeTypes.containsCodecsCorrespondingToMimeType(format.codecs, "video/hevc")) && ((b2 & 126) >> 1) == 39);
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static androidx.media3.container.NalUnitUtil.H265SpsData parseH265SpsNalUnitPayload(byte[] r16, int r17, int r18, androidx.media3.container.NalUnitUtil.H265NalHeader r19, androidx.media3.container.NalUnitUtil.H265VpsData r20) {
        /*
        ...
        if (b2 != 0 && i2 > i3) {
            ...
            while (parsableNalUnitBitArray.canReadBits(16)) {
                ...
                if (i5 == 176) {
                    ...
                    return new H265Sei3dRefDisplayInfoData(unsignedExpGolombCodedInt, unsignedExpGolombCodedInt2, unsignedExpGolombCodedInt3 + 1, unsignedExpGolombCodedInt4, unsignedExpGolombCodedInt5, bits3, bits4, i8, bits5);
                }
            }
        }
        return null;
