...
public interface HttpDataSource extends DataSource {
    ...
    static /* synthetic */ boolean lambda$static$0(String str) {
        ...
        return (TextUtils.isEmpty(lowerCase) || (lowerCase.contains("text") && !lowerCase.contains("text/vtt")) || lowerCase.contains("html") || lowerCase.contains(AbstractHttpOverXmpp.Xml.ELEMENT)) ? false : true;
    }
