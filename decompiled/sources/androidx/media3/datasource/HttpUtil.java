    ...
    public static long getContentLength(String str, String str2) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                Log.e(TAG, "Unexpected Content-Length [" + str + Constants.AES_SUFFIX);
                j = -1;
            }
        }
        ...
        try {
            ...
            Log.w(TAG, "Inconsistent headers [" + str + "] [" + str2 + Constants.AES_SUFFIX);
            return Math.max(j, j2);
        } catch (NumberFormatException unused2) {
            Log.e(TAG, "Unexpected Content-Range [" + str2 + Constants.AES_SUFFIX);
            return j;
        }
    }
}
