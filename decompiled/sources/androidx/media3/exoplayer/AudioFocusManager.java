...
final class AudioFocusManager {
    ...
    public AudioFocusManager(final Context context, Handler handler, PlayerControl playerControl) {
        this.audioManager = Suppliers.memoize(new Supplier() { // from class: androidx.media3.exoplayer.AudioFocusManager$$ExternalSyntheticLambda0
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return AudioFocusManager.lambda$new$0(context);
            }
        });
    ...
    static /* synthetic */ AudioManager lambda$new$0(Context context) {
        return (AudioManager) Assertions.checkNotNull((AudioManager) context.getApplicationContext().getSystemService("audio"));
    }
    ...
    class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
        ...
        /* synthetic */ void m9181x93d291e3(int i) {
