...
public interface LoadControl {
    ...
    public static final class Parameters {
        ...
        public Parameters(PlayerId playerId, Timeline timeline, MediaSource.MediaPeriodId mediaPeriodId, long j, long j2, float f2, boolean z, boolean z2, long j3) {
    ...
    @Deprecated
    default boolean shouldContinueLoading(long j, long j2, float f2) {
    ...
    @Deprecated
    default boolean shouldStartPlayback(Timeline timeline, MediaSource.MediaPeriodId mediaPeriodId, long j, float f2, boolean z, long j2) {
        return shouldStartPlayback(j, f2, z, j2);
    }

    @Deprecated
    default boolean shouldStartPlayback(long j, float f2, boolean z, long j2) {
