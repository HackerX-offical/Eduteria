...
public final class MediaExtractorCompat {
    ...
    public void setDataSource(Context context, Uri uri, Map<String, String> map) throws IOException {
        ...
        try {
            assetFileDescriptorOpenAssetFileDescriptor = context.getContentResolver().openAssetFileDescriptor(uri, StreamManagement.AckRequest.ELEMENT);
    ...
    private void prepareDataSource(DataSource dataSource, DataSpec dataSpec) throws IOException {
        ...
        while (z) {
            ...
            if (e2 != null || (z2 && i == -1)) {
                ...
                throw ParserException.createForMalformedContainer(str, e2);
            }
            if (i == 1) {
