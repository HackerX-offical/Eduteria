...
public class DefaultAudioTrackBufferSizeProvider implements DefaultAudioSink.AudioTrackBufferSizeProvider {
    ...
    public int getBufferSizeInBytes(int i, int i2, int i3, int i4, int i5, int i6, double d2) {
        return (((Math.max(i, (int) (((double) get1xBufferSizeInBytes(i, i2, i3, i4, i5, i6)) * d2)) + i4) - 1) / i4) * i4;
    }
