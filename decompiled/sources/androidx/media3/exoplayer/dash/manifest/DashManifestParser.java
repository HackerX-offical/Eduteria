...
public class DashManifestParser extends DefaultHandler implements ParsingLoadable.Parser<DashManifest> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:80:0x01e0 A[LOOP:0: B:24:0x00a8->B:80:0x01e0, LOOP_END] */
    ...
    */
    ...
    protected ServiceDescriptionElement parseServiceDescription(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, "Latency")) {
                ...
                j3 = parseLong(xmlPullParser, Constants.PRIORITY_MAX, -9223372036854775807L);
            } else if (XmlPullParserUtil.isStartTag(xmlPullParser, "PlaybackRate")) {
                f2 = parseFloat(xmlPullParser, "min", -3.4028235E38f);
                f3 = parseFloat(xmlPullParser, Constants.PRIORITY_MAX, -3.4028235E38f);
            }
            long j4 = j;
            long j5 = j2;
            long j6 = j3;
    ...
    protected Pair<Period, Long> parsePeriod(XmlPullParser xmlPullParser, List<BaseUrl> list, long j, long j2, long j3, long j4, boolean z) throws XmlPullParserException, IOException {
        ...
        long duration2 = parseDuration(xmlPullParser3, TypedValues.TransitionType.S_DURATION, -9223372036854775807L);
    ...
    /* JADX WARN: Removed duplicated region for block: B:73:0x039c A[LOOP:0: B:3:0x0094->B:73:0x039c, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:74:0x034c A[EDGE_INSN: B:74:0x034c->B:67:0x034c BREAK  A[LOOP:0: B:3:0x0094->B:73:0x039c], SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    protected androidx.media3.exoplayer.dash.manifest.AdaptationSet parseAdaptationSet(org.xmlpull.v1.XmlPullParser r44, java.util.List<androidx.media3.exoplayer.dash.manifest.BaseUrl> r45, androidx.media3.exoplayer.dash.manifest.SegmentBase r46, long r47, long r49, long r51, long r53, long r55, boolean r57) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:56:0x0218 A[LOOP:0: B:3:0x006d->B:56:0x0218, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:57:0x01cb A[EDGE_INSN: B:57:0x01cb->B:46:0x01cb BREAK  A[LOOP:0: B:3:0x006d->B:56:0x0218], SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    protected androidx.media3.exoplayer.dash.manifest.DashManifestParser.RepresentationInfo parseRepresentation(org.xmlpull.v1.XmlPullParser r33, java.util.List<androidx.media3.exoplayer.dash.manifest.BaseUrl> r34, java.lang.String r35, java.lang.String r36, int r37, int r38, float r39, int r40, int r41, java.lang.String r42, java.util.List<androidx.media3.exoplayer.dash.manifest.Descriptor> r43, java.util.List<androidx.media3.exoplayer.dash.manifest.Descriptor> r44, java.util.List<androidx.media3.exoplayer.dash.manifest.Descriptor> r45, java.util.List<androidx.media3.exoplayer.dash.manifest.Descriptor> r46, androidx.media3.exoplayer.dash.manifest.SegmentBase r47, long r48, long r50, long r52, long r54, long r56, boolean r58) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
    ...
    protected SegmentBase.SegmentList parseSegmentList(XmlPullParser xmlPullParser, SegmentBase.SegmentList segmentList, long j, long j2, long j3, long j4, long j5) throws XmlPullParserException, IOException {
        ...
        long j9 = parseLong(xmlPullParser, TypedValues.TransitionType.S_DURATION, segmentList != null ? segmentList.duration : -9223372036854775807L);
    ...
    protected SegmentBase.SegmentTemplate parseSegmentTemplate(XmlPullParser xmlPullParser, SegmentBase.SegmentTemplate segmentTemplate, List<Descriptor> list, long j, long j2, long j3, long j4, long j5) throws XmlPullParserException, IOException {
        ...
        long j9 = parseLong(xmlPullParser, TypedValues.TransitionType.S_DURATION, segmentTemplate != null ? segmentTemplate.duration : -9223372036854775807L);
    ...
    protected Pair<Long, EventMessage> parseEvent(XmlPullParser xmlPullParser, String str, String str2, long j, long j2, ByteArrayOutputStream byteArrayOutputStream) throws XmlPullParserException, IOException {
        ...
        long j4 = parseLong(xmlPullParser, TypedValues.TransitionType.S_DURATION, -9223372036854775807L);
    ...
    protected List<SegmentBase.SegmentTimelineElement> parseSegmentTimeline(XmlPullParser xmlPullParser, long j, long j2) throws XmlPullParserException, IOException {
        ...
        do {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParser, ExifInterface.LATITUDE_SOUTH)) {
                ...
                i = parseInt(xmlPullParser, StreamManagement.AckRequest.ELEMENT, 0);
                z = true;
            } else {
                maybeSkipTag(xmlPullParser);
            }
