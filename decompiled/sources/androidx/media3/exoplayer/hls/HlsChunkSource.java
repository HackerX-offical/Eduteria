...
class HlsChunkSource {
    ...
    public void getNextChunk(LoadingInfo loadingInfo, long j, List<HlsMediaChunk> list, boolean z, HlsChunkHolder hlsChunkHolder) {
        ...
        long j5 = jMax;
        this.trackSelection.updateSelectedTrack(j4, j5, jResolveTimeToLiveEdgeUs, list, createMediaChunkIterators(hlsMediaChunk2, j));
        ...
        Uri uri2 = uri;
        long initialStartTimeUs = playlistSnapshot.startTimeUs - this.playlistTracker.getInitialStartTimeUs();
        Pair<Long, Integer> nextMediaSequenceAndPartIndex = getNextMediaSequenceAndPartIndex(hlsMediaChunk2, z2, playlistSnapshot2, initialStartTimeUs, j);
        ...
        boolean z3 = z2;
        if (jLongValue >= playlistSnapshot2.mediaSequence || hlsMediaChunk3 == null || !z3) {
        ...
        if (this.cmcdConfiguration != null) {
            ...
            SegmentBaseHolder nextSegmentHolder2 = getNextSegmentHolder(hlsMediaPlaylist, j3, segmentBaseHolder.partIndex == -1 ? -1 : segmentBaseHolder.partIndex + 1);
        ...
        hlsChunkHolder.chunk = maybeCreateEncryptionChunkFor(fullEncryptionKeyUri, selectedIndexInTrackGroup, true, objectType);
        ...
        hlsChunkHolder.chunk = maybeCreateEncryptionChunkFor(fullEncryptionKeyUri2, selectedIndexInTrackGroup, false, objectType);
        if (hlsChunkHolder.chunk != null) {
            return;
        }
