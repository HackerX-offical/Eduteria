...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    private final CopyOnWriteArrayList<HlsPlaylistTracker.PlaylistEventListener> f225listeners;
    ...
    public DefaultHlsPlaylistTracker(HlsDataSourceFactory hlsDataSourceFactory, LoadErrorHandlingPolicy loadErrorHandlingPolicy, HlsPlaylistParserFactory hlsPlaylistParserFactory, double d2) {
        ...
        this.f225listeners = new CopyOnWriteArrayList<>();
    ...
    public void addListener(HlsPlaylistTracker.PlaylistEventListener playlistEventListener) {
        ...
        this.f225listeners.add(playlistEventListener);
    }

    @Override // androidx.media3.exoplayer.hls.playlist.HlsPlaylistTracker
    public void removeListener(HlsPlaylistTracker.PlaylistEventListener playlistEventListener) {
        this.f225listeners.remove(playlistEventListener);
    }
    ...
    public void onLoadCompleted(ParsingLoadable<HlsPlaylist> parsingLoadable, long j, long j2) {
        ...
        this.f225listeners.add(new FirstPrimaryMediaPlaylistListener());
    ...
    public void onPlaylistUpdated(Uri uri, HlsMediaPlaylist hlsMediaPlaylist) {
        ...
        Iterator<HlsPlaylistTracker.PlaylistEventListener> it = this.f225listeners.iterator();
        while (it.hasNext()) {
    ...
    final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
        ...
        /* synthetic */ void m9237x7d3061bf(Uri uri) {
        ...
        private Uri getMediaPlaylistUriForReload() {
            ...
            if (this.playlistSnapshot.serverControl.canBlockReload) {
                builderBuildUpon.appendQueryParameter(BLOCK_MSN_PARAM, String.valueOf(this.playlistSnapshot.mediaSequence + ((long) this.playlistSnapshot.segments.size())));
    ...
    private class FirstPrimaryMediaPlaylistListener implements HlsPlaylistTracker.PlaylistEventListener {
        ...
        public void onPlaylistChanged() {
            DefaultHlsPlaylistTracker.this.f225listeners.remove(this);
        }
