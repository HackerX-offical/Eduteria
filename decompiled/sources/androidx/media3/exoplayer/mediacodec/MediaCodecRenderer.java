    ...
    */
    ...
    public void render(long j, long j2) throws ExoPlaybackException {
        ...
        try {
            ...
            if (isMediaCodecException(e3)) {
                ...
                throw createRendererException(mediaCodecDecoderExceptionCreateDecoderException, this.inputFormat, z, mediaCodecDecoderExceptionCreateDecoderException.errorCode == 1101 ? PlaybackException.ERROR_CODE_DECODING_RESOURCES_RECLAIMED : 4003);
            }
            throw e3;
        }
    }
    ...
    private List<MediaCodecInfo> getAvailableCodecInfos(boolean z) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (!decoderInfos2.isEmpty()) {
            Log.w(TAG, "Drm session requires secure decoder for " + format.sampleMimeType + ", but no secure decoder available. Trying to proceed with " + decoderInfos2 + InstructionFileId.DOT);
        }
    ...
    private boolean feedInputBuffer() throws ExoPlaybackException {
        ...
        try {
            ...
            if (shouldSkipDecoderInputBuffer(this.buffer)) {
                this.buffer.clear();
