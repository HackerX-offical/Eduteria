...
public final class SynchronousMediaCodecAdapter implements MediaCodecAdapter {
    ...
    public static class Factory implements MediaCodecAdapter.Factory {
        ...
        public MediaCodecAdapter createAdapter(MediaCodecAdapter.Configuration configuration) throws Throwable {
            ...
            try {
                ...
                mediaCodecCreateCodec.configure(configuration.mediaFormat, configuration.surface, configuration.crypto, (configuration.surface == null && configuration.codecInfo.detachedSurfaceSupported && Util.SDK_INT >= 35) ? 8 : 0);
    ...
    public void setOnFrameRenderedListener(final MediaCodecAdapter.OnFrameRenderedListener onFrameRenderedListener, Handler handler) {
        this.codec.setOnFrameRenderedListener(new MediaCodec.OnFrameRenderedListener() { // from class: androidx.media3.exoplayer.mediacodec.SynchronousMediaCodecAdapter$$ExternalSyntheticLambda0
            ...
            public final void onFrameRendered(MediaCodec mediaCodec, long j, long j2) {
                this.f$0.m9240xe3d0a01f(onFrameRenderedListener, mediaCodec, j, j2);
            }
        }, handler);
    }
    ...
    /* synthetic */ void m9240xe3d0a01f(MediaCodecAdapter.OnFrameRenderedListener onFrameRenderedListener, MediaCodec mediaCodec, long j, long j2) {
