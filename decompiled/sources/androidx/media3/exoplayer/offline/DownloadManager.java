...
public final class DownloadManager {
    ...
    private final CopyOnWriteArraySet<Listener> f226listeners;
    ...
    public DownloadManager(Context context, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        this.f226listeners = new CopyOnWriteArraySet<>();
    ...
    public void addListener(Listener listener) {
        ...
        this.f226listeners.add(listener);
    }

    public void removeListener(Listener listener) {
        this.f226listeners.remove(listener);
    }
    ...
    private void setDownloadsPaused(boolean z) {
        ...
        Iterator<Listener> it = this.f226listeners.iterator();
        while (it.hasNext()) {
    ...
    private void onDownloadUpdate(DownloadUpdate downloadUpdate) {
        ...
        if (downloadUpdate.isRemove) {
            ...
            Iterator<Listener> it2 = this.f226listeners.iterator();
            while (it2.hasNext()) {
