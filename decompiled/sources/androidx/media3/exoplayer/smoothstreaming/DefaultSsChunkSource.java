...
public class DefaultSsChunkSource implements SsChunkSource {
    ...
    public final void getNextChunk(LoadingInfo loadingInfo, long j, List<? extends MediaChunk> list, ChunkHolder chunkHolder) {
        ...
        this.trackSelection.updateSelectedTrack(j2, j3, jResolveTimeToLiveEdgeUs, list2, mediaChunkIteratorArr);
        ...
        chunkHolder.chunk = newMediaChunk(this.trackSelection.getSelectedFormat(), this.dataSource, uriBuildRequestUri, i3, startTimeUs, chunkDurationUs, j4, this.trackSelection.getSelectionReason(), this.trackSelection.getSelectionData(), chunkExtractor, objectType);
    }
    ...
    private static MediaChunk newMediaChunk(Format format, DataSource dataSource, Uri uri, int i, long j, long j2, long j3, int i2, Object obj, ChunkExtractor chunkExtractor, CmcdData.Factory factory) {
        ...
        return new ContainerMediaChunk(dataSource, dataSpecBuild, format, i2, obj, j, j2, j3, -9223372036854775807L, i, 1, j, chunkExtractor);
    }
