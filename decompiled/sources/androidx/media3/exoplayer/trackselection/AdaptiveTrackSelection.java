...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public static class Factory implements ExoTrackSelection.Factory {
        ...
        public Factory(int i, int i2, int i3, float f2, float f3, Clock clock) {
            this(i, i2, i3, 1279, 719, f2, f3, clock);
        }
    ...
    private long getTotalAllocatableBandwidth(long j) {
        ...
        float f2 = j;
        return (long) ((j2 * Math.max((f2 / this.playbackSpeed) - timeToFirstByteEstimateUs, 0.0f)) / f2);
    }
        ...
        for (int i = 0; i < jArr.length; i++) {
            ...
            if (jArr2.length > 1) {
                ...
                while (i4 < i3) {
                    double d3 = dArr[i4];
                    i4++;
                    multimapBuild.put(Double.valueOf(d2 == 0.0d ? 1.0d : (((d3 + dArr[i4]) * 0.5d) - dArr[0]) / d2), Integer.valueOf(i));
                }
            }
        }
