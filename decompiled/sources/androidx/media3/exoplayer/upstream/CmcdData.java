...
public final class CmcdData {
    private static final Joiner COMMA_JOINER = Joiner.on(Constants.SEPARATOR_COMMA);
    ...
    public static final class Factory {
        ...
        public Factory(CmcdConfiguration cmcdConfiguration, ExoTrackSelection exoTrackSelection, long j, float f2, String str, boolean z, boolean z2, boolean z3) {
            boolean z4 = true;
