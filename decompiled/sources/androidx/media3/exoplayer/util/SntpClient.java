...
public final class SntpClient {
        ...
        try {
            ...
            while (i < length) {
                ...
                try {
                    ...
                    checkValidServerReply((byte) ((b2 >> 6) & 3), (byte) (b2 & 7), i3, timestamp3);
    ...
    private static long readTimestamp(byte[] bArr, int i) {
        ...
        return ((j - 2208988800L) * 1000) + ((j2 * 1000) / Conversions.THIRTYTWO_BIT);
    }
    ...
    private static void writeTimestamp(byte[] bArr, int i, long j) {
        ...
        long j4 = (j3 * Conversions.THIRTYTWO_BIT) / 1000;
        bArr[i + 4] = (byte) (j4 >> 24);
        bArr[i + 5] = (byte) (j4 >> 16);
        bArr[i + 6] = (byte) (j4 >> 8);
