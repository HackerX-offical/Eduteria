    ...
    private static final class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl10, EGLConfig eGLConfig) {
            try {
                ...
                Log.e(VideoDecoderGLSurfaceView.TAG, "Failed to set up the textures and program", e2);
            }
        }
        ...
        public void onDrawFrame(GL10 gl10) {
            ...
            try {
                ...
                Log.e(VideoDecoderGLSurfaceView.TAG, "Failed to draw a frame", e2);
            }
        }
        ...
        private void setupTextures() {
            try {
                ...
                Log.e(VideoDecoderGLSurfaceView.TAG, "Failed to set up the textures", e2);
            }
        }
    }
}
