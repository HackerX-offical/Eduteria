...
public final class AvcConfig {
    ...
    public static AvcConfig parse(ParsableByteArray parsableByteArray) throws ParserException {
        ...
        try {
            ...
            return new AvcConfig(arrayList, unsignedByte, i, i2, i3, i4, i7, i8, i5, i6, f2, strBuildAvcCodecString);
        } catch (ArrayIndexOutOfBoundsException e2) {
            throw ParserException.createForMalformedContainer("Error parsing AVC config", e2);
        }
    }

    private AvcConfig(List<byte[]> list, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, float f2, String str) {
