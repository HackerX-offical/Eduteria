...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public FragmentedMp4Extractor(SubtitleParser.Factory factory, int i, TimestampAdjuster timestampAdjuster, Track track, List<Format> list, TrackOutput trackOutput) {
        ...
        this.reorderingSeiMessageQueue = new ReorderingSeiMessageQueue(new ReorderingSeiMessageQueue.SeiConsumer() { // from class: androidx.media3.extractor.mp4.FragmentedMp4Extractor$$ExternalSyntheticLambda3
            ...
            public final void consume(long j, ParsableByteArray parsableByteArray) {
                this.f$0.m9304x40e97494(j, parsableByteArray);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$2$androidx-media3-extractor-mp4-FragmentedMp4Extractor, reason: not valid java name */
    /* synthetic */ void m9304x40e97494(long j, ParsableByteArray parsableByteArray) {
    ...
    public void init(ExtractorOutput extractorOutput) {
        ...
        if (this.sideloadedTrack != null) {
            this.trackBundles.put(0, new TrackBundle(this.extractorOutput.track(0, this.sideloadedTrack.type), new TrackSampleTable(this.sideloadedTrack, new long[0], new int[0], 0, new long[0], new int[0], 0L), new DefaultSampleValues(0, 0, 0, 0)));
    ...
    private void onLeafAtomRead(Mp4Box.LeafBox leafBox, long j) throws ParserException {
        ...
        if (leafBox.type == 1936286840) {
            Pair<Long, ChunkIndex> sidx = parseSidx(leafBox.data, j);
    ...
    private void onMoovContainerAtomRead(Mp4Box.ContainerBox containerBox) throws ParserException {
        ...
        List<TrackSampleTable> traks = BoxParser.parseTraks(containerBox, new GaplessInfoHolder(), mehd, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new Function() { // from class: androidx.media3.extractor.mp4.FragmentedMp4Extractor$$ExternalSyntheticLambda0
    ...
    private static void parseTraf(Mp4Box.ContainerBox containerBox, SparseArray<TrackBundle> sparseArray, boolean z, int i, byte[] bArr) throws ParserException {
        TrackBundle tfhd = parseTfhd(((Mp4Box.LeafBox) Assertions.checkNotNull(containerBox.getLeafBoxOfType(1952868452))).data, sparseArray, z);
        if (tfhd == null) {
            return;
        }
    ...
    private boolean readSample(ExtractorInput extractorInput) throws IOException {
        ...
        if (this.parserState == 3) {
            ...
            this.isSampleDependedOn = (this.flags & 64) == 0 || !Objects.equals(nextTrackBundle.moovSampleTable.track.format.sampleMimeType, "video/avc");
        ...
        if (track.nalUnitLengthFieldLength == 0) {
            ...
            while (this.sampleBytesWritten < this.sampleSize) {
                ...
                if (i8 == 0) {
                    ...
                    this.nalPrefix.setPosition(i2);
                    int i9 = this.nalPrefix.readInt();
                    if (i9 < r9) {
                        throw ParserException.createForMalformedContainer("Invalid NAL length", null);
                    }
                    this.sampleCurrentNalBytesRemaining = i9 - 1;
                    this.nalStartCode.setPosition(i2);
                    trackOutput.sampleData(this.nalStartCode, i3);
                    trackOutput.sampleData(this.nalPrefix, r9 == true ? 1 : 0);
                    this.processSeiNalUnitPayload = (this.ceaTrackOutputs.length <= 0 || !NalUnitUtil.isNalUnitSei(track.format, data[i3])) ? i2 : r9 == true ? 1 : 0;
                    this.sampleBytesWritten += 5;
                    this.sampleSize += i7;
                    if (!this.isSampleDependedOn && Objects.equals(nextTrackBundle.moovSampleTable.track.format.sampleMimeType, "video/avc") && NalUnitUtil.isH264NalUnitDependedOn(data[i3])) {
                        this.isSampleDependedOn = r9;
                    }
                } else {
                    if (this.processSeiNalUnitPayload) {
                        this.nalBuffer.reset(i8);
                        extractorInput.readFully(this.nalBuffer.getData(), i2, this.sampleCurrentNalBytesRemaining);
                        ...
                        boolean z3 = r9 == true ? 1 : 0;
                        parsableByteArray.setPosition((Objects.equals(track.format.sampleMimeType, "video/hevc") || MimeTypes.containsCodecsCorrespondingToMimeType(track.format.codecs, "video/hevc")) ? z3 ? 1 : 0 : 0);
                        ...
                        this.reorderingSeiMessageQueue.add(currentSamplePresentationTimeUs, this.nalBuffer);
                        z2 = z3;
                        ...
                        i = i3;
                        z2 = r9 == true ? 1 : 0;
                        iSampleData = trackOutput.sampleData((DataReader) extractorInput, i8, (boolean) i2);
                    }
