...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static final int[] SPECIAL_CHARACTER_SET = {ByteCode.FRETURN, ByteCode.ARETURN, 189, ByteCode.ATHROW, 8482, 162, 163, 9834, 224, 32, 232, 226, 234, 238, 244, 251};
    private static final int[] SPECIAL_ES_FR_CHARACTER_SET = {ByteCode.INSTANCEOF, 201, Primes.SMALL_FACTOR_LIMIT, 218, 220, 252, 8216, 161, 42, 39, 8212, ByteCode.RET, 8480, 8226, 8220, 8221, 192, ByteCode.MONITORENTER, ByteCode.IFNONNULL, 200, 202, 203, 235, 206, 207, 239, 212, 217, 249, 219, ByteCode.LOOKUPSWITCH, ByteCode.NEW};
    private static final int[] SPECIAL_PT_DE_CHARACTER_SET = {ByteCode.MONITOREXIT, 227, HttpStatus.SC_RESET_CONTENT, 204, 236, 210, 242, 213, 245, 123, 125, 92, 94, 95, 124, 126, ByteCode.WIDE, 228, 214, 246, 223, 165, 164, 9474, ByteCode.MULTIANEWARRAY, 229, 216, 248, 9484, 9488, 9492, 9496};
    ...
    */
    ...
    private static final class CueBuilder {
        ...
        public Cue build(int i) {
            ...
            return new Cue.Builder().setText(spannableStringBuilder).setTextAlignment(Layout.Alignment.ALIGN_NORMAL).setLine(i5, 1).setPosition(f2).setPositionAnchor(i).build();
        }
