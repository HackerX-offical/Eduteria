    ...
    private static final class CueBuilder {
        ...
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                double d3 = unsignedByte3 + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
                double d4 = unsignedByte4 + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
                this.colors[unsignedByte] = (Util.constrainValue((int) ((d2 - (0.34414d * d4)) - (d3 * 0.71414d)), 0, 255) << 8) | (unsignedByte5 << 24) | (Util.constrainValue((int) ((1.402d * d3) + d2), 0, 255) << 16) | Util.constrainValue((int) (d2 + (d4 * 1.772d)), 0, 255);
            }
            this.colorsSet = true;
        }
