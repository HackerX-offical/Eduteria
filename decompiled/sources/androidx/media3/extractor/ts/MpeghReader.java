...
public final class MpeghReader implements ElementaryStreamReader {
    ...
    private void parseConfig(ParsableBitArray parsableBitArray) throws ParserException {
        ...
        if (this.mainStreamLabel != this.header.packetLabel) {
            ...
            this.output.format(new Format.Builder().setId(this.formatId).setSampleMimeType("audio/mhm1").setSampleRate(this.samplingRate).setCodecs(mpegh3daConfig.profileLevelIndication != -1 ? "mhm1" + String.format(".%02X", Integer.valueOf(mpegh3daConfig.profileLevelIndication)) : "mhm1").setInitializationData((mpegh3daConfig.compatibleProfileLevelSet == null || mpegh3daConfig.compatibleProfileLevelSet.length <= 0) ? null : ImmutableList.of(Util.EMPTY_BYTE_ARRAY, mpegh3daConfig.compatibleProfileLevelSet)).build());
        }
