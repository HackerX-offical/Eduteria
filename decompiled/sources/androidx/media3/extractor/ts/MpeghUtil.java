...
final class MpeghUtil {
    ...
    public static Mpegh3daConfig parseMpegh3daConfig(ParsableBitArray parsableBitArray) throws ParserException {
        ...
        return new Mpegh3daConfig(bits, (int) (((double) samplingFrequency) * resamplingRatio), (int) (((double) outputFrameLength) * resamplingRatio), bArr3);
    }
    ...
    private static int getSamplingFrequency(int i) throws ParserException {
        switch (i) {
            ...
            case 8:
                return 16000;
            case 9:
                return ArcAnimationFactory.COMPLETE_ROTATE_DURATION;
            case 10:
                return 11025;
            case 11:
                return 8000;
