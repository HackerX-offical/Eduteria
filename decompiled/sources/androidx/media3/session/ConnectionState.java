...
class ConnectionState {
    ...
    public Bundle toBundleForRemoteProcess(int i) {
        ...
        if (!this.mediaButtonPreferences.isEmpty()) {
            if (i >= 7) {
                ...
                bundle.putParcelableArrayList(FIELD_CUSTOM_LAYOUT, BundleCollectionUtil.toBundleArrayList(this.mediaButtonPreferences, new ConnectionState$$ExternalSyntheticLambda3()));
            }
        }
    ...
    public static ConnectionState fromBundle(Bundle bundle) {
        ...
        return new ConnectionState(i, i2, iMediaSessionAsInterface, pendingIntent, immutableList, immutableList2, immutableList3, sessionCommands, commands2, commands, bundle9, bundle8, playerInfo, token);
    }
