...
public final class MediaBrowser extends MediaController {
    ...
    public static final class Builder {
        ...
        public ListenableFuture<MediaBrowser> buildAsync() {
            ...
            final MediaBrowser mediaBrowser = new MediaBrowser(this.context, this.token, this.connectionHints, this.listener, this.applicationLooper, mediaControllerHolder, this.bitmapLoader, this.maxCommandsForMediaItems);
    ...
    MediaBrowser(Context context, SessionToken sessionToken, Bundle bundle, Listener listener, Looper looper, MediaController.ConnectionCallback connectionCallback, androidx.media3.common.util.BitmapLoader bitmapLoader, int i) {
    ...
    public MediaBrowserImpl createImpl(Context context, SessionToken sessionToken, Bundle bundle, Looper looper, androidx.media3.common.util.BitmapLoader bitmapLoader) {
        ...
        if (sessionToken.isLegacySession()) {
            mediaBrowser = this;
            mediaBrowserImplBase = new MediaBrowserImplLegacy(context, mediaBrowser, sessionToken, bundle, looper, (androidx.media3.common.util.BitmapLoader) Assertions.checkNotNull(bitmapLoader));
        } else {
            mediaBrowser = this;
