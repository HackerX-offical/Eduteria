...
public class MediaController implements Player {
    ...
    MediaController(Context context, SessionToken sessionToken, Bundle bundle, Listener listener, Looper looper, ConnectionCallback connectionCallback, androidx.media3.common.util.BitmapLoader bitmapLoader, int i) {
    ...
    MediaControllerImpl createImpl(Context context, SessionToken sessionToken, Bundle bundle, Looper looper, androidx.media3.common.util.BitmapLoader bitmapLoader) {
        if (sessionToken.isLegacySession()) {
            return new MediaControllerImplLegacy(context, this, sessionToken, bundle, looper, (androidx.media3.common.util.BitmapLoader) Assertions.checkNotNull(bitmapLoader));
        }
        ...
        if (this.connectionNotified) {
            notifyControllerListener(new Consumer() { // from class: androidx.media3.session.MediaController$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    this.f$0.m9319lambda$release$0$androidxmedia3sessionMediaController((MediaController.Listener) obj);
                }
            });
        } else {
    ...
    /* synthetic */ void m9319lambda$release$0$androidxmedia3sessionMediaController(Listener listener) {
