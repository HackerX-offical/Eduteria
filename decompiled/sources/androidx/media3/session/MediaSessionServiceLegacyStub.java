...
class MediaSessionServiceLegacyStub extends MediaBrowserServiceCompat {
    ...
    public MediaBrowserServiceCompat.BrowserRoot onGetRoot(String str, int i, Bundle bundle) {
        ...
        Util.postOrRun(this.sessionImpl.getApplicationHandler(), new Runnable() { // from class: androidx.media3.session.MediaSessionServiceLegacyStub$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m9499x22fee84d(atomicReference, controllerInfoCreateControllerInfo, conditionVariable);
            }
        });
        try {
            ...
            Log.e(TAG, "Couldn't get a result from onConnect", e2);
            return null;
        }
    }
    ...
    /* synthetic */ void m9499x22fee84d(AtomicReference atomicReference, MediaSession.ControllerInfo controllerInfo, ConditionVariable conditionVariable) {
