...
class PlayerInfo {
    ...
    public PlayerInfo copyWithVolume(float f2) {
    ...
    public static PlayerInfo fromBundle(Bundle bundle, int i) {
        ...
        return new PlayerInfo(playbackException, i2, sessionPositionInfo, positionInfo, positionInfo2, i3, playbackParameters, i4, z, videoSizeFromBundle, timelineFromBundle, i5, mediaMetadata, f2, audioAttributes, cueGroupFromBundle, deviceInfoFromBundle, i6, z2, z3, i7, i8, i9, z4, z5, mediaMetadata2, j2, j3, j4, tracksFromBundle, trackSelectionParametersFromBundle);
    }
