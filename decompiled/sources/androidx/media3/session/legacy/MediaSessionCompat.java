...
public class MediaSessionCompat {
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, VersionedParcelable versionedParcelable) {
        ...
        if (componentName != null && pendingIntent == null) {
            ...
            pendingIntent = PendingIntent.getBroadcast(context, 0, intent, Build.VERSION.SDK_INT >= 31 ? GroupFlagsKt.HasAuxSlotFlag : 0);
        }
    ...
    public static MediaSessionCompat fromMediaSession(Context context, Object obj) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            mediaSessionImplApi28 = new MediaSessionImplApi28(obj);
        }
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                ...
                try {
                    ...
                    if (str.equals("android.support.v4.media.session.command.GET_EXTRA_BINDER")) {
                        ...
                        List<QueueItem> list = sessionImplIfCallbackIsSet.mQueue;
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        int mFlags = 3;
        private VolumeProviderCompat.Callback mVolumeCallback = new VolumeProviderCompat.Callback() { // from class: androidx.media3.session.legacy.MediaSessionCompat.MediaSessionImplBase.1
        ...
        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, VersionedParcelable versionedParcelable, Bundle bundle) {
            ...
            this.mAudioManager = (AudioManager) Assertions.checkNotNull(context.getSystemService("audio"));
        ...
        static class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (mediaSessionImplBase.mLock) {
                    ...
                    if (i == 2) {
                        ...
                        int streamMaxVolume = mediaSessionImplBase.mAudioManager.getStreamMaxVolume(i2);
                        streamVolume = mediaSessionImplBase.mAudioManager.getStreamVolume(i2);
                        maxVolume = streamMaxVolume;
                    }
                    parcelableVolumeInfo = new ParcelableVolumeInfo(i, i2, volumeControl, maxVolume, streamVolume);
                }
            ...
            public void setPlaybackSpeed(float f2) {
                postToHandler(32, Float.valueOf(f2));
            }
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            if (callback == null) {
                ...
                this.mRcc.setPlaybackPositionUpdateListener(new RemoteControlClient.OnPlaybackPositionUpdateListener() { // from class: androidx.media3.session.legacy.MediaSessionCompat.MediaSessionImplApi18.1
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            if (callback == null) {
                ...
                this.mRcc.setMetadataUpdateListener(new RemoteControlClient.OnMetadataUpdateListener() { // from class: androidx.media3.session.legacy.MediaSessionCompat.MediaSessionImplApi19.1
        ...
        RemoteControlClient.MetadataEditor buildRccMetadata(Bundle bundle) {
            ...
            if (bundle != null) {
                ...
                if (bundle.containsKey("android.media.metadata.RATING")) {
                    metadataEditorBuildRccMetadata.putObject(101, (Object) LegacyParcelableUtil.convert(bundle.getParcelable("android.media.metadata.RATING"), RatingCompat.CREATOR));
                }
                if (bundle.containsKey("android.media.metadata.USER_RATING")) {
                    metadataEditorBuildRccMetadata.putObject(268435457, (Object) LegacyParcelableUtil.convert(bundle.getParcelable("android.media.metadata.USER_RATING"), RatingCompat.CREATOR));
                }
            }
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public void setQueue(List<QueueItem> list) {
            ...
            while (it.hasNext()) {
                arrayList.add((MediaSession.QueueItem) Assertions.checkNotNull(it.next().getQueueItem()));
            }
