...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public long getCurrentPosition(Long l) {
        ...
        return Math.max(0L, j + ((long) (f2 * jElapsedRealtime)));
    }
    ...
    public Object getPlaybackState() {
        if (this.mStateFwk == null) {
            ...
            while (it.hasNext()) {
                ...
                if (customAction != null) {
                    Api21Impl.addCustomAction(builderCreateBuilder, customAction);
                }
            }
    ...
    private static class Api21Impl {
        ...
        static void setState(PlaybackState.Builder builder, int i, long j, float f2, long j2) {
