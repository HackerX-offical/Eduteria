...
public class DefaultTimeBar extends View implements TimeBar {
    ...
    private final CopyOnWriteArraySet<TimeBar.OnScrubListener> f236listeners;
    ...
    public DefaultTimeBar(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2, int i2) {
        ...
        this.f236listeners = new CopyOnWriteArraySet<>();
        ...
        this.stopScrubbingRunnable = new Runnable() { // from class: androidx.media3.ui.DefaultTimeBar$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m9518lambda$new$0$androidxmedia3uiDefaultTimeBar();
            }
        };
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.DefaultTimeBar$$ExternalSyntheticLambda1
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.m9519lambda$new$1$androidxmedia3uiDefaultTimeBar(valueAnimator2);
            }
        });
    ...
    /* synthetic */ void m9518lambda$new$0$androidxmedia3uiDefaultTimeBar() {
        stopScrubbing(false);
    }

    /* JADX INFO: renamed from: lambda$new$1$androidx-media3-ui-DefaultTimeBar, reason: not valid java name */
    /* synthetic */ void m9519lambda$new$1$androidxmedia3uiDefaultTimeBar(ValueAnimator valueAnimator) {
    ...
    public void addListener(TimeBar.OnScrubListener onScrubListener) {
        ...
        this.f236listeners.add(onScrubListener);
    }

    @Override // androidx.media3.ui.TimeBar
    public void removeListener(TimeBar.OnScrubListener onScrubListener) {
        this.f236listeners.remove(onScrubListener);
    }
    ...
    */
    ...
    private void startScrubbing(long j) {
        ...
        Iterator<TimeBar.OnScrubListener> it = this.f236listeners.iterator();
        while (it.hasNext()) {
