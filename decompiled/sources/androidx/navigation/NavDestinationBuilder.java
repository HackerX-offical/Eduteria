...
public class NavDestinationBuilder<D extends NavDestination> {
    ...
    public D build() {
        D d2 = (D) instantiateDestination();
        d2.setLabel(this.label);
        ...
        while (it.hasNext()) {
            d2.addDeepLink((NavDeepLink) it.next());
        }
