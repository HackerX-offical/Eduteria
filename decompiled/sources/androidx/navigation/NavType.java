...
public abstract class NavType<T> {
    ...
    public static final NavType<String> StringType = new NavType<String>() { // from class: androidx.navigation.NavType$Companion$StringType$1
        ...
        public String parseValue(String value) {
            Intrinsics.checkNotNullParameter(value, "value");
            if (Intrinsics.areEqual(value, Constants.NULL_VERSION_ID)) {
                return null;
            }
            return value;
        }
        ...
        public String serializeAsValue(String value) {
            ...
            return strEncode == null ? Constants.NULL_VERSION_ID : strEncode;
        }
    };
    ...
    public static final class Companion {
        ...
        public NavType<?> fromArgType(String type, String packageName) {
            ...
            if (str != null && str.length() != 0) {
                try {
                    String strSubstring = (!StringsKt.startsWith$default(type, InstructionFileId.DOT, false, 2, (Object) null) || packageName == null) ? type : packageName + type;
    ...
    public static final class EnumType<D extends Enum<?>> extends SerializableType<D> {
        ...
        public D parseValue(String value) {
            ...
            while (true) {
                ...
                d2 = enumConstants[i];
                if (StringsKt.equals(d2.name(), value, true)) {
                    break;
                }
                i++;
            }
