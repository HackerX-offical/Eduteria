...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    private String getFullClassName(Context context, String str) {
        ...
        return str.contains(InstructionFileId.DOT) ? str : RecyclerView.class.getPackage().getName() + '.' + str;
    }
    ...
    private int consumeFlingInStretch(int i, EdgeEffect edgeEffect, EdgeEffect edgeEffect2, int i2) {
        ...
        float f2 = i2;
        int iRound2 = Math.round((f2 / 4.0f) * EdgeEffectCompat.onPullDistance(edgeEffect2, (i * 4.0f) / f2, 0.5f));
        if (iRound2 != i) {
            edgeEffect2.finish();
        }
        return i - iRound2;
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:47:0x00de A[PHI: r1
      0x00de: PHI (r1v46 int) = (r1v26 int), (r1v50 int) binds: [B:41:0x00c7, B:45:0x00da] A[DONT_GENERATE, DONT_INLINE]] */
