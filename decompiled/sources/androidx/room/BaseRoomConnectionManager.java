...
public abstract class BaseRoomConnectionManager {
        ...
        try {
            ...
            if (i != getOpenDelegate().getVersion()) {
                ...
                try {
                    ...
                    objM12393constructorimpl = Result.m12393constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM12393constructorimpl = Result.m12393constructorimpl(ResultKt.createFailure(th));
                }
                if (Result.m12400isSuccessimpl(objM12393constructorimpl)) {
                    SQLite.execSQL(connection, "END TRANSACTION");
                }
                Throwable thM12396exceptionOrNullimpl = Result.m12396exceptionOrNullimpl(objM12393constructorimpl);
                if (thM12396exceptionOrNullimpl != null) {
                    SQLite.execSQL(connection, "ROLLBACK TRANSACTION");
                    throw thM12396exceptionOrNullimpl;
                }
            }
            onOpen(connection);
        } finally {
            ...
            try {
                ...
                while (sQLiteStatement.step()) {
                    ...
                    if (!StringsKt.startsWith$default(text, "sqlite_", false, 2, (Object) null) && !Intrinsics.areEqual(text, "android_metadata")) {
                        listCreateListBuilder.add(TuplesKt.to(text, Boolean.valueOf(Intrinsics.areEqual(sQLiteStatement.getText(1), ViewHierarchyConstants.VIEW_KEY))));
                    }
                }
    ...
    private final void checkIdentity(SQLiteConnection connection) throws Exception {
        ...
        Result.m12392boximpl(objM12393constructorimpl);
    }
