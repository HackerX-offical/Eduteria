...
public final class QueryInterceptorStatement implements SupportSQLiteStatement {
    ...
    static final class C05161 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05161(List<? extends Object> list, Continuation<? super C05161> continuation) {
            super(2, continuation);
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorStatement.this.new C05161(this.$argsCopy, continuation);
        }
    ...
    public int executeUpdateDelete() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C05161(CollectionsKt.toList(this.bindArgsCache), null), 3, null);
    ...
    static final class C05151 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ List<Object> $argsCopy;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05151(List<? extends Object> list, Continuation<? super C05151> continuation) {
            super(2, continuation);
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorStatement.this.new C05151(this.$argsCopy, continuation);
        }
    ...
    public long executeInsert() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C05151(CollectionsKt.toList(this.bindArgsCache), null), 3, null);
    ...
    static final class C05171 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05171(List<? extends Object> list, Continuation<? super C05171> continuation) {
            super(2, continuation);
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorStatement.this.new C05171(this.$argsCopy, continuation);
        }
    ...
    public long simpleQueryForLong() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C05171(CollectionsKt.toList(this.bindArgsCache), null), 3, null);
    ...
    static final class C05181 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C05181(List<? extends Object> list, Continuation<? super C05181> continuation) {
            super(2, continuation);
            this.$argsCopy = list;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return QueryInterceptorStatement.this.new C05181(this.$argsCopy, continuation);
        }
    ...
    public String simpleQueryForString() {
        BuildersKt__Builders_commonKt.launch$default(this.queryCallbackScope, null, null, new C05181(CollectionsKt.toList(this.bindArgsCache), null), 3, null);
