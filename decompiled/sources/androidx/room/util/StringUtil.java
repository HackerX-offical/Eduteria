...
public final class StringUtil {
    ...
    public static final void appendPlaceholders(StringBuilder builder, int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            builder.append("?");
            if (i2 < i - 1) {
                builder.append(Constants.SEPARATOR_COMMA);
            }
        }
    }
    ...
    public static final List<Integer> splitToIntList(String str) {
        ...
        Integer numValueOf;
        if (str == null || (listSplit$default = StringsKt.split$default((CharSequence) str, new char[]{CsvReader.Letters.COMMA}, false, 0, 6, (Object) null)) == null) {
            return null;
        }
    ...
    public static final String joinIntoString(List<Integer> list) {
        if (list != null) {
            return CollectionsKt.joinToString$default(list, Constants.SEPARATOR_COMMA, null, null, 0, null, null, 62, null);
        }
        return null;
    }
}
