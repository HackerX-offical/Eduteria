...
public final class LocalSavedStateRegistryOwnerKt {
    ...
    static {
        ...
        try {
            ...
            objM12393constructorimpl = Result.m12393constructorimpl(providableCompositionLocal);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM12393constructorimpl = Result.m12393constructorimpl(ResultKt.createFailure(th));
        }
        ProvidableCompositionLocal<SavedStateRegistryOwner> providableCompositionLocalStaticCompositionLocalOf = (ProvidableCompositionLocal) (Result.m12399isFailureimpl(objM12393constructorimpl) ? null : objM12393constructorimpl);
