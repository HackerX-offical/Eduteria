...
public final class SavedStateRegistryImpl {
    ...
    public final Bundle consumeRestoredStateForKey(String key) {
        ...
        Bundle bundleM9581constructorimpl = SavedStateReader.m9581constructorimpl(bundle);
        Bundle bundleM9638getSavedStateimpl = SavedStateReader.m9582containsimpl(bundleM9581constructorimpl, key) ? SavedStateReader.m9638getSavedStateimpl(bundleM9581constructorimpl, key) : null;
        ...
        return bundleM9638getSavedStateimpl;
    }
    ...
    public final void performRestore$savedstate_release(Bundle savedState) {
        ...
        Bundle bundleM9638getSavedStateimpl = null;
        if (savedState != null) {
            Bundle bundleM9581constructorimpl = SavedStateReader.m9581constructorimpl(savedState);
            if (SavedStateReader.m9582containsimpl(bundleM9581constructorimpl, SAVED_COMPONENTS_KEY)) {
                bundleM9638getSavedStateimpl = SavedStateReader.m9638getSavedStateimpl(bundleM9581constructorimpl, SAVED_COMPONENTS_KEY);
            }
        }
        this.restoredState = bundleM9638getSavedStateimpl;
    ...
    public final void performSave$savedstate_release(Bundle outBundle) {
        ...
        synchronized (this.lock) {
            for (Map.Entry entry2 : this.keyToProviders.entrySet()) {
                SavedStateWriter.m9694putSavedStateimpl(bundleM9667constructorimpl, (String) entry2.getKey(), ((SavedStateRegistry.SavedStateProvider) entry2.getValue()).saveState());
            }
            Unit unit = Unit.INSTANCE;
        }
        if (SavedStateReader.m9659isEmptyimpl(SavedStateReader.m9581constructorimpl(bundleBundleOf))) {
            return;
        }
        SavedStateWriter.m9694putSavedStateimpl(SavedStateWriter.m9667constructorimpl(outBundle), SAVED_COMPONENTS_KEY, bundleBundleOf);
    }
}
