...
public final class SavedStateEncoder extends AbstractEncoder {
    ...
    private final void checkDiscriminatorCollisions(Bundle savedState, String elementName) {
        if (this.configuration.getClassDiscriminatorMode() == 1) {
            boolean zM9582containsimpl = SavedStateReader.m9582containsimpl(SavedStateReader.m9581constructorimpl(savedState), "type");
            boolean zAreEqual = Intrinsics.areEqual(elementName, "type");
            if (zM9582containsimpl && zAreEqual) {
                throw new IllegalArgumentException("SavedStateEncoder for " + SavedStateReader.m9652getStringimpl(SavedStateReader.m9581constructorimpl(savedState), "type") + " has property '" + elementName + "' that conflicts with the class discriminator. You can rename a property with @SerialName annotation.");
            }
        }
    }
    ...
    public void encodeBoolean(boolean value) {
        SavedStateWriter.m9673putBooleanimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeByte(byte value) {
        SavedStateWriter.m9684putIntimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }
    ...
    public void encodeLong(long value) {
        SavedStateWriter.m9688putLongimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeFloat(float value) {
        SavedStateWriter.m9682putFloatimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeDouble(double value) {
        SavedStateWriter.m9680putDoubleimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeChar(char value) {
        SavedStateWriter.m9675putCharimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeString(String value) {
        Intrinsics.checkNotNullParameter(value, "value");
        SavedStateWriter.m9700putStringimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeEnum(SerialDescriptor enumDescriptor, int index) {
        Intrinsics.checkNotNullParameter(enumDescriptor, "enumDescriptor");
        SavedStateWriter.m9684putIntimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, index);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeNull() {
        SavedStateWriter.m9690putNullimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key);
    }

    private final void encodeIntList(List<Integer> value) {
        SavedStateWriter.m9686putIntListimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeStringList(List<String> value) {
        SavedStateWriter.m9702putStringListimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeBooleanArray(boolean[] value) {
        SavedStateWriter.m9674putBooleanArrayimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeCharArray(char[] value) {
        SavedStateWriter.m9676putCharArrayimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeDoubleArray(double[] value) {
        SavedStateWriter.m9681putDoubleArrayimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeFloatArray(float[] value) {
        SavedStateWriter.m9683putFloatArrayimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeIntArray(int[] value) {
        SavedStateWriter.m9685putIntArrayimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeLongArray(long[] value) {
        SavedStateWriter.m9689putLongArrayimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeStringArray(String[] value) {
        SavedStateWriter.m9701putStringArrayimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, value);
    }
    ...
    public CompositeEncoder beginStructure(SerialDescriptor descriptor) {
        ...
        SavedStateWriter.m9667constructorimpl(bundleBundleOf);
        SavedStateWriter.m9694putSavedStateimpl(SavedStateWriter.m9667constructorimpl(this.savedState), this.key, bundleBundleOf);
    ...
    private final void putClassDiscriminatorIfRequired(SavedStateConfiguration configuration, SerialDescriptor descriptor, Bundle savedState) {
        if (configuration.getClassDiscriminatorMode() == 1 && !SavedStateReader.m9582containsimpl(SavedStateReader.m9581constructorimpl(savedState), "type")) {
            if (Intrinsics.areEqual(descriptor.getKind(), StructureKind.CLASS.INSTANCE) || Intrinsics.areEqual(descriptor.getKind(), StructureKind.OBJECT.INSTANCE)) {
                SavedStateWriter.m9700putStringimpl(SavedStateWriter.m9667constructorimpl(savedState), "type", descriptor.getSerialName());
            }
        }
    }
