...
public final class CharSequenceListSerializer implements KSerializer<List<? extends CharSequence>> {
    ...
    public void serialize(Encoder encoder, List<? extends CharSequence> value) {
        ...
        SavedStateWriter.m9679putCharSequenceListimpl(SavedStateWriter.m9667constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public List<CharSequence> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m9601getCharSequenceListimpl(SavedStateReader.m9581constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
