...
public final class IBinderSerializer implements KSerializer<IBinder> {
    ...
    public void serialize(Encoder encoder, IBinder value) {
        ...
        SavedStateWriter.m9672putBinderimpl(SavedStateWriter.m9667constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public IBinder deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m9588getBinderimpl(SavedStateReader.m9581constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
