...
public final class SizeFSerializer implements KSerializer<SizeF> {
    ...
    public void serialize(Encoder encoder, SizeF value) {
        ...
        SavedStateWriter.m9698putSizeFimpl(SavedStateWriter.m9667constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public SizeF deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m9645getSizeFimpl(SavedStateReader.m9581constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
