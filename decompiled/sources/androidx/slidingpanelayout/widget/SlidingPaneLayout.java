        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(layoutParams.width, 1073741824);
                }
            ...
            while (i9 < childCount) {
                ...
                if (childAt2.getVisibility() != i3) {
                    ...
                    if (z) {
                        ...
                        iMax = ((int) ((layoutParams2.weight * Math.max(0, i6)) / f2)) + measuredWidth2;
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, 1073741824);
                    } else {
                        iMax = measuredWidth2;
                        iMakeMeasureSpec = 0;
            ...
            for (int i10 = 0; i10 < childCount; i10++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if ((childAt3.getMeasuredWidthAndState() & 16777216) == 1 || (getMinimumWidth(childAt3) != 0 && rect.width() < getMinimumWidth(childAt3))) {
                        childAt3.measure(View.MeasureSpec.makeMeasureSpec(i8 - i11, 1073741824), iMakeMeasureSpec3);
                        if (i10 != 0) {
