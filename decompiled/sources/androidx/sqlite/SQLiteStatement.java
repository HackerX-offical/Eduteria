...
public interface SQLiteStatement extends AutoCloseable {
    ...
    void mo9567bindBlob(int index, byte[] value);

    /* JADX INFO: renamed from: bindDouble */
    void mo9568bindDouble(int index, double value);

    /* JADX INFO: renamed from: bindLong */
    void mo9569bindLong(int index, long value);

    /* JADX INFO: renamed from: bindNull */
    void mo9570bindNull(int index);

    /* JADX INFO: renamed from: bindText */
    void mo9571bindText(int index, String value);

    /* JADX INFO: renamed from: clearBindings */
    void mo9572clearBindings();
