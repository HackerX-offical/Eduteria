...
public class ChangeBounds extends Transition {
    ...
    private static final Property<View, PointF> POSITION_PROPERTY = new Property<View, PointF>(PointF.class, Const.POSITION) { // from class: androidx.transition.ChangeBounds.5
