...
public class TransitionSet extends Transition {
    ...
    */
    ...
    public void resume(View view) {
        super.resume(view);
        Transition[] transitionArrTransitionsAsArray = transitionsAsArray();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionArrTransitionsAsArray[i].resume(view);
        }
        returnTransitionArrayToCache(transitionArrTransitionsAsArray);
    }
    ...
    protected void cancel() {
        ...
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionArrTransitionsAsArray[i].cancel();
        }
        returnTransitionArrayToCache(transitionArrTransitionsAsArray);
    }
    ...
    void forceToEnd(ViewGroup viewGroup) {
        ...
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionArrTransitionsAsArray[i].forceToEnd(viewGroup);
        }
        returnTransitionArrayToCache(transitionArrTransitionsAsArray);
    }
    ...
    public Transition mo9712clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo9712clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo9712clone());
        }
