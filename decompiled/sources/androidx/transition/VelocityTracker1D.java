...
class VelocityTracker1D {
    ...
    float calculateVelocity() {
        ...
        if (i2 == 2) {
            ...
            fKineticEnergyToVelocity = (fArr[i3] - fArr[i4]) / f3;
        } else {
            int i5 = this.mIndex;
            int i6 = ((i5 - i2) + 21) % 20;
            int i7 = (i5 + 21) % 20;
            long j4 = this.mTimeSamples[i6];
            float f4 = this.mDataSamples[i6];
            int i8 = i6 + 1;
            ...
            for (int i9 = i8 % 20; i9 != i7; i9 = (i9 + 1) % 20) {
                ...
                if (f5 != 0.0f) {
                    ...
                    float f7 = (f6 - f4) / f5;
                    fKineticEnergyToVelocity2 += (f7 - kineticEnergyToVelocity(fKineticEnergyToVelocity2)) * Math.abs(f7);
                    if (i9 == i8) {
    ...
    private float kineticEnergyToVelocity(float f2) {
        return (float) (((double) Math.signum(f2)) * Math.sqrt(Math.abs(f2) * 2.0f));
    }
}
