...
public class AnimatorInflaterCompat {
    ...
    private static void setupObjectAnimator(ValueAnimator valueAnimator, TypedArray typedArray, int i, float f2, XmlPullParser xmlPullParser) {
        ...
        objectAnimator.setPropertyName(TypedArrayUtils.getNamedString(typedArray, xmlPullParser, TriggerAdapter.INAPP_PROPERTYNAME, 0));
    }
    ...
    */
        ...
        while (true) {
            ...
            if (eventType != 2) {
                ...
                if (xmlPullParser2.getName().equals("propertyValuesHolder")) {
                    ...
                    String namedString = TypedArrayUtils.getNamedString(typedArrayObtainAttributes, xmlPullParser2, TriggerAdapter.INAPP_PROPERTYNAME, 3);
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            Object value = Constants.NULL_VERSION_ID;
            StringBuilder sbAppend2 = sbAppend.append(fraction < 0.0f ? Constants.NULL_VERSION_ID : Float.valueOf(keyframe.getFraction())).append(", , value : ");
