...
public class ViewPager extends ViewGroup {
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
            ...
            if (i2 < itemInfo.position) {
                ...
                while (true) {
                    ...
                    while (i2 > itemInfo3.position) {
                        pageWidth2 -= this.mAdapter.getPageWidth(i2) + f2;
                        i2--;
                    }
        ...
        while (i7 >= 0) {
            ...
            while (i5 > itemInfo7.position) {
                pageWidth3 -= this.mAdapter.getPageWidth(i5) + f2;
                i5--;
            }
        ...
        while (i9 < size2) {
            ...
            while (i8 < itemInfo8.position) {
                pageWidth4 += this.mAdapter.getPageWidth(i8) + f2;
                i8++;
            }
    ...
    */
    ...
    private boolean pageScrolled(int i) {
        ...
        float f3 = ((i / f2) - itemInfoInfoForCurrentScrollPosition.offset) / (itemInfoInfoForCurrentScrollPosition.widthFactor + (i2 / f2));
        this.mCalledSuper = false;
