...
final class WindowAreaControllerImpl$windowAreaInfos$1 extends SuspendLambda implements Function2<ProducerScope<? super List<? extends WindowAreaInfo>>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.this$0.windowAreaComponent.addRearDisplayPresentationStatusListener(consumer22);
            ...
            if (ProduceKt.awaitClose(producerScope, new Function0() { // from class: androidx.window.area.WindowAreaControllerImpl$windowAreaInfos$1$$ExternalSyntheticLambda2
                ...
                public final Object invoke() {
                    return WindowAreaControllerImpl$windowAreaInfos$1.invokeSuspend$lambda$2(windowAreaControllerImpl3, consumer2, consumer22);
                }
    ...
    public static final void invokeSuspend$lambda$0(WindowAreaControllerImpl windowAreaControllerImpl, ProducerScope producerScope, int i) {
        ...
        channel.mo13895trySendJP2dKIU(CollectionsKt.toList(collectionValues));
    }
    ...
    public static final Unit invokeSuspend$lambda$2(WindowAreaControllerImpl windowAreaControllerImpl, Consumer2 consumer2, Consumer2 consumer22) {
        ...
        windowAreaControllerImpl.windowAreaComponent.removeRearDisplayPresentationStatusListener(consumer22);
        return Unit.INSTANCE;
    }
}
