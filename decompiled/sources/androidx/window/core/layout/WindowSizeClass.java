...
public final class WindowSizeClass {
    ...
    @JvmStatic
    public static final WindowSizeClass compute(float f2, float f3) {
        return INSTANCE.compute(f2, f3);
    }
    ...
    public WindowSizeClass(float f2, float f3) {
        this((int) f2, (int) f3);
    }
    ...
    static {
        ...
        List<Integer> listPlus = CollectionsKt.plus((Collection) listListOf, (Iterable) CollectionsKt.listOf((Object[]) new Integer[]{1200, Integer.valueOf(WIDTH_DP_EXTRA_LARGE_LOWER_BOUND)}));
        WIDTH_DP_BREAKPOINTS_V2 = listPlus;
        List<Integer> listListOf2 = CollectionsKt.listOf((Object[]) new Integer[]{0, Integer.valueOf(HEIGHT_DP_MEDIUM_LOWER_BOUND), 900});
