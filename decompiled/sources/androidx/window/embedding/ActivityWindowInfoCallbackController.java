...
public class ActivityWindowInfoCallbackController {
    ...
    public final void addCallback(Activity activity, Consumer<EmbeddedActivityWindowInfo> callback) {
        ...
        try {
            if (this.callbacks.isEmpty()) {
                this.embeddingExtension.setEmbeddedActivityWindowInfoCallback(new DashDownloader$$ExternalSyntheticLambda0(), this.extensionsCallback);
            }
    ...
    public EmbeddedActivityWindowInfo translate$window_release(androidx.window.extensions.embedding.EmbeddedActivityWindowInfo info2) {
        Intrinsics.checkNotNullParameter(info2, "info");
