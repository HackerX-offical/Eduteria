...
public final class EmbeddingAspectRatio {
    ...
    public /* synthetic */ EmbeddingAspectRatio(String str, float f2, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, f2);
    }

    @JvmStatic
    public static final EmbeddingAspectRatio ratio(float f2) {
        return INSTANCE.ratio(f2);
    }

    private EmbeddingAspectRatio(String str, float f2) {
