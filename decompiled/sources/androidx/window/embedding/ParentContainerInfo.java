...
public final /* data */ class ParentContainerInfo {
    ...
    public static /* synthetic */ ParentContainerInfo copy$default(ParentContainerInfo parentContainerInfo, Bounds bounds, WindowLayoutInfo windowLayoutInfo, Configuration configuration, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        if ((i & 8) != 0) {
            f2 = parentContainerInfo.density;
        }
        return parentContainerInfo.copy(bounds, windowLayoutInfo, configuration, f2);
    }
    ...
    public ParentContainerInfo(Bounds windowBounds, WindowLayoutInfo windowLayoutInfo, Configuration configuration, float f2) {
        Intrinsics.checkNotNullParameter(windowBounds, "windowBounds");
        Intrinsics.checkNotNullParameter(windowLayoutInfo, "windowLayoutInfo");
        Intrinsics.checkNotNullParameter(configuration, "configuration");
