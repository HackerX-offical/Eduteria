...
public final class ExtensionsWindowLayoutInfoAdapter {
    ...
    public final WindowLayoutInfo translate$window_release(Context context, androidx.window.extensions.layout.WindowLayoutInfo info2) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            return translate$window_release(windowMetricsCalculatorCompat.computeCurrentWindowMetrics(context), info2);
        }
        if (Build.VERSION.SDK_INT >= 29 && (context instanceof Activity)) {
            return translate$window_release(windowMetricsCalculatorCompat.computeCurrentWindowMetrics((Activity) context), info2);
        }
