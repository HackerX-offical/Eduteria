...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    protected SupportSQLiteOpenHelper createOpenHelper(final DatabaseConfiguration config) {
        return config.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(config.context).name(config.name).callback(new RoomOpenHelper(config, new RoomOpenHelper.Delegate(23) { // from class: androidx.work.impl.WorkDatabase_Impl.1
            ...
            public void dropAllTables(final SupportSQLiteDatabase db) {
                ...
                List list = WorkDatabase_Impl.this.mCallbacks;
                if (list != null) {
            ...
            public RoomOpenHelper.ValidationResult onValidateSchema(final SupportSQLiteDatabase db) {
                ...
                TableInfo tableInfo2 = TableInfo.read(db, "Dependency");
                ...
                TableInfo tableInfo4 = TableInfo.read(db, "WorkSpec");
                ...
                TableInfo tableInfo6 = TableInfo.read(db, "WorkTag");
                ...
                TableInfo tableInfo8 = TableInfo.read(db, "SystemIdInfo");
                ...
                TableInfo tableInfo10 = TableInfo.read(db, "WorkName");
                ...
                TableInfo tableInfo12 = TableInfo.read(db, "WorkProgress");
                ...
                TableInfo tableInfo14 = TableInfo.read(db, "Preference");
