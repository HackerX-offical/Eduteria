...
public class SystemForegroundDispatcher implements OnConstraintsStateChangedListener, ExecutionListener {
    ...
    public static Intent createStartForegroundIntent(Context context, WorkGenerationalId id, ForegroundInfo info2) {
        Intent intent = new Intent(context, (Class<?>) SystemForegroundService.class);
        intent.setAction(ACTION_START_FOREGROUND);
        intent.putExtra(KEY_WORKSPEC_ID, id.getWorkSpecId());
        intent.putExtra(KEY_GENERATION, id.getGeneration());
        intent.putExtra(KEY_NOTIFICATION_ID, info2.getNotificationId());
        intent.putExtra(KEY_FOREGROUND_SERVICE_TYPE, info2.getForegroundServiceType());
        intent.putExtra(KEY_NOTIFICATION, info2.getNotification());
        return intent;
    }
    ...
    public static Intent createNotifyIntent(Context context, WorkGenerationalId id, ForegroundInfo info2) {
        Intent intent = new Intent(context, (Class<?>) SystemForegroundService.class);
