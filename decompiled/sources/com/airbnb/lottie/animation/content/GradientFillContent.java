...
public class GradientFillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public void draw(Canvas canvas, Matrix matrix, int i, DropShadow dropShadow) {
        ...
        this.paint.setAlpha(MiscUtils.clamp((int) (i * fIntValue), 0, 255));
        if (dropShadow != null) {
    ...
    private RadialGradient getRadialGradient() {
        ...
        RadialGradient radialGradient2 = new RadialGradient(f2, f3, fHypot, iArr, fArr, Shader.TileMode.CLAMP);
