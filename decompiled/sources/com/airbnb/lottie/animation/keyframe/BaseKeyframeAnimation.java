...
public abstract class BaseKeyframeAnimation<K, A> {
    ...
    final List<AnimationListener> f297listeners = new ArrayList(1);
    ...
    public void addUpdateListener(AnimationListener animationListener) {
        this.f297listeners.add(animationListener);
    }
    ...
    public void notifyListeners() {
        ...
        for (int i = 0; i < this.f297listeners.size(); i++) {
            this.f297listeners.get(i).onValueChanged();
        }
        if (L.isTraceEnabled()) {
    ...
    protected A getValue(Keyframe<K> keyframe, float f2, float f3, float f4) {
