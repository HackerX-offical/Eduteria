...
public class ColorKeyframeAnimation extends KeyframeAnimation<Integer> {
    ...
    public int getIntValue(Keyframe<Integer> keyframe, float f2) {
        ...
        if (this.valueCallback == null || keyframe.endFrame == null) {
            ...
            f3 = f2;
            Integer num = (Integer) this.valueCallback.getValueInternal(keyframe.startFrame, keyframe.endFrame.floatValue(), keyframe.startValue, keyframe.endValue, f3, getLinearCurrentKeyframeProgress(), getProgress());
            if (num != null) {
                return num.intValue();
            }
        }
        return GammaEvaluator.evaluate(MiscUtils.clamp(f3, 0.0f, 1.0f), keyframe.startValue.intValue(), keyframe.endValue.intValue());
    }
