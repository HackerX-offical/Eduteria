...
public class ShapeKeyframeAnimation extends BaseKeyframeAnimation<ShapeData, Path> {
    ...
    public Path getValue(Keyframe<ShapeData> keyframe, float f2) {
        ...
        this.tempShapeData.interpolateBetween(shapeData, shapeData2 == null ? shapeData : shapeData2, f2);
        ...
        if (this.valueCallback != null) {
            ...
            return (Path) lottieValueCallback.getValueInternal(f3, fFloatValue, path, shapeData2 == null ? path : this.valueCallbackEndPath, f2, getLinearCurrentKeyframeProgress(), getProgress());
        }
