...
public class TextLayer extends BaseLayer {
    ...
    */
    ...
    private void drawGlyphTextLine(String str, DocumentData documentData, Font font, Canvas canvas, float f2, float f3, float f4, int i) {
        ...
        while (i3 < str.length()) {
            ...
            if (fontCharacter == null) {
                ...
                f5 = f3;
                i2 = i;
                drawCharacterAsGlyph(fontCharacter, f5, documentData2, canvas2, i3, i2);
                canvas2.translate((((float) fontCharacter.getWidth()) * f5 * Utils.dpScale()) + f4, 0.0f);
            }
            i3++;
            f3 = f5;
            documentData = documentData2;
    ...
    */
    ...
    private boolean offsetCanvas(Canvas canvas, DocumentData documentData, int i, float f2) {
    ...
    private void drawFontTextLine(String str, DocumentData documentData, Canvas canvas, float f2, int i, int i2) {
        int length = 0;
        while (length < str.length()) {
            ...
            canvas2.translate(this.fillPaint.measureText(strCodePointToString) + f2, 0.0f);
    ...
    private List<TextSubLine> splitGlyphTextIntoLines(String str, float f2, Font font, float f3, float f4, boolean z) {
        float fMeasureText;
        int i = 0;
        int i2 = 0;
        boolean z2 = false;
        ...
        for (int i4 = 0; i4 < str.length(); i4++) {
            ...
            if (f2 > 0.0f && f5 >= f2 && cCharAt != ' ') {
                ...
                if (i3 == i2) {
                    textSubLineEnsureEnoughSubLines.set(str.substring(i2, i4).trim(), (f5 - f8) - ((r9.length() - r7.length()) * f7));
                    i2 = i4;
                    i3 = i2;
                    f5 = f8;
                    f6 = f5;
                } else {
                    textSubLineEnsureEnoughSubLines.set(str.substring(i2, i3 - 1).trim(), ((f5 - f6) - ((r7.length() - r13.length()) * f7)) - f7);
                    f5 = f6;
                    i2 = i3;
                }
            }
        ...
        if (f5 > 0.0f) {
            i++;
            ensureEnoughSubLines(i).set(str.substring(i2), f5);
        }
    ...
    private void drawCharacterAsGlyph(FontCharacter fontCharacter, float f2, DocumentData documentData, Canvas canvas, int i, int i2) {
