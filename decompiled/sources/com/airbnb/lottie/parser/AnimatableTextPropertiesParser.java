...
public class AnimatableTextPropertiesParser {
    private static final JsonReader.Options PROPERTIES_NAMES = JsonReader.Options.of(CmcdData.Factory.STREAMING_FORMAT_SS, "a");
    private static final JsonReader.Options ANIMATABLE_RANGE_PROPERTIES_NAMES = JsonReader.Options.of(CmcdData.Factory.STREAMING_FORMAT_SS, "e", "o", StreamManagement.AckRequest.ELEMENT);
    private static final JsonReader.Options ANIMATABLE_PROPERTIES_NAMES = JsonReader.Options.of("fc", Constants.INAPP_NOTIF_SHOW_CLOSE, "sw", "t", "o");
