...
class GradientStrokeParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.of(Constants.NOTIF_MSG, "g", "o", "t", CmcdData.Factory.STREAMING_FORMAT_SS, "e", Constants.INAPP_WINDOW, "lc", "lj", "ml", "hd", "d");
    private static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.of("p", "k");
    private static final JsonReader.Options DASH_PATTERN_NAMES = JsonReader.Options.of(CTProductConfigConstants.PRODUCT_CONFIG_JSON_KEY_FOR_KEY, "v");
