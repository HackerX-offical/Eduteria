...
class KeyframeParser {
    ...
    static JsonReader.Options NAMES = JsonReader.Options.of("t", CmcdData.Factory.STREAMING_FORMAT_SS, "e", "o", CmcdData.Factory.OBJECT_TYPE_INIT_SEGMENT, "h", "to", Constants.INAPP_ID_IN_PAYLOAD);
    ...
    static <T> Keyframe<T> parse(JsonReader jsonReader, LottieComposition lottieComposition, float f2, ValueParser<T> valueParser, boolean z, boolean z2) throws IOException {
        if (z && z2) {
