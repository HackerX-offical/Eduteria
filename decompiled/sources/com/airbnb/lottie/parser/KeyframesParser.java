...
class KeyframesParser {
    ...
    static <T> List<Keyframe<T>> parse(JsonReader jsonReader, LottieComposition lottieComposition, float f2, ValueParser<T> valueParser, boolean z) throws IOException {
            ...
            if (jsonReader.selectName(NAMES) == 0) {
                if (jsonReader.peek() == JsonReader.Token.BEGIN_ARRAY) {
                    ...
                    if (jsonReader.peek() == JsonReader.Token.NUMBER) {
                        ...
                        boolean z3 = z;
                        Keyframe keyframe = KeyframeParser.parse(jsonReader3, lottieComposition3, f4, valueParser3, false, z3);
                        ...
                        while (jsonReader2.hasNext()) {
                            arrayList.add(KeyframeParser.parse(jsonReader2, lottieComposition2, f3, valueParser2, true, z2));
                        }
                    }
                    ...
                    arrayList.add(KeyframeParser.parse(jsonReader4, lottieComposition, f2, valueParser, false, z));
