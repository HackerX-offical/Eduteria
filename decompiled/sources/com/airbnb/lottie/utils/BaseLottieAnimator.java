...
public abstract class BaseLottieAnimator extends ValueAnimator {
    ...
    private final Set<Animator.AnimatorListener> f298listeners = new CopyOnWriteArraySet();
    ...
    public void addListener(Animator.AnimatorListener animatorListener) {
        this.f298listeners.add(animatorListener);
    }

    @Override // android.animation.Animator
    public void removeListener(Animator.AnimatorListener animatorListener) {
        this.f298listeners.remove(animatorListener);
    }

    @Override // android.animation.Animator
    public void removeAllListeners() {
        this.f298listeners.clear();
    }

    void notifyStart(boolean z) {
        Iterator<Animator.AnimatorListener> it = this.f298listeners.iterator();
        while (it.hasNext()) {
