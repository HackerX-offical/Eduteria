...
public class LottieValueAnimator extends BaseLottieAnimator implements Choreographer.FrameCallback {
    ...
    public void doFrame(long j) {
        ...
        boolean zContains = MiscUtils.contains(f3, getMinFrame(), getMaxFrame());
        float f4 = this.frameRaw;
        float fClamp = MiscUtils.clamp(f3, getMinFrame(), getMaxFrame());
    ...
    private void checkNotifyUpdate(float f2) {
        if (this.useCompositionFrameRate && this.frameRaw == f2) {
            return;
        }
        notifyUpdate();
    }
    ...
    public void setMinAndMaxFrames(float f2, float f3) {
        ...
        float fClamp = MiscUtils.clamp(f2, startFrame, endFrame);
        float fClamp2 = MiscUtils.clamp(f3, startFrame, endFrame);
