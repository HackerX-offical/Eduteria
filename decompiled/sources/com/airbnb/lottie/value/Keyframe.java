...
public class Keyframe<T> {
    ...
    protected Keyframe(LottieComposition lottieComposition, T t, T t2, Interpolator interpolator, Interpolator interpolator2, Interpolator interpolator3, float f2, Float f3) {
        this.startValueFloat = UNSET_FLOAT;
        this.endValueFloat = UNSET_FLOAT;
        this.startValueInt = UNSET_INT;
        this.endValueInt = UNSET_INT;
    ...
    public float getEndProgress() {
        ...
        if (this.endProgress == Float.MIN_VALUE) {
            if (this.endFrame == null) {
                ...
                this.endProgress = (float) (((double) startProgress) + (((double) (this.endFrame.floatValue() - this.startFrame)) / ((double) this.composition.getDurationFrames())));
            }
        }
