...
public class ClasspathPropertiesFileCredentialsProvider implements AWSCredentialsProvider {
    ...
    public ClasspathPropertiesFileCredentialsProvider(String str) {
        ...
        if (!str.startsWith(MqttTopic.TOPIC_LEVEL_SEPARATOR)) {
            this.credentialsFilePath = MqttTopic.TOPIC_LEVEL_SEPARATOR + str;
        } else {
    ...
    public AWSCredentials getCredentials() {
        ...
        try {
            ...
            throw new AmazonClientException("Unable to load AWS credentials from the " + this.credentialsFilePath + " file on the classpath", e2);
        }
    }
