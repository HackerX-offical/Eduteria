    ...
    public AmazonServiceException handle(HttpResponse httpResponse) throws Exception {
        try {
            ...
            try {
                ...
                return newAmazonServiceException(String.format("Unable to unmarshall error response (%s)", string), httpResponse, e2);
            }
            ...
            return newAmazonServiceException("Unable to unmarshall error response", httpResponse, e3);
        }
    }
