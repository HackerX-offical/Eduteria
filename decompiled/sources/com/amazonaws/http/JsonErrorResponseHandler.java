...
public class JsonErrorResponseHandler implements HttpResponseHandler<AmazonServiceException> {
    ...
    public static final class JsonErrorResponse {
        ...
        public static JsonErrorResponse fromResponse(HttpResponse httpResponse) throws IOException {
            ...
            Map<String, String> mapJsonToMap = JsonUtils.jsonToMap(new BufferedReader(new InputStreamReader(httpResponse.getContent(), StringUtils.UTF8)));
            ...
            } else if (mapJsonToMap.containsKey("__type")) {
                String str = mapJsonToMap.get("__type");
                strSubstring = str.substring(str.lastIndexOf(MqttTopic.MULTI_LEVEL_WILDCARD) + 1);
            }
            return new JsonErrorResponse(statusCode, strSubstring, mapJsonToMap);
        }
    }
}
