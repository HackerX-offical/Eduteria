...
public class UrlHttpClient implements HttpClient {
    ...
    void writeContentToConnection(HttpRequest httpRequest, HttpURLConnection httpURLConnection, CurlBuilder curlBuilder) throws IOException {
        ...
        } else if (httpRequest.getContentLength() < SieveCacheKt.NodeLinkMask) {
    ...
    protected final class CurlBuilder {
        ...
        public String build() {
            ...
            if (this.content != null) {
                sb.append(" -d '").append(this.content).append("'");
            }
            return sb.append(" ").append(this.url.toString()).toString();
        }
    }
}
