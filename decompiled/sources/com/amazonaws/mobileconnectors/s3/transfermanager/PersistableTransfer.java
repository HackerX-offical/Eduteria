    ...
    public static <T extends PersistableTransfer> T deserializeFrom(InputStream inputStream) {
        ...
        try {
            ...
            while (jsonReader.hasNext()) {
                ...
                if (strNextName.equals("pauseType")) {
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (strNextName2.equals("contentType")) {
            ...
            if ("download".equals(strNextString)) {
                return new PersistableDownload(strNextString2, strNextString3, strNextString4, jArr, responseHeaderOverrides, z, strNextString5);
            }
            String str = strNextString5;
            if ("upload".equals(strNextString)) {
                return new PersistableUpload(strNextString2, strNextString3, str, strNextString6, j, j2);
            }
