...
public class TransferUtility {
    ...
    public TransferObserver upload(String str, String str2, File file, ObjectMetadata objectMetadata, CannedAccessControlList cannedAccessControlList, TransferListener transferListener) {
        ...
        if (shouldUploadInMultipart(file)) {
            ...
            transferUtility = this;
            str4 = str2;
            iCreateMultipartUploadRecords = Integer.parseInt(transferUtility.dbUtil.insertSingleTransferRecord(TransferType.UPLOAD, str3, str4, file, objectMetadata, cannedAccessControlList, transferUtility.transferUtilityOptions).getLastPathSegment());
        }
        int i = iCreateMultipartUploadRecords;
        TransferObserver transferObserver = new TransferObserver(i, transferUtility.dbUtil, str3, str4, file, transferListener);
        submitTransferJob(TRANSFER_ADD, i);
        return transferObserver;
    }
    ...
    private int createMultipartUploadRecords(String str, String str2, File file, ObjectMetadata objectMetadata, CannedAccessControlList cannedAccessControlList) {
        ...
        int iCeil = ((int) Math.ceil(d2 / jMax)) + 1;
