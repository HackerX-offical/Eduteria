...
public class LookupDeveloperIdentityRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public String toString() {
        ...
        if (getIdentityId() != null) {
            sb.append("IdentityId: " + getIdentityId() + Constants.SEPARATOR_COMMA);
        }
        if (getDeveloperUserIdentifier() != null) {
            sb.append("DeveloperUserIdentifier: " + getDeveloperUserIdentifier() + Constants.SEPARATOR_COMMA);
        }
        if (getMaxResults() != null) {
            sb.append("MaxResults: " + getMaxResults() + Constants.SEPARATOR_COMMA);
        }
