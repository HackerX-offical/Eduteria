...
public class BatchWriteItemResult implements Serializable {
    ...
    public String toString() {
        ...
        if (getUnprocessedItems() != null) {
            sb.append("UnprocessedItems: " + getUnprocessedItems() + Constants.SEPARATOR_COMMA);
        }
        if (getItemCollectionMetrics() != null) {
            sb.append("ItemCollectionMetrics: " + getItemCollectionMetrics() + Constants.SEPARATOR_COMMA);
        }
        if (getConsumedCapacity() != null) {
