...
public class DescribeLimitsResult implements Serializable {
    ...
    public String toString() {
        ...
        if (getAccountMaxReadCapacityUnits() != null) {
            sb.append("AccountMaxReadCapacityUnits: " + getAccountMaxReadCapacityUnits() + Constants.SEPARATOR_COMMA);
        }
        if (getAccountMaxWriteCapacityUnits() != null) {
            sb.append("AccountMaxWriteCapacityUnits: " + getAccountMaxWriteCapacityUnits() + Constants.SEPARATOR_COMMA);
        }
        if (getTableMaxReadCapacityUnits() != null) {
            sb.append("TableMaxReadCapacityUnits: " + getTableMaxReadCapacityUnits() + Constants.SEPARATOR_COMMA);
        }
