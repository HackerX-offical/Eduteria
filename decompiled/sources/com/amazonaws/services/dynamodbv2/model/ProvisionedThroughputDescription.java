...
public class ProvisionedThroughputDescription implements Serializable {
    ...
    public String toString() {
        ...
        if (getLastIncreaseDateTime() != null) {
            sb.append("LastIncreaseDateTime: " + getLastIncreaseDateTime() + Constants.SEPARATOR_COMMA);
        }
        if (getLastDecreaseDateTime() != null) {
            sb.append("LastDecreaseDateTime: " + getLastDecreaseDateTime() + Constants.SEPARATOR_COMMA);
        }
        if (getNumberOfDecreasesToday() != null) {
            sb.append("NumberOfDecreasesToday: " + getNumberOfDecreasesToday() + Constants.SEPARATOR_COMMA);
        }
        if (getReadCapacityUnits() != null) {
            sb.append("ReadCapacityUnits: " + getReadCapacityUnits() + Constants.SEPARATOR_COMMA);
        }
