...
public class QueryRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public String toString() {
        ...
        if (getSelect() != null) {
            sb.append("Select: " + getSelect() + Constants.SEPARATOR_COMMA);
        }
        if (getAttributesToGet() != null) {
            sb.append("AttributesToGet: " + getAttributesToGet() + Constants.SEPARATOR_COMMA);
        }
        if (getLimit() != null) {
            sb.append("Limit: " + getLimit() + Constants.SEPARATOR_COMMA);
        }
        if (getConsistentRead() != null) {
            sb.append("ConsistentRead: " + getConsistentRead() + Constants.SEPARATOR_COMMA);
        }
        if (getKeyConditions() != null) {
            sb.append("KeyConditions: " + getKeyConditions() + Constants.SEPARATOR_COMMA);
        }
        if (getQueryFilter() != null) {
            sb.append("QueryFilter: " + getQueryFilter() + Constants.SEPARATOR_COMMA);
        }
        if (getConditionalOperator() != null) {
            sb.append("ConditionalOperator: " + getConditionalOperator() + Constants.SEPARATOR_COMMA);
        }
        if (getScanIndexForward() != null) {
            sb.append("ScanIndexForward: " + getScanIndexForward() + Constants.SEPARATOR_COMMA);
        }
        if (getExclusiveStartKey() != null) {
            sb.append("ExclusiveStartKey: " + getExclusiveStartKey() + Constants.SEPARATOR_COMMA);
        }
        if (getReturnConsumedCapacity() != null) {
            sb.append("ReturnConsumedCapacity: " + getReturnConsumedCapacity() + Constants.SEPARATOR_COMMA);
        }
        if (getProjectionExpression() != null) {
            sb.append("ProjectionExpression: " + getProjectionExpression() + Constants.SEPARATOR_COMMA);
        }
        if (getFilterExpression() != null) {
            sb.append("FilterExpression: " + getFilterExpression() + Constants.SEPARATOR_COMMA);
        }
        if (getKeyConditionExpression() != null) {
            sb.append("KeyConditionExpression: " + getKeyConditionExpression() + Constants.SEPARATOR_COMMA);
        }
        if (getExpressionAttributeNames() != null) {
            sb.append("ExpressionAttributeNames: " + getExpressionAttributeNames() + Constants.SEPARATOR_COMMA);
        }
