...
public class ScanRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public String toString() {
        ...
        if (getScanFilter() != null) {
            sb.append("ScanFilter: " + getScanFilter() + Constants.SEPARATOR_COMMA);
        }
        ...
        if (getTotalSegments() != null) {
            sb.append("TotalSegments: " + getTotalSegments() + Constants.SEPARATOR_COMMA);
        }
        if (getSegment() != null) {
            sb.append("Segment: " + getSegment() + Constants.SEPARATOR_COMMA);
        }
        ...
        if (getExpressionAttributeValues() != null) {
            sb.append("ExpressionAttributeValues: " + getExpressionAttributeValues() + Constants.SEPARATOR_COMMA);
        }
