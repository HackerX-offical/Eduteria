...
public class RestoreTableFromBackupRequestMarshaller implements Marshaller<Request<RestoreTableFromBackupRequest>, RestoreTableFromBackupRequest> {
    ...
    public Request<RestoreTableFromBackupRequest> marshall(RestoreTableFromBackupRequest restoreTableFromBackupRequest) {
        if (restoreTableFromBackupRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(RestoreTableFromBackupRequest)");
        }
        DefaultRequest defaultRequest = new DefaultRequest(restoreTableFromBackupRequest, "AmazonDynamoDB");
        defaultRequest.addHeader("X-Amz-Target", "DynamoDB_20120810.RestoreTableFromBackup");
