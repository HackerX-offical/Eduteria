...
public class CreateGrantRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public String toString() {
        ...
        if (getGranteePrincipal() != null) {
            sb.append("GranteePrincipal: " + getGranteePrincipal() + Constants.SEPARATOR_COMMA);
        }
        if (getRetiringPrincipal() != null) {
            sb.append("RetiringPrincipal: " + getRetiringPrincipal() + Constants.SEPARATOR_COMMA);
        }
        if (getOperations() != null) {
            sb.append("Operations: " + getOperations() + Constants.SEPARATOR_COMMA);
        }
        if (getConstraints() != null) {
            sb.append("Constraints: " + getConstraints() + Constants.SEPARATOR_COMMA);
        }
        if (getGrantTokens() != null) {
            sb.append("GrantTokens: " + getGrantTokens() + Constants.SEPARATOR_COMMA);
        }
        if (getName() != null) {
