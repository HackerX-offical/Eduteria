...
public class CustomKeyStoresListEntry implements Serializable {
    ...
    public String toString() {
        ...
        if (getCustomKeyStoreName() != null) {
            sb.append("CustomKeyStoreName: " + getCustomKeyStoreName() + Constants.SEPARATOR_COMMA);
        }
        if (getCloudHsmClusterId() != null) {
            sb.append("CloudHsmClusterId: " + getCloudHsmClusterId() + Constants.SEPARATOR_COMMA);
        }
        if (getTrustAnchorCertificate() != null) {
            sb.append("TrustAnchorCertificate: " + getTrustAnchorCertificate() + Constants.SEPARATOR_COMMA);
        }
        if (getConnectionState() != null) {
            sb.append("ConnectionState: " + getConnectionState() + Constants.SEPARATOR_COMMA);
        }
        if (getConnectionErrorCode() != null) {
            sb.append("ConnectionErrorCode: " + getConnectionErrorCode() + Constants.SEPARATOR_COMMA);
        }
