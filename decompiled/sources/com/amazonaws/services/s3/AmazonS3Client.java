...
public class AmazonS3Client extends AmazonWebServiceClient implements AmazonS3 {
    ...
    public VersionListing listVersions(ListVersionsRequest listVersionsRequest) throws AmazonClientException {
        ...
        addParameterIfNotNull((Request<?>) requestCreateRequest, "prefix", listVersionsRequest.getPrefix());
        addParameterIfNotNull((Request<?>) requestCreateRequest, "delimiter", listVersionsRequest.getDelimiter());
        addParameterIfNotNull((Request<?>) requestCreateRequest, "key-marker", listVersionsRequest.getKeyMarker());
        addParameterIfNotNull((Request<?>) requestCreateRequest, "version-id-marker", listVersionsRequest.getVersionIdMarker());
        addParameterIfNotNull((Request<?>) requestCreateRequest, "encoding-type", listVersionsRequest.getEncodingType());
    ...
    public ObjectListing listObjects(ListObjectsRequest listObjectsRequest) throws AmazonClientException {
        ...
        addParameterIfNotNull((Request<?>) requestCreateRequest, "prefix", listObjectsRequest.getPrefix());
        addParameterIfNotNull((Request<?>) requestCreateRequest, "delimiter", listObjectsRequest.getDelimiter());
        addParameterIfNotNull((Request<?>) requestCreateRequest, "marker", listObjectsRequest.getMarker());
        addParameterIfNotNull((Request<?>) requestCreateRequest, "encoding-type", listObjectsRequest.getEncodingType());
    ...
    public ListObjectsV2Result listObjectsV2(ListObjectsV2Request listObjectsV2Request) throws AmazonClientException {
        ...
        requestCreateRequest.addParameter("list-type", "2");
        addParameterIfNotNull((Request<?>) requestCreateRequest, "start-after", listObjectsV2Request.getStartAfter());
        addParameterIfNotNull((Request<?>) requestCreateRequest, "continuation-token", listObjectsV2Request.getContinuationToken());
        addParameterIfNotNull((Request<?>) requestCreateRequest, "delimiter", listObjectsV2Request.getDelimiter());
        addParameterIfNotNull((Request<?>) requestCreateRequest, "max-keys", listObjectsV2Request.getMaxKeys());
        addParameterIfNotNull((Request<?>) requestCreateRequest, "prefix", listObjectsV2Request.getPrefix());
        addParameterIfNotNull((Request<?>) requestCreateRequest, "encoding-type", listObjectsV2Request.getEncodingType());
        ...
        try {
            ...
            if (!ServiceUtils.skipMd5CheckPerRequest(getObjectRequest) && !ServiceUtils.skipMd5CheckPerResponse(s3Object.getObjectMetadata())) {
                ...
                if (eTag != null && !ServiceUtils.isMultipartUploadETag(eTag)) {
                    try {
                        serviceClientHolderInputStream = new DigestValidationInputStream(serviceClientHolderInputStream, MessageDigest.getInstance(org.jivesoftware.smack.util.StringUtils.MD5), BinaryUtils.fromHex(s3Object.getObjectMetadata().getETag()));
    ...
    public PutObjectResult putObject(PutObjectRequest putObjectRequest) throws AmazonClientException {
        ...
        boolean zSkipMd5CheckPerRequest = ServiceUtils.skipMd5CheckPerRequest(putObjectRequest);
    ...
    public CopyObjectResult copyObject(CopyObjectRequest copyObjectRequest) throws AmazonClientException {
        ...
        Request<? extends AmazonWebServiceRequest> requestCreateRequest = createRequest(destinationBucketName, destinationKey, copyObjectRequest, HttpMethodName.PUT);
    ...
    public BucketLifecycleConfiguration getBucketLifecycleConfiguration(GetBucketLifecycleConfigurationRequest getBucketLifecycleConfigurationRequest) {
        ...
        requestCreateRequest.addParameter("lifecycle", null);
        try {
    ...
    public void setBucketNotificationConfiguration(SetBucketNotificationConfigurationRequest setBucketNotificationConfigurationRequest) throws AmazonClientException {
        ...
        requestCreateRequest.addParameter("notification", null);
    ...
    public BucketLoggingConfiguration getBucketLoggingConfiguration(GetBucketLoggingConfigurationRequest getBucketLoggingConfigurationRequest) throws AmazonClientException {
        ...
        requestCreateRequest.addParameter(PingWorker.LOGGING, null);
    ...
    public InitiateMultipartUploadResult initiateMultipartUpload(InitiateMultipartUploadRequest initiateMultipartUploadRequest) throws AmazonClientException {
        ...
        if (initiateMultipartUploadRequest.objectMetadata != null) {
            populateRequestMetadata(requestCreateRequest, initiateMultipartUploadRequest.objectMetadata);
        }
    ...
    private S3Signer createSigV2Signer(Request<?> request, String str, String str2) {
        StringBuilder sbAppend = new StringBuilder(MqttTopic.TOPIC_LEVEL_SEPARATOR).append(str != null ? str + MqttTopic.TOPIC_LEVEL_SEPARATOR : "");
        if (str2 == null) {
            str2 = "";
        }
        return new S3Signer(request.getHttpMethod().toString(), sbAppend.append(str2).toString());
    }
    ...
    protected <T> void presignRequest(Request<T> request, HttpMethod httpMethod, String str, String str2, Date date, String str3) {
        ...
        String strReplaceAll = sbAppend.append(str2).append(str3 != null ? "?" + str3 : "").toString().replaceAll("(?<=/)/", "%2F");
    ...
    private void populateRequestWithCopyObjectParameters(Request<? extends AmazonWebServiceRequest> request, CopyObjectRequest copyObjectRequest) {
        String str = MqttTopic.TOPIC_LEVEL_SEPARATOR + copyObjectRequest.getSourceBucketName() + MqttTopic.TOPIC_LEVEL_SEPARATOR + copyObjectRequest.getSourceKey();
    ...
    private void populateRequestWithCopyPartParameters(Request<?> request, CopyPartRequest copyPartRequest) {
        String str = MqttTopic.TOPIC_LEVEL_SEPARATOR + copyPartRequest.getSourceBucketName() + MqttTopic.TOPIC_LEVEL_SEPARATOR + copyPartRequest.getSourceKey();
    ...
    private <X, Y extends AmazonWebServiceRequest> X invoke(Request<Y> request, HttpResponseHandler<AmazonWebServiceResponse<X>> httpResponseHandler, String str, String str2) {
        ...
        try {
            try {
                ...
                return (X) responseExecute.getAwsResponse();
            } catch (AmazonS3Exception e2) {
    ...
    public ListBucketMetricsConfigurationsResult listBucketMetricsConfigurations(ListBucketMetricsConfigurationsRequest listBucketMetricsConfigurationsRequest) throws AmazonClientException {
        ...
        requestCreateRequest.addParameter("metrics", null);
        addParameterIfNotNull((Request<?>) requestCreateRequest, "continuation-token", listBucketMetricsConfigurationsRequest.getContinuationToken());
    ...
    public DeleteBucketAnalyticsConfigurationResult deleteBucketAnalyticsConfiguration(DeleteBucketAnalyticsConfigurationRequest deleteBucketAnalyticsConfigurationRequest) throws AmazonClientException {
        ...
        requestCreateRequest.addParameter("analytics", null);
        requestCreateRequest.addParameter("id", strAssertStringNotEmpty2);
    ...
    public ListBucketAnalyticsConfigurationsResult listBucketAnalyticsConfigurations(ListBucketAnalyticsConfigurationsRequest listBucketAnalyticsConfigurationsRequest) throws AmazonClientException {
        ...
        requestCreateRequest.addParameter("analytics", null);
        addParameterIfNotNull((Request<?>) requestCreateRequest, "continuation-token", listBucketAnalyticsConfigurationsRequest.getContinuationToken());
    ...
    public ListBucketInventoryConfigurationsResult listBucketInventoryConfigurations(ListBucketInventoryConfigurationsRequest listBucketInventoryConfigurationsRequest) throws AmazonClientException {
        ...
        requestCreateRequest.addParameter("inventory", null);
        addParameterIfNotNull((Request<?>) requestCreateRequest, "continuation-token", listBucketInventoryConfigurationsRequest.getContinuationToken());
    ...
    private String urlEncodeTags(ObjectTagging objectTagging) {
        ...
        while (it.hasNext()) {
            Tag next = it.next();
            sb.append(S3HttpUtils.urlEncode(next.getKey(), false)).append('=').append(S3HttpUtils.urlEncode(next.getValue(), false));
            if (it.hasNext()) {
                sb.append("&");
            }
        }
    ...
    public GetObjectTaggingResult getObjectTagging(GetObjectTaggingRequest getObjectTaggingRequest) {
        ...
        requestCreateRequest.addParameter("tagging", null);
        addParameterIfNotNull((Request<?>) requestCreateRequest, "versionId", getObjectTaggingRequest.getVersionId());
    ...
    public DeleteObjectTaggingResult deleteObjectTagging(DeleteObjectTaggingRequest deleteObjectTaggingRequest) {
        ...
        requestCreateRequest.addParameter("tagging", null);
        addParameterIfNotNull((Request<?>) requestCreateRequest, "versionId", deleteObjectTaggingRequest.getVersionId());
    ...
    private String getBucketRegionViaHeadRequest(String str) {
        ...
        try {
            bucketRegion = ((HeadBucketResult) invoke(createRequest(str2, null, new HeadBucketRequest(str), HttpMethodName.HEAD, new URI("https://s3-us-west-1.amazonaws.com")), new HeadBucketResultHandler(), str2, (String) null)).getBucketRegion();
        } catch (AmazonS3Exception e3) {
            e = e3;
            AmazonS3Exception amazonS3Exception = e;
            if (amazonS3Exception.getAdditionalDetails() != null) {
                bucketRegion = amazonS3Exception.getAdditionalDetails().get(Headers.S3_BUCKET_REGION);
            }
        } catch (URISyntaxException unused2) {
            log.warn("Error while creating URI");
        }
        if (bucketRegion == null && log.isDebugEnabled()) {
            log.debug("Not able to derive region of the " + str2 + " from the HEAD Bucket requests.");
        }
        return bucketRegion;
    }
    ...
    private String getHostStyleResourcePath(String str) {
        return (str == null || !str.startsWith(MqttTopic.TOPIC_LEVEL_SEPARATOR)) ? str : MqttTopic.TOPIC_LEVEL_SEPARATOR + str;
    }

    private String getPathStyleResourcePath(String str, String str2) {
        StringBuilder sbAppend = new StringBuilder().append(str).append(MqttTopic.TOPIC_LEVEL_SEPARATOR);
        if (str2 == null) {
            str2 = "";
        }
