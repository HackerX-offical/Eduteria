...
public class XmlResponsesSaxParser {
    ...
    public static int parseInt(String str) {
        try {
            ...
            log.error("Unable to parse integer value '" + str + "'", e2);
            return -1;
        }
    }
    ...
    public static long parseLong(String str) {
        try {
            ...
            log.error("Unable to parse long value '" + str + "'", e2);
            return -1L;
        }
    }
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (!in("ListBucketResult")) {
                if (!in("ListBucketResult", "Contents")) {
                    ...
                    if (in("ListBucketResult", "CommonPrefixes") && str2.equals(TextFieldImplKt.PrefixId)) {
            ...
            if (str2.equals(Constants.KEY_ENCRYPTION_NAME)) {
            ...
            if (str2.equals(TextFieldImplKt.PrefixId)) {
            ...
            if (str2.equals("IsTruncated")) {
                String strLowerCase = StringUtils.lowerCase(getText());
                if (strLowerCase.startsWith("false")) {
                    this.objectListing.setTruncated(false);
                    return;
                } else {
                    if (strLowerCase.startsWith("true")) {
    ...
    public static class CopyObjectResultHandler extends AbstractSSEHandler implements ObjectExpirationResult, S3RequesterChargedResult, S3VersionResult {
        ...
        protected void doStartElement(String str, String str2, String str3, Attributes attributes) {
            if (atTopLevel()) {
                ...
                } else if (str2.equals(com.paytm.pgsdk.Constants.EVENT_ACTION_ERROR)) {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (in(com.paytm.pgsdk.Constants.EVENT_ACTION_ERROR)) {
                if (str2.equals("Code")) {
    ...
    public static class BucketWebsiteConfigurationHandler extends AbstractHandler {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (in("WebsiteConfiguration", "IndexDocument")) {
                if (str2.equals(TextFieldImplKt.SuffixId)) {
    ...
    public static class CompleteMultipartUploadHandler extends AbstractSSEHandler implements ObjectExpirationResult, S3VersionResult, S3RequesterChargedResult {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (atTopLevel()) {
                if (!str2.equals(com.paytm.pgsdk.Constants.EVENT_ACTION_ERROR) || (amazonS3Exception = this.ase) == null) {
                    return;
                }
        ...
        protected void doEndElement(String str, String str2, String str3) {
            if (in("DeleteResult")) {
                if (str2.equals("Deleted")) {
                    ...
                    if (str2.equals(com.paytm.pgsdk.Constants.EVENT_ACTION_ERROR)) {
            ...
            if (in("DeleteResult", com.paytm.pgsdk.Constants.EVENT_ACTION_ERROR)) {
                if (str2.equals("Key")) {
    ...
    public static class GetBucketAnalyticsConfigurationHandler extends AbstractHandler {
        ...
        protected void doEndElement(String str, String str2, String str3) {
            ...
            if (in("AnalyticsConfiguration", "StorageClassAnalysis", "DataExport", HttpHeaders.DESTINATION)) {
                ...
                } else if (str2.equals(TextFieldImplKt.PrefixId)) {
