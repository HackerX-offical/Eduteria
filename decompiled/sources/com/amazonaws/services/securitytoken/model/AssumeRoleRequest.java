...
public class AssumeRoleRequest extends AmazonWebServiceRequest implements Serializable {
    ...
    public String toString() {
        ...
        if (getRoleArn() != null) {
            sb.append("RoleArn: " + getRoleArn() + Constants.SEPARATOR_COMMA);
        }
        if (getRoleSessionName() != null) {
            sb.append("RoleSessionName: " + getRoleSessionName() + Constants.SEPARATOR_COMMA);
        }
        if (getPolicyArns() != null) {
        ...
        if (getDurationSeconds() != null) {
            sb.append("DurationSeconds: " + getDurationSeconds() + Constants.SEPARATOR_COMMA);
        }
        if (getExternalId() != null) {
            sb.append("ExternalId: " + getExternalId() + Constants.SEPARATOR_COMMA);
        }
        if (getSerialNumber() != null) {
            sb.append("SerialNumber: " + getSerialNumber() + Constants.SEPARATOR_COMMA);
        }
