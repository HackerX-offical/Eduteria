...
public class AssumeRoleWithWebIdentityResult implements Serializable {
    ...
    public String toString() {
        ...
        if (getCredentials() != null) {
            sb.append("Credentials: " + getCredentials() + Constants.SEPARATOR_COMMA);
        }
        if (getSubjectFromWebIdentityToken() != null) {
            sb.append("SubjectFromWebIdentityToken: " + getSubjectFromWebIdentityToken() + Constants.SEPARATOR_COMMA);
        }
        if (getAssumedRoleUser() != null) {
            sb.append("AssumedRoleUser: " + getAssumedRoleUser() + Constants.SEPARATOR_COMMA);
        }
        if (getPackedPolicySize() != null) {
            sb.append("PackedPolicySize: " + getPackedPolicySize() + Constants.SEPARATOR_COMMA);
        }
        if (getProvider() != null) {
            sb.append("Provider: " + getProvider() + Constants.SEPARATOR_COMMA);
        }
        if (getAudience() != null) {
