...
public class Credentials implements Serializable {
    ...
    public String toString() {
        ...
        if (getAccessKeyId() != null) {
            sb.append("AccessKeyId: " + getAccessKeyId() + Constants.SEPARATOR_COMMA);
        }
        if (getSecretAccessKey() != null) {
            sb.append("SecretAccessKey: " + getSecretAccessKey() + Constants.SEPARATOR_COMMA);
        }
        if (getSessionToken() != null) {
            sb.append("SessionToken: " + getSessionToken() + Constants.SEPARATOR_COMMA);
        }
