...
public class StaxUnmarshallerContext {
    ...
    public boolean testExpression(String str, int i) {
        ...
        int iIndexOf = -1;
        while (true) {
            iIndexOf = str.indexOf(MqttTopic.TOPIC_LEVEL_SEPARATOR, iIndexOf + 1);
            if (iIndexOf <= -1) {
                break;
            }
        ...
        return getCurrentDepth() == i && this.stackString.endsWith(new StringBuilder(MqttTopic.TOPIC_LEVEL_SEPARATOR).append(str).toString());
    }
