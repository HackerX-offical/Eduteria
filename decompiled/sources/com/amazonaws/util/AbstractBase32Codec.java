...
abstract class AbstractBase32Codec implements Codec {
    ...
    protected abstract int pos(byte b2);
    ...
    private final void encode4bytes(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i3 = (b4 & Ascii.SI) << 1;
        byte b5 = bArr[i + 3];
        bArr2[i2 + 4] = bArr3[((b5 >>> 7) & 1) | i3];
        bArr2[i2 + 5] = bArr3[(b5 >>> 2) & 31];
        bArr2[i2 + 6] = bArr3[(b5 & 3) << 3];
        bArr2[i2 + 7] = 61;
    }
    ...
    private final void encode3bytes(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i3 = i2 + 4;
        byte b4 = bArr[i + 2];
        bArr2[i2 + 3] = bArr3[((b4 >>> 4) & 15) | ((b3 & 1) << 4)];
        int i4 = i2 + 5;
        bArr2[i3] = bArr3[(b4 & Ascii.SI) << 1];
        int i5 = 0;
        while (i5 < 3) {
            bArr2[i4] = 61;
            i5++;
