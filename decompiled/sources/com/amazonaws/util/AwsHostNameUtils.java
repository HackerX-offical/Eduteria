...
public class AwsHostNameUtils {
    ...
    public static String parseRegionName(String str, String str2) {
        ...
        if (str.endsWith(".amazonaws.com.cn")) {
            return parseStandardRegionName(str.substring(0, str.length() - ".amazonaws.com.cn".length()));
        }
        if (str2 != null) {
    ...
    public static String localHostName() {
        try {
            ...
            LogFactory.getLog(AwsHostNameUtils.class).debug("Failed to determine the local hostname; fall back to use \"localhost\".", e2);
            return "localhost";
        }
    }
}
