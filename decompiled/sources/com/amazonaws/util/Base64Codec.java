...
class Base64Codec implements Codec {
    ...
    void encode3bytes(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        byte b3 = bArr[i + 1];
        bArr2[i2 + 1] = bArr3[((b2 & 3) << 4) | ((b3 >>> 4) & 15)];
        int i3 = (b3 & Ascii.SI) << 2;
        byte b4 = bArr[i + 2];
        bArr2[i2 + 2] = bArr3[((b4 >>> 6) & 3) | i3];
        bArr2[i2 + 3] = bArr3[b4 & Utf8.REPLACEMENT_BYTE];
    }
    ...
    void encode2bytes(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        byte b3 = bArr[i3];
        bArr2[i2 + 1] = bArr3[((b2 & 3) << 4) | ((b3 >>> 4) & 15)];
        bArr2[i2 + 2] = bArr3[(b3 & Ascii.SI) << 2];
        bArr2[i2 + 3] = 61;
    }
