...
public class NoDataSettings extends Base {
    ...
    public NoDataSettings(String str) {
        StringBuilder sb = new StringBuilder("noDataSettings");
    ...
    public Label label() {
        return new Label(this.jsBase + ".label()");
    }

    public NoDataSettings label(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".label(%s);", wrapQuotes(str)));
        return this;
    }

    public NoDataSettings label(Boolean bool) {
