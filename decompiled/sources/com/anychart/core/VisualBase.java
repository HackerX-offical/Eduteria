...
public class VisualBase extends Base {
    ...
    public VisualBase(String str) {
        StringBuilder sb = new StringBuilder("visualBase");
    ...
    public VisualBase enabled(Boolean bool) {
    ...
    public VisualBase zIndex(Number number) {
