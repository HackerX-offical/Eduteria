...
public class Line extends Base {
    ...
    @Override // com.anychart.core.annotations.Base
    public Line allowEdit(String str) {
    ...
    @Override // com.anychart.core.annotations.Base
    public Line hoverGap(String str) {
    ...
    public Line secondValueAnchor(String str) {
    ...
    public Line secondXAnchor(String str) {
    ...
    public Line valueAnchor(String str) {
    ...
    @Override // com.anychart.core.annotations.Base
    public Line xScale(StockScatterDateTime stockScatterDateTime) {
