...
public class MapSettings extends VisualBase {
    ...
    public MapSettings(String str) {
        StringBuilder sb = new StringBuilder("mapSettings");
    ...
    public Map bottom() {
        return new Map(this.jsBase + ".bottom()");
    }

    public MapSettings bottom(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".bottom(%s);", bool));
        return this;
    }

    public MapSettings bottom(String str) {
    ...
    public MapSettings drawFirstLabel(Boolean bool) {
    ...
    public MapSettings drawLastLabel(Boolean bool) {
    ...
    @Override // com.anychart.core.VisualBase
    public MapSettings enabled(Boolean bool) {
    ...
    public MapSettings labels(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".labels(%s);", wrapQuotes(str)));
        return this;
    }

    public MapSettings labels(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".labels(%s);", bool));
        return this;
    }

    public Map left() {
        return new Map(this.jsBase + ".left()");
    }

    public MapSettings left(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".left(%s);", bool));
        return this;
    }

    public MapSettings left(String str) {
    ...
    public MapSettings overlapMode(LabelsOverlapMode labelsOverlapMode) {
    ...
    public MapSettings overlapMode(String str) {
    ...
    public Map right() {
        return new Map(this.jsBase + ".right()");
    }

    public MapSettings right(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".right(%s);", bool));
        return this;
    }

    public MapSettings right(String str) {
    ...
    public MapSettings stroke(Stroke stroke, Number number, String str, String str2, String str3) {
    ...
    public MapSettings stroke(Stroke stroke, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public MapSettings stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public MapSettings stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public MapSettings stroke(ColoredFill coloredFill, Number number, String str, String str2, String str3) {
    ...
    public MapSettings stroke(ColoredFill coloredFill, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public MapSettings stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public MapSettings stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public MapSettings stroke(String str, Number number, String str2, String str3, String str4) {
    ...
    public MapSettings stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    public MapSettings stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, String str3) {
    ...
    public MapSettings stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public MapSettings title(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".title(%s);", bool));
        return this;
    }

    public MapSettings title(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".title(%s);", wrapQuotes(str)));
        return this;
    }

    public Map top() {
        return new Map(this.jsBase + ".top()");
    }

    public MapSettings top(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".top(%s);", bool));
        return this;
    }

    public MapSettings top(String str) {
    ...
    @Override // com.anychart.core.VisualBase
    public MapSettings zIndex(Number number) {
