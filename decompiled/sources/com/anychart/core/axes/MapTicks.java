...
public class MapTicks extends VisualBase {
    ...
    public MapTicks(String str) {
        StringBuilder sb = new StringBuilder("mapTicks");
    ...
    @Override // com.anychart.core.VisualBase
    public MapTicks enabled(Boolean bool) {
    ...
    public MapTicks position(SidePosition sidePosition) {
    ...
    public MapTicks position(String str) {
    ...
    public MapTicks stroke(Stroke stroke, Number number, String str, String str2, String str3) {
    ...
    public MapTicks stroke(Stroke stroke, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public MapTicks stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public MapTicks stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public MapTicks stroke(String str, Number number, String str2, String str3, String str4) {
    ...
    public MapTicks stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    public MapTicks stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, String str3) {
    ...
    public MapTicks stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public MapTicks stroke(String str) {
    ...
    @Override // com.anychart.core.VisualBase
    public MapTicks zIndex(Number number) {
