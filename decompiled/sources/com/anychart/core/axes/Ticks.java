...
public class Ticks extends VisualBase {
    ...
    @Override // com.anychart.core.VisualBase
    public Ticks enabled(Boolean bool) {
    ...
    public Ticks length(Number number) {
    ...
    public Ticks position(SidePosition sidePosition) {
    ...
    public Ticks position(String str) {
    ...
    public Ticks stroke(Stroke stroke) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".stroke(%s);", stroke != null ? stroke.getJsBase() : null));
        return this;
    }

    public Ticks stroke(String str, Number number, String str2, String str3, String str4) {
    ...
    public Ticks stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    public Ticks stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, String str3) {
    ...
    public Ticks stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Ticks stroke(String str) {
    ...
    @Override // com.anychart.core.VisualBase
    public Ticks zIndex(Number number) {
