...
public class GanttLine extends VisualBase {
    ...
    public GanttLine(String str) {
        StringBuilder sb = new StringBuilder("ganttLine");
    ...
    @Override // com.anychart.core.VisualBase
    public GanttLine enabled(Boolean bool) {
    ...
    public GanttLine scale(GanttDateTime ganttDateTime) {
    ...
    public GanttLine stroke(Stroke stroke, Number number, String str, String str2, String str3) {
    ...
    public GanttLine stroke(Stroke stroke, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public GanttLine stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public GanttLine stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public GanttLine stroke(ColoredFill coloredFill, Number number, String str, String str2, String str3) {
    ...
    public GanttLine stroke(ColoredFill coloredFill, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public GanttLine stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public GanttLine stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public GanttLine stroke(String str, Number number, String str2, String str3, String str4) {
    ...
    public GanttLine stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    public GanttLine stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, String str3) {
    ...
    public GanttLine stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public GanttLine stroke(String str) {
    ...
    public GanttLine value(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".value(%s);", number));
        return this;
    }

    public GanttLine value(GanttDateTimeMarkers ganttDateTimeMarkers) {
    ...
    public GanttLine value(String str) {
    ...
    @Override // com.anychart.core.VisualBase
    public GanttLine zIndex(Number number) {
