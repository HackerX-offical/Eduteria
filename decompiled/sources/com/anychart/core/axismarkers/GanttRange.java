...
public class GanttRange extends VisualBase {
    ...
    public GanttRange(String str) {
        StringBuilder sb = new StringBuilder("ganttRange");
    ...
    @Override // com.anychart.core.VisualBase
    public GanttRange enabled(Boolean bool) {
    ...
    public GanttRange fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    public GanttRange fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    public GanttRange fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    public GanttRange fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    public GanttRange fill(String[] strArr, Number number, String str, Number number2) {
    ...
    public GanttRange fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public GanttRange fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public GanttRange from(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".from(%s);", number));
        return this;
    }

    public GanttRange from(GanttDateTimeMarkers ganttDateTimeMarkers) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".from(%s);", ganttDateTimeMarkers != null ? ganttDateTimeMarkers.getJsBase() : null));
        return this;
    }

    public GanttRange from(String str) {
    ...
    public GanttRange scale(GanttDateTime ganttDateTime) {
    ...
    public GanttRange to(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".to(%s);", number));
        return this;
    }

    public GanttRange to(GanttDateTimeMarkers ganttDateTimeMarkers) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".to(%s);", ganttDateTimeMarkers != null ? ganttDateTimeMarkers.getJsBase() : null));
        return this;
    }

    public GanttRange to(String str) {
    ...
    @Override // com.anychart.core.VisualBase
    public GanttRange zIndex(Number number) {
