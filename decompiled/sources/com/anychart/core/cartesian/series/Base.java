...
public class Base extends SeriesBase {
    ...
    public static Base instantiate() {
        return new Base("new anychart.core.cartesian.series.base()");
    }
    ...
    public Base isVertical(Boolean bool) {
    ...
    public Base xPointPosition(Number number) {
