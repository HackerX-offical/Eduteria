...
public class Marker extends Base {
    ...
    public static Marker instantiate() {
        return new Marker("new anychart.core.cartesian.series.marker()");
    }
    ...
    @Override // com.anychart.core.cartesian.series.Base
    public Marker isVertical(Boolean bool) {
    ...
    @Override // com.anychart.core.cartesian.series.Base
    public Marker rendering(String str) {
    ...
    @Override // com.anychart.core.cartesian.series.Base
    public Marker seriesType(String str) {
    ...
    @Override // com.anychart.core.cartesian.series.Base
    public Marker xPointPosition(Number number) {
