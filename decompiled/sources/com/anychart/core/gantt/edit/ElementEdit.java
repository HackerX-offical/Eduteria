...
public class ElementEdit extends Base {
    ...
    public ElementEdit(String str) {
        StringBuilder sb = new StringBuilder("elementEdit");
    ...
    public Thumb connectorThumbs() {
        return new Thumb(this.jsBase + ".connectorThumbs()");
    }

    public ElementEdit connectorThumbs(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".connectorThumbs(%s);", wrapQuotes(str)));
        return this;
    }
    ...
    public ElementEdit enabled(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".enabled(%s);", bool));
        return this;
    }

    public SideControl end() {
        return new SideControl(this.jsBase + ".end()");
    }

    public ElementEdit end(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".end(%s);", wrapQuotes(str)));
        return this;
    }
    ...
    public ElementEdit fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    public ElementEdit fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    public ElementEdit fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    public ElementEdit fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    public ElementEdit fill(String[] strArr, Number number, String str, Number number2) {
    ...
    public ElementEdit fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public ElementEdit fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public SideControl start() {
        return new SideControl(this.jsBase + ".start()");
    }

    public ElementEdit start(String str) {
    ...
    public ElementEdit stroke(Stroke stroke, Number number, String str, String str2, String str3) {
    ...
    public ElementEdit stroke(Stroke stroke, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public ElementEdit stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public ElementEdit stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public ElementEdit stroke(String str, Number number, String str2, String str3, String str4) {
    ...
    public ElementEdit stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    public ElementEdit stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, String str3) {
    ...
    public ElementEdit stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public ElementEdit stroke(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".stroke(%s);", wrapQuotes(str)));
        return this;
    }

    public Thumb thumbs() {
        return new Thumb(this.jsBase + ".thumbs()");
    }

    public ElementEdit thumbs(String str) {
    ...
    public ElementEdit fill(String str) {
