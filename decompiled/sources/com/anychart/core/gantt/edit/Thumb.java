...
public class Thumb extends Base {
    protected Thumb() {
    }

    public static Thumb instantiate() {
        return new Thumb("new anychart.core.gantt.edit.thumb()");
    }
    ...
    public Thumb enabled(Boolean bool) {
    ...
    public Thumb fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    public Thumb fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    public Thumb fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    public Thumb fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    public Thumb fill(String[] strArr, Number number, String str, Number number2) {
    ...
    public Thumb fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Thumb fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Thumb horizontalOffset(Number number) {
    ...
    public Thumb size(Number number) {
    ...
    public Thumb stroke(Stroke stroke, Number number, String str, String str2, String str3) {
    ...
    public Thumb stroke(Stroke stroke, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public Thumb stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public Thumb stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Thumb stroke(String str, Number number, String str2, String str3, String str4) {
    ...
    public Thumb stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    public Thumb stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, String str3) {
    ...
    public Thumb stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Thumb stroke(String str) {
