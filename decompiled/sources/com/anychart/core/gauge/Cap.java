package com.anychart.core.gauge;
...
public class Cap extends VisualBase {
    ...
    public static Cap instantiate() {
        return new Cap("new anychart.core.gauge.cap()");
    }
    ...
    @Override // com.anychart.core.VisualBase
    public Cap enabled(Boolean bool) {
    ...
    public Cap fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    public Cap fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    public Cap fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    public Cap fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    public Cap fill(String[] strArr, Number number, String str, Number number2) {
    ...
    public Cap fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Cap fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Cap hatchFill(HatchFillType hatchFillType, String str, Number number, Number number2) {
    ...
    public Cap hatchFill(String str, String str2, Number number, Number number2) {
    ...
    public Cap stroke(Stroke stroke, Number number, String str, String str2, String str3) {
    ...
    public Cap stroke(Stroke stroke, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public Cap stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public Cap stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Cap stroke(ColoredFill coloredFill, Number number, String str, String str2, String str3) {
    ...
    public Cap stroke(ColoredFill coloredFill, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public Cap stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public Cap stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Cap stroke(String str, Number number, String str2, String str3, String str4) {
    ...
    public Cap stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    public Cap stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, String str3) {
    ...
    public Cap stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.VisualBase
    public Cap zIndex(Number number) {
