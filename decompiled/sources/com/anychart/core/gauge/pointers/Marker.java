...
public class Marker extends Base {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Marker axisIndex(Number number) {
    ...
    public Marker position(GaugeSidePosition gaugeSidePosition) {
    ...
    public Marker position(String str) {
