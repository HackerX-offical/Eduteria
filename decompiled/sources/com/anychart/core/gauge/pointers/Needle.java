...
public class Needle extends Base {
    protected Needle() {
    }

    public static Needle instantiate() {
        return new Needle("new anychart.core.gauge.pointers.needle()");
    }

    public Needle(String str) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle axisIndex(Number number) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle dataIndex(Number number) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base, com.anychart.core.VisualBase
    public Needle enabled(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".enabled(%s);", bool));
        return this;
    }

    public void endRadius() {
        APIlib.getInstance().addJSLine(this.jsBase + ".endRadius();");
    }

    public Needle endRadius(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".endRadius(%s);", number));
        return this;
    }

    public Needle endRadius(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".endRadius(%s);", wrapQuotes(str)));
        return this;
    }

    public void endWidth() {
        APIlib.getInstance().addJSLine(this.jsBase + ".endWidth();");
    }

    public Needle endWidth(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".endWidth(%s);", number));
        return this;
    }

    public Needle endWidth(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".endWidth(%s);", wrapQuotes(str)));
        return this;
    }
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle fill(String[] strArr, Number number, String str, Number number2) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle hatchFill(HatchFillType hatchFillType, String str, Number number, Number number2) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle hatchFill(String str, String str2, Number number, Number number2) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle id(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".id(%s);", wrapQuotes(str)));
        return this;
    }

    @Override // com.anychart.core.gauge.pointers.Base
    public Needle id(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".id(%s);", number));
        return this;
    }

    public void middleRadius() {
        APIlib.getInstance().addJSLine(this.jsBase + ".middleRadius();");
    }

    public Needle middleRadius(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".middleRadius(%s);", number));
        return this;
    }

    public Needle middleRadius(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".middleRadius(%s);", wrapQuotes(str)));
        return this;
    }

    public void middleWidth() {
        APIlib.getInstance().addJSLine(this.jsBase + ".middleWidth();");
    }

    public Needle middleWidth(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".middleWidth(%s);", number));
        return this;
    }

    public Needle middleWidth(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".middleWidth(%s);", wrapQuotes(str)));
        return this;
    }
    ...
    public void startRadius() {
        APIlib.getInstance().addJSLine(this.jsBase + ".startRadius();");
    }

    public Needle startRadius(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".startRadius(%s);", number));
        return this;
    }

    public Needle startRadius(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".startRadius(%s);", wrapQuotes(str)));
        return this;
    }

    public void startWidth() {
        APIlib.getInstance().addJSLine(this.jsBase + ".startWidth();");
    }

    public Needle startWidth(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".startWidth(%s);", number));
        return this;
    }

    public Needle startWidth(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".startWidth(%s);", wrapQuotes(str)));
        return this;
    }
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(Stroke stroke, Number number, String str, String str2, String str3) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(Stroke stroke, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(ColoredFill coloredFill, Number number, String str, String str2, String str3) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(ColoredFill coloredFill, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(String str, Number number, String str2, String str3, String str4) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, String str3) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base
    public Needle stroke(String str) {
    ...
    @Override // com.anychart.core.gauge.pointers.Base, com.anychart.core.VisualBase
    public Needle zIndex(Number number) {
