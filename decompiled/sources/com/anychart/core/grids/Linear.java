...
public class Linear extends VisualBase {
    ...
    public static Linear instantiate() {
        return new Linear("new anychart.core.grids.linear()");
    }
    ...
    public com.anychart.core.axes.Linear axis() {
        return new com.anychart.core.axes.Linear(this.jsBase + ".axis()");
    }

    public Linear axis(com.anychart.core.axes.Linear linear) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".axis(%s);", linear != null ? linear.getJsBase() : null));
        return this;
    }
    ...
    public Linear drawFirstLine(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".drawFirstLine(%s);", bool));
        return this;
    }
    ...
    public Linear drawLastLine(Boolean bool) {
    ...
    public Linear fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    public Linear fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    public Linear fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    public Linear fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    public Linear fill(String[] strArr, Number number, String str, Number number2) {
    ...
    public Linear fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Linear fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Linear isMinor(Boolean bool) {
    ...
    @Override // com.anychart.core.VisualBase
    public Linear parentBounds(com.anychart.math.Rect rect) {
    ...
    @Override // com.anychart.core.VisualBase
    public Linear parentBounds(Number number) {
