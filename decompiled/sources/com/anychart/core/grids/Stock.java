...
public class Stock extends VisualBase {
    ...
    public Stock axis(StockDateTime stockDateTime) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".axis(%s);", stockDateTime != null ? stockDateTime.getJsBase() : null));
        return this;
    }

    public Stock axis(com.anychart.core.axes.Linear linear) {
    ...
    public Stock drawFirstLine(Boolean bool) {
    ...
    public Stock drawLastLine(Boolean bool) {
    ...
    public Stock fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    public Stock fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    public Stock fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    public Stock fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    public Stock fill(String[] strArr, Number number, String str, Number number2) {
    ...
    public Stock fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Stock fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Stock isMinor(Boolean bool) {
    ...
    public Stock scale(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".scale(%s);", wrapQuotes(str)));
        return this;
    }

    public Stock scale(Base base) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".scale(%s);", base != null ? base.getJsBase() : null));
        return this;
    }

    public Stock scale(StockScatterDateTime stockScatterDateTime) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".scale(%s);", stockScatterDateTime != null ? stockScatterDateTime.getJsBase() : null));
        return this;
    }
    ...
    public Stock stroke(Stroke stroke, Number number, String str, String str2, String str3) {
    ...
    public Stock stroke(Stroke stroke, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public Stock stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public Stock stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Stock stroke(ColoredFill coloredFill, Number number, String str, String str2, String str3) {
    ...
    public Stock stroke(ColoredFill coloredFill, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public Stock stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public Stock stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Stock stroke(String str, Number number, String str2, String str3, String str4) {
    ...
    public Stock stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    public Stock stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, String str3) {
    ...
    public Stock stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.VisualBase
    public Stock parentBounds(com.anychart.math.Rect rect) {
