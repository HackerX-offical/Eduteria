...
public class Base extends VisualBase {
    ...
    public Base dataIndex(Number number) {
    ...
    public Base fill(GradientKey gradientKey) {
    ...
    public Base fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    public Base fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    public Base labels(LabelsFactory labelsFactory) {
    ...
    public Base scale(com.anychart.scales.Base base) {
    ...
    @Override // com.anychart.core.VisualBase
    public Base parentBounds(com.anychart.math.Rect rect) {
