...
public class Marker extends Base {
    ...
    public static Marker instantiate() {
        return new Marker("new anychart.core.linearGauge.pointers.marker()");
    }
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Marker dataIndex(Number number) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Marker labels(LabelsFactory labelsFactory) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Marker scale(com.anychart.scales.Base base) {
