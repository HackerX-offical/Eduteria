...
public class Thermometer extends Base {
    protected Thermometer() {
    }

    public static Thermometer instantiate() {
        return new Thermometer("new anychart.core.linearGauge.pointers.thermometer()");
    }

    public Thermometer(String str) {
        StringBuilder sb = new StringBuilder("thermometer");
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base, com.anychart.core.VisualBase, com.anychart.core.Base, com.anychart.JsObject
    public String getJsBase() {
        return this.jsBase;
    }

    public void bulbPadding() {
        APIlib.getInstance().addJSLine(this.jsBase + ".bulbPadding();");
    }

    public Thermometer bulbPadding(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".bulbPadding(%s);", wrapQuotes(str)));
        return this;
    }

    public Thermometer bulbPadding(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".bulbPadding(%s);", number));
        return this;
    }

    public void bulbRadius() {
        APIlib.getInstance().addJSLine(this.jsBase + ".bulbRadius();");
    }

    public Thermometer bulbRadius(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".bulbRadius(%s);", wrapQuotes(str)));
        return this;
    }

    @Override // com.anychart.core.lineargauge.pointers.Base
    public void color() {
        APIlib.getInstance().addJSLine(this.jsBase + ".color();");
    }

    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer color(String str) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer dataIndex(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".dataIndex(%s);", number));
        return this;
    }

    @Override // com.anychart.core.lineargauge.pointers.Base, com.anychart.core.VisualBase
    public void enabled() {
        APIlib.getInstance().addJSLine(this.jsBase + ".enabled();");
    }

    @Override // com.anychart.core.lineargauge.pointers.Base, com.anychart.core.VisualBase
    public Thermometer enabled(Boolean bool) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer fill(String[] strArr, Number number, String str, Number number2) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer hatchFill(HatchFillType hatchFillType, String str, Number number, Number number2) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer hatchFill(String str, String str2, Number number, Number number2) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer hovered(String str) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer labels(LabelsFactory labelsFactory) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer legendItem(String str) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer name(String str) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer normal(String str) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base, com.anychart.core.VisualBase, com.anychart.core.Base
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer scale(com.anychart.scales.Base base) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer selected(String str) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer stroke(Stroke stroke, Number number, String str, String str2, String str3) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer stroke(Stroke stroke, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer stroke(ColoredFill coloredFill, Number number, String str, String str2, String str3) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer stroke(ColoredFill coloredFill, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer stroke(String str, Number number, String str2, String str3, String str4) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, String str3) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer width(String str) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base, com.anychart.core.VisualBase
    public Thermometer zIndex(Number number) {
    ...
    @Override // com.anychart.core.lineargauge.pointers.Base
    public Thermometer fill(String str) {
