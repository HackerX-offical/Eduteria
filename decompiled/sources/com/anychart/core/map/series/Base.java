...
public class Base extends SeriesBase {
    ...
    public static Base instantiate() {
        return new Base("new anychart.core.map.series.base()");
    }
    ...
    public Base allowPointsSelect(Boolean bool) {
    ...
    public Base fill(GradientKey gradientKey, Number number, com.anychart.graphics.vector.Rect rect, Number number2) {
    ...
    public Base fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    public Base fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    public Base fill(String[] strArr, Number number, com.anychart.graphics.vector.Rect rect, Number number2) {
    ...
    public Base fill(String[] strArr, Number number, String str, Number number2) {
    ...
    public Base fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Base fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Base geoIdField(String str) {
    ...
    public Base hatchFill(HatchFillType hatchFillType, String str, Number number, Number number2) {
    ...
    public Base hatchFill(String str, String str2, Number number, Number number2) {
    ...
    public Base overlapMode(LabelsOverlapMode labelsOverlapMode) {
    ...
    public Base stroke(ColoredFill coloredFill, Number number, String str, String str2, String str3) {
    ...
    public Base stroke(ColoredFill coloredFill, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public Base stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public Base stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
