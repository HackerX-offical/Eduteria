...
public class Bubble extends BaseWithMarkers {
    ...
    public static Bubble instantiate() {
        return new Bubble("new anychart.core.map.series.bubble()");
    }
    ...
    @Override // com.anychart.core.map.series.BaseWithMarkers, com.anychart.core.map.series.Base
    public Bubble allowPointsSelect(Boolean bool) {
    ...
    @Override // com.anychart.core.map.series.BaseWithMarkers, com.anychart.core.map.series.Base
    public Bubble geoIdField(String str) {
    ...
    @Override // com.anychart.core.map.series.BaseWithMarkers, com.anychart.core.map.series.Base
    public Bubble overlapMode(LabelsOverlapMode labelsOverlapMode) {
