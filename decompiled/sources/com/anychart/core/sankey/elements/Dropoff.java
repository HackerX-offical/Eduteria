...
public class Dropoff extends Base {
    protected Dropoff() {
    }

    public static Dropoff instantiate() {
        return new Dropoff("new anychart.core.sankey.elements.dropoff()");
    }

    public Dropoff(String str) {
        StringBuilder sb = new StringBuilder("dropoff");
    ...
    public Dropoff hovered(String str) {
    ...
    public Dropoff normal(String str) {
