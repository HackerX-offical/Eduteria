...
public class Cartesian extends Base {
    protected Cartesian() {
    }

    public static Cartesian instantiate() {
        return new Cartesian("new anychart.core.series.cartesian()");
    }
    ...
    @Override // com.anychart.core.series.Base
    public Cartesian name(String str) {
    ...
    public Cartesian selectionMode(SelectionMode selectionMode) {
    ...
    public com.anychart.scales.Base xScale(com.anychart.scales.Base base) {
        return new com.anychart.scales.Base(String.format(Locale.US, this.jsBase + ".xScale(%s)", base != null ? base.getJsBase() : null));
    }
    ...
    public Cartesian data(View view) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".data(%s);", view != null ? view.getJsBase() : null));
        return this;
    }

    public Cartesian data(List<DataEntry> list, TreeFillingMethod treeFillingMethod) {
    ...
    public Cartesian data(List<DataEntry> list, String str) {
