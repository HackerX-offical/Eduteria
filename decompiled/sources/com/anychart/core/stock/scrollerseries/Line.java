...
public class Line extends Base {
    ...
    public static Line instantiate() {
        return new Line("new anychart.core.stock.scrollerSeries.line()");
    }
    ...
    @Override // com.anychart.core.stock.scrollerseries.Base
    public Line allowPointSettings(Boolean bool) {
    ...
    @Override // com.anychart.core.stock.scrollerseries.Base
    public Line yScale(ScatterBase scatterBase) {
