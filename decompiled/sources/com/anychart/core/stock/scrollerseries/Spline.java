...
public class Spline extends Base {
    ...
    public static Spline instantiate() {
        return new Spline("new anychart.core.stock.scrollerSeries.spline()");
    }
    ...
    @Override // com.anychart.core.stock.scrollerseries.Base
    public Spline allowPointSettings(Boolean bool) {
    ...
    @Override // com.anychart.core.stock.scrollerseries.Base
    public Spline yScale(ScatterBase scatterBase) {
