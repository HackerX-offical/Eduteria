...
public class StepArea extends Base {
    protected StepArea() {
    }

    public static StepArea instantiate() {
        return new StepArea("new anychart.core.stock.scrollerSeries.stepArea()");
    }
    ...
    @Override // com.anychart.core.stock.scrollerseries.Base
    public StepArea allowPointSettings(Boolean bool) {
    ...
    @Override // com.anychart.core.stock.scrollerseries.Base
    public StepArea yScale(ScatterBase scatterBase) {
