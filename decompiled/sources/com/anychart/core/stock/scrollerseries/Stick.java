...
public class Stick extends DiscreteBase {
    protected Stick() {
    }

    public static Stick instantiate() {
        return new Stick("new anychart.core.stock.scrollerSeries.stick()");
    }
    ...
    @Override // com.anychart.core.stock.scrollerseries.DiscreteBase, com.anychart.core.stock.scrollerseries.Base
    public Stick allowPointSettings(Boolean bool) {
    ...
    @Override // com.anychart.core.stock.scrollerseries.DiscreteBase, com.anychart.core.stock.scrollerseries.Base
    public Stick yScale(ScatterBase scatterBase) {
