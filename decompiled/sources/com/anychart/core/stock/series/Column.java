...
public class Column extends DiscreteBase {
    protected Column() {
    }

    public static Column instantiate() {
        return new Column("new anychart.core.stock.series.column()");
    }
    ...
    @Override // com.anychart.core.stock.series.DiscreteBase, com.anychart.core.stock.series.Base
    public Column allowPointSettings(Boolean bool) {
    ...
    @Override // com.anychart.core.stock.series.DiscreteBase, com.anychart.core.stock.series.Base
    public Column yScale(ScatterBase scatterBase) {
