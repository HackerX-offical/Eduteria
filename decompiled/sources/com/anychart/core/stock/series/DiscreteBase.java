...
public class DiscreteBase extends Base {
    ...
    public static DiscreteBase instantiate() {
        return new DiscreteBase("new anychart.core.stock.series.discreteBase()");
    }
    ...
    @Override // com.anychart.core.stock.series.Base
    public DiscreteBase allowPointSettings(Boolean bool) {
    ...
    @Override // com.anychart.core.stock.series.Base
    public DiscreteBase pointWidth(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".pointWidth(%s);", number));
        return this;
    }

    @Override // com.anychart.core.stock.series.Base
    public DiscreteBase pointWidth(String str) {
    ...
    @Override // com.anychart.core.stock.series.Base
    public DiscreteBase yScale(ScatterBase scatterBase) {
    ...
    @Override // com.anychart.core.stock.series.Base
    public DiscreteBase maxPointWidth(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".maxPointWidth(%s);", number));
        return this;
    }

    @Override // com.anychart.core.stock.series.Base
    public DiscreteBase maxPointWidth(String str) {
    ...
    @Override // com.anychart.core.stock.series.Base
    public DiscreteBase minPointLength(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".minPointLength(%s);", number));
        return this;
    }

    @Override // com.anychart.core.stock.series.Base
    public DiscreteBase minPointLength(String str) {
