...
public class Hilo extends Base {
    ...
    public static Hilo instantiate() {
        return new Hilo("new anychart.core.stock.series.hilo()");
    }
    ...
    @Override // com.anychart.core.stock.series.Base
    public Hilo allowPointSettings(Boolean bool) {
    ...
    @Override // com.anychart.core.stock.series.Base
    public Hilo yScale(ScatterBase scatterBase) {
