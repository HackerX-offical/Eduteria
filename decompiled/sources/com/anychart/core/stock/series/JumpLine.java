...
public class JumpLine extends Base {
    protected JumpLine() {
    }

    public static JumpLine instantiate() {
        return new JumpLine("new anychart.core.stock.series.jumpLine()");
    }
    ...
    @Override // com.anychart.core.stock.series.Base
    public JumpLine allowPointSettings(Boolean bool) {
    ...
    @Override // com.anychart.core.stock.series.Base
    public JumpLine yScale(ScatterBase scatterBase) {
