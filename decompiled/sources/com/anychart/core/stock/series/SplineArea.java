...
public class SplineArea extends Base {
    protected SplineArea() {
    }

    public static SplineArea instantiate() {
        return new SplineArea("new anychart.core.stock.series.splineArea()");
    }
    ...
    @Override // com.anychart.core.stock.series.Base
    public SplineArea allowPointSettings(Boolean bool) {
    ...
    @Override // com.anychart.core.stock.series.Base
    public SplineArea yScale(ScatterBase scatterBase) {
    ...
    @Override // com.anychart.core.stock.series.Base
    public SplineArea maxPointWidth(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".maxPointWidth(%s);", number));
        return this;
    }

    @Override // com.anychart.core.stock.series.Base
    public SplineArea maxPointWidth(String str) {
    ...
    @Override // com.anychart.core.stock.series.Base
    public SplineArea minPointLength(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".minPointLength(%s);", number));
        return this;
    }

    @Override // com.anychart.core.stock.series.Base
    public SplineArea minPointLength(String str) {
