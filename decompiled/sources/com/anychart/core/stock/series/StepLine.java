...
public class StepLine extends Base {
    protected StepLine() {
    }

    public static StepLine instantiate() {
        return new StepLine("new anychart.core.stock.series.stepLine()");
    }
    ...
    @Override // com.anychart.core.stock.series.Base
    public StepLine allowPointSettings(Boolean bool) {
    ...
    @Override // com.anychart.core.stock.series.Base
    public StepLine yScale(ScatterBase scatterBase) {
