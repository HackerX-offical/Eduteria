...
public class Label extends JsObject {
    ...
    public void autoRotate() {
        APIlib.getInstance().addJSLine(this.jsBase + ".autoRotate();");
    }

    public Label autoRotate(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".autoRotate(%s);", bool));
        return this;
    }
    ...
    public Label padding(Number number) {
    ...
    public void positionFormatter(String str) {
    ...
    public Rect measureWithText(String str) {
        return new Rect(String.format(Locale.US, this.jsBase + ".measureWithText(%s)", wrapQuotes(str)));
    }
