package com.anychart.core.ui.markersfactory;
...
public class Marker extends VisualBase {
    protected Marker() {
    }

    public static Marker instantiate() {
        return new Marker("new anychart.core.ui.MarkersFactory.marker()");
    }
    ...
    public Marker position(Position position) {
    ...
    public Marker rotation(Number number) {
    ...
    public Marker stroke(Stroke stroke) {
