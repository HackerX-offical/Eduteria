package com.anychart.core.ui.scroller;
...
public class Thumbs extends JsObject {
    ...
    public static Thumbs instantiate() {
        return new Thumbs("new anychart.core.ui.Scroller.thumbs()");
    }

    public Thumbs(String str) {
        StringBuilder sb = new StringBuilder("thumbs");
    ...
    public Thumbs autoHide(Boolean bool) {
    ...
    public Thumbs enabled(Boolean bool) {
    ...
    public Thumbs fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    public Thumbs fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    public Thumbs fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    public Thumbs fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    public Thumbs fill(String[] strArr, Number number, String str, Number number2) {
    ...
    public Thumbs fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Thumbs fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Thumbs hovered(String str) {
    ...
    public Thumbs normal(String str) {
    ...
    public Thumbs stroke(Stroke stroke, Number number, String str, String str2, String str3) {
    ...
    public Thumbs stroke(Stroke stroke, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public Thumbs stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public Thumbs stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Thumbs stroke(ColoredFill coloredFill, Number number, String str, String str2, String str3) {
    ...
    public Thumbs stroke(ColoredFill coloredFill, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public Thumbs stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public Thumbs stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Thumbs stroke(String str, Number number, String str2, String str3, String str4) {
    ...
    public Thumbs stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    public Thumbs stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, String str3) {
    ...
    public Thumbs stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
