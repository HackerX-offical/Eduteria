...
public class Padding extends Base {
    ...
    public Padding set(String str, String str2, String str3, String str4) {
    ...
    public Padding set(String str, String str2, String str3, Number number) {
    ...
    public Padding set(String str, String str2, Number number, String str3) {
    ...
    public Padding set(String str, String str2, Number number, Number number2) {
    ...
    public Padding set(String str, Number number, String str2, String str3) {
    ...
    public Padding set(String str, Number number, String str2, Number number2) {
    ...
    public Padding set(String str, Number number, Number number2, String str2) {
    ...
    public Padding set(String str, Number number, Number number2, Number number3) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".set(%s, %s, %s, %s);", wrapQuotes(str), number, number2, number3));
        return this;
    }

    public Padding set(Number number, String str, String str2, String str3) {
    ...
    public Padding set(Number number, String str, String str2, Number number2) {
    ...
    public Padding set(Number number, String str, Number number2, String str2) {
    ...
    public Padding set(Number number, String str, Number number2, Number number3) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".set(%s, %s, %s, %s);", number, wrapQuotes(str), number2, number3));
        return this;
    }

    public Padding set(Number number, Number number2, String str, String str2) {
    ...
    public Padding set(Number[] numberArr, String str, String str2, Number number) {
    ...
    public Padding set(Number[] numberArr, String str, Number number, String str2) {
    ...
    public Padding set(Number[] numberArr, String str, Number number, Number number2) {
    ...
    public Padding set(Number[] numberArr, Number number, String str, String str2) {
    ...
    public Padding set(Number[] numberArr, Number number, String str, Number number2) {
    ...
    public Padding set(Number[] numberArr, Number number, Number number2, String str) {
    ...
    public Padding set(Number[] numberArr, Number number, Number number2, Number number3) {
    ...
    public Padding set(String[] strArr, String str, String str2, String str3) {
    ...
    public Padding set(String[] strArr, String str, String str2, Number number) {
    ...
    public Padding set(String[] strArr, String str, Number number, String str2) {
    ...
    public Padding set(String[] strArr, String str, Number number, Number number2) {
    ...
    public Padding set(String[] strArr, Number number, String str, String str2) {
    ...
    public Padding set(String[] strArr, Number number, String str, Number number2) {
    ...
    public Padding set(String[] strArr, Number number, Number number2, String str) {
    ...
    public Padding set(String[] strArr, Number number, Number number2, Number number3) {
