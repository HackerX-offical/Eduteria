...
public class StockInteractivity extends Interactivity {
    ...
    public StockInteractivity(String str) {
        StringBuilder sb = new StringBuilder("stockInteractivity");
    ...
    @Override // com.anychart.core.utils.Interactivity
    public StockInteractivity multiSelectOnClick(Boolean bool) {
    ...
    public StockInteractivity scrollOnMouseWheel(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".scrollOnMouseWheel(%s);", bool));
        return this;
    }
    ...
    @Override // com.anychart.core.utils.Interactivity
    public StockInteractivity unselectOnClickOutOfPoint(Boolean bool) {
    ...
    public StockInteractivity zoomOnMouseWheel(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".zoomOnMouseWheel(%s);", bool));
        return this;
    }

    @Override // com.anychart.core.utils.Interactivity
    public StockInteractivity allowMultiSeriesSelection(Boolean bool) {
    ...
    @Override // com.anychart.core.utils.Interactivity
    public StockInteractivity selectionMode(SelectionMode selectionMode) {
    ...
    @Override // com.anychart.core.utils.Interactivity
    public StockInteractivity selectionMode(String str) {
    ...
    @Override // com.anychart.core.utils.Interactivity
    public StockInteractivity spotRadius(Number number) {
