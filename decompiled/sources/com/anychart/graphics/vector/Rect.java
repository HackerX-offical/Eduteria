...
public class Rect extends Shape {
    ...
    public Rect cut(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".cut(%s);", wrapQuotes(str)));
        return this;
    }

    public Rect cut(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".cut(%s);", number));
        return this;
    }

    public Rect cut(Number number, Number number2, Number number3, Number number4) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".cut(%s, %s, %s, %s);", number, number2, number3, number4));
        return this;
    }
    ...
    public Rect round(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".round(%s);", wrapQuotes(str)));
        return this;
    }

    public Rect round(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".round(%s);", number));
        return this;
    }

    public Rect round(Number number, Number number2, Number number3, Number number4) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".round(%s, %s, %s, %s);", number, number2, number3, number4));
        return this;
    }

    public Rect roundInner(String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".roundInner(%s);", wrapQuotes(str)));
        return this;
    }

    public Rect roundInner(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".roundInner(%s);", number));
        return this;
    }

    public Rect roundInner(Number number, Number number2, Number number3, Number number4) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".roundInner(%s, %s, %s, %s);", number, number2, number3, number4));
        return this;
    }
    ...
    public Rect setBounds(com.anychart.graphics.math.Rect rect) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".setBounds(%s);", rect != null ? rect.getJsBase() : null));
        return this;
    }

    public Rect setHeight(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".setHeight(%s);", number));
        return this;
    }
    ...
    public Rect setWidth(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".setWidth(%s);", number));
        return this;
    }

    public Rect setX(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".setX(%s);", number));
        return this;
    }

    public Rect setY(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".setY(%s);", number));
        return this;
    }
