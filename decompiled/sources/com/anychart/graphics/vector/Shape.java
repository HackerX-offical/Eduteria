...
public class Shape extends Element {
    ...
    public static Shape instantiate() {
        return new Shape("new anychart.graphics.vector.shape()");
    }
    ...
    public Shape appendTransformationMatrix(Number number, Number number2, Number number3, Number number4, Number number5, Number number6) {
    ...
    @Override // com.anychart.graphics.vector.Element
    public Shape cursor(Cursor cursor) {
    ...
    @Override // com.anychart.graphics.vector.Element
    public Shape disablePointerEvents(Boolean bool) {
    ...
    @Override // com.anychart.graphics.vector.Element
    public Shape disableStrokeScaling(Boolean bool) {
    ...
    @Override // com.anychart.graphics.vector.Element
    public Shape drag(Boolean bool) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".drag(%s);", bool));
        return this;
    }

    @Override // com.anychart.graphics.vector.Element
    public Shape drag(com.anychart.graphics.math.Rect rect) {
    ...
    public Shape fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    public Shape fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    public Shape fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    public Shape fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    public Shape fill(String[] strArr, Number number, String str, Number number2) {
    ...
    public Shape fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Shape fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    @Override // com.anychart.graphics.vector.Element
    public Shape rotate(Number number, Number number2, Number number3) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".rotate(%s, %s, %s);", number, number2, number3));
        return this;
    }

    @Override // com.anychart.graphics.vector.Element
    public Shape rotateByAnchor(Number number, Anchor anchor) {
    ...
    @Override // com.anychart.graphics.vector.Element
    public Shape setRotationByAnchor(Number number, String str) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".setRotationByAnchor(%s, %s);", number, wrapQuotes(str)));
        return this;
    }

    @Override // com.anychart.graphics.vector.Element
    public Shape setTransformationMatrix(Number number, Number number2, Number number3, Number number4, Number number5, Number number6) {
    ...
    public Shape stroke(Stroke stroke, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public Shape stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public Shape stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Shape stroke(ColoredFill coloredFill, Number number, String str, String str2, String str3) {
    ...
    public Shape stroke(ColoredFill coloredFill, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public Shape stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, String str2) {
    ...
    public Shape stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Shape stroke(String str, Number number, String str2, String str3, String str4) {
    ...
    public Shape stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    public Shape stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, String str3) {
    ...
    public Shape stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Shape strokeThickness(Number number) {
    ...
    @Override // com.anychart.graphics.vector.Element
    public Shape visible(Boolean bool) {
    ...
    @Override // com.anychart.graphics.vector.Element
    public Shape zIndex(Number number) {
