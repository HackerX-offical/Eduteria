...
public class GeoTicks extends com.anychart.core.Base {
    protected GeoTicks() {
    }
    ...
    public GeoTicks(String str) {
        StringBuilder sb = new StringBuilder("geoTicks");
    ...
    public GeoTicks count(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".count(%s);", number));
        return this;
    }

    public GeoTicks count(Number number, Number number2) {
