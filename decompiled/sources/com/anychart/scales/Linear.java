...
public class Linear extends ScatterBase {
    ...
    @Override // com.anychart.scales.ScatterBase
    public Linear alignMaximum(Boolean bool) {
    ...
    @Override // com.anychart.scales.ScatterBase
    public Linear alignMinimum(Boolean bool) {
    ...
    public Linear compareWith(ScaleCompareWithMode scaleCompareWithMode) {
    ...
    public Linear comparisonMode(ScaleComparisonMode scaleComparisonMode) {
    ...
    @Override // com.anychart.scales.ScatterBase, com.anychart.scales.Base
    public Linear inverted(Boolean bool) {
    ...
    @Override // com.anychart.scales.ScatterBase
    public Linear maximum(Number number) {
    ...
    public Linear maximumGap(Number number) {
    ...
    @Override // com.anychart.scales.ScatterBase
    public Linear minimum(Number number) {
    ...
    public Linear minimumGap(Number number) {
    ...
    public Linear minorTicks(String[] strArr) {
    ...
    public Linear softMaximum(Number number) {
    ...
    public Linear softMinimum(Number number) {
    ...
    public Linear stackDirection(ScaleStackDirection scaleStackDirection) {
    ...
    public Linear stackDirection(String str) {
    ...
    public Linear stackMode(ScaleStackMode scaleStackMode) {
    ...
    public Linear stickToZero(Boolean bool) {
    ...
    public Linear ticks(String[] strArr) {
    ...
    @Override // com.anychart.scales.ScatterBase
    public Linear maxTicksCount(Number number) {
