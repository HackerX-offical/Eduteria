...
public class MarkersFactory extends JsObject {
    ...
    public MarkersFactory add(String str, Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".add(%s, %s);", wrapQuotes(str), number));
        return this;
    }
    ...
    public MarkersFactory clear(Number number) {
    ...
    public com.anychart.math.Rect measure(String str) {
        return new com.anychart.math.Rect(String.format(Locale.US, this.jsBase + ".measure(%s)", wrapQuotes(str)));
    }
