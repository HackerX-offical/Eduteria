...
public class Scroller extends JsObject {
    ...
    public void endRatio() {
        APIlib.getInstance().addJSLine(this.jsBase + ".endRatio();");
    }

    public Scroller endRatio(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".endRatio(%s);", number));
        return this;
    }
    ...
    public Scroller setRange(Number number, Number number2) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".setRange(%s, %s);", number, number2));
        return this;
    }

    public void startRatio() {
        APIlib.getInstance().addJSLine(this.jsBase + ".startRatio();");
    }

    public Scroller startRatio(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".startRatio(%s);", number));
        return this;
    }
