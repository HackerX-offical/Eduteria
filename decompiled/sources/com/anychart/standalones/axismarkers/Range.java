...
public class Range extends JsObject {
    ...
    public static Range instantiate() {
        return new Range("new anychart.standalones.axisMarkers.range()");
    }
    ...
    public Range enabled(Boolean bool) {
    ...
    public Range fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    public Range fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    public Range fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    public Range fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    public Range fill(String[] strArr, Number number, String str, Number number2) {
    ...
    public Range fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Range fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Range from(Number number) {
    ...
    public Range scale(ScaleTypes scaleTypes) {
    ...
    public Range zIndex(Number number) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".zIndex(%s);", number));
        return this;
    }

    public Range fill(String str) {
