...
public class Polar extends JsObject {
    ...
    public com.anychart.core.axes.Polar axis() {
        return new com.anychart.core.axes.Polar(this.jsBase + ".axis()");
    }

    public Polar axis(com.anychart.core.axes.Polar polar) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, this.jsBase + ".axis(%s);", polar != null ? polar.getJsBase() : null));
        return this;
    }

    public Polar axis(Radial radial) {
    ...
    public Polar drawLastLine(Boolean bool) {
    ...
    public Polar fill(GradientKey gradientKey, Number number, Rect rect, Number number2) {
    ...
    public Polar fill(GradientKey gradientKey, Number number, String str, Number number2) {
    ...
    public Polar fill(String[] strArr, Number number, Boolean bool, Number number2) {
    ...
    public Polar fill(String[] strArr, Number number, Rect rect, Number number2) {
    ...
    public Polar fill(String[] strArr, Number number, String str, Number number2) {
    ...
    public Polar fill(GradientKey gradientKey, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Polar fill(String[] strArr, Number number, Number number2, com.anychart.graphics.math.Rect rect, Number number3, Number number4, Number number5) {
    ...
    public Polar isMinor(Boolean bool) {
    ...
    public Polar parentBounds(com.anychart.math.Rect rect) {
    ...
    public Polar stroke(Stroke stroke, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public Polar stroke(Stroke stroke, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Polar stroke(ColoredFill coloredFill, Number number, String str, String str2, StrokeLineCap strokeLineCap) {
    ...
    public Polar stroke(ColoredFill coloredFill, Number number, String str, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Polar stroke(String str, Number number, String str2, String str3, StrokeLineCap strokeLineCap) {
    ...
    public Polar stroke(String str, Number number, String str2, StrokeLineJoin strokeLineJoin, StrokeLineCap strokeLineCap) {
    ...
    public Polar stroke(String str) {
    ...
    public com.anychart.scales.Linear xScale() {
        return new com.anychart.scales.Linear(this.jsBase + ".xScale()");
    }

    public Polar xScale(Base base) {
