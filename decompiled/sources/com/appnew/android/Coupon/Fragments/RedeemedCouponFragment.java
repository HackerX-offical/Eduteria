...
public class RedeemedCouponFragment extends Fragment {
    ...
    public static RedeemedCouponFragment newInstance(String param1, String param2) {
        return new RedeemedCouponFragment();
    }
    ...
    private void setData() {
        ...
        if (couponPojo != null && couponPojo.getRedeemed() != null && this.couponPojo.getRedeemed().size() > 0) {
            this.availables.addAll(this.couponPojo.getRedeemed());
        } else {
            this.no_data_found_RL.setVisibility(0);
            this.upcomingrecycler.setVisibility(8);
        }
        CouponTypeAdapter couponTypeAdapter = new CouponTypeAdapter(getContext(), this.availables, 2);
    ...
    private void intiViews(View view) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: com.appnew.android.Coupon.Fragments.RedeemedCouponFragment.1
            @Override // androidx.swiperefreshlayout.widget.SwipeRefreshLayout.OnRefreshListener
            public void onRefresh() {
                ((CouponActivity) RedeemedCouponFragment.this.getActivity()).fetchData();
                ((CouponActivity) RedeemedCouponFragment.this.getContext()).stackPlace = 1;
            }
        });
