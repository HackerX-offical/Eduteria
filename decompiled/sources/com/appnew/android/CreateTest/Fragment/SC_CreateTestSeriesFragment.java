...
public class SC_CreateTestSeriesFragment extends MainFragment implements View.OnClickListener, Html.ImageGetter, MachingOnDrag {
    ...
    public View.OnClickListener onClickListener = new View.OnClickListener() { // from class: com.appnew.android.CreateTest.Fragment.SC_CreateTestSeriesFragment.1
        ...
        public void onClick(View view) {
            if (!((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).isIssaveMarkForReview()) {
                String str = SC_CreateTestSeriesFragment.this.questionType;
                str.hashCode();
                switch (str) {
                    case "MC":
                        SC_CreateTestSeriesFragment.this.MC_Clicked(view);
                        break;
                    case "MT":
                    case "FIB":
                        break;
                    case "SC":
                        SC_CreateTestSeriesFragment.this.SC_Clicked(view);
                        break;
                    case "TF":
                        SC_CreateTestSeriesFragment.this.SC_Clicked(view);
                        break;
            ...
            Toast.makeText(SC_CreateTestSeriesFragment.this.activity, SC_CreateTestSeriesFragment.this.activity.getResources().getString(R.string.select_remove_and_mark_for_review), 0).show();
        }
    };
    ...
    public void MC_Clicked(View view) {
        this.selectedAnswerposition = ((Integer) view.getTag()).intValue();
        ((TestCreateActivity) this.activity).questionBankList.get(this.position).getAnswer().split(Constants.SEPARATOR_COMMA);
        ...
        for (int i3 = 0; i3 < ((TestCreateActivity) this.activity).questionBankList.get(this.position).getSelectedValue().size(); i3++) {
            str = str + ((TestCreateActivity) this.activity).questionBankList.get(this.position).getSelectedValue().get(i3) + Constants.SEPARATOR_COMMA;
        }
        this.tags.clear();
    ...
    private void addMachingQuestionOption() {
        ...
        for (int i = 1; i <= 10 && !this.status1; i++) {
            switch (i) {
                case 1:
                    if (!TextUtils.isEmpty(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption1())) {
                        if (Arrays.asList(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption1().split("\\s*##\\s*")).size() == 2) {
                            int i2 = i - 1;
                ...
                case 2:
                    if (!TextUtils.isEmpty(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption2())) {
                        if (Arrays.asList(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption2().split("\\s*##\\s*")).size() == 2) {
                            int i3 = i - 1;
                ...
                case 3:
                    if (!TextUtils.isEmpty(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption3())) {
                        if (Arrays.asList(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption3().split("\\s*##\\s*")).size() == 2) {
                            int i4 = i - 1;
                ...
                case 4:
                    if (!TextUtils.isEmpty(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption4())) {
                        if (Arrays.asList(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption4().split("\\s*##\\s*")).size() == 2) {
                            int i5 = i - 1;
                ...
                case 5:
                    if (!TextUtils.isEmpty(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption5())) {
                        if (Arrays.asList(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption5().split("\\s*##\\s*")).size() == 2) {
                            int i6 = i - 1;
                ...
                case 6:
                    if (!TextUtils.isEmpty(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption6())) {
                        if (Arrays.asList(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption6().split("\\s*##\\s*")).size() == 2) {
                            int i7 = i - 1;
                ...
                case 7:
                    if (!TextUtils.isEmpty(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption7())) {
                        if (Arrays.asList(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption7().split("\\s*##\\s*")).size() == 2) {
                            int i8 = i - 1;
                ...
                case 8:
                    if (!TextUtils.isEmpty(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption8())) {
                        if (Arrays.asList(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption8().split("\\s*##\\s*")).size() == 2) {
                            int i9 = i - 1;
                ...
                case 9:
                    if (!TextUtils.isEmpty(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption9())) {
                        if (Arrays.asList(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption9().split("\\s*##\\s*")).size() == 2) {
                            int i10 = i - 1;
                ...
                case 10:
                    if (!TextUtils.isEmpty(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption10())) {
                        if (Arrays.asList(((TestCreateActivity) getActivity()).questionBankList.get(this.position).getOption10().split("\\s*##\\s*")).size() == 2) {
                            int i11 = i - 1;
        ...
        if (!this.status1) {
            ...
            this.adapterMatchingListDrag.setOnItemClickListener(new AdapterMatchingListDrag.OnItemClickListener() { // from class: com.appnew.android.CreateTest.Fragment.SC_CreateTestSeriesFragment.2
                ...
                public void onItemClick(View view, Social obj, int p, int bg, int circle, boolean select) {
                    if (select) {
                        SC_CreateTestSeriesFragment.this.selected.add(new mcSelection(p, bg, circle, select));
                        ...
                        int i13 = 0;
                        while (true) {
                            if (i13 >= ((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted().size()) {
                                break;
                            }
                            if (((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted().get(i13).getPosition() == p) {
                    ...
                    boolean z = false;
                    for (int i14 = 0; i14 < ((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted().size(); i14++) {
                        if (((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted().get(i14).isSelect()) {
                            z = true;
                        }
                    }
                    if (z) {
                        SC_CreateTestSeriesFragment.this.tags.clear();
                        for (int i15 = 0; i15 < ((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).items1.size(); i15++) {
                            int i16 = 0;
                            while (true) {
                                ...
                                if (!((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted().get(i16).isSelect()) {
                                    SC_CreateTestSeriesFragment.this.tags.add(i15, 0);
                                    break;
                                }
                                int i17 = 0;
                                while (true) {
                                    if (i17 < TestCreateActivity.SAMPLE_CIRCLE.length) {
                                        int circlecolor_code = ((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted().get(i16).getCirclecolor_code();
                                        if (circlecolor_code == TestCreateActivity.SAMPLE_CIRCLE[i17]) {
                                            SC_CreateTestSeriesFragment.this.tags.add(Integer.valueOf(((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted().get(i16).getPosition() + 1));
                                            break;
                                        }
                                        i17++;
                                    }
            ...
            this.adapterMatchingListDrag.setMachingOnDrag(new AdapterMatchingListDrag.MachingOnDrag() { // from class: com.appnew.android.CreateTest.Fragment.SC_CreateTestSeriesFragment.3
                ...
                public void sendOnclickInd(int p) {
                    if (SC_CreateTestSeriesFragment.this.adapterMatchingListNormal != null) {
                        int i13 = 0;
                        while (true) {
                            if (i13 >= ((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted2().size()) {
                                break;
                            }
                            if (((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted2().get(i13).getPosition() == p) {
                                ((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted2().remove(i13);
                                break;
                            }
                            i13++;
                        }
            ...
            this.adapterMatchingListNormal.setMachingOnDrag(new AdapterMatchingListNormal.MachingOnDrag() { // from class: com.appnew.android.CreateTest.Fragment.SC_CreateTestSeriesFragment.4
                ...
                public void sendOnclickInd(int p) {
                    ((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted().remove(p);
            ...
            this.adapterMatchingListNormal.setOnItemClickListener(new AdapterMatchingListNormal.OnItemClickListener() { // from class: com.appnew.android.CreateTest.Fragment.SC_CreateTestSeriesFragment.5
                ...
                public void onItemClick(View view, int p, Social obj, int bg, int circle, boolean select) {
                    if (select) {
                        SC_CreateTestSeriesFragment.this.selected2.add(new mcSelection(p, bg, circle, select));
                    ...
                    for (int i13 = 0; i13 < ((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted2().size(); i13++) {
                        if (((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted2().get(i13).getPosition() == p) {
                            ((TestCreateActivity) SC_CreateTestSeriesFragment.this.getActivity()).questionBankList.get(SC_CreateTestSeriesFragment.this.position).getSelcted2().remove(i13);
                            return;
                        }
    ...
    public LinearLayout initMCQOptionView(String str, String str2, String str3, boolean z, int i) {
        ...
        if (iHashCode != 2454) {
            if (iHashCode != 2640) {
                ...
                } else if (str4.equals("TF") && ((TestCreateActivity) getActivity()).questionBankList.get(this.position).isanswer() && ((TestCreateActivity) getActivity()).questionBankList.get(this.position).getAnswerPosttion() != 0 && ((TestCreateActivity) getActivity()).questionBankList.get(this.position).getAnswerPosttion() - 1 == i) {
                    linearLayout.setSelected(true);
                }
            } else if (str4.equals("SC") && ((TestCreateActivity) getActivity()).questionBankList.get(this.position).isanswer() && ((TestCreateActivity) getActivity()).questionBankList.get(this.position).getAnswerPosttion() != 0 && ((TestCreateActivity) getActivity()).questionBankList.get(this.position).getAnswerPosttion() - 1 == i) {
                linearLayout.setSelected(true);
            }
        } else if (str4.equals("MC") && ((TestCreateActivity) this.activity).questionBankList.get(this.position).getSelectedValue() != null && ((TestCreateActivity) this.activity).questionBankList.get(this.position).getSelectedValue().contains(Integer.valueOf(i))) {
            linearLayout.setSelected(true);
    ...
    public void refereshPage() {
        ...
        ((TestCreateActivity) getActivity()).questionBankList.get(this.position).setUser_answer("");
        ((TestCreateActivity) Objects.requireNonNull(getActivity())).questionBankList.get(this.position).setIsanswer(false, 0);
        if (((TestCreateActivity) getActivity()).changelang.getText().equals("H/E")) {
            ((TestCreateActivity) getActivity()).data.getQuestionsHindi().get(this.position).setIsanswer(false, 0);
        } else if (((TestCreateActivity) getActivity()).changelang.getText().equals("E/H")) {
            ((TestCreateActivity) getActivity()).data.getQuestions().get(this.position).setIsanswer(false, 0);
        ...
        if (((TestCreateActivity) Objects.requireNonNull(getActivity())).data.getQuestionsHindi() != null && ((TestCreateActivity) Objects.requireNonNull(getActivity())).data.getQuestionsHindi().size() > 0) {
            ((TestCreateActivity) Objects.requireNonNull(getActivity())).data.getQuestionsHindi().get(this.position).setAnspositions("-1");
            ((TestCreateActivity) Objects.requireNonNull(getActivity())).data.getQuestionsHindi().get(this.position).setSelectedValue(new ArrayList<>());
            ((TestCreateActivity) Objects.requireNonNull(getActivity())).data.getQuestionsHindi().get(this.position).setAnswers(new ArrayList<>());
            ((TestCreateActivity) getActivity()).data.getQuestionsHindi().get(this.position).setUser_answer("");
        }
        if (((TestCreateActivity) Objects.requireNonNull(getActivity())).data.getQuestions() != null && ((TestCreateActivity) Objects.requireNonNull(getActivity())).data.getQuestions().size() > 0) {
            ((TestCreateActivity) Objects.requireNonNull(getActivity())).data.getQuestions().get(this.position).setAnspositions("-1");
            ((TestCreateActivity) Objects.requireNonNull(getActivity())).data.getQuestions().get(this.position).setSelectedValue(new ArrayList<>());
            ((TestCreateActivity) Objects.requireNonNull(getActivity())).data.getQuestions().get(this.position).setAnswers(new ArrayList<>());
            ((TestCreateActivity) getActivity()).data.getQuestions().get(this.position).setUser_answer("");
        }
        ((TestCreateActivity) Objects.requireNonNull(getActivity())).questionBankList.get(this.position).setAnspositions("-1");
        ((TestCreateActivity) Objects.requireNonNull(getActivity())).questionBankList.get(this.position).setSelectedValue(new ArrayList<>());
        ((TestCreateActivity) Objects.requireNonNull(getActivity())).questionBankList.get(this.position).setAnswers(new ArrayList<>());
        this.guess = "0";
        for (int i3 = 0; i3 < this.LinearLayoutList.size(); i3++) {
    ...
    public void sendOnclickInd(int p) {
        if (this.adapterMatchingListNormal != null) {
            int i = 0;
            while (true) {
                if (i >= ((TestCreateActivity) getActivity()).questionBankList.get(this.position).getSelcted2().size()) {
                    break;
                }
                if (((TestCreateActivity) getActivity()).questionBankList.get(this.position).getSelcted2().get(i).getPosition() == p) {
                    ((TestCreateActivity) getActivity()).questionBankList.get(this.position).getSelcted2().remove(i);
                    break;
                }
                i++;
            }
