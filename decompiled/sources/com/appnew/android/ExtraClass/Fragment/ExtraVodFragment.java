...
import com.appnew.android.databinding.FragmentExtraVodBinding;
...
public final class ExtraVodFragment extends Fragment {
    ...
    public final FragmentExtraVodBinding getBinding() {
        FragmentExtraVodBinding fragmentExtraVodBinding = this.binding;
        if (fragmentExtraVodBinding != null) {
            return fragmentExtraVodBinding;
        }
        Intrinsics.throwUninitializedPropertyAccessException("binding");
        return null;
    }

    public final void setBinding(FragmentExtraVodBinding fragmentExtraVodBinding) {
        Intrinsics.checkNotNullParameter(fragmentExtraVodBinding, "<set-?>");
        this.binding = fragmentExtraVodBinding;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        setBinding(FragmentExtraVodBinding.inflate(getLayoutInflater(), container, false));
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        getBinding().extraFragRV.setAdapter(new ExtraClassRVAdapter(getContext(), getVideoTypeArrayList(), false));
    }

    /* JADX INFO: compiled from: ExtraVodFragment.kt */
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u001e\u0010\u0004\u001a\u00020\u00052\u0016\u0010\u0006\u001a\u0012\u0012\u0004\u0012\u00020\b0\u0007j\b\u0012\u0004\u0012\u00020\b`\t¨\u0006\n"}, d2 = {"Lcom/appnew/android/ExtraClass/Fragment/ExtraVodFragment$Companion;", "", "<init>", "()V", "newInstance", "Lcom/appnew/android/ExtraClass/Fragment/ExtraVodFragment;", "videoTypeArrayList", "Ljava/util/ArrayList;", "Lcom/appnew/android/home/model/ExtraVideoType;", "Lkotlin/collections/ArrayList;", "app_EDUTERIARelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
        ...
        public final ExtraVodFragment newInstance(ArrayList<ExtraVideoType> videoTypeArrayList) {
            Intrinsics.checkNotNullParameter(videoTypeArrayList, "videoTypeArrayList");
            new ExtraVodFragment();
            Bundle bundle = new Bundle();
            bundle.putSerializable("video", videoTypeArrayList);
            ExtraVodFragment extraVodFragment = new ExtraVodFragment();
            extraVodFragment.setArguments(bundle);
            return extraVodFragment;
        }
    }
}
