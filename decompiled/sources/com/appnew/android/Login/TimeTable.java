...
public final /* data */ class TimeTable {
    ...
    public static /* synthetic */ TimeTable copy$default(TimeTable timeTable, long j, List list, int i, int i2, String str, boolean z, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            j = timeTable.cdTime;
        }
        long j2 = j;
        ...
        int i6 = i2;
        if ((i4 & 16) != 0) {
            str = timeTable.message;
        }
        return timeTable.copy(j2, list2, i5, i6, str, (i4 & 32) != 0 ? timeTable.status : z, (i4 & 64) != 0 ? timeTable.time : i3);
    }
    ...
    public final TimeTable copy(long cdTime, List<Data> data, int interval, int limit, String message, boolean status, int time) {
        Intrinsics.checkNotNullParameter(data, "data");
        Intrinsics.checkNotNullParameter(message, "message");
        return new TimeTable(cdTime, data, interval, limit, message, status, time);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.cdTime == timeTable.cdTime && Intrinsics.areEqual(this.data, timeTable.data) && this.interval == timeTable.interval && this.limit == timeTable.limit && Intrinsics.areEqual(this.message, timeTable.message) && this.status == timeTable.status && this.time == timeTable.time;
    }
    ...
    public String toString() {
        return "TimeTable(cdTime=" + this.cdTime + ", data=" + this.data + ", interval=" + this.interval + ", limit=" + this.limit + ", message=" + this.message + ", status=" + this.status + ", time=" + this.time + ")";
    }

    public TimeTable(long j, List<Data> data, int i, int i2, String message, boolean z, int i3) {
        Intrinsics.checkNotNullParameter(data, "data");
        Intrinsics.checkNotNullParameter(message, "message");
        this.cdTime = j;
        this.data = data;
