...
public class Courselist implements Serializable {
    ...
    @SerializedName("delivery_charge_out_of_india")
    @Expose
    private String delivery_charge_out_of_india;
    ...
    public Courselist() {
        this.cat_type = "";
        this.hide_validity = "";
        this.check_for_expiry = "";
        this.home_screen = "0";
        this.isExpand = false;
        this.isSelect = false;
    }

    public Courselist(String course_id, String title, String cover_image, String mrp, String course_sp, String validity, String subject_id, String lang_id, String desc_header_image, ExtraJson extra_json, String viewType, String themeName) {
        this.cat_type = "";
        this.hide_validity = "";
        this.check_for_expiry = "";
        this.home_screen = "0";
        ...
        this.mrp = mrp;
        this.courseSp = course_sp;
        this.validity = validity;
        this.subject_id = subject_id;
        this.lang_id = lang_id;
        this.descHeaderImage = desc_header_image;
        this.extra_json = extra_json;
        this.viewType = viewType;
    }

    public Courselist(String course_id, String title, String cover_image, String mrp, String course_sp, String validity, String subject_id, String lang_id, String desc_header_image, ExtraJson extra_json, String combo_course_ids, String theme, String content_type, String isHome, String cat_type, String hide_validity, String payment_mode, String is_purchased) {
        this.check_for_expiry = "";
        this.home_screen = "0";
        this.isExpand = false;
        this.isSelect = false;
    ...
    public String getDelivery_charge_out_of_india() {
        return this.delivery_charge_out_of_india;
    }

    public void setDelivery_charge_out_of_india(String delivery_charge_out_of_india) {
        this.delivery_charge_out_of_india = delivery_charge_out_of_india;
    }
    ...
    public Courselist(String id, String title, String cover_image, String mrp, String courseSp, String validity, String subjectid, String lang, String descHeaderImage, ExtraJson extra_json, String avg_rating, String user_rated, String is_purchased, String combo_course_ids, String bb, String cat_type, String hide_validity, String description, String discount, String delivery_charge, String book_redirection_link, String payment_mode) {
        this.check_for_expiry = "";
        this.home_screen = "0";
        this.isExpand = false;
        this.isSelect = false;
    ...
    public Courselist(String id, String title, String cover_image, String mrp, String courseSp, String validity, String subjectid, String lang, ExtraJson extra_json) {
        this.cat_type = "";
        this.hide_validity = "";
        this.check_for_expiry = "";
        this.home_screen = "0";
