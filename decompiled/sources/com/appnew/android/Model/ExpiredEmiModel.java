...
public class ExpiredEmiModel implements Serializable {
    private int auto_id;
    ...
    public ExpiredEmiModel(String id, String viewType, String holderType, String maintenanceText, String title, String courseAttribute, String cover_image, String descHeaderImage, String mrp, String courseSp, String colorCode, String validity, String learner, String isLive, String url) {
        this.id = id;
    ...
    public ExpiredEmiModel(String id, String title, String cover_image, String mrp, String courseSp, String validity, String subjectid, String lang, String descHeaderImage) {
        this.id = id;
        this.title = title;
        this.cover_image = cover_image;
        this.mrp = mrp;
    ...
    public ExpiredEmiModel(String id, String title, String cover_image, String mrp, String courseSp, String validity, String subjectid, String lang, String descHeaderImage, ExtraJson extra_json) {
        this.id = id;
        this.title = title;
        this.cover_image = cover_image;
        this.mrp = mrp;
    ...
    public ExpiredEmiModel(String id, String title, String cover_image, String mrp, String courseSp, String validity, String subjectid, String lang, ExtraJson extra_json) {
        this.id = id;
        this.title = title;
        this.cover_image = cover_image;
        this.mrp = mrp;
