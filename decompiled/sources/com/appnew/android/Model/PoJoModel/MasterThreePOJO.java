...
public class MasterThreePOJO implements Serializable {
    private String id;
    ...
    public MasterThreePOJO(String id, String layer, String main_id, String sub_id, String test_type, String type, String tile_id, String revert_api, String test_filter, int page) {
        this.id = id;
        this.layer = layer;
