...
public class RegOnePOJO implements Serializable {
    ...
    public RegOnePOJO(String name, String email, String password, String mobile, String c_code, String is_social, String social_type, String social_tokken, String device_type, String device_id, String device_tokken, String profile_picture) {
        this.name = name;
        this.email = email;
