...
public final /* data */ class StudentModel {
    ...
    public static /* synthetic */ StudentModel copy$default(StudentModel studentModel, long j, ArrayList arrayList, int i, int i2, String str, boolean z, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            j = studentModel.cdTime;
        }
        long j2 = j;
        if ((i4 & 2) != 0) {
        ...
        if ((i4 & 4) != 0) {
            i = studentModel.interval;
        }
        int i5 = i;
        if ((i4 & 8) != 0) {
            i2 = studentModel.limit;
        }
        int i6 = i2;
        if ((i4 & 16) != 0) {
            str = studentModel.message;
        }
        return studentModel.copy(j2, arrayList2, i5, i6, str, (i4 & 32) != 0 ? studentModel.status : z, (i4 & 64) != 0 ? studentModel.time : i3);
    }
    ...
    public final StudentModel copy(long cdTime, ArrayList<Data> data, int interval, int limit, String message, boolean status, int time) {
        Intrinsics.checkNotNullParameter(data, "data");
        Intrinsics.checkNotNullParameter(message, "message");
        return new StudentModel(cdTime, data, interval, limit, message, status, time);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.cdTime == studentModel.cdTime && Intrinsics.areEqual(this.data, studentModel.data) && this.interval == studentModel.interval && this.limit == studentModel.limit && Intrinsics.areEqual(this.message, studentModel.message) && this.status == studentModel.status && this.time == studentModel.time;
    }
    ...
    public String toString() {
        return "StudentModel(cdTime=" + this.cdTime + ", data=" + this.data + ", interval=" + this.interval + ", limit=" + this.limit + ", message=" + this.message + ", status=" + this.status + ", time=" + this.time + ")";
    }

    public StudentModel(long j, ArrayList<Data> data, int i, int i2, String message, boolean z, int i3) {
        Intrinsics.checkNotNullParameter(data, "data");
        Intrinsics.checkNotNullParameter(message, "message");
        this.cdTime = j;
        this.data = data;
