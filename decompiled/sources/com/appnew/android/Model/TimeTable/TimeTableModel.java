...
public final /* data */ class TimeTableModel {
    ...
    public static /* synthetic */ TimeTableModel copy$default(TimeTableModel timeTableModel, long j, ArrayList arrayList, int i, int i2, String str, boolean z, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            j = timeTableModel.cdTime;
        }
        long j2 = j;
        if ((i4 & 2) != 0) {
            arrayList = timeTableModel.data;
        }
        ArrayList arrayList2 = arrayList;
        if ((i4 & 4) != 0) {
            i = timeTableModel.interval;
        }
        int i5 = i;
        if ((i4 & 8) != 0) {
            i2 = timeTableModel.limit;
        }
        int i6 = i2;
        if ((i4 & 16) != 0) {
            str = timeTableModel.message;
        }
        return timeTableModel.copy(j2, arrayList2, i5, i6, str, (i4 & 32) != 0 ? timeTableModel.status : z, (i4 & 64) != 0 ? timeTableModel.time : i3);
    }
    ...
    public final TimeTableModel copy(long cdTime, ArrayList<Data> data, int interval, int limit, String message, boolean status, int time) {
        Intrinsics.checkNotNullParameter(data, "data");
        Intrinsics.checkNotNullParameter(message, "message");
        return new TimeTableModel(cdTime, data, interval, limit, message, status, time);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.cdTime == timeTableModel.cdTime && Intrinsics.areEqual(this.data, timeTableModel.data) && this.interval == timeTableModel.interval && this.limit == timeTableModel.limit && Intrinsics.areEqual(this.message, timeTableModel.message) && this.status == timeTableModel.status && this.time == timeTableModel.time;
    }
    ...
    public String toString() {
        return "TimeTableModel(cdTime=" + this.cdTime + ", data=" + this.data + ", interval=" + this.interval + ", limit=" + this.limit + ", message=" + this.message + ", status=" + this.status + ", time=" + this.time + ")";
    }

    public TimeTableModel(long j, ArrayList<Data> data, int i, int i2, String message, boolean z, int i3) {
        Intrinsics.checkNotNullParameter(data, "data");
        Intrinsics.checkNotNullParameter(message, "message");
        this.cdTime = j;
        this.data = data;
