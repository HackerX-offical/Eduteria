...
public final class DashboardSquareGifTabAdapter extends RecyclerView.Adapter<DashboradSquareViewHolder> {
    ...
    /* JADX INFO: compiled from: DashboardSquareGifTabAdapter.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0006"}, d2 = {"Lcom/appnew/android/Theme/Adapter/DashboardSquareGifTabAdapter$addDashboardItemClicked;", "", "onDashboardItemClicked", "", Const.POSITION, "", "app_EDUTERIARelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public DashboardSquareGifTabAdapter(Context context, List<? extends CourseTypeMasterTable> courseTypeMasterTables, DashboardTabAdapter.addDashboardItemClicked dashboardClicked) {
    ...
    public DashboradSquareViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View viewInflate = LayoutInflater.from(this.context).inflate(R.layout.single_item_square_tile_home_tabs_gif, parent, false);
    ...
    public void onBindViewHolder(DashboradSquareViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.Theme.Adapter.DashboardSquareGifTabAdapter$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                DashboardSquareGifTabAdapter.onBindViewHolder$lambda$1$lambda$0(this.f$0, position, view);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void onBindViewHolder$lambda$1$lambda$0(DashboardSquareGifTabAdapter dashboardSquareGifTabAdapter, int i, View view) {
        DashboardTabAdapter.addDashboardItemClicked adddashboarditemclicked = dashboardSquareGifTabAdapter.dashboardClicked;
        String id = dashboardSquareGifTabAdapter.courseTypeMasterTables.get(i).getId();
