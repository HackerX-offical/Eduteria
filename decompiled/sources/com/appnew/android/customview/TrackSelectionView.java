...
public class TrackSelectionView extends LinearLayout {
    ...
    public TrackSelectionView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.defaultSelectionPosition = -1;
        this.resolution = "";
        setOrientation(1);
        ...
        checkedTextView2.setText(com.eduteria.app.app.R.string.auto);
    ...
    public void init(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int rendererIndex, boolean isDisabled, List<DefaultTrackSelector.SelectionOverride> overrides, TrackSelectionListener listener, int defaultSelectionPosition, String resolution) {
    ...
    private void updateViewStates() {
        ...
        this.defaultView.setChecked(!this.isDisabled && this.overrides.size() == 0 && this.defaultSelectionPosition == -1);
        if (this.trackViews != null) {
            for (int i = 0; i < this.trackViews.length; i++) {
                ...
                int i2 = 0;
                while (true) {
                    checkedTextViewArr2 = this.trackViews;
                    CheckedTextView[] checkedTextViewArr3 = checkedTextViewArr2[i];
                    if (i2 >= checkedTextViewArr3.length) {
                        break;
                    }
                    checkedTextViewArr3[i2].setChecked(selectionOverride != null && selectionOverride.containsTrack(i2));
                    i2++;
                }
                int i3 = this.defaultSelectionPosition;
                if (i3 != -1 && checkedTextViewArr2.length > 0 && checkedTextViewArr2[0].length > i3 && i == 0 && selectionOverride != null && selectionOverride.length > 0 && !selectionOverride.containsTrack(this.defaultSelectionPosition) && (checkedTextView = this.trackViews[0][this.defaultSelectionPosition]) != null) {
                    checkedTextView.setChecked(false);
                }
            }
        }
        if (this.defaultSelectionPosition == -1 || this.trackGroups.length <= 0) {
            return;
        }
        int i4 = this.trackGroups.get(0).length;
        int i5 = this.defaultSelectionPosition;
        if (i4 <= i5 || (checkedTextViewArr = this.trackViews) == null || checkedTextViewArr.length <= 0 || checkedTextViewArr[0].length <= i5 || this.overrides.size() != 0) {
            return;
        }
        List listAsList = Arrays.asList("144", "240", "360", "480", "720", "1080", "1440", "2160");
        int i6 = 0;
        while (true) {
            CheckedTextView[] checkedTextViewArr4 = this.trackViews[0];
            if (i6 >= checkedTextViewArr4.length) {
                return;
            }
            String strReplaceAll = checkedTextViewArr4[i6].getText().toString().replaceAll("[^0-9]", "");
            if (listAsList.contains(strReplaceAll) && strReplaceAll.equals(this.resolution)) {
                Log.d("TrackSelectionView", "Selecting default: groupIndex=0, trackIndex=" + i6);
                this.trackViews[0][i6].setChecked(true);
                return;
            }
            i6++;
        }
    ...
    public void onClick(View view) {
        if (view == this.disableView) {
            ...
            if (view.getTag() == null) {
                Log.e("TrackSelectionView", "View tag is null inside onClick!");
                return;
            }
    ...
    private void onDefaultViewClicked() {
        ...
        if (getContext() instanceof VODPlayerActivity) {
            ((VODPlayerActivity) getContext()).resolutionPossition = -1;
        }
    }
    ...
    private void onTrackViewClicked(View view) {
        ...
        if (view == null || view.getTag() == null) {
            Log.e("TrackSelectionView", "View or tag is null inside onClick!");
            return;
        }
        try {
            ...
            if (selectionOverride == null) {
                Log.d("TrackSelectionView", "override is null");
            } else {
                Log.d("TrackSelectionView", "override length: " + selectionOverride.length);
                if (selectionOverride.tracks == null) {
                    Log.d("TrackSelectionView", "override.tracks is null");
                }
            }
            ...
            int i2 = this.defaultSelectionPosition;
            if (i2 != -1 && (checkedTextViewArr = this.trackViews) != null && checkedTextViewArr.length > 0 && iIntValue == 0 && (checkedTextViewArr2 = checkedTextViewArr[0]) != null && checkedTextViewArr2.length > i2 && iIntValue2 != i2) {
                checkedTextViewArr2[i2].setChecked(false);
            }
            updateViewStates();
        } catch (ArrayIndexOutOfBoundsException e2) {
            Log.e("TrackSelectionView", "ArrayIndexOutOfBoundsException: " + e2.getMessage());
        } catch (ClassCastException e3) {
            Log.e("TrackSelectionView", "ClassCastException: " + e3.getMessage());
        }
    }
