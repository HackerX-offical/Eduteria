...
public final class ActivityCouponBinding implements ViewBinding {
    ...
    private ActivityCouponBinding(RelativeLayout rootView, ImageView imageBack, Toolbar mainToolbar, RelativeLayout root, RelativeLayout tabRelativeLayout, TabLayout tabs, TextView toolbarTitleTV, ViewPager viewPager) {
    ...
    public static ActivityCouponBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityCouponBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_coupon, parent, false);
        if (attachToParent) {
    ...
    public static ActivityCouponBinding bind(View rootView) {
                ...
                if (relativeLayout2 != null) {
                    ...
                    if (tabLayout != null) {
                        ...
                        if (textView != null) {
                            ...
                            if (viewPager != null) {
                                return new ActivityCouponBinding(relativeLayout, imageView, toolbar, relativeLayout, relativeLayout2, tabLayout, textView, viewPager);
                            }
                        }
                    }
                }
