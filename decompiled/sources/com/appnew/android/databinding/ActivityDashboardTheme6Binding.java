...
public final class ActivityDashboardTheme6Binding implements ViewBinding {
    public final ImageView arrowImg;
    public final CardView changeInterfaceCV;
    public final AppBarDashboard6Binding dashBoardMain6;
    ...
    public static ActivityDashboardTheme6Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityDashboardTheme6Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_dashboard_theme6, parent, false);
        if (attachToParent) {
    ...
    public static ActivityDashboardTheme6Binding bind(View rootView) {
        ...
        if (imageView != null) {
            ...
            if (cardView != null) {
                i = R.id.dashBoardMain6;
                View viewFindChildViewById = ViewBindings.findChildViewById(rootView, R.id.dashBoardMain6);
                if (viewFindChildViewById != null) {
                    AppBarDashboard6Binding appBarDashboard6BindingBind = AppBarDashboard6Binding.bind(viewFindChildViewById);
                                                                        ...
                                                                        if (imageView8 != null) {
                                                                            ...
                                                                            if (textView2 != null) {
                                                                                ...
                                                                                if (linearLayout3 != null) {
                                                                                    ...
                                                                                    if (textView3 != null) {
                                                                                        return new ActivityDashboardTheme6Binding(drawerLayout, imageView, cardView, appBarDashboard6BindingBind, drawerLayout, frameLayout, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7, linearLayout, linearLayout2, recyclerView, navigationView, textView, circleImageView, imageView8, textView2, linearLayout3, textView3);
                                                                                    }
                                                                                }
                                                                            }
                                                                        }
