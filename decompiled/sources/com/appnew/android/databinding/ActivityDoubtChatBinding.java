...
public final class ActivityDoubtChatBinding implements ViewBinding {
    ...
    public static ActivityDoubtChatBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityDoubtChatBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_doubt_chat, parent, false);
        if (attachToParent) {
    ...
    public static ActivityDoubtChatBinding bind(View rootView) {
                                                                            ...
                                                                            if (toolbar != null) {
                                                                                ...
                                                                                if (button3 != null) {
                                                                                    ...
                                                                                    if (button4 != null) {
                                                                                        ...
                                                                                        if (textView4 != null) {
                                                                                            return new ActivityDoubtChatBinding((RelativeLayout) rootView, textView, linearLayout, imageView, linearLayoutCompat, imageView2, textView2, recyclerView, button, textView3, button2, editText, imageView3, imageView4, linearLayout2, cardView, linearLayout3, linearLayout4, toolbar, button3, button4, textView4);
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
