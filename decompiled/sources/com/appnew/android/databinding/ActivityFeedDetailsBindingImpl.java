...
public class ActivityFeedDetailsBindingImpl extends ActivityFeedDetailsBinding {
    ...
    public ActivityFeedDetailsBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 58, sIncludes, sViewsWithIds));
    }

    private ActivityFeedDetailsBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
