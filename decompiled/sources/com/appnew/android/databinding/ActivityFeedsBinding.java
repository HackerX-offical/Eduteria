...
public abstract class ActivityFeedsBinding extends ViewDataBinding {
    ...
    public static ActivityFeedsBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActivityFeedsBinding inflate(LayoutInflater inflater, ViewGroup root, boolean attachToRoot, Object component) {
        return (ActivityFeedsBinding) ViewDataBinding.inflateInternal(inflater, R.layout.activity_feeds, root, attachToRoot, component);
    }

    public static ActivityFeedsBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static ActivityFeedsBinding inflate(LayoutInflater inflater, Object component) {
        return (ActivityFeedsBinding) ViewDataBinding.inflateInternal(inflater, R.layout.activity_feeds, null, false, component);
    }
    ...
    @Deprecated
    public static ActivityFeedsBinding bind(View view, Object component) {
