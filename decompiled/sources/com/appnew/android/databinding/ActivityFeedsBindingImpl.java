...
public class ActivityFeedsBindingImpl extends ActivityFeedsBinding {
    ...
    public ActivityFeedsBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }

    private ActivityFeedsBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
