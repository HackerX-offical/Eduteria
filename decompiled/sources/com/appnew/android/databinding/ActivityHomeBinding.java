...
public final class ActivityHomeBinding implements ViewBinding {
    public final AppBarHomeBinding appBarHomeLayout;
    ...
    private ActivityHomeBinding(DrawerLayout rootView, AppBarHomeBinding appBarHomeLayout, DrawerLayout drawerLayout, FrameLayout forchatbot, LinearLayout navHeaderLL, LinearLayout navHeaderRL, RecyclerView navRV, NavigationView navView, TextView profileEmail, CircleImageView profileImage, ImageView profileImageText, TextView profileName, TextView vNameTV) {
        this.rootView = rootView;
        this.appBarHomeLayout = appBarHomeLayout;
    ...
    public static ActivityHomeBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_home, parent, false);
        if (attachToParent) {
    ...
    public static ActivityHomeBinding bind(View rootView) {
        int i = R.id.appBarHomeLayout;
        View viewFindChildViewById = ViewBindings.findChildViewById(rootView, R.id.appBarHomeLayout);
        if (viewFindChildViewById != null) {
            AppBarHomeBinding appBarHomeBindingBind = AppBarHomeBinding.bind(viewFindChildViewById);
                                    ...
                                    if (circleImageView != null) {
                                        ...
                                        if (imageView != null) {
                                            ...
                                            if (textView2 != null) {
                                                ...
                                                if (textView3 != null) {
                                                    return new ActivityHomeBinding(drawerLayout, appBarHomeBindingBind, drawerLayout, frameLayout, linearLayout, linearLayout2, recyclerView, navigationView, textView, circleImageView, imageView, textView2, textView3);
                                                }
                                            }
                                        }
                                    }
