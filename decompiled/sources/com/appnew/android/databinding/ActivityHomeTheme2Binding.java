...
public final class ActivityHomeTheme2Binding implements ViewBinding {
    public final AppBarHomeTheme2Binding dashBoardMain;
    ...
    public final ImageView profileEditIv;
    ...
    private ActivityHomeTheme2Binding(DrawerLayout rootView, AppBarHomeTheme2Binding dashBoardMain, DrawerLayout drawerLayout, FrameLayout forchatbot, ImageView iconFacebook, ImageView iconInstagram, ImageView iconLinkedIn, ImageView iconTelegram, ImageView iconTwitter, ImageView iconWebsite, ImageView iconWhatsapp, ImageView iconYoutube, LinearLayout navHeaderLL, LinearLayout navHeaderRL, RecyclerView navRV, NavigationView navView, ImageView profileEditIv, TextView profileEmail, CircleImageView profileImage, ImageView profileImageText, TextView profileName, LinearLayout socialIconLL, TextView vNameTV) {
        ...
        this.profileEditIv = profileEditIv;
    ...
    public static ActivityHomeTheme2Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityHomeTheme2Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_home_theme2, parent, false);
        if (attachToParent) {
    ...
    public static ActivityHomeTheme2Binding bind(View rootView) {
        int i = R.id.dashBoardMain;
        View viewFindChildViewById = ViewBindings.findChildViewById(rootView, R.id.dashBoardMain);
        if (viewFindChildViewById != null) {
            AppBarHomeTheme2Binding appBarHomeTheme2BindingBind = AppBarHomeTheme2Binding.bind(viewFindChildViewById);
                                                    ...
                                                    if (linearLayout2 != null) {
                                                        ...
                                                        if (recyclerView != null) {
                                                            ...
                                                            if (navigationView != null) {
                                                                i = R.id.profile_edit_iv;
                                                                ImageView imageView9 = (ImageView) ViewBindings.findChildViewById(rootView, R.id.profile_edit_iv);
                                                                if (imageView9 != null) {
                                                                    i = R.id.profileEmail;
                                                                    ...
                                                                    if (textView != null) {
                                                                        ...
                                                                        if (circleImageView != null) {
                                                                            ...
                                                                            ImageView imageView10 = (ImageView) ViewBindings.findChildViewById(rootView, R.id.profileImageText);
                                                                            if (imageView10 != null) {
                                                                                i = R.id.profileName;
                                                                                ...
                                                                                if (textView2 != null) {
                                                                                    ...
                                                                                    if (linearLayout3 != null) {
                                                                                        ...
                                                                                        if (textView3 != null) {
                                                                                            return new ActivityHomeTheme2Binding(drawerLayout, appBarHomeTheme2BindingBind, drawerLayout, frameLayout, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7, imageView8, linearLayout, linearLayout2, recyclerView, navigationView, imageView9, textView, circleImageView, imageView10, textView2, linearLayout3, textView3);
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
