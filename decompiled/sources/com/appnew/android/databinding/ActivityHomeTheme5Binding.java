...
public final class ActivityHomeTheme5Binding implements ViewBinding {
    public final AppBarDashboard5Binding dashBoardMain;
    ...
    public static ActivityHomeTheme5Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityHomeTheme5Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_home_theme5, parent, false);
        if (attachToParent) {
    ...
    public static ActivityHomeTheme5Binding bind(View rootView) {
        int i = R.id.dashBoardMain;
        View viewFindChildViewById = ViewBindings.findChildViewById(rootView, R.id.dashBoardMain);
        if (viewFindChildViewById != null) {
            AppBarDashboard5Binding appBarDashboard5BindingBind = AppBarDashboard5Binding.bind(viewFindChildViewById);
                                                                ...
                                                                if (imageView7 != null) {
                                                                    ...
                                                                    if (textView2 != null) {
                                                                        ...
                                                                        if (linearLayout3 != null) {
                                                                            ...
                                                                            if (textView3 != null) {
                                                                                return new ActivityHomeTheme5Binding(drawerLayout, appBarDashboard5BindingBind, drawerLayout, frameLayout, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, linearLayout, linearLayout2, recyclerView, navigationView, textView, circleImageView, imageView7, textView2, linearLayout3, textView3);
                                                                            }
                                                                        }
                                                                    }
                                                                }
