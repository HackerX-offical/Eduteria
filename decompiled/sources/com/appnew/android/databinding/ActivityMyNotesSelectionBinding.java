...
public final class ActivityMyNotesSelectionBinding implements ViewBinding {
    ...
    private ActivityMyNotesSelectionBinding(RelativeLayout rootView, AppBarLayout appBarLayout, ImageView back, Button buttonProceed, ImageView imageIV, NestedScrollView llMain, Toolbar myProgressToolbar, RecyclerView recyclerNotes, TextView toolbartitleTV, TextView tvNoDataFound) {
    ...
    public static ActivityMyNotesSelectionBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityMyNotesSelectionBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_my_notes_selection, parent, false);
        if (attachToParent) {
    ...
    public static ActivityMyNotesSelectionBinding bind(View rootView) {
                            ...
                            if (toolbar != null) {
                                ...
                                if (recyclerView != null) {
                                    ...
                                    if (textView != null) {
                                        ...
                                        if (textView2 != null) {
                                            return new ActivityMyNotesSelectionBinding((RelativeLayout) rootView, appBarLayout, imageView, button, imageView2, nestedScrollView, toolbar, recyclerView, textView, textView2);
                                        }
                                    }
                                }
                            }
