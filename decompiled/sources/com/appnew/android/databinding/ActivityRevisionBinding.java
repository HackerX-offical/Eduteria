...
public final class ActivityRevisionBinding implements ViewBinding {
    ...
    public static ActivityRevisionBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityRevisionBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_revision, parent, false);
        if (attachToParent) {
    ...
    public static ActivityRevisionBinding bind(View rootView) {
                    ...
                    if (frameLayout3 != null) {
                        ...
                        if (button != null) {
                            ...
                            if (appCompatImageView != null) {
                                ...
                                i = R.id.gridView;
                                TextView textView2 = (TextView) ViewBindings.findChildViewById(rootView, R.id.gridView);
                                if (textView2 != null) {
                                    i = R.id.img_pause;
                                        ...
                                        if (imageView2 != null) {
                                            ...
                                            if (imageView3 != null) {
                                                ...
                                                if (linearLayout != null) {
                                                    i = R.id.listView;
                                                    TextView textView3 = (TextView) ViewBindings.findChildViewById(rootView, R.id.listView);
                                                    if (textView3 != null) {
                                                        i = R.id.ll_bottom;
                                                                ...
                                                                if (linearLayout4 != null) {
                                                                    ...
                                                                    if (linearLayout5 != null) {
                                                                        ...
                                                                        if (linearLayout6 != null) {
                                                                            i = R.id.nextTV;
                                                                            TextView textView4 = (TextView) ViewBindings.findChildViewById(rootView, R.id.nextTV);
                                                                            if (textView4 != null) {
                                                                                ...
                                                                                if (recyclerView != null) {
                                                                                    ...
                                                                                    if (relativeLayout != null) {
                                                                                        ...
                                                                                        if (recyclerView2 != null) {
                                                                                            i = R.id.save_mark;
                                                                                            TextView textView5 = (TextView) ViewBindings.findChildViewById(rootView, R.id.save_mark);
                                                                                            if (textView5 != null) {
                                                                                                i = R.id.save_mark_count;
                                                                                                ImageView imageView4 = (ImageView) ViewBindings.findChildViewById(rootView, R.id.save_mark_count);
                                                                                                if (imageView4 != null) {
                                                                                                    i = R.id.testSeriesName;
                                                                                                    TextView textView6 = (TextView) ViewBindings.findChildViewById(rootView, R.id.testSeriesName);
                                                                                                    if (textView6 != null) {
                                                                                                        i = R.id.toolbar;
                                                                                                        Toolbar toolbar = (Toolbar) ViewBindings.findChildViewById(rootView, R.id.toolbar);
                                                                                                        if (toolbar != null) {
                                                                                                            i = R.id.tv_answer_count;
                                                                                                            TextView textView7 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_answer_count);
                                                                                                            if (textView7 != null) {
                                                                                                                i = R.id.tv_markforReview_count;
                                                                                                                TextView textView8 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_markforReview_count);
                                                                                                                if (textView8 != null) {
                                                                                                                    i = R.id.tv_questionnumber;
                                                                                                                    TextView textView9 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_questionnumber);
                                                                                                                    if (textView9 != null) {
                                                                                                                        i = R.id.tv_savemarkforReview_count;
                                                                                                                        TextView textView10 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_savemarkforReview_count);
                                                                                                                        if (textView10 != null) {
                                                                                                                            i = R.id.tv_skip_count;
                                                                                                                            TextView textView11 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_skip_count);
                                                                                                                            if (textView11 != null) {
                                                                                                                                i = R.id.tv_time;
                                                                                                                                TextView textView12 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_time);
                                                                                                                                if (textView12 != null) {
                                                                                                                                    i = R.id.tv_unanswer_count;
                                                                                                                                    TextView textView13 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_unanswer_count);
                                                                                                                                    if (textView13 != null) {
