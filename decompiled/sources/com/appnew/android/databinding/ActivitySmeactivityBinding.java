...
public final class ActivitySmeactivityBinding implements ViewBinding {
    ...
    private ActivitySmeactivityBinding(DrawerLayout rootView, FrameLayout forchatbot, ImageView iconFacebook, ImageView iconInstagram, ImageView iconLinkedIn, ImageView iconTelegram, ImageView iconTwitter, ImageView iconYoutube, LinearLayout navHeaderLL, LinearLayout navHeaderRL, RecyclerView navRV, NavigationView navView, TextView profileEmail, CircleImageView profileImage, ImageView profileImageText, TextView profileName, DrawerLayout smeDrawerLayout, SmeHomeLayoutBinding smeHomeLayout, LinearLayout socialIconLL, TextView vNameTV) {
        ...
        this.smeDrawerLayout = smeDrawerLayout;
    ...
    public static ActivitySmeactivityBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivitySmeactivityBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_smeactivity, parent, false);
        if (attachToParent) {
    ...
    public static ActivitySmeactivityBinding bind(View rootView) {
                                                        ...
                                                        if (circleImageView != null) {
                                                            ...
                                                            if (imageView7 != null) {
                                                                ...
                                                                if (textView2 != null) {
                                                                    ...
                                                                    View viewFindChildViewById = ViewBindings.findChildViewById(rootView, R.id.sme_home_layout);
                                                                    if (viewFindChildViewById != null) {
                                                                        SmeHomeLayoutBinding smeHomeLayoutBindingBind = SmeHomeLayoutBinding.bind(viewFindChildViewById);
                                                                        i = R.id.socialIconLL;
                                                                        ...
                                                                        if (linearLayout3 != null) {
                                                                            ...
                                                                            if (textView3 != null) {
                                                                                return new ActivitySmeactivityBinding(drawerLayout, frameLayout, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, linearLayout, linearLayout2, recyclerView, navigationView, textView, circleImageView, imageView7, textView2, drawerLayout, smeHomeLayoutBindingBind, linearLayout3, textView3);
                                                                            }
                                                                        }
                                                                    }
                                                                }
