...
public final class ActivitySplashscreenBinding implements ViewBinding {
    ...
    private ActivitySplashscreenBinding(RelativeLayout rootView, ImageView splashImageView) {
    ...
    public static ActivitySplashscreenBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_splashscreen, parent, false);
        if (attachToParent) {
    ...
    public static ActivitySplashscreenBinding bind(View rootView) {
        ImageView imageView = (ImageView) ViewBindings.findChildViewById(rootView, R.id.splashImageView);
        if (imageView != null) {
            return new ActivitySplashscreenBinding((RelativeLayout) rootView, imageView);
        }
        throw new NullPointerException("Missing required view with ID: ".concat(rootView.getResources().getResourceName(R.id.splashImageView)));
    }
}
