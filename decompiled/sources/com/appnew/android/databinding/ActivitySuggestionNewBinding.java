...
public final class ActivitySuggestionNewBinding implements ViewBinding {
    ...
    private ActivitySuggestionNewBinding(ConstraintLayout rootView, RelativeLayout SuggestionRL, EditText comment, Toolbar mainToolbar, RatingBar ratting, RelativeLayout relativeLayout, RelativeLayout relativeLayout0, RelativeLayout relativeLayout1, RelativeLayout rl2, RelativeLayout subject1, Button submitRatting, Button submitSupport, EditText suggestionComment, ImageView suggestionImageBack, ImageView suggestionImg, LinearLayout suggestionLl, RelativeLayout suggestionRelative, RelativeLayout suggestionRll, TextView suggestionText, ImageView supportImg, RelativeLayout supportRll, TextView supportText, TextView toolbarTitleTV, TextView tvHintComment) {
        ...
        this.tvHintComment = tvHintComment;
    }
    ...
    public static ActivitySuggestionNewBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivitySuggestionNewBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_suggestion_new, parent, false);
        if (attachToParent) {
    ...
    public static ActivitySuggestionNewBinding bind(View rootView) {
                                                                                ...
                                                                                if (imageView3 != null) {
                                                                                    ...
                                                                                    if (relativeLayout9 != null) {
                                                                                        ...
                                                                                        if (textView2 != null) {
                                                                                            ...
                                                                                            if (textView3 != null) {
                                                                                                i = R.id.tv_hint_comment;
                                                                                                TextView textView4 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_hint_comment);
                                                                                                if (textView4 != null) {
                                                                                                    return new ActivitySuggestionNewBinding((ConstraintLayout) rootView, relativeLayout, editText, toolbar, ratingBar, relativeLayout2, relativeLayout3, relativeLayout4, relativeLayout5, relativeLayout6, button, button2, editText2, imageView, imageView2, linearLayout, relativeLayout7, relativeLayout8, textView, imageView3, relativeLayout9, textView2, textView3, textView4);
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
