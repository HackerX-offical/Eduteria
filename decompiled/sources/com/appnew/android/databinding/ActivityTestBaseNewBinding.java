...
public final class ActivityTestBaseNewBinding implements ViewBinding {
    public final TextView btnClear;
    public final Button btnExamInstructions;
    ...
    public final RelativeLayout clPart;
    public final DrawerLayout drawerLayout;
    public final ImageButton dropdownIcon;
    ...
    public final Button moveToSection;
    ...
    public final LinearLayout topicLinearTextViews;
    public final HorizontalScrollView topicScrollView;
    ...
    private ActivityTestBaseNewBinding(DrawerLayout rootView, TextView btnClear, Button btnExamInstructions, FrameLayout btnFinish, FrameLayout btnNext, FrameLayout btnPrev, Button btnSubmit, AppCompatImageView calci, TextView changelang, RelativeLayout clPart, DrawerLayout drawerLayout, ImageButton dropdownIcon, TextView gridView, ImageView imgPause, ImageView imgTestback, ImageView imgTestmenu, ImageView langimage, LinearLayout layout, TextView listView, LinearLayout llBottom, LinearLayout llBottomRightmenu, LinearLayout llDrawerRight, LinearLayout llMarkForReview, LinearLayout llMarkForReviewCount, Button moveToSection, TextView nextTV, RecyclerView rlQuestionpad, RelativeLayout rlTime, RecyclerView rvnumberpad, TextView saveMark, ImageView saveMarkCount, TextView testSeriesName, FrameLayout testlayout, TextView textSpinner, Toolbar toolbar, LinearLayout topicLinearTextViews, HorizontalScrollView topicScrollView, TextView tvAnswerCount, TextView tvMarkforReviewCount, TextView tvQuestionnumber, TextView tvSavemarkforReviewCount, TextView tvSkipCount, TextView tvTime, TextView tvUnanswerCount, View viewMarkForReviewCount, ViewPager viewPagerTest) {
        this.rootView = rootView;
        this.btnClear = btnClear;
        this.btnExamInstructions = btnExamInstructions;
        ...
        this.topicLinearTextViews = topicLinearTextViews;
        this.topicScrollView = topicScrollView;
    ...
    public static ActivityTestBaseNewBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityTestBaseNewBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_test_base_new, parent, false);
        if (attachToParent) {
    ...
    public static ActivityTestBaseNewBinding bind(View rootView) {
        int i = R.id.btn_clear;
        TextView textView = (TextView) ViewBindings.findChildViewById(rootView, R.id.btn_clear);
        if (textView != null) {
            i = R.id.btn_exam_instructions;
            Button button = (Button) ViewBindings.findChildViewById(rootView, R.id.btn_exam_instructions);
            if (button != null) {
                i = R.id.btn_finish;
                        ...
                        if (frameLayout3 != null) {
                            ...
                            if (button2 != null) {
                                ...
                                if (appCompatImageView != null) {
                                    ...
                                    if (textView2 != null) {
                                        i = R.id.cl_part;
                                        RelativeLayout relativeLayout = (RelativeLayout) ViewBindings.findChildViewById(rootView, R.id.cl_part);
                                        if (relativeLayout != null) {
                                            DrawerLayout drawerLayout = (DrawerLayout) rootView;
                                            i = R.id.dropdown_icon;
                                            ImageButton imageButton = (ImageButton) ViewBindings.findChildViewById(rootView, R.id.dropdown_icon);
                                            if (imageButton != null) {
                                                i = R.id.gridView;
                                                                                    ...
                                                                                    if (linearLayout4 != null) {
                                                                                        ...
                                                                                        if (linearLayout5 != null) {
                                                                                            ...
                                                                                            if (linearLayout6 != null) {
                                                                                                i = R.id.move_to_section;
                                                                                                Button button3 = (Button) ViewBindings.findChildViewById(rootView, R.id.move_to_section);
                                                                                                if (button3 != null) {
                                                                                                    i = R.id.nextTV;
                                                                                                    ...
                                                                                                    if (textView5 != null) {
                                                                                                        ...
                                                                                                        if (recyclerView != null) {
                                                                                                            i = R.id.rl_time;
                                                                                                            RelativeLayout relativeLayout2 = (RelativeLayout) ViewBindings.findChildViewById(rootView, R.id.rl_time);
                                                                                                                        ...
                                                                                                                        if (imageView5 != null) {
                                                                                                                            ...
                                                                                                                            if (textView7 != null) {
                                                                                                                                ...
                                                                                                                                if (frameLayout4 != null) {
                                                                                                                                    i = R.id.text_spinner;
                                                                                                                                    TextView textView8 = (TextView) ViewBindings.findChildViewById(rootView, R.id.text_spinner);
                                                                                                                                    if (textView8 != null) {
                                                                                                                                        i = R.id.toolbar;
                                                                                                                                        Toolbar toolbar = (Toolbar) ViewBindings.findChildViewById(rootView, R.id.toolbar);
                                                                                                                                        if (toolbar != null) {
                                                                                                                                            i = R.id.topicLinearTextViews;
                                                                                                                                            LinearLayout linearLayout7 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.topicLinearTextViews);
                                                                                                                                            if (linearLayout7 != null) {
                                                                                                                                                i = R.id.topicScrollView;
                                                                                                                                                HorizontalScrollView horizontalScrollView = (HorizontalScrollView) ViewBindings.findChildViewById(rootView, R.id.topicScrollView);
                                                                                                                                                if (horizontalScrollView != null) {
                                                                                                                                                    i = R.id.tv_answer_count;
                                                                                                                                                    TextView textView9 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_answer_count);
                                                                                                                                                    if (textView9 != null) {
                                                                                                                                                        i = R.id.tv_markforReview_count;
                                                                                                                                                        TextView textView10 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_markforReview_count);
                                                                                                                                                        if (textView10 != null) {
                                                                                                                                                            i = R.id.tv_questionnumber;
                                                                                                                                                            TextView textView11 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_questionnumber);
                                                                                                                                                            if (textView11 != null) {
                                                                                                                                                                i = R.id.tv_savemarkforReview_count;
                                                                                                                                                                TextView textView12 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_savemarkforReview_count);
                                                                                                                                                                if (textView12 != null) {
                                                                                                                                                                    i = R.id.tv_skip_count;
                                                                                                                                                                    TextView textView13 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_skip_count);
                                                                                                                                                                    if (textView13 != null) {
                                                                                                                                                                        i = R.id.tv_time;
                                                                                                                                                                        TextView textView14 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_time);
                                                                                                                                                                        if (textView14 != null) {
                                                                                                                                                                            i = R.id.tv_unanswer_count;
                                                                                                                                                                            TextView textView15 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_unanswer_count);
                                                                                                                                                                            if (textView15 != null) {
                                                                                                                                                                                ...
                                                                                                                                                                                if (viewFindChildViewById != null) {
                                                                                                                                                                                    ...
                                                                                                                                                                                    if (viewPager != null) {
                                                                                                                                                                                        return new ActivityTestBaseNewBinding(drawerLayout, textView, button, frameLayout, frameLayout2, frameLayout3, button2, appCompatImageView, textView2, relativeLayout, drawerLayout, imageButton, textView3, imageView, imageView2, imageView3, imageView4, linearLayout, textView4, linearLayout2, linearLayout3, linearLayout4, linearLayout5, linearLayout6, button3, textView5, recyclerView, relativeLayout2, recyclerView2, textView6, imageView5, textView7, frameLayout4, textView8, toolbar, linearLayout7, horizontalScrollView, textView9, textView10, textView11, textView12, textView13, textView14, textView15, viewFindChildViewById, viewPager);
                                                                                                                                                                                    }
                                                                                                                                                                                }
                                                                                                                                                                            }
                                                                                                                                                                        }
