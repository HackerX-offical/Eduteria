...
public final class ActivityUserHistroyBinding implements ViewBinding {
    ...
    private ActivityUserHistroyBinding(RelativeLayout rootView, TextView delete, RecyclerView downloadRecycler, ImageView imageBack, Toolbar mainToolbar, CheckBox selectAllDelete, TextView toolbarTitleTV) {
    ...
    public static ActivityUserHistroyBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityUserHistroyBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_user_histroy, parent, false);
        if (attachToParent) {
    ...
    public static ActivityUserHistroyBinding bind(View rootView) {
        int i = R.id.delete;
                ...
                if (imageView != null) {
                    ...
                    if (toolbar != null) {
                        ...
                        if (checkBox != null) {
                            ...
                            if (textView2 != null) {
                                return new ActivityUserHistroyBinding((RelativeLayout) rootView, textView, recyclerView, imageView, toolbar, checkBox, textView2);
                            }
                        }
                    }
                }
