...
public final class ActivityViewSolutionBinding implements ViewBinding {
    ...
    public final TextView challengesTxt;
    ...
    public final RelativeLayout solutionRl;
    public final ImageView testResultFilter;
    ...
    private ActivityViewSolutionBinding(DrawerLayout rootView, AppCompatImageView bookmarkIconDeselect, AppCompatImageView bookmarkIconSelect, FrameLayout btnFinish, FrameLayout btnNext, FrameLayout btnPrev, TextView challengesTxt, TextView changelang, DrawerLayout drawerLayout, ImageView imgTestback, ImageView langimage, LinearLayout llBottom, TextView nextTV, RelativeLayout relativeLayout4, RelativeLayout rlTime, ConstraintLayout rootConstraint, RecyclerView rvnumberpad, RelativeLayout solutionRl, ImageView testResultFilter, TextView testSeriesName, FrameLayout testlayout, Toolbar toolbar, TextView tvQuestionnumber, ViewPager viewPagerTest) {
        ...
        this.challengesTxt = challengesTxt;
    ...
    public static ActivityViewSolutionBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ActivityViewSolutionBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.activity_view_solution, parent, false);
        if (attachToParent) {
    ...
    public static ActivityViewSolutionBinding bind(View rootView) {
                ...
                if (frameLayout != null) {
                    ...
                    if (frameLayout2 != null) {
                        ...
                        if (frameLayout3 != null) {
                            i = R.id.challenges_txt;
                            TextView textView = (TextView) ViewBindings.findChildViewById(rootView, R.id.challenges_txt);
                            if (textView != null) {
                                i = R.id.changelang;
                                    ...
                                    if (imageView != null) {
                                        ...
                                        if (imageView2 != null) {
                                            ...
                                            if (linearLayout != null) {
                                                i = R.id.nextTV;
                                                TextView textView3 = (TextView) ViewBindings.findChildViewById(rootView, R.id.nextTV);
                                                if (textView3 != null) {
                                                    i = R.id.relativeLayout4;
                                                    RelativeLayout relativeLayout = (RelativeLayout) ViewBindings.findChildViewById(rootView, R.id.relativeLayout4);
                                                        ...
                                                        if (relativeLayout2 != null) {
                                                            ...
                                                            if (constraintLayout != null) {
                                                                ...
                                                                if (recyclerView != null) {
                                                                    i = R.id.solutionRl;
                                                                    RelativeLayout relativeLayout3 = (RelativeLayout) ViewBindings.findChildViewById(rootView, R.id.solutionRl);
                                                                    if (relativeLayout3 != null) {
                                                                        i = R.id.testResultFilter;
                                                                        ImageView imageView3 = (ImageView) ViewBindings.findChildViewById(rootView, R.id.testResultFilter);
                                                                        if (imageView3 != null) {
                                                                            i = R.id.testSeriesName;
                                                                            TextView textView4 = (TextView) ViewBindings.findChildViewById(rootView, R.id.testSeriesName);
                                                                            if (textView4 != null) {
                                                                                i = R.id.testlayout;
                                                                                ...
                                                                                if (frameLayout4 != null) {
                                                                                    ...
                                                                                    if (toolbar != null) {
                                                                                        ...
                                                                                        TextView textView5 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_questionnumber);
                                                                                        if (textView5 != null) {
                                                                                            i = R.id.view_pager_test;
                                                                                            ViewPager viewPager = (ViewPager) ViewBindings.findChildViewById(rootView, R.id.view_pager_test);
                                                                                            if (viewPager != null) {
                                                                                                return new ActivityViewSolutionBinding(drawerLayout, appCompatImageView, appCompatImageView2, frameLayout, frameLayout2, frameLayout3, textView, textView2, drawerLayout, imageView, imageView2, linearLayout, textView3, relativeLayout, relativeLayout2, constraintLayout, recyclerView, relativeLayout3, imageView3, textView4, frameLayout4, toolbar, textView5, viewPager);
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }
