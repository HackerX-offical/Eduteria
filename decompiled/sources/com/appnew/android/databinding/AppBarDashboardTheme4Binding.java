...
public final class AppBarDashboardTheme4Binding implements ViewBinding {
    ...
    public static AppBarDashboardTheme4Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static AppBarDashboardTheme4Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.app_bar_dashboard_theme4, parent, false);
        if (attachToParent) {
    ...
    public static AppBarDashboardTheme4Binding bind(View rootView) {
        int i = R.id.CourseLL;
                                                ...
                                                if (linearLayout8 != null) {
                                                    ...
                                                    if (linearLayout9 != null) {
                                                        ...
                                                        if (linearLayout10 != null) {
                                                            i = R.id.my_library;
                                                            LinearLayout linearLayout11 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.my_library);
                                                                            ...
                                                                            if (relativeLayout3 != null) {
                                                                                ...
                                                                                if (imageView2 != null) {
                                                                                    ...
                                                                                    if (relativeLayout4 != null) {
                                                                                        ...
                                                                                        if (viewPager2 != null) {
                                                                                            i = R.id.tabsRV;
                                                                                            RecyclerView recyclerView = (RecyclerView) ViewBindings.findChildViewById(rootView, R.id.tabsRV);
                                                                                            if (recyclerView != null) {
                                                                                                i = R.id.testLL;
                                                                                                LinearLayout linearLayout12 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.testLL);
                                                                                                if (linearLayout12 != null) {
                                                                                                    i = R.id.viewPagerRL;
                                                                                                    RelativeLayout relativeLayout5 = (RelativeLayout) ViewBindings.findChildViewById(rootView, R.id.viewPagerRL);
                                                                                                    if (relativeLayout5 != null) {
                                                                                                        i = R.id.vodView;
                                                                                                        View viewFindChildViewById = ViewBindings.findChildViewById(rootView, R.id.vodView);
                                                                                                        if (viewFindChildViewById != null) {
                                                                                                            return new AppBarDashboardTheme4Binding((RelativeLayout) rootView, linearLayout, relativeLayout, linearLayout2, linearLayout3, linearLayout4, toolbar, relativeLayout2, linearLayout5, linearLayout6, linearLayout7, linearLayout8, linearLayout9, linearLayout10, linearLayout11, textView, textView2, imageView, relativeLayout3, imageView2, relativeLayout4, viewPager2, recyclerView, linearLayout12, relativeLayout5, viewFindChildViewById);
                                                                                                        }
                                                                                                    }
                                                                                                }
                                                                                            }
