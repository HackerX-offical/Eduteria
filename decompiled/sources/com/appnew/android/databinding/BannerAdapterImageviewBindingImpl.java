...
public class BannerAdapterImageviewBindingImpl extends BannerAdapterImageviewBinding implements OnClickListener.Listener {
    ...
    public BannerAdapterImageviewBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }

    private BannerAdapterImageviewBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((j & 4) != 0) {
            this.imgeView.setOnClickListener(this.mCallback1);
        }
        if (j2 != 0) {
