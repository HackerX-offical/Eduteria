...
public class BannerAdapterImageviewBindingSw600dpImpl extends BannerAdapterImageviewBinding implements OnClickListener.Listener {
    ...
    public BannerAdapterImageviewBindingSw600dpImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }

    private BannerAdapterImageviewBindingSw600dpImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((j & 4) != 0) {
            this.imgeView.setOnClickListener(this.mCallback12);
        }
        if (j2 != 0) {
