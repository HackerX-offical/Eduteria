...
public class CommentAdapterBindingImpl extends CommentAdapterBinding {
    ...
    public CommentAdapterBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }

    private CommentAdapterBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
