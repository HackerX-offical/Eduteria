...
public final class CreateTestResultScreenBinding implements ViewBinding {
    ...
    public static CreateTestResultScreenBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static CreateTestResultScreenBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.create_test_result_screen, parent, false);
        if (attachToParent) {
    ...
    public static CreateTestResultScreenBinding bind(View rootView) {
                                                                                ...
                                                                                if (imageView != null) {
                                                                                    ...
                                                                                    if (viewFindChildViewById != null) {
                                                                                        ...
                                                                                        if (viewFindChildViewById2 != null) {
                                                                                            return new CreateTestResultScreenBinding((RelativeLayout) rootView, linearLayout, nestedScrollView, textView, linearLayout2, textView2, textView3, textView4, textView5, textView6, linearLayout3, textView7, textView8, textView9, textView10, textView11, textView12, textView13, linearLayout4, imageView, viewFindChildViewById, viewFindChildViewById2);
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
