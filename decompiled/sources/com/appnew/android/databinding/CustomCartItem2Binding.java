...
public final class CustomCartItem2Binding implements ViewBinding {
    ...
    private CustomCartItem2Binding(RelativeLayout rootView, ShapeableImageView cartItemImage, TextView cartItemTittle, TextView cartItemType, TextView cartRatingTextView, TextView cartRatingUserTextView, TextView courseTax, TextView courseValidity, ImageView deleteItem, RatingBar ratingBarIndicator, TextView totalPriceId) {
    ...
    public static CustomCartItem2Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static CustomCartItem2Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.custom_cart_item2, parent, false);
        if (attachToParent) {
    ...
    public static CustomCartItem2Binding bind(View rootView) {
                                ...
                                if (textView6 != null) {
                                    ...
                                    if (imageView != null) {
                                        ...
                                        if (ratingBar != null) {
                                            ...
                                            if (textView7 != null) {
                                                return new CustomCartItem2Binding((RelativeLayout) rootView, shapeableImageView, textView, textView2, textView3, textView4, textView5, textView6, imageView, ratingBar, textView7);
                                            }
                                        }
                                    }
                                }
