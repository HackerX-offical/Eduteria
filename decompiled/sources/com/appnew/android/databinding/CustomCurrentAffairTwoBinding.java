...
public final class CustomCurrentAffairTwoBinding implements ViewBinding {
    ...
    private CustomCurrentAffairTwoBinding(RelativeLayout rootView, ImageView blinkNewCF, TextView currentAffairDate, ImageView currentAffairImage, TextView currentAffairSubject, TextView currentAffairTittle, ImageView shareCurrentAffair) {
    ...
    public static CustomCurrentAffairTwoBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static CustomCurrentAffairTwoBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.custom_current_affair_two, parent, false);
        if (attachToParent) {
    ...
    public static CustomCurrentAffairTwoBinding bind(View rootView) {
                ...
                if (imageView2 != null) {
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            ...
                            if (imageView3 != null) {
                                return new CustomCurrentAffairTwoBinding((RelativeLayout) rootView, imageView, textView, imageView2, textView2, textView3, imageView3);
                            }
                        }
                    }
                }
