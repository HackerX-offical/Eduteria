...
public final class CustomDoubtChatNewBinding implements ViewBinding {
    ...
    public final ClickableWebView replayMessage;
    ...
    private CustomDoubtChatNewBinding(LinearLayout rootView, TextView audioTextUsernameLeft, TextView audioTimeLeftAudio, Button audiopauseLeft, Button audioplayLeft, RelativeLayout cvrLeftAudio, RelativeLayout cvrLeftimage, LinearLayout ivImgLeftClick, TextView leftimagetime, ImageView letfmessageTvimage, LinearLayout masterMessageCard, LinearLayout navHeaderLeftAudio, ClickableWebView replayMessage, TextView textaudioLeft, TextView tvTime, TextView userMessage, LinearLayout userMessageCard, TextView userNameimage, ImageView userimageLeft) {
    ...
    public static CustomDoubtChatNewBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static CustomDoubtChatNewBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.custom_doubt_chat_new, parent, false);
        if (attachToParent) {
    ...
    public static CustomDoubtChatNewBinding bind(View rootView) {
                                        ...
                                        if (imageView != null) {
                                            ...
                                            if (linearLayout2 != null) {
                                                ...
                                                if (linearLayout3 != null) {
                                                    ...
                                                    ClickableWebView clickableWebView = (ClickableWebView) ViewBindings.findChildViewById(rootView, R.id.replayMessage);
                                                    if (clickableWebView != null) {
                                                        i = R.id.textaudioLeft;
                                                        TextView textView4 = (TextView) ViewBindings.findChildViewById(rootView, R.id.textaudioLeft);
                                                        if (textView4 != null) {
                                                            i = R.id.tv_time;
                                                            TextView textView5 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_time);
                                                            if (textView5 != null) {
                                                                i = R.id.userMessage;
                                                                TextView textView6 = (TextView) ViewBindings.findChildViewById(rootView, R.id.userMessage);
                                                                if (textView6 != null) {
                                                                    ...
                                                                    if (linearLayout4 != null) {
                                                                        ...
                                                                        TextView textView7 = (TextView) ViewBindings.findChildViewById(rootView, R.id.userNameimage);
                                                                        if (textView7 != null) {
                                                                            i = R.id.userimageLeft;
                                                                            ImageView imageView2 = (ImageView) ViewBindings.findChildViewById(rootView, R.id.userimageLeft);
                                                                            if (imageView2 != null) {
                                                                                return new CustomDoubtChatNewBinding((LinearLayout) rootView, textView, textView2, button, button2, relativeLayout, relativeLayout2, linearLayout, textView3, imageView, linearLayout2, linearLayout3, clickableWebView, textView4, textView5, textView6, linearLayout4, textView7, imageView2);
                                                                            }
                                                                        }
                                                                    }
                                                                }
