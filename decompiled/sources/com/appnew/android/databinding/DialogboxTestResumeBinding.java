...
public final class DialogboxTestResumeBinding implements ViewBinding {
    ...
    private DialogboxTestResumeBinding(LinearLayout rootView, TextView answeredTV, Button btnResume, TextView marked1, TextView markedTV, View markedView1, View markedView2, TextView notVisited, TextView notVistedValue, TextView saveMarked1, TextView saveMarkedTV, TextView tvUnattemptQuestion, TextView unansweredTV) {
    ...
    public static DialogboxTestResumeBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static DialogboxTestResumeBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.dialogbox_test_resume, parent, false);
        if (attachToParent) {
    ...
    public static DialogboxTestResumeBinding bind(View rootView) {
        int i = R.id.answeredTV;
        TextView textView = (TextView) ViewBindings.findChildViewById(rootView, R.id.answeredTV);
        if (textView != null) {
            i = R.id.btn_resume;
            Button button = (Button) ViewBindings.findChildViewById(rootView, R.id.btn_resume);
            if (button != null) {
                i = R.id.marked1;
                                    ...
                                    if (textView5 != null) {
                                        ...
                                        if (textView6 != null) {
                                            ...
                                            if (textView7 != null) {
                                                ...
                                                TextView textView8 = (TextView) ViewBindings.findChildViewById(rootView, R.id.tv_unattempt_question);
                                                if (textView8 != null) {
                                                    i = R.id.unansweredTV;
                                                    TextView textView9 = (TextView) ViewBindings.findChildViewById(rootView, R.id.unansweredTV);
                                                    if (textView9 != null) {
                                                        return new DialogboxTestResumeBinding((LinearLayout) rootView, textView, button, textView2, textView3, viewFindChildViewById, viewFindChildViewById2, textView4, textView5, textView6, textView7, textView8, textView9);
                                                    }
                                                }
                                            }
                                        }
