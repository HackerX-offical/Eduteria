...
public final class ExamPrepSingleRowItemTheme8Binding implements ViewBinding {
    ...
    private ExamPrepSingleRowItemTheme8Binding(RelativeLayout rootView, LinearLayout LogsLL, LinearLayout actalll, TextView actualduration, LinearLayout attemptLL, LinearLayout classdurationll, LinearLayout cvrClickItems, ProgressBar downloadprogess, TextView duration, LinearLayout durationLL, TextView examPrepTitleTV, ImageView forwardIV, CardView ibtSingleSubVdRL, RelativeLayout imageRL, RelativeLayout layoutFun, TextView learn, TextView listneNow, ImageView liveIV, RelativeLayout lockRL, TextView messageTV, AppCompatImageView optionMenuImgView, TextView practice, CircleImageView profileImage, LinearLayout progressLL, TextView readNow, TextView remainingTime, LinearLayout remainingtimell, RelativeLayout rl, ImageView share, RelativeLayout studySingleItemLL, TextView subItemRV, TextView totalViewTime, LinearLayout totalviewtimell, TextView watchNow) {
    ...
    public static ExamPrepSingleRowItemTheme8Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ExamPrepSingleRowItemTheme8Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.exam_prep_single_row_item_theme8, parent, false);
        if (attachToParent) {
    ...
    public static ExamPrepSingleRowItemTheme8Binding bind(View rootView) {
        int i = R.id.LogsLL;
                                                                                                                            ...
                                                                                                                            if (textView10 != null) {
                                                                                                                                ...
                                                                                                                                if (textView11 != null) {
                                                                                                                                    ...
                                                                                                                                    if (linearLayout9 != null) {
                                                                                                                                        ...
                                                                                                                                        if (textView12 != null) {
                                                                                                                                            return new ExamPrepSingleRowItemTheme8Binding((RelativeLayout) rootView, linearLayout, linearLayout2, textView, linearLayout3, linearLayout4, linearLayout5, progressBar, textView2, linearLayout6, textView3, imageView, cardView, relativeLayout, relativeLayout2, textView4, textView5, imageView2, relativeLayout3, textView6, appCompatImageView, textView7, circleImageView, linearLayout7, textView8, textView9, linearLayout8, relativeLayout4, imageView3, relativeLayout5, textView10, textView11, linearLayout9, textView12);
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                }
                                                                                                                            }
