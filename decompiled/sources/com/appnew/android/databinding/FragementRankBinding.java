...
public final class FragementRankBinding implements ViewBinding {
    ...
    private FragementRankBinding(RelativeLayout rootView, NestedScrollView nestedScroll, RecyclerView notification, ProgressBar progressBar, SwipeRefreshLayout pulltoReferesh) {
    ...
    public static FragementRankBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static FragementRankBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.fragement_rank, parent, false);
        if (attachToParent) {
    ...
    public static FragementRankBinding bind(View rootView) {
            ...
            if (recyclerView != null) {
                ...
                if (progressBar != null) {
                    ...
                    if (swipeRefreshLayout != null) {
                        return new FragementRankBinding((RelativeLayout) rootView, nestedScrollView, recyclerView, progressBar, swipeRefreshLayout);
                    }
                }
            }
        }
