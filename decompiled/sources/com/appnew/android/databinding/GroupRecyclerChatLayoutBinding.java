...
public final class GroupRecyclerChatLayoutBinding implements ViewBinding {
    ...
    public static GroupRecyclerChatLayoutBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static GroupRecyclerChatLayoutBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.group_recycler_chat_layout, parent, false);
        if (attachToParent) {
    ...
    public static GroupRecyclerChatLayoutBinding bind(View rootView) {
