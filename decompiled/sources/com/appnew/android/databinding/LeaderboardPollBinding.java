...
public final class LeaderboardPollBinding implements ViewBinding {
    ...
    public static LeaderboardPollBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LeaderboardPollBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.leaderboard_poll, parent, false);
        if (attachToParent) {
    ...
    public static LeaderboardPollBinding bind(View rootView) {
        int i = R.id.LayRank;
                                                                                    ...
                                                                                    if (textView4 != null) {
                                                                                        ...
                                                                                        if (textView5 != null) {
                                                                                            ...
                                                                                            if (textView6 != null) {
                                                                                                ...
                                                                                                if (textView7 != null) {
                                                                                                    return new LeaderboardPollBinding((RelativeLayout) rootView, linearLayout, relativeLayout, relativeLayout2, relativeLayout3, relativeLayout4, cardView, cardView2, cardView3, imageView, relativeLayout5, relativeLayout6, relativeLayout7, imageView2, recyclerView, recyclerView2, nestedScrollView, textView, textView2, textView3, textView4, textView5, textView6, textView7);
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
