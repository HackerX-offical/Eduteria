...
public class LiveClassVmBindingImpl extends LiveClassVmBinding implements OnClickListener.Listener {
    ...
    public LiveClassVmBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private LiveClassVmBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((j & 4) != 0) {
            this.viewAll.setOnClickListener(this.mCallback2);
        }
    }
