...
public class LiveClassVmBindingSw720dpImpl extends LiveClassVmBinding implements OnClickListener.Listener {
    ...
    public LiveClassVmBindingSw720dpImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private LiveClassVmBindingSw720dpImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((j & 4) != 0) {
            this.viewAll.setOnClickListener(this.mCallback18);
        }
    }
