...
public class LiveTestVmBindingSw600dpImpl extends LiveTestVmBinding implements OnClickListener.Listener {
    ...
    public LiveTestVmBindingSw600dpImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private LiveTestVmBindingSw600dpImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((j & 4) != 0) {
            this.viewAll.setOnClickListener(this.mCallback23);
        }
    }
