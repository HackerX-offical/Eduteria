...
public class LiveTestVmBindingSw720dpImpl extends LiveTestVmBinding implements OnClickListener.Listener {
    ...
    public LiveTestVmBindingSw720dpImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private LiveTestVmBindingSw720dpImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((j & 4) != 0) {
            this.viewAll.setOnClickListener(this.mCallback22);
        }
    }
