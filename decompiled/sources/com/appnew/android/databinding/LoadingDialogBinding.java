...
public final class LoadingDialogBinding implements ViewBinding {
    ...
    private LoadingDialogBinding(LinearLayout rootView) {
    ...
    public static LoadingDialogBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.loading_dialog, parent, false);
        if (attachToParent) {
    ...
    public static LoadingDialogBinding bind(View rootView) {
        if (rootView == null) {
            throw new NullPointerException("rootView");
        }
        return new LoadingDialogBinding((LinearLayout) rootView);
    }
}
