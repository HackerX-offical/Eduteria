...
public class NewTestResultAdapterBindingImpl extends NewTestResultAdapterBinding implements OnClickListener.Listener {
    ...
    public NewTestResultAdapterBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }

    private NewTestResultAdapterBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((j & 2) != 0) {
            this.testResult.setOnClickListener(this.mCallback16);
        }
    }
