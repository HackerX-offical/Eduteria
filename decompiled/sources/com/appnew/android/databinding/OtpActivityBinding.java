...
public final class OtpActivityBinding implements ViewBinding {
    ...
    private OtpActivityBinding(NestedScrollView rootView, EditText OPT1ET, EditText OPT2ET, EditText OPT3ET, EditText OPT4ET, EditText OPT5ET, EditText OPT6ET, ImageView ivBack, EditText pinHiddenEdittext, TextView resendotpTV, TextView resendotpTV1, TextView title, TextView tvTimer, Button verifyBtn, TextView verifyTextTV) {
    ...
    public static OtpActivityBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static OtpActivityBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.otp_activity, parent, false);
        if (attachToParent) {
    ...
    public static OtpActivityBinding bind(View rootView) {
        int i = R.id.OPT1ET;
                                                ...
                                                if (textView3 != null) {
                                                    ...
                                                    if (textView4 != null) {
                                                        ...
                                                        if (button != null) {
                                                            ...
                                                            if (textView5 != null) {
                                                                return new OtpActivityBinding((NestedScrollView) rootView, editText, editText2, editText3, editText4, editText5, editText6, imageView, editText7, textView, textView2, textView3, textView4, button, textView5);
                                                            }
                                                        }
                                                    }
                                                }
