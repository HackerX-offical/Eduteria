...
public final class PagerItemBinding implements ViewBinding {
    ...
    private PagerItemBinding(RelativeLayout rootView, ImageView imageView) {
    ...
    public static PagerItemBinding bind(View rootView) {
        ...
        if (imageView != null) {
            return new PagerItemBinding((RelativeLayout) rootView, imageView);
        }
        throw new NullPointerException("Missing required view with ID: ".concat(rootView.getResources().getResourceName(R.id.imageView)));
    }
}
