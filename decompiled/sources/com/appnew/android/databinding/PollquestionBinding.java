...
public final class PollquestionBinding implements ViewBinding {
    ...
    private PollquestionBinding(RelativeLayout rootView, Button buyNowBtn, Button cancel, LinearLayout cvrQuestions, Button submit, TextView txt1, LayoutItemPollQuestionsBinding typeA, LayoutItemPollQuestionsBinding typeB, LayoutItemPollQuestionsBinding typeC, LayoutItemPollQuestionsBinding typeD) {
    ...
    public static PollquestionBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static PollquestionBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.pollquestion, parent, false);
        if (attachToParent) {
    ...
    public static PollquestionBinding bind(View rootView) {
                                ...
                                if (viewFindChildViewById2 != null) {
                                    ...
                                    if (viewFindChildViewById3 != null) {
                                        ...
                                        if (viewFindChildViewById4 != null) {
                                            return new PollquestionBinding((RelativeLayout) rootView, button, button2, linearLayout, button3, textView, layoutItemPollQuestionsBindingBind, layoutItemPollQuestionsBindingBind2, layoutItemPollQuestionsBindingBind3, LayoutItemPollQuestionsBinding.bind(viewFindChildViewById4));
                                        }
                                    }
                                }
                            }
