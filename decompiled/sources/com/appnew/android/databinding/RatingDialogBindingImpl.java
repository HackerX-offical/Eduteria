...
public class RatingDialogBindingImpl extends RatingDialogBinding implements OnClickListener.Listener {
    ...
    public RatingDialogBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }

    private RatingDialogBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((j & 2) != 0) {
            ...
            this.submitRating.setOnClickListener(this.mCallback10);
        }
    }
