...
public class RatingDialogBindingSw600dpImpl extends RatingDialogBinding implements OnClickListener.Listener {
    ...
    public RatingDialogBindingSw600dpImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }

    private RatingDialogBindingSw600dpImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((j & 2) != 0) {
            this.closeButton.setOnClickListener(this.mCallback24);
            this.submitRating.setOnClickListener(this.mCallback25);
        }
    }
