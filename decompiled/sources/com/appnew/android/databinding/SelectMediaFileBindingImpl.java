...
public class SelectMediaFileBindingImpl extends SelectMediaFileBinding implements OnClickListener.Listener {
    ...
    public SelectMediaFileBindingImpl(DataBindingComponent bindingComponent, View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }

    private SelectMediaFileBindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((j & 2) != 0) {
            this.closeButton.setOnClickListener(this.mCallback19);
