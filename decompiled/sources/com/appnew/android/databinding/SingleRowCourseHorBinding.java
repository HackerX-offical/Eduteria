...
public final class SingleRowCourseHorBinding implements ViewBinding {
    ...
    private SingleRowCourseHorBinding(LinearLayout rootView, ImageView imageIV, TextView learnerTV, TextView nameTV, LinearLayout parentLL, TextView priceTV, RatingBar ratingRB, TextView ratingTV) {
    ...
    public static SingleRowCourseHorBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static SingleRowCourseHorBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.single_row_course_hor, parent, false);
        if (attachToParent) {
    ...
    public static SingleRowCourseHorBinding bind(View rootView) {
        int i = R.id.imageIV;
                ...
                if (textView2 != null) {
                    ...
                    if (textView3 != null) {
                        ...
                        if (ratingBar != null) {
                            ...
                            if (textView4 != null) {
                                return new SingleRowCourseHorBinding(linearLayout, imageView, textView, textView2, linearLayout, textView3, ratingBar, textView4);
                            }
                        }
                    }
                }
