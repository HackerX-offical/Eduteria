...
public final class SingleStudyItemNewSpringboardBinding implements ViewBinding {
    ...
    private SingleStudyItemNewSpringboardBinding(RelativeLayout rootView, TextView count, ImageView courseImage, ImageView forwardIV, CardView ibtSingleSubVdRL, ImageView liveIV, RelativeLayout lockRL, TextView noData, RelativeLayout rlThumb, TextView studyItemTitleTV, LinearLayout studySingleItemLL) {
    ...
    public static SingleStudyItemNewSpringboardBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static SingleStudyItemNewSpringboardBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.single_study_item_new_springboard, parent, false);
        if (attachToParent) {
    ...
    public static SingleStudyItemNewSpringboardBinding bind(View rootView) {
        int i = R.id.count;
                                    ...
                                    if (relativeLayout2 != null) {
                                        ...
                                        if (textView3 != null) {
                                            ...
                                            if (linearLayout != null) {
                                                return new SingleStudyItemNewSpringboardBinding((RelativeLayout) rootView, textView, imageView, imageView2, cardView, imageView3, relativeLayout, textView2, relativeLayout2, textView3, linearLayout);
                                            }
                                        }
                                    }
                                }
