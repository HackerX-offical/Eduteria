...
public final class SubjectivepopupBinding implements ViewBinding {
    ...
    public static SubjectivepopupBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static SubjectivepopupBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.subjectivepopup, parent, false);
        if (attachToParent) {
    ...
    public static SubjectivepopupBinding bind(View rootView) {
        int i = R.id.LogsLL;
                                ...
                                if (progressBar != null) {
                                    ...
                                    if (textView != null) {
                                        ...
                                        if (textView2 != null) {
                                            ...
                                            ImageView imageView2 = (ImageView) ViewBindings.findChildViewById(rootView, R.id.ibt_single_sub_vd_iv);
                                            if (imageView2 != null) {
                                                                                                                            ...
                                                                                                                            if (toolbar != null) {
                                                                                                                                ...
                                                                                                                                if (textView10 != null) {
                                                                                                                                    ...
                                                                                                                                    if (button4 != null) {
                                                                                                                                        ...
                                                                                                                                        if (textView11 != null) {
                                                                                                                                            return new SubjectivepopupBinding((RelativeLayout) rootView, linearLayout, linearLayout2, imageView, button, cardView, relativeLayout, progressBar, textView, textView2, imageView2, cardView2, textView3, linearLayout3, textView4, textView5, imageView3, relativeLayout2, button2, textView6, appCompatImageView, button3, textView7, textView8, relativeLayout3, textView9, imageView4, relativeLayout4, linearLayout4, appCompatTextView, toolbar, textView10, button4, textView11);
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                }
                                                                                                                            }
