...
public final class TileDataItemAdapterNewBinding implements ViewBinding {
    ...
    public static TileDataItemAdapterNewBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static TileDataItemAdapterNewBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View viewInflate = inflater.inflate(R.layout.tile_data_item_adapter_new, parent, false);
        if (attachToParent) {
    ...
    public static TileDataItemAdapterNewBinding bind(View rootView) {
        int i = R.id.buyNow;
                                                                            ...
                                                                            if (imageView4 != null) {
                                                                                ...
                                                                                if (relativeLayout2 != null) {
                                                                                    ...
                                                                                    if (cardView2 != null) {
                                                                                        ...
                                                                                        if (cardView3 != null) {
                                                                                            return new TileDataItemAdapterNewBinding(linearLayout2, cardView, imageView, linearLayout, textView, textView2, linearLayout2, imageView2, linearLayout3, linearLayout4, imageView3, linearLayout5, textView3, linearLayout6, textView4, ratingBar, relativeLayout, textView5, textView6, imageView4, relativeLayout2, cardView2, cardView3);
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
