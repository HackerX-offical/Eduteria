...
final class FeedDetails$onCreate$4$5 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ FeedDetails this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FeedDetails$onCreate$4$5(FeedDetails feedDetails, Continuation<? super FeedDetails$onCreate$4$5> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FeedDetails$onCreate$4$5(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((FeedDetails$onCreate$4$5) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
