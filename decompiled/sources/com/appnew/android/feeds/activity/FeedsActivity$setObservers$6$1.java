...
final class FeedsActivity$setObservers$6$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final /* synthetic */ PostDataTable $postDataTable;
    int label;
    final /* synthetic */ FeedsActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    FeedsActivity$setObservers$6$1(FeedsActivity feedsActivity, PostDataTable postDataTable, Continuation<? super FeedsActivity$setObservers$6$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FeedsActivity$setObservers$6$1(this.this$0, this.$postDataTable, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((FeedsActivity$setObservers$6$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
