...
public final class FeedViewModelProviderFactory implements ViewModelProvider.Factory {
    ...
    public <T extends ViewModel> T create(Class<T> modelClass) {
        ...
        if (modelClass.isAssignableFrom(FeedViewModel.class)) {
            return new FeedViewModel(this.userRepository, this.utkashRoom);
        }
        throw new InvalidParameterException("Unable to construct AuthViewModel");
    }
}
