...
public class LoginGoogleNewActivity extends AppCompatActivity implements NetworkCall.MyNetworkCallBack, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.btn_submit.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.loginRevamp.Activity.LoginGoogleNewActivity$$ExternalSyntheticLambda0
    ...
    public void onStart() {
        ...
        if (optionalPendingResultSilentSignIn.isDone()) {
            ...
            optionalPendingResultSilentSignIn.setResultCallback(new ResultCallback() { // from class: com.appnew.android.loginRevamp.Activity.LoginGoogleNewActivity$$ExternalSyntheticLambda1
    ...
    public void CheckValidation() {
        ...
        if (zDataNotValid) {
            ...
            callApi(FCMTokenHelper.getSavedToken(this));
        }
    }
