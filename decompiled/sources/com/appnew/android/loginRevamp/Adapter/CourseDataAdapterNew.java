package com.appnew.android.loginRevamp.Adapter;
...
public class CourseDataAdapterNew extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements NetworkCall.MyNetworkCallBack {
    Activity activity;
    ...
    public CourseDataAdapterNew(Activity activity, ArrayList<Courselist> courseDataArrayList, String isBook, ItemClicked itemClicked) {
    ...
    public class MyViewHodler extends RecyclerView.ViewHolder {
        ...
        public void setData(final Courselist course, final MyViewHodler hodler, final int pos) {
            ...
            if (course.getViewType().equalsIgnoreCase("0")) {
                hodler.llmain.setBackground(CourseDataAdapterNew.this.activity.getDrawable(R.drawable.gray_stroke_bg));
                hodler.iv_check.setImageResource(R.drawable.gray_img);
            } else {
                CourseDataAdapterNew.this.oldHolder = hodler;
                CourseDataAdapterNew.this.posOld = pos;
                hodler.llmain.setBackground(CourseDataAdapterNew.this.activity.getDrawable(R.drawable.primary_stroke_bg));
                hodler.iv_check.setImageResource(R.drawable.primary_check_img);
            }
            this.llmain.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.loginRevamp.Adapter.CourseDataAdapterNew$MyViewHodler$$ExternalSyntheticLambda0
        ...
        public /* synthetic */ void lambda$setData$0(MyViewHodler myViewHodler, int i, Courselist courselist, View view) {
            if (Helper.isNetworkConnected(CourseDataAdapterNew.this.activity)) {
                if (CourseDataAdapterNew.this.oldHolder != null) {
                    CourseDataAdapterNew.this.oldHolder.llmain.setBackground(CourseDataAdapterNew.this.activity.getDrawable(R.drawable.gray_stroke_bg));
                    CourseDataAdapterNew.this.oldHolder.iv_check.setImageResource(R.drawable.gray_img);
                    CourseDataAdapterNew.this.courseDataArrayList.get(CourseDataAdapterNew.this.posOld).setViewType("0");
                }
                CourseDataAdapterNew.this.oldHolder = myViewHodler;
                CourseDataAdapterNew.this.posOld = i;
                CourseDataAdapterNew.this.courseDataArrayList.get(i).setViewType("1");
                myViewHodler.llmain.setBackground(CourseDataAdapterNew.this.activity.getDrawable(R.drawable.primary_stroke_bg));
                myViewHodler.iv_check.setImageResource(R.drawable.primary_check_img);
                CourseDataAdapterNew.this.itemClicked.onItemClicked(courselist.getId());
                return;
            }
            Helper.showInternetToast(CourseDataAdapterNew.this.activity);
        }
    }
}
