...
public class ChooseLanguageIBTNew extends Fragment {
    Activity activity;
    Button continue_btn;
    ...
    public static ChooseLanguageIBTNew newInstance(int type) {
        ChooseLanguageIBTNew chooseLanguageIBTNew = new ChooseLanguageIBTNew();
        Bundle bundle = new Bundle();
        bundle.putInt("type", type);
        chooseLanguageIBTNew.setArguments(bundle);
        return chooseLanguageIBTNew;
    }
    ...
    private void initView(View view) {
        ...
        this.englishRL.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.loginRevamp.Fragment.ChooseLanguageIBTNew.1
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                ChooseLanguageIBTNew.this.hindiRadio.setChecked(false);
                ChooseLanguageIBTNew.this.engRadio.setChecked(true);
                ChooseLanguageIBTNew.this.languageDecider = Const.ENGLISH;
            }
        });
        this.hindiRL.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.loginRevamp.Fragment.ChooseLanguageIBTNew.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                ChooseLanguageIBTNew.this.hindiRadio.setChecked(true);
                ChooseLanguageIBTNew.this.engRadio.setChecked(false);
                ChooseLanguageIBTNew.this.languageDecider = Const.HINDI;
            }
        });
        this.engRadio.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.loginRevamp.Fragment.ChooseLanguageIBTNew.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                ChooseLanguageIBTNew.this.hindiRadio.setChecked(false);
                ChooseLanguageIBTNew.this.engRadio.setChecked(true);
        ...
        this.hindiRadio.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.loginRevamp.Fragment.ChooseLanguageIBTNew.4
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                ChooseLanguageIBTNew.this.hindiRadio.setChecked(true);
                ChooseLanguageIBTNew.this.engRadio.setChecked(false);
        ...
        this.continue_btn.setOnClickListener(new OnSingleClickListener(new Function0() { // from class: com.appnew.android.loginRevamp.Fragment.ChooseLanguageIBTNew$$ExternalSyntheticLambda0
    ...
    private void nextActivity(int lngCode, String language) {
        ...
        Intent intent = new Intent(this.activity, (Class<?>) SignInNewActivity.class);
