...
public final class forgetpasswordnew extends MainFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.ibt_fragment_forget_password_new, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        this.title = (TextView) viewFindViewById7;
        View viewFindViewById8 = view.findViewById(R.id.desc);
        Intrinsics.checkNotNull(viewFindViewById8, "null cannot be cast to non-null type android.widget.TextView");
        this.desc = (TextView) viewFindViewById8;
        ...
        if (editText3 != null) {
            editText3.setFilters(new InputFilter[]{new InputFilter() { // from class: com.appnew.android.loginRevamp.Fragment.forgetpasswordnew$$ExternalSyntheticLambda0
                @Override // android.text.InputFilter
                public final CharSequence filter(CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
                    return forgetpasswordnew.onViewCreated$lambda$0(charSequence, i, i2, spanned, i3, i4);
                }
            }});
        }
        String string = null;
        if (this.isChangePass) {
            ...
            textView2.setText((activity == null || (resources6 = activity.getResources()) == null) ? null : resources6.getString(R.string.change_password));
            TextView textView3 = this.desc;
            Intrinsics.checkNotNull(textView3);
            Activity activity2 = this.activity;
            textView3.setText((activity2 == null || (resources5 = activity2.getResources()) == null) ? null : resources5.getString(R.string.reset_password));
        } else {
            TextView textView4 = this.title;
            Intrinsics.checkNotNull(textView4);
            Activity activity3 = this.activity;
            textView4.setText((activity3 == null || (resources2 = activity3.getResources()) == null) ? null : resources2.getString(R.string.forget_password));
            TextView textView5 = this.desc;
            Intrinsics.checkNotNull(textView5);
            Activity activity4 = this.activity;
            textView5.setText((activity4 == null || (resources = activity4.getResources()) == null) ? null : resources.getString(R.string.india_trusted_app));
        }
        if (this.country) {
        ...
        if (!TextUtils.isEmpty(SharedPreference.getInstance().getLoggedInUser().getEmail())) {
            XtensionFunctionKt.visible(getEmailLL());
            RelativeLayout relativeLayout5 = this.mobileRl;
            if (relativeLayout5 != null) {
                XtensionFunctionKt.gone(relativeLayout5);
            }
            TextView textView6 = this.loginUsingTV;
            if (textView6 != null) {
                Activity activity5 = this.activity;
                if (activity5 != null && (resources4 = activity5.getResources()) != null) {
                    string = resources4.getString(R.string.recover_using_mobile_number);
                }
                textView6.setText(string);
            }
        } else {
            XtensionFunctionKt.gone(getEmailLL());
            RelativeLayout relativeLayout6 = this.mobileRl;
            if (relativeLayout6 != null) {
                XtensionFunctionKt.visible(relativeLayout6);
            }
            TextView textView7 = this.loginUsingTV;
            if (textView7 != null) {
                Activity activity6 = this.activity;
                if (activity6 != null && (resources3 = activity6.getResources()) != null) {
                    string = resources3.getString(R.string.recover_using_email);
                }
                textView7.setText(string);
            }
        }
        if (!TextUtils.isEmpty(SharedPreference.getInstance().getLoggedInUser().getMobile()) && !TextUtils.isEmpty(SharedPreference.getInstance().getLoggedInUser().getEmail())) {
            this.is_show_email = true;
        } else {
            this.is_show_email = false;
        }
        if (this.is_show_email && (textView = this.loginUsingTV) != null) {
            XtensionFunctionKt.visible(textView);
        }
        TextView textView8 = this.loginUsingTV;
        if (textView8 != null) {
            textView8.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.loginRevamp.Fragment.forgetpasswordnew$$ExternalSyntheticLambda1
        ...
        button.setOnClickListener(new OnSingleClickListener(new Function0() { // from class: com.appnew.android.loginRevamp.Fragment.forgetpasswordnew$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return forgetpasswordnew.onViewCreated$lambda$2(this.f$0);
            }
        }));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit onViewCreated$lambda$2(forgetpasswordnew forgetpasswordnewVar) {
        forgetpasswordnewVar.CheckValidationNew();
    ...
    */
    private final void CheckValidationNew() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appnew.android.loginRevamp.Fragment.forgetpasswordnew.CheckValidationNew():void");
    }
    ...
    /* JADX INFO: compiled from: forgetpasswordnew.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0016\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0007¨\u0006\t"}, d2 = {"Lcom/appnew/android/loginRevamp/Fragment/forgetpasswordnew$Companion;", "", "<init>", "()V", "newInstance", "Lcom/appnew/android/loginRevamp/Fragment/forgetpasswordnew;", "resetpass", "", "isChangePass", "app_EDUTERIARelease"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class Companion {
        ...
        public final forgetpasswordnew newInstance(boolean resetpass, boolean isChangePass) {
            forgetpasswordnew forgetpasswordnewVar = new forgetpasswordnew();
            Bundle bundle = new Bundle();
            bundle.putBoolean(Const.RESET_PASS, resetpass);
            bundle.putBoolean(Const.IS_CHANGE_PASS, isChangePass);
            forgetpasswordnewVar.setArguments(bundle);
            return forgetpasswordnewVar;
        }
    }
}
