...
public class DoubtChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Serializable {
    ...
    public DoubtChatAdapter(Context context, ArrayList<DoubtChatPojo> dataSet) {
    ...
    public void setData(final MyViewHolder holder, final int listPosition) {
        ...
        holder.cvrRightimage.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.sme.Adapter.DoubtChatAdapter$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$setData$0(listPosition, view);
            }
        });
        holder.cvrLeftimage.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.sme.Adapter.DoubtChatAdapter$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$setData$2(listPosition, view);
            }
        });
        holder.pdfViewLeft.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.sme.Adapter.DoubtChatAdapter$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$setData$3(listPosition, view);
            }
        });
        holder.pdfViewRight.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.sme.Adapter.DoubtChatAdapter$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        if (this.dataSet.get(listPosition).getId().equals(SharedPreference.getInstance().getLoggedInUser().getId())) {
            ...
            if (this.dataSet.get(listPosition).getType().equalsIgnoreCase(Const.PDF)) {
                ...
                holder.cvrDownLoadRight.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.sme.Adapter.DoubtChatAdapter.2
                    @Override // android.view.View.OnClickListener
                    public void onClick(View v) {
                        if (Helper.isNetworkConnected(DoubtChatAdapter.this.mContext)) {
                            DoubtChatAdapter doubtChatAdapter = DoubtChatAdapter.this;
                            doubtChatAdapter.ActivityInstanceDownload(doubtChatAdapter.dataSet.get(listPosition).getMessage());
                        } else {
            ...
            if (this.dataSet.get(listPosition).getType().equalsIgnoreCase("audio")) {
                ...
                holder.audioplay.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.sme.Adapter.DoubtChatAdapter.3
                    @Override // android.view.View.OnClickListener
                    public void onClick(View view) {
                        if (Helper.isNetworkConnected(DoubtChatAdapter.this.mContext)) {
                            DoubtChatAdapter.this.pauseAudio();
                            if (DoubtChatAdapter.this.mediaPlayer == null) {
                                DoubtChatPojo doubtChatPojo = DoubtChatAdapter.this.dataSet.get(listPosition);
                                doubtChatPojo.setIsplaying(true);
                                DoubtChatAdapter.this.dataSet.set(listPosition, doubtChatPojo);
                                DoubtChatAdapter.this.lastselected = listPosition;
                                DoubtChatAdapter doubtChatAdapter = DoubtChatAdapter.this;
                                doubtChatAdapter.notifyItemChanged(doubtChatAdapter.lastselected);
                                DoubtChatAdapter doubtChatAdapter2 = DoubtChatAdapter.this;
                                doubtChatAdapter2.mediaPlayer = MediaPlayer.create(doubtChatAdapter2.mContext, Uri.parse(DoubtChatAdapter.this.dataSet.get(listPosition).getMessage()));
                                DoubtChatAdapter.this.mediaPlayer.start();
                                DoubtChatAdapter doubtChatAdapter3 = DoubtChatAdapter.this;
                                MyViewHolder myViewHolder = holder;
                                doubtChatAdapter3.starttimer(myViewHolder, myViewHolder.audiopause, holder.audioplay, listPosition);
                                return;
                            }
                            if (DoubtChatAdapter.this.mediaPlayer.isPlaying()) {
                                DoubtChatAdapter.this.mediaPlayer.pause();
                                DoubtChatAdapter.this.stoptimer();
                                DoubtChatPojo doubtChatPojo2 = DoubtChatAdapter.this.dataSet.get(DoubtChatAdapter.this.lastselected);
                                doubtChatPojo2.setIsplaying(false);
                                DoubtChatAdapter.this.dataSet.set(DoubtChatAdapter.this.lastselected, doubtChatPojo2);
                                DoubtChatPojo doubtChatPojo3 = DoubtChatAdapter.this.dataSet.get(listPosition);
                                doubtChatPojo3.setIsplaying(true);
                                DoubtChatAdapter.this.dataSet.set(listPosition, doubtChatPojo3);
                                DoubtChatAdapter.this.lastselected = listPosition;
                                ...
                                doubtChatAdapter5.mediaPlayer = MediaPlayer.create(doubtChatAdapter5.mContext, Uri.parse(DoubtChatAdapter.this.dataSet.get(listPosition).getMessage()));
                                DoubtChatAdapter.this.mediaPlayer.start();
                                DoubtChatAdapter doubtChatAdapter6 = DoubtChatAdapter.this;
                                MyViewHolder myViewHolder2 = holder;
                                doubtChatAdapter6.starttimer(myViewHolder2, myViewHolder2.audiopause, holder.audioplay, listPosition);
                                return;
                            }
                            DoubtChatPojo doubtChatPojo4 = DoubtChatAdapter.this.dataSet.get(listPosition);
                            doubtChatPojo4.setIsplaying(true);
                            DoubtChatAdapter.this.dataSet.set(listPosition, doubtChatPojo4);
                            DoubtChatAdapter.this.lastselected = listPosition;
                            ...
                            doubtChatAdapter8.mediaPlayer = MediaPlayer.create(doubtChatAdapter8.mContext, Uri.parse(DoubtChatAdapter.this.dataSet.get(listPosition).getMessage()));
                            DoubtChatAdapter.this.mediaPlayer.start();
                            DoubtChatAdapter doubtChatAdapter9 = DoubtChatAdapter.this;
                            MyViewHolder myViewHolder3 = holder;
                            doubtChatAdapter9.starttimer(myViewHolder3, myViewHolder3.audiopause, holder.audioplay, listPosition);
                            return;
                        }
                        Helper.showInternetToast(DoubtChatAdapter.this.mContext);
                    }
                });
                holder.audiopause.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.sme.Adapter.DoubtChatAdapter$$ExternalSyntheticLambda4
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
        ...
        if (this.dataSet.get(listPosition).getType().equalsIgnoreCase(Const.PDF)) {
            ...
            holder.pdfdownloadLeft.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.sme.Adapter.DoubtChatAdapter.4
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
                    if (Helper.isNetworkConnected(DoubtChatAdapter.this.mContext)) {
                        DoubtChatAdapter doubtChatAdapter = DoubtChatAdapter.this;
        ...
        if (this.dataSet.get(listPosition).getType().equalsIgnoreCase("audio")) {
            ...
            holder.audioplayLeft.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.sme.Adapter.DoubtChatAdapter.5
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    if (Helper.isNetworkConnected(DoubtChatAdapter.this.mContext)) {
                        DoubtChatAdapter.this.pauseAudio();
                        ...
                        if (DoubtChatAdapter.this.mediaPlayer.isPlaying()) {
                            ...
                            DoubtChatAdapter.this.lastselected = listPosition;
                            DoubtChatAdapter doubtChatAdapter5 = DoubtChatAdapter.this;
                            doubtChatAdapter5.notifyItemChanged(doubtChatAdapter5.lastselected);
                            DoubtChatAdapter doubtChatAdapter6 = DoubtChatAdapter.this;
                            doubtChatAdapter6.mediaPlayer = MediaPlayer.create(doubtChatAdapter6.mContext, Uri.parse(DoubtChatAdapter.this.dataSet.get(listPosition).getMessage()));
                            DoubtChatAdapter.this.mediaPlayer.start();
                            DoubtChatAdapter doubtChatAdapter7 = DoubtChatAdapter.this;
                            MyViewHolder myViewHolder2 = holder;
                            doubtChatAdapter7.starttimer(myViewHolder2, myViewHolder2.audiopause, holder.audioplay, listPosition);
                            return;
                        }
                        DoubtChatPojo doubtChatPojo4 = DoubtChatAdapter.this.dataSet.get(listPosition);
                        doubtChatPojo4.setIsplaying(true);
                        ...
                        DoubtChatAdapter doubtChatAdapter9 = DoubtChatAdapter.this;
                        doubtChatAdapter9.mediaPlayer = MediaPlayer.create(doubtChatAdapter9.mContext, Uri.parse(DoubtChatAdapter.this.dataSet.get(listPosition).getMessage()));
                        DoubtChatAdapter.this.mediaPlayer.start();
                        DoubtChatAdapter doubtChatAdapter10 = DoubtChatAdapter.this;
                        MyViewHolder myViewHolder3 = holder;
                        doubtChatAdapter10.starttimer(myViewHolder3, myViewHolder3.audiopause, holder.audioplay, listPosition);
                        return;
                    }
                    Helper.showInternetToast(DoubtChatAdapter.this.mContext);
                }
            });
            holder.audiopauseLeft.setOnClickListener(new View.OnClickListener() { // from class: com.appnew.android.sme.Adapter.DoubtChatAdapter.6
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    DoubtChatAdapter.this.stoptimer();
                    DoubtChatPojo doubtChatPojo = DoubtChatAdapter.this.dataSet.get(listPosition);
                    ...
                    DoubtChatAdapter.this.dataSet.set(listPosition, doubtChatPojo);
                    DoubtChatAdapter.this.notifyItemChanged(listPosition);
                    DoubtChatAdapter.this.mediaPlayer.pause();
                }
            });
            if (this.dataSet.get(listPosition).isIsplaying()) {
