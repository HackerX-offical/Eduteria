...
public class SubjectiveRankAdapter extends RecyclerView.Adapter<MyViewHolder> {
    Context context;
    List<TopRanker> topTenLists;

    public SubjectiveRankAdapter(Context context, List<TopRanker> topTenLists) {
        new ArrayList();
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.textrank.setText(this.context.getResources().getString(R.string.rank_) + (position + 1));
        holder.mark.setText("Marks : " + this.topTenLists.get(holder.getAbsoluteAdapterPosition()).getMarks());
        if (position == 0) {
        ...
        TextDrawable textDrawableGetDrawable = Helper.GetDrawable(this.topTenLists.get(position).getName(), this.context, this.topTenLists.get(position).getId());
