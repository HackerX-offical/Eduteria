...
class DataCacheGenerator implements DataFetcherGenerator, DataFetcher.DataCallback<Object> {
    ...
    private final DecodeHelper<?> f557helper;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x001d, code lost:
        ...
        r7.loadData = r0.get(r3).buildLoadData(r7.cacheFile, r7.f557helper.getWidth(), r7.f557helper.getHeight(), r7.f557helper.getOptions());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:15:0x0057, code lost:
        ...
        if (r7.f557helper.hasLoadPath(r7.loadData.fetcher.getDataClass()) == false) goto L45;
     */
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0059, code lost:
    
        r7.loadData.fetcher.loadData(r7.f557helper.getPriority(), r7);
     */
    ...
    */
    public boolean startNext() {
        ...
        L15:
            ...
            com.bumptech.glide.load.engine.DecodeHelper<?> r4 = r7.f557helper     // Catch: java.lang.Throwable -> Lae
            int r4 = r4.getWidth()     // Catch: java.lang.Throwable -> Lae
            com.bumptech.glide.load.engine.DecodeHelper<?> r5 = r7.f557helper     // Catch: java.lang.Throwable -> Lae
            int r5 = r5.getHeight()     // Catch: java.lang.Throwable -> Lae
            com.bumptech.glide.load.engine.DecodeHelper<?> r6 = r7.f557helper     // Catch: java.lang.Throwable -> Lae
            ...
            if (r0 == 0) goto L15
            com.bumptech.glide.load.engine.DecodeHelper<?> r0 = r7.f557helper     // Catch: java.lang.Throwable -> Lae
            ...
            com.bumptech.glide.load.engine.DecodeHelper<?> r1 = r7.f557helper     // Catch: java.lang.Throwable -> Lae
        ...
        L7d:
            ...
            com.bumptech.glide.load.engine.DecodeHelper<?> r3 = r7.f557helper     // Catch: java.lang.Throwable -> Lae
