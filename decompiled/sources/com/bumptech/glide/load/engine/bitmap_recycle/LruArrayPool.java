...
public final class LruArrayPool implements ArrayPool {
    ...
    /* JADX INFO: renamed from: adapters, reason: collision with root package name */
    private final Map<Class<?>, ArrayAdapterInterface<?>> f560adapters;
    ...
    private <T> ArrayAdapterInterface<T> getAdapterFromType(Class<T> cls) {
        ...
        ArrayAdapterInterface<T> arrayAdapterInterface = (ArrayAdapterInterface) this.f560adapters.get(cls);
        ...
        this.f560adapters.put(cls, byteArrayAdapter);
