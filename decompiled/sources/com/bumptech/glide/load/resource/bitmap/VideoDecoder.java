...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
        ...
        try {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= 29) {
                    FontRequestWorker$$ExternalSyntheticBackport0.m9114m((Object) mediaMetadataRetrieverBuild);
                } else {
    ...
    /* JADX WARN: Removed duplicated region for block: B:25:0x005d A[Catch: all -> 0x0068, TRY_LEAVE, TryCatch #2 {all -> 0x0068, blocks: (B:23:0x0057, B:25:0x005d), top: B:38:0x0057 }] */
    ...
    */
    private boolean isUnsupportedFormat(T r6, android.media.MediaMetadataRetriever r7) {
        /*
            ...
            r1 = 12
            r3 = 0
            java.lang.String r7 = r7.extractMetadata(r1)     // Catch: java.lang.Throwable -> L55
            java.lang.String r1 = "video/webm"
            boolean r7 = r1.equals(r7)     // Catch: java.lang.Throwable -> L55
            if (r7 != 0) goto L22
            return r2
        L22:
            android.media.MediaExtractor r7 = new android.media.MediaExtractor     // Catch: java.lang.Throwable -> L55
            r7.<init>()     // Catch: java.lang.Throwable -> L55
            com.bumptech.glide.load.resource.bitmap.VideoDecoder$MediaInitializer<T> r1 = r5.initializer     // Catch: java.lang.Throwable -> L52
            r1.initializeExtractor(r7, r6)     // Catch: java.lang.Throwable -> L52
            int r6 = r7.getTrackCount()     // Catch: java.lang.Throwable -> L52
            r1 = r2
        L31:
            if (r1 >= r6) goto L4e
            android.media.MediaFormat r3 = r7.getTrackFormat(r1)     // Catch: java.lang.Throwable -> L52
        ...
        L56:
            r7 = 3
            boolean r7 = android.util.Log.isLoggable(r0, r7)     // Catch: java.lang.Throwable -> L68
            if (r7 == 0) goto L62
            java.lang.String r7 = "Exception trying to extract track info for a webm video on CrOS."
            android.util.Log.d(r0, r7, r6)     // Catch: java.lang.Throwable -> L68
        L62:
            if (r3 == 0) goto L67
            r3.release()
        L67:
