                    ...
                    if (r1.status == Status.WAITING_FOR_SIZE) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    i3 = r1.height;
                                    resourceClass = r1.requestOptions.getResourceClass();
                                    try {
                                        cls = r1.transcodeClass;
                                        try {
                                            priority = r1.priority;
                                            diskCacheStrategy = r1.requestOptions.getDiskCacheStrategy();
                                            transformations = r1.requestOptions.getTransformations();
                                            zIsTransformationRequired = r1.requestOptions.isTransformationRequired();
                                            zIsScaleOnlyOrNoTransform = r1.requestOptions.isScaleOnlyOrNoTransform();
                                            options = r1.requestOptions.getOptions();
                                            zIsMemoryCacheable = r1.requestOptions.isMemoryCacheable();
                                            useUnlimitedSourceGeneratorsPool = r1.requestOptions.getUseUnlimitedSourceGeneratorsPool();
                                            useAnimationPool = r1.requestOptions.getUseAnimationPool();
                                            onlyRetrieveFromCache = r1.requestOptions.getOnlyRetrieveFromCache();
                                            executor = r1.callbackExecutor;
                                            r1 = obj;
                                        } catch (Throwable th) {
                                            th = th;
                                            r1 = obj;
                                ...
                                try {
                                    r1.loadStatus = r2.load(glideContext, obj2, signature, i4, i3, resourceClass, cls, priority, diskCacheStrategy, transformations, zIsTransformationRequired, zIsScaleOnlyOrNoTransform, options, zIsMemoryCacheable, useUnlimitedSourceGeneratorsPool, useAnimationPool, onlyRetrieveFromCache, r1, executor);
    ...
    */
    ...
    private void onLoadFailed(GlideException glideException, int i) {
        ...
        synchronized (this.requestLock) {
            ...
            if (logLevel <= i) {
                Log.w(GLIDE_TAG, "Load failed for [" + this.model + "] with dimensions [" + this.width + "x" + this.height + Constants.AES_SUFFIX, glideException);
                if (logLevel <= 4) {
