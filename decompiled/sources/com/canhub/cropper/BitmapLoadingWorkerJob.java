...
public final class BitmapLoadingWorkerJob implements CoroutineScope {
    ...
    public BitmapLoadingWorkerJob(Context context, CropImageView cropImageView, Uri uri) {
        ...
        double d2 = displayMetrics.density > 1.0f ? 1.0d / ((double) displayMetrics.density) : 1.0d;
        this.width = (int) (((double) displayMetrics.widthPixels) * d2);
        this.height = (int) (((double) displayMetrics.heightPixels) * d2);
    }
