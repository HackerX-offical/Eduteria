...
public class CleverTapAPI implements CTInboxActivity.InboxActivityListener {
    ...
    public static void createNotificationChannel(final Context context, final String str, final CharSequence charSequence, final String str2, final int i, final String str3, final boolean z) {
        ...
        try {
            defaultInstanceOrFirstOther.getCoreState().getExecutors().postAsyncSafelyTask().execute("creatingNotificationChannel", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda0
                @Override // java.util.concurrent.Callable
    ...
    public static void createNotificationChannel(final Context context, final String str, final CharSequence charSequence, final String str2, final int i, final boolean z, final String str3) {
        ...
        try {
            defaultInstanceOrFirstOther.getCoreState().getExecutors().postAsyncSafelyTask().execute("createNotificationChannel", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda14
                @Override // java.util.concurrent.Callable
                public final Object call() {
    ...
    */
    ...
    public static void createNotificationChannel(final Context context, final String str, final CharSequence charSequence, final String str2, final int i, final String str3, final boolean z, final String str4) {
        ...
        try {
            defaultInstanceOrFirstOther.getCoreState().getExecutors().postAsyncSafelyTask().execute("creatingNotificationChannel", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda1
                @Override // java.util.concurrent.Callable
                public final Object call() {
    ...
    */
    ...
    public static void createNotificationChannelGroup(final Context context, final String str, final CharSequence charSequence) {
        ...
        try {
            defaultInstanceOrFirstOther.getCoreState().getExecutors().postAsyncSafelyTask().execute("creatingNotificationChannelGroup", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda11
                @Override // java.util.concurrent.Callable
                public final Object call() {
    ...
    public static void deleteNotificationChannel(final Context context, final String str) {
        ...
        try {
            defaultInstanceOrFirstOther.getCoreState().getExecutors().postAsyncSafelyTask().execute("deletingNotificationChannel", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda16
                @Override // java.util.concurrent.Callable
                public final Object call() {
    ...
    public static void deleteNotificationChannelGroup(final Context context, final String str) {
        ...
        try {
            defaultInstanceOrFirstOther.getCoreState().getExecutors().postAsyncSafelyTask().execute("deletingNotificationChannelGroup", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda8
                @Override // java.util.concurrent.Callable
                public final Object call() {
    ...
    public static void fcmTokenRefresh(Context context, String str) {
        for (CleverTapAPI cleverTapAPI : getAvailableInstances(context)) {
            if (cleverTapAPI == null || cleverTapAPI.getCoreState().getConfig().isAnalyticsOnly()) {
                ...
                cleverTapAPI.getCoreState().getPushProviders().doTokenRefresh(str, PushConstants.FCM);
            }
        }
    }
    ...
    public void syncRegisteredInAppTemplates() {
        ...
        if (coreState.getNetworkManager() == null) {
            ...
            getCleverTapID(new OnInitCleverTapIDListener() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda9
                @Override // com.clevertap.android.sdk.interfaces.OnInitCleverTapIDListener
                public final void onInitCleverTapID(String str) {
                    this.f$0.m11865xc726bba6(networkManager, templatesManager, str);
                }
            });
        }
    }

    /* JADX INFO: renamed from: lambda$syncRegisteredInAppTemplates$7$com-clevertap-android-sdk-CleverTapAPI, reason: not valid java name */
    /* synthetic */ void m11865xc726bba6(final NetworkManager networkManager, final TemplatesManager templatesManager, String str) {
        this.coreState.getExecutors().postAsyncSafelyTask().execute("DefineTemplates", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda10
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return CleverTapAPI.lambda$syncRegisteredInAppTemplates$6(networkManager, templatesManager);
            }
        });
    }

    static /* synthetic */ Void lambda$syncRegisteredInAppTemplates$6(NetworkManager networkManager, TemplatesManager templatesManager) throws Exception {
    ...
    CleverTapAPI(Context context, CleverTapInstanceConfig cleverTapInstanceConfig, CoreState coreState, Clock clock) {
    ...
    private void asyncStartup() {
        this.coreState.getExecutors().postAsyncSafelyTask().execute("CleverTapAPI#initializeDeviceInfo", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda2
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m11858lambda$asyncStartup$8$comclevertapandroidsdkCleverTapAPI();
            }
        });
        ...
        this.coreState.getExecutors().postAsyncSafelyTask().execute("setStatesAsync", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda3
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m11859lambda$asyncStartup$9$comclevertapandroidsdkCleverTapAPI();
            }
        });
        this.coreState.getExecutors().postAsyncSafelyTask().execute("saveConfigtoSharedPrefs", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda4
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m11856lambda$asyncStartup$10$comclevertapandroidsdkCleverTapAPI();
            }
        });
        this.coreState.getExecutors().postAsyncSafelyTask().execute("recordDeviceIDErrors", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda5
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m11857lambda$asyncStartup$11$comclevertapandroidsdkCleverTapAPI();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$asyncStartup$8$com-clevertap-android-sdk-CleverTapAPI, reason: not valid java name */
    /* synthetic */ Void m11858lambda$asyncStartup$8$comclevertapandroidsdkCleverTapAPI() throws Exception {
    ...
    /* JADX INFO: renamed from: lambda$asyncStartup$9$com-clevertap-android-sdk-CleverTapAPI, reason: not valid java name */
    /* synthetic */ Void m11859lambda$asyncStartup$9$comclevertapandroidsdkCleverTapAPI() throws Exception {
    ...
    /* JADX INFO: renamed from: lambda$asyncStartup$10$com-clevertap-android-sdk-CleverTapAPI, reason: not valid java name */
    /* synthetic */ Void m11856lambda$asyncStartup$10$comclevertapandroidsdkCleverTapAPI() throws Exception {
        String jSONString = getConfig().toJSONString();
        if (jSONString == null) {
            Logger.v("Unable to save config to SharedPrefs, config Json is null");
            return null;
        }
        StorageHelper.putString(this.context, getConfig().getAccountId(), "instance", jSONString);
        return null;
    }

    /* JADX INFO: renamed from: lambda$asyncStartup$11$com-clevertap-android-sdk-CleverTapAPI, reason: not valid java name */
    /* synthetic */ Void m11857lambda$asyncStartup$11$comclevertapandroidsdkCleverTapAPI() throws Exception {
    ...
    public void discardInAppNotifications(boolean z) {
        if (!this.coreState.getConfig().isAnalyticsOnly()) {
            ...
            this.coreState.getInAppController().discardInApps(z);
            return;
        }
    ...
    public ArrayList<CTInboxMessage> getAllInboxMessages() {
        ...
        synchronized (this.coreState.getCTLockManager().getInboxControllerLock()) {
            if (this.coreState.getControllerManager().getCTInboxController() != null) {
                for (CTMessageDAO cTMessageDAO : this.coreState.getControllerManager().getCTInboxController().getMessages()) {
                    Logger.v("CTMessage Dao - " + cTMessageDAO.toJSON().toString());
    ...
    @Deprecated(since = com.android.billingclient.BuildConfig.VERSION_NAME)
            ...
            FirebaseMessaging.getInstance().getToken().addOnCompleteListener(new OnCompleteListener<String>() { // from class: com.clevertap.android.sdk.CleverTapAPI.2
                ...
                public void onComplete(Task<String> task) {
                    if (!task.isSuccessful()) {
                        Logger.v(PushConstants.LOG_TAG, "FCMFCM token using googleservices.json failed", task.getException());
                        requestDevicePushTokenListener.onDevicePushToken(null, PushConstants.FCM);
                    } else {
                        String result = task.getResult() != null ? task.getResult() : null;
                        Logger.v(PushConstants.LOG_TAG, "FCMFCM token using googleservices.json - " + result);
                        requestDevicePushTokenListener.onDevicePushToken(result, PushConstants.FCM);
                    }
                }
            });
        } catch (Throwable th) {
    ...
    public void messageDidShow(CTInboxActivity cTInboxActivity, final CTInboxMessage cTInboxMessage, final Bundle bundle) {
        this.coreState.getExecutors().postAsyncSafelyTask().execute("handleMessageDidShow", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda6
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m11862lambda$messageDidShow$12$comclevertapandroidsdkCleverTapAPI(cTInboxMessage, bundle);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$messageDidShow$12$com-clevertap-android-sdk-CleverTapAPI, reason: not valid java name */
    /* synthetic */ Void m11862lambda$messageDidShow$12$comclevertapandroidsdkCleverTapAPI(CTInboxMessage cTInboxMessage, Bundle bundle) throws Exception {
    ...
    public void pushFcmRegistrationId(String str, boolean z) {
        this.coreState.getPushProviders().handleToken(str, PushConstants.FCM, z);
    }
    ...
    public void setOptOut(final boolean z, final boolean z2) {
        this.coreState.getExecutors().postAsyncSafelyTask().execute("setOptOut", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda17
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m11864lambda$setOptOut$13$comclevertapandroidsdkCleverTapAPI(z, z2);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$setOptOut$13$com-clevertap-android-sdk-CleverTapAPI, reason: not valid java name */
    /* synthetic */ Void m11864lambda$setOptOut$13$comclevertapandroidsdkCleverTapAPI(boolean z, boolean z2) throws Exception {
        boolean z3 = !z || z2;
        HashMap map = new HashMap();
        map.put(Constants.CLEVERTAP_OPTOUT, Boolean.valueOf(z));
        map.put(Constants.CLEVERTAP_ALLOW_SYSTEM_EVENTS, Boolean.valueOf(z3));
        this.coreState.getCoreMetaData().setCurrentUserOptedOut(false);
        this.coreState.getAnalyticsManager().pushProfile(map);
        this.coreState.getCoreMetaData().setCurrentUserOptedOut(z);
        this.coreState.getCoreMetaData().setEnabledSystemEvents(z3);
        this.coreState.getDeviceInfo().saveOptOutState(z);
        this.coreState.getDeviceInfo().saveAllowedSystemEventsState(z3);
        return null;
    }
    ...
    void deviceIDCreated(final String str) {
        ...
        final ICryptHandler cryptHandler = this.coreState.getCryptHandler();
        ...
        this.coreState.getExecutors().ioTask().execute("initStores", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda7
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m11860lambda$deviceIDCreated$14$comclevertapandroidsdkCleverTapAPI(storeRegistry, storeProvider, cryptHandler, str, accountId, evaluationManager);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$deviceIDCreated$14$com-clevertap-android-sdk-CleverTapAPI, reason: not valid java name */
    /* synthetic */ Void m11860lambda$deviceIDCreated$14$comclevertapandroidsdkCleverTapAPI(StoreRegistry storeRegistry, StoreProvider storeProvider, ICryptHandler iCryptHandler, String str, String str2, EvaluationManager evaluationManager) throws Exception {
        if (storeRegistry.getInAppStore() == null) {
            InAppStore inAppStoreProvideInAppStore = storeProvider.provideInAppStore(this.context, iCryptHandler, str, str2);
    ...
    */
    ...
    private static CleverTapInstanceConfig getDefaultConfig(Context context) {
        ...
        CleverTapInstanceConfig cleverTapInstanceConfigCreateDefaultInstance = CleverTapInstanceConfig.createDefaultInstance(context, accountId, accountToken, accountRegion);
    ...
    public void getCleverTapID(final OnInitCleverTapIDListener onInitCleverTapIDListener) {
        this.coreState.getExecutors().ioTask().execute("getCleverTapID", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda12
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m11861lambda$getCleverTapID$16$comclevertapandroidsdkCleverTapAPI(onInitCleverTapIDListener);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$getCleverTapID$16$com-clevertap-android-sdk-CleverTapAPI, reason: not valid java name */
    /* synthetic */ Void m11861lambda$getCleverTapID$16$comclevertapandroidsdkCleverTapAPI(final OnInitCleverTapIDListener onInitCleverTapIDListener) throws Exception {
        final String deviceID = this.coreState.getDeviceInfo().getDeviceID();
        if (deviceID != null) {
            Utils.runOnUiThread(new Runnable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda18
    ...
    public Future<?> renderPushNotification(final INotificationRenderer iNotificationRenderer, final Context context, final Bundle bundle) {
        ...
        try {
            return this.coreState.getExecutors().postAsyncSafelyTask().submit("CleverTapAPI#renderPushNotification", new Callable() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda15
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return this.f$0.m11863x7018dffe(iNotificationRenderer, bundle, context);
                }
            });
        } catch (Throwable th) {
    ...
    /* JADX INFO: renamed from: lambda$renderPushNotification$17$com-clevertap-android-sdk-CleverTapAPI, reason: not valid java name */
    /* synthetic */ Void m11863x7018dffe(INotificationRenderer iNotificationRenderer, Bundle bundle, Context context) throws Exception {
    ...
    JSONObject getFetchRequestAsJson(int i) {
        ...
        try {
            ...
            Logger.v(Constants.CLEVERTAP_LOG_TAG, "Failed while parsing fetch request as json:", e2);
            return jSONObject;
        }
    }
    ...
    public void syncVariables() {
        if (isDevelopmentMode()) {
            ...
            getCleverTapID(new OnInitCleverTapIDListener() { // from class: com.clevertap.android.sdk.CleverTapAPI$$ExternalSyntheticLambda13
                @Override // com.clevertap.android.sdk.interfaces.OnInitCleverTapIDListener
                public final void onInitCleverTapID(String str) {
                    this.f$0.m11866lambda$syncVariables$18$comclevertapandroidsdkCleverTapAPI(str);
                }
            });
        } else {
    ...
    /* JADX INFO: renamed from: lambda$syncVariables$18$com-clevertap-android-sdk-CleverTapAPI, reason: not valid java name */
    /* synthetic */ void m11866lambda$syncVariables$18$comclevertapandroidsdkCleverTapAPI(String str) {
    ...
    public void pushRegistrationToken(String str, PushType pushType, boolean z) {
        this.coreState.getPushProviders().handleToken(str, pushType, z);
    }
}
