...
public interface Constants {
    public static final String AES_GCM_PREFIX = "<ct<";
    public static final String AES_GCM_SUFFIX = ">ct>";
    public static final String AES_PREFIX = "[";
    public static final String AES_SUFFIX = "]";
    ...
    public static final String CACHED_GUIDS_LENGTH_KEY = "cachedGUIDsLengthKey";
    ...
    public static final String CLEVERTAP_ALLOW_SYSTEM_EVENTS = "ct_allow_sys_events_and_communication";
    ...
    public static final String CLTAP_APP_VERSION = "Version";
    public static final String CLTAP_BLUETOOTH_ENABLED = "BluetoothEnabled";
    public static final String CLTAP_BLUETOOTH_VERSION = "BluetoothVersion";
    public static final String CLTAP_CONNECTED_TO_WIFI = "wifi";
    public static final String CLTAP_LATITUDE = "Latitude";
    public static final String CLTAP_LONGITUDE = "Longitude";
    public static final String CLTAP_NETWORK_TYPE = "Radio";
    public static final String CLTAP_OS_VERSION = "OS Version";
    public static final String CLTAP_PROP_CAMPAIGN_ID = "Campaign id";
    public static final String CLTAP_PROP_VARIANT = "Variant";
    public static final String CLTAP_SDK_VERSION = "SDK Version";
    ...
    public static final String CONTENT_FETCH_JSON_RESPONSE_KEY = "content_fetch";
    ...
    public static final String CT_FALLBACK_NOTIFICATION_CHANNEL_ID_LOW = "ct_fallback_notification_channel_low_importance";
    ...
    public static final long DEFAULT_PUSH_TTL_SECONDS = 345600;
    ...
    public static final int FETCH_TYPE_IN_APPS = 5;
    ...
    public static final String INAPP_ADVANCED_BUILDER_TYPE = "advanced-builder";
    public static final String INAPP_ASPECT_RATIO = "aspectRatio";
    public static final int INAPP_CLOSE_IV_WIDTH = 40;
    public static final String INAPP_DATA_TAG = "d";
    public static final String INAPP_DELIVERY_MODE_KEY = "inapp_delivery_mode";
    public static final String INAPP_FC_LIMITS = "frequencyLimits";
    public static final String INAPP_HTML_SPLIT = "\"##Vars##\"";
    public static final String INAPP_HTML_TAG = "html";
    public static final String INAPP_ID_IN_PAYLOAD = "ti";
    public static final String INAPP_IMAGE_INTERSTITIAL_CONFIG = "imageInterstitialConfig";
    public static final String INAPP_IMAGE_INTERSTITIAL_HTML_NAME = "image_interstitial.html";
    public static final String INAPP_IMAGE_INTERSTITIAL_TYPE = "image-interstitial";
    ...
    public static final String INAPP_MAX_PER_DAY_KEY = "imp";
    public static final String INAPP_MAX_PER_SESSION_KEY = "imc";
    public static final String INAPP_NOTIFS_APP_LAUNCHED_KEY = "inapp_notifs_applaunched";
    public static final String INAPP_NOTIFS_KEY_CS = "inapp_notifs_cs";
    public static final String INAPP_NOTIFS_KEY_SS = "inapp_notifs_ss";
    public static final String INAPP_NOTIFS_STALE_KEY = "inapp_stale";
    public static final String INAPP_NOTIF_DARKEN_SCREEN = "dk";
    public static final String INAPP_NOTIF_SHOW_CLOSE = "sc";
    public static final String INAPP_OCCURRENCE_LIMITS = "occurrenceLimits";
    ...
    public static final String INAPP_PREVIEW_PUSH_PAYLOAD_TYPE_KEY = "wzrk_inapp_type";
    public static final String INAPP_PREVIEW_S3_URL_KEY = "wzrk_inapp_s3_url";
    public static final String INAPP_PRIORITY = "priority";
    public static final String INAPP_SS_EVAL_META = "inapps_eval";
    public static final String INAPP_SUPPRESSED = "suppressed";
    public static final String INAPP_SUPPRESSED_META = "inapps_suppressed";
    public static final String INAPP_WHEN_LIMITS = "whenLimit";
    public static final String INAPP_WHEN_TRIGGERS = "whenTriggers";
    public static final String INAPP_WINDOW = "w";
    public static final String INAPP_WZRK_CGID = "wzrk_cgId";
    public static final String INAPP_WZRK_PIVOT = "wzrk_pivot";
    ...
    public static final String KEY_ENCRYPTION_INAPP_CS = "cs";
    public static final String KEY_ENCRYPTION_INAPP_SS = "ss";
    public static final String KEY_ENCRYPTION_PHONE = "Phone";
    public static final String KEY_EVT_DATA = "evtData";
    public static final String KEY_EVT_NAME = "evtName";
    public static final String KEY_EXCLUDE_GLOBAL_CAPS = "excludeGlobalFCaps";
    ...
    public static final String KEY_TRIGGERS_PER_INAPP = "triggers_per_inapp";
    ...
    public static final String LOG_TAG_INAPP = "InApp : ";
    ...
    public static final String LOW_IMPORTANCE_FALLBACK_NOTIFICATION_CHANNEL_NAME = "Silent Misc";
    ...
    public static final String NOTIF_HIDE_APP_LARGE_ICON = "wzrk_hide_large_icon";
    ...
    public static final String PREFS_EVALUATED_INAPP_KEY_SS = "evaluated_ss";
    public static final String PREFS_INAPP_KEY_CS = "inapp_notifs_cs";
    public static final String PREFS_INAPP_KEY_SS = "inapp_notifs_ss";
    public static final String PREFS_SUPPRESSED_INAPP_KEY_CS = "suppressed_ss";
    ...
    public static final String PUSH_DIRECTORY_NAME = "CleverTap.Push";
    ...
    public static final String URL_PARAM_DL_SEPARATOR = "__dl__";
    public static final String USER_ATTRIBUTE_CHANGE = "_CTUserAttributeChange";
    ...
    public static final String WZRK_BIG_PICTURE_ALT_TEXT_KEY = "alt_text_wzrk_bp";
    ...
    public static final String WZRK_DEDUPE = "wzrk_dd";
    public static final String WZRK_DISMISS = "wzrk_dismiss";
    ...
    public static final String WZRK_GIF = "wzrk_gif";
    ...
    public static final String WZRK_SILENCE_IN_FOREGROUND = "wzrk_sif";
    public static final String WZRK_SOUND = "wzrk_sound";
    public static final String WZRK_STICKY = "wzrk_sticky";
    public static final String WZRK_SUBTITLE = "wzrk_st";
    public static final String WZRK_TIME_TO_LIVE = "wzrk_ttl";
    public static final String WZRK_TIME_TO_LIVE_OFFSET = "wzrk_ttl_offset";
    public static final String WZRK_TSR_FB = "wzrk_tsr_fb";
    public static final String WZRK_URL_SCHEMA = "wzrk://";
    ...
    public static final HashSet<String> MEDIUM_CRYPT_KEYS = new HashSet<>(Arrays.asList(KEY_ENCRYPTION_CGK, KEY_ENCRYPTION_MIGRATION, "Email", "Phone", "Identity", KEY_ENCRYPTION_NAME));
    public static final HashSet<String> NONE_CRYPT_KEYS = new HashSet<>(Arrays.asList(KEY_ENCRYPTION_MIGRATION));
    public static final HashSet<String> piiDBKeys = new HashSet<>(Arrays.asList(KEY_ENCRYPTION_NAME, "Email", "Identity", "Phone"));
    public static final String CLTAP_CARRIER = "Carrier";
    public static final HashSet<String> keysToSkipForUserAttributesEvaluation = new HashSet<>(Arrays.asList("cc", "tz", CLTAP_CARRIER));
