...
/* JADX INFO: compiled from: NotificationBitmapDownloadRequestHandler.kt */
...
public final class NotificationBitmapDownloadRequestHandler implements IBitmapDownloadRequestHandler {
    ...
    public DownloadedBitmap handleRequest(BitmapDownloadRequest bitmapDownloadRequest) {
        ...
        if (str == null || StringsKt.isBlank(str)) {
            ...
            Intrinsics.checkNotNullExpressionValue(downloadedBitmapPostFallbackIconCheck, "getDownloadedBitmapPostFallbackIconCheck(...)");
        ...
        Intrinsics.checkNotNullExpressionValue(downloadedBitmapPostFallbackIconCheck2, "getDownloadedBitmapPostFallbackIconCheck(...)");
