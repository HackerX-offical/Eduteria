...
public class CleverTapDisplayUnit implements Parcelable {
    ...
    public static CleverTapDisplayUnit toDisplayUnit(JSONObject jSONObject) {
        try {
            ...
            Logger.d(Constants.FEATURE_DISPLAY_UNIT, "Unable to init CleverTapDisplayUnit with JSON - " + e2.getLocalizedMessage());
    ...
    public JSONObject getWZRKFields() {
        try {
            ...
            Logger.d(Constants.FEATURE_DISPLAY_UNIT, "Error in getting WiZRK fields " + e2.getLocalizedMessage());
            return null;
        }
    }
    ...
    public String toString() {
        try {
            ...
            if (arrayList != null && !arrayList.isEmpty()) {
                for (int i = 0; i < this.contents.size(); i++) {
                    ...
                    if (cleverTapDisplayUnitContent != null) {
                        sb.append(", Content Item:").append(i).append(" ").append(cleverTapDisplayUnitContent.toString());
                        sb.append("\n");
                    }
                }
            }
            ...
            Logger.d(Constants.FEATURE_DISPLAY_UNIT, "Exception in toString:" + e2);
    ...
    HashMap<String, String> getKeyValues(JSONObject jSONObject) {
        if (jSONObject != null) {
            try {
                Iterator<String> itKeys = jSONObject.keys();
                if (itKeys != null) {
                ...
                Logger.d(Constants.FEATURE_DISPLAY_UNIT, "Error in getting Key Value Pairs " + e2.getLocalizedMessage());
            }
        }
        return null;
    }
