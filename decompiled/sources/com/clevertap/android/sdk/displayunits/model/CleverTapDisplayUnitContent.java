...
public class CleverTapDisplayUnitContent implements Parcelable {
    ...
    public boolean mediaIsImage() {
        String str = this.contentType;
        return (str == null || this.media == null || !str.startsWith("image") || this.contentType.equals("image/gif")) ? false : true;
    }
    ...
    static CleverTapDisplayUnitContent toContent(JSONObject jSONObject) {
        String string;
        String string2;
        String string3;
        String string4;
        ...
        try {
            ...
            Logger.d(Constants.FEATURE_DISPLAY_UNIT, "Unable to init CleverTapDisplayUnitContent with JSON - " + e2.getLocalizedMessage());
