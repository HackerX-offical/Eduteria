...
public class EventQueueManager extends BaseEventQueueManager implements FailureFlushListener {
    ...
    @Override // com.clevertap.android.sdk.events.BaseEventQueueManager
    public void flushQueueSync(Context context, EventGroup eventGroup, String str) throws JSONException {
        flushQueueSync(context, eventGroup, str, false);
    }

    @Override // com.clevertap.android.sdk.events.BaseEventQueueManager
    public void flushQueueSync(final Context context, final EventGroup eventGroup, final String str, final boolean z) throws JSONException {
        if (!NetworkManager.isNetworkOnline(context)) {
            ...
            this.networkManager.initHandshake(eventGroup, new Runnable() { // from class: com.clevertap.android.sdk.events.EventQueueManager$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() throws JSONException {
                    this.f$0.m11886x351d92e3(context, eventGroup, str, z);
                }
            });
        } else {
            this.logger.verbose(this.config.getAccountId(), "Pushing Notification Viewed event onto queue DB flush");
            this.networkManager.flushDBQueue(context, eventGroup, str, z);
        }
    }

    /* JADX INFO: renamed from: lambda$flushQueueSync$0$com-clevertap-android-sdk-events-EventQueueManager, reason: not valid java name */
    /* synthetic */ void m11886x351d92e3(Context context, EventGroup eventGroup, String str, boolean z) throws JSONException {
        this.networkManager.flushDBQueue(context, eventGroup, str, z);
    }
    ...
    public void sendImmediately(final Context context, final EventGroup eventGroup, JSONObject jSONObject) throws JSONException {
        ...
        if (this.networkManager.needsHandshakeForDomain(eventGroup)) {
            this.networkManager.initHandshake(eventGroup, new Runnable() { // from class: com.clevertap.android.sdk.events.EventQueueManager$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() throws JSONException {
                    this.f$0.m11887xb7b7676e(context, eventGroup, jSONArrayPut);
                }
            });
        } else {
            this.networkManager.sendQueue(context, eventGroup, jSONArrayPut, null, false);
        }
    }

    /* JADX INFO: renamed from: lambda$sendImmediately$1$com-clevertap-android-sdk-events-EventQueueManager, reason: not valid java name */
    /* synthetic */ void m11887xb7b7676e(Context context, EventGroup eventGroup, JSONArray jSONArray) throws JSONException {
    ...
    public void processEvent(Context context, JSONObject jSONObject, int i) {
        ...
        synchronized (this.ctLockManager.getEventLock()) {
            try {
                ...
                jSONObject.put(CmcdData.Factory.STREAMING_FORMAT_SS, this.cleverTapMetaData.getCurrentSessionId());
                    ...
                    if (jSONObject2 != null) {
                        ...
                        if (repo.hasIdentity(next) && !this.deviceInfo.isErrorDeviceId()) {
                            if (z) {
                                ...
                                this.loginInfoProvider.cacheGUIDForIdentifier(cleverTapID, next, jSONObject2.toString());
                            }
                        }
                    }
                }
    ...
    /* JADX INFO: renamed from: com.clevertap.android.sdk.events.EventQueueManager$3, reason: invalid class name */
    class AnonymousClass3 implements Callable<Void> {
        ...
        AnonymousClass3(JSONObject jSONObject, int i, Context context) {
        ...
        public Void call() throws JSONException {
            ...
            if (EventQueueManager.this.eventMediator.shouldDeferProcessingEvent(this.val$event, this.val$eventType)) {
                ...
                mainLooperHandler.postDelayed(new Runnable() { // from class: com.clevertap.android.sdk.events.EventQueueManager$3$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m11888x8be2abfc(context, jSONObject, i);
                    }
                }, 2000L);
            } else {
        ...
        /* JADX INFO: renamed from: lambda$call$0$com-clevertap-android-sdk-events-EventQueueManager$3, reason: not valid java name */
        /* synthetic */ void m11888x8be2abfc(final Context context, final JSONObject jSONObject, final int i) {
    ...
    public Future<?> queueEvent(Context context, JSONObject jSONObject, int i) {
        return CTExecutorFactory.executors(this.config).postAsyncSafelyTask().submit("queueEvent", new AnonymousClass3(jSONObject, i, context));
    }
