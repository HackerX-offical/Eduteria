...
/* JADX INFO: compiled from: PushPermissionTemplate.kt */
...
public final class PushPermissionTemplate {
    ...
    public final CustomTemplate createTemplate(final InAppActionHandler systemActionHandler) {
        ...
        return CustomTemplatesExtKt.function(true, new Function1() { // from class: com.clevertap.android.sdk.inapp.customtemplates.system.PushPermissionTemplate$$ExternalSyntheticLambda0
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return PushPermissionTemplate.createTemplate$lambda$1(systemActionHandler, (CustomTemplate.FunctionBuilder) obj);
            }
        });
    }
    ...
    public static final Unit createTemplate$lambda$1(final InAppActionHandler systemActionHandler, CustomTemplate.FunctionBuilder function) {
        ...
        function.presenter(new FunctionPresenter() { // from class: com.clevertap.android.sdk.inapp.customtemplates.system.PushPermissionTemplate$$ExternalSyntheticLambda1
            ...
            public final void onPresent(CustomTemplateContext customTemplateContext) {
                PushPermissionTemplate.createTemplate$lambda$1$lambda$0(systemActionHandler, (CustomTemplateContext.FunctionContext) customTemplateContext);
            }
        });
    ...
    public static final void createTemplate$lambda$1$lambda$0(InAppActionHandler systemActionHandler, CustomTemplateContext.FunctionContext templateContext) {
        ...
        if (systemActionHandler.launchPushPermissionPrompt(Intrinsics.areEqual((Object) templateContext.getBoolean("fbSettings"), (Object) true))) {
