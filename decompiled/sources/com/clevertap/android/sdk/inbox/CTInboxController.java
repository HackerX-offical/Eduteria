...
public class CTInboxController {
    ...
    public ArrayList<CTMessageDAO> getUnreadMessages() {
        ...
        synchronized (this.messagesLock) {
            for (CTMessageDAO cTMessageDAO : getMessages()) {
                if (cTMessageDAO.isRead() == 0) {
    ...
    boolean _markReadForMessageWithId(final String str) {
        ...
        taskPostAsyncSafelyTask.addOnSuccessListener(new OnSuccessListener() { // from class: com.clevertap.android.sdk.inbox.CTInboxController$$ExternalSyntheticLambda0
            ...
            public final void onSuccess(Object obj) {
                this.f$0.m11928x2c9bbe28((Void) obj);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$_markReadForMessageWithId$0$com-clevertap-android-sdk-inbox-CTInboxController, reason: not valid java name */
    /* synthetic */ void m11928x2c9bbe28(Void r1) {
    ...
    boolean _markReadForMessagesWithIds(final ArrayList<String> arrayList) {
        ...
        taskPostAsyncSafelyTask.addOnSuccessListener(new OnSuccessListener() { // from class: com.clevertap.android.sdk.inbox.CTInboxController$$ExternalSyntheticLambda2
            @Override // com.clevertap.android.sdk.task.OnSuccessListener
            public final void onSuccess(Object obj) {
                this.f$0.m11929xb0fd8d68((Void) obj);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$_markReadForMessagesWithIds$2$com-clevertap-android-sdk-inbox-CTInboxController, reason: not valid java name */
    /* synthetic */ void m11929xb0fd8d68(Void r1) {
        this.callbackManager._notifyInboxMessagesDidUpdate();
    }

    private CTMessageDAO findMessageById(String str) {
        synchronized (this.messagesLock) {
            for (CTMessageDAO cTMessageDAO : this.messages) {
    ...
    private void trimMessages() {
        ...
        synchronized (this.messagesLock) {
            for (CTMessageDAO cTMessageDAO : this.messages) {
                if (!this.videoSupported && cTMessageDAO.containsVideoOrAudio()) {
            ...
            while (it.hasNext()) {
                _deleteMessageWithId(((CTMessageDAO) it.next()).getId());
            }
        }
    }
}
