...
public class LoginController {
    ...
    public void _onUserLogin(Map<String, Object> map, String str) {
        ...
        try {
            ...
            for (String str2 : map.keySet()) {
                ...
                if (repo.hasIdentity(str2)) {
                    ...
                    if (string != null && !string.isEmpty()) {
                        z = true;
                        String gUIDForIdentifier = this.loginInfoProvider.getGUIDForIdentifier(str2, string);
            ...
            if (!this.deviceInfo.isErrorDeviceId() && (!z || this.loginInfoProvider.isAnonymousDevice())) {
