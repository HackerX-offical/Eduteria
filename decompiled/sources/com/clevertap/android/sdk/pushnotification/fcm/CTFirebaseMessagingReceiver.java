...
public class CTFirebaseMessagingReceiver extends BroadcastReceiver implements NotificationRenderedListener {
            ...
            if (Utils.isRenderFallback(remoteMessage, context)) {
                ...
                new Thread(new Runnable() { // from class: com.clevertap.android.sdk.pushnotification.fcm.CTFirebaseMessagingReceiver$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m11935x804ce635(context, bundle);
                    }
                }).start();
                return;
            }
    ...
    /* JADX INFO: renamed from: lambda$onReceive$0$com-clevertap-android-sdk-pushnotification-fcm-CTFirebaseMessagingReceiver, reason: not valid java name */
    /* synthetic */ void m11935x804ce635(Context context, Bundle bundle) {
        try {
            ...
            e2.printStackTrace();
            Logger.v(TAG, "Failed executing CTRM flushQueueSync thread.", e2);
        } finally {
