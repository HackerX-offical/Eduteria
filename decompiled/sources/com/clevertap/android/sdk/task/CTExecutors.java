...
public class CTExecutors {
    ...
    CTExecutors(CleverTapInstanceConfig cleverTapInstanceConfig) {
        ...
        this.CURRENT_THREAD_EXECUTOR = new DashDownloader$$ExternalSyntheticLambda0();
    ...
    public <TResult> Task<TResult> postAsyncSafelyTask() {
        ...
        if (cleverTapInstanceConfig != null) {
            accountId = cleverTapInstanceConfig.getAccountId();
        } else {
            accountId = this.singleThreadExecutorTag;
        }
        return postAsyncSafelyTask(accountId);
    }
