...
/* JADX INFO: compiled from: UserEventLog.kt */
...
public final /* data */ class UserEventLog {
    ...
    public static /* synthetic */ UserEventLog copy$default(UserEventLog userEventLog, String str, String str2, long j, long j2, int i, String str3, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        if ((i2 & 4) != 0) {
            j = userEventLog.firstTs;
        }
        if ((i2 & 8) != 0) {
            j2 = userEventLog.lastTs;
        }
        if ((i2 & 16) != 0) {
            i = userEventLog.countOfEvents;
        }
        if ((i2 & 32) != 0) {
        ...
        long j3 = j2;
        long j4 = j;
        return userEventLog.copy(str, str2, j4, j3, i, str3);
    }
