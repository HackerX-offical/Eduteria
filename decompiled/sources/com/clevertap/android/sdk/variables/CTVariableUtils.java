...
public final class CTVariableUtils {
    ...
    public static Map<String, Object> convertFlatMapToNestedMaps(Map<String, Object> map) {
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            if (key.contains(InstructionFileId.DOT)) {
    ...
    static void convertNestedMapsToFlatMap(String str, Map<String, Object> map, Map<String, Object> map2) {
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            if (value instanceof Map) {
                convertNestedMapsToFlatMap(str + key + InstructionFileId.DOT, (Map) JsonUtil.uncheckedCast(value), map2);
            } else {
                ...
                if (obj instanceof Map) {
                    ...
                    for (Map.Entry entry : map4.entrySet()) {
                        ...
                        if ("file".equals(map2.get(str3))) {
                            strKindFromValue = "file";
                        } else {
                            strKindFromValue = kindFromValue(value);
                        }
