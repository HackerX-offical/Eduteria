...
public class CTVariables {
    ...
    public CTVariables(VarCache varCache) {
        ...
        varCache.setGlobalCallbacksRunnable(new Runnable() { // from class: com.clevertap.android.sdk.variables.CTVariables$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m11944lambda$new$0$comclevertapandroidsdkvariablesCTVariables();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$com-clevertap-android-sdk-variables-CTVariables, reason: not valid java name */
    /* synthetic */ void m11944lambda$new$0$comclevertapandroidsdkvariablesCTVariables() {
    ...
    public void init() {
        logD("init() called");
        this.varCache.loadDiffs(new Function0() { // from class: com.clevertap.android.sdk.variables.CTVariables$$ExternalSyntheticLambda3
    ...
    public void handleVariableResponseError(FetchVariablesCallback fetchVariablesCallback) {
        if (!hasVarsRequestCompleted().booleanValue()) {
            ...
            this.varCache.loadDiffsAndTriggerHandlers(new Function0() { // from class: com.clevertap.android.sdk.variables.CTVariables$$ExternalSyntheticLambda2
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return this.f$0.m11942xa448b5d2();
                }
            });
        }
    ...
    /* JADX INFO: renamed from: lambda$handleVariableResponseError$2$com-clevertap-android-sdk-variables-CTVariables, reason: not valid java name */
    /* synthetic */ Unit m11942xa448b5d2() {
    ...
    private void handleVariableResponseSuccess(JSONObject jSONObject, FetchVariablesCallback fetchVariablesCallback) {
        setHasVarsRequestCompleted(true);
        this.varCache.updateDiffsAndTriggerHandlers(CTVariableUtils.convertFlatMapToNestedMaps(JsonUtil.mapFromJson(jSONObject)), new Function0() { // from class: com.clevertap.android.sdk.variables.CTVariables$$ExternalSyntheticLambda1
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return this.f$0.m11943xdd83e18e();
            }
        });
        if (fetchVariablesCallback != null) {
    ...
    /* JADX INFO: renamed from: lambda$handleVariableResponseSuccess$3$com-clevertap-android-sdk-variables-CTVariables, reason: not valid java name */
    /* synthetic */ Unit m11943xdd83e18e() {
        triggerGlobalFilesCallbacks();
        this.preRegisteredFilesDownloaded = true;
        return null;
    }
