    ...
    public final Bundle load() {
        ...
        for (String key : this.cache.getAll().keySet()) {
            try {
                ...
                companion.log(loggingBehavior, 5, TAG2, "Error reading cached value for key: '" + key + "' -- " + e2);
                return null;
            }
        }
        return bundle;
    ...
    public final void save(Bundle bundle) {
        ...
        for (String key : bundle.keySet()) {
            try {
                ...
                String TAG2 = TAG;
                Intrinsics.checkNotNullExpressionValue(TAG2, "TAG");
                companion.log(loggingBehavior, 5, TAG2, "Error processing value for key: '" + key + "' -- " + e2);
                return;
            }
        }
        editor.apply();
