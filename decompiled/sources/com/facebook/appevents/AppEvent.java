...
public final class AppEvent implements Serializable {
    ...
    public /* synthetic */ AppEvent(String str, String str2, Double d2, Bundle bundle, boolean z, boolean z2, UUID uuid, OperationalData operationalData, int i, DefaultConstructorMarker defaultConstructorMarker) throws JSONException, FacebookException {
        this(str, str2, d2, bundle, z, z2, uuid, (i & 128) != 0 ? null : operationalData);
    }

    public AppEvent(String contextName, String eventName, Double d2, Bundle bundle, boolean z, boolean z2, UUID uuid, OperationalData operationalData) throws JSONException, FacebookException {
        JSONObject json;
