...
public final class AppEventsLoggerImpl {
    ...
    public static /* synthetic */ void logEvent$default(AppEventsLoggerImpl appEventsLoggerImpl, String str, Double d2, Bundle bundle, boolean z, UUID uuid, OperationalData operationalData, int i, Object obj) {
        if (CrashShieldHandler.isObjectCrashing(AppEventsLoggerImpl.class)) {
            return;
        }
        if ((i & 32) != 0) {
        ...
        try {
            appEventsLoggerImpl.logEvent(str, d2, bundle, z, uuid, operationalData);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, AppEventsLoggerImpl.class);
        }
    }
    ...
    */
    ...
    public static final class Companion {
        ...
        public final Pair<Bundle, OperationalData> addImplicitPurchaseParameters(Bundle params, OperationalData operationalData, boolean isImplicitlyLogged) {
            Pair<Bundle, OperationalData> pairAddParameterAndReturn = OperationalData.INSTANCE.addParameterAndReturn(OperationalDataEnum.IAPParameters, Constants.EVENT_PARAM_IS_IMPLICIT_PURCHASE_LOGGING_ENABLED, AutomaticAnalyticsLogger.isImplicitPurchaseLoggingEnabled() ? "1" : "0", params, operationalData);
            ...
            Pair<Bundle, OperationalData> pairAddParameterAndReturn3 = OperationalData.INSTANCE.addParameterAndReturn(OperationalDataEnum.IAPParameters, Constants.EVENT_PARAM_IS_AUTOLOG_APP_EVENTS_ENABLED, UserSettingsManager.getAutoLogAppEventsEnabled() ? "1" : "0", pairAddParameterAndReturn.getFirst(), pairAddParameterAndReturn.getSecond());
        ...
        public final void augmentWebView(WebView webView, Context context) {
            ...
            String[] strArr = (String[]) StringsKt.split$default((CharSequence) RELEASE, new String[]{InstructionFileId.DOT}, false, 0, 6, (Object) null).toArray(new String[0]);
