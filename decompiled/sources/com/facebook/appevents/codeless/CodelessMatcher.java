                ...
                if (view != null) {
                        ...
                        if (Intrinsics.areEqual(pathComponent.getClassName(), CodelessMatcher.PARENT_CLASS_NAME)) {
                            ...
                            if (parent instanceof ViewGroup) {
                                ...
                                while (i < size) {
                                    ...
                                    arrayList.addAll(findViewByPath(eventBinding2, listFindVisibleChildren.get(i), list2, level + 1, i, str));
                                    i++;
                    ...
                    if (view instanceof ViewGroup) {
                        ...
                        while (i2 < size2) {
                            ...
                            arrayList.addAll(companion.findViewByPath(eventBinding3, listFindVisibleChildren2.get(i2), list, level + 1, i2, str));
                            i2++;
                            companion = this;
