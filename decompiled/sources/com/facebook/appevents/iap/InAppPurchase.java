...
/* JADX INFO: compiled from: InAppPurchase.kt */
...
public final /* data */ class InAppPurchase {
    ...
    public static /* synthetic */ InAppPurchase copy$default(InAppPurchase inAppPurchase, String str, double d2, Currency currency, int i, Object obj) {
        if ((i & 1) != 0) {
            str = inAppPurchase.eventName;
        }
        if ((i & 2) != 0) {
            d2 = inAppPurchase.amount;
        }
        if ((i & 4) != 0) {
            currency = inAppPurchase.currency;
        }
        return inAppPurchase.copy(str, d2, currency);
    }
