            ...
            for (String key : dedupeParameters.keySet()) {
                try {
                    ...
                    if (string != null) {
                        ...
                        Pair<Bundle, OperationalData> pairAddParameterAndReturn = companion.addParameterAndReturn(operationalDataEnum, key, string, bundle, operationalDataComponent2);
