    ...
    private final InAppPurchaseUtils.BillingClientVersion getBillingClientVersion() {
        try {
            ...
            try {
                ...
                List listSplit$default = StringsKt.split$default((CharSequence) string, new String[]{InstructionFileId.DOT}, false, 3, 2, (Object) null);
                if (string.length() == 0) {
