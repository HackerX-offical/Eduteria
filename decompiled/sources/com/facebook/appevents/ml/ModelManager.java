...
public final class ModelManager {
    ...
    private final JSONObject fetchModels() {
        ...
        try {
            ...
            bundle.putString("fields", TextUtils.join(Constants.SEPARATOR_COMMA, strArr));
    ...
    private final boolean isLocaleEnglish() {
        ...
        try {
            ...
            return StringsKt.contains$default((CharSequence) language, (CharSequence) Const.ENGLISH, false, 2, (Object) null);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, this);
            return false;
        }
