...
public final class FacebookInitProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        try {
            ...
            Log.i(TAG, "Failed to auto initialize the Facebook SDK", e2);
            return false;
        }
    }
}
