...
public final class Utility {
    ...
    @JvmStatic
    public static final boolean isNullOrEmpty(Collection<?> c2) {
    ...
    @JvmStatic
    public static final void putNonEmptyString(Bundle b2, String key, String value) {
    ...
    @JvmStatic
    public static final void putCommaSeparatedStringList(Bundle b2, String key, List<String> list) {
        Intrinsics.checkNotNullParameter(b2, "b");
        if (list != null) {
            b2.putString(key, TextUtils.join(Constants.SEPARATOR_COMMA, list));
        }
    }

    @JvmStatic
    public static final void putUri(Bundle b2, String key, Uri uri) {
        Intrinsics.checkNotNullParameter(b2, "b");
        if (uri != null) {
            putNonEmptyString(b2, key, uri.toString());
        }
    }
    ...
    @JvmStatic
    public static final boolean stringsEqualOrEmpty(String a2, String b2) {
        String str = a2;
    ...
    @JvmStatic
    public static final <T> boolean areObjectsEqual(T a2, T b2) {
        if (a2 == null) {
            return b2 == null;
        }
        return Intrinsics.areEqual(a2, b2);
    ...
    public static final void setAppEventAttributionParameters(JSONObject params, AttributionIdentifiers attributionIdentifiers, String anonymousAppDeviceGUID, boolean limitEventUsage, Context context) throws JSONException {
        ...
        String info2 = companion != null ? companion.getInfo(AppLinkManager.CAMPAIGN_IDS_KEY) : null;
        if (info2 != null) {
            params.put(AppLinkManager.CAMPAIGN_IDS_KEY, info2);
        }
    }
    ...
    public static final boolean isWebUri(Uri uri) {
        if (uri != null) {
            return StringsKt.equals(HttpHost.DEFAULT_SCHEME_NAME, uri.getScheme(), true) || StringsKt.equals("https", uri.getScheme(), true) || StringsKt.equals("fbstaging", uri.getScheme(), true);
        }
        return false;
    }
    ...
    public static final String getGraphDomainFromTokenDomain(String tokenGraphDomain) {
        ...
        if (tokenGraphDomain != null) {
            ...
            if (Intrinsics.areEqual(tokenGraphDomain, FacebookSdk.INSTAGRAM)) {
                return StringsKt.replace$default(facebookDomain, "facebook.com", FacebookSdk.INSTAGRAM_COM, false, 4, (Object) null);
            }
        }
