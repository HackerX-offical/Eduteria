...
public final class CrashShieldHandler {
    ...
    @JvmStatic
    public static final void handleThrowable(Throwable e2, Object o) {
        Intrinsics.checkNotNullParameter(o, "o");
        if (enabled) {
            crashingObjects.add(o);
            if (FacebookSdk.getAutoLogAppEventsEnabled()) {
                ExceptionAnalyzer.execute(e2);
                InstrumentData.Builder.build(e2, InstrumentData.Type.CrashShield).save();
            }
            scheduleCrashInDebug(e2);
        }
    }
    ...
    @JvmStatic
    public static final void scheduleCrashInDebug(final Throwable e2) {
        if (isDebug()) {
