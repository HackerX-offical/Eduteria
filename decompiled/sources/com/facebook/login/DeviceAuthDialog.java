...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public void startLogin(LoginClient.Request request) {
        ...
        bundle.putString("scope", TextUtils.join(Constants.SEPARATOR_COMMA, request.getPermissions()));
        ...
        bundle.putString("device_info", DeviceRequestsHelper.getDeviceInfo(mapAdditionalDeviceInfo != null ? MapsKt.toMutableMap(mapAdditionalDeviceInfo) : null));
    ...
    private final void onSuccess(final String accessToken, long expiresIn, Long dataAccessExpirationTime) {
        ...
        GraphRequest graphRequestNewGraphPathRequest = GraphRequest.INSTANCE.newGraphPathRequest(new AccessToken(accessToken, FacebookSdk.getApplicationId(), "0", null, null, null, null, date2, null, date3, null, 1024, null), TournamentShareDialogURIBuilder.me, new GraphRequest.Callback() { // from class: com.facebook.login.DeviceAuthDialog$$ExternalSyntheticLambda3
            @Override // com.facebook.GraphRequest.Callback
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.onSuccess$lambda$10(this.f$0, accessToken, date4, date3, graphResponse);
            }
        });
