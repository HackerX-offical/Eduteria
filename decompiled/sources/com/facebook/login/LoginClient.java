...
public class LoginClient implements Parcelable {
    ...
    private final void addLoggingExtra(String key, String value, boolean accumulate) {
        ...
        if (map.containsKey(key) && accumulate) {
            value = map.get(key) + CsvReader.Letters.COMMA + value;
        }
        map.put(key, value);
    }
    ...
    */
    public final void validateSameFbidAndFinish(com.facebook.login.LoginClient.Result r8) {
        /*
            ...
            boolean r0 = kotlin.jvm.internal.Intrinsics.areEqual(r0, r1)     // Catch: java.lang.Exception -> L41
            if (r0 == 0) goto L2e
    ...
    public static final class Result implements Parcelable {
        ...
        public enum Code {
            SUCCESS("success"),
            CANCEL(VideoDownloadService.CANCEL),
            ERROR("error");
