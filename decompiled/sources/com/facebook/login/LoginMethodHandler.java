    ...
    public static final class Companion {
        ...
        */
        ...
        public final String getUserIDFromSignedRequest(String signedRequest) throws FacebookException {
            ...
            try {
                String[] strArr = (String[]) StringsKt.split$default((CharSequence) signedRequest, new String[]{InstructionFileId.DOT}, false, 0, 6, (Object) null).toArray(new String[0]);
                if (strArr.length == 2) {
