...
public final class MessengerUtils {
    ...
    private final List<String> parseParticipants(String s) {
        ...
        String[] strArr = (String[]) StringsKt.split$default((CharSequence) str, new String[]{Constants.SEPARATOR_COMMA}, false, 0, 6, (Object) null).toArray(new String[0]);
