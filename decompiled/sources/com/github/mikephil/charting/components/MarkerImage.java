...
public class MarkerImage implements IMarker {
    ...
    public MPPointF getOffsetForDrawingAtPoint(float f2, float f3) {
        ...
        if (this.mOffset2.x + f2 < 0.0f) {
            this.mOffset2.x = -f2;
        } else if (chartView != null && f2 + intrinsicWidth + this.mOffset2.x > chartView.getWidth()) {
            this.mOffset2.x = (chartView.getWidth() - f2) - intrinsicWidth;
        }
        if (this.mOffset2.y + f3 < 0.0f) {
            this.mOffset2.y = -f3;
        } else if (chartView != null && f3 + intrinsicHeight + this.mOffset2.y > chartView.getHeight()) {
            this.mOffset2.y = (chartView.getHeight() - f3) - intrinsicHeight;
        }
