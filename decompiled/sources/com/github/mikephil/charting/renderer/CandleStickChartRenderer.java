            ...
            while (i < dataSets.size()) {
                ...
                if (candleStickChartRenderer.shouldDrawValues(iCandleDataSet) && iCandleDataSet.getEntryCount() >= 1) {
                    ...
                    while (i2 < fArrGenerateTransformedValuesCandle.length) {
                        ...
                        if (!candleStickChartRenderer.mViewPortHandler.isInBoundsRight(f2)) {
                            break;
                        }
                        if (candleStickChartRenderer.mViewPortHandler.isInBoundsLeft(f2) && candleStickChartRenderer.mViewPortHandler.isInBoundsY(f3)) {
                            int i3 = i2 / 2;
                            ...
                            if (iCandleDataSet.isDrawValuesEnabled()) {
                                ...
                                candleStickChartRenderer.drawValue(canvas, valueFormatter.getCandleLabel(candleEntry2), f2, f3 - fConvertDpToPixel, iCandleDataSet.getValueTextColor(i3));
                            } else {
                                candleEntry = candleEntry2;
                            }
