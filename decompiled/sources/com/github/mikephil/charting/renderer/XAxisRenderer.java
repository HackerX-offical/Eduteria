...
public class XAxisRenderer extends AxisRenderer {
    ...
    public void renderAxisLine(Canvas canvas) {
        ...
        if (this.mXAxis.isDrawAxisLineEnabled() && this.mXAxis.isEnabled()) {
            ...
            if (this.mXAxis.getPosition() == XAxis.XAxisPosition.TOP || this.mXAxis.getPosition() == XAxis.XAxisPosition.TOP_INSIDE || this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTH_SIDED) {
                canvas2 = canvas;
                canvas2.drawLine(this.mViewPortHandler.contentLeft(), this.mViewPortHandler.contentTop(), this.mViewPortHandler.contentRight(), this.mViewPortHandler.contentTop(), this.mAxisLinePaint);
            } else {
                canvas2 = canvas;
            }
            if (this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTTOM || this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTTOM_INSIDE || this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTH_SIDED) {
                canvas2.drawLine(this.mViewPortHandler.contentLeft(), this.mViewPortHandler.contentBottom(), this.mViewPortHandler.contentRight(), this.mViewPortHandler.contentBottom(), this.mAxisLinePaint);
            }
        }
    }
    ...
    protected void drawLabels(Canvas canvas, float f2, MPPointF mPPointF) {
        ...
        while (i3 < i) {
            ...
            if (this.mViewPortHandler.isInBoundsX(fCalcTextWidth)) {
                ...
                f3 = f2;
                mPPointF2 = mPPointF;
                drawLabel(canvas2, axisLabel, fCalcTextWidth, f3, mPPointF2, labelRotationAngle);
            } else {
                canvas2 = canvas;
                f3 = f2;
                mPPointF2 = mPPointF;
    ...
    public void renderLimitLineLabel(Canvas canvas, LimitLine limitLine, float[] fArr, float f2) {
        ...
        if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_TOP) {
            ...
            canvas.drawText(label, fArr[0] + lineWidth, this.mViewPortHandler.contentTop() + f2 + fCalcTextHeight, this.mLimitLinePaint);
            ...
            canvas.drawText(label, fArr[0] - lineWidth, this.mViewPortHandler.contentTop() + f2 + Utils.calcTextHeight(this.mLimitLinePaint, label), this.mLimitLinePaint);
        } else {
            this.mLimitLinePaint.setTextAlign(Paint.Align.RIGHT);
            canvas.drawText(label, fArr[0] - lineWidth, this.mViewPortHandler.contentBottom() - f2, this.mLimitLinePaint);
        }
