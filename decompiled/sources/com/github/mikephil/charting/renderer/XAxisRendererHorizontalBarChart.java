...
public class XAxisRendererHorizontalBarChart extends XAxisRenderer {
    ...
    protected void drawLabels(Canvas canvas, float f2, MPPointF mPPointF) {
        ...
        while (i3 < i) {
            float f4 = fArr[i3 + 1];
            if (this.mViewPortHandler.isInBoundsY(f4)) {
                canvas2 = canvas;
                f3 = f2;
                mPPointF2 = mPPointF;
                drawLabel(canvas2, this.mXAxis.getValueFormatter().getAxisLabel(this.mXAxis.mEntries[i3 / 2], this.mXAxis), f3, f4, mPPointF2, labelRotationAngle);
            } else {
                canvas2 = canvas;
                f3 = f2;
                mPPointF2 = mPPointF;
    ...
    public void renderAxisLine(Canvas canvas) {
        ...
        if (this.mXAxis.isDrawAxisLineEnabled() && this.mXAxis.isEnabled()) {
            ...
            if (this.mXAxis.getPosition() == XAxis.XAxisPosition.TOP || this.mXAxis.getPosition() == XAxis.XAxisPosition.TOP_INSIDE || this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTH_SIDED) {
                canvas2 = canvas;
                canvas2.drawLine(this.mViewPortHandler.contentRight(), this.mViewPortHandler.contentTop(), this.mViewPortHandler.contentRight(), this.mViewPortHandler.contentBottom(), this.mAxisLinePaint);
            } else {
                canvas2 = canvas;
            }
            if (this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTTOM || this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTTOM_INSIDE || this.mXAxis.getPosition() == XAxis.XAxisPosition.BOTH_SIDED) {
                canvas2.drawLine(this.mViewPortHandler.contentLeft(), this.mViewPortHandler.contentTop(), this.mViewPortHandler.contentLeft(), this.mViewPortHandler.contentBottom(), this.mAxisLinePaint);
            }
        }
    }
