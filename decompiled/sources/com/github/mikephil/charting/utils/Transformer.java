...
public class Transformer {
    ...
    public float[] generateTransformedValuesScatter(IScatterDataSet iScatterDataSet, float f2, float f3, int i, int i2) {
    ...
    public float[] generateTransformedValuesBubble(IBubbleDataSet iBubbleDataSet, float f2, int i, int i2) {
        int i3 = ((i2 - i) + 1) * 2;
    ...
    /* JADX WARN: Type inference failed for: r1v2, types: [com.github.mikephil.charting.data.Entry] */
    public float[] generateTransformedValuesLine(ILineDataSet iLineDataSet, float f2, float f3, int i, int i2) {
    ...
    public float[] generateTransformedValuesCandle(ICandleDataSet iCandleDataSet, float f2, float f3, int i, int i2) {
        int i3 = ((int) (((i2 - i) * f2) + 1.0f)) * 2;
