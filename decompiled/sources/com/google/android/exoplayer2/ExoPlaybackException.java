...
public final class ExoPlaybackException extends PlaybackException {
    public static final Bundleable.Creator<ExoPlaybackException> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.ExoPlaybackException$$ExternalSyntheticLambda0
        ...
        public final Bundleable fromBundle(Bundle bundle) {
            return ExoPlaybackException.m12057$r8$lambda$1XKy3W7SelM_FKalWARGECf72M(bundle);
        }
    };
    ...
    public static /* synthetic */ ExoPlaybackException m12057$r8$lambda$1XKy3W7SelM_FKalWARGECf72M(Bundle bundle) {
    ...
    private static String deriveMessage(int i, String str, String str2, int i2, Format format, int i3) {
        ...
        if (i == 0) {
            ...
            string = new StringBuilder(String.valueOf(str2).length() + 53 + String.valueOf(strValueOf).length() + String.valueOf(formatSupportString).length()).append(str2).append(" error, index=").append(i2).append(", format=").append(strValueOf).append(", format_supported=").append(formatSupportString).toString();
        } else if (i == 3) {
            string = "Remote error";
        } else {
        ...
        return new StringBuilder(String.valueOf(strValueOf2).length() + 2 + String.valueOf(str).length()).append(strValueOf2).append(": ").append(str).toString();
    }
