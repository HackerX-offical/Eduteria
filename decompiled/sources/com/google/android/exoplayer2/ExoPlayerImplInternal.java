...
final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSourceList.MediaSourceListInfoRefreshListener, DefaultMediaClock.PlaybackParametersListener, PlayerMessage.Sender {
    ...
    public synchronized boolean release() {
        if (!this.released && this.internalPlaybackThread.isAlive()) {
            ...
            waitUninterruptibly(new Supplier() { // from class: com.google.android.exoplayer2.ExoPlayerImplInternal$$ExternalSyntheticLambda1
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m12064x37739a9a();
                }
    ...
    /* synthetic */ Boolean m12064x37739a9a() {
    ...
    public boolean handleMessage(Message message) throws Throwable {
        ...
        try {
            ...
            if (e.type == 1 && (readingPeriod = this.queue.getReadingPeriod()) != null) {
                e = e.copyWithMediaPeriodId(readingPeriod.f596info.id);
            }
    ...
    private void handleIoException(IOException iOException, int i) {
        ...
        if (playingPeriod != null) {
            exoPlaybackExceptionCreateForSource = exoPlaybackExceptionCreateForSource.copyWithMediaPeriodId(playingPeriod.f596info.id);
        }
    ...
    private void seekToCurrentPosition(boolean z) throws ExoPlaybackException {
        MediaSource.MediaPeriodId mediaPeriodId = this.queue.getPlayingPeriod().f596info.id;
    ...
    */
     ...
     */
    /* JADX WARN: Removed duplicated region for block: B:24:0x00a1 A[Catch: all -> 0x015d, TryCatch #6 {all -> 0x015d, blocks: (B:22:0x0097, B:24:0x00a1, B:27:0x00a7, B:29:0x00ad, B:30:0x00b0, B:33:0x00b8, B:37:0x00ca, B:41:0x00d2), top: B:105:0x0097 }] */
    ...
    */
    ...
    private long seekToPeriodPosition(MediaSource.MediaPeriodId mediaPeriodId, long j, boolean z, boolean z2) throws ExoPlaybackException {
        ...
        while (next != null && !mediaPeriodId.equals(next.f596info.id)) {
            next = next.getNext();
        }
        ...
        if (next != null) {
            this.queue.removeAfter(next);
            if (!next.prepared) {
                next.f596info = next.f596info.copyWithStartPositionUs(j);
        ...
        if (!looper.getThread().isAlive()) {
            ...
            this.clock.createHandler(looper, null).post(new Runnable() { // from class: com.google.android.exoplayer2.ExoPlayerImplInternal$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    this.f$0.m12065xacec0129(playerMessage);
                }
            });
        }
    }
    ...
    /* synthetic */ void m12065xacec0129(PlayerMessage playerMessage) {
        try {
            deliverMessage(playerMessage);
        } catch (ExoPlaybackException e2) {
    ...
    */
            ...
            if (trackSelectorResultSelectTracks.isEquivalent(playingPeriod.getTrackSelectorResult())) {
                ...
                if (z) {
                    ...
                    if (playingPeriod.prepared) {
                        playingPeriod.applyTrackSelection(trackSelectorResultSelectTracks, Math.max(playingPeriod.f596info.startPositionUs, playingPeriod.toPeriodTime(this.rendererPositionUs)), false);
                    }
                }
    ...
    private boolean shouldTransitionToReadyState(boolean z) {
        ...
        long targetLiveOffsetUs = shouldUseLivePlaybackSpeedControl(this.playbackInfo.timeline, this.queue.getPlayingPeriod().f596info.id) ? this.livePlaybackSpeedControl.getTargetLiveOffsetUs() : -9223372036854775807L;
        MediaPeriodHolder loadingPeriod = this.queue.getLoadingPeriod();
        return (loadingPeriod.isFullyBuffered() && loadingPeriod.f596info.isFinal) || (loadingPeriod.f596info.id.isAd() && !loadingPeriod.prepared) || this.loadControl.shouldStartPlayback(getTotalBufferedDurationUs(), this.mediaClock.getPlaybackParameters().speed, this.isRebuffering, targetLiveOffsetUs);
    }

    private boolean isTimelineReady() {
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        long j = playingPeriod.f596info.durationUs;
        if (playingPeriod.prepared) {
            ...
            try {
                if (z4) {
                    ...
                    if (!timeline3.isEmpty()) {
                        for (MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod(); playingPeriod != null; playingPeriod = playingPeriod.getNext()) {
                            if (playingPeriod.f596info.id.equals(mediaPeriodId2)) {
                                playingPeriod.f596info = this.queue.getUpdatedMediaPeriodInfo(timeline3, playingPeriod.f596info);
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    updatePlaybackSpeedSettingsForNewPeriod(timeline6, mediaPeriodId, this.playbackInfo.timeline, this.playbackInfo.periodId, positionUpdateForPlaylistChangeResolvePositionForPlaylistChange.setTargetLiveOffset ? jSeekToPeriodPosition : -9223372036854775807L);
                                    if (z4 || j != this.playbackInfo.requestedContentPositionUs) {
                                        ...
                                        this.playbackInfo = handlePositionDiscontinuity(mediaPeriodId, jSeekToPeriodPosition, j2, this.playbackInfo.discontinuityStartPositionUs, z2, timeline6.getIndexOfPeriod(obj) == i3 ? i : 3);
                                    }
                                    resetPendingPauseAtEndOfPeriod();
                ...
                updatePlaybackSpeedSettingsForNewPeriod(timeline3, mediaPeriodId2, this.playbackInfo.timeline, this.playbackInfo.periodId, positionUpdateForPlaylistChangeResolvePositionForPlaylistChange.setTargetLiveOffset ? jSeekToPeriodPosition : -9223372036854775807L);
    ...
    private void maybeUpdateReadingPeriod() {
        ...
        if (readingPeriod != null) {
            ...
            if (readingPeriod.getNext() == null || this.pendingPauseAtEndOfPeriod) {
                if (!readingPeriod.f596info.isFinal && !this.pendingPauseAtEndOfPeriod) {
                    return;
                }
                while (true) {
                    Renderer[] rendererArr = this.renderers;
                    ...
                    if (sampleStream != null && renderer.getStream() == sampleStream && renderer.hasReadStreamToEnd()) {
                        setCurrentStreamFinal(renderer, (readingPeriod.f596info.durationUs == -9223372036854775807L || readingPeriod.f596info.durationUs == Long.MIN_VALUE) ? -9223372036854775807L : readingPeriod.getRendererOffset() + readingPeriod.f596info.durationUs);
                    }
                    i++;
                }
                ...
                updatePlaybackSpeedSettingsForNewPeriod(this.playbackInfo.timeline, mediaPeriodHolderAdvanceReadingPeriod.f596info.id, this.playbackInfo.timeline, readingPeriod.f596info.id, -9223372036854775807L);
    ...
    private void maybeUpdatePlayingPeriod() throws ExoPlaybackException {
        ...
        while (shouldAdvancePlayingPeriod()) {
            ...
            this.playbackInfo = handlePositionDiscontinuity(mediaPeriodHolder.f596info.id, mediaPeriodHolder.f596info.startPositionUs, mediaPeriodHolder.f596info.requestedContentPositionUs, mediaPeriodHolder.f596info.startPositionUs, !(this.playbackInfo.periodId.periodUid.equals(mediaPeriodHolder.f596info.id.periodUid) && this.playbackInfo.periodId.adGroupIndex == -1 && mediaPeriodHolder.f596info.id.adGroupIndex == -1 && this.playbackInfo.periodId.nextAdGroupIndex != mediaPeriodHolder.f596info.id.nextAdGroupIndex), 0);
            resetPendingPauseAtEndOfPeriod();
            updatePlaybackPositions();
            z = true;
        }
    ...
    private void resetPendingPauseAtEndOfPeriod() {
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        this.pendingPauseAtEndOfPeriod = playingPeriod != null && playingPeriod.f596info.isLastInTimelineWindow && this.pauseAtEndOfWindow;
    }
    ...
    private boolean hasReachedServerSideInsertedAdsTransition(Renderer renderer, MediaPeriodHolder mediaPeriodHolder) {
        ...
        if (mediaPeriodHolder.f596info.isFollowedByTransitionToSameStream && next.prepared) {
    ...
    private void handlePeriodPrepared(MediaPeriod mediaPeriod) throws ExoPlaybackException {
        if (this.queue.isLoading(mediaPeriod)) {
            ...
            if (loadingPeriod == this.queue.getPlayingPeriod()) {
                resetRendererPosition(loadingPeriod.f596info.startPositionUs);
                enableRenderers();
                this.playbackInfo = handlePositionDiscontinuity(this.playbackInfo.periodId, loadingPeriod.f596info.startPositionUs, this.playbackInfo.requestedContentPositionUs, loadingPeriod.f596info.startPositionUs, false, 5);
            }
            maybeContinueLoading();
        }
    }
    ...
    private boolean shouldContinueLoading() {
        ...
        if (loadingPeriod == this.queue.getPlayingPeriod()) {
            ...
            periodTime = loadingPeriod.toPeriodTime(this.rendererPositionUs) - loadingPeriod.f596info.startPositionUs;
        }
    ...
    private PlaybackInfo handlePositionDiscontinuity(MediaSource.MediaPeriodId mediaPeriodId, long j, long j2, long j3, boolean z, int i) {
        ...
        if (this.mediaSourceList.isPrepared()) {
            ...
            if (playingPeriod != null && playingPeriod.f596info.requestedContentPositionUs != j2) {
                playingPeriod.f596info = playingPeriod.f596info.copyWithRequestedContentPositionUs(j2);
            }
            trackGroupArray = trackGroups;
            trackSelectorResult = trackSelectorResult2;
    ...
    private void handleLoadingMediaPeriodChanged(boolean z) {
        ...
        MediaPeriodHolder loadingPeriod = this.queue.getLoadingPeriod();
        MediaSource.MediaPeriodId mediaPeriodId = loadingPeriod == null ? this.playbackInfo.periodId : loadingPeriod.f596info.id;
    ...
    private static PositionUpdateForPlaylistChange resolvePositionForPlaylistChange(Timeline timeline, PlaybackInfo playbackInfo, SeekPosition seekPosition, MediaPeriodQueue mediaPeriodQueue, int i, boolean z, Timeline.Window window, Timeline.Period period) {
        ...
        boolean zIsIgnorableServerSideAdInsertionPeriodChange = isIgnorableServerSideAdInsertionPeriodChange(zIsUsingPlaceholderPeriod, mediaPeriodId, j4, mediaPeriodId2, timeline2.getPeriodByUid(obj, period2), j3);
        ...
        return new PositionUpdateForPlaylistChange(mediaPeriodId2, jLongValue, j3, z2, z3, z4);
    }
