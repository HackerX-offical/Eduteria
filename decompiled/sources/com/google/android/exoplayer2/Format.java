...
public final class Format implements Bundleable {
    ...
    public static String toLogString(Format format) {
        ...
        if (format.drmInitData != null) {
            ...
            sb.append(", drm=[");
            Joiner.on(CsvReader.Letters.COMMA).appendTo(sb, (Iterable<? extends Object>) linkedHashSet);
            sb.append(']');
        }
        ...
        if (format.selectionFlags != 0) {
            ...
            Joiner.on(CsvReader.Letters.COMMA).appendTo(sb, (Iterable<? extends Object>) arrayList);
        ...
        if (format.roleFlags != 0) {
            ...
            sb.append(", roleFlags=[");
            Joiner.on(CsvReader.Letters.COMMA).appendTo(sb, (Iterable<? extends Object>) arrayList2);
            sb.append(com.clevertap.android.sdk.Constants.AES_SUFFIX);
        }
        return sb.toString();
    }
    ...
    private static String keyForInitializationData(int i) {
        ...
        return new StringBuilder(String.valueOf(strKeyForField).length() + 1 + String.valueOf(string).length()).append(strKeyForField).append("_").append(string).toString();
    }
}
