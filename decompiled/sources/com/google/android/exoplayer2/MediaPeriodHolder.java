...
final class MediaPeriodHolder {
    ...
    public MediaPeriodInfo f596info;
    ...
    public long getStartPositionRendererTime() {
        return this.f596info.startPositionUs + this.rendererPositionOffsetUs;
    }
    ...
    public long getBufferedPositionUs() {
        if (!this.prepared) {
            return this.f596info.startPositionUs;
        }
        long bufferedPositionUs = this.hasEnabledTracks ? this.mediaPeriod.getBufferedPositionUs() : Long.MIN_VALUE;
        return bufferedPositionUs == Long.MIN_VALUE ? this.f596info.durationUs : bufferedPositionUs;
    }
    ...
    public void handlePrepared(float f2, Timeline timeline) throws ExoPlaybackException {
        ...
        long jMax = this.f596info.startPositionUs;
        if (this.f596info.durationUs != -9223372036854775807L && jMax >= this.f596info.durationUs) {
            jMax = Math.max(0L, this.f596info.durationUs - 1);
        }
        long jApplyTrackSelection = applyTrackSelection(trackSelectorResultSelectTracks, jMax, false);
        this.rendererPositionOffsetUs += this.f596info.startPositionUs - jApplyTrackSelection;
        this.f596info = this.f596info.copyWithStartPositionUs(jApplyTrackSelection);
    }
    ...
    public TrackSelectorResult selectTracks(float f2, Timeline timeline) throws ExoPlaybackException {
        TrackSelectorResult trackSelectorResultSelectTracks = this.trackSelector.selectTracks(this.rendererCapabilities, getTrackGroups(), this.f596info.id, timeline);
    ...
    public void updateClipping() {
        if (this.mediaPeriod instanceof ClippingMediaPeriod) {
            ((ClippingMediaPeriod) this.mediaPeriod).updateClipping(0L, this.f596info.endPositionUs == -9223372036854775807L ? Long.MIN_VALUE : this.f596info.endPositionUs);
        }
    }
