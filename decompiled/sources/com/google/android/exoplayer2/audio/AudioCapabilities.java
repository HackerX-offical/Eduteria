...
public final class AudioCapabilities {
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(string).length() + 67).append("AudioCapabilities[maxChannelCount=").append(i).append(", supportedEncodings=").append(string).append(Constants.AES_SUFFIX).toString();
    }
