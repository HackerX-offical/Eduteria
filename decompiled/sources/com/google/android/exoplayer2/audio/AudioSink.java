...
public interface AudioSink {
    ...
    public static final class InitializationException extends Exception {
        ...
        public InitializationException(int i, int i2, int i3, int i4, Format format, boolean z, Exception exc) {
            ...
            super(new StringBuilder(String.valueOf(str).length() + 80).append("AudioTrack init failed ").append(i).append(" Config(").append(i2).append(", ").append(i3).append(", ").append(i4).append(")").append(str).toString(), exc);
