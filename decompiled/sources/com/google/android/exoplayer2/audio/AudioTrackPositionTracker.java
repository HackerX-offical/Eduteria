    ...
    public long getCurrentPositionUs(boolean z) {
        ...
        if (!this.notifiedPositionIncreasing) {
            ...
            if (jMax > j3) {
                ...
                this.listener.onPositionAdvancing(System.currentTimeMillis() - Util.usToMs(Util.getPlayoutDurationForMediaDuration(Util.usToMs(jMax - j3), this.audioTrackPlaybackSpeed)));
            }
        }
