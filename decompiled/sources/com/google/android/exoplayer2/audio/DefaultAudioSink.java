...
public final class DefaultAudioSink implements AudioSink {
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if ("audio/raw".equals(format.sampleMimeType)) {
            ...
            if (useOffloadedPlayback(format, this.audioAttributes)) {
                ...
                if (encodingAndChannelConfigForPassthrough == null) {
                    ...
                    throw new AudioSink.ConfigurationException(new StringBuilder(String.valueOf(strValueOf).length() + 37).append("Unable to configure passthrough for: ").append(strValueOf).toString(), format);
                }
        ...
        if (i != 0) {
            ...
            int bufferSizeInBytes = this.audioTrackBufferSizeProvider.getBufferSizeInBytes(getAudioTrackMinBufferSize(i9, iIntValue2, i8), i8, i4, pcmFrameSize, i9, this.enableAudioTrackPlaybackParams ? 8.0d : 1.0d);
            i8 = i8;
            i6 = bufferSizeInBytes;
        }
        if (i8 == 0) {
            String strValueOf2 = String.valueOf(format);
            throw new AudioSink.ConfigurationException(new StringBuilder(String.valueOf(strValueOf2).length() + 48).append("Invalid output encoding (mode=").append(i4).append(") for: ").append(strValueOf2).toString(), format);
        }
        if (iIntValue2 == 0) {
            String strValueOf3 = String.valueOf(format);
            throw new AudioSink.ConfigurationException(new StringBuilder(String.valueOf(strValueOf3).length() + 54).append("Invalid output channel config (mode=").append(i4).append(") for: ").append(strValueOf3).toString(), format);
        }
        this.offloadDisabledUntilNextConfiguration = false;
        Configuration configuration = new Configuration(format, i5, i4, pcmFrameSize, i9, iIntValue2, i8, i6, audioProcessorArr);
    ...
    private void writeBuffer(ByteBuffer byteBuffer, long j) throws Exception {
        ...
        if (byteBuffer.hasRemaining()) {
            ...
            if (iWriteNonBlockingV21 < 0) {
                ...
                AudioSink.WriteException writeException = new AudioSink.WriteException(iWriteNonBlockingV21, defaultAudioSink.configuration.inputFormat, zIsAudioTrackDeadObject);
            ...
            if (isOffloadedPlayback(defaultAudioSink.audioTrack)) {
                long j2 = defaultAudioSink.writtenEncodedFrames;
                if (j2 > 0) {
                    defaultAudioSink.isWaitingForOffloadEndOfStreamHandled = false;
                }
                if (defaultAudioSink.playing && defaultAudioSink.listener != null && iWriteNonBlockingV21 < iRemaining2 && !defaultAudioSink.isWaitingForOffloadEndOfStreamHandled) {
                    defaultAudioSink.listener.onOffloadBufferFull(defaultAudioSink.audioTrackPositionTracker.getPendingBufferDurationMs(j2));
                }
            }
            ...
            if (iWriteNonBlockingV21 == iRemaining2) {
                if (defaultAudioSink.configuration.outputMode != 0) {
                    ...
                    defaultAudioSink.writtenEncodedFrames += (long) (defaultAudioSink.framesPerEncodedSample * defaultAudioSink.inputBufferAccessUnitCount);
                }
    ...
    */
    ...
    private static Pair<Integer, Integer> getEncodingAndChannelConfigForPassthrough(Format format, AudioCapabilities audioCapabilities) {
        ...
        if (encoding == 18) {
            if (Util.SDK_INT >= 29) {
                maxSupportedChannelCountForPassthroughV29 = getMaxSupportedChannelCountForPassthroughV29(18, format.sampleRate != -1 ? format.sampleRate : 48000);
                if (maxSupportedChannelCountForPassthroughV29 == 0) {
    ...
    private final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public void onPositionFramesMismatch(long j, long j2, long j3, long j4) {
            ...
            String string = new StringBuilder(ByteCode.INVOKEVIRTUAL).append("Spurious audio timestamp (frame position mismatch): ").append(j).append(", ").append(j2).append(", ").append(j3).append(", ").append(j4).append(", ").append(submittedFrames).append(", ").append(DefaultAudioSink.this.getWrittenFrames()).toString();
        ...
        public void onSystemTimeUsMismatch(long j, long j2, long j3, long j4) {
            long submittedFrames = DefaultAudioSink.this.getSubmittedFrames();
            String string = new StringBuilder(180).append("Spurious audio timestamp (system clock mismatch): ").append(j).append(", ").append(j2).append(", ").append(j3).append(", ").append(j4).append(", ").append(submittedFrames).append(", ").append(DefaultAudioSink.this.getWrittenFrames()).toString();
            if (DefaultAudioSink.failOnSpuriousAudioTimestamp) {
                throw new InvalidAudioTrackTimestampException(string);
            }
            Log.w(DefaultAudioSink.TAG, string);
