    ...
    private void changeSpeed(float f2) {
        ...
        do {
            if (this.remainingInputToCopyFrameCount > 0) {
                ...
                if (f2 > 1.0d) {
                    iInsertPitchPeriod = iFindPitchPeriod + skipPitchPeriod(this.inputBuffer, i2, f2, iFindPitchPeriod);
                } else {
                    iInsertPitchPeriod = insertPitchPeriod(this.inputBuffer, i2, f2, iFindPitchPeriod);
                }
            }
