...
public final class AmrExtractor implements Extractor {
    ...
    private int getFrameSizeInBytes(int i) throws ParserException {
        ...
        String str = this.isWideBand ? "WB" : Constants.EASYPAY_PAYTYPE_NETBANKING;
        throw ParserException.createForMalformedContainer(new StringBuilder(String.valueOf(str).length() + 35).append("Illegal AMR ").append(str).append(" frame type ").append(i).toString(), null);
    }
