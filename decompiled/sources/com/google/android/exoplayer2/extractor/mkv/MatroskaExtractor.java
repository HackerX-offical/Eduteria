...
public class MatroskaExtractor implements Extractor {
    ...
    protected void binaryElement(int i, int i2, ExtractorInput extractorInput) throws IOException {
        ...
        if (i != 161 && i != 163) {
            ...
            if (i == ID_CODEC_PRIVATE) {
                ...
                throw ParserException.createForMalformedContainer(new StringBuilder(26).append("Unexpected id: ").append(i).toString(), null);
            }
        }
        int i13 = 8;
            ...
            if (i14 == 0) {
                ...
                if (i14 == 2) {
                    ...
                    if (i14 != 1) {
                                    ...
                                    while (true) {
                                        ...
                                        if ((this.scratch.getData()[i20] & i24) != 0) {
                                            ...
                                            while (true) {
                                                ...
                                                i25 = i26 + 1;
                                                j = (j << i6) | ((long) (this.scratch.getData()[i26] & 255));
                                                i18 = i18;
                                            }
                                            i7 = i18;
                                            if (i7 > 0) {
                        ...
                        throw ParserException.createForMalformedContainer(new StringBuilder(36).append("Unexpected lacing value: ").append(i14).toString(), null);
                    }
                    int i28 = 0;
                    int i29 = 0;
                    int i30 = 4;
        ...
        if (i == 163) {
            while (true) {
                ...
                if (i32 < this.blockSampleCount) {
                    int iWriteSampleData = writeSampleData(extractorInput, track, this.blockSampleSizes[i32]);
                    Track track2 = track;
            ...
            while (true) {
                ...
                iArr3[i33] = writeSampleData(extractorInput, track, iArr3[i33]);
                this.blockSampleIndex++;
            }
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:32:0x00bc A[PHI: r2
      0x00bc: PHI (r2v17 int) = (r2v16 int), (r2v18 int) binds: [B:27:0x009e, B:31:0x00ad] A[DONT_GENERATE, DONT_INLINE]] */
    @org.checkerframework.checker.nullness.qual.RequiresNonNull({"#1.output"})
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private void commitSampleToOutput(com.google.android.exoplayer2.extractor.mkv.MatroskaExtractor.Track r20, long r21, int r23, int r24, int r25) {
        /*
