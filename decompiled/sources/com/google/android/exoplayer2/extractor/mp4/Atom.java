...
abstract class Atom {
    ...
    static final class ContainerAtom extends Atom {
        ...
        public String toString() {
            ...
            String string = Arrays.toString(this.leafChildren.toArray());
            String string2 = Arrays.toString(this.containerChildren.toArray());
            return new StringBuilder(String.valueOf(atomTypeString).length() + 22 + String.valueOf(string).length() + String.valueOf(string2).length()).append(atomTypeString).append(" leaves: ").append(string).append(" containers: ").append(string2).toString();
        }
    }
    ...
    public static String getAtomTypeString(int i) {
        ...
        return new StringBuilder(4).append((char) ((i >> 24) & 255)).append(c2).append(c3).append((char) (i & 255)).toString();
    }
}
