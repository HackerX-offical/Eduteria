...
final class AtomParsers {
    ...
    */
    ...
    private static void parseVideoSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, int i5, DrmInitData drmInitData, StsdData stsdData, int i6) throws ParserException {
            ...
            if (i14 == 1635148611) {
                ...
                if (i14 == 1685480259 || i14 == 1685485123) {
                    ...
                    if (i14 == 1681012275) {
                        ...
                        if (i15 == TYPE_nclx || i15 == TYPE_nclc) {
                            ...
                            String strValueOf = String.valueOf(Atom.getAtomTypeString(i15));
        ...
        Format.Builder drmInitData4 = new Format.Builder().setId(i4).setSampleMimeType(str).setCodecs(str5).setWidth(unsignedShort).setHeight(unsignedShort2).setPixelWidthHeightRatio(f3).setRotationDegrees(i5).setProjectionData(bArr4).setStereoMode(i11).setInitializationData(list3).setDrmInitData(drmInitData3);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static void parseAudioSampleEntry(com.google.android.exoplayer2.util.ParsableByteArray r21, int r22, int r23, int r24, int r25, java.lang.String r26, boolean r27, com.google.android.exoplayer2.drm.DrmInitData r28, com.google.android.exoplayer2.extractor.mp4.AtomParsers.StsdData r29, int r30) throws com.google.android.exoplayer2.ParserException {
        /*
