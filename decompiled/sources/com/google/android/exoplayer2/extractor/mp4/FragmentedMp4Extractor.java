...
public class FragmentedMp4Extractor implements Extractor {
    ...
    private static void parseSaiz(TrackEncryptionBox trackEncryptionBox, ParsableByteArray parsableByteArray, TrackFragment trackFragment) throws ParserException {
        ...
        if (unsignedIntToInt > trackFragment.sampleCount) {
            throw ParserException.createForMalformedContainer(new StringBuilder(78).append("Saiz sample count ").append(unsignedIntToInt).append(" is greater than fragment sample count").append(trackFragment.sampleCount).toString(), null);
        }
        if (unsignedByte == 0) {
    ...
    private static int parseTrun(TrackBundle trackBundle, int i, int i2, ParsableByteArray parsableByteArray, int i3) throws ParserException {
        ...
        boolean z2 = (fullAtomFlags & 4) != 0;
        int i11 = defaultSampleValues.flags;
        if (z2) {
            i11 = parsableByteArray.readInt();
        }
        boolean z3 = (fullAtomFlags & 256) != 0;
        boolean z4 = (fullAtomFlags & 512) != 0;
        boolean z5 = (fullAtomFlags & 1024) != 0;
        boolean z6 = (fullAtomFlags & 2048) != 0;
        long j = 0;
    ...
    private static void parseSenc(ParsableByteArray parsableByteArray, int i, TrackFragment trackFragment) throws ParserException {
        ...
        if (unsignedIntToInt == 0) {
            ...
            if (unsignedIntToInt != trackFragment.sampleCount) {
                throw ParserException.createForMalformedContainer(new StringBuilder(80).append("Senc sample count ").append(unsignedIntToInt).append(" is different from fragment sample count").append(trackFragment.sampleCount).toString(), null);
            }
