...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> traks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, -9223372036854775807L, null, (this.flags & 1) != 0, z3, new Function() { // from class: com.google.android.exoplayer2.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda0
        ...
        while (i5 < size) {
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                int i6 = size2;
                long j = track.durationUs != -9223372036854775807L ? track.durationUs : trackSampleTable.durationUs;
                jMax = Math.max(jMax, j);
                list = traks;
                Mp4Track mp4Track = new Mp4Track(track, trackSampleTable, extractorOutput.track(i5, track.type));
                i = size;
                ...
                i3 = i5;
                if (track.type == 2 && j > 0 && trackSampleTable.sampleCount > 1) {
                    builderBuildUpon.setFrameRate(trackSampleTable.sampleCount / (j / 1000000.0f));
                }
                MetadataUtil.setFormatGaplessInfo(track.type, gaplessInfoHolder, builderBuildUpon);
                int i7 = track.type;
                Metadata[] metadataArr = new Metadata[2];
                metadataArr[0] = metadata5;
                z = true;
