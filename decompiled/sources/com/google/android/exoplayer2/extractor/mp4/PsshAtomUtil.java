...
public final class PsshAtomUtil {
    ...
    public static byte[] parseSchemeSpecificData(byte[] bArr, UUID uuid) {
        ...
        if (!uuid.equals(psshAtom.uuid)) {
            ...
            Log.w(TAG, new StringBuilder(String.valueOf(strValueOf).length() + 33 + String.valueOf(strValueOf2).length()).append("UUID mismatch. Expected: ").append(strValueOf).append(", got: ").append(strValueOf2).append(InstructionFileId.DOT).toString());
            return null;
        }
