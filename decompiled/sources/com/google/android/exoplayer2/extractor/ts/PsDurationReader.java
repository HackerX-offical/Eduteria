...
final class PsDurationReader {
    ...
    public int readDuration(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        if (jAdjustTsTimestamp < 0) {
            Log.w(TAG, new StringBuilder(65).append("Invalid duration: ").append(jAdjustTsTimestamp).append(". Using TIME_UNSET instead.").toString());
    ...
    private static long readScrValueFromPackHeader(byte[] bArr) {
        byte b2 = bArr[0];
        long j = (((((long) b2) & 56) >> 3) << 30) | ((((long) b2) & 3) << 28) | ((((long) bArr[1]) & 255) << 20);
        byte b3 = bArr[2];
        return j | (((((long) b3) & 248) >> 3) << 15) | ((((long) b3) & 3) << 13) | ((((long) bArr[3]) & 255) << 5) | ((((long) bArr[4]) & 248) >> 3);
    }
}
