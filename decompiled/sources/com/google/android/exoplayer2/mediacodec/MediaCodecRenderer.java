...
public abstract class MediaCodecRenderer extends BaseRenderer {
    private static final byte[] ADAPTATION_WORKAROUND_BUFFER = {0, 0, 1, 103, 66, -64, 11, -38, 37, -112, 0, 0, 1, 104, -50, Ascii.SI, 19, 32, 0, 0, 1, 101, -120, -124, 13, -50, 113, Ascii.CAN, -96, 0, 47, -65, Ascii.FS, 49, -61, 39, 93, 120};
    ...
    public static class DecoderInitializationException extends Exception {
        ...
        public DecoderInitializationException(Format format, Throwable th, boolean z, int i) {
            ...
            this(new StringBuilder(String.valueOf(strValueOf).length() + 36).append("Decoder init failed: [").append(i).append("], ").append(strValueOf).toString(), th, format.sampleMimeType, z, null, buildCustomDiagnosticInfo(i), null);
        }
        ...
        public DecoderInitializationException(Format format, Throwable th, boolean z, MediaCodecInfo mediaCodecInfo) {
            ...
            String strValueOf = String.valueOf(format);
            this(new StringBuilder(String.valueOf(str).length() + 23 + String.valueOf(strValueOf).length()).append("Decoder init failed: ").append(str).append(", ").append(strValueOf).toString(), th, format.sampleMimeType, z, mediaCodecInfo, Util.SDK_INT >= 21 ? getDiagnosticInfoV21(th) : null, null);
        }
    ...
    public void render(long j, long j2) throws ExoPlaybackException {
        ...
        try {
            ...
            if (isMediaCodecException(e2)) {
                ...
                throw createRendererException(createDecoderException(e2, getCodecInfo()), this.inputFormat, z, 4003);
            }
            throw e2;
        }
    }
    ...
    */
    ...
    private List<MediaCodecInfo> getAvailableCodecInfos(boolean z) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (!decoderInfos2.isEmpty()) {
            String str = this.inputFormat.sampleMimeType;
            String strValueOf = String.valueOf(decoderInfos2);
            Log.w(TAG, new StringBuilder(String.valueOf(str).length() + 99 + String.valueOf(strValueOf).length()).append("Drm session requires secure decoder for ").append(str).append(", but no secure decoder available. Trying to proceed with ").append(strValueOf).append(InstructionFileId.DOT).toString());
        }
    ...
    */
    ...
    private FrameworkCryptoConfig getFrameworkCryptoConfig(DrmSession drmSession) throws ExoPlaybackException {
        ...
        if (cryptoConfig != null && !(cryptoConfig instanceof FrameworkCryptoConfig)) {
            ...
            throw createRendererException(new IllegalArgumentException(new StringBuilder(String.valueOf(strValueOf).length() + 43).append("Expecting FrameworkCryptoConfig but found: ").append(strValueOf).toString()), this.inputFormat, 6001);
        }
    ...
    private static boolean codecNeedsEosPropagationWorkaround(MediaCodecInfo mediaCodecInfo) {
        ...
        if (Util.SDK_INT > 29 || !("OMX.broadcom.video_decoder.tunnel".equals(str) || "OMX.broadcom.video_decoder.tunnel.secure".equals(str))) {
