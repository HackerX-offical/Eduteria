...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    */
    private static boolean validateFrames(com.google.android.exoplayer2.util.ParsableByteArray r18, int r19, int r20, boolean r21) {
        ...
        L8:
            int r3 = r1.bytesLeft()     // Catch: java.lang.Throwable -> Laf
            r4 = 1
            r5 = r20
            if (r3 < r5) goto Lab
            r3 = 3
            r6 = 0
            if (r0 < r3) goto L22
            int r7 = r1.readInt()     // Catch: java.lang.Throwable -> Laf
            long r8 = r1.readUnsignedInt()     // Catch: java.lang.Throwable -> Laf
            int r10 = r1.readUnsignedShort()     // Catch: java.lang.Throwable -> Laf
            goto L2c
        L22:
            int r7 = r1.readUnsignedInt24()     // Catch: java.lang.Throwable -> Laf
            int r8 = r1.readUnsignedInt24()     // Catch: java.lang.Throwable -> Laf
            long r8 = (long) r8
            r10 = r6
        L2c:
            r11 = 0
    ...
    /* JADX WARN: Removed duplicated region for block: B:171:0x0214 A[Catch: UnsupportedEncodingException -> 0x0246, all -> 0x024f, TRY_LEAVE, TryCatch #2 {UnsupportedEncodingException -> 0x0246, blocks: (B:171:0x0214, B:161:0x01f2, B:168:0x0205, B:169:0x020a), top: B:183:0x0108 }] */
