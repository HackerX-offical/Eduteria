...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    public DefaultDownloadIndex(DatabaseProvider databaseProvider, String str) {
        ...
        String strValueOf = String.valueOf(TABLE_PREFIX);
        String strValueOf2 = String.valueOf(str);
        this.tableName = strValueOf2.length() != 0 ? strValueOf.concat(strValueOf2) : new String(strValueOf);
            ...
            try {
                ...
                if (version != 3) {
                    ...
                    try {
                        ...
                        writableDatabase.execSQL(new StringBuilder(String.valueOf(str).length() + HttpStatus.SC_UNSUPPORTED_MEDIA_TYPE).append("CREATE TABLE ").append(str).append(" (id TEXT PRIMARY KEY NOT NULL,mime_type TEXT,uri TEXT NOT NULL,stream_keys TEXT NOT NULL,custom_cache_key TEXT,data BLOB NOT NULL,state INTEGER NOT NULL,start_time_ms INTEGER NOT NULL,update_time_ms INTEGER NOT NULL,content_length INTEGER NOT NULL,stop_reason INTEGER NOT NULL,failure_reason INTEGER NOT NULL,percent_downloaded REAL NOT NULL,bytes_downloaded INTEGER NOT NULL,key_set_id BLOB NOT NULL)").toString());
    ...
    private static String inferMimeType(String str) {
        ...
        if (Const.HLS.equals(str)) {
            return "application/x-mpegURL";
        }
        if (Constants.KEY_ENCRYPTION_INAPP_SS.equals(str)) {
    ...
    static String encodeStreamKeys(List<StreamKey> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            sb.append(streamKey.periodIndex).append('.').append(streamKey.groupIndex).append('.').append(streamKey.streamIndex).append(CsvReader.Letters.COMMA);
        }
        if (sb.length() > 0) {
    ...
    private static List<StreamKey> decodeStreamKeys(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            for (String str2 : Util.split(str, Constants.SEPARATOR_COMMA)) {
