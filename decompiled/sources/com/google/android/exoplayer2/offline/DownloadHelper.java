...
public final class DownloadHelper {
    ...
    public static DownloadHelper forMediaItem(MediaItem mediaItem, DefaultTrackSelector.Parameters parameters, RenderersFactory renderersFactory, DataSource.Factory factory, DrmSessionManager drmSessionManager) {
        ...
        return new DownloadHelper(mediaItem, mediaSourceCreateMediaSourceInternal, parameters, rendererCapabilities);
    }
        ...
        if (this.mediaSource != null) {
            ...
            this.callbackHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.offline.DownloadHelper$$ExternalSyntheticLambda3
                ...
                public final void run() {
                    this.f$0.m12101xf9781d7d(callback);
                }
            });
        }
    }
    ...
    /* synthetic */ void m12101xf9781d7d(Callback callback) {
    ...
    public void onMediaPrepared() {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            ...
            this.trackSelector.onSelectionActivated(runTrackSelection(i3).f600info);
    ...
    /* synthetic */ void m12100xbc158121() {
    ...
    public void onMediaPreparationFailed(final IOException iOException) {
        ((Handler) Assertions.checkNotNull(this.callbackHandler)).post(new Runnable() { // from class: com.google.android.exoplayer2.offline.DownloadHelper$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m12099xa7571479(iOException);
            }
        });
    }
    ...
    /* synthetic */ void m12099xa7571479(IOException iOException) {
