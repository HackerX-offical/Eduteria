...
public final class DownloadManager {
    ...
    private final CopyOnWriteArraySet<Listener> f599listeners;
    ...
    public DownloadManager(Context context, DatabaseProvider databaseProvider, Cache cache, DataSource.Factory factory) {
        this(context, databaseProvider, cache, factory, new DashDownloader$$ExternalSyntheticLambda0());
    }
    ...
    public DownloadManager(Context context, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        this.f599listeners = new CopyOnWriteArraySet<>();
    ...
    public void addListener(Listener listener) {
        ...
        this.f599listeners.add(listener);
    }

    public void removeListener(Listener listener) {
        this.f599listeners.remove(listener);
    }
    ...
    private void setDownloadsPaused(boolean z) {
        ...
        Iterator<Listener> it = this.f599listeners.iterator();
        while (it.hasNext()) {
    ...
    private void onDownloadUpdate(DownloadUpdate downloadUpdate) {
        ...
        if (downloadUpdate.isRemove) {
            ...
            Iterator<Listener> it2 = this.f599listeners.iterator();
            while (it2.hasNext()) {
            ...
            if (str == null) {
                ...
                if (download != null) {
                    ...
                    try {
                        ...
                        Log.e(DownloadManager.TAG, strValueOf.length() != 0 ? "Failed to set manual stop reason: ".concat(strValueOf) : new String("Failed to set manual stop reason: "), e3);
                    }
                }
            }
            syncTasks();
