...
public final class DownloadRequest implements Parcelable {
    ...
    private DownloadRequest(String str, Uri uri, String str2, List<StreamKey> list, byte[] bArr, String str3, byte[] bArr2) {
        ...
        if (iInferContentTypeForUriAndMimeType == 0 || iInferContentTypeForUriAndMimeType == 2 || iInferContentTypeForUriAndMimeType == 1) {
            Assertions.checkArgument(str3 == null, new StringBuilder(49).append("customCacheKey must be null for type: ").append(iInferContentTypeForUriAndMimeType).toString());
        }
        this.id = str;
        this.uri = uri;
        this.mimeType = str2;
