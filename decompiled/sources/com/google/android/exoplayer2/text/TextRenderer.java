...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    private void handleDecoderError(SubtitleDecoderException subtitleDecoderException) {
        ...
        Log.e(TAG, new StringBuilder(String.valueOf(strValueOf).length() + 39).append("Subtitle decoding failed. streamFormat=").append(strValueOf).toString(), subtitleDecoderException);
        clearOutput();
        replaceDecoder();
    }
}
