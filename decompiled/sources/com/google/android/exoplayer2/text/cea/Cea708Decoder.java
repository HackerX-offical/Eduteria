...
public final class Cea708Decoder extends CeaDecoder {
    ...
    private void processCurrentPacket() {
        ...
        int position = this.serviceBlockPacket.getPosition() + (bits2 * 8);
        boolean z = false;
    ...
    private static final class CueInfoBuilder {
        ...
        public Cea708CueInfo build() {
            ...
            return new Cea708CueInfo(spannableStringBuilder, alignment, f6, 0, i2, f4, i5, -3.4028235E38f, this.windowFillColor != COLOR_SOLID_BLACK, this.windowFillColor, this.priority);
        }
