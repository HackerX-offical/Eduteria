...
final class SsaStyle {
    ...
    public static SsaStyle fromStyleLine(String str, Format format) {
        ...
        try {
            ...
            if (format.strikeoutIndex != -1 && parseBooleanValue(strArrSplit[format.strikeoutIndex].trim())) {
                z3 = true;
            }
            return new SsaStyle(strTrim, alignment, color, fontSize, z4, z5, z2, z3);
    ...
    static final class Format {
        ...
        public static Format fromFormatLine(String str) {
            ...
            if (i != -1) {
                return new Format(i, i2, i3, i4, i5, i6, i7, i8, strArrSplit.length);
            }
            return null;
        }
    }
