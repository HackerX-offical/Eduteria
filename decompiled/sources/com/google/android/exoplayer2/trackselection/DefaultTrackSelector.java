...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    protected final Pair<RendererConfiguration[], ExoTrackSelection[]> selectTracks(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, MediaSource.MediaPeriodId mediaPeriodId, Timeline timeline) throws ExoPlaybackException {
        ...
        for (int i = 0; i < applicableOverrides.size(); i++) {
            Pair<TrackSelectionOverrides.TrackSelectionOverride, Integer> pairValueAt = applicableOverrides.valueAt(i);
            applyTrackTypeOverride(mappedTrackInfo, definitionArrSelectAllTracks, applicableOverrides.keyAt(i), (TrackSelectionOverrides.TrackSelectionOverride) pairValueAt.first, ((Integer) pairValueAt.second).intValue());
        }
        for (int i2 = 0; i2 < rendererCount; i2++) {
            if (hasLegacyRendererOverride(mappedTrackInfo, parameters, i2)) {
                definitionArrSelectAllTracks[i2] = getLegacyRendererOverride(mappedTrackInfo, parameters, i2);
            }
        }
        for (int i3 = 0; i3 < rendererCount; i3++) {
            if (isRendererDisabled(mappedTrackInfo, parameters, i3)) {
                definitionArrSelectAllTracks[i3] = null;
            }
        }
        ...
        for (int i4 = 0; i4 < rendererCount; i4++) {
            rendererConfigurationArr[i4] = (parameters.getRendererDisabled(i4) || parameters.disabledTrackTypes.contains(Integer.valueOf(mappedTrackInfo.getRendererType(i4))) || (mappedTrackInfo.getRendererType(i4) != -2 && exoTrackSelectionArrCreateTrackSelections[i4] == null)) ? null : RendererConfiguration.DEFAULT;
        }
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda4
            ...
            public final List create(int i2, TrackGroup trackGroup, int[] iArr3) {
                return DefaultTrackSelector.AudioTrackInfo.createForTrackGroup(i2, trackGroup, parameters, iArr3, z);
            }
    ...
    */
    ...
    static final class AudioTrackInfo extends TrackInfo<AudioTrackInfo> implements Comparable<AudioTrackInfo> {
        ...
        public static ImmutableList<AudioTrackInfo> createForTrackGroup(int i, TrackGroup trackGroup, Parameters parameters, int[] iArr, boolean z) {
            ...
            for (int i2 = 0; i2 < trackGroup.length; i2++) {
                builder.add(new AudioTrackInfo(i, trackGroup, i2, parameters, iArr[i2], z));
            }
            return builder.build();
        }
    ...
    static final class TextTrackInfo extends TrackInfo<TextTrackInfo> implements Comparable<TextTrackInfo> {
        ...
        public TextTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, String str) {
            ...
            int i4 = 0;
            this.isWithinRendererCapabilities = DefaultTrackSelector.isSupported(i3, false);
            int i5 = this.format.selectionFlags & (~parameters.disabledTextTrackSelectionFlags);
