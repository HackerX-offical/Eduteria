    ...
    static TracksInfo buildTracksInfo(TrackSelection[] trackSelectionArr, MappedTrackInfo mappedTrackInfo) {
        ...
        for (int i = 0; i < mappedTrackInfo.getRendererCount(); i++) {
            ...
            for (int i2 = 0; i2 < trackGroups.length; i2++) {
                ...
                builder.add(new TracksInfo.TrackGroupInfo(trackGroup, iArr, mappedTrackInfo.getRendererType(i), zArr));
            }
        }
        ...
        for (int i4 = 0; i4 < unmappedTrackGroups.length; i4++) {
            ...
            Arrays.fill(iArr2, 0);
            builder.add(new TracksInfo.TrackGroupInfo(trackGroup2, iArr2, MimeTypes.getTrackType(trackGroup2.getFormat(0).sampleMimeType), new boolean[trackGroup2.length]));
        }
