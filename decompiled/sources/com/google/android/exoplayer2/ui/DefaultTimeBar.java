...
public class DefaultTimeBar extends View implements TimeBar {
    ...
    private final CopyOnWriteArraySet<TimeBar.OnScrubListener> f601listeners;
    ...
    public DefaultTimeBar(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2, int i2) {
        ...
        this.f601listeners = new CopyOnWriteArraySet<>();
        ...
        this.stopScrubbingRunnable = new Runnable() { // from class: com.google.android.exoplayer2.ui.DefaultTimeBar$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m12133lambda$new$0$comgoogleandroidexoplayer2uiDefaultTimeBar();
            }
        };
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.exoplayer2.ui.DefaultTimeBar$$ExternalSyntheticLambda1
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.m12134lambda$new$1$comgoogleandroidexoplayer2uiDefaultTimeBar(valueAnimator2);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$new$0$com-google-android-exoplayer2-ui-DefaultTimeBar, reason: not valid java name */
    /* synthetic */ void m12133lambda$new$0$comgoogleandroidexoplayer2uiDefaultTimeBar() {
        stopScrubbing(false);
    }

    /* JADX INFO: renamed from: lambda$new$1$com-google-android-exoplayer2-ui-DefaultTimeBar, reason: not valid java name */
    /* synthetic */ void m12134lambda$new$1$comgoogleandroidexoplayer2uiDefaultTimeBar(ValueAnimator valueAnimator) {
    ...
    public void addListener(TimeBar.OnScrubListener onScrubListener) {
        ...
        this.f601listeners.add(onScrubListener);
    }

    @Override // com.google.android.exoplayer2.ui.TimeBar
    public void removeListener(TimeBar.OnScrubListener onScrubListener) {
        this.f601listeners.remove(onScrubListener);
    }
    ...
    */
    ...
    private void startScrubbing(long j) {
        ...
        Iterator<TimeBar.OnScrubListener> it = this.f601listeners.iterator();
        while (it.hasNext()) {
    ...
    private void drawTimeBar(Canvas canvas) {
        ...
        for (int i5 = 0; i5 < this.adGroupCount; i5++) {
            canvas.drawRect(this.progressBar.left + Math.min(this.progressBar.width() - this.adMarkerWidth, Math.max(0, ((int) ((((long) this.progressBar.width()) * Util.constrainValue(jArr[i5], 0L, this.duration)) / this.duration)) - i4)), iCenterY, r9 + this.adMarkerWidth, i, zArr[i5] ? this.playedAdMarkerPaint : this.adMarkerPaint);
        }
    }
