...
public class StyledPlayerControlView extends FrameLayout {
    ...
    public StyledPlayerControlView(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2) {
        ...
        drawableArr[0] = this.resources.getDrawable(R.drawable.exo_styled_controls_speed);
        strArr[c2] = this.resources.getString(R.string.exo_track_selection_title_audio);
        drawableArr[c2] = this.resources.getDrawable(R.drawable.exo_styled_controls_audiotrack);
        this.settingsAdapter = new SettingsAdapter(strArr, drawableArr);
        ...
        this.settingsWindow = new PopupWindow((View) this.settingsView, -2, -2, (boolean) c2);
        if (Util.SDK_INT < 23) {
            z11 = false;
        ...
        this.controlViewLayoutManager.setShowButton(imageView5, z2);
        this.controlViewLayoutManager.setShowButton(this.subtitleButton, z20);
        this.controlViewLayoutManager.setShowButton(viewFindViewById10, z9);
        this.controlViewLayoutManager.setShowButton(imageView4, this.repeatToggleModes != 0 ? true : z11);
            ...
            if (trackGroupInfo.getTrackType() == i) {
                ...
                for (int i3 = 0; i3 < trackGroup.length; i3++) {
                    if (trackGroupInfo.isTrackSupported(i3)) {
                        builder.add(new TrackInformation(tracksInfo, i2, i3, this.trackNameProvider.getTrackName(trackGroup.getFormat(i3))));
                    }
                }
            }
        }
    ...
    */
    ...
    final class SettingViewHolder extends RecyclerView.ViewHolder {
        ...
        public SettingViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.exoplayer2.ui.StyledPlayerControlView$SettingViewHolder$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view2) {
                    this.f$0.m12141xbf8efbb9(view2);
                }
            });
        }
        ...
        /* synthetic */ void m12141xbf8efbb9(View view) {
    ...
    final class PlaybackSpeedAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public void onBindViewHolder(SubSettingViewHolder subSettingViewHolder, final int i) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.exoplayer2.ui.StyledPlayerControlView$PlaybackSpeedAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m12140xdf46b9b2(i, view);
                }
            });
        }
        ...
        /* synthetic */ void m12140xdf46b9b2(int i, View view) {
    ...
    final class TextTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        /* synthetic */ void m12142xcc051aee(View view) {
            if (StyledPlayerControlView.this.player != null) {
                ...
                StyledPlayerControlView.this.player.setTrackSelectionParameters(trackSelectionParameters.buildUpon().setDisabledTrackTypes(new ImmutableSet.Builder().addAll((Iterable) trackSelectionParameters.disabledTrackTypes).add(3).build()).build());
                StyledPlayerControlView.this.settingsWindow.dismiss();
            }
        }
    ...
    final class AudioTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        /* synthetic */ void m12139x5e042c6b(View view) {
            if (StyledPlayerControlView.this.player == null) {
                return;
            }
            TrackSelectionParameters trackSelectionParameters = StyledPlayerControlView.this.player.getTrackSelectionParameters();
    ...
    abstract class TrackSelectionAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public void onBindViewHolder(SubSettingViewHolder subSettingViewHolder, int i) {
            ...
            boolean z = ((Player) Assertions.checkNotNull(StyledPlayerControlView.this.player)).getTrackSelectionParameters().trackSelectionOverrides.getOverride(trackGroup) != null && trackInformation.isSelected();
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.exoplayer2.ui.StyledPlayerControlView$TrackSelectionAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m12143x30db9e7f(trackGroup, trackInformation, view);
                }
            });
        }
        ...
        /* synthetic */ void m12143x30db9e7f(TrackGroup trackGroup, TrackInformation trackInformation, View view) {
            if (StyledPlayerControlView.this.player == null) {
                return;
            }
            TrackSelectionParameters trackSelectionParameters = StyledPlayerControlView.this.player.getTrackSelectionParameters();
