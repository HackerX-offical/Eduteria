...
public class StyledPlayerView extends FrameLayout implements AdViewProvider {
    ...
    public StyledPlayerView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            ...
            try {
                ...
                int resourceId = typedArrayObtainStyledAttributes.getResourceId(R.styleable.StyledPlayerView_player_layout_id, i8);
                ...
                int i9 = typedArrayObtainStyledAttributes.getInt(R.styleable.StyledPlayerView_surface_type, 1);
                int i10 = typedArrayObtainStyledAttributes.getInt(R.styleable.StyledPlayerView_resize_mode, 0);
                int i11 = typedArrayObtainStyledAttributes.getInt(R.styleable.StyledPlayerView_show_timeout, 5000);
        ...
        this.useArtwork = (!z4 || imageView2 == null) ? false : z7;
        if (i6 != 0) {
        ...
        this.controllerShowTimeoutMs = styledPlayerControlView3 != null ? i2 : i7;
        this.controllerHideOnTouch = z3;
        this.controllerAutoShow = z;
        this.controllerHideDuringAds = z2;
        this.useController = (!z5 || styledPlayerControlView3 == null) ? i7 : z7;
    ...
    private boolean shouldShowControllerIndefinitely() {
        ...
        if (!this.controllerAutoShow || this.player.getCurrentTimeline().isEmpty()) {
            return false;
        }
