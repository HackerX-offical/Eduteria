...
public final class Loader implements LoaderErrorThrower {
    ...
    public static final class UnexpectedLoaderException extends IOException {
        ...
        public UnexpectedLoaderException(Throwable th) {
            ...
            super(new StringBuilder(String.valueOf(simpleName).length() + 13 + String.valueOf(message).length()).append("Unexpected ").append(simpleName).append(": ").append(message).toString(), th);
        }
    }
    ...
    public Loader(String str) {
        String strValueOf = String.valueOf(THREAD_NAME_PREFIX);
        String strValueOf2 = String.valueOf(str);
        this.downloadExecutorService = Util.newSingleThreadExecutor(strValueOf2.length() != 0 ? strValueOf.concat(strValueOf2) : new String(strValueOf));
    }
