...
public final class SimpleCache implements Cache {
    ...
    private final HashMap<String, ArrayList<Cache.Listener>> f605listeners;
    ...
    SimpleCache(File file, CacheEvictor cacheEvictor, CachedContentIndex cachedContentIndex, CacheFileMetadataIndex cacheFileMetadataIndex) {
        ...
        this.f605listeners = new HashMap<>();
    ...
    public synchronized NavigableSet<CacheSpan> addListener(String str, Cache.Listener listener) {
        ...
        ArrayList<Cache.Listener> arrayList = this.f605listeners.get(str);
        if (arrayList == null) {
            arrayList = new ArrayList<>();
            this.f605listeners.put(str, arrayList);
        }
    ...
    */
    public synchronized boolean isCached(java.lang.String r3, long r4, long r6) {
        /*
            ...
            com.google.android.exoplayer2.upstream.cache.CachedContentIndex r0 = r2.contentIndex     // Catch: java.lang.Throwable -> L1c
            com.google.android.exoplayer2.upstream.cache.CachedContent r3 = r0.get(r3)     // Catch: java.lang.Throwable -> L1c
            if (r3 == 0) goto L19
    ...
    private void notifySpanRemoved(CacheSpan cacheSpan) {
        ArrayList<Cache.Listener> arrayList = this.f605listeners.get(cacheSpan.key);
        if (arrayList != null) {
    ...
    private void notifySpanAdded(SimpleCacheSpan simpleCacheSpan) {
        ArrayList<Cache.Listener> arrayList = this.f605listeners.get(simpleCacheSpan.key);
        if (arrayList != null) {
            for (int size = arrayList.size() - 1; size >= 0; size--) {
    ...
    private static long createUid(File file) throws IOException {
        ...
        String strValueOf2 = String.valueOf(UID_FILE_SUFFIX);
        File file2 = new File(file, strValueOf2.length() != 0 ? strValueOf.concat(strValueOf2) : new String(strValueOf));
        if (file2.createNewFile()) {
            return jAbs;
        }
        String strValueOf3 = String.valueOf(file2);
        throw new IOException(new StringBuilder(String.valueOf(strValueOf3).length() + 27).append("Failed to create UID file: ").append(strValueOf3).toString());
    }
