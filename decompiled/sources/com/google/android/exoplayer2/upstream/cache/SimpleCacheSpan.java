...
final class SimpleCacheSpan extends CacheSpan {
    ...
    public static File getCacheFile(File file, int i, long j, long j2) {
        return new File(file, new StringBuilder(60).append(i).append(InstructionFileId.DOT).append(j).append(InstructionFileId.DOT).append(j2).append(SUFFIX).toString());
    }
