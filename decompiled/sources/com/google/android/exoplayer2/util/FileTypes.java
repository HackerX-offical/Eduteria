    ...
    public static int inferFileTypeFromMimeType(String str) {
        ...
        switch (strNormalizeMimeType.hashCode()) {
            ...
            case -1606874997:
                ...
                break;
            case -1487394660:
                b2 = !strNormalizeMimeType.equals("image/jpeg") ? (byte) -1 : (byte) 5;
                break;
            case -1248337486:
                b2 = !strNormalizeMimeType.equals("application/mp4") ? (byte) -1 : (byte) 6;
                break;
            case -1004728940:
                b2 = !strNormalizeMimeType.equals("text/vtt") ? (byte) -1 : (byte) 7;
                break;
            case -387023398:
                b2 = !strNormalizeMimeType.equals("audio/x-matroska") ? (byte) -1 : (byte) 8;
                break;
            case -43467528:
                b2 = !strNormalizeMimeType.equals("application/webm") ? (byte) -1 : (byte) 9;
                break;
            case 13915911:
                b2 = !strNormalizeMimeType.equals("video/x-flv") ? (byte) -1 : (byte) 10;
                break;
            case 187078296:
                b2 = !strNormalizeMimeType.equals("audio/ac3") ? (byte) -1 : (byte) 11;
                break;
            case 187078297:
                b2 = !strNormalizeMimeType.equals("audio/ac4") ? (byte) -1 : (byte) 12;
                break;
            case 187078669:
                b2 = !strNormalizeMimeType.equals("audio/amr") ? (byte) -1 : (byte) 13;
                break;
            case 187090232:
                b2 = !strNormalizeMimeType.equals("audio/mp4") ? (byte) -1 : (byte) 14;
                break;
            case 187091926:
                b2 = !strNormalizeMimeType.equals("audio/ogg") ? (byte) -1 : Ascii.SI;
                break;
            case 187099443:
                b2 = !strNormalizeMimeType.equals("audio/wav") ? (byte) -1 : (byte) 16;
                break;
            case 1331848029:
                b2 = !strNormalizeMimeType.equals("video/mp4") ? (byte) -1 : (byte) 17;
                break;
            case 1503095341:
                b2 = !strNormalizeMimeType.equals("audio/3gpp") ? (byte) -1 : Ascii.DC2;
                break;
            case 1504578661:
                b2 = !strNormalizeMimeType.equals("audio/eac3") ? (byte) -1 : (byte) 19;
                break;
            case 1504619009:
                b2 = !strNormalizeMimeType.equals("audio/flac") ? (byte) -1 : Ascii.DC4;
                break;
            case 1504831518:
                b2 = !strNormalizeMimeType.equals("audio/mpeg") ? (byte) -1 : Ascii.NAK;
                break;
            case 1505118770:
                b2 = !strNormalizeMimeType.equals("audio/webm") ? (byte) -1 : Ascii.SYN;
                break;
            case 2039520277:
                b2 = !strNormalizeMimeType.equals("video/x-matroska") ? (byte) -1 : Ascii.ETB;
                break;
            default:
                b2 = -1;
                break;
