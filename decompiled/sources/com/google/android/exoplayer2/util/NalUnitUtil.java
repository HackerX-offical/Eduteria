...
public final class NalUnitUtil {
    ...
    */
    ...
    public static H265SpsData parseH265SpsNalUnitPayload(byte[] bArr, int i, int i2) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (bits5 == 255) {
                    ...
                    if (bits5 < fArr.length) {
                        ...
                        Log.w(TAG, new StringBuilder(46).append("Unexpected aspect_ratio_idc value: ").append(bits5).toString());
                    }
                }
            }
            if (parsableNalUnitBitArray.readBit()) {
        ...
        return new H265SpsData(bits2, bit, bits3, i3, iArr, bits4, unsignedExpGolombCodedInt, i8, unsignedExpGolombCodedInt4, f2);
    }
