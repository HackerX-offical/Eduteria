...
public final class NetworkTypeObserver {
    ...
    private final CopyOnWriteArrayList<WeakReference<Listener>> f607listeners = new CopyOnWriteArrayList<>();
    ...
    public void register(final Listener listener) {
        ...
        this.f607listeners.add(new WeakReference<>(listener));
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.util.NetworkTypeObserver$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m12154x43b1341d(listener);
            }
        });
    }
    ...
    /* synthetic */ void m12154x43b1341d(Listener listener) {
    ...
    private void removeClearedReferences() {
        for (WeakReference<Listener> weakReference : this.f607listeners) {
            if (weakReference.get() == null) {
                this.f607listeners.remove(weakReference);
            }
        }
    }
