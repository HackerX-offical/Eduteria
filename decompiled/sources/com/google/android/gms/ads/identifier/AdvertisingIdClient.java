...
public class AdvertisingIdClient {
    ...
    private final Info zzd(int i) throws IOException {
        ...
        synchronized (this) {
            if (this.zzc) {
                ...
                info2 = new Info(this.zzb.zzc(), this.zzb.zze(true));
            } else {
    ...
    final boolean zzc(Info info2, boolean z, float f2, long j, String str, Throwable th) {
        if (Math.random() > 0.0d) {
            return false;
        }
        ...
        map.put(Const.TIME_SPENT, Long.toString(j));
