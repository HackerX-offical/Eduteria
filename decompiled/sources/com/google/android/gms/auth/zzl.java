...
public class zzl {
    ...
    public static Boolean requestGoogleAccountsAccess(Context context) throws GoogleAuthException, IOException {
        ...
        if (zzhw.zze() && zzp(context)) {
            try {
                ...
                String string = bundle.getString(Constants.EVENT_ACTION_ERROR);
    ...
    private static TokenData zzg(Context context, String str, Bundle bundle) throws GoogleAuthException, IOException {
        ...
        zzn(context, "getTokenWithDetails", bundle.getString(Constants.EVENT_ACTION_ERROR), (Intent) bundle.getParcelable("userRecoveryIntent"), (PendingIntent) bundle.getParcelable("userRecoveryPendingIntent"));
        throw new GoogleAuthException("Invalid state. Shouldn't happen");
    }
