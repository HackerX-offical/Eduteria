...
final class zzaj extends zzae<Boolean> {
    ...
    public final Boolean zza(SharedPreferences sharedPreferences) {
        try {
            ...
            Log.e("PhenotypeFlag", strValueOf.length() != 0 ? "Invalid boolean value in SharedPreferences for ".concat(strValueOf) : new String("Invalid boolean value in SharedPreferences for "), e2);
            return null;
        }
    }
