...
public final class zzfs {
    ...
    private static int zza(CharSequence charSequence) {
                    ...
                    if (cCharAt2 < 2048) {
                        ...
                        if (55296 <= cCharAt2 && cCharAt2 <= 57343) {
                            if (Character.codePointAt(charSequence, i2) < 65536) {
                                throw new IllegalArgumentException(new StringBuilder(39).append("Unpaired surrogate at index ").append(i2).toString());
                            }
                            i2++;
                        }
                    }
        ...
        throw new IllegalArgumentException(new StringBuilder(54).append("UTF-8 length does not fit in int: ").append(((long) i3) + Conversions.THIRTYTWO_BIT).toString());
    }
        ...
        if (!byteBuffer.hasArray()) {
            ...
            while (i2 < length) {
                ...
                if (cCharAt2 < 128) {
                    ...
                    byteBuffer.put((byte) ((cCharAt2 >>> CsvReader.Letters.FORM_FEED) | WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND));
            ...
            if (i2 == length2) {
                ...
                while (i2 < length2) {
                    ...
                    if (cCharAt4 < 128 && i < i5) {
                        ...
                        if ((cCharAt4 >= 55296 && c2 >= cCharAt4) || i > i5 - 3) {
                            if (i > i5 - 4) {
                        ...
                        bArrArray[i] = (byte) ((cCharAt4 >>> CsvReader.Letters.FORM_FEED) | WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND);
                        int i10 = i + 2;
