...
public final class zzp implements ClearcutLogger.zza {
    ...
    private static zzgw.zza.zzb zza(String str) {
        ...
        try {
            ...
            Log.e("LogSamplerImpl", new StringBuilder(72).append("negative values not supported: ").append(j).append(MqttTopic.TOPIC_LEVEL_SEPARATOR).append(j2).toString());
            return null;
        } catch (NumberFormatException e2) {
            String strValueOf2 = String.valueOf(str);
            Log.e("LogSamplerImpl", strValueOf2.length() != 0 ? "parseLong() failed while parsing: ".concat(strValueOf2) : new String("parseLong() failed while parsing: "), e2);
            return null;
        }
    }
