...
public final class zzr extends AbstractSafeParcelable {
    ...
    public final String toString() {
        ...
        sb.append(this.zzi).append(",logSource=");
        sb.append(this.zzk).append(",logSourceName=");
        sb.append(this.zzj).append(",uploadAccount=");
        sb.append(this.zzl).append(",loggingId=");
        sb.append(this.zzm).append(",logAndroidId=");
        sb.append(this.zzay).append(",isAnonymous=");
        sb.append(this.zzn).append(",qosTier=");
        sb.append(this.zzaz);
