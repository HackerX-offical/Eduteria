...
public final class zzfm extends AbstractSafeParcelable implements com.google.firebase.auth.api.internal.zzdz<zzfm, zzp.zzk> {
    ...
    zzfm(String str, String str2, String str3, zzfh zzfhVar) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
        this.zzd = zzfhVar;
    ...
    public final /* synthetic */ com.google.firebase.auth.api.internal.zzdz zza(zzjp zzjpVar) {
        String str;
        if (!(zzjpVar instanceof zzp.zzk)) {
            throw new IllegalArgumentException("The passed proto must be an instance of ResetPasswordResponse.");
        }
        zzp.zzk zzkVar = (zzp.zzk) zzjpVar;
