...
public final class zzfr extends AbstractSafeParcelable implements com.google.firebase.auth.api.internal.zzfk<zzp.zzl> {
    ...
    public final /* synthetic */ zzjp zza() {
        zzp.zzl.zza zzaVarZza = zzp.zzl.zza().zza(this.zza);
        String str = this.zze;
        if (str != null) {
            zzaVarZza.zzc(str);
        }
        ...
        return (zzp.zzl) ((zzie) zzaVarZza.zzf());
    }
}
