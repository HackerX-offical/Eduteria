...
public final class zzfy extends AbstractSafeParcelable implements com.google.firebase.auth.api.internal.zzfk<zzp.zzr> {
    ...
    zzfy(String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, boolean z, boolean z2, String str9, String str10, String str11, String str12, boolean z3, String str13) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
        this.zzd = str4;
    ...
    public final /* synthetic */ zzjp zza() {
        zzp.zzr.zza zzaVarZzc = zzp.zzr.zza().zza(this.zzi).zzc(this.zzj);
        String str = this.zzb;
        if (str != null) {
            zzaVarZzc.zzd(str);
        }
        ...
        if (!TextUtils.isEmpty(this.zzl)) {
            zzaVarZzc.zzc(this.zzl);
        }
        if (!TextUtils.isEmpty(this.zzm)) {
            zzaVarZzc.zza(this.zzm);
        }
        return (zzp.zzr) ((zzie) zzaVarZzc.zzb(this.zzo).zzf());
    }
}
