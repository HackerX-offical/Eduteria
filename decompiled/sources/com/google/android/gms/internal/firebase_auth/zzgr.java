...
final class zzgr extends zzgp<Boolean> implements zzim<Boolean>, zzjy, RandomAccess {
    ...
    private zzgr(boolean[] zArr, int i) {
        this.zzb = zArr;
        this.zzc = i;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzgrVar.zzc) {
            return false;
        }
        boolean[] zArr = zzgrVar.zzb;
    ...
    public final boolean addAll(Collection<? extends Boolean> collection) {
        ...
        System.arraycopy(zzgrVar.zzb, 0, this.zzb, this.zzc, zzgrVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final /* synthetic */ zzim<Boolean> zza(int i) {
        if (i < this.zzc) {
            throw new IllegalArgumentException();
        }
        return new zzgr(Arrays.copyOf(this.zzb, i), this.zzc);
    }
    ...
    static {
        zzgr zzgrVar = new zzgr(new boolean[0], 0);
        zza = zzgrVar;
        zzgrVar.c_();
    }
}
