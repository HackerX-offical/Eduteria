...
public abstract class zzho extends zzgu {
    private static final Logger zzb = Logger.getLogger(zzho.class.getName());
    private static final boolean zzc = zzld.zza();
    zzhq zza;
    ...
    public abstract void zza(int i, zzgt zzgtVar) throws IOException;

    public abstract void zza(int i, zzjp zzjpVar) throws IOException;

    abstract void zza(int i, zzjp zzjpVar, zzkf zzkfVar) throws IOException;
    ...
    public abstract void zzb(int i, zzgt zzgtVar) throws IOException;
    ...
    static class zzb extends zzho {
        ...
        @Override // com.google.android.gms.internal.firebase_auth.zzho
        final void zza(int i, zzjp zzjpVar, zzkf zzkfVar) throws IOException {
            zza(i, 2);
            zzgl zzglVar = (zzgl) zzjpVar;
            int iZzy = zzglVar.zzy();
            if (iZzy == -1) {
                iZzy = zzkfVar.zzd(zzglVar);
                zzglVar.zzb(iZzy);
            }
            zzb(iZzy);
            zzkfVar.zza(zzjpVar, this.zza);
        }

        @Override // com.google.android.gms.internal.firebase_auth.zzho
        public final void zza(int i, zzjp zzjpVar) throws IOException {
            zza(1, 3);
            zzc(2, i);
            zza(3, 2);
            zza(zzjpVar);
        ...
        @Override // com.google.android.gms.internal.firebase_auth.zzho
        public final void zzb(int i, zzgt zzgtVar) throws IOException {
            zza(1, 3);
            zzc(2, i);
            zza(3, zzgtVar);
            zza(1, 4);
        ...
        public final void zzb(int i) throws IOException {
            ...
            if ((i & WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT) == 0) {
                ...
                int i4 = this.zze;
                this.zze = i4 + 1;
                zzld.zza(bArr3, i4, (byte) i);
                return;
            }
            byte[] bArr4 = this.zzb;
            int i5 = this.zze;
            this.zze = i5 + 1;
            zzld.zza(bArr4, i5, (byte) (i | 128));
            int i6 = i >>> 7;
            if ((i6 & WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT) == 0) {
                byte[] bArr5 = this.zzb;
                int i7 = this.zze;
                this.zze = i7 + 1;
                zzld.zza(bArr5, i7, (byte) i6);
                return;
            }
            byte[] bArr6 = this.zzb;
            int i8 = this.zze;
            this.zze = i8 + 1;
            zzld.zza(bArr6, i8, (byte) (i6 | 128));
            int i9 = i >>> 14;
            if ((i9 & WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT) == 0) {
                byte[] bArr7 = this.zzb;
                int i10 = this.zze;
                this.zze = i10 + 1;
                zzld.zza(bArr7, i10, (byte) i9);
                return;
            }
            byte[] bArr8 = this.zzb;
            int i11 = this.zze;
            this.zze = i11 + 1;
            zzld.zza(bArr8, i11, (byte) (i9 | 128));
            int i12 = i >>> 21;
            if ((i12 & WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT) == 0) {
                byte[] bArr9 = this.zzb;
                int i13 = this.zze;
                this.zze = i13 + 1;
                zzld.zza(bArr9, i13, (byte) i12);
                return;
            }
            byte[] bArr10 = this.zzb;
            int i14 = this.zze;
            this.zze = i14 + 1;
            zzld.zza(bArr10, i14, (byte) (i12 | 128));
            byte[] bArr11 = this.zzb;
            int i15 = this.zze;
            this.zze = i15 + 1;
            zzld.zza(bArr11, i15, (byte) (i >>> 28));
        }
        ...
        public final void zza(long j) throws IOException {
            if (zzho.zzc && zza() >= 10) {
                while ((j & (-128)) != 0) {
                    ...
                    int i = this.zze;
                    this.zze = i + 1;
                    zzld.zza(bArr, i, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
                byte[] bArr2 = this.zzb;
                int i2 = this.zze;
                this.zze = i2 + 1;
                zzld.zza(bArr2, i2, (byte) j);
                return;
            }
            while ((j & (-128)) != 0) {
                try {
        ...
        public final void zza(String str) throws IOException {
            ...
            try {
                ...
                if (iZzg2 == iZzg) {
                    int i2 = i + iZzg2;
                    this.zze = i2;
                    int iZza = zzlg.zza(str, this.zzb, i2, zza());
                    this.zze = i;
                    zzb((iZza - i) - iZzg2);
                    this.zze = iZza;
                    return;
                ...
                zzb(zzlg.zza(str));
                this.zze = zzlg.zza(str, this.zzb, this.zze, zza());
            } catch (zzlj e2) {
                this.zze = i;
                zza(str, e2);
    ...
    public static int zzc(int i, zzgt zzgtVar) {
        int iZze = zze(i);
        int iZza = zzgtVar.zza();
        return iZze + zzg(iZza) + iZza;
    }

    public static int zza(int i, zziu zziuVar) {
        int iZze = zze(i);
        int iZzb = zziuVar.zzb();
        return iZze + zzg(iZzb) + iZzb;
    }

    static int zzb(int i, zzjp zzjpVar, zzkf zzkfVar) {
        return zze(i) + zza(zzjpVar, zzkfVar);
    }

    public static int zzb(int i, zzjp zzjpVar) {
        return (zze(1) << 1) + zzg(2, i) + zze(3) + zzb(zzjpVar);
    }

    public static int zzd(int i, zzgt zzgtVar) {
        return (zze(1) << 1) + zzg(2, i) + zzc(3, zzgtVar);
    }

    public static int zzb(int i, zziu zziuVar) {
        return (zze(1) << 1) + zzg(2, i) + zza(3, zziuVar);
    }
    ...
    public static int zzb(String str) {
        ...
        try {
            ...
            length = str.getBytes(zzig.zza).length;
        }
        return zzg(length) + length;
    }

    public static int zza(zziu zziuVar) {
        int iZzb = zziuVar.zzb();
    ...
    public static int zzb(zzjp zzjpVar) {
        int iZzab = zzjpVar.zzab();
        return zzg(iZzab) + iZzab;
    }

    static int zza(zzjp zzjpVar, zzkf zzkfVar) {
        zzgl zzglVar = (zzgl) zzjpVar;
        int iZzy = zzglVar.zzy();
        if (iZzy == -1) {
            iZzy = zzkfVar.zzd(zzglVar);
    ...
    final void zza(String str, zzlj zzljVar) throws IOException {
        zzb.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) zzljVar);
        byte[] bytes = str.getBytes(zzig.zza);
        try {
            zzb(bytes.length);
    ...
    @Deprecated
    static int zzc(int i, zzjp zzjpVar, zzkf zzkfVar) {
        int iZze = zze(i) << 1;
        zzgl zzglVar = (zzgl) zzjpVar;
        int iZzy = zzglVar.zzy();
        if (iZzy == -1) {
    ...
    @Deprecated
    public static int zzc(zzjp zzjpVar) {
        return zzjpVar.zzab();
    }
