...
final class zzid extends zzgp<Float> implements zzim<Float>, zzjy, RandomAccess {
    private static final zzid zza;
    private float[] zzb;
    private int zzc;
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzidVar.zzc) {
            return false;
        }
        float[] fArr = zzidVar.zzb;
    ...
    public final boolean addAll(Collection<? extends Float> collection) {
        zzc();
        zzig.zza(collection);
        if (!(collection instanceof zzid)) {
            return super.addAll(collection);
        }
        zzid zzidVar = (zzid) collection;
        int i = zzidVar.zzc;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(zzidVar.zzb, 0, this.zzb, this.zzc, zzidVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final /* synthetic */ zzim<Float> zza(int i) {
        if (i < this.zzc) {
            throw new IllegalArgumentException();
        }
        return new zzid(Arrays.copyOf(this.zzb, i), this.zzc);
    }
    ...
    static {
        zzid zzidVar = new zzid(new float[0], 0);
        zza = zzidVar;
        zzidVar.c_();
    }
}
