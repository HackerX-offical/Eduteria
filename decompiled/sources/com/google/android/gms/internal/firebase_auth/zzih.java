...
final class zzih extends zzgp<Integer> implements zzik, zzjy, RandomAccess {
    ...
    public final zzik zza(int i) {
        if (i < this.zzc) {
            throw new IllegalArgumentException();
        }
        return new zzih(Arrays.copyOf(this.zzb, i), this.zzc);
    }
    ...
    @Override // com.google.android.gms.internal.firebase_auth.zzik
    ...
    static {
        zzih zzihVar = new zzih(new int[0], 0);
        zza = zzihVar;
        zzihVar.c_();
    }
}
