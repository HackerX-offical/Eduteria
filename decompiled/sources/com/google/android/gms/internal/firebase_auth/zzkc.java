...
interface zzkc {
    ...
    <T> T zza(zzkf<T> zzkfVar, zzhr zzhrVar) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzkf<T> zzkfVar, zzhr zzhrVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzjg<K, V> zzjgVar, zzhr zzhrVar) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzkf<T> zzkfVar, zzhr zzhrVar) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzkf<T> zzkfVar, zzhr zzhrVar) throws IOException;
    ...
    void zzk(List<zzgt> list) throws IOException;
