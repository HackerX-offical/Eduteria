...
final class zzld {
    ...
    static final class zza extends zzd {
        ...
        @Override // com.google.android.gms.internal.firebase_auth.zzld.zzd
        public final byte zza(Object obj, long j) {
            if (zzld.zza) {
                return zzld.zzk(obj, j);
            }
            return zzld.zzl(obj, j);
        }
        ...
        public final boolean zzb(Object obj, long j) {
            if (zzld.zza) {
                return zzld.zzm(obj, j);
            }
            return zzld.zzn(obj, j);
        }
    ...
    static Unsafe zzc() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzlf());
    ...
    private static Field zzf() {
        Field fieldZza;
        if (zzgs.zza() && (fieldZza = zza((Class<?>) Buffer.class, "effectiveDirectAddress")) != null) {
            return fieldZza;
        }
