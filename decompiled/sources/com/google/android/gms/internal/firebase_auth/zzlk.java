        ...
        while (i < i3) {
            ...
            if (zzli.zzd(b3)) {
                ...
                if (i6 < i3 - 1) {
                    int i9 = i + 2;
                    i += 3;
                    zzli.zzb(b3, bArr[i6], bArr[i9], cArr, i5);
                    i5++;
                } else {
                    throw zzip.zzi();
                }
                ...
                byte b6 = bArr[i + 2];
                i += 4;
                zzli.zzb(b3, b5, b6, bArr[i10], cArr, i5);
                i5 += 2;
            }
        }
