...
interface zzlu {
    ...
    void zza(int i, zzgt zzgtVar) throws IOException;

    <K, V> void zza(int i, zzjg<K, V> zzjgVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzkf zzkfVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzkf zzkfVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzkf zzkfVar) throws IOException;

    void zzb(int i, List<zzgt> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzkf zzkfVar) throws IOException;
