...
public abstract class zzjc extends zzil {
    ...
    private static class zza extends zzjc {
        ...
        public final void zza(byte b2) throws IOException {
            ...
            try {
                ...
                try {
                    ...
                    e = e2;
                    i = i2;
                    throw new zzb(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(i), Integer.valueOf(this.zzc), 1), e);
                }
        ...
        private final void zzc(byte[] bArr, int i, int i2) throws IOException {
            try {
                ...
                throw new zzb(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)), e2);
            }
        }
    ...
    abstract void zza(int i, zzlc zzlcVar, zzlu zzluVar) throws IOException;
    ...
    @Deprecated
    static int zzb(int i, zzlc zzlcVar, zzlu zzluVar) {
    ...
    static int zzc(int i, zzlc zzlcVar, zzlu zzluVar) {
    ...
    public final void zzb(int i, double d2) throws IOException {
        zza(i, Double.doubleToRawLongBits(d2));
    }
    ...
    public final void zzb(int i, float f2) throws IOException {
        zza(i, Float.floatToRawIntBits(f2));
    }
