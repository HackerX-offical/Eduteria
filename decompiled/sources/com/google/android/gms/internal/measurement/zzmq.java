...
final class zzmq extends zzmr {
    ...
    @Override // com.google.android.gms.internal.measurement.zzmr
    final String zza(byte[] bArr, int i, int i2) throws zzkb {
        ...
        while (i < i3) {
            ...
            if (b3 >= 0) {
                ...
                int i9 = i + 2;
                i += 3;
                zzmo.zza(b3, bArr[i6], bArr[i9], cArr, i5);
                i5++;
            } else {
                if (i6 >= i3 - 2) {
                    throw zzkb.zzd();
                ...
                byte b6 = bArr[i + 2];
                i += 4;
                zzmo.zza(b3, b5, b6, bArr[i10], cArr, i5);
                i5 += 2;
            }
        }
