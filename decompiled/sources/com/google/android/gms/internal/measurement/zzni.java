...
public final class zzni implements zznj {
    ...
    static {
        ...
        zzg = zzhrVarZza.zza("measurement.config.url_scheme", TournamentShareDialogURIBuilder.scheme);
        ...
        zzp = zzhrVarZza.zza("measurement.store.max_stored_events_per_app", SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US);
        ...
        zzak = zzhrVarZza.zza("measurement.rb.attribution.uri_scheme", TournamentShareDialogURIBuilder.scheme);
        ...
        zzav = zzhrVarZza.zza("measurement.upload.max_events_per_day", SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US);
