...
final class zziy {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.play_billing.zziy.<clinit>():void");
    }
    ...
    public static void zzD(Object obj, long j, byte b2) {
        zzix zzixVar = zzf;
        long j2 = (-4) & j;
        int i = zzixVar.zza.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        zzixVar.zza.putInt(obj, j2, ((255 & b2) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void zzE(Object obj, long j, byte b2) {
        ...
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        zzixVar.zza.putInt(obj, j2, ((255 & b2) << i) | (zzixVar.zza.getInt(obj, j2) & (~(255 << i))));
    }
    ...
    static Unsafe zzg() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zziu());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        Logger.getLogger(zziy.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
