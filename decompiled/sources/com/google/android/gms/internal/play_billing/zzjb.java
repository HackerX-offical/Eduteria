...
final class zzjb {
    ...
    static int zzc(String str) {
        ...
        throw new IllegalArgumentException("UTF-8 length does not fit in int: " + (((long) i3) + Conversions.THIRTYTWO_BIT));
    }
    ...
    */
    static boolean zzd(byte[] r6, int r7, int r8) {
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.play_billing.zzjb.zzd(byte[], int, int):boolean");
    }
}
