...
public class Cap extends AbstractSafeParcelable {
    ...
    private Cap(int i, BitmapDescriptor bitmapDescriptor, Float f2) {
        ...
        Preconditions.checkArgument(z, String.format("Invalid Cap: type=%s bitmapDescriptor=%s bitmapRefWidth=%s", Integer.valueOf(i), bitmapDescriptor, f2));
        this.type = i;
    ...
    public String toString() {
        return new StringBuilder(23).append("[Cap: type=").append(this.type).append(Constants.AES_SUFFIX).toString();
    }
