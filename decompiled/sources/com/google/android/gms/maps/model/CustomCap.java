...
public final class CustomCap extends Cap {
    ...
    public final String toString() {
        ...
        return new StringBuilder(String.valueOf(strValueOf).length() + 55).append("[CustomCap: bitmapDescriptor=").append(strValueOf).append(" refWidth=").append(this.refWidth).append(Constants.AES_SUFFIX).toString();
    }
}
