...
final class zzal extends zznr {
    ...
    */
    ...
    public final List<zzop> zzl(String str) {
        ...
        try {
            try {
                cursorQuery = e_().query("user_attributes", new String[]{"name", "origin", "set_timestamp", "value"}, "app_id=?", new String[]{str}, null, null, "rowid", Constants.LEFT_NAV_KEY.book_history);
                if (cursorQuery.moveToFirst()) {
                    do {
                        String string = cursorQuery.getString(0);
    ...
    */
            ...
            try {
                ...
                do {
                    ...
                    try {
                        ...
                        zzj().zzg().zza("Failed to merge filter results. appId, audienceId, error", zzgo.zza(str), Integer.valueOf(i), e2);
                    }
                } while (cursorQuery.moveToNext());
                if (cursorQuery != null) {
                    cursorQuery.close();
    ...
    final void zza(List<Long> list) {
        ...
        if (zzaa()) {
            String str = "(" + TextUtils.join(com.clevertap.android.sdk.Constants.SEPARATOR_COMMA, list) + ")";
    ...
    */
    ...
    final void zza(String str, List<zzfo.zza> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            zzfo.zza.C0147zza c0147zzaZzcd = list.get(i).zzcd();
            if (c0147zzaZzcd.zza() != 0) {
                for (int i2 = 0; i2 < c0147zzaZzcd.zza(); i2++) {
                    zzfo.zzb.zza zzaVarZzcd = c0147zzaZzcd.zza(i2).zzcd();
                    ...
                    if (z2) {
                        c0147zzaZzcd = c0147zzaZzcd.zza(i2, zzaVar);
                        list.set(i, (zzfo.zza) ((com.google.android.gms.internal.measurement.zzjt) c0147zzaZzcd.zzai()));
                    }
                }
            }
            if (c0147zzaZzcd.zzb() != 0) {
                for (int i4 = 0; i4 < c0147zzaZzcd.zzb(); i4++) {
                    zzfo.zze zzeVarZzb = c0147zzaZzcd.zzb(i4);
                    String strZza2 = zzjj.zza(zzeVarZzb.zze());
                    if (strZza2 != null) {
                        c0147zzaZzcd = c0147zzaZzcd.zza(i4, zzeVarZzb.zzcd().zza(strZza2));
                        list.set(i, (zzfo.zza) ((com.google.android.gms.internal.measurement.zzjt) c0147zzaZzcd.zzai()));
                    }
                }
            }
    ...
    */
    ...
    private final boolean zzb(String str, List<Integer> list) {
        ...
        try {
            ...
            return sQLiteDatabaseE_.delete("audience_filter_values", new StringBuilder("audience_id in (select audience_id from audience_filter_values where app_id=? and audience_id not in ").append(new StringBuilder("(").append(TextUtils.join(com.clevertap.android.sdk.Constants.SEPARATOR_COMMA, arrayList)).append(")").toString()).append(" order by rowid desc limit -1 offset ?)").toString(), new String[]{str, Integer.toString(iMax)}) > 0;
        } catch (SQLiteException e2) {
    ...
    */
    ...
    final boolean zzb(String str, Bundle bundle) {
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        contentValues.put(DynamicLink.Builder.KEY_DYNAMIC_LINK_PARAMETERS, bArrZzca);
        try {
