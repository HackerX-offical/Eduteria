    ...
    */
    ...
    protected final void zzx() {
        ...
        try {
            ...
            zzj().zzg().zza("Fetching Google App Id failed with exception. appId", zzgo.zza(packageName), e2);
        }
        this.zzg = null;
    ...
    final void zzag() {
        ...
        zzj().zzc().zza(String.format("Resetting session stitching token to %s", str == null ? Constants.NULL_VERSION_ID : "not null"));
        this.zzl = str;
