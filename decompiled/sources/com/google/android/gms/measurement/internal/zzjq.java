    ...
    */
    ...
    public final void zzav() {
        ...
        if (strZza == null) {
            ...
            zzjqVar = this;
            zzjqVar.zza(StoreProvider.StoreData.APP, "_npa", (Object) null, zzb().currentTimeMillis());
        } else {
            zza(StoreProvider.StoreData.APP, "_npa", Long.valueOf("true".equals(strZza) ? 1L : 0L), zzb().currentTimeMillis());
            zzjqVar = this;
        }
