...
public final class zzlj extends zzh {
    ...
    public final void zza(zzlk zzlkVar, zzlk zzlkVar2, long j, boolean z, Bundle bundle) {
        ...
        if (z3) {
            ...
            if (zzlkVar.zze) {
                str = StoreProvider.StoreData.APP;
            } else {
                str = "auto";
            }
            String str2 = str;
    ...
    public final void zza(Activity activity, String str, String str2) {
        ...
        zzj().zzp().zza("Setting current screen to name, class", str == null ? Constants.NULL_VERSION_ID : str, str2);
    ...
    public final void zza(Bundle bundle, long j) {
        ...
        synchronized (this.zzj) {
            ...
            zzj().zzp().zza("Logging screen view with name, class", str == null ? Constants.NULL_VERSION_ID : str, str2 == null ? Constants.NULL_VERSION_ID : str2);
