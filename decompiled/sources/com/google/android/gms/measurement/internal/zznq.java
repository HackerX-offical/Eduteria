...
public final class zznq extends zznr {
    ...
    public final void zza(long j) {
        ...
        zzb().elapsedRealtime();
        if (j < Math.max(0L, zzbh.zzy.zza(null).longValue()) && !zzx().zzc()) {
            zzx().zza(j);
        }
        ...
        com.google.android.gms.internal.measurement.zzcv.zza(contextZza2, new JobInfo.Builder(iZzv, componentName).setMinimumLatency(j).setOverrideDeadline(j << 1).setExtras(persistableBundle).build(), "com.google.android.gms", "UploadAlarm");
    }
