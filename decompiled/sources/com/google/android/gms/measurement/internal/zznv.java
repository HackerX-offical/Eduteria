...
public class zznv implements zzjc {
    ...
    private final long zzx() {
        ...
        if (jZza == 0) {
            jZza = ((long) zzmwVar.zzq().zzv().nextInt(DateTimeConstants.MILLIS_PER_DAY)) + 1;
    ...
    */
    ...
    final void zza(String str, zzfy.zzk.zza zzaVar) {
        ...
        if (zzi().zzs(str)) {
            ...
            if (!TextUtils.isEmpty(strZzy) && (iIndexOf = strZzy.indexOf(InstructionFileId.DOT)) != -1) {
        ...
        if (next != null) {
            if (zzahVarZza.zza(zzje.zza.AD_PERSONALIZATION) == zzak.UNSET) {
                ...
                if (zzopVarZze != null) {
                    ...
                    } else if (StoreProvider.StoreData.APP.equals(zzopVarZze.zzb)) {
    ...
    private final void zza(zzfy.zzk.zza zzaVar, long j, boolean z) {
        ...
        if (zzopVarZze == null || zzopVarZze.zze == null) {
            zzopVar = new zzop(zzaVar.zzt(), "auto", str3, zzb().currentTimeMillis(), Long.valueOf(j));
        } else {
            zzopVar = new zzop(zzaVar.zzt(), "auto", str3, zzb().currentTimeMillis(), Long.valueOf(((Long) zzopVarZze.zze).longValue() + j));
        }
    ...
    */
    ...
    final void zzb(zzg zzgVar, zzfy.zzk.zza zzaVar) {
        zzl().zzt();
        zzs();
        zzfy.zza.C0152zza c0152zzaZzc = zzfy.zza.zzc();
        byte[] bArrZzav = zzgVar.zzav();
        if (bArrZzav != null) {
            try {
                c0152zzaZzc = (zzfy.zza.C0152zza) zzoo.zza(c0152zzaZzc, bArrZzav);
                    ...
                    if ("referrer API v2".equals(zzoo.zzb(zzfVar, "_cis"))) {
                        if (jLongValue > c0152zzaZzc.zzb()) {
                            ...
                            if (str2.isEmpty()) {
                                ...
                                c0152zzaZzc.zze(str2);
                            }
                            if (str3.isEmpty()) {
                                c0152zzaZzc.zzf();
                            } else {
                                c0152zzaZzc.zzd(str3);
                            }
                            c0152zzaZzc.zzb(jLongValue);
                        }
                    } else if (jLongValue > c0152zzaZzc.zza()) {
                        if (str.isEmpty()) {
                            c0152zzaZzc.zze();
                        } else {
                            c0152zzaZzc.zzc(str);
                        ...
                        if (str2.isEmpty()) {
                            ...
                            c0152zzaZzc.zzb(str2);
                        }
                        if (str3.isEmpty()) {
                            c0152zzaZzc.zzc();
                        } else {
                            c0152zzaZzc.zza(str3);
                        }
                        c0152zzaZzc.zza(jLongValue);
                    }
                }
            }
        }
        if (!((zzfy.zza) ((com.google.android.gms.internal.measurement.zzjt) c0152zzaZzc.zzai())).equals(zzfy.zza.zze())) {
            zzaVar.zza((zzfy.zza) ((com.google.android.gms.internal.measurement.zzjt) c0152zzaZzc.zzai()));
        }
        zzgVar.zza(((zzfy.zza) ((com.google.android.gms.internal.measurement.zzjt) c0152zzaZzc.zzai())).zzca());
        if (zzgVar.zzas()) {
