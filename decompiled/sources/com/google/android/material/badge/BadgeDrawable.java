...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void calculateCenterAndBounds(Rect rect, View view) {
        float f2;
        float f3;
        float f4 = !hasNumber() ? this.state.badgeRadius : this.state.badgeWithTextRadius;
        ...
        if (ViewCompat.getLayoutDirection(view) == 0) {
            f3 = (rect.right + this.halfBadgeWidth) - totalHorizontalOffsetForState;
        } else {
            f3 = (rect.left - this.halfBadgeWidth) + totalHorizontalOffsetForState;
        }
