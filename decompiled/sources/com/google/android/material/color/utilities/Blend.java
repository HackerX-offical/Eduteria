...
public class Blend {
    ...
    public static int hctHue(int i, int i2, double d2) {
        return Hct.from(Cam16.fromInt(cam16Ucs(i, i2, d2)).getHue(), Cam16.fromInt(i).getChroma(), ColorUtils.lstarFromArgb(i)).toInt();
    }

    public static int cam16Ucs(int i, int i2, double d2) {
