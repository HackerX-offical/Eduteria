...
public final class Cam16 {
    ...
    static Cam16 fromXyzInViewingConditions(double d2, double d3, double d4, ViewingConditions viewingConditions) {
        ...
        double dSqrt = dPow5 * Math.sqrt(d17);
        ...
        return new Cam16(d16, dSqrt, dPow4, c2, flRoot, dSqrt2, d18, dLog1p * Math.cos(radians), dLog1p * Math.sin(radians));
    }
    ...
    private static Cam16 fromJchInViewingConditions(double d2, double d3, double d4, ViewingConditions viewingConditions) {
        ...
        double dLog1p = Math.log1p(0.0228d * flRoot) * 43.859649122807014d;
        return new Cam16(d4, d3, d2, c2, flRoot, dSqrt, d6, dLog1p * Math.cos(radians), dLog1p * Math.sin(radians));
    }
