...
public final class TemperatureCache {
    ...
    public Hct getComplement() {
        ...
        double d3 = zIsBetween ? hue2 : hue;
        double d4 = zIsBetween ? hue : hue2;
        ...
        double d7 = 0.0d;
        while (d7 <= 360.0d) {
            double dSanitizeDegreesDouble = MathUtils.sanitizeDegreesDouble((d5 * d7) + d3);
            if (isBetween(dSanitizeDegreesDouble, d3, d4)) {
                d2 = d5;
    ...
    private List<Hct> getHctsByTemp() {
        ...
        Collections.sort(arrayList, Comparator.comparing(new Function() { // from class: com.google.android.material.color.utilities.TemperatureCache$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return this.f$0.m12180xb7a75f35((Hct) obj);
            }
    ...
    /* synthetic */ Double m12180xb7a75f35(Hct hct) {
