...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    private final ArrayList<Animator.AnimatorListener> f623listeners = new ArrayList<>();
    ...
    public final void addAnimationListener(Animator.AnimatorListener animatorListener) {
        this.f623listeners.add(animatorListener);
    }

    @Override // com.google.android.material.floatingactionbutton.MotionStrategy
    public final void removeAnimationListener(Animator.AnimatorListener animatorListener) {
        this.f623listeners.remove(animatorListener);
    }

    @Override // com.google.android.material.floatingactionbutton.MotionStrategy
    public final List<Animator.AnimatorListener> getListeners() {
        return this.f623listeners;
    }
    ...
    AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(CropImage.SCALE)) {
            arrayList.add(motionSpec.getAnimator(CropImage.SCALE, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec.getAnimator(CropImage.SCALE, this.fab, View.SCALE_X));
        }
