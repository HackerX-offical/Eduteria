...
class FloatingActionButtonImpl {
    ...
    private AnimatorSet createAnimator(MotionSpec motionSpec, float f2, float f3, float f4) {
        ...
        motionSpec.getTiming(CropImage.SCALE).apply(objectAnimatorOfFloat2);
        ...
        motionSpec.getTiming(CropImage.SCALE).apply(objectAnimatorOfFloat3);
    ...
    private AnimatorSet createDefaultAnimator(final float f2, final float f3, final float f4, int i, int i2) {
        AnimatorSet animatorSet = new AnimatorSet();
        ArrayList arrayList = new ArrayList();
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.4
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                FloatingActionButtonImpl.this.view.setAlpha(AnimationUtils.lerp(alpha, f2, 0.0f, 0.2f, fFloatValue));
