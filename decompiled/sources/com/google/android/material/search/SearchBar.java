...
public class SearchBar extends Toolbar {
    ...
    /* synthetic */ void m12184lambda$new$0$comgoogleandroidmaterialsearchSearchBar(boolean z) {
    ...
    public SearchBar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.search.SearchBar$$ExternalSyntheticLambda1
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m12184lambda$new$0$comgoogleandroidmaterialsearchSearchBar(z);
            }
        };
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_APP, Const.SUBTITLE) != null) {
    ...
    private void initBackground(ShapeAppearanceModel shapeAppearanceModel, float f2, float f3, int i) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(shapeAppearanceModel);
        this.backgroundShape = materialShapeDrawable;
        materialShapeDrawable.initializeElevationOverlay(getContext());
        this.backgroundShape.setElevation(f2);
        if (f3 >= 0.0f) {
            this.backgroundShape.setStroke(f3, i);
        }
    ...
    /* synthetic */ void m12185x58362b63() {
