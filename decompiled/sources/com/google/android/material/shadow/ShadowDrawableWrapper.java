...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float f5 = f3 * 2.0f;
        boolean z = this.contentBounds.width() - f5 > 0.0f;
        boolean z2 = this.contentBounds.height() - f5 > 0.0f;
        float f6 = this.rawShadowSize;
        float f7 = f3 / ((f6 - (0.5f * f6)) + f3);
        float f8 = f3 / ((f6 - (SHADOW_TOP_SCALE * f6)) + f3);
        float f9 = f3 / ((f6 - (f6 * 1.0f)) + f3);
        int iSave2 = canvas.save();
        canvas.translate(this.contentBounds.left + f3, this.contentBounds.top + f3);
        canvas.scale(f7, f8);
        ...
        canvas.translate(this.contentBounds.right - f3, this.contentBounds.bottom - f3);
        canvas.scale(f7, f9);
        canvas.rotate(180.0f);
        canvas.drawPath(this.cornerShadowPath, this.cornerShadowPaint);
        if (z) {
            canvas.scale(f2 / f7, f2);
            canvas.drawRect(0.0f, f4, this.contentBounds.width() - f5, this.shadowSize + (-this.cornerRadius), this.edgeShadowPaint);
        }
        canvas.restoreToCount(iSave3);
        int iSave4 = canvas.save();
        canvas.translate(this.contentBounds.left + f3, this.contentBounds.bottom - f3);
        canvas.scale(f7, f9);
        ...
        canvas.translate(this.contentBounds.right - f3, this.contentBounds.top + f3);
        canvas.scale(f7, f8);
        canvas.rotate(90.0f);
        canvas.drawPath(this.cornerShadowPath, this.cornerShadowPaint);
        if (z2) {
