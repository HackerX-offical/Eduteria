...
public class ShadowRenderer {
    ...
    public void drawInnerCornerShadow(Canvas canvas, Matrix matrix, RectF rectF, int i, float f2, float f3, float[] fArr) {
        if (f3 > 0.0f) {
            f2 += f3;
            f3 = -f3;
        }
        float f4 = f2;
        float f5 = f3;
        drawCornerShadow(canvas, matrix, rectF, i, f4, f5);
        Path path = this.scratch;
        path.rewind();
