...
public class TabLayout extends HorizontalScrollView {
    ...
    public void setScrollPosition(int i, float f2, boolean z, boolean z2) {
        setScrollPosition(i, f2, z, z2, true);
    }

    void setScrollPosition(int i, float f2, boolean z, boolean z2, boolean z3) {
        ...
        int iCalculateScrollXForTab = calculateScrollXForTab(i, f2);
    ...
    */
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        void setIndicatorPositionFromTabPosition(int i, float f2) {
            TabLayout.this.indicatorPosition = Math.round(i + f2);
            ValueAnimator valueAnimator = this.indicatorAnimator;
            if (valueAnimator != null && valueAnimator.isRunning()) {
                this.indicatorAnimator.cancel();
            }
            tweenIndicatorPosition(getChildAt(i), getChildAt(i + 1), f2);
        }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int i, float f2, int i2) {
            ...
            if (tabLayout != null) {
                ...
                tabLayout.setScrollPosition(i, f2, z2, z, false);
            }
        }
