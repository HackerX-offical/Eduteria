...
public class TextInputLayout extends LinearLayout {
    ...
    private MaterialShapeDrawable getDropDownMaterialShapeDrawable(boolean z) {
        ...
        ShapeAppearanceModel shapeAppearanceModelBuild = ShapeAppearanceModel.builder().setTopLeftCornerSize(f2).setTopRightCornerSize(f2).setBottomLeftCornerSize(dimensionPixelOffset2).setBottomRightCornerSize(dimensionPixelOffset2).build();
        MaterialShapeDrawable materialShapeDrawableCreateWithElevationOverlay = MaterialShapeDrawable.createWithElevationOverlay(getContext(), dimensionPixelOffset);
    ...
    private void updateCursorColor(boolean z) {
        ...
        if (z) {
            ColorStateList colorStateListValueOf = this.strokeErrorColor;
            if (colorStateListValueOf == null) {
                colorStateListValueOf = ColorStateList.valueOf(this.boxStrokeColor);
            }
            colorStateListOrNull = colorStateListValueOf;
        }
