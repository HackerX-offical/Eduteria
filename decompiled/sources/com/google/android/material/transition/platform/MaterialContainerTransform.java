...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f2) {
            ...
            this.currentStartBounds.set(f7 - (fitModeResultEvaluate.currentStartWidth / 2.0f), f8, (this.fitModeResult.currentStartWidth / 2.0f) + f7, this.fitModeResult.currentStartHeight + f8);
            ...
            float f10 = (int) (fCalculateElevationDyMultiplier * f9);
            this.currentElevationDy = f10;
            this.shadowPaint.setShadowLayer(f9, (int) (fCalculateElevationDxMultiplier * f9), f10, SHADOW_COLOR);
