...
public class SplitCompat {
    ...
    private static boolean zzi(Context context, boolean z) {
        ...
        while (true) {
            if (MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, null, splitCompat)) {
                z2 = true;
                break;
            }
        ...
        if (z2) {
            context2 = context;
            com.google.android.play.core.splitinstall.zzo.INSTANCE.zzb(new zzak(context2, zzd.zza(), new zzam(context, splitCompat2.zzc, new zzah()), splitCompat2.zzc, new zzs()));
