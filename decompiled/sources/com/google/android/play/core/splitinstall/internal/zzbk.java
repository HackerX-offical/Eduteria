...
public final class zzbk {
    ...
    public static Object zzc(Class cls) {
        try {
            ...
            throw new zzbl(String.format("Failed to invoke default constructor on class %s", cls.getName()), e2);
        }
    }
    ...
    public static Object zzd(Object obj, String str, Class cls, Class cls2, Object obj2) {
        try {
            ...
            throw new zzbl(String.format("Failed to invoke method %s on an object of type %s", str, obj.getClass()), e2);
        }
    }
    ...
    public static Object zzf(Class cls, String str, Class cls2, Class cls3, Object obj) {
        try {
            ...
            throw new zzbl(String.format("Failed to invoke static method %s on type %s", "isDexOptNeeded", cls), e2);
        }
    }
    ...
    public static Object zzg(Class cls, String str, Class cls2, Class cls3, Object obj, Class cls4, Object obj2) {
        try {
            ...
            throw new zzbl(String.format("Failed to invoke static method %s on type %s", "optimizedPathFor", cls), e2);
        }
    }
