...
public class Base64 {
    ...
    public static byte[] encode(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        if (i6 < i2) {
            encode3to4(bArr, i + i6, i2 - i6, bArr3, i7, bArr2);
            if (i8 + 4 == i3) {
                bArr3[i7 + 4] = 10;
            }
        }
    ...
    private static int decode4to3(byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3) {
        ...
        byte b3 = bArr[i + 3];
        if (b3 == 61) {
            int i3 = ((bArr3[bArr[i + 1]] << Ascii.CAN) >>> 12) | ((bArr3[bArr[i]] << Ascii.CAN) >>> 6) | ((bArr3[b2] << Ascii.CAN) >>> 18);
            bArr2[i2] = (byte) (i3 >>> 16);
            bArr2[i2 + 1] = (byte) (i3 >>> 8);
            return 2;
        }
        int i4 = ((bArr3[bArr[i + 1]] << Ascii.CAN) >>> 12) | ((bArr3[bArr[i]] << Ascii.CAN) >>> 6) | ((bArr3[b2] << Ascii.CAN) >>> 18) | ((bArr3[b3] << Ascii.CAN) >>> 24);
        bArr2[i2] = (byte) (i4 >> 16);
