...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        private final Function<A, ? extends B> f626f;

        /* JADX INFO: renamed from: g, reason: collision with root package name */
        private final Function<B, C> f627g;

        public FunctionComposition(Function<B, C> g2, Function<A, ? extends B> f2) {
            this.f627g = (Function) Preconditions.checkNotNull(g2);
            this.f626f = (Function) Preconditions.checkNotNull(f2);
        }

        @Override // com.google.common.base.Function
        @ParametricNullness
        public C apply(@ParametricNullness A a2) {
            return (C) this.f627g.apply(this.f626f.apply(a2));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            if (obj instanceof FunctionComposition) {
                ...
                if (this.f626f.equals(functionComposition.f626f) && this.f627g.equals(functionComposition.f627g)) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return this.f626f.hashCode() ^ this.f627g.hashCode();
        }

        public String toString() {
            return this.f627g + "(" + this.f626f + ")";
        }
    }
