...
public final class Predicates {
    ...
    public static String toStringHelper(String methodName, Iterable<?> components) {
        StringBuilder sbAppend = new StringBuilder("Predicates.").append(methodName).append('(');
        boolean z = true;
        for (Object obj : components) {
            if (!z) {
                sbAppend.append(CsvReader.Letters.COMMA);
            }
            sbAppend.append(obj);
            z = false;
        }
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        final Function<A, ? extends B> f628f;
        final Predicate<B> p;

        private CompositionPredicate(Predicate<B> p, Function<A, ? extends B> f2) {
            this.p = (Predicate) Preconditions.checkNotNull(p);
            this.f628f = (Function) Preconditions.checkNotNull(f2);
        }

        @Override // com.google.common.base.Predicate
        public boolean apply(@ParametricNullness A a2) {
            return this.p.apply(this.f628f.apply(a2));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            if (obj instanceof CompositionPredicate) {
                ...
                if (this.f628f.equals(compositionPredicate.f628f) && this.p.equals(compositionPredicate.p)) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return this.f628f.hashCode() ^ this.p.hashCode();
        }

        public String toString() {
            return this.p + "(" + this.f628f + ")";
        }
    }
