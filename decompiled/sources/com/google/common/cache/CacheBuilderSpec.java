...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.on(CsvReader.Letters.COMMA).trimResults();
    ...
    static abstract class IntegerParser implements ValueParser {
        ...
        public void parse(CacheBuilderSpec spec, String key, String value) {
            ...
            try {
                ...
                throw new IllegalArgumentException(CacheBuilderSpec.format("key %s value set to %s, must be integer", key, value), e2);
            }
        }
    }
