...
public final class Comparators {
    ...
    public static <T extends Comparable<? super T>> T min(T a2, T b2) {
        return a2.compareTo(b2) <= 0 ? a2 : b2;
    }

    @ParametricNullness
    public static <T> T min(@ParametricNullness T a2, @ParametricNullness T b2, Comparator<? super T> comparator) {
        return comparator.compare(a2, b2) <= 0 ? a2 : b2;
    }

    public static <T extends Comparable<? super T>> T max(T a2, T b2) {
        return a2.compareTo(b2) >= 0 ? a2 : b2;
    }

    @ParametricNullness
    public static <T> T max(@ParametricNullness T a2, @ParametricNullness T b2, Comparator<? super T> comparator) {
        return comparator.compare(a2, b2) >= 0 ? a2 : b2;
    }
}
