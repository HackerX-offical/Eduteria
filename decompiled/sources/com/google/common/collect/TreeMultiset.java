    ...
    private static final class AvlNode<E> {
            ...
            if (iCompare < 0) {
                ...
                if (avlNode == null) {
                    ...
                    if (expectedCount == 0 && newCount > 0) {
                        return addLeftChild(e2, newCount);
                    }
                } else {
                ...
                if (avlNode2 == null) {
                    result[0] = 0;
                    if (expectedCount == 0 && newCount > 0) {
                        return addRightChild(e2, newCount);
                    }
                } else {
        ...
        public AvlNode<E> ceiling(Comparator<? super E> comparator, @ParametricNullness E e2) {
            ...
            if (iCompare < 0) {
                AvlNode<E> avlNode = this.left;
                if (avlNode != null) {
                    return (AvlNode) MoreObjects.firstNonNull(avlNode.ceiling(comparator, e2), this);
                }
            } else if (iCompare != 0) {
                AvlNode<E> avlNode2 = this.right;
                if (avlNode2 == null) {
        ...
        public AvlNode<E> floor(Comparator<? super E> comparator, @ParametricNullness E e2) {
            ...
            if (iCompare > 0) {
                AvlNode<E> avlNode = this.right;
                if (avlNode != null) {
                    return (AvlNode) MoreObjects.firstNonNull(avlNode.floor(comparator, e2), this);
                }
            } else if (iCompare != 0) {
