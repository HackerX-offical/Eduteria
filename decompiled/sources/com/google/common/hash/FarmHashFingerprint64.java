...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength65Plus(byte[] bytes, int offset, int length) {
        ...
        while (true) {
            ...
            long jRotateRight2 = Long.rotateRight(j4 + jArr[c2] + LittleEndianByteArray.load64(bArr, i6 + 48), 42) * j5;
            long j6 = jRotateRight ^ jArr2[c2];
            char c3 = c2;
            ...
            weakHashLength32WithSeeds(bArr, i6, jArr[c3] * j5, j6 + jArr2[0], jArr);
            int i7 = i6;
            long[] jArr3 = jArr;
            weakHashLength32WithSeeds(bArr, i7 + 32, jArr2[c3] + jRotateRight3, jLoad642 + LittleEndianByteArray.load64(bArr, i7 + 16), jArr2);
            i6 = i7 + 64;
            if (i6 == i2) {
                long j7 = ((j6 & 255) << c3) + j5;
                ...
                long jRotateRight5 = Long.rotateRight(jLoad642 + jArr3[c3] + LittleEndianByteArray.load64(bArr, i4 - 15), 42) * j7;
                long j10 = jRotateRight4 ^ (jArr2[c3] * 9);
                ...
                weakHashLength32WithSeeds(bArr, i5, jArr3[c3] * j7, jArr2[0] + j10, jArr3);
                weakHashLength32WithSeeds(bArr, i4 - 31, jArr2[c3] + jRotateRight6, LittleEndianByteArray.load64(bArr, i4 - 47) + jLoad643, jArr2);
                return hashLength16(hashLength16(jArr3[0], jArr2[0], j7) + (shiftMix(jLoad643) * K0) + j10, hashLength16(jArr3[c3], jArr2[c3], j7) + jRotateRight6, j7);
            }
            bArr = bytes;
