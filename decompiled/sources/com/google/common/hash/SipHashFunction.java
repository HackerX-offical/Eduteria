...
final class SipHashFunction extends AbstractHashFunction implements Serializable {
    ...
    SipHashFunction(int c2, int d2, long k0, long k1) {
    ...
    public Hasher newHasher() {
        return new SipHasher(this.f630c, this.f631d, this.k0, this.k1);
    }

    public String toString() {
        return "Hashing.sipHash" + this.f630c + "" + this.f631d + "(" + this.k0 + ", " + this.k1 + ")";
    }

    public boolean equals(@CheckForNull Object object) {
        if (object instanceof SipHashFunction) {
            SipHashFunction sipHashFunction = (SipHashFunction) object;
            if (this.f630c == sipHashFunction.f630c && this.f631d == sipHashFunction.f631d && this.k0 == sipHashFunction.k0 && this.k1 == sipHashFunction.k1) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (int) ((((long) ((getClass().hashCode() ^ this.f630c) ^ this.f631d)) ^ this.k0) ^ this.k1);
    }
    ...
    private static final class SipHasher extends AbstractStreamingHasher {
        ...
        protected void processRemaining(ByteBuffer buffer) {
            this.f632b += (long) buffer.remaining();
            int i = 0;
        ...
        protected HashCode makeHash() {
            long j = this.finalM ^ (this.f632b << 56);
            this.finalM = j;
            processM(j);
            this.v2 ^= 255;
            sipRound(this.f634d);
