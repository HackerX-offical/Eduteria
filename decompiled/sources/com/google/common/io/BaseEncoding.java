            ...
            while (true) {
                if (i <= 90) {
                    ...
                    if (b2 == -1) {
                        ...
                        Preconditions.checkState(b3 == -1, "Can't ignoreCase() since '%s' and '%s' encode different values", (char) i, (char) i2);
                        bArrCopyOf[i2] = b2;
                    }
                    i++;
                } else {
        ...
        public OutputStream encodingStream(final Writer out) {
            ...
            return new OutputStream(this) { // from class: com.google.common.io.BaseEncoding.StandardBaseEncoding.1
                ...
                public void write(int b2) throws IOException {
                    this.bitBuffer = (b2 & 255) | (this.bitBuffer << 8);
    ...
    static Writer separatingWriter(final Writer delegate, String separator, int afterEveryChars) {
        ...
        return new Writer() { // from class: com.google.common.io.BaseEncoding.5
            ...
            public void write(int c2) throws IOException {
                appendableSeparatingAppendable.append((char) c2);
            }
