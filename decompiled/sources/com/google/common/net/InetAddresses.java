    ...
    */
    ...
    private static InetAddress bytesToInetAddress(byte[] addr, String scope) {
        try {
            ...
            try {
                ...
                throw new IllegalArgumentException("No such interface: " + scope, e2);
            }
    ...
    public static String toUriString(InetAddress ip) {
        if (ip instanceof Inet6Address) {
            return Constants.AES_PREFIX + toAddrString(ip) + Constants.AES_SUFFIX;
        }
    ...
    private static InetAddress forUriStringOrNull(String str, boolean z) {
        ...
        if (str.startsWith(Constants.AES_PREFIX) && str.endsWith(Constants.AES_SUFFIX)) {
