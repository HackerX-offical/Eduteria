...
public final class MediaType {
    ...
    public static final MediaType XML_UTF_8 = createConstantUtf8("text", AbstractHttpOverXmpp.Xml.ELEMENT);
    ...
    public static final MediaType BASIC_AUDIO = createConstant("audio", ValidateElement.BasicValidateElement.METHOD);
    ...
    public static final MediaType APPLICATION_XML_UTF_8 = createConstantUtf8("application", AbstractHttpOverXmpp.Xml.ELEMENT);
    ...
    public static final MediaType APPLICATION_BINARY = createConstant("application", MIME.ENC_BINARY);
    ...
    public static final MediaType JWT = createConstant("application", Const.JWT);
    ...
    public static final MediaType PDF = createConstant("application", Const.PDF);
    ...
    private static void consumeSeparator(Tokenizer tokenizer, char c2) {
        CharMatcher charMatcher = LINEAR_WHITE_SPACE;
        tokenizer.consumeTokenIfPresent(charMatcher);
        tokenizer.consumeCharacter(c2);
        tokenizer.consumeTokenIfPresent(charMatcher);
    }
    ...
    private static String escapeAndQuote(String value) {
        StringBuilder sbAppend = new StringBuilder(value.length() + 16).append('\"');
