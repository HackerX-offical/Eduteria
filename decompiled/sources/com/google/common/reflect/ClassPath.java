            ...
            for (File file : fileArrListFiles) {
                ...
                if (file.isDirectory()) {
                    ...
                    if (currentPath.add(canonicalFile)) {
                        scanDirectory(canonicalFile, packagePrefix + name + MqttTopic.TOPIC_LEVEL_SEPARATOR, currentPath, builder);
                        currentPath.remove(canonicalFile);
                    }
                } else {
                    String str = packagePrefix + name;
                    if (!str.equals("META-INF/MANIFEST.MF")) {
                        builder.add(ResourceInfo.of(file, str, this.classloader));
                    }
                }
            }
        }
