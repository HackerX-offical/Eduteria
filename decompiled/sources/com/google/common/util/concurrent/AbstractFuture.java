...
import com.google.android.gms.internal.play_billing.zzdi$$ExternalSyntheticBackportWithForwarding0;
...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    @CheckForNull
    private volatile Listener f635listeners;
    ...
    static {
        ...
        try {
            ...
            th = e2;
            try {
                safeAtomicHelper = new SafeAtomicHelper(AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Thread.class, Message.Thread.ELEMENT), AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Waiter.class, ES6Iterator.NEXT_METHOD), AtomicReferenceFieldUpdater.newUpdater(AbstractFuture.class, Waiter.class, "waiters"), AtomicReferenceFieldUpdater.newUpdater(AbstractFuture.class, Listener.class, "listeners"), AtomicReferenceFieldUpdater.newUpdater(AbstractFuture.class, Object.class, "value"));
    ...
    public void addListener(Runnable listener, Executor executor) {
        ...
        if (!isDone() && (listener2 = this.f635listeners) != Listener.TOMBSTONE) {
    ...
    public static Object getFutureValue(ListenableFuture<?> future) {
        ...
        try {
            ...
            if (!zIsCancelled) {
                return new Failure(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: " + future, e3));
            }
    ...
    public String toString() {
        ...
        return sb.append(Constants.AES_SUFFIX).toString();
    }
    ...
    private void addPendingString(StringBuilder builder) {
        ...
        if (obj instanceof SetFuture) {
            ...
            if (strEmptyToNull != null) {
                builder.append(", info=[").append(strEmptyToNull).append(Constants.AES_SUFFIX);
            }
        }
        if (isDone()) {
    ...
    private void addDoneString(StringBuilder builder) {
        try {
            ...
            builder.append("FAILURE, cause=[").append(e2.getCause()).append(Constants.AES_SUFFIX);
        } catch (Exception e3) {
    ...
    private void appendResultObject(StringBuilder builder, @CheckForNull Object o) {
        if (o == null) {
            builder.append(com.amazonaws.services.s3.internal.Constants.NULL_VERSION_ID);
        } else if (o == this) {
    ...
    private static void executeListener(Runnable runnable, Executor executor) {
        try {
            ...
            log.get().log(Level.SEVERE, "RuntimeException while executing runnable " + runnable + " with executor " + executor, (Throwable) e2);
        }
    }
    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        static {
            ...
            try {
                ...
                WAITER_THREAD_OFFSET = unsafe.objectFieldOffset(Waiter.class.getDeclaredField(Message.Thread.ELEMENT));
        ...
        boolean casWaiters(AbstractFuture<?> future, @CheckForNull Waiter expect, @CheckForNull Waiter update) {
            return zzdi$$ExternalSyntheticBackportWithForwarding0.m(UNSAFE, future, WAITERS_OFFSET, expect, update);
        }

        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casListeners(AbstractFuture<?> future, @CheckForNull Listener expect, Listener update) {
            return zzdi$$ExternalSyntheticBackportWithForwarding0.m(UNSAFE, future, LISTENERS_OFFSET, expect, update);
        }
        ...
        Listener gasListeners(AbstractFuture<?> future, Listener update) {
            Listener listener;
            do {
                listener = ((AbstractFuture) future).f635listeners;
                if (update == listener) {
                    break;
                }
        ...
        boolean casValue(AbstractFuture<?> future, @CheckForNull Object expect, Object update) {
            return zzdi$$ExternalSyntheticBackportWithForwarding0.m(UNSAFE, future, VALUE_OFFSET, expect, update);
        }
    }
    ...
    private static final class SynchronizedHelper extends AtomicHelper {
        ...
        boolean casListeners(AbstractFuture<?> future, @CheckForNull Listener expect, Listener update) {
            synchronized (future) {
                if (((AbstractFuture) future).f635listeners != expect) {
                    return false;
                }
                ((AbstractFuture) future).f635listeners = update;
                return true;
            }
        }
