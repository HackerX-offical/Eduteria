...
public class CycleDetectingLockFactory {
    ...
    public enum Policies implements Policy {
        ...
        WARN { // from class: com.google.common.util.concurrent.CycleDetectingLockFactory.Policies.2
            @Override // com.google.common.util.concurrent.CycleDetectingLockFactory.Policy
            public void handlePotentialDeadlock(PotentialDeadlockException e2) {
                CycleDetectingLockFactory.logger.get().log(Level.SEVERE, "Detected potential deadlock", (Throwable) e2);
            }
        },
    ...
    private static String getLockName(Enum<?> rank) {
        return rank.getDeclaringClass().getSimpleName() + InstructionFileId.DOT + rank.name();
    }
