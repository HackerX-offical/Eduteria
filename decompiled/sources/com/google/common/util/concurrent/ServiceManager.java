...
public final class ServiceManager implements ServiceManagerBridge {
    ...
    public ServiceManager startAsync() {
        ...
        while (it2.hasNext()) {
            ...
            try {
                ...
                logger.get().log(Level.WARNING, "Unable to start Service " + next, (Throwable) e2);
            }
        }
        return this;
    }
    ...
    private static final class ServiceManagerState {
        ...
        final ListenerCallQueue<Listener> f638listeners;
        ...
        ServiceManagerState(ImmutableCollection<Service> services) {
            ...
            this.f638listeners = new ListenerCallQueue<>();
        ...
        void addListener(Listener listener, Executor executor) {
            this.f638listeners.addListener(listener, executor);
        }
        ...
        void enqueueStoppedEvent() {
            this.f638listeners.enqueue(ServiceManager.STOPPED_EVENT);
        }

        void enqueueHealthyEvent() {
            this.f638listeners.enqueue(ServiceManager.HEALTHY_EVENT);
        }

        void enqueueFailedEvent(final Service service) {
            this.f638listeners.enqueue(new ListenerCallQueue.Event<Listener>(this) { // from class: com.google.common.util.concurrent.ServiceManager.ServiceManagerState.2
