...
public final class SimpleTimeLimiter implements TimeLimiter {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static Exception throwCause(Exception e2, boolean combineStackTraces) throws Exception {
        Throwable cause = e2.getCause();
        if (cause == null) {
            throw e2;
        }
        if (combineStackTraces) {
            cause.setStackTrace((StackTraceElement[]) ObjectArrays.concat(cause.getStackTrace(), e2.getStackTrace(), StackTraceElement.class));
        }
