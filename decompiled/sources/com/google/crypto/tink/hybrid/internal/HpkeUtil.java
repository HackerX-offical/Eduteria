...
public final class HpkeUtil {
    ...
    static byte[] labelInfo(String label, byte[] info2, byte[] suiteId, int length) throws GeneralSecurityException {
        return Bytes.concat(intToByteArray(2, length), HPKE_V1, suiteId, label.getBytes(Util.UTF_8), info2);
    }
