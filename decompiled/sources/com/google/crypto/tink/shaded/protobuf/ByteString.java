...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public final ByteString concat(ByteString other) {
        if (Integer.MAX_VALUE - size() < other.size()) {
            throw new IllegalArgumentException("ByteString would be too long: " + size() + MqttTopic.SINGLE_LEVEL_WILDCARD + other.size());
        }
    ...
    public static final class Output extends OutputStream {
        ...
        public synchronized void write(byte[] b2, int offset, int length) {
            ...
            int i = this.bufferPos;
            if (length <= length2 - i) {
                System.arraycopy(b2, offset, bArr, i, length);
                this.bufferPos += length;
            } else {
                int length3 = bArr.length - i;
                System.arraycopy(b2, offset, bArr, i, length3);
                int i2 = length - length3;
                flushFullBuffer(i2);
                System.arraycopy(b2, offset + length3, this.buffer, 0, i2);
                this.bufferPos = i2;
            }
        }
