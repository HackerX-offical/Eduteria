...
final class Utf8 {
    ...
    static int encodedLength(CharSequence sequence) {
        ...
        throw new IllegalArgumentException("UTF-8 length does not fit in int: " + (((long) iEncodedLengthGeneral) + Conversions.THIRTYTWO_BIT));
    }
        ...
        final String decodeUtf8Default(ByteBuffer buffer, int index, int size) throws InvalidProtocolBufferException {
            ...
            while (index < i) {
                ...
                if (DecodeUtil.isOneByte(b3)) {
                    ...
                    int i7 = index + 2;
                    index += 3;
                    DecodeUtil.handleThreeBytes(b3, buffer.get(i4), buffer.get(i7), cArr, i3);
                    i3++;
                } else {
                    if (i4 >= i - 2) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    index += 4;
                    DecodeUtil.handleFourBytes(b3, b5, b6, buffer.get(i8), cArr, i3);
                    i3 += 2;
                }
            }
        ...
        final void encodeUtf8Default(CharSequence in, ByteBuffer out) {
            ...
            while (i < length) {
                ...
                if (cCharAt2 < 128) {
                    ...
                    int i3 = iPosition + 1;
                    out.put(iPosition, (byte) ((cCharAt2 >>> CsvReader.Letters.FORM_FEED) | 224));
                    iPosition += 2;
        ...
        String decodeUtf8(byte[] bytes, int index, int size) throws InvalidProtocolBufferException {
            ...
            while (index < i) {
                ...
                if (DecodeUtil.isOneByte(b3)) {
                    ...
                    int i7 = index + 2;
                    index += 3;
                    DecodeUtil.handleThreeBytes(b3, bytes[i4], bytes[i7], cArr, i3);
                    i3++;
                } else {
                    if (i4 >= i - 2) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    index += 4;
                    DecodeUtil.handleFourBytes(b3, b5, b6, bytes[i8], cArr, i3);
                    i3 += 2;
                }
            }
            return new String(cArr, 0, i3);
        ...
        int encodeUtf8(CharSequence in, byte[] out, int offset, int length) {
            ...
            while (i4 < length2) {
                ...
                if (cCharAt2 < 128 && i5 < i3) {
                    ...
                    out[i5] = (byte) ((cCharAt2 >>> CsvReader.Letters.FORM_FEED) | WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND);
                    int i9 = i5 + 2;
        ...
        String decodeUtf8Direct(ByteBuffer buffer, int index, int size) throws InvalidProtocolBufferException {
            ...
            while (jAddressOffset < j) {
                ...
                if (DecodeUtil.isOneByte(b3)) {
                    ...
                    jAddressOffset += 3;
                    DecodeUtil.handleThreeBytes(b3, UnsafeUtil.getByte(j2), UnsafeUtil.getByte(j4), cArr, i2);
                    i2++;
                } else {
                    if (j2 >= j - 2) {
                        throw InvalidProtocolBufferException.invalidUtf8();
        ...
        int encodeUtf8(final CharSequence in, final byte[] out, final int offset, final int length) {
            ...
            while (i2 < length2) {
                ...
                if (cCharAt2 < 128 && j4 < j5) {
                    ...
                    UnsafeUtil.putByte(out, j4, (byte) ((cCharAt2 >>> CsvReader.Letters.FORM_FEED) | WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND));
                    long j7 = j4 + 2;
                    j3 = j5;
            ...
            while (i2 < length) {
                ...
                if (cCharAt2 >= c2 || jPosition >= jLimit) {
                    ...
                    if (cCharAt2 < 2048 && jPosition <= jLimit - 2) {
                        ...
                        UnsafeUtil.putByte(jPosition, (byte) ((cCharAt2 >>> CsvReader.Letters.FORM_FEED) | WindowSizeClass.HEIGHT_DP_MEDIUM_LOWER_BOUND));
                        j3 = jAddressOffset;
                        long j7 = jPosition + 2;
                        j4 = jLimit;
