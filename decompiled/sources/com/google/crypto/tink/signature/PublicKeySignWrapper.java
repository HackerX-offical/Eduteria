    ...
    private static class WrappedPublicKeySign implements PublicKeySign {
        ...
        public WrappedPublicKeySign(final PrimitiveSet<PublicKeySign> primitives) {
            ...
            if (primitives.hasAnnotations()) {
                this.logger = MutableMonitoringRegistry.globalInstance().getMonitoringClient().createLogger(MonitoringUtil.getMonitoringKeysetInfo(primitives), "public_key_sign", SignElement.ELEMENT);
            } else {
