...
final class Ed25519 {
    ...
    private static void select(CachedXYT t, int pos, byte b2) {
        int i = (b2 & 255) >> 7;
        int i2 = b2 - (((-i) & b2) << 1);
    ...
    private static void mulAdd(byte[] s, byte[] a2, byte[] b2, byte[] c2) {
        long jLoad3 = load3(a2, 0) & 2097151;
        long jLoad4 = (load4(a2, 2) >> 5) & 2097151;
        long jLoad32 = (load3(a2, 5) >> 2) & 2097151;
        long jLoad42 = (load4(a2, 7) >> 7) & 2097151;
        long jLoad43 = (load4(a2, 10) >> 4) & 2097151;
        ...
        long jLoad45 = (load4(a2, 23) >> 5) & 2097151;
        long jLoad36 = (load3(a2, 26) >> 2) & 2097151;
        long jLoad46 = load4(a2, 28) >> 7;
        long jLoad37 = load3(b2, 0) & 2097151;
        long jLoad47 = (load4(b2, 2) >> 5) & 2097151;
        long jLoad38 = (load3(b2, 5) >> 2) & 2097151;
        long jLoad48 = (load4(b2, 7) >> 7) & 2097151;
        long jLoad49 = (load4(b2, 10) >> 4) & 2097151;
        long jLoad39 = (load3(b2, 13) >> 1) & 2097151;
        long jLoad410 = (load4(b2, 15) >> 6) & 2097151;
        long jLoad310 = (load3(b2, 18) >> 3) & 2097151;
        long jLoad311 = load3(b2, 21) & 2097151;
        long jLoad411 = (load4(b2, 23) >> 5) & 2097151;
        long jLoad312 = (load3(b2, 26) >> 2) & 2097151;
        ...
        long jLoad414 = (load4(c2, 7) >> 7) & 2097151;
        long jLoad415 = (load4(c2, 10) >> 4) & 2097151;
        long jLoad315 = (load3(c2, 13) >> 1) & 2097151;
        long jLoad416 = (load4(c2, 15) >> 6) & 2097151;
        long jLoad316 = (load3(c2, 18) >> 3) & 2097151;
        long jLoad317 = load3(c2, 21) & 2097151;
        ...
        long jLoad417 = ((load4(c2, 23) >> 5) & 2097151) + (jLoad3 * jLoad411) + (jLoad4 * jLoad311) + (jLoad32 * jLoad310) + (jLoad42 * jLoad410) + (jLoad43 * jLoad39) + (jLoad33 * jLoad49) + (jLoad44 * jLoad48) + (jLoad34 * jLoad38) + (jLoad35 * jLoad47) + (jLoad45 * jLoad37);
        long jLoad318 = ((load3(c2, 26) >> 2) & 2097151) + (jLoad3 * jLoad312) + (jLoad4 * jLoad411) + (jLoad32 * jLoad311) + (jLoad42 * jLoad310) + (jLoad43 * jLoad410) + (jLoad33 * jLoad39) + (jLoad44 * jLoad49) + (jLoad34 * jLoad48) + (jLoad35 * jLoad38) + (jLoad45 * jLoad47) + (jLoad36 * jLoad37);
        long jLoad418 = (load4(c2, 28) >> 7) + (jLoad3 * jLoad412) + (jLoad4 * jLoad312) + (jLoad32 * jLoad411) + (jLoad42 * jLoad311) + (jLoad43 * jLoad310) + (jLoad33 * jLoad410) + (jLoad44 * jLoad39) + (jLoad34 * jLoad49) + (jLoad35 * jLoad48) + (jLoad45 * jLoad38) + (jLoad36 * jLoad47) + (jLoad37 * jLoad46);
