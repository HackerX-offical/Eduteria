...
final class zzcs extends zzes<AuthResult, com.google.firebase.auth.internal.zza> {
    ...
    public zzcs(AuthCredential authCredential, String str) {
        ...
        this.zza = new com.google.android.gms.internal.firebase_auth.zzdj(com.google.firebase.auth.internal.zzc.zza(authCredential, str));
    }
    ...
    public final TaskApiCall<zzdt, AuthResult> zzb() {
        return TaskApiCall.builder().setAutoResolveMissingFeatures(false).setFeatures((this.zzu || this.zzv) ? null : new Feature[]{com.google.android.gms.internal.firebase_auth.zze.zza}).run(new RemoteCall(this) { // from class: com.google.firebase.auth.api.internal.zzcr
