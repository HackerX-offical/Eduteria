...
final class zzdi extends zzes<Void, com.google.firebase.auth.internal.zza> {
    ...
    final /* synthetic */ void zza(zzdt zzdtVar, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ...
        if (this.zzu) {
            zzdtVar.zza().zzb(this.zze.zzf(), this.zza, this.zzc);
        } else {
            zzdtVar.zza().zza(new com.google.android.gms.internal.firebase_auth.zzbz(this.zze.zzf(), this.zza), this.zzc);
        }
    }
}
