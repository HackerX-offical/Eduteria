...
public final class zzdv {
    ...
    */
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.auth.api.internal.zzdv.zza(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }

    public static FirebaseAuthUserCollisionException zza(Status status, AuthCredential authCredential, String str, String str2) {
    ...
    public static com.google.firebase.auth.zzs zza(FirebaseAuth firebaseAuth, com.google.android.gms.internal.firebase_auth.zzej zzejVar, FirebaseUser firebaseUser) {
        com.google.android.gms.internal.firebase_auth.zzav.zza(firebaseAuth);
        com.google.android.gms.internal.firebase_auth.zzav.zza(zzejVar);
        Pair<String, String> pair = zza.get(17078);
        return new com.google.firebase.auth.zzs((String) pair.first, (String) pair.second, com.google.firebase.auth.internal.zzu.zza(zzejVar, firebaseAuth, firebaseUser));
    }
    ...
    static {
        ...
        sparseArray.put(17052, new Pair<>("ERROR_QUOTA_EXCEEDED", "The sms quota for this project has been exceeded."));
        ...
        sparseArray.put(17093, new Pair<>("ERROR_MISSING_CLIENT_IDENTIFIER", "This request is missing a reCAPTCHA token."));
