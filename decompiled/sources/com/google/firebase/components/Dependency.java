...
public final class Dependency {
    ...
    public String toString() {
        ...
        int i = this.type;
        return sbAppend.append(i == 1 ? FormField.Required.ELEMENT : i == 0 ? Session.Feature.OPTIONAL_ELEMENT : "set").append(", injection=").append(describeInjection(this.injection)).append("}").toString();
    }
