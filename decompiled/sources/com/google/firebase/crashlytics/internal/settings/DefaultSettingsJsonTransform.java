...
class DefaultSettingsJsonTransform implements SettingsJsonTransform {
    ...
    public SettingsData buildFromJson(CurrentTimeProvider currentTimeProvider, JSONObject jSONObject) throws JSONException {
        ...
        return new SettingsData(getExpiresAtFrom(currentTimeProvider, iOptInt2, jSONObject), buildAppDataFrom(jSONObject.getJSONObject(StoreProvider.StoreData.APP)), buildSessionDataFrom(jSONObject.getJSONObject(Session.ELEMENT)), buildFeaturesSessionDataFrom(jSONObject.getJSONObject("features")), iOptInt, iOptInt2);
    }
