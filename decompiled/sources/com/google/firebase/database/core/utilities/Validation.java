...
public class Validation {
    ...
    private static boolean isWritableKey(String str) {
        ...
        return (str.startsWith(InstructionFileId.DOT) || INVALID_KEY_REGEX.matcher(str).find()) ? false : true;
    }
    ...
    private static boolean isWritablePath(Path path) {
        ...
        return front == null || !front.asString().startsWith(InstructionFileId.DOT);
    }
