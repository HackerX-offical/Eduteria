    ...
    public void runReader() {
        try {
            try {
                ...
                this.eventHandler.onError(new WebSocketException("error while connecting: " + e4.getMessage(), e4));
            }
        } finally {
            close();
        }
