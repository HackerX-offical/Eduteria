...
class WebSocketHandshake {
    ...
    public byte[] getHandshake() {
        ...
        linkedHashMap.put("Upgrade", io.socket.engineio.client.transports.WebSocket.NAME);
    ...
    public void verifyServerHandshakeHeaders(HashMap<String, String> map) {
        if (io.socket.engineio.client.transports.WebSocket.NAME.equals(map.get("upgrade"))) {
