...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    ObjectEncoderContext add(FieldDescriptor fieldDescriptor, double d2, boolean z) throws IOException {
        if (z && d2 == 0.0d) {
            return this;
        }
    ...
    ObjectEncoderContext add(FieldDescriptor fieldDescriptor, float f2, boolean z) throws IOException {
        if (z && f2 == 0.0f) {
            return this;
        }
