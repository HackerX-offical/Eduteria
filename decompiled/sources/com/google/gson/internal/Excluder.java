...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder withVersion(double d2) {
        Excluder excluderM12298clone = m12298clone();
        excluderM12298clone.version = d2;
        return excluderM12298clone;
    }

    public Excluder withModifiers(int... iArr) {
        Excluder excluderM12298clone = m12298clone();
        excluderM12298clone.modifiers = 0;
        for (int i : iArr) {
            excluderM12298clone.modifiers = i | excluderM12298clone.modifiers;
        }
        return excluderM12298clone;
    }
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM12298clone = m12298clone();
        excluderM12298clone.serializeInnerClasses = false;
        return excluderM12298clone;
    }

    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM12298clone = m12298clone();
        excluderM12298clone.requireExpose = true;
        return excluderM12298clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            excluderM12298clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z2) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM12298clone.deserializationStrategies = arrayList2;
