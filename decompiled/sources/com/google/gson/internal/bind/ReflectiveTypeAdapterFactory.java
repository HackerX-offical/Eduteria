...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public static void checkAccessible(Object obj, Field field) {
        ...
        if (!ReflectionAccessFilterHelper.canAccess(field, obj)) {
            throw new JsonIOException("Field '" + field.getDeclaringClass().getName() + MqttTopic.MULTI_LEVEL_WILDCARD + field.getName() + "' is not accessible and ReflectionAccessFilter does not permit making it accessible. Register a TypeAdapter for the declaring type or adjust the access filter.");
        }
    }
                ...
                while (i3 < length) {
                    ...
                    if (zIncludeField || zIncludeField2) {
                        ...
                        while (i5 < size) {
                            ...
                            boolean z6 = zIncludeField;
                            int i6 = i4;
                            int i7 = length;
                            BoundField boundField2 = (BoundField) linkedHashMap.put(str, reflectiveTypeAdapterFactory.createBoundField(gson, field, str, TypeToken.get(typeResolve), z6, zIncludeField2, z5));
                            if (boundField == null) {
