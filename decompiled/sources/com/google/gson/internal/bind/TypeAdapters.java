...
public final class TypeAdapters {
    ...
    static {
        ...
        TypeAdapter<URL> typeAdapter9 = new TypeAdapter<URL>() { // from class: com.google.gson.internal.bind.TypeAdapters.21
            ...
            public URL read2(JsonReader jsonReader) throws IOException {
                ...
                String strNextString = jsonReader.nextString();
                if (Constants.NULL_VERSION_ID.equals(strNextString)) {
                    return null;
                }
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final TypeAdapter<TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.31
            ...
            public String toString() {
                return "Factory[type=" + cls.getName() + ",adapter=" + typeAdapter + com.clevertap.android.sdk.Constants.AES_SUFFIX;
            }
        };
    }
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final Class<TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.32
            ...
            public String toString() {
                return "Factory[type=" + cls2.getName() + MqttTopic.SINGLE_LEVEL_WILDCARD + cls.getName() + ",adapter=" + typeAdapter + com.clevertap.android.sdk.Constants.AES_SUFFIX;
            }
        };
    }
    ...
    public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(final Class<TT> cls, final Class<? extends TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.33
            ...
            public String toString() {
                return "Factory[type=" + cls.getName() + MqttTopic.SINGLE_LEVEL_WILDCARD + cls2.getName() + ",adapter=" + typeAdapter + com.clevertap.android.sdk.Constants.AES_SUFFIX;
            }
        };
    }
    ...
    public static <T1> TypeAdapterFactory newTypeHierarchyFactory(final Class<T1> cls, final TypeAdapter<T1> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.34
            ...
            public String toString() {
                return "Factory[typeHierarchy=" + cls.getName() + ",adapter=" + typeAdapter + com.clevertap.android.sdk.Constants.AES_SUFFIX;
            }
        };
    }
}
