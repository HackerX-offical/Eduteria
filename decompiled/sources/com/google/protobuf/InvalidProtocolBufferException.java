...
public class InvalidProtocolBufferException extends IOException {
    ...
    public InvalidProtocolBufferException(Exception e2) {
        super(e2.getMessage(), e2);
        this.unfinishedMessage = null;
    }

    public InvalidProtocolBufferException(String description, Exception e2) {
    ...
    public InvalidProtocolBufferException(String description, IOException e2) {
        super(description, e2);
        this.unfinishedMessage = null;
    }
