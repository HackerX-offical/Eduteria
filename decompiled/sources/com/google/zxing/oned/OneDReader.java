        ...
        try {
            ...
            if (map != null && map.containsKey(DecodeHintType.TRY_HARDER) && binaryBitmap.isRotateSupported()) {
                ...
                if (resultMetadata != null && resultMetadata.containsKey(ResultMetadataType.ORIENTATION)) {
                    iIntValue = (((Integer) resultMetadata.get(ResultMetadataType.ORIENTATION)).intValue() + 270) % CropImageOptionsKt.DEGREES_360;
                }
                            ...
                            try {
                                ...
                                if (resultPoints != null) {
                                    ...
                                    try {
                                        ...
                                        try {
                                            resultPoints[0] = new ResultPoint((f2 - resultPoints[0].getX()) - 1.0f, resultPoints[0].getY());
                                            resultPoints[i2] = new ResultPoint((f2 - resultPoints[i2].getX()) - 1.0f, resultPoints[i2].getY());
