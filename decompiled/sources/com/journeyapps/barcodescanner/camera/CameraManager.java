...
public final class CameraManager {
    ...
    private int calculateDisplayRotation() {
        ...
        if (this.cameraInfo.facing == 1) {
            i = (360 - ((this.cameraInfo.orientation + i2) % CropImageOptionsKt.DEGREES_360)) % CropImageOptionsKt.DEGREES_360;
        } else {
            i = ((this.cameraInfo.orientation - i2) + CropImageOptionsKt.DEGREES_360) % CropImageOptionsKt.DEGREES_360;
        }
