...
public class RoundedDrawable extends Drawable {
    ...
    private void redrawBitmapForSquareCorners(Canvas canvas) {
        ...
        float fWidth = this.mDrawableRect.width() + f2;
    ...
    private void redrawBorderForSquareCorners(Canvas canvas) {
        ...
        float f4 = this.mDrawableRect.left;
        float f5 = this.mDrawableRect.top;
        float fWidth = this.mDrawableRect.width() + f4;
        float fHeight = f5 + this.mDrawableRect.height();
        ...
        if (this.mCornersRounded[0]) {
            ...
            f2 = f5;
            canvas.drawLine(f4 - f7, f5, f4 + f6, f2, this.mBorderPaint);
            canvas.drawLine(f4, f2 - f7, f4, f2 + f6, this.mBorderPaint);
        }
        if (!this.mCornersRounded[1]) {
            float f8 = f2;
            canvas.drawLine((fWidth - f6) - f7, f8, fWidth, f2, this.mBorderPaint);
            canvas.drawLine(fWidth, f8 - f7, fWidth, f8 + f6, this.mBorderPaint);
            fWidth = fWidth;
        }
        if (this.mCornersRounded[2]) {
            f3 = fHeight;
        } else {
            canvas.drawLine((fWidth - f6) - f7, fHeight, fWidth + f7, fHeight, this.mBorderPaint);
            float f9 = fWidth;
            canvas.drawLine(f9, fHeight - f6, fWidth, fHeight, this.mBorderPaint);
            f3 = fHeight;
        }
        if (this.mCornersRounded[3]) {
            return;
        }
        canvas.drawLine(f4 - f7, f3, f4 + f6, f3, this.mBorderPaint);
        canvas.drawLine(f4, f3 - f6, f4, f3, this.mBorderPaint);
    }
    ...
    public RoundedDrawable setCornerRadius(int i, float f2) {
        if (f2 != 0.0f) {
