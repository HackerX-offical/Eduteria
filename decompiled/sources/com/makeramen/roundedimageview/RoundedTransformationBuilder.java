...
public final class RoundedTransformationBuilder {
    ...
    public RoundedTransformationBuilder cornerRadius(int i, float f2) {
    ...
    public RoundedTransformationBuilder cornerRadiusDp(int i, float f2) {
        return cornerRadius(i, TypedValue.applyDimension(1, f2, this.mDisplayMetrics));
    }
