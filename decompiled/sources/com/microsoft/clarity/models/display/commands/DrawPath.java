...
public final class DrawPath extends PaintableCommand {
    ...
    public MutationPayload$DisplayCommand toProtobufInstance() {
        MutationPayload$DisplayCommand mutationPayload$DisplayCommandBuild = MutationPayload$DisplayCommand.newBuilder().b(getType().name()).k(this.pathIndex).j(getPaintIndex()).build();
