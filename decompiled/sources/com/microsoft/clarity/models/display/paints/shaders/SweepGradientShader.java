...
public final /* data */ class SweepGradientShader extends Shader {
    ...
    public SweepGradientShader(Point center, float f2, float f3, long j, long j2, List<Color4f> colors, List<Float> list, List<Float> list2) {
    ...
    public static /* synthetic */ SweepGradientShader copy$default(SweepGradientShader sweepGradientShader, Point point, float f2, float f3, long j, long j2, List list, List list2, List list3, int i, Object obj) {
        if ((i & 1) != 0) {
            point = sweepGradientShader.center;
        }
        if ((i & 2) != 0) {
            f2 = sweepGradientShader.startAngle;
        }
        if ((i & 4) != 0) {
            f3 = sweepGradientShader.endAngle;
        }
        if ((i & 8) != 0) {
        ...
        long j4 = j;
        float f4 = f3;
        return sweepGradientShader.copy(point, f2, f4, j4, j3, list5, list2, list4);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.center, sweepGradientShader.center) && Intrinsics.areEqual((Object) Float.valueOf(this.startAngle), (Object) Float.valueOf(sweepGradientShader.startAngle)) && Intrinsics.areEqual((Object) Float.valueOf(this.endAngle), (Object) Float.valueOf(sweepGradientShader.endAngle)) && this.tileMode == sweepGradientShader.tileMode && this.gradFlags == sweepGradientShader.gradFlags && Intrinsics.areEqual(this.colors, sweepGradientShader.colors) && Intrinsics.areEqual(this.pos, sweepGradientShader.pos) && Intrinsics.areEqual(this.localMatrix, sweepGradientShader.localMatrix);
    }
    ...
    public int hashCode() {
        int iHashCode = (this.colors.hashCode() + ((Long.hashCode(this.gradFlags) + ((Long.hashCode(this.tileMode) + ((Float.hashCode(this.endAngle) + ((Float.hashCode(this.startAngle) + (this.center.hashCode() * 31)) * 31)) * 31)) * 31)) * 31)) * 31;
    ...
    public MutationPayload$Shader toProtobufInstance() {
        MutationPayload$Shader.a aVarA = MutationPayload$Shader.newBuilder().a(getType().name()).a(this.center.toProtobufInstance()).c(this.startAngle).a(this.endAngle).d(this.tileMode).a(this.gradFlags);
    ...
    public String toString() {
        return b.a("SweepGradientShader(center=").append(this.center).append(", startAngle=").append(this.startAngle).append(", endAngle=").append(this.endAngle).append(", tileMode=").append(this.tileMode).append(", gradFlags=").append(this.gradFlags).append(", colors=").append(this.colors).append(", pos=").append(this.pos).append(", localMatrix=").append(this.localMatrix).append(')').toString();
    }
}
