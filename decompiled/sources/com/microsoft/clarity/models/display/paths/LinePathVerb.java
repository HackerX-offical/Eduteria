...
public final /* data */ class LinePathVerb extends PathVerb {
    ...
    public LinePathVerb(float f2, float f3) {
        this.x = f2;
        this.y = f3;
    }

    public static /* synthetic */ LinePathVerb copy$default(LinePathVerb linePathVerb, float f2, float f3, int i, Object obj) {
        if ((i & 1) != 0) {
            f2 = linePathVerb.x;
        }
        if ((i & 2) != 0) {
        ...
        return linePathVerb.copy(f2, f3);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual((Object) Float.valueOf(this.x), (Object) Float.valueOf(linePathVerb.x)) && Intrinsics.areEqual((Object) Float.valueOf(this.y), (Object) Float.valueOf(linePathVerb.y));
    }
    ...
    public String toString() {
        return b.a("LinePathVerb(x=").append(this.x).append(", y=").append(this.y).append(')').toString();
    }
}
