...
public enum AnalyticsEvent {
    ...
    HANDOVER_ERROR("ch:and", "merch:cb:handover", Constants.EVENT_LABEL_FAIL),
    CHECKOUT_LOADED("ch:and", "checkout", "loaded"),
    INTERNAL_DESTROY_METHOD_CALLED("ch:and", "checkout", Destroy.ELEMENT),
    ACTIVITY_ONCREATE_CALLED("ch:and", "checkout:activity", "create"),
    ACTIVITY_ONRESUME_CALLED("ch:and", "checkout:activity", "resume"),
    ACTIVITY_ONPAUSE_CALLED("ch:and", "checkout:activity", VideoDownloadService.PAUSE),
    ACTIVITY_ONDESTROY_CALLED("ch:and", "checkout:activity", Destroy.ELEMENT),
    ...
    CHECKOUT_PAYMENT_COMPLETE("ch:and", Const.PAYMENT, "complete"),
    ...
    WEB_VIEW_UNEXPECTED_NULL("ch:and", "webview", com.amazonaws.services.s3.internal.Constants.NULL_VERSION_ID),
    ...
    NATIVE_INTENT_CALLED("ch:and", SDKConstants.PARAM_INTENT, "called"),
    NATIVE_INTENT_ONACTIVITY_RESULT("ch:and", SDKConstants.PARAM_INTENT, "result:received"),
    ...
    PHONE_NUMBER_HINT_INTENT_LAUNCH_FAILED("ch:and", "phone_number_hint", "failure"),
    PHONE_NUMBER_HINT_RESULT_SUCCESS("ch:and", "phone_number_hint", "success"),
    PHONE_NUMBER_HINT_RESULT_FAILED_TO_FETCH_NUMBER("ch:and", "phone_number_hint", Constants.EVENT_LABEL_FAIL),
    ...
    MAGIC_PAYMENT_FLOW_START("magic:and", Const.PAYMENT, "start"),
    MAGIC_PAYMENT_FLOW_END("magic:and", Const.PAYMENT, "end"),
    ...
    MAGIC_OTP_EXTRACT("magic:and", Const.OTP, "extract"),
    MAGIC_OTP_SHOW("magic:and", Const.OTP, "show"),
    ...
    CUSTOM_UI_PAYMENT_COMPLETE("cu:and", Const.PAYMENT, "complete"),
    ...
    CUSTOM_UI_NATIVE_INTENT_CALLED("cu:and", SDKConstants.PARAM_INTENT, "called"),
    CUSTOM_UI_NATIVE_INTENT_ONACTIVITY_RESULT("cu:and", SDKConstants.PARAM_INTENT, "result:received"),
    ...
    CUSTOMUI_METHOD_AMAZONPAY_PASSED("cu:and", com.tv9news.utils.helpers.AnalyticsConstants.payment_method, "amazon_pay:passed"),
    ...
    GPAY_IN_A_BOX_PAYMENT_CALLBACK_FAILURE("gpay_in_a_box:and", "gpay_in_a_box:callback", "failure"),
    ...
    GPAY_IN_A_BOX_PROCESS_PAYMENT_FAILURE("gpay_in_a_box:and", "process:payment", "failure"),
    ...
    CHECKOUT_PREFETCH_PUBLIC_PAGE_DOWNLOAD_FAILED("ch:and", "public:page:download", Constants.EVENT_LABEL_FAIL),
    ...
    CHECKOUT_PREFETCH_ASSET_FILES_STORING_FAILED("ch:and", "asset:file:storing", Constants.EVENT_LABEL_FAIL),
    ...
    CHECKOUT_PRELOAD_FAILED("ch:and", "preload", Constants.EVENT_LABEL_FAIL),
    ...
    GET_LINKED_UPI_ACCOUNTS_CHECKOUT_FAILURE("ch:and:turbo_plugin", "get_linked_upi_accounts", "failure"),
    ...
    LINK_NEW_UPI_ACCOUNT_CHECKOUT_FAILURE("ch:and:turbo_plugin", "link_account", "failure"),
    ...
    LINK_NEW_UPI_ACCOUNT_MERCHANT_FAILURE("ch:and:turbo_plugin", "link_account", "failure"),
    ...
    GET_LINKED_UPI_ACCOUNTS_FAILURE("cu:and:turbo_plugin", "get_linked_upi_accounts", "failure"),
    ...
    LINK_NEW_UPI_ACCOUNT_FAILURE("cu:and:turbo_plugin", "link_account", "failure"),
    ...
    LINK_ACCOUNT_CHECK_PERMISSION_FAILURE("cu:and:turbo_plugin", "link_account:check_permission", "failure"),
    ...
    LINK_ACCOUNT_REQUEST_PERMISSION_FAILURE("cu:and:turbo_plugin", "link_account:request_permission", "failure"),
    ...
    LINK_ACCOUNT_SELECT_SIM_FAILURE("cu:and:turbo_plugin", "link_account:select_sim", "failure"),
    ...
    LINK_ACCOUNT_SIM_SELECTION_AND_NUMBER_INPUT_FAILURE("cu:and:turbo_plugin", "link_account:sim_selection_and_number_input", "failure"),
    ...
    LINK_ACCOUNT_REGISTER_FAILURE("cu:and:turbo_plugin", "link_account:register", "failure"),
    ...
    LINK_ACCOUNT_EXISTING_ACCOUNTS_FAILURE("cu:and:turbo_plugin", "link_account:existing", "failure"),
    ...
    LINK_ACCOUNT_SELECT_BANK_FAILURE("cu:and:turbo_plugin", "link_account:select_bank", "failure"),
    ...
    LINK_ACCOUNT_SELECT_BANK_ACCOUNT_FAILURE("cu:and:turbo_plugin", "link_account:select_bank_account", "failure"),
    ...
    LINK_ACCOUNT_SET_UP_UPI_PIN_FAILURE("cu:and:turbo_plugin", "link_account:setup_upi_pin", "failure"),
    ...
    TURBO_PROCESS_PAYMENT_FAILURE("cu:and:turbo_plugin", "process:payment", "failure"),
    TURBO_GET_BALANCE_CALLED("cu:and:turbo_plugin", "bank_account:get_balance", "called"),
    TURBO_GET_BALANCE_FAILURE("cu:and:turbo_plugin", "bank_account:get_balance", "failure"),
    TURBO_RESET_UPI_PIN_CALLED("cu:and:turbo_plugin", "bank_account:reset_upi_pin", "called"),
    TURBO_RESET_UPI_PIN_FAILURE("cu:and:turbo_plugin", "bank_account:reset_upi_pin", "failure"),
    TURBO_CHANGE_UPI_PIN_CALLED("cu:and:turbo_plugin", "bank_account:change_upi_pin", "called"),
    TURBO_CHANGE_UPI_PIN_FAILURE("cu:and:turbo_plugin", "bank_account:change_upi_pin", "failure"),
    TURBO_DELINK_CALLED("cu:and:turbo_plugin", "bank_account:delink", "called"),
    TURBO_DELINK_FAILURE("cu:and:turbo_plugin", "bank_account:delink", "failure"),
    GET_LINKED_TPV_UPI_ACCOUNTS_CALLED("cu:and:turbo_plugin", "get_linked_tpv_upi_accounts", "called"),
    GET_LINKED_TPV_UPI_ACCOUNTS_FAILURE("cu:and:turbo_plugin", "get_linked_tpv_upi_accounts", "failure"),
    ...
    LINK_NEW_TPV_UPI_ACCOUNT_FAILURE("cu:and:turbo_plugin", "link_new_tpv_upi_account", "failure"),
    ...
    PREFETCH_POST_USER_CONSENT_FAILURE("cu:and:turbo_plugin", "prefetch_link_account:post_user_consent", "failure"),
    ...
    PREFETCH_AND_LINK_ACCOUNTS_FAILURE("cu:and:turbo_plugin", "prefetch_and_link_account", "failure"),
    ...
    WEBVIEW_CREATION_FAILED("ch:and", AnalyticsConstants.WEBVIEW_CREATION, StreamManagement.Failed.ELEMENT),
    ...
    final void setEventName(String str) {
        this.eventName = str;
    }
