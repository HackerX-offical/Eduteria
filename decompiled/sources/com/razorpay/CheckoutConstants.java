...
class CheckoutConstants {
    static final String ACTIVITY_INVALID_PARAMETER = "Invalid parameters passed";
    static final String ACTIVITY_RESULT_INVALID_URL = "Invalid URL. Please make sure you've set public key";
    ...
    static final String ERR_NAME_NOT_RESOLVED_DESCRIPTION = "Unable to connect to Razorpay.\n\nPlease check your internet connection and/or disconnect from VPN if connected and hit Try Again";
    static final String ERR_NAME_NOT_RESOLVED_TITLE = "Trouble Connecting";
    ...
    static final String MERCHANT_ACTIVITY_EXTRA_RESULT_ACTION = "actionResult";
    static final int MERCHANT_ACTIVITY_REQUEST_CODE = 98003;
    static final String MERCHANT_FEATURES = "{\"query\":[{\"resource\":\"merchant_features\"}],\"action\":\"get\"}";
    static final String OPTIMIZER_HOSTED = "optimizer_hosted";
    public static final String OPTIONS = "OPTIONS";
    static final String PAYMENT_ERROR = "Payment Error";
    static final String PREFETCH_ASSSET_URL = "https://checkout.razorpay.com/v1/prefetch.json";
    ...
    static final String SAVED_STATE_BUNDLE_MAP = "SAVED_STATE_BUNDLE_MAP";
    ...
    static final String WEBVIEW_BACKGROUND = "#99000000";
