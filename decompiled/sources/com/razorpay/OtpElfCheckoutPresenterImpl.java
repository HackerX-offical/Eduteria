...
class OtpElfCheckoutPresenterImpl extends CheckoutPresenterImpl {
    ...
    public OtpElfCheckoutPresenterImpl(Activity activity, CheckoutPresenterImpl.CheckoutView checkoutView, HashMap<String, String> map) {
    ...
    public void setUpAddOn() {
        RzpAssist rzpAssist;
        RzpAssist rzpAssist2 = new RzpAssist(this.merchantKey, this.activity, this.view.getWebView(1), ConfigCheckout.SDK_TYPE, ConfigCheckout.SDK_VERSION_CODE, ConfigCheckout.SDK_VERSION);
        this.primaryRzpAssist = rzpAssist2;
        rzpAssist2.setRzpAssistEnabled(true);
        RzpAssist rzpAssist3 = new RzpAssist(this.merchantKey, this.activity, this.view.getWebView(2), ConfigCheckout.SDK_TYPE, ConfigCheckout.SDK_VERSION_CODE, ConfigCheckout.SDK_VERSION);
