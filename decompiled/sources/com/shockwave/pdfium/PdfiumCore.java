...
public class PdfiumCore {
    ...
    public PdfiumCore(Context context) {
        ...
        Log.d(TAG, "Starting PdfiumAndroid 1.9.5-beta01");
    }
    ...
    public Point mapPageCoordsToDevice(PdfDocument pdfDocument, int i, int i2, int i3, int i4, int i5, int i6, double d2, double d3) {
        return nativePageCoordsToDevice(pdfDocument.mNativePagesPtr.get(Integer.valueOf(i)).longValue(), i2, i3, i4, i5, i6, d2, d3);
    }
