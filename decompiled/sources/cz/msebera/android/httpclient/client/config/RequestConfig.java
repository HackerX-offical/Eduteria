...
public class RequestConfig implements Cloneable {
    ...
    public RequestConfig m12362clone() throws CloneNotSupportedException {
    ...
    public String toString() {
        ...
        sb.append(", decompressionEnabled=").append(this.decompressionEnabled);
