...
public class MessageConstraints implements Cloneable {
    ...
    public MessageConstraints m12364clone() throws CloneNotSupportedException {
        return (MessageConstraints) super.clone();
    }

    public String toString() {
        StringBuilder sb = new StringBuilder("[maxLineLength=");
        sb.append(this.maxLineLength).append(", maxHeaderCount=").append(this.maxHeaderCount).append(Constants.AES_SUFFIX);
        return sb.toString();
    }
