...
public final class ContentType implements Serializable {
    ...
    static {
        ...
        APPLICATION_XML = create(Mimetypes.MIMETYPE_XML, Consts.ISO_8859_1);
        MULTIPART_FORM_DATA = create(HttpConnection.MULTIPART_FORM_DATA, Consts.ISO_8859_1);
        TEXT_HTML = create(Mimetypes.MIMETYPE_HTML, Consts.ISO_8859_1);
