...
final class NTLMEngineImpl implements NTLMEngine {
    ...
    public static Key createDESKey(byte[] bArr, int i) {
        ...
        byte b7 = bArr2[5];
        byte b8 = bArr2[6];
        byte[] bArr3 = {b2, (byte) ((b2 << 7) | ((b3 & 255) >>> 1)), (byte) ((b3 << 6) | ((b4 & 255) >>> 2)), (byte) ((b4 << 5) | ((b5 & 255) >>> 3)), (byte) ((b5 << 4) | ((b6 & 255) >>> 4)), (byte) (((b7 & 255) >>> 5) | (b6 << 3)), (byte) ((b7 << 2) | ((b8 & 255) >>> 6)), (byte) (b8 << 1)};
        oddParity(bArr3);
    ...
    static class Type3Message extends NTLMMessage {
        ...
        String getResponse() {
            ...
            addULong((i6 & 4) | (524928 & i6) | 33554432 | (32768 & i6) | (i6 & 32) | (i6 & 16) | (536870912 & i6) | (Integer.MIN_VALUE & i6) | (1073741824 & i6) | (8388608 & i6) | (i6 & 1));
            addUShort(261);
            addULong(2600);
            addUShort(3840);
