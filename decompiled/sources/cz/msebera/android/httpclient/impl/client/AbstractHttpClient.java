    ...
    protected final CloseableHttpResponse doExecute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) throws IOException {
        ...
        try {
            if (connectionBackoffStrategy != null && backoffManager != null) {
                HttpRoute httpRouteDetermineRoute = routePlanner.determineRoute(httpHost != null ? httpHost : (HttpHost) determineParams(httpRequest).getParameter(ClientPNames.DEFAULT_HOST), httpRequest, defaultedHttpContext);
                try {
                    CloseableHttpResponse closeableHttpResponseNewProxy = CloseableHttpResponseProxy.newProxy(requestDirectorCreateClientRequestDirector.execute(httpHost, httpRequest, defaultedHttpContext));
            ...
            return CloseableHttpResponseProxy.newProxy(requestDirectorCreateClientRequestDirector.execute(httpHost, httpRequest, defaultedHttpContext));
