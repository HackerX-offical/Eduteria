...
public final class FutureRequestExecutionMetrics {
    ...
    public String toString() {
        ...
        sb.append(this.activeConnections).append(", scheduledConnections=").append(this.scheduledConnections).append(", successfulConnections=").append(this.successfulConnections).append(", failedConnections=").append(this.failedConnections).append(", requests=").append(this.requests).append(", tasks=").append(this.tasks).append(Constants.AES_SUFFIX);
        return sb.toString();
    }
    ...
    static class DurationCounter {
        ...
        public String toString() {
            ...
            sb.append(count()).append(", averageDuration=").append(averageDuration()).append(Constants.AES_SUFFIX);
            return sb.toString();
        }
    }
}
