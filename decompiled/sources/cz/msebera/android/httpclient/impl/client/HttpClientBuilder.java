...
public class HttpClientBuilder {
    ...
    public CloseableHttpClient build() {
        ...
        if (httpClientConnectionManager2 == null) {
            ...
            Registry registryBuild = RegistryBuilder.create().register(HttpHost.DEFAULT_SCHEME_NAME, PlainConnectionSocketFactory.getSocketFactory()).register(TournamentShareDialogURIBuilder.scheme, sSLConnectionSocketFactory2).build();
        ...
        ClientExecChain backoffStrategyExec = (this.backoffManager == null || this.connectionBackoffStrategy == null) ? clientExecChainDecorateProtocolExec : new BackoffStrategyExec(clientExecChainDecorateProtocolExec, this.connectionBackoffStrategy, this.backoffManager);
        ...
        if (lookupBuild2 == null) {
            ...
            lookupBuild2 = RegistryBuilder.create().register(CookieSpecs.DEFAULT, defaultCookieSpecProvider).register("best-match", defaultCookieSpecProvider).register("compatibility", defaultCookieSpecProvider).register("standard", new RFC6265CookieSpecProvider(RFC6265CookieSpecProvider.CompatibilityLevel.RELAXED, publicSuffixMatcher2)).register(CookieSpecs.STANDARD_STRICT, new RFC6265CookieSpecProvider(RFC6265CookieSpecProvider.CompatibilityLevel.STRICT, publicSuffixMatcher2)).register("netscape", new NetscapeDraftSpecProvider()).register("ignoreCookies", new IgnoreSpecProvider()).build();
        }
        ...
        return new InternalHttpClient(backoffStrategyExec, httpClientConnectionManager, httpRoutePlanner, lookup2, lookup, cookieStore, credentialsProvider, requestConfig, arrayList3);
    }
}
