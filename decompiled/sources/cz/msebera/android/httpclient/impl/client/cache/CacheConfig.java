...
public class CacheConfig implements Cloneable {
    ...
    CacheConfig(long j, int i, int i2, boolean z, boolean z2, boolean z3, float f2, long j2, boolean z4, int i3, int i4, int i5, int i6, boolean z5) {
    ...
    public void setMaxObjectSizeBytes(int i) {
        if (i > Integer.MAX_VALUE) {
            this.maxObjectSize = SieveCacheKt.NodeLinkMask;
        } else {
    ...
    public CacheConfig m12366clone() throws CloneNotSupportedException {
