...
public class PoolingHttpClientConnectionManager implements HttpClientConnectionManager, ConnPoolControl<HttpRoute>, Closeable {
    ...
    public PoolingHttpClientConnectionManager(HttpClientConnectionOperator httpClientConnectionOperator, HttpConnectionFactory<HttpRoute, ManagedHttpClientConnection> httpConnectionFactory, long j, TimeUnit timeUnit) {
        ...
        this.pool = cPool;
        cPool.setValidateAfterInactivity(5000);
    ...
    private String format(HttpRoute httpRoute, Object obj) {
        ...
        sb.append(httpRoute).append(Constants.AES_SUFFIX);
        if (obj != null) {
            sb.append("[state: ").append(obj).append(Constants.AES_SUFFIX);
        }
        return sb.toString();
    }
    ...
    private String formatStats(HttpRoute httpRoute) {
        ...
        sb.append(" of ").append(totalStats.getMax()).append(Constants.AES_SUFFIX);
        return sb.toString();
    }
    ...
    private String format(CPoolEntry cPoolEntry) {
        ...
        sb.append(cPoolEntry.getRoute()).append(Constants.AES_SUFFIX);
        Object state = cPoolEntry.getState();
        if (state != null) {
            sb.append("[state: ").append(state).append(Constants.AES_SUFFIX);
        }
        return sb.toString();
    }
