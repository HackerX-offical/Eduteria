...
public class BasicClientCookie implements SetCookie, ClientCookie, Cloneable, Serializable {
    ...
    public BasicClientCookie(String str, String str2) {
        Args.notNull(str, Constants.KEY_ENCRYPTION_NAME);
        this.name = str;
    ...
    public String toString() {
        return "[version: " + Integer.toString(this.cookieVersion) + "][name: " + this.name + "][value: " + this.value + "][domain: " + this.cookieDomain + "][path: " + this.cookiePath + "][expiry: " + this.cookieExpiryDate + Constants.AES_SUFFIX;
    }
}
