...
public class Socket extends Emitter {
    ...
    public Socket(Options options) {
        ...
        this.path = (options.path != null ? options.path : "/engine.io").replaceAll("/$", "") + MqttTopic.TOPIC_LEVEL_SEPARATOR;
    ...
    /* JADX INFO: renamed from: io.socket.engineio.client.Socket$7, reason: invalid class name */
    ...
    public void onPacket(Packet packet) {
        ...
        if (logger3.isLoggable(Level.FINE)) {
            logger3.fine(String.format("packet received with socket readyState '%s'", this.readyState));
        }
    }
    ...
    public static class Options extends Transport.Options {
        ...
        public static Options fromURI(URI uri, Options options) {
            ...
            options.secure = TournamentShareDialogURIBuilder.scheme.equals(uri.getScheme()) || "wss".equals(uri.getScheme());
