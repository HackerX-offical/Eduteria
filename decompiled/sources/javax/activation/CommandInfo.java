    ...
    private static final class Beans {
        ...
        static Object instantiate(ClassLoader classLoader, String str) throws ClassNotFoundException, IOException {
            ...
            if (securityManager != null) {
                ...
                if (strReplace.startsWith(Constants.AES_PREFIX) && (iLastIndexOf = strReplace.lastIndexOf(91) + 2) > 1 && iLastIndexOf < strReplace.length()) {
            ...
            try {
                ...
                throw new ClassNotFoundException(cls + ": " + e2, e2);
            }
        }
    }
}
