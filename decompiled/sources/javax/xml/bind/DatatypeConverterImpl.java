...
final class DatatypeConverterImpl implements DatatypeConverterInterface {
    ...
    public static float _parseFloat(CharSequence charSequence) {
        ...
        if (string.equals(BuildConfig.FAQ_URL)) {
            return Float.NaN;
        }
        ...
        if (cCharAt != '0') {
            if (cCharAt == '1') {
                ...
                while (true) {
                    i3 = i + 1;
                    i4 = i8 + 1;
                    if ("alse".charAt(i8) != charSequence.charAt(i) || i3 >= length || i4 >= 4) {
                        break;
                    }
                    i = i3;
                    i8 = i4;
                ...
                while (true) {
                    i5 = i + 1;
                    i6 = i9 + 1;
                    if ("rue".charAt(i9) != charSequence.charAt(i) || i5 >= length || i6 >= 3) {
                        break;
                    }
                    i = i5;
                    i9 = i6;
    ...
    @Override // javax.xml.bind.DatatypeConverterInterface
    public String printByte(byte b2) {
        return _printByte(b2);
    }

    public static String _printByte(byte b2) {
    ...
    public static byte[] _parseBase64Binary(String str) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            ...
            if (i2 == 4) {
                ...
                byte b3 = bArr2[2];
                if (b3 != 127) {
                    bArr[i4] = (byte) ((b3 >> 2) | (bArr2[1] << 4));
                    i4 = i + 2;
                }
                byte b4 = bArr2[3];
                if (b4 != 127) {
                    bArr[i4] = (byte) (b4 | (bArr2[2] << 6));
                    i = i4 + 1;
                } else {
                    i = i4;
                }
    ...
    public static int _printBase64Binary(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        while (i2 >= 3) {
            ...
            int i4 = i + 1;
            bArr2[i3 + 1] = encodeByte(((bArr[i] & 3) << 4) | ((bArr[i4] >> 4) & 15));
            int i5 = i3 + 3;
            int i6 = i + 2;
            bArr2[i3 + 2] = encodeByte((3 & (bArr[i6] >> 6)) | ((bArr[i4] & Ascii.SI) << 2));
            i3 += 4;
            bArr2[i5] = encodeByte(bArr[i6] & Utf8.REPLACEMENT_BYTE);
            i2 -= 3;
            i += 3;
        }
        if (i2 == 1) {
            bArr2[i3] = encodeByte(bArr[i] >> 2);
            bArr2[i3 + 1] = encodeByte((bArr[i] & 3) << 4);
            int i7 = i3 + 3;
        ...
        int i8 = (3 & bArr[i]) << 4;
        int i9 = i + 1;
        bArr2[i3 + 1] = encodeByte(i8 | ((bArr[i9] >> 4) & 15));
        int i10 = i3 + 3;
        bArr2[i3 + 2] = encodeByte((bArr[i9] & Ascii.SI) << 2);
        int i11 = i3 + 4;
