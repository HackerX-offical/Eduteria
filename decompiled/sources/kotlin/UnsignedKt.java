...
public final class UnsignedKt {
    ...
    public static final int m12745uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m12488constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m12744uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m12488constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m12746ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? ULong.m12567constructorimpl(0L) : ULong.m12567constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m12567constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m12567constructorimpl(j3 + ((long) (Long.compareUnsigned(ULong.m12567constructorimpl(j - (j3 * j2)), ULong.m12567constructorimpl(j2)) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m12747ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? j : ULong.m12567constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m12567constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compareUnsigned(ULong.m12567constructorimpl(j3), ULong.m12567constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m12567constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d2) {
        ...
        if (d2 <= 2.147483647E9d) {
            return UInt.m12488constructorimpl((int) d2);
        }
        return UInt.m12488constructorimpl(UInt.m12488constructorimpl((int) (d2 - ((double) Integer.MAX_VALUE))) + UInt.m12488constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d2) {
        ...
        if (d2 < 9.223372036854776E18d) {
            return ULong.m12567constructorimpl((long) d2);
        }
        return ULong.m12567constructorimpl(ULong.m12567constructorimpl((long) (d2 - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
