...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        if (0 > j || j > SieveCacheKt.NodeLinkMask) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m12613toStringimpl(ULong.m12567constructorimpl(j))));
        }
        return (int) j;
    }
    ...
    */
    ...
    public static /* synthetic */ String toHexString$default(byte b2, HexFormat hexFormat, int i, Object obj) {
        if ((i & 1) != 0) {
            hexFormat = HexFormat.INSTANCE.getDefault();
        }
    ...
    public static final String toHexString(byte b2, HexFormat format) {
        ...
        if (number.getIsDigitsOnlyAndNoPadding()) {
            char[] cArr = {str.charAt((b2 >> 4) & 15), str.charAt(b2 & Ascii.SI)};
            if (number.getRemoveLeadingZeros()) {
                return StringsKt.concatToString$default(cArr, RangesKt.coerceAtMost((Integer.numberOfLeadingZeros(b2 & 255) - 24) >> 2, 1), 0, 2, null);
            }
            return StringsKt.concatToString(cArr);
        }
