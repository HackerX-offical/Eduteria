...
public class StringsKt__StringNumberConversionsJVMKt extends StringsKt__StringBuilderKt {
    private static final int asciiLetterToLowerCaseCode$StringsKt__StringNumberConversionsJVMKt(char c2) {
        return c2 | ' ';
    }
    ...
    private static final String toString(byte b2, int i) {
        String string = Integer.toString(b2, CharsKt.checkRadix(i));
