...
public final class UStringsKt {
    ...
    public static final String m13727toStringLxnNnR4(byte b2, int i) {
        String string = Integer.toString(b2 & 255, CharsKt.checkRadix(i));
        Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
        return string;
    }

    /* JADX INFO: renamed from: toString-olVBNx4, reason: not valid java name */
    public static final String m13729toStringolVBNx4(short s, int i) {
    ...
    public static final String m13728toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m13726toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m12488constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m12405boximpl(UByte.m12411constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m12488constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m12668boximpl(UShort.m12674constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM12488constructorimpl = UInt.m12488constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM12488constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM12488constructorimpl2 = UInt.m12488constructorimpl(i3 * iM12488constructorimpl);
            int iM12488constructorimpl3 = UInt.m12488constructorimpl(UInt.m12488constructorimpl(iDigitOf) + iM12488constructorimpl2);
            if (Integer.compareUnsigned(iM12488constructorimpl3, iM12488constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM12488constructorimpl3;
        }
        return UInt.m12482boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM12567constructorimpl = ULong.m12567constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM12567constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM12567constructorimpl2 = ULong.m12567constructorimpl(j * jM12567constructorimpl);
            long jM12567constructorimpl3 = ULong.m12567constructorimpl(ULong.m12567constructorimpl(((long) UInt.m12488constructorimpl(iDigitOf)) & 4294967295L) + jM12567constructorimpl2);
            if (Long.compareUnsigned(jM12567constructorimpl3, jM12567constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM12567constructorimpl3;
        }
        return ULong.m12561boximpl(j);
    }
}
