...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo13731minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m13851minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo13730elapsedNowUwyO8pc() {
        return Duration.m13768minusLRDsOJo(this.mark.mo13730elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo13733plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m13769plusLRDsOJo(this.adjustment, duration), null);
    }
}
