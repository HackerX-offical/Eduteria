...
public final class DurationKt {
    ...
    private static final long m13837timesmvk6XK0(int i, long j) {
        return Duration.m13771timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m13836timeskIfJnKk(double d2, long j) {
        return Duration.m13770timesUwyO8pc(j, d2);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM13831getZEROUwyO8pc = Duration.INSTANCE.m13831getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM13769plusLRDsOJo = Duration.m13769plusLRDsOJo(jM13831getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM13831getZEROUwyO8pc = Duration.m13769plusLRDsOJo(jM13769plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM13831getZEROUwyO8pc = Duration.m13769plusLRDsOJo(jM13831getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, iMax, true)) {
                jM13831getZEROUwyO8pc = Duration.INSTANCE.m13829getINFINITEUwyO8pc();
            } else {
                boolean z5 = !z2;
                ...
                while (length2 < i) {
                    ...
                    int i6 = length2;
                    while (i6 < str.length() && (('0' <= (cCharAt2 = str.charAt(i6)) && cCharAt2 < c4) || cCharAt2 == '.')) {
                        i6++;
                    }
                    Intrinsics.checkNotNull(str, "null cannot be cast to non-null type java.lang.String");
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM13769plusLRDsOJo2 = Duration.m13769plusLRDsOJo(jM13831getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM13831getZEROUwyO8pc = Duration.m13769plusLRDsOJo(jM13769plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM13831getZEROUwyO8pc = Duration.m13769plusLRDsOJo(jM13831getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z3 ? Duration.m13784unaryMinusUwyO8pc(jM13831getZEROUwyO8pc) : jM13831getZEROUwyO8pc;
    }
    ...
    private static final long parseOverLongIsoComponent(String str) {
        ...
        return (!StringsKt.startsWith$default(str, MqttTopic.SINGLE_LEVEL_WILDCARD, false, 2, (Object) null) || length <= 1 || '0' > (cCharAt = str.charAt(1)) || cCharAt >= ':') ? Long.parseLong(str) : Long.parseLong(StringsKt.drop(str, 1));
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m13740constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m13740constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m13740constructorimpl((j << 1) + ((long) i));
    }
