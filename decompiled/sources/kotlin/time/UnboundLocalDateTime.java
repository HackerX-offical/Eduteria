...
final class UnboundLocalDateTime {
    ...
    public final <T> T toInstant(int offsetSeconds, Function2<? super Long, ? super Integer, ? extends T> buildInstant) {
        ...
        if (year >= 0) {
            j = j2 + (((((long) 3) + year) / ((long) 4)) - ((((long) 99) + year) / ((long) 100))) + ((year + ((long) 399)) / ((long) HttpStatus.SC_BAD_REQUEST));
        } else {
            j = j2 - (((year / ((long) (-4))) - (year / ((long) (-100)))) + (year / ((long) Store.STORE_NOT_FOUND)));
        }
        long month = j + ((long) (((getMonth() * 367) - 362) / 12)) + ((long) (getDay() - 1));
        if (getMonth() > 2) {
            month = !InstantKt.isLeapYear(getYear()) ? month - 2 : (-1) + month;
        }
        return buildInstant.invoke(Long.valueOf((((month - ((long) 719528)) * ((long) DateTimeConstants.SECONDS_PER_DAY)) + ((long) (((getHour() * 3600) + (getMinute() * 60)) + getSecond()))) - ((long) offsetSeconds)), Integer.valueOf(getNanosecond()));
    }
    ...
    public static final class Companion {
        ...
        public final UnboundLocalDateTime fromInstant(Instant instant) {
            ...
            if (j5 < 0) {
                ...
                long j6 = 146097;
                long j7 = ((j5 + 1) / j6) - 1;
                j2 = ((long) HttpStatus.SC_BAD_REQUEST) * j7;
                j5 += (-j7) * j6;
            } else {
                j = -1;
                j2 = 0;
            ...
            int i5 = i - (i4 * 3600);
            int i6 = i5 / 60;
            return new UnboundLocalDateTime((int) (j9 + j2 + ((long) (i3 / 10))), ((i3 + 2) % 12) + 1, (i2 - (((i3 * 306) + 5) / 10)) + 1, i4, i6, i5 - (i6 * 60), instant.getNanosecondsOfSecond());
        }
    }
}
