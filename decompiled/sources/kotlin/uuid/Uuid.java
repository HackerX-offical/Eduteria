...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m12561boximpl(ULong.m12567constructorimpl(getMostSignificantBits())), ULong.m12561boximpl(ULong.m12567constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m13877toUByteArrayTcUX1vc() {
        return UByteArray.m12464constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m12567constructorimpl(j), ULong.m12567constructorimpl(other.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m12567constructorimpl(this.leastSignificantBits), ULong.m12567constructorimpl(other.leastSignificantBits));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m13879fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m13878fromUByteArrayGBYM_sE(byte[] ubyteArray) {
