...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.get$context()).mo13962scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m13883delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m13884toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m13884toDelayMillisLRDsOJo(long j) {
        boolean zM13767isPositiveimpl = Duration.m13767isPositiveimpl(j);
        if (zM13767isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m13751getInWholeMillisecondsimpl(Duration.m13769plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM13767isPositiveimpl) {
