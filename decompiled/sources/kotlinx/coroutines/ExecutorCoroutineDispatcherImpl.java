...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo13961dispatch(CoroutineContext context, Runnable block) {
        ...
        try {
            ...
            cancelJobOnRejection(context, e2);
            Dispatchers.getIO().mo13961dispatch(context, block);
        }
    }
    ...
    public void mo13962scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        ...
        if (scheduledFutureScheduleBlock != null) {
            ...
            DefaultExecutor.INSTANCE.mo13962scheduleResumeAfterDelay(j, continuation);
        }
    }
