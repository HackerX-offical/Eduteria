...
public final /* synthetic */ class JobKt__JobKt {
    ...
    public static /* synthetic */ Job m13889Job$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m13888Job(job);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Since 1.2.0, binary compatibility with versions <= 1.1.x")
    /* JADX INFO: renamed from: Job, reason: collision with other method in class */
    public static final /* synthetic */ Job m13888Job(Job job) {
        return JobKt.Job(job);
    }
