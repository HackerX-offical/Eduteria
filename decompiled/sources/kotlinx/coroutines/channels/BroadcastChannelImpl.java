...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.channels.BroadcastChannelImpl", f = "BroadcastChannel.kt", i = {0, 0}, l = {ByteCode.PUTSTATIC}, m = "send", n = {"this", "element"}, s = {"L$0", "L$1"})
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.mo13895trySendJP2dKIU(getValue());
                }
    ...
    */
    ...
    public Object mo13895trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo13895trySendJP2dKIU(element);
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo13895trySendJP2dKIU(element);
            }
