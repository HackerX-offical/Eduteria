...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e2, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM13929trySendImplMj0NB7M = conflatedBufferedChannel.m13929trySendImplMj0NB7M(e2, true);
        if (objM13929trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m13914exceptionOrNullimpl(objM13929trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e2, Continuation<? super Boolean> continuation) {
        Object objM13929trySendImplMj0NB7M = conflatedBufferedChannel.m13929trySendImplMj0NB7M(e2, true);
        if (!(objM13929trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo13895trySendJP2dKIU(E element) {
        return m13929trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m13929trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m13928trySendDropLatestMj0NB7M(element, isSendOp) : m13904trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m13928trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo13895trySendJP2dKIU = super.mo13895trySendJP2dKIU(element);
        if (ChannelResult.m13920isSuccessimpl(objMo13895trySendJP2dKIU) || ChannelResult.m13918isClosedimpl(objMo13895trySendJP2dKIU)) {
            return objMo13895trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo13895trySendJP2dKIU = mo13895trySendJP2dKIU(element);
        if (!(objMo13895trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo13895trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m13914exceptionOrNullimpl(objMo13895trySendJP2dKIU);
