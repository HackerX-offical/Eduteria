...
public interface ReceiveChannel<E> {
    ...
    Object mo13902receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo13903tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo13903tryReceivePtdJZtk = receiveChannel.mo13903tryReceivePtdJZtk();
            if (ChannelResult.m13920isSuccessimpl(objMo13903tryReceivePtdJZtk)) {
                return (E) ChannelResult.m13916getOrThrowimpl(objMo13903tryReceivePtdJZtk);
            }
            Throwable thM13914exceptionOrNullimpl = ChannelResult.m13914exceptionOrNullimpl(objMo13903tryReceivePtdJZtk);
            if (thM13914exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM13914exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo13902receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
