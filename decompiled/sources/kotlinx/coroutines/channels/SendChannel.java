...
public interface SendChannel<E> {
    ...
    Object mo13895trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e2) throws Throwable {
            ...
            if (ChannelResult.m13920isSuccessimpl(objMo13895trySendJP2dKIU)) {
                return true;
            }
            Throwable thM13914exceptionOrNullimpl = ChannelResult.m13914exceptionOrNullimpl(objMo13895trySendJP2dKIU);
