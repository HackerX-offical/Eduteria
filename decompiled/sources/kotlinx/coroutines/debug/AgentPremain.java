...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM12393constructorimpl = Result.m12393constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM12393constructorimpl = Result.m12393constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m12399isFailureimpl(objM12393constructorimpl) ? null : objM12393constructorimpl);
