...
final class StartedWhileSubscribed implements SharingStarted {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.StartedWhileSubscribed$command$1", f = "SharingStarted.kt", i = {1, 2, 3}, l = {ByteCode.FRETURN, ByteCode.ARETURN, ByteCode.GETSTATIC, ByteCode.PUTSTATIC, ByteCode.PUTFIELD}, m = "invokeSuspend", n = {"$this$transformLatest", "$this$transformLatest", "$this$transformLatest"}, s = {"L$0", "L$0", "L$0"})
