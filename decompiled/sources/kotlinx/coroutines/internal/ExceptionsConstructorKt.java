...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e2) {
        ...
        if (e2 instanceof CopyableThrowable) {
            try {
                ...
                objM12393constructorimpl = Result.m12393constructorimpl(((CopyableThrowable) e2).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM12393constructorimpl;
        }
    ...
    public static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            objM12393constructorimpl = Result.m12393constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            objM12393constructorimpl = Result.m12393constructorimpl(ResultKt.createFailure(th3));
        }
        return (Throwable) (Result.m12399isFailureimpl(objM12393constructorimpl) ? null : objM12393constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM12393constructorimpl = Result.m12393constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM12393constructorimpl = Result.m12393constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m12399isFailureimpl(objM12393constructorimpl)) {
            objM12393constructorimpl = numValueOf;
        }
        return ((Number) objM12393constructorimpl).intValue();
    }
