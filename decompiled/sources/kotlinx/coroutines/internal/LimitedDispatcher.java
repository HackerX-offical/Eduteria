...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo13962scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo13962scheduleResumeAfterDelay(timeMillis, continuation);
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (i >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo13961dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
    ...
    public void mo13961dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo13961dispatch(this, new Worker(runnableObtainTaskOrDeallocateWorker));
    }
