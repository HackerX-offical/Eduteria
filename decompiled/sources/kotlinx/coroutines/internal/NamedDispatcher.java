...
public final class NamedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo13961dispatch(CoroutineContext context, Runnable block) {
        this.dispatcher.mo13961dispatch(context, block);
    }
