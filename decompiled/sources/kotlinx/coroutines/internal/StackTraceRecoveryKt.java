...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM12393constructorimpl2;
        ...
        try {
            ...
            objM12393constructorimpl = Result.m12393constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM12393constructorimpl = Result.m12393constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m12396exceptionOrNullimpl(objM12393constructorimpl) == null) {
            obj2 = objM12393constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM12393constructorimpl2 = Result.m12393constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM12393constructorimpl2 = Result.m12393constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m12396exceptionOrNullimpl(objM12393constructorimpl2) == null) {
            obj = objM12393constructorimpl2;
        }
