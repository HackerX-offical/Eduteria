...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo13982getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            try {
                ...
                objM12393constructorimpl = Result.m12393constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
            ...
            Object objPutIfAbsent = concurrentHashMap2.putIfAbsent(arrayList2, resultM12392boximpl);
