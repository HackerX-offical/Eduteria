...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m13987computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                objM12393constructorimpl = Result.m12393constructorimpl(producer.invoke());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM12393constructorimpl = Result.m12393constructorimpl(ResultKt.createFailure(th));
            }
            Result resultM12392boximpl = Result.m12392boximpl(objM12393constructorimpl);
            Object objPutIfAbsent = concurrentHashMap.putIfAbsent(arrayList2, resultM12392boximpl);
            obj = objPutIfAbsent == null ? resultM12392boximpl : objPutIfAbsent;
        }
