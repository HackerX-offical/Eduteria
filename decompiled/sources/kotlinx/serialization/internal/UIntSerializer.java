...
public final class UIntSerializer implements KSerializer<UInt> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UInt.m12482boximpl(m14004deserializeOGnWXxg(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m14005serializeQn1smSk(encoder, ((UInt) obj).getData());
    }
    ...
    public void m14005serializeQn1smSk(Encoder encoder, int value) {
    ...
    public int m14004deserializeOGnWXxg(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UInt.m12488constructorimpl(decoder.decodeInline(getDescriptor()).decodeInt());
    }
}
