...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return ULong.m12561boximpl(m14012deserializeI7RO_PI(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m14013serialize2TYgG_w(encoder, ((ULong) obj).getData());
    }
    ...
    public void m14013serialize2TYgG_w(Encoder encoder, long value) {
    ...
    public long m14012deserializeI7RO_PI(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return ULong.m12567constructorimpl(decoder.decodeInline(getDescriptor()).decodeLong());
    }
}
