...
public class SamsungHomeBadger implements Badger {
    private static final String[] CONTENT_PROJECTION = {"_id", Const.CLASS};
        ...
        try {
            ...
            if (cursorQuery != null) {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    if (className.equals(cursorQuery.getString(cursorQuery.getColumnIndex(Const.CLASS)))) {
                        z = true;
                    }
                }
                if (!z) {
    ...
    private ContentValues getContentValues(ComponentName componentName, int i, boolean z) {
        ...
        if (z) {
            contentValues.put(AnalyticsConstants.PACKAGE, componentName.getPackageName());
            contentValues.put(Const.CLASS, componentName.getClassName());
        }
