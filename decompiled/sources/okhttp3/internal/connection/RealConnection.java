...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    */
    ...
    private final void connectTls(ConnectionSpecSelector connectionSpecSelector) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                if (sSLSocket != null) {
                    Util.closeQuietly((java.net.Socket) sSLSocket);
                }
                throw th;
            }
        } catch (Throwable th2) {
    ...
    public static final class Companion {
        ...
        public final RealConnection newTestConnection(RealConnectionPool connectionPool, Route route, java.net.Socket socket, long idleAtNs) {
            Intrinsics.checkNotNullParameter(connectionPool, "connectionPool");
            Intrinsics.checkNotNullParameter(route, "route");
