...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public final void connect(OkHttpClient client) {
        ...
        final Request requestBuild = this.originalRequest.newBuilder().header("Upgrade", io.socket.engineio.client.transports.WebSocket.NAME).header("Connection", "Upgrade").header(HttpHeaders.SEC_WEBSOCKET_KEY, this.key).header(HttpHeaders.SEC_WEBSOCKET_VERSION, "13").header(HttpHeaders.SEC_WEBSOCKET_EXTENSIONS, "permessage-deflate").build();
    ...
    public final void checkUpgradeSuccess$okhttp(Response response, Exchange exchange) throws IOException {
        ...
        if (!StringsKt.equals(io.socket.engineio.client.transports.WebSocket.NAME, strHeader$default2, true)) {
