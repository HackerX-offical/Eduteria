            ...
            for (int i = 0; i < size; i++) {
                if (StringsKt.equals(responseHeaders.name(i), "Sec-WebSocket-Extensions", true)) {
                    ...
                    while (i2 < strValue.length()) {
                        int i3 = i2;
                        int iDelimiterOffset$default = Util.delimiterOffset$default(strValue, CsvReader.Letters.COMMA, i3, 0, 4, (Object) null);
