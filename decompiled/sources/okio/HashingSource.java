...
public final class HashingSource extends ForwardingSource implements Source {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = HashElement.ELEMENT, imports = {}))
    /* JADX INFO: renamed from: -deprecated_hash, reason: not valid java name */
    public final ByteString m14179deprecated_hash() {
        return hash();
    }
    ...
    public static final class Companion {
        ...
        public final HashingSource md5(Source source) {
            Intrinsics.checkNotNullParameter(source, "source");
            return new HashingSource(source, StringUtils.MD5);
        }
