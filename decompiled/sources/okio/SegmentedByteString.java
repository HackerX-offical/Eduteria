...
public final class SegmentedByteString {
    ...
    public static final String toHexString(byte b2) {
        return StringsKt.concatToString(new char[]{okio.internal.ByteString.getHEX_DIGIT_CHARS()[(b2 >> 4) & 15], okio.internal.ByteString.getHEX_DIGIT_CHARS()[b2 & Ascii.SI]});
    }
