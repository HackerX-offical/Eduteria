...
public final class RealBufferedSource {
    ...
    public static final long commonReadDecimalLong(okio.RealBufferedSource realBufferedSource) throws EOFException {
        ...
        while (true) {
            ...
            b2 = realBufferedSource.bufferField.getByte(j);
    ...
    public static final long commonReadHexadecimalUnsignedLong(okio.RealBufferedSource realBufferedSource) throws EOFException {
        ...
        while (true) {
            ...
            b2 = realBufferedSource.bufferField.getByte(i);
    ...
    public static final long commonIndexOf(okio.RealBufferedSource realBufferedSource, byte b2, long j, long j2) {
        Intrinsics.checkNotNullParameter(realBufferedSource, "<this>");
        if (realBufferedSource.closed) {
            throw new IllegalStateException("closed".toString());
        }
        ...
        while (jMax < j2) {
            byte b3 = b2;
            long j3 = j2;
            long jIndexOf = realBufferedSource.bufferField.indexOf(b3, jMax, j3);
            if (jIndexOf != -1) {
                return jIndexOf;
            }
