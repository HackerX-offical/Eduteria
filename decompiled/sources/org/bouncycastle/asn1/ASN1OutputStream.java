...
public class ASN1OutputStream {
    ...
    final void writeEncoded(boolean z, int i, byte b2) throws IOException {
        if (z) {
            write(i);
        }
        writeLength(1);
    ...
    final void writeEncoded(boolean z, int i, byte b2, byte[] bArr) throws IOException {
        if (z) {
            write(i);
        }
    ...
    final void writeEncoded(boolean z, int i, byte b2, byte[] bArr, int i2, int i3, byte b3) throws IOException {
        if (z) {
            write(i);
        }
        writeLength(i3 + 2);
