...
public interface CMCObjectIdentifiers {
    ...
    static {
        ...
        id_cmc_identityProof = aSN1ObjectIdentifierBranch.branch("3");
        ...
        id_cmc_identification = aSN1ObjectIdentifierBranch.branch("2");
        ...
        id_cct_PKIData = aSN1ObjectIdentifierBranch2.branch("2");
        id_cct_PKIResponse = aSN1ObjectIdentifierBranch2.branch("3");
        ...
        id_cmc_trustedAnchors = aSN1ObjectIdentifierBranch.branch(Constants.LEFT_NAV_KEY.user_support);
        id_cmc_authData = aSN1ObjectIdentifierBranch.branch(Constants.LEFT_NAV_KEY.bookmark);
        id_cmc_batchRequests = aSN1ObjectIdentifierBranch.branch(Constants.LEFT_NAV_KEY.pdfDownload);
        id_cmc_batchResponses = aSN1ObjectIdentifierBranch.branch(Constants.LEFT_NAV_KEY.testReport);
        id_cmc_publishCert = aSN1ObjectIdentifierBranch.branch("30");
        id_cmc_modCertTemplate = aSN1ObjectIdentifierBranch.branch(Constants.LEFT_NAV_KEY.Course_Chat);
        id_cmc_controlProcessed = aSN1ObjectIdentifierBranch.branch(Constants.LEFT_NAV_KEY.attendance_report);
        id_cmc_identityProofV2 = aSN1ObjectIdentifierBranch.branch(Constants.LEFT_NAV_KEY.TEACHER_TIME_TABLE);
        id_cmc_popLinkWitnessV2 = aSN1ObjectIdentifierBranch.branch(Constants.LEFT_NAV_KEY.LANGUAGE);
    }
}
