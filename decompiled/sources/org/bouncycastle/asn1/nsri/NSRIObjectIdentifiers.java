...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_aria128_ocb2 = aSN1ObjectIdentifierBranch2.branch(Constants.LEFT_NAV_KEY.Course_Chat);
        id_aria192_ocb2 = aSN1ObjectIdentifierBranch2.branch(Constants.LEFT_NAV_KEY.attendance_report);
        id_aria256_ocb2 = aSN1ObjectIdentifierBranch2.branch(Constants.LEFT_NAV_KEY.LANGUAGE);
        id_aria128_gcm = aSN1ObjectIdentifierBranch2.branch(Constants.LEFT_NAV_KEY.TEACHER_TIME_TABLE);
        id_aria192_gcm = aSN1ObjectIdentifierBranch2.branch(Constants.LEFT_NAV_KEY.STUDENT_RESULT);
        id_aria256_gcm = aSN1ObjectIdentifierBranch2.branch(Constants.LEFT_NAV_KEY.NOTICE_BOARD);
        id_aria128_ccm = aSN1ObjectIdentifierBranch2.branch(Constants.LEFT_NAV_KEY.LEFT_DOUBT);
        id_aria192_ccm = aSN1ObjectIdentifierBranch2.branch(Constants.LEFT_NAV_KEY.CUSTOM_TEST);
        ...
        id_aria256_kw = aSN1ObjectIdentifierBranch2.branch(RoomMasterTable.DEFAULT_ID);
