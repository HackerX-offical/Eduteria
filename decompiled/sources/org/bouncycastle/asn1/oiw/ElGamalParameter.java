...
public class ElGamalParameter extends ASN1Object {
    ...
    public BigInteger getG() {
        return this.f1355g.getPositiveValue();
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f1355g);
