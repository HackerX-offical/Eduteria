...
public interface SECObjectIdentifiers {
    ...
    static {
        ...
        sect233k1 = aSN1ObjectIdentifier.branch(Constants.LEFT_NAV_KEY.user_support);
        sect233r1 = aSN1ObjectIdentifier.branch(Constants.LEFT_NAV_KEY.bookmark);
        secp128r1 = aSN1ObjectIdentifier.branch(Constants.LEFT_NAV_KEY.pdfDownload);
        secp128r2 = aSN1ObjectIdentifier.branch(Constants.LEFT_NAV_KEY.testReport);
        secp160r2 = aSN1ObjectIdentifier.branch("30");
        secp192k1 = aSN1ObjectIdentifier.branch(Constants.LEFT_NAV_KEY.Course_Chat);
        secp224k1 = aSN1ObjectIdentifier.branch(Constants.LEFT_NAV_KEY.attendance_report);
        secp224r1 = aSN1ObjectIdentifier.branch(Constants.LEFT_NAV_KEY.LANGUAGE);
        secp384r1 = aSN1ObjectIdentifier.branch(Constants.LEFT_NAV_KEY.TEACHER_TIME_TABLE);
        secp521r1 = aSN1ObjectIdentifier.branch(Constants.LEFT_NAV_KEY.STUDENT_RESULT);
        sect409k1 = aSN1ObjectIdentifier.branch(Constants.LEFT_NAV_KEY.NOTICE_BOARD);
        sect409r1 = aSN1ObjectIdentifier.branch(Constants.LEFT_NAV_KEY.LEFT_DOUBT);
        sect571k1 = aSN1ObjectIdentifier.branch(Constants.LEFT_NAV_KEY.CUSTOM_TEST);
