...
public class DSTU4145ECBinary extends ASN1Object {
    ...
    ASN1OctetString f1359b;
    ASN1OctetString bp;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    DSTU4145BinaryField f1360f;
    ASN1Integer n;
    BigInteger version;
    ...
    private DSTU4145ECBinary(ASN1Sequence aSN1Sequence) {
        ...
        this.f1360f = DSTU4145BinaryField.getInstance(aSN1Sequence.getObjectAt(i));
        this.f1358a = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(i + 1));
        this.f1359b = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(i + 2));
    ...
    public DSTU4145ECBinary(ECDomainParameters eCDomainParameters) {
        ...
        this.f1360f = dSTU4145BinaryField;
        this.f1358a = new ASN1Integer(curve.getA().toBigInteger());
        this.f1359b = new DEROctetString(curve.getB().getEncoded());
    ...
    public BigInteger getA() {
        return this.f1358a.getValue();
    }

    public byte[] getB() {
        return Arrays.clone(this.f1359b.getOctets());
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f1360f);
        aSN1EncodableVector.add(this.f1358a);
        aSN1EncodableVector.add(this.f1359b);
