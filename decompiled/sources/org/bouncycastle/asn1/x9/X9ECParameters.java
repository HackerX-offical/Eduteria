...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    private X9ECPoint f1365g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private BigInteger f1366h;
    ...
    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() == 6) {
            this.f1366h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
        }
        X9Curve x9Curve = new X9Curve(X9FieldID.getInstance(aSN1Sequence.getObjectAt(1)), this.n, this.f1366h, ASN1Sequence.getInstance(aSN1Sequence.getObjectAt(2)));
        this.curve = x9Curve.getCurve();
        ASN1Encodable objectAt = aSN1Sequence.getObjectAt(3);
        if (objectAt instanceof X9ECPoint) {
            this.f1365g = (X9ECPoint) objectAt;
        } else {
            this.f1365g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
        }
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        X9FieldID x9FieldID;
        this.curve = eCCurve;
        this.f1365g = x9ECPoint;
        this.n = bigInteger;
        this.f1366h = bigInteger2;
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f1365g);
        aSN1EncodableVector.add(new ASN1Integer(this.n));
        if (this.f1366h != null) {
            aSN1EncodableVector.add(new ASN1Integer(this.f1366h));
        }
