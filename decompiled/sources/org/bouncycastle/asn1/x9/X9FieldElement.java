...
public class X9FieldElement extends ASN1Object {
    ...
    protected ECFieldElement f1368f;
    ...
    public ASN1Primitive toASN1Primitive() {
        return new DEROctetString(converter.integerToBytes(this.f1368f.toBigInteger(), converter.getByteLength(this.f1368f)));
    }
}
