...
public interface SignatureSubpacketTags {
    public static final int ATTESTED_CERTIFICATIONS = 37;
    ...
    public static final int INTENDED_RECIPIENT_FINGERPRINT = 35;
    public static final int ISSUER_FINGERPRINT = 33;
    ...
    public static final int PREFERRED_AEAD_ALGORITHMS = 34;
