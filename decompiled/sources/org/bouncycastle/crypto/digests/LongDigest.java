...
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
    ...
    protected void processBlock() {
        ...
        while (i2 < 10) {
            ...
            long j14 = j11;
            long j15 = j9;
            long jSum1 = Sum1(j11) + Ch(j11, j13, j9);
            long[] jArr3 = K;
            int i4 = i3 + 1;
            long j16 = j10 + jSum1 + jArr3[i3] + this.W[i3];
            long j17 = j6 + j16;
            long j18 = jSum0;
            long j19 = j12;
            long j20 = j8;
            ...
            int i5 = i3 + 2;
            long jSum12 = j15 + Sum1(j17) + Ch(j17, j14, j13) + jArr3[i4] + this.W[i4];
            long j21 = j20 + jSum12;
            long jSum03 = jSum12 + Sum0(jSum02) + Maj(jSum02, j18, j19);
            int i6 = i3 + 3;
            long jSum13 = j13 + Sum1(j21) + Ch(j21, j17, j14) + jArr3[i5] + this.W[i5];
            long j22 = j19 + jSum13;
            long jSum04 = jSum13 + Sum0(jSum03) + Maj(jSum03, jSum02, j18);
            int i7 = i3 + 4;
            long jSum14 = j14 + Sum1(j22) + Ch(j22, j21, j17) + jArr3[i6] + this.W[i6];
            long j23 = j18 + jSum14;
            long jSum05 = jSum14 + Sum0(jSum04) + Maj(jSum04, jSum03, jSum02);
            int i8 = i3 + 5;
            long jSum15 = j17 + Sum1(j23) + Ch(j23, j22, j21) + jArr3[i7] + this.W[i7];
            long j24 = jSum02 + jSum15;
            long jSum06 = jSum15 + Sum0(jSum05) + Maj(jSum05, jSum04, jSum03);
            int i9 = i3 + 6;
            long jSum16 = j21 + Sum1(j24) + Ch(j24, j23, j22) + jArr3[i8] + this.W[i8];
            long j25 = jSum03 + jSum16;
            long jSum07 = jSum16 + Sum0(jSum06) + Maj(jSum06, jSum05, jSum04);
            int i10 = i3 + 7;
            long jSum17 = j22 + Sum1(j25) + Ch(j25, j24, j23) + jArr3[i9] + this.W[i9];
            long j26 = jSum04 + jSum17;
            long jSum08 = jSum17 + Sum0(jSum07) + Maj(jSum07, jSum06, jSum05);
            i3 += 8;
            long jSum18 = j23 + Sum1(j26) + Ch(j26, j25, j24) + jArr3[i10] + this.W[i10];
