...
public final class WhirlpoolDigest implements ExtendedDigest, Memoable {
    ...
    private long[] _state;
    private static final int[] SBOX = {24, 35, ByteCode.IFNULL, 232, 135, ByteCode.INVOKESTATIC, 1, 79, 54, 166, 210, 245, 121, 111, 145, 82, 96, 188, 155, 142, 163, 12, 123, 53, 29, 224, 215, ByteCode.MONITORENTER, 46, 75, 254, 87, 21, 119, 55, 229, 159, 240, 74, 218, 88, 201, 41, 10, ByteCode.RETURN, 160, 107, 133, 189, 93, 16, 244, 203, 62, 5, 103, 228, 39, 65, 139, ByteCode.GOTO, 125, 149, 216, 251, 238, 124, 102, Constants.EASY_PAY_MINIMIZE_ASSIST, 23, 71, 158, 202, 45, ByteCode.ATHROW, 7, ByteCode.LRETURN, 90, 131, 51, 99, 2, 170, 113, 200, 25, 73, 217, 242, 227, 91, 136, 154, 38, 50, ByteCode.ARETURN, 233, 15, 213, 128, 190, HttpStatus.SC_RESET_CONTENT, 52, 72, 255, 122, 144, 95, 32, 104, 26, ByteCode.FRETURN, 180, 84, 147, 34, 100, 241, 115, 18, 64, 8, ByteCode.MONITOREXIT, 236, 219, 161, 141, 61, 151, 0, 207, 43, 118, 130, 214, 27, ByteCode.PUTFIELD, ByteCode.DRETURN, 106, 80, 69, 243, 48, 239, 63, 85, 162, 234, 101, ByteCode.INVOKEDYNAMIC, 47, 192, Constants.EASY_PAY_MAXIMIZE_ASSIST, 28, 253, 77, 146, 117, 6, 138, ByteCode.GETSTATIC, 230, 14, 31, 98, 212, 168, 150, 249, ByteCode.MULTIANEWARRAY, 37, 89, 132, 114, 57, 76, 94, 120, 56, 140, 209, 165, 226, 97, ByteCode.PUTSTATIC, 33, 156, 30, 67, ByteCode.IFNONNULL, 252, 4, 81, 153, 109, 13, 250, 223, 126, 36, 59, ByteCode.LOOKUPSWITCH, 206, 17, 143, 78, ByteCode.INVOKESPECIAL, 235, 60, 129, 148, 247, ByteCode.INVOKEINTERFACE, 19, 44, Primes.SMALL_FACTOR_LIMIT, 231, 110, ByteCode.WIDE, 3, 86, 68, 127, ByteCode.RET, 42, ByteCode.NEW, ByteCode.INSTANCEOF, 83, 220, 11, 157, 108, 49, 116, 246, 70, 172, 137, 20, 225, 22, 58, 105, 9, 112, ByteCode.INVOKEVIRTUAL, 208, 237, 204, 66, 152, 164, 40, 92, 248, 134};
    ...
    protected void processBlock() {
        ...
        for (int i2 = 1; i2 <= 10; i2++) {
            ...
            while (i4 < 8) {
                ...
                jArr9[i4] = j12;
                long j13 = j12 ^ C2[((int) (jArr11[(i4 - 2) & 7] >>> c5)) & 255];
                jArr9[i4] = j13;
                long j14 = j13 ^ C3[((int) (jArr11[(i4 - 3) & 7] >>> c4)) & 255];
                jArr9[i4] = j14;
