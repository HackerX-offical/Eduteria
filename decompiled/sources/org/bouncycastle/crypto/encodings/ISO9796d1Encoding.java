...
public class ISO9796d1Encoding implements AsymmetricBlockCipher {
    ...
    private static byte[] shadows = {14, 3, 5, 8, 9, 4, 2, Ascii.SI, 0, 13, 11, 6, 7, 10, 12, 1};
    private static byte[] inverse = {8, Ascii.SI, 6, 1, 5, 2, 11, 12, 3, 4, 13, 10, 14, 9, 0, 7};
    ...
    private byte[] decodeBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        byte[] bArr2 = shadows;
        byte b2 = bArrConvertOutputDecryptOnly[1];
        byte b3 = (byte) (bArr2[b2 & Ascii.SI] | (bArr2[(b2 & 255) >>> 4] << 4));
        bArrConvertOutputDecryptOnly[0] = b3;
        int i4 = 1;
        int i5 = 0;
        boolean z = false;
        for (int length = bArrConvertOutputDecryptOnly.length - 1; length >= bArrConvertOutputDecryptOnly.length - (i3 * 2); length -= 2) {
            byte[] bArr3 = shadows;
            byte b4 = bArrConvertOutputDecryptOnly[length];
            int i6 = bArr3[b4 & Ascii.SI] | (bArr3[(b4 & 255) >>> 4] << 4);
            int i7 = length - 1;
            byte b5 = bArrConvertOutputDecryptOnly[i7];
            if (((b5 ^ i6) & 255) != 0) {
                if (z) {
    ...
    private byte[] encodeBlock(byte[] bArr, int i, int i2) throws InvalidCipherTextException {
        ...
        for (int i10 = i4 - (i7 * 2); i10 != i4; i10 += 2) {
            byte b2 = bArr2[(i4 - i7) + (i10 / 2)];
            byte[] bArr3 = shadows;
            bArr2[i10] = (byte) (bArr3[b2 & Ascii.SI] | (bArr3[(b2 & 255) >>> 4] << 4));
            bArr2[i10 + 1] = b2;
        }
        int i11 = i4 - (i2 * 2);
        ...
        if (i13 != 8) {
            byte b3 = (byte) (bArr2[0] & (255 >>> i13));
            bArr2[0] = b3;
            bArr2[0] = (byte) ((128 >>> i13) | b3);
            i5 = 0;
        } else {
            bArr2[0] = 0;
