...
public final class CAST6Engine extends CAST5Engine {
    ...
    protected void setKey(byte[] bArr) {
        ...
        while (i7 < 12) {
            ...
            int i14 = i8 + 6;
            iArr7[c3] = iArr7[c3] ^ F1(iArr7[1], this._Tm[i14], this._Tr[i14]);
            int[] iArr8 = this._workingKey;
            int i15 = i8 + 7;
            iArr8[7] = F2(iArr8[c3], this._Tm[i15], this._Tr[i15]) ^ iArr8[7];
            int i16 = ((i7 * 2) + 1) * 8;
            ...
            int i22 = i16 + 6;
            iArr15[c3] = iArr15[c3] ^ F1(iArr15[1], this._Tm[i22], this._Tr[i22]);
            int[] iArr16 = this._workingKey;
            int i23 = i16 + 7;
            iArr16[7] = F2(iArr16[c3], this._Tm[i23], this._Tr[i23]) ^ iArr16[7];
            int[] iArr17 = this._Kr;
            int i24 = i7 * 4;
            int[] iArr18 = this._workingKey;
            iArr17[i24] = iArr18[c3] & 31;
            int i25 = i24 + 1;
