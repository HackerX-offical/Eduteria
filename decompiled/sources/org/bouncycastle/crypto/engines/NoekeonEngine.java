...
public class NoekeonEngine implements BlockCipher {
    ...
    private static final int[] roundConstants = {128, 27, 54, 108, 216, ByteCode.LOOKUPSWITCH, 77, 154, 47, 94, 188, 99, ByteCode.IFNULL, 151, 53, 106, 212};
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (true) {
            ...
            if (i3 <= 0) {
                ...
                int i4 = roundConstants[i3] ^ iArr4[0];
                iArr4[0] = i4;
