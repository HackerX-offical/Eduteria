...
public class KDFDoublePipelineIterationBytesGenerator implements MacDerivationFunction {
    private static final BigInteger INTEGER_MAX = BigInteger.valueOf(SieveCacheKt.NodeLinkMask);
    ...
    private void generateNext() {
        if (this.generatedBytes == 0) {
            ...
            this.prf.doFinal(this.f1393a, 0);
        } else {
            Mac mac2 = this.prf;
            byte[] bArr2 = this.f1393a;
            mac2.update(bArr2, 0, bArr2.length);
            this.prf.doFinal(this.f1393a, 0);
        }
        Mac mac3 = this.prf;
        byte[] bArr3 = this.f1393a;
        mac3.update(bArr3, 0, bArr3.length);
        if (this.useCounter) {
            int i = (this.generatedBytes / this.f1394h) + 1;
            byte[] bArr4 = this.ios;
    ...
    public void init(DerivationParameters derivationParameters) {
        ...
        if (kDFDoublePipelineIterationParameters.useCounter()) {
            BigInteger bigIntegerMultiply = TWO.pow(r).multiply(BigInteger.valueOf(this.f1394h));
