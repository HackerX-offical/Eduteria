...
public class SipHash implements Mac {
    ...
    public long doFinal() throws IllegalStateException, DataLengthException {
        long j = this.m;
        int i = this.wordPos;
        this.m = ((j >>> ((7 - i) << 3)) >>> 8) | ((((long) ((this.wordCount << 3) + i)) & 255) << 56);
        processMessageWord();
        this.v2 ^= 255;
        applySipRounds(this.f1398d);
    ...
    public String getAlgorithmName() {
        return "SipHash-" + this.f1397c + "-" + this.f1398d;
    }
    ...
    public void update(byte b2) throws IllegalStateException {
        this.m = (this.m >>> 8) | ((((long) b2) & 255) << 56);
    ...
    public void update(byte[] bArr, int i, int i2) throws IllegalStateException, DataLengthException {
        ...
        if (i4 == 0) {
            ...
            while (i5 < i2) {
                long j2 = this.m >>> 8;
                this.m = j2;
                this.m = j2 | ((((long) bArr[i + i5]) & 255) << 56);
                i5++;
            }
            this.wordPos = i2 - i3;
            return;
        ...
        while (i7 < i2) {
            long j4 = this.m >>> 8;
            this.m = j4;
            this.m = j4 | ((((long) bArr[i + i7]) & j3) << c3);
