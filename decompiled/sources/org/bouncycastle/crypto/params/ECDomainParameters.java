...
public class ECDomainParameters implements ECConstants {
    ...
    private final BigInteger f1406h;
    ...
    public ECDomainParameters(ECCurve eCCurve, ECPoint eCPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        ...
        if (bigInteger == null) {
            throw new NullPointerException(CTProductConfigConstants.PRODUCT_CONFIG_JSON_KEY_FOR_KEY);
        }
        this.curve = eCCurve;
        this.G = validatePublicPoint(eCCurve, eCPoint);
        this.n = bigInteger;
        this.f1406h = bigInteger2;
    ...
    public synchronized BigInteger getHInv() {
        if (this.hInv == null) {
            this.hInv = this.f1406h.modInverse(this.n);
        }
        return this.hInv;
    }
