...
public class PSSSigner implements Signer {
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        if ((b2 & 255) != (b2 & length) || bArr2[bArr2.length - 1] != this.trailer) {
            clearBlock(bArr2);
            return false;
        }
        int length2 = bArr2.length;
        int i = this.hLen;
        byte[] bArrMaskGeneratorFunction1 = maskGeneratorFunction1(bArr2, (length2 - i) - 1, i, (bArr2.length - i) - 1);
        for (int i2 = 0; i2 != bArrMaskGeneratorFunction1.length; i2++) {
            byte[] bArr6 = this.block;
            bArr6[i2] = (byte) (bArr6[i2] ^ bArrMaskGeneratorFunction1[i2]);
        }
        byte[] bArr7 = this.block;
