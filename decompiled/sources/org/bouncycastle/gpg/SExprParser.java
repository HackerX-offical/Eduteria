...
public class SExprParser {
    ...
    private static byte[][] extractData(InputStream inputStream, PBEProtectionRemoverFactory pBEProtectionRemoverFactory) throws IOException, PGPException {
    ...
    private BigInteger processDSASecretKey(InputStream inputStream, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, PBEProtectionRemoverFactory pBEProtectionRemoverFactory) throws IOException, PGPException {
        ...
        SXprUtils.skipOpenParenthesis(byteArrayInputStream);
        if (!SXprUtils.readString(byteArrayInputStream, byteArrayInputStream.read()).equals(HashElement.ELEMENT)) {
        ...
        if (pGPDigestCalculatorProvider != null) {
            ...
            writeCanonical(outputStream, XHTMLText.Q, bigInteger2);
    ...
    private BigInteger processECSecretKey(InputStream inputStream, String str, String str2, byte[] bArr, PBEProtectionRemoverFactory pBEProtectionRemoverFactory) throws IOException, PGPException {
        ...
        if (pGPDigestCalculatorProvider != null) {
            ...
            writeCanonical(outputStream, XHTMLText.Q, bArr);
    ...
    private BigInteger[] processRSASecretKey(InputStream inputStream, BigInteger bigInteger, BigInteger bigInteger2, PBEProtectionRemoverFactory pBEProtectionRemoverFactory) throws IOException, PGPException {
        ...
        byte[][] bArrExtractData = extractData(inputStream2, pBEProtectionRemoverFactory);
        if (bArrExtractData == null) {
            bigInteger3 = new BigInteger(1, SXprUtils.readBytes(inputStream2, inputStream2.read()));
        ...
        BigInteger bigInteger4 = readBigInteger("p", inputStream2);
        BigInteger bigInteger5 = readBigInteger(XHTMLText.Q, inputStream2);
        BigInteger bigInteger6 = readBigInteger("u", inputStream2);
        if (bArrExtractData == null) {
            return new BigInteger[]{bigInteger3, bigInteger4, bigInteger5, bigInteger6};
        }
        SXprUtils.skipCloseParenthesis(inputStream2);
        SXprUtils.skipOpenParenthesis(inputStream2);
        if (!SXprUtils.readString(inputStream2, inputStream2.read()).equals(HashElement.ELEMENT)) {
            throw new PGPException("hash keyword expected");
        }
        if (!SXprUtils.readString(inputStream2, inputStream2.read()).equals("sha1")) {
            throw new PGPException("hash keyword expected");
        }
        byte[] bytes = SXprUtils.readBytes(inputStream2, inputStream2.read());
        SXprUtils.skipCloseParenthesis(inputStream2);
        PGPDigestCalculatorProvider pGPDigestCalculatorProvider = this.digestProvider;
        if (pGPDigestCalculatorProvider != null) {
            PGPDigestCalculator pGPDigestCalculator = pGPDigestCalculatorProvider.get(2);
            ...
            c2 = 2;
            writeCanonical(outputStream, CTProductConfigConstants.PRODUCT_CONFIG_JSON_KEY_FOR_KEY, bigInteger);
            writeCanonical(outputStream, "e", bigInteger2);
            writeCanonical(outputStream, "d", bigInteger3);
            writeCanonical(outputStream, "p", bigInteger4);
            writeCanonical(outputStream, XHTMLText.Q, bigInteger5);
        ...
        bigIntegerArr[c2] = bigInteger5;
        bigIntegerArr[3] = bigInteger6;
    ...
    public PGPSecretKey parseSecretKey(InputStream inputStream, PBEProtectionRemoverFactory pBEProtectionRemoverFactory, PGPPublicKey pGPPublicKey) throws IOException, PGPException {
        ...
        if (string2.equals("ecc")) {
            ...
            SXprUtils.skipCloseParenthesis(inputStream);
            SXprUtils.skipOpenParenthesis(inputStream);
            if (!SXprUtils.readString(inputStream, inputStream.read()).equals(XHTMLText.Q)) {
            ...
            ECDSAPublicBCPGKey eCDSAPublicBCPGKey = new ECDSAPublicBCPGKey(ECNamedCurveTable.getOID(string4.startsWith("NIST ") ? string4.substring("NIST ".length()) : string4), new BigInteger(1, bytes));
        ...
        if (string2.equals("dsa")) {
            BigInteger bigInteger = readBigInteger("p", inputStream);
            BigInteger bigInteger2 = readBigInteger(XHTMLText.Q, inputStream);
        ...
        if (string2.equals("elg")) {
            BigInteger bigInteger5 = readBigInteger("p", inputStream);
        ...
        BigInteger bigInteger8 = readBigInteger(CTProductConfigConstants.PRODUCT_CONFIG_JSON_KEY_FOR_KEY, inputStream);
