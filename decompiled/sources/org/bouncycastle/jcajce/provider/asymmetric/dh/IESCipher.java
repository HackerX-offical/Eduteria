...
public class IESCipher extends CipherSpi {
    ...
    private final JcaJceHelper f1419helper;
    ...
    public IESCipher(IESEngine iESEngine) {
        this.f1419helper = new BCJcaJceHelper();
        this.state = -1;
    ...
    public AlgorithmParameters engineGetParameters() {
        if (this.engineParam == null && this.engineSpec != null) {
            try {
                AlgorithmParameters algorithmParametersCreateAlgorithmParameters = this.f1419helper.createAlgorithmParameters("IES");
