...
public class BCDSTU4145PrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private transient BigInteger f1421d;
    ...
    public BCDSTU4145PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f1421d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public BCDSTU4145PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f1421d = eCPrivateKeySpec.getS();
    ...
    public BCDSTU4145PrivateKey(BCDSTU4145PrivateKey bCDSTU4145PrivateKey) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f1421d = bCDSTU4145PrivateKey.f1421d;
    ...
    public BCDSTU4145PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "DSTU4145";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f1421d = eCPrivateKeySpec.getD();
    ...
    /* JADX WARN: Removed duplicated region for block: B:18:0x00ab A[Catch: IOException -> 0x00db, TryCatch #0 {IOException -> 0x00db, blocks: (B:16:0x00a1, B:18:0x00ab, B:20:0x00d4, B:19:0x00c0), top: B:23:0x00a1 }] */
    /* JADX WARN: Removed duplicated region for block: B:19:0x00c0 A[Catch: IOException -> 0x00db, TryCatch #0 {IOException -> 0x00db, blocks: (B:16:0x00a1, B:18:0x00ab, B:20:0x00d4, B:19:0x00c0), top: B:23:0x00a1 }] */
    @Override // java.security.Key
    /*
    ...
    */
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f1421d, engineGetSpec());
    }
}
