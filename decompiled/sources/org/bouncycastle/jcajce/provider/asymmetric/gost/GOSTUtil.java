...
class GOSTUtil {
    ...
    static String privateKeyToString(String str, BigInteger bigInteger, GOST3410Parameters gOST3410Parameters) {
        ...
        stringBuffer.append(" Private Key [").append(generateKeyFingerprint(bigIntegerModPow, gOST3410Parameters)).append(Constants.AES_SUFFIX).append(strLineSeparator);
    ...
    static String publicKeyToString(String str, BigInteger bigInteger, GOST3410Parameters gOST3410Parameters) {
        ...
        String strLineSeparator = Strings.lineSeparator();
        stringBuffer.append(str);
        stringBuffer.append(" Public Key [").append(generateKeyFingerprint(bigInteger, gOST3410Parameters)).append(Constants.AES_SUFFIX).append(strLineSeparator);
