...
public class CipherSpi extends BaseCipherSpi {
    ...
    private final JcaJceHelper f1428helper;
    ...
    public CipherSpi(OAEPParameterSpec oAEPParameterSpec) {
        this.f1428helper = new BCJcaJceHelper();
    ...
    protected AlgorithmParameters engineGetParameters() {
        if (this.engineParams == null && this.paramSpec != null) {
            try {
                AlgorithmParameters algorithmParametersCreateAlgorithmParameters = this.f1428helper.createAlgorithmParameters("OAEP");
    ...
    protected void engineSetPadding(String str) throws NoSuchPaddingException {
        ...
        if (upperCase.equals("OAEPWITHMD5ANDMGF1PADDING")) {
            initFromSpec(new OAEPParameterSpec(StringUtils.MD5, "MGF1", new MGF1ParameterSpec(StringUtils.MD5), PSource.PSpecified.DEFAULT));
            return;
        }
