...
public abstract class BaseAgreementSpi extends KeyAgreementSpi {
    ...
    static {
        ...
        map2.put(PKCSObjectIdentifiers.id_hmacWithSHA384.getId(), Integers.valueOf(RendererCapabilities.DECODER_SUPPORT_MASK));
        ...
        map.put(JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM, NISTObjectIdentifiers.id_aes256_CBC);
        ...
        map3.put(NISTObjectIdentifiers.id_aes128_wrap.getId(), JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
        map3.put(NISTObjectIdentifiers.id_aes128_CCM.getId(), JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
        map3.put(NISTObjectIdentifiers.id_aes128_CCM.getId(), JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM);
        hashtable.put("DESEDE", PKCSObjectIdentifiers.des_EDE3_CBC);
        hashtable.put(JceEncryptionConstants.SYMMETRIC_KEY_ALGORITHM, NISTObjectIdentifiers.id_aes256_CBC);
