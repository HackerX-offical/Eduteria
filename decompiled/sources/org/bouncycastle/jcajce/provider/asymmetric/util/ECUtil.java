...
public class ECUtil {
    ...
    public static String privateKeyToString(String str, BigInteger bigInteger, ECParameterSpec eCParameterSpec) {
        ...
        stringBuffer.append(" Private Key [").append(generateKeyFingerprint(eCPointNormalize, eCParameterSpec)).append(Constants.AES_SUFFIX).append(strLineSeparator);
    ...
    public static String publicKeyToString(String str, ECPoint eCPoint, ECParameterSpec eCParameterSpec) {
        ...
        String strLineSeparator = Strings.lineSeparator();
        stringBuffer.append(str);
        stringBuffer.append(" Public Key [").append(generateKeyFingerprint(eCPoint, eCParameterSpec)).append(Constants.AES_SUFFIX).append(strLineSeparator);
