...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f1433c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.f1433c.equals(x509CRLEntryObject.f1433c);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f1433c.getEncoded(ASN1Encoding.DER);
    ...
    public Date getRevocationDate() {
        return this.f1433c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f1433c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f1433c.getExtensions() != null;
    }
