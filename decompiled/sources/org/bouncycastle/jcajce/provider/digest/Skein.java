...
public class Skein {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        private void addSkeinMacAlgorithm(ConfigurableProvider configurableProvider, int i, int i2) {
            ...
            String str2 = PREFIX;
            String string = sb.append(str2).append("$SkeinMac_").append(i).append("_").append(i2).toString();
            configurableProvider.addAlgorithm("Mac." + str, string);
            configurableProvider.addAlgorithm("Alg.Alias.Mac.Skein-MAC" + i + MqttTopic.TOPIC_LEVEL_SEPARATOR + i2, str);
            configurableProvider.addAlgorithm("KeyGenerator." + str, str2 + "$SkeinMacKeyGenerator_" + i + "_" + i2);
            configurableProvider.addAlgorithm("Alg.Alias.KeyGenerator.Skein-MAC" + i + MqttTopic.TOPIC_LEVEL_SEPARATOR + i2, str);
        }
