...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    private final JcaJceHelper f1436helper = new BCJcaJceHelper();
    ...
    private Certificate decodeCertificate(DataInputStream dataInputStream) throws IOException {
        ...
        dataInputStream.readFully(bArr);
        try {
            return this.f1436helper.createCertificateFactory(utf).generateCertificate(new ByteArrayInputStream(bArr));
    ...
    public Key decodeKey(DataInputStream dataInputStream) throws IOException {
        ...
        try {
            ...
            if (i == 2) {
                return this.f1436helper.createSecretKeyFactory(utf2).generateSecret(pKCS8EncodedKeySpec);
            }
    ...
    protected Cipher makePBECipher(String str, int i, char[] cArr, byte[] bArr, int i2) throws IOException {
        try {
            ...
            SecretKeyFactory secretKeyFactoryCreateSecretKeyFactory = this.f1436helper.createSecretKeyFactory(str);
            PBEParameterSpec pBEParameterSpec = new PBEParameterSpec(bArr, i2);
            Cipher cipherCreateCipher = this.f1436helper.createCipher(str);
