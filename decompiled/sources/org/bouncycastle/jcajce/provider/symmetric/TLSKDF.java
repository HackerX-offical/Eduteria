...
public class TLSKDF {
    ...
    public static class TLS12 extends TLSKeyMaterialFactory {
        ...
        private byte[] PRF(TLSKeyMaterialSpec tLSKeyMaterialSpec, Mac mac) throws CloneNotSupportedException {
    ...
    public static byte[] PRF_legacy(TLSKeyMaterialSpec tLSKeyMaterialSpec) throws CloneNotSupportedException {
