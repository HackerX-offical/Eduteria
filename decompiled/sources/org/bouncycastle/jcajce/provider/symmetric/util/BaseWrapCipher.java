...
public abstract class BaseWrapCipher extends CipherSpi implements PBE {
    ...
    private final JcaJceHelper f1440helper;
    private byte[] iv;
    private int ivSize;
    ...
    protected BaseWrapCipher() {
        ...
        this.f1440helper = new BCJcaJceHelper();
    }
    ...
    protected final AlgorithmParameters createParametersInstance(String str) throws NoSuchAlgorithmException, NoSuchProviderException {
        return this.f1440helper.createAlgorithmParameters(str);
    }
    ...
    protected Key engineUnwrap(byte[] bArr, String str, int i) throws NoSuchAlgorithmException, InvalidKeyException {
        try {
            ...
            try {
                KeyFactory keyFactoryCreateKeyFactory = this.f1440helper.createKeyFactory(str);
                if (i == 1) {
