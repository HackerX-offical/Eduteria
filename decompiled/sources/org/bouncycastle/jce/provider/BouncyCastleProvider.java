...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    private static String f1441info = "BouncyCastle Security Provider v1.65";
    ...
    private static final String[] DIGESTS = {"GOST3411", "Keccak", "MD2", "MD4", StringUtils.MD5, "SHA1", "RIPEMD128", "RIPEMD160", "RIPEMD256", "RIPEMD320", "SHA224", "SHA256", "SHA384", "SHA512", "SHA3", "Skein", "SM3", "Tiger", "Whirlpool", "Blake2b", "Blake2s", "DSTU7564", "Haraka"};
    ...
    public BouncyCastleProvider() {
        super(PROVIDER_NAME, 1.65d, f1441info);
    ...
    public boolean hasAlgorithm(String str, String str2) {
        return containsKey(new StringBuilder().append(str).append(InstructionFileId.DOT).append(str2).toString()) || containsKey(new StringBuilder("Alg.Alias.").append(str).append(InstructionFileId.DOT).append(str2).toString());
    }
