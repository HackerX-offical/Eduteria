...
public class X509StoreLDAPAttrCerts extends X509StoreSpi {
    ...
    private LDAPStoreHelper f1450helper;
    ...
    public Collection engineGetMatches(Selector selector) throws StoreException {
        ...
        hashSet.addAll(this.f1450helper.getAACertificates(x509AttributeCertStoreSelector));
        hashSet.addAll(this.f1450helper.getAttributeCertificateAttributes(x509AttributeCertStoreSelector));
        hashSet.addAll(this.f1450helper.getAttributeDescriptorCertificates(x509AttributeCertStoreSelector));
        return hashSet;
    }
    ...
    public void engineInit(X509StoreParameters x509StoreParameters) {
        ...
        this.f1450helper = new LDAPStoreHelper((X509LDAPCertStoreParameters) x509StoreParameters);
    }
}
