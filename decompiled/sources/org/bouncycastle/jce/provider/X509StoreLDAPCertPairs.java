...
public class X509StoreLDAPCertPairs extends X509StoreSpi {
    ...
    private LDAPStoreHelper f1452helper;
    ...
    public Collection engineGetMatches(Selector selector) throws StoreException {
        ...
        hashSet.addAll(this.f1452helper.getCrossCertificatePairs((X509CertPairStoreSelector) selector));
        return hashSet;
    }
    ...
    public void engineInit(X509StoreParameters x509StoreParameters) {
        ...
        this.f1452helper = new LDAPStoreHelper((X509LDAPCertStoreParameters) x509StoreParameters);
    }
}
