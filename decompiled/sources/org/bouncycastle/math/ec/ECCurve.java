...
public abstract class ECCurve {
    ...
    protected ECFieldElement f1460a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    protected ECFieldElement f1461b;
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        public boolean isKoblitz() {
            if (this.order == null || this.cofactor == null || !this.f1461b.isOne()) {
                return false;
            }
            return this.f1460a.isZero() || this.f1460a.isOne();
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        protected ECPoint decompressPoint(int i, BigInteger bigInteger) {
            ECFieldElement eCFieldElementFromBigInteger = fromBigInteger(bigInteger);
            ECFieldElement eCFieldElementSqrt = eCFieldElementFromBigInteger.square().add(this.f1460a).multiply(eCFieldElementFromBigInteger).add(this.f1461b).sqrt();
    ...
    public static class F2m extends AbstractF2m {
        ...
        public F2m(int i, int i2, int i3, int i4, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f1460a = fromBigInteger(bigInteger);
            this.f1461b = fromBigInteger(bigInteger2);
            this.coord = 6;
        }
        ...
        protected F2m(int i, int i2, int i3, int i4, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            this.infinity = new ECPoint.F2m(this, null, null);
            this.f1460a = eCFieldElement;
            this.f1461b = eCFieldElement2;
            this.coord = 6;
        }
        ...
        protected ECCurve cloneCurve() {
            return new F2m(this.m, this.k1, this.k2, this.k3, this.f1460a, this.f1461b, this.order, this.cofactor);
        }
    ...
    public static class Fp extends AbstractFp {
        ...
        public Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5) {
            ...
            this.f1460a = fromBigInteger(bigInteger2);
            this.f1461b = fromBigInteger(bigInteger3);
        ...
        @Override // org.bouncycastle.math.ec.ECCurve
        protected ECCurve cloneCurve() {
            return new Fp(this.q, this.r, this.f1460a, this.f1461b, this.order, this.cofactor);
        }
