    ...
    public LongArray modInverse(int i, int[] iArr) {
        ...
        while (true) {
            if (i5 < 0) {
                ...
                i2 = 1 - i2;
                i4 = iArr2[i2];
                iDegreeFrom = iArr3[i2];
            }
            int i6 = 1 - i2;
            longArrayArr[i2].addShiftedByBitsSafe(longArrayArr[i6], iArr2[i6], i5);
            int iDegreeFrom2 = longArrayArr[i2].degreeFrom(i4);
            if (iDegreeFrom2 == 0) {
                return longArrayArr2[i6];
            }
            int i7 = iArr3[i6];
            longArrayArr2[i2].addShiftedByBitsSafe(longArrayArr2[i6], i7, i5);
            int i8 = i7 + i5;
            if (i8 > iDegreeFrom) {
                iDegreeFrom = i8;
            } else if (i8 == iDegreeFrom) {
