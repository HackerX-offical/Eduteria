...
public class Curve25519Field {
    ...
    private static int addPExtTo(int[] iArr) {
        ...
        int[] iArr2 = PExt;
        long j2 = j + (((long) iArr2[0]) & 4294967295L);
        iArr[0] = (int) j2;
        long jIncAt = j2 >> 32;
        if (jIncAt != 0) {
            jIncAt = Nat.incAt(8, iArr, 1);
        }
        long j3 = jIncAt + ((((long) iArr[8]) & 4294967295L) - 19);
        iArr[8] = (int) j3;
        long jDecAt = j3 >> 32;
        if (jDecAt != 0) {
            jDecAt = Nat.decAt(15, iArr, 9);
        }
        long j4 = jDecAt + (((long) iArr[15]) & 4294967295L) + (4294967295L & ((long) (iArr2[15] + 1)));
        iArr[15] = (int) j4;
        return (int) (j4 >> 32);
    }
    ...
    private static int addPTo(int[] iArr) {
        ...
        long j2 = jDecAt + (4294967295L & ((long) iArr[7])) + CacheValidityPolicy.MAX_AGE;
        iArr[7] = (int) j2;
        return (int) (j2 >> 32);
    }
    ...
    private static int subPExtFrom(int[] iArr) {
        ...
        long j3 = jDecAt + (((long) iArr[8]) & 4294967295L) + 19;
        iArr[8] = (int) j3;
        long jIncAt = j3 >> 32;
        if (jIncAt != 0) {
            jIncAt = Nat.incAt(15, iArr, 9);
        }
        long j4 = jIncAt + ((((long) iArr[15]) & 4294967295L) - (4294967295L & ((long) (iArr2[15] + 1))));
        iArr[15] = (int) j4;
        return (int) (j4 >> 32);
    }
    ...
    private static int subPFrom(int[] iArr) {
        ...
        long j2 = jIncAt + ((4294967295L & ((long) iArr[7])) - CacheValidityPolicy.MAX_AGE);
        iArr[7] = (int) j2;
        return (int) (j2 >> 32);
    }
