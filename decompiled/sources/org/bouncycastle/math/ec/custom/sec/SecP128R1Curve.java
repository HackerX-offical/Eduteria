...
public class SecP128R1Curve extends ECCurve.AbstractFp {
    ...
    public SecP128R1Curve() {
        ...
        this.f1460a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f1461b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("E87579C11079F43DD824993C2CEE5ED3")));
