...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElementAdd.isZero()) {
            return new SecT163K1Point(curve, eCFieldElementAdd, curve.getB());
        }
        ...
        return new SecT163K1Point(curve, eCFieldElementSquare2, eCFieldElementSquare3.add(eCFieldElementAdd).add(eCFieldElementSquare).multiply(eCFieldElementSquare3).add(eCFieldElementSquare2), new ECFieldElement[]{eCFieldElementMultiply2});
    }
