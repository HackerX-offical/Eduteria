...
public class SecT409Field {
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j3 = (jUnshuffle3 & 4294967295L) | (jUnshuffle4 << 32);
        ...
        long j5 = (jUnshuffle5 >>> 32) | (jUnshuffle6 & (-4294967296L));
        long jUnshuffle7 = Interleave.unshuffle(jArr[6]);
        long j6 = jUnshuffle7 >>> 32;
        jArr2[0] = j ^ (j2 << 44);
        jArr2[1] = (j3 ^ (j4 << 44)) ^ (j2 >>> 20);
        jArr2[2] = (((jUnshuffle5 & 4294967295L) | (jUnshuffle6 << 32)) ^ (j5 << 44)) ^ (j4 >>> 20);
        jArr2[3] = (((j6 << 44) ^ (jUnshuffle7 & 4294967295L)) ^ (j5 >>> 20)) ^ (j2 << 13);
