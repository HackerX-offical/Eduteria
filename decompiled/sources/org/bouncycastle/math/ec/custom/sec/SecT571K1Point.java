...
public class SecT571K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (secT571FieldElement5.isZero()) {
            ...
            SecT571Field.multiply(jArrCreate64, jArrCreate642, secT571FieldElement11.x);
            ...
            SecT571Field.multiplyPrecomp(jArrCreate644, jArrPrecompMultiplicand3, secT571FieldElement12.x);
            if (jArrPrecompMultiplicand2 != null) {
                SecT571Field.multiplyPrecomp(secT571FieldElement12.x, jArrPrecompMultiplicand2, secT571FieldElement12.x);
            }
            ...
            SecT571Field.multiplyAddToExt(jArrCreate644, secT571FieldElement12.x, jArrCreateExt64);
            SecT571FieldElement secT571FieldElement13 = new SecT571FieldElement(jArrCreate644);
            SecT571Field.reduce(jArrCreateExt64, secT571FieldElement13.x);
            if (jArrPrecompMultiplicand != null) {
                SecT571Field.multiplyPrecomp(secT571FieldElement12.x, jArrPrecompMultiplicand, secT571FieldElement12.x);
            }
