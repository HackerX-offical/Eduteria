...
public abstract class X448Field {
    ...
    public static void mul(int[] iArr, int i, int[] iArr2) {
        ...
        long j15 = j9 + (((long) i16) * j);
        iArr2[14] = ((int) j15) & M28;
        long j16 = j15 >>> 28;
        long j17 = j11 + (((long) i5) * j);
        iArr2[3] = ((int) j17) & M28;
        long j18 = j13 + (((long) i9) * j);
        iArr2[7] = ((int) j18) & M28;
        long j19 = (j14 >>> 28) + (((long) i13) * j);
        iArr2[11] = ((int) j19) & M28;
        long j20 = j16 + (((long) i17) * j);
        iArr2[15] = ((int) j20) & M28;
        long j21 = j20 >>> 28;
        long j22 = (j17 >>> 28) + (((long) i6) * j);
        iArr2[4] = ((int) j22) & M28;
        long j23 = (j18 >>> 28) + j21 + (((long) i10) * j);
        iArr2[8] = ((int) j23) & M28;
        long j24 = (j19 >>> 28) + (((long) i14) * j);
        iArr2[12] = ((int) j24) & M28;
        long j25 = j21 + (((long) i2) * j);
        iArr2[0] = ((int) j25) & M28;
