...
public abstract class Ed25519 {
    ...
    private static boolean decodePointVar(byte[] bArr, int i, boolean z, PointAffine pointAffine) {
        ...
        byte b2 = bArrCopyOfRange[31];
        int i2 = (b2 & 128) >>> 7;
        bArrCopyOfRange[31] = (byte) (b2 & 127);
    ...
    private static void implSign(byte[] bArr, int i, byte[] bArr2, byte b2, byte[] bArr3, int i2, int i3, byte[] bArr4, int i4) {
        ...
        implSign(digestCreateDigest, bArr5, bArr6, bArr7, 0, bArr2, b2, bArr3, i2, i3, bArr4, i4);
    }
    ...
    private static void implSign(byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, byte b2, byte[] bArr4, int i3, int i4, byte[] bArr5, int i5) {
        ...
        implSign(digestCreateDigest, bArr6, bArr7, bArr2, i2, bArr3, b2, bArr4, i3, i4, bArr5, i5);
    }
    ...
    private static boolean implVerify(byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, byte b2, byte[] bArr4, int i3, int i4) {
        ...
        Digest digestCreateDigest = createDigest();
        byte[] bArr5 = new byte[digestCreateDigest.getDigestSize()];
        dom2(digestCreateDigest, b2, bArr3);
    ...
    private static int[] pointPrecomp(PointAffine pointAffine, int i) {
        ...
        while (true) {
            ...
            X25519Field.copy(pointExtPointCopy.y, 0, iArrCreateTable, i2 + 10);
            X25519Field.copy(pointExtPointCopy.z, 0, iArrCreateTable, i2 + 20);
            X25519Field.copy(pointExtPointCopy.t, 0, iArrCreateTable, i2 + 30);
            i2 += 40;
            i3++;
            if (i3 == i) {
    ...
    private static byte[] reduceScalar(byte[] bArr) {
        ...
        long j3 = jDecode249 + ((jDecode329 & 4294967295L) >> 28);
        long j4 = jDecode329 & M28L;
        long j5 = (jDecode327 - (j2 * (-6428113))) - (j3 * 5343);
        long j6 = (jDecode325 - (j3 * (-50998291))) - (j4 * 19280294);
        long j7 = ((jDecode245 - (j2 * (-50998291))) - (j3 * 19280294)) - (j4 * 127719000);
        long j8 = ((jDecode326 - (j2 * 19280294)) - (j3 * 127719000)) - (j4 * (-6428113));
        long j9 = ((jDecode246 - (j2 * 127719000)) - (j3 * (-6428113))) - (j4 * 5343);
        long j10 = jDecode248 + (j >> 28);
        long j11 = jDecode328 & M28L;
        long j12 = j8 - (j10 * 5343);
        long j13 = (j7 - (j10 * (-6428113))) - (j11 * 5343);
        long j14 = (jDecode247 - (j2 * 5343)) + (j5 >> 28);
        long j15 = ((jDecode324 - (j10 * (-50998291))) - (j11 * 19280294)) - (j14 * 127719000);
        long j16 = (((jDecode244 - (j4 * (-50998291))) - (j10 * 19280294)) - (j11 * 127719000)) - (j14 * (-6428113));
        long j17 = ((j6 - (j10 * 127719000)) - (j11 * (-6428113))) - (j14 * 5343);
        long j18 = (j5 & M28L) + (j9 >> 28);
        long j19 = (jDecode323 - (j14 * (-50998291))) - (j18 * 19280294);
        long j20 = ((jDecode243 - (j11 * (-50998291))) - (j14 * 19280294)) - (j18 * 127719000);
        long j21 = j16 - (j18 * 5343);
        long j22 = (j9 & M28L) + (j12 >> 28);
        long j23 = jDecode322 - (j22 * (-50998291));
        long j24 = (jDecode242 - (j18 * (-50998291))) - (j22 * 19280294);
        ...
        encode56(j66 | (j68 << 28), bArr2, 0);
        encode56(j70 | (j72 << 28), bArr2, 7);
        encode56((j76 << 28) | j74, bArr2, 14);
        encode56((j80 << 28) | j78, bArr2, 21);
        encode32((int) j79, bArr2, 28);
        return bArr2;
    }
    ...
    private static void scalarMultStrausVar(int[] iArr, int[] iArr2, PointAffine pointAffine, PointAccum pointAccum) {
        ...
        while (true) {
            ...
            if (b2 != 0) {
                int i2 = b2 >> Ascii.US;
                pointAddVar(i2 != 0, precompBaseTable[(b2 ^ i2) >>> 1], pointAccum);
            }
            byte b3 = wnafVar2[i];
            if (b3 != 0) {
                int i3 = b3 >> Ascii.US;
                pointAddVar(i3 != 0, pointExtArrPointPrecompVar[(b3 ^ i3) >>> 1], pointAccum);
            }
            i--;
            if (i < 0) {
                return;
