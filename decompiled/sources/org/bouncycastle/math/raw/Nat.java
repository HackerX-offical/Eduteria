...
public abstract class Nat {
    ...
    public static long[] fromBigInteger64(int i, BigInteger bigInteger) {
        ...
        long[] jArrCreate64 = create64((i + 63) >> 6);
        int i2 = 0;
        while (bigInteger.signum() != 0) {
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        while (i5 < i) {
            ...
            int[] iArr5 = iArr3;
            int i9 = i6 + i7;
            long jMulWordAddTo = j + (((long) mulWordAddTo(i7, iArr[i2 + i5], iArr4, i8, iArr5, i6)) & 4294967295L) + (((long) iArr5[i9]) & 4294967295L);
            iArr5[i9] = (int) jMulWordAddTo;
            j = jMulWordAddTo >>> 32;
            i6++;
            i5++;
            i = i7;
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i2 < i) {
            ...
            int[] iArr5 = iArr3;
            int i4 = i2 + i3;
            long jMulWordAddTo = j + (((long) mulWordAddTo(i3, iArr[i2], iArr4, 0, iArr5, i2)) & 4294967295L) + (((long) iArr5[i4]) & 4294967295L);
            iArr5[i4] = (int) jMulWordAddTo;
            j = jMulWordAddTo >>> 32;
            i2++;
            i = i3;
            iArr2 = iArr4;
    ...
    public static void square(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        ...
        long j3 = 0;
        for (i4 = 1; i4 < i; i4++) {
            long jSquareWordAddTo = j3 + (((long) squareWordAddTo(iArr, i2, i4, iArr2, i3)) & 4294967295L) + (((long) iArr2[i9]) & 4294967295L);
            int i10 = i9 + 1;
            iArr2[i9] = (int) jSquareWordAddTo;
            long j4 = (jSquareWordAddTo >>> 32) + (((long) iArr2[i10]) & 4294967295L);
            i9 += 2;
            iArr2[i10] = (int) j4;
            j3 = j4 >>> 32;
        }
    ...
    public static void square(int i, int[] iArr, int[] iArr2) {
        ...
        int i8 = 2;
        for (i2 = 1; i2 < i; i2++) {
            long jSquareWordAddTo = j3 + (((long) squareWordAddTo(iArr, i2, iArr2)) & 4294967295L) + (((long) iArr2[i8]) & 4294967295L);
            int i9 = i8 + 1;
            iArr2[i8] = (int) jSquareWordAddTo;
            long j4 = (jSquareWordAddTo >>> 32) + (((long) iArr2[i9]) & 4294967295L);
            i8 += 2;
            iArr2[i9] = (int) j4;
            j3 = j4 >>> 32;
        }
