...
public abstract class Nat160 {
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (true) {
            ...
            i = i3 + 1;
            char c3 = c2;
            long j14 = (j13 >>> c2) + (j12 * j2) + (((long) iArr3[i]) & 4294967295L);
            iArr3[i] = (int) j14;
            int i4 = i3 + 2;
            long j15 = j5;
            long j16 = (j14 >>> c3) + (j12 * j3) + (((long) iArr3[i4]) & 4294967295L);
            iArr3[i4] = (int) j16;
            int i5 = i3 + 3;
            long j17 = (j16 >>> c3) + (j12 * j4) + (((long) iArr3[i5]) & 4294967295L);
            iArr3[i5] = (int) j17;
            int i6 = i3 + 4;
            long j18 = (j17 >>> c3) + (j12 * j15) + (((long) iArr3[i6]) & 4294967295L);
            iArr3[i6] = (int) j18;
            iArr3[i3 + 5] = (int) (j18 >>> c3);
            c2 = c3;
            j5 = j15;
            i2 = 5;
        }
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i4 < 5) {
            ...
            iArr3[i9] = (int) j16;
            int i10 = i5 + 5;
            long j17 = j6 + (j16 >>> 32) + (((long) iArr3[i10]) & 4294967295L);
            iArr3[i10] = (int) j17;
            j6 = j17 >>> 32;
            i4++;
            i5 = i6;
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 5) {
            ...
            iArr3[i2] = (int) j10;
            int i3 = i2 + 1;
            long j11 = (j10 >>> 32) + (j9 * j3) + (((long) iArr3[i3]) & j8);
            iArr3[i3] = (int) j11;
            int i4 = i2 + 2;
            long j12 = (j11 >>> 32) + (j9 * j4) + (((long) iArr3[i4]) & j8);
            iArr3[i4] = (int) j12;
            int i5 = i2 + 3;
            long j13 = (j12 >>> 32) + (j9 * j5) + (((long) iArr3[i5]) & j8);
            iArr3[i5] = (int) j13;
            int i6 = i2 + 4;
            long j14 = (j13 >>> 32) + (j9 * j6) + (((long) iArr3[i6]) & j8);
            iArr3[i6] = (int) j14;
            int i7 = i2 + 5;
            long j15 = j7 + (j14 >>> 32) + (((long) iArr3[i7]) & j8);
            iArr3[i7] = (int) j15;
            j7 = j15 >>> 32;
            j = j8;
            j2 = j2;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                long j28 = (j21 & 4294967295L) + (j * j24);
                int i20 = (int) j28;
                iArr2[i12] = (i20 << 1) | i17;
                long j29 = (j22 & 4294967295L) + (j28 >>> 32) + (j6 * j24);
                long j30 = (j23 & 4294967295L) + (j29 >>> 32) + (j24 * j10);
                long j31 = j27 + (j30 >>> 32) + (j24 * j16);
                long j32 = j26 + (j31 >>> 32);
                int i21 = (int) j29;
                ...
                int i23 = (int) j31;
                iArr2[i18] = (i23 << 1) | (i22 >>> 31);
                int i24 = (int) j32;
                iArr2[i19] = (i23 >>> 31) | (i24 << 1);
                int i25 = i24 >>> 31;
                int i26 = i2 + 9;
                iArr2[i26] = i25 | ((iArr2[i26] + ((int) (j32 >>> 32))) << 1);
                return;
            }
            i5 = i6;
        }
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                int i17 = (int) j32;
                iArr2[8] = i16 | (i17 << 1);
                iArr2[9] = (i17 >>> 31) | ((iArr2[9] + ((int) (j32 >>> 32))) << 1);
                return;
            }
            i3 = i4;
        }
