...
public class PGPPublicKey implements PublicKeyAlgorithmTags {
    ...
    private void init(KeyFingerPrintCalculator keyFingerPrintCalculator) throws PGPException {
        ...
        if (this.publicPk.getVersion() <= 3) {
            ...
            this.keyID = (((long) (bArr[bArr.length - 3] & 255)) << 16) | (((long) (bArr[bArr.length - 8] & 255)) << 56) | (((long) (bArr[bArr.length - 7] & 255)) << 48) | (((long) (bArr[bArr.length - 6] & 255)) << 40) | (((long) (bArr[bArr.length - 5] & 255)) << 32) | (((long) (bArr[bArr.length - 4] & 255)) << 24) | (((long) (bArr[bArr.length - 2] & 255)) << 8) | ((long) (bArr[bArr.length - 1] & 255));
