    ...
    public PGPSecretKeyRing(InputStream inputStream, KeyFingerPrintCalculator keyFingerPrintCalculator) throws IOException, PGPException {
        ...
        while (true) {
            ...
            if (bCPGInputStreamWrap.nextPacketTag() == 7) {
                ...
                TrustPacket optionalTrustPacket2 = readOptionalTrustPacket(bCPGInputStreamWrap);
                List signaturesAndTrust2 = readSignaturesAndTrust(bCPGInputStreamWrap);
                list = this.keys;
                ...
                TrustPacket optionalTrustPacket3 = readOptionalTrustPacket(bCPGInputStreamWrap);
                List signaturesAndTrust3 = readSignaturesAndTrust(bCPGInputStreamWrap);
