    ...
    public PGPSignature generate() throws PGPException {
        ...
        try {
            ...
            if (this.contentSigner.getKeyAlgorithm() == 3 || this.contentSigner.getKeyAlgorithm() == 1) {
                ...
                mPIntegerArrDsaSigToMpi = new MPInteger[]{new MPInteger(new BigInteger(1, Arrays.copyOfRange(signature, 0, signature.length / 2))), new MPInteger(new BigInteger(1, Arrays.copyOfRange(signature, signature.length / 2, signature.length)))};
            } else {
