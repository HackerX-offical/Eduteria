...
public class PGPUtil implements HashAlgorithmTags {
    ...
    public static boolean isKeyRing(byte[] bArr) throws IOException {
        ...
        return iNextPacketTag == 6 || iNextPacketTag == 14 || iNextPacketTag == 5 || iNextPacketTag == 5;
    }
    ...
    public static void writeFileToLiteralData(OutputStream outputStream, char c2, File file) throws IOException {
        pipeFileContents(file, new PGPLiteralDataGenerator().open(outputStream, c2, file), 32768);
    }
