...
public class DSAElGamalKeyRingGenerator {
    private static void exportKeyPair(OutputStream outputStream, OutputStream outputStream2, KeyPair keyPair, KeyPair keyPair2, String str, char[] cArr, boolean z) throws SignatureException, IOException, InvalidKeyException, PGPException, NoSuchProviderException {
        if (z) {
