...
public class JcaPGPContentSignerBuilder implements PGPContentSignerBuilder {
    ...
    private OperatorHelper f1464helper = new OperatorHelper(new DefaultJcaJceHelper());
    ...
    public PGPContentSigner build(final int i, final long j, PrivateKey privateKey) throws PGPException {
        ...
        final Signature signatureCreateSignature = this.f1464helper.createSignature(this.keyAlgorithm, this.hashAlgorithm);
        try {
    ...
    public JcaPGPContentSignerBuilder setProvider(String str) {
        this.f1464helper = new OperatorHelper(new NamedJcaJceHelper(str));
    ...
    public JcaPGPContentSignerBuilder setProvider(Provider provider) {
        this.f1464helper = new OperatorHelper(new ProviderJcaJceHelper(provider));
