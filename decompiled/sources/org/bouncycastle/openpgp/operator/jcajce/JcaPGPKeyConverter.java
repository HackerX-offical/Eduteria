...
public class JcaPGPKeyConverter {
    ...
    private OperatorHelper f1467helper = new OperatorHelper(new DefaultJcaJceHelper());
    ...
    private ECParameterSpec getECParameterSpec(ASN1ObjectIdentifier aSN1ObjectIdentifier, X9ECParameters x9ECParameters) throws NoSuchAlgorithmException, InvalidParameterSpecException, NoSuchProviderException {
        AlgorithmParameters algorithmParametersCreateAlgorithmParameters = this.f1467helper.createAlgorithmParameters("EC");
    ...
    private BCPGKey getPublicBCPGKey(int i, PGPAlgorithmParameters pGPAlgorithmParameters, PublicKey publicKey, Date date) throws PGPException {
        ...
        return new ECDHPublicBCPGKey(CryptlibObjectIdentifiers.curvey25519, new BigInteger(1, bArr2), pGPKdfParameters2.getHashAlgorithm(), pGPKdfParameters2.getSymmetricWrapAlgorithm());
    }

    private PrivateKey implGeneratePrivate(String str, KeySpec keySpec) throws GeneralSecurityException, PGPException {
        return this.f1467helper.createKeyFactory(str).generatePrivate(keySpec);
    }

    private PublicKey implGeneratePublic(String str, KeySpec keySpec) throws GeneralSecurityException, PGPException {
        return this.f1467helper.createKeyFactory(str).generatePublic(keySpec);
    }

    private PrivateKey implGetPrivateKeyEC(String str, ECPublicBCPGKey eCPublicBCPGKey, ECSecretBCPGKey eCSecretBCPGKey) throws GeneralSecurityException, PGPException {
        return implGeneratePrivate(str, new ECPrivateKeySpec(eCSecretBCPGKey.getX(), getECParameterSpec(eCPublicBCPGKey.getCurveOID())));
    }

    private PrivateKey implGetPrivateKeyPKCS8(String str, PrivateKeyInfo privateKeyInfo) throws GeneralSecurityException, IOException, PGPException {
    ...
    private PublicKey implGetPublicKeyX509(String str, SubjectPublicKeyInfo subjectPublicKeyInfo) throws GeneralSecurityException, IOException, PGPException {
    ...
    public PrivateKey getPrivateKey(PGPPrivateKey pGPPrivateKey) throws PGPException {
        ...
        try {
            ...
            if (algorithm != 1 && algorithm != 2 && algorithm != 3) {
                if (algorithm != 22) {
                    switch (algorithm) {
                        ...
                        case 20:
                            ...
                            rSAPrivateCrtKeySpec = new DHPrivateKeySpec(((ElGamalSecretBCPGKey) privateKeyDataPacket).getX(), elGamalPublicBCPGKey.getP(), elGamalPublicBCPGKey.getG());
                            str = "ElGamal";
                            break;
                        case 17:
                            DSAPublicBCPGKey dSAPublicBCPGKey = (DSAPublicBCPGKey) publicKeyPacket.getKey();
                            rSAPrivateCrtKeySpec = new DSAPrivateKeySpec(((DSASecretBCPGKey) privateKeyDataPacket).getX(), dSAPublicBCPGKey.getP(), dSAPublicBCPGKey.getQ(), dSAPublicBCPGKey.getG());
                            str = "DSA";
                            break;
                        case 18:
                            ...
                            if (!CryptlibObjectIdentifiers.curvey25519.equals((ASN1Primitive) eCPublicBCPGKey.getCurveOID())) {
                                str3 = "ECDH";
                                return implGetPrivateKeyEC(str3, eCPublicBCPGKey, eCSecretBCPGKey);
                            }
                            str2 = "XDH";
                ...
                return implGetPrivateKeyPKCS8(str2, privateKeyInfo);
            }
            ...
            str = "RSA";
            return implGeneratePrivate(str, rSAPrivateCrtKeySpec);
            ...
            if (algorithm != 1 && algorithm != 2 && algorithm != 3) {
                if (algorithm != 22) {
                    switch (algorithm) {
                        ...
                        case 20:
                            ElGamalPublicBCPGKey elGamalPublicBCPGKey = (ElGamalPublicBCPGKey) publicKeyPacket.getKey();
                            rSAPublicKeySpec = new DHPublicKeySpec(elGamalPublicBCPGKey.getY(), elGamalPublicBCPGKey.getP(), elGamalPublicBCPGKey.getG());
                            str = "ElGamal";
                            break;
                        case 17:
                            DSAPublicBCPGKey dSAPublicBCPGKey = (DSAPublicBCPGKey) publicKeyPacket.getKey();
                            rSAPublicKeySpec = new DSAPublicKeySpec(dSAPublicBCPGKey.getY(), dSAPublicBCPGKey.getP(), dSAPublicBCPGKey.getQ(), dSAPublicBCPGKey.getG());
                            str = "DSA";
                            break;
                        case 18:
                            eCPublicBCPGKey = (ECDHPublicBCPGKey) publicKeyPacket.getKey();
                            if (!eCPublicBCPGKey.getCurveOID().equals((ASN1Primitive) CryptlibObjectIdentifiers.curvey25519)) {
                                str3 = "ECDH";
                                return implGetPublicKeyEC(str3, eCPublicBCPGKey);
                            }
                ...
                return implGetPublicKeyX509(str2, subjectPublicKeyInfo);
            }
            RSAPublicBCPGKey rSAPublicBCPGKey = (RSAPublicBCPGKey) publicKeyPacket.getKey();
            rSAPublicKeySpec = new RSAPublicKeySpec(rSAPublicBCPGKey.getModulus(), rSAPublicBCPGKey.getPublicExponent());
            str = "RSA";
            return implGeneratePublic(str, rSAPublicKeySpec);
        } catch (PGPException e2) {
            throw e2;
        } catch (Exception e3) {
    ...
    public JcaPGPKeyConverter setProvider(String str) {
        this.f1467helper = new OperatorHelper(new NamedJcaJceHelper(str));
        return this;
    }

    public JcaPGPKeyConverter setProvider(Provider provider) {
        this.f1467helper = new OperatorHelper(new ProviderJcaJceHelper(provider));
        return this;
    }
}
