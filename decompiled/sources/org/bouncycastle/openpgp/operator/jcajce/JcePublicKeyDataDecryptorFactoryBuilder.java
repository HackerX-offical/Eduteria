...
public class JcePublicKeyDataDecryptorFactoryBuilder {
    ...
    private OperatorHelper f1476helper = new OperatorHelper(new DefaultJcaJceHelper());
    ...
    public byte[] decryptSessionData(int i, PrivateKey privateKey, byte[][] bArr) throws PGPException {
        Cipher cipherCreatePublicKeyCipher = this.f1476helper.createPublicKeyCipher(i);
        try {
    ...
    public byte[] decryptSessionData(JcaPGPKeyConverter jcaPGPKeyConverter, PGPPrivateKey pGPPrivateKey, byte[][] bArr) throws PGPException {
        ...
        try {
            if (eCDHPublicBCPGKey.getCurveOID().equals((ASN1Primitive) CryptlibObjectIdentifiers.curvey25519)) {
                keyAgreementCreateKeyAgreement = this.f1476helper.createKeyAgreement(RFC6637Utils.getXDHAlgorithm(publicKeyPacket));
                KeyFactory keyFactoryCreateKeyFactory = this.f1476helper.createKeyFactory("XDH");
                if (i != 33 || 64 != bArr3[0]) {
                ...
                keyAgreementCreateKeyAgreement = this.f1476helper.createKeyAgreement(RFC6637Utils.getAgreementAlgorithm(publicKeyPacket));
            ...
            Cipher cipherCreateKeyWrapper = this.f1476helper.createKeyWrapper(eCDHPublicBCPGKey.getSymmetricKeyAlgorithm());
    ...
    public JcePublicKeyDataDecryptorFactoryBuilder setProvider(String str) {
        this.f1476helper = new OperatorHelper(new NamedJcaJceHelper(str));
        this.keyConverter.setProvider(str);
        this.contentHelper = this.f1476helper;
        return this;
    }

    public JcePublicKeyDataDecryptorFactoryBuilder setProvider(Provider provider) {
        this.f1476helper = new OperatorHelper(new ProviderJcaJceHelper(provider));
