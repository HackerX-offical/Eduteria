...
public class McElieceCCA2PublicKey extends ASN1Object {
    ...
    private final GF2Matrix f1479g;
    private final int n;
    private final int t;
    ...
    public McElieceCCA2PublicKey(int i, int i2, GF2Matrix gF2Matrix, AlgorithmIdentifier algorithmIdentifier) {
        this.n = i;
        this.t = i2;
        this.f1479g = new GF2Matrix(gF2Matrix.getEncoded());
    ...
    private McElieceCCA2PublicKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f1479g = new GF2Matrix(((ASN1OctetString) aSN1Sequence.getObjectAt(2)).getOctets());
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new DEROctetString(this.f1479g.getEncoded()));
