...
public class ParSet extends ASN1Object {
    ...
    private ParSet(ASN1Sequence aSN1Sequence) {
        ...
        this.f1481h = new int[aSN1Sequence2.size()];
        this.w = new int[aSN1Sequence3.size()];
        this.k = new int[aSN1Sequence4.size()];
        for (int i = 0; i < this.t; i++) {
            this.f1481h[i] = checkBigIntegerInIntRangeAndPositive(aSN1Sequence2.getObjectAt(i));
    ...
    public int[] getH() {
        return Arrays.clone(this.f1481h);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        for (int i = 0; i < this.f1481h.length; i++) {
            aSN1EncodableVector.add(new ASN1Integer(this.f1481h[i]));
