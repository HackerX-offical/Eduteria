...
public class GMSSLeaf {
    ...
    GMSSLeaf(Digest digest, int i, int i2) {
        ...
        int iCeil2 = iCeil + ((int) Math.ceil(((double) getLog((iCeil << i) + 1)) / d2));
        this.keysize = iCeil2;
        int i3 = 1 << i;
        this.two_power_w = i3;
    ...
    public GMSSLeaf(Digest digest, byte[][] bArr, int[] iArr) {
        ...
        int digestSize = this.messDigestOTS.getDigestSize();
        this.mdsize = digestSize;
        int iCeil = (int) Math.ceil(((double) (digestSize << 3)) / ((double) this.w));
        this.keysize = iCeil + ((int) Math.ceil(((double) getLog((iCeil << this.w) + 1)) / ((double) this.w)));
