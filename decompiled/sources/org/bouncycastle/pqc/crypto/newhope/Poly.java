...
class Poly {
    ...
    static void fromBytes(short[] sArr, byte[] bArr) {
        for (int i = 0; i < 256; i++) {
            ...
            int i7 = i * 4;
            sArr[i7] = (short) (i3 | ((b2 & Utf8.REPLACEMENT_BYTE) << 8));
            sArr[i7 + 1] = (short) (((b2 & 255) >>> 6) | (i4 << 2) | ((b3 & Ascii.SI) << 10));
            sArr[i7 + 2] = (short) (((b3 & 255) >>> 4) | (i5 << 4) | ((b4 & 3) << 12));
            sArr[i7 + 3] = (short) ((i6 << 6) | ((b4 & 255) >>> 2));
        }
    }
