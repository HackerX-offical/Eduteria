...
public final class BigEndianConversions {
    ...
    public static long OS2LIP(byte[] bArr, int i) {
        long j = ((((long) bArr[i]) & 255) << 56) | ((((long) bArr[i + 1]) & 255) << 48) | ((((long) bArr[i + 2]) & 255) << 40) | ((((long) bArr[i + 3]) & 255) << 32) | ((255 & ((long) bArr[i + 4])) << 24) | ((long) ((bArr[i + 5] & 255) << 16));
        return ((long) (bArr[i + 7] & 255)) | j | ((long) ((bArr[i + 6] & 255) << 8));
    }
