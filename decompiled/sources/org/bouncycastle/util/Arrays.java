...
public final class Arrays {
    ...
    public static byte[] concatenate(byte[] bArr, byte[] bArr2) throws CloneNotSupportedException {
        Object objClone;
        if (bArr == null) {
            objClone = bArr2.clone();
        } else {
            if (bArr2 != null) {
    ...
    public static int[] concatenate(int[] iArr, int[] iArr2) throws CloneNotSupportedException {
        Object objClone;
        if (iArr == null) {
            objClone = iArr2.clone();
        } else {
            if (iArr2 != null) {
    ...
    public static void fill(byte[] bArr, int i, byte b2) {
        fill(bArr, i, bArr.length, b2);
    }

    public static void fill(byte[] bArr, int i, int i2, byte b2) {
        java.util.Arrays.fill(bArr, i, i2, b2);
    }
    ...
    public static void fill(char[] cArr, int i, int i2, char c2) {
        java.util.Arrays.fill(cArr, i, i2, c2);
    }
