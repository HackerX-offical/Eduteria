...
public class MqttAsyncClient implements IMqttAsyncClient {
    ...
    public MqttAsyncClient(String str, String str2, MqttClientPersistence mqttClientPersistence, MqttPingSender mqttPingSender, ScheduledExecutorService scheduledExecutorService, HighResolutionTimer highResolutionTimer) throws MqttException {
        ...
        while (i < str2.length() - 1) {
            MqttPingSender mqttPingSender2 = mqttPingSender;
    ...
    public IMqttToken connect(MqttConnectOptions mqttConnectOptions, Object obj, IMqttActionListener iMqttActionListener) throws MqttException {
        ...
        Boolean boolValueOf = Boolean.valueOf(mqttConnectOptions2.isCleanSession());
        Integer numValueOf = Integer.valueOf(mqttConnectOptions2.getConnectionTimeout());
        Integer numValueOf2 = Integer.valueOf(mqttConnectOptions2.getKeepAliveInterval());
        String userName = mqttConnectOptions2.getUserName();
        String str2 = "[notnull]";
        if (mqttConnectOptions2.getPassword() == null) {
            obj2 = "[notnull]";
            str2 = "[null]";
        } else {
            obj2 = "[notnull]";
        }
        logger.fine(str, "connect", "103", new Object[]{boolValueOf, numValueOf, numValueOf2, userName, str2, mqttConnectOptions2.getWillMessage() == null ? "[null]" : obj2, obj, iMqttActionListener});
    ...
    public void reconnect() throws MqttException {
        this.log.fine(CLASS_NAME, Manager.EVENT_RECONNECT, "500", new Object[]{this.clientId});
        if (this.comms.isConnected()) {
            throw ExceptionHelper.createMqttException(32100);
        }
        if (this.comms.isConnecting()) {
