...
public final class LastActivityManager extends Manager {
    ...
    private LastActivityManager(XMPPConnection xMPPConnection) {
        ...
        this.enabled = false;
        xMPPConnection.addStanzaSendingListener(new StanzaListener() { // from class: org.jivesoftware.smackx.iqlast.LastActivityManager.2
        ...
        xMPPConnection.addStanzaSendingListener(new StanzaListener() { // from class: org.jivesoftware.smackx.iqlast.LastActivityManager.3
            @Override // org.jivesoftware.smack.StanzaListener
            public void processStanza(Stanza stanza) {
    ...
    /* JADX INFO: renamed from: org.jivesoftware.smackx.iqlast.LastActivityManager$5, reason: invalid class name */
    ...
    public LastActivity getLastActivity(Jid jid) throws SmackException.NotConnectedException, SmackException.NoResponseException, InterruptedException, XMPPException.XMPPErrorException {
        return (LastActivity) connection().createStanzaCollectorAndSend(new LastActivity(jid)).nextResultOrThrow();
    }

    public boolean isLastActivitySupported(Jid jid) throws SmackException.NotConnectedException, SmackException.NoResponseException, InterruptedException, XMPPException.XMPPErrorException {
