...
public class CryptElement extends EncryptedOpenPgpContentElement {
    ...
    public CryptElement(Set<? extends Jid> set, String str, Date date, List<ExtensionElement> list) {
        super(set, str, date, list);
    }

    public CryptElement(Set<? extends Jid> set, List<ExtensionElement> list) {
        super(set, list);
    }
