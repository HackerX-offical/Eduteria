...
public class DateTimeUtils {
    ...
    public static final Map<String, DateTimeZone> getDefaultTimeZoneNames() {
        ...
        Map<String, DateTimeZone> mapBuildDefaultTimeZoneNames = atomicReference.get();
        if (mapBuildDefaultTimeZoneNames == null) {
            mapBuildDefaultTimeZoneNames = buildDefaultTimeZoneNames();
            if (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, null, mapBuildDefaultTimeZoneNames)) {
