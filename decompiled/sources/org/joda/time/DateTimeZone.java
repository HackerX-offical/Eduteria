...
public abstract class DateTimeZone implements Serializable {
    ...
    public static DateTimeZone getDefault() {
        ...
        return !MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, null, dateTimeZoneForTimeZone) ? atomicReference.get() : dateTimeZoneForTimeZone;
    }
    ...
    public static Provider getProvider() {
        ...
        if (defaultProvider == null) {
            ...
            if (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, null, defaultProvider)) {
    ...
    public static NameProvider getNameProvider() {
        ...
        if (defaultNameProvider == null) {
            ...
            if (!MutatorMutex$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, null, defaultNameProvider)) {
                return atomicReference.get();
            }
        }
