...
class GJLocaleSymbols {
    ...
    static GJLocaleSymbols forLocale(Locale locale) {
        GJLocaleSymbols gJLocaleSymbolsPutIfAbsent;
        if (locale == null) {
            locale = Locale.getDefault();
        }
        GJLocaleSymbols gJLocaleSymbols = cCache.get(locale);
        return (gJLocaleSymbols != null || (gJLocaleSymbolsPutIfAbsent = cCache.putIfAbsent(locale, (gJLocaleSymbols = new GJLocaleSymbols(locale)))) == null) ? gJLocaleSymbols : gJLocaleSymbolsPutIfAbsent;
    }
    ...
    private GJLocaleSymbols(Locale locale) {
        ...
        if (Const.ENGLISH.equals(locale.getLanguage())) {
