...
public class DateTimeFormatterBuilder {
    ...
    static class CharacterLiteral implements InternalPrinter, InternalParser {
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            ...
            char c2 = this.iValue;
            return (cCharAt == c2 || (upperCase = Character.toUpperCase(cCharAt)) == (upperCase2 = Character.toUpperCase(c2)) || Character.toLowerCase(upperCase) == Character.toLowerCase(upperCase2)) ? i + 1 : ~i;
        }
    }
    ...
    static class TextField implements InternalPrinter, InternalParser {
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            ...
            if (objArr == null) {
                ...
                if (Const.ENGLISH.equals(locale.getLanguage()) && this.iFieldType == DateTimeFieldType.era()) {
    ...
    static class Fraction implements InternalPrinter, InternalParser {
        ...
        protected void printTo(Appendable appendable, long j, Chronology chronology) throws IOException {
            ...
            try {
                ...
                if (jRemainder != 0) {
                    ...
                    if ((SieveCacheKt.NodeLinkMask & j2) == j2) {
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            ...
            long j2 = j / 10;
            if (i2 != 0 && j2 <= SieveCacheKt.NodeLinkMask) {
