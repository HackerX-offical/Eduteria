...
class CodeGenerator extends Icode {
    ...
    /* JADX WARN: Removed duplicated region for block: B:64:0x0164 A[LOOP:0: B:63:0x0162->B:64:0x0164, LOOP_END] */
    /*
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private void visitExpression(org.mozilla.javascript.Node r17, int r18) {
        /*
    ...
    private int getDoubleIndex(double d2) {
        ...
        this.itsData.itsDoubleTable[i] = d2;
