...
final class NativeNumber extends IdScriptableObject {
    ...
    protected void fillConstructorProperties(IdFunctionObject idFunctionObject) {
        idFunctionObject.defineProperty(BuildConfig.FAQ_URL, ScriptRuntime.NaNobj, 7);
        ...
        switch (i) {
            ...
            case -4:
                if (objArr.length != 0) {
                    ...
                    if (obj != obj2 && (obj2 instanceof Number)) {
                        return Boolean.valueOf(isSafeInteger((Number) obj2));
                    }
                }
                return false;
            case -3:
                if (objArr.length != 0) {
                    ...
                    if (obj3 != obj4 && (obj4 instanceof Number)) {
                        return Boolean.valueOf(isInteger((Number) obj4));
                    }
                }
                return false;
            case -2:
                if (objArr.length != 0) {
                    ...
                    if (obj5 != obj6 && (obj6 instanceof Number)) {
                        return isNaN((Number) obj6);
                    }
                }
                return false;
            case -1:
                if (objArr.length != 0) {
                    ...
                    if (obj7 != obj8 && (obj8 instanceof Number)) {
                        return isFinite(obj8);
                    }
                }
                return false;
            default:
    ...
    private static String num_to(double d2, Object[] objArr, int i, int i2, int i3, int i4) {
        int int32 = 0;
        if (objArr.length != 0) {
        ...
        DToA.JS_dtostr(sb, i, int32 + i4, d2);
        return sb.toString();
    }
