...
public class ObjToIntMap implements Serializable {
    ...
    private int ensureIndex(Object obj) {
        ...
        if (objArr != null) {
            ...
            if (obj2 != null) {
                int i4 = 1 << i3;
                if (obj2 != obj && (this.values[i4 + i] != iHashCode || !obj2.equals(obj))) {
                    i = obj2 == DELETED ? i : -1;
                    int i5 = i4 - 1;
                    int iTableLookupStep = tableLookupStep(i2, i5, this.power);
                    while (true) {
                        i = (i + iTableLookupStep) & i5;
                        Object obj3 = this.keys[i];
                        if (obj3 == null) {
                            break;
                        }
                        if (obj3 == obj || (this.values[i4 + i] == iHashCode && obj3.equals(obj))) {
                            break;
                        }
                        if (obj3 == DELETED && i < 0) {
                            i = i;
