...
public final class OptRuntime extends ScriptRuntime {
    ...
    public static Object add(Object obj, double d2) {
        ...
        if (!(obj instanceof CharSequence)) {
            return wrapDouble(toNumber(obj) + d2);
        }
        return new ConsString((CharSequence) obj, toString(d2));
    }
    ...
    public static Object add(double d2, Object obj) {
        ...
        return new ConsString(toString(d2), (CharSequence) obj);
    }

    @Deprecated
    public static Object elemIncrDecr(Object obj, double d2, Context context, int i) {
        return elemIncrDecr(obj, d2, context, getTopCallScope(context), i);
    }

    public static Object elemIncrDecr(Object obj, double d2, Context context, Scriptable scriptable, int i) {
        return ScriptRuntime.elemIncrDecr(obj, new Double(d2), context, scriptable, i);
    }
