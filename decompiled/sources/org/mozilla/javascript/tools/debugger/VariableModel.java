...
class VariableModel implements TreeTableModel {
    ...
    public int getIndexOfChild(Object obj, Object obj2) {
        ...
        for (int i = 0; i != variableNodeArrChildren.length; i++) {
            if (variableNodeArrChildren[i] == variableNode) {
                return i;
            }
        }
        return -1;
    ...
    public Object getValueAt(Object obj, int i) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            char cCharAt = message.charAt(i2);
    ...
    private static class VariableNode {
        ...
        public String toString() {
            Object obj = this.id;
            return obj instanceof String ? (String) obj : Constants.AES_PREFIX + ((Integer) this.id).intValue() + Constants.AES_SUFFIX;
        }
    }
}
