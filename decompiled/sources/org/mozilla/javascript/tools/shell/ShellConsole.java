...
public abstract class ShellConsole {
    ...
    private static class JLineShellConsoleV2 extends ShellConsole {
        ...
        @Override // org.mozilla.javascript.tools.shell.ShellConsole
        public void flush() throws IOException {
            ShellConsole.tryInvoke(this.reader, Socket.EVENT_FLUSH, ShellConsole.NO_ARG, new Object[0]);
        }
    ...
    private static class ConsoleInputStream extends InputStream {
        ...
        public synchronized int read(byte[] bArr, int i, int i2) throws IOException {
            ...
            int iMin = Math.min(i2, this.buffer.length - this.cursor);
    ...
    private static JLineShellConsoleV1 getJLineShellConsoleV1(ClassLoader classLoader, Class<?> cls, Scriptable scriptable, Charset charset) throws IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException {
    ...
    private static JLineShellConsoleV2 getJLineShellConsoleV2(ClassLoader classLoader, Class<?> cls, Scriptable scriptable, Charset charset) throws IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException {
        Object objNewInstance = cls.getConstructor(new Class[0]).newInstance(new Object[0]);
        tryInvoke(objNewInstance, "setBellEnabled", BOOLEAN_ARG, Boolean.FALSE);
