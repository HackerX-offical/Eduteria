...
public class ByteIo {
    ...
    public static void writeFloat32(byte[] bArr, int i, double d2, boolean z) {
        writeUint32(bArr, i, Float.floatToIntBits((float) d2), z);
    }
    ...
    public static void writeFloat64(byte[] bArr, int i, double d2, boolean z) {
        writeUint64(bArr, i, Double.doubleToLongBits(d2), z);
    }
}
