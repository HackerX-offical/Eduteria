...
public class MXParser implements XmlPullParser {
    ...
    public void setFeature(String str, boolean z) throws XmlPullParserException {
        ...
        if (XmlPullParser.FEATURE_PROCESS_NAMESPACES.equals(str)) {
            ...
            throw new XmlPullParserException(new StringBuffer("unsupported feature ").append(str).toString());
        }
    }
    ...
    public boolean getFeature(String str) {
        ...
        if (FEATURE_NAMES_INTERNED.equals(str) || XmlPullParser.FEATURE_PROCESS_DOCDECL.equals(str) || !"http://xmlpull.org/v1/doc/features.html#xml-roundtrip".equals(str)) {
            return false;
        }
    ...
    public void setInput(InputStream inputStream, String str) throws XmlPullParserException {
        ...
        try {
            ...
            throw new XmlPullParserException(new StringBuffer("could not create reader for encoding ").append(str).append(" : ").append(e2).toString(), this, e2);
        }
    }
    ...
    public int getNamespaceCount(int i) throws XmlPullParserException {
        ...
        if (i < 0 || i > this.depth) {
            throw new IllegalArgumentException(new StringBuffer("allowed namespace depth 0..").append(this.depth).append(" not ").append(i).toString());
        }
    ...
    public String getPositionDescription() {
        ...
        StringBuffer stringBufferAppend = new StringBuffer(" ").append(XmlPullParser.TYPES[this.eventType]).append(str != null ? new StringBuffer(" seen ").append(printable(str)).append("...").toString() : "").append(" ");
        String str = this.location;
        return stringBufferAppend.append(str != null ? str : "").append("@").append(getLineNumber()).append(":").append(getColumnNumber()).toString();
    }
    ...
    public void require(int i, String str, String str2) throws XmlPullParserException, IOException {
        if (!this.processNamespaces && str != null) {
            throw new XmlPullParserException(new StringBuffer("processing namespaces must be enabled on parser (or factory) to have possible namespaces declared on elements (position:").append(getPositionDescription()).append(")").toString());
        }
        ...
        throw new XmlPullParserException(stringBufferAppend.append(string).append(" (position:").append(getPositionDescription()).append(")").toString());
    }
    ...
    */
    ...
    public int parseEndTag() throws XmlPullParserException, IOException {
        ...
        if (cMore != '>') {
            throw new XmlPullParserException(new StringBuffer("expected > to finish end tag not ").append(printable(cMore)).append(" from line ").append(this.elRawNameLine[this.depth]).toString(), this, null);
        }
        this.posEnd = this.pos;
    ...
    /* JADX WARN: Removed duplicated region for block: B:127:0x00c3 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:128:0x00be A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:38:0x00e0  */
    /* JADX WARN: Removed duplicated region for block: B:74:0x017c  */
    /* JADX WARN: Removed duplicated region for block: B:77:0x019f  */
    /* JADX WARN: Removed duplicated region for block: B:82:0x01db A[LOOP:5: B:82:0x01db->B:100:0x022f, LOOP_START, PHI: r1
      0x01db: PHI (r1v1 int) = (r1v0 int), (r1v2 int) binds: [B:37:0x00de, B:100:0x022f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    protected char[] parseEntityRef() throws XmlPullParserException, IOException {
        ...
        if (cMore3 == '#') {
            ...
            if (cMore4 == 'x') {
                ...
                if (cMore2 != ';') {
                    throw new XmlPullParserException(new StringBuffer("character reference (with hex value) may not contain ").append(printable(cMore2)).toString(), this, null);
                }
            } else {
                char c3 = 0;
                ...
                if (cMore4 != ';') {
                    throw new XmlPullParserException(new StringBuffer("character reference (with decimal value) may not contain ").append(printable(cMore4)).toString(), this, null);
                }
                c2 = c3;
            }
            this.posEnd = this.pos - 1;
        ...
        if (!isNameStartChar(cMore3)) {
            throw new XmlPullParserException(new StringBuffer("entity reference names can not start with character '").append(printable(cMore3)).append("'").toString(), this, null);
        }
        do {
            cMore = more();
            if (cMore == ';') {
        ...
        throw new XmlPullParserException(new StringBuffer("entity reference name can not contain character ").append(printable(cMore)).append("'").toString(), this, null);
    }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:41:0x0081 A[Catch: EOFException -> 0x015c, TryCatch #0 {EOFException -> 0x015c, blocks: (B:11:0x001d, B:64:0x00d5, B:66:0x00d9, B:68:0x00e3, B:69:0x00e7, B:71:0x00f6, B:73:0x00fd, B:74:0x0100, B:92:0x014b, B:78:0x0114, B:80:0x0118, B:82:0x011f, B:83:0x0122, B:85:0x012e, B:87:0x0132, B:89:0x0139, B:90:0x013c, B:29:0x0054, B:31:0x005a, B:33:0x0065, B:37:0x0071, B:41:0x0081, B:50:0x0096, B:51:0x009e, B:52:0x009f, B:54:0x00a6, B:55:0x00ac, B:57:0x00be, B:58:0x00c6, B:93:0x0153, B:94:0x015b), top: B:98:0x001d }] */
    /* JADX WARN: Removed duplicated region for block: B:59:0x00c7 A[PHI: r10
      0x00c7: PHI (r10v2 int) = (r10v1 int), (r10v1 int), (r10v6 int), (r10v6 int) binds: [B:28:0x0052, B:30:0x0058, B:32:0x0063, B:36:0x006f] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:62:0x00cf  */
    /* JADX WARN: Removed duplicated region for block: B:73:0x00fd A[Catch: EOFException -> 0x015c, TryCatch #0 {EOFException -> 0x015c, blocks: (B:11:0x001d, B:64:0x00d5, B:66:0x00d9, B:68:0x00e3, B:69:0x00e7, B:71:0x00f6, B:73:0x00fd, B:74:0x0100, B:92:0x014b, B:78:0x0114, B:80:0x0118, B:82:0x011f, B:83:0x0122, B:85:0x012e, B:87:0x0132, B:89:0x0139, B:90:0x013c, B:29:0x0054, B:31:0x005a, B:33:0x0065, B:37:0x0071, B:41:0x0081, B:50:0x0096, B:51:0x009e, B:52:0x009f, B:54:0x00a6, B:55:0x00ac, B:57:0x00be, B:58:0x00c6, B:93:0x0153, B:94:0x015b), top: B:98:0x001d }] */
    ...
    */
    ...
    protected void parseXmlDecl(char c2) throws XmlPullParserException, IOException {
        ...
        this.bufStart = 0;
        char cSkipS = skipS(requireInput(skipS(c2), VERSION));
        if (cSkipS != '=') {
                ...
                if (cArr[i + 2] == '0') {
                    ...
                    if (cSkipS == 'e') {
                        ...
                        while (cMore2 != cSkipS3) {
                            if ((cMore2 < 'a' || cMore2 > 'z') && ((cMore2 < 'A' || cMore2 > 'Z') && ((cMore2 < c2 || cMore2 > '9') && cMore2 != '.' && cMore2 != '_' && cMore2 != '-'))) {
    ...
    protected void parseCDSect(boolean z) throws XmlPullParserException, IOException {
        ...
        if (z2 && z) {
            try {
                ...
                throw new XmlPullParserException(new StringBuffer("CDATA section started on line ").append(i2).append(" and column ").append(i3).append(" was not closed").toString(), this, e2);
            }
        }
        boolean z3 = false;
        boolean z4 = false;
    ...
    protected void fillBuf() throws XmlPullParserException, IOException {
        ...
        if (i > i2) {
            ...
            if (z2) {
                ...
                if (i4 > 0) {
                    this.bufSoftLimit = (int) ((((long) i4) * ((long) cArr3.length)) / 100);
                }
            } else {
    ...
    protected char requireInput(char c2, char[] cArr) throws XmlPullParserException, IOException {
        for (int i = 0; i < cArr.length; i++) {
            if (c2 != cArr[i]) {
                throw new XmlPullParserException(new StringBuffer("expected ").append(printable(cArr[i])).append(" in ").append(new String(cArr)).append(" and not ").append(printable(c2)).toString(), this, null);
            }
            c2 = more();
        }
        return c2;
    ...
    protected boolean isNameStartChar(char c2) {
        ...
        if (c2 < 8234 || c2 > 8591) {
            return c2 >= 10240 && c2 <= 65519;
        }
        return true;
    }

    protected boolean isNameChar(char c2) {
        if (c2 < 1024 && lookupNameChar[c2]) {
            return true;
        }
        if (c2 >= 1024 && c2 <= 8231) {
            return true;
    ...
    protected String printable(char c2) {
        ...
        if (c2 > 127 || c2 < ' ') {
            return new StringBuffer("\\u").append(Integer.toHexString(c2)).toString();
        }
        return new StringBuffer("").append(c2).toString();
    }
