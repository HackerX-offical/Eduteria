...
public class XmlInfosetBuilderImpl extends XmlInfosetBuilder {
    ...
    public Object parseItem(XmlPullParser xmlPullParser) {
        try {
            ...
            throw new XmlBuilderException("could not parse XML item", e2);
        }
    }
    ...
    private XmlDocument parseDocumentStart(XmlPullParser xmlPullParser) {
        try {
            ...
            throw new XmlBuilderException("could not parse XML document prolog", e3);
        }
    }
    ...
    public XmlElement parseFragment(XmlPullParser xmlPullParser) {
        try {
            ...
            throw new XmlBuilderException("could not build tree from XML", e3);
        }
    }
    ...
    public XmlElement parseStartTag(XmlPullParser xmlPullParser) {
        try {
            ...
            throw new XmlBuilderException("could not parse XML start tag", e2);
        }
    }
    ...
    public XmlDocument parseLocation(String str) {
        try {
            try {
                ...
                throw new XmlBuilderException(new StringBuffer("could not open connection to URL ").append(str).toString(), e2);
            }
        } catch (MalformedURLException e3) {
            throw new XmlBuilderException(new StringBuffer("could not parse URL ").append(str).toString(), e3);
        }
    }
    ...
    private void serializeContainer(XmlContainer xmlContainer, XmlSerializer xmlSerializer) {
        if (xmlContainer instanceof XmlSerializable) {
            try {
                ...
                throw new XmlBuilderException(new StringBuffer("could not serialize node ").append(xmlContainer).append(": ").append(e2).toString(), e2);
            }
        ...
        try {
            if (obj instanceof XmlSerializable) {
                try {
                    ...
                    throw new XmlBuilderException(new StringBuffer("could not serialize item ").append(obj).append(": ").append(e2).toString(), e2);
                }
            } else {
                ...
                if (obj instanceof XmlCharacters) {
                    ...
                    throw new IllegalArgumentException(stringBuffer.append(obj).toString());
                }
            }
        } catch (IOException e3) {
            throw new XmlBuilderException("serializing XML start tag failed", e3);
        }
    }
    ...
    public void serializeStartTag(XmlElement xmlElement, XmlSerializer xmlSerializer) {
        try {
            ...
            if (xmlElement.hasNamespaceDeclarations()) {
                ...
                while (itNamespaces.hasNext()) {
                    ...
                    if (!prefix.equals(prefix2)) {
                        ...
                        namespaceName = xmlNamespace.getNamespaceName();
                    }
                }
            }
            if (namespaceName != null) {
                ...
                if (namespaceName2.length() > 0) {
                    xmlSerializer.getPrefix(namespaceName2, false);
                }
                if ("" != prefix && !"".equals(prefix)) {
                    xmlSerializer.setPrefix(prefix, namespaceName2);
                }
            }
    ...
    public void serializeEndTag(XmlElement xmlElement, XmlSerializer xmlSerializer) {
        try {
            ...
            throw new XmlBuilderException("serializing XML end tag failed", e2);
        }
    }
        ...
        try {
            ...
            if (xmlDocument.getDocumentElement() != null) {
                ...
                try {
                    ...
                    throw new XmlBuilderException("serializing XML document end failed", e2);
                }
            }
            throw new XmlBuilderException(new StringBuffer("could not serialize document without root element ").append(xmlDocument).append(": ").toString());
        } catch (IOException e3) {
            throw new XmlBuilderException("serializing XML document start failed", e3);
        }
    }
            ...
            while (itChildren.hasNext()) {
                ...
                if (next instanceof XmlSerializable) {
                    try {
                        ...
                        throw new XmlBuilderException(new StringBuffer("could not serialize item ").append(next).append(": ").append(e2).toString(), e2);
                    }
