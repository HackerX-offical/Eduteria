...
public class StaticXmlSerializerWrapper extends XmlSerializerDelegate implements XmlSerializerWrapper {
    ...
    public void writeDouble(double d2) throws XmlPullParserException, IOException, IllegalArgumentException {
    ...
    public void writeFloat(float f2) throws XmlPullParserException, IOException, IllegalArgumentException {
    ...
    public void writeDoubleElement(String str, String str2, double d2) throws XmlPullParserException, IOException, IllegalArgumentException {
        this.xs.startTag(str, str2);
        writeDouble(d2);
        this.xs.endTag(str, str2);
    }

    public void writeFloatElement(String str, String str2, float f2) throws XmlPullParserException, IOException, IllegalArgumentException {
        this.xs.startTag(str, str2);
        writeFloat(f2);
        this.xs.endTag(str, str2);
    }
    ...
    public void writeStringElement(String str, String str2, String str3) throws XmlPullParserException, IOException, IllegalArgumentException {
        this.xs.startTag(str, str2);
        if (str3 == null) {
