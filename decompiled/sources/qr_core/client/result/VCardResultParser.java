...
public final class VCardResultParser extends ResultParser {
    ...
    private static final Pattern COMMA = Pattern.compile(Constants.SEPARATOR_COMMA);
    ...
    public AddressBookParsedResult parse(Result result) {
        ...
        List<List<String>> listMatchVCardPrefixedField5 = matchVCardPrefixedField(CheckoutConstants.URL, massagedText, true, false);
