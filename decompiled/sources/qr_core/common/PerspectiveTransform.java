...
public final class PerspectiveTransform {
    ...
    public static PerspectiveTransform squareToQuadrilateral(float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9) {
        ...
        return new PerspectiveTransform((f4 - f2) + (f17 * f4), (f8 - f2) + (f18 * f8), f2, (f5 - f3) + (f17 * f5), (f9 - f3) + (f18 * f9), f3, f17, f18, 1.0f);
    }
    ...
    PerspectiveTransform times(PerspectiveTransform perspectiveTransform) {
        ...
        float f17 = this.a12;
        float f18 = this.a22;
        float f19 = (f17 * f3) + (f18 * f5);
        float f20 = this.a32;
        float f21 = f19 + (f20 * f7);
        float f22 = (f17 * f9) + (f18 * f10) + (f20 * f11);
        float f23 = (f17 * f13) + (f18 * f14) + (f20 * f15);
        float f24 = this.a13;
        float f25 = f3 * f24;
        float f26 = this.a23;
        float f27 = f25 + (f5 * f26);
        float f28 = this.a33;
        return new PerspectiveTransform(f8, f12, f16, f21, f22, f23, f27 + (f7 * f28), (f24 * f9) + (f10 * f26) + (f11 * f28), (f24 * f13) + (f26 * f14) + (f28 * f15));
    }
}
