...
public final class StringUtils {
    ...
    */
    public static java.nio.charset.Charset guessCharset(byte[] r21, java.util.Map<qr_core.DecodeHintType, ?> r22) {
        /*
            Method dump skipped, instruction units count: 367
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: qr_core.common.StringUtils.guessCharset(byte[], java.util.Map):java.nio.charset.Charset");
    }
}
