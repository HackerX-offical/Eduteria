...
public final class MonochromeRectangleDetector {
    ...
    */
    private int[] blackWhiteRange(int r6, int r7, int r8, int r9, boolean r10) {
        ...
        L5:
            if (r2 < r8) goto L3a
            qr_core.common.BitMatrix r3 = r5.image
            if (r10 == 0) goto L12
        ...
        L1c:
            int r3 = r3 + (-1)
            if (r3 < r8) goto L31
            qr_core.common.BitMatrix r4 = r5.image
            if (r10 == 0) goto L2b
        ...
        L7c:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: qr_core.common.detector.MonochromeRectangleDetector.blackWhiteRange(int, int, int, int, boolean):int[]");
    }
}
