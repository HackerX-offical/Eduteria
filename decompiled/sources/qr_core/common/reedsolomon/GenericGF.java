package qr_core.common.reedsolomon;
...
public final class GenericGF {
    ...
    public static final GenericGF AZTEC_DATA_10 = new GenericGF(AnalyticsListener.EVENT_RENDERER_READY_CHANGED, 1024, 1);
    ...
    public String toString() {
        return "GF(0x" + Integer.toHexString(this.primitive) + CsvReader.Letters.COMMA + this.size + ')';
    }
}
