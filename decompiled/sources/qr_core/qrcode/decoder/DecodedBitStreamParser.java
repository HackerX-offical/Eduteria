package qr_core.qrcode.decoder;

import java.nio.charset.Charset;
import java.util.Collection;
import java.util.Map;
import qr_core.DecodeHintType;
import qr_core.FormatException;
import qr_core.common.BitSource;
...
final class DecodedBitStreamParser {
    ...
    */
    static qr_core.common.DecoderResult decode(byte[] r18, qr_core.qrcode.decoder.Version r19, qr_core.qrcode.decoder.ErrorCorrectionLevel r20, java.util.Map<qr_core.DecodeHintType, ?> r21) throws qr_core.FormatException {
        /*
            Method dump skipped, instruction units count: 272
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: qr_core.qrcode.decoder.DecodedBitStreamParser.decode(byte[], qr_core.qrcode.decoder.Version, qr_core.qrcode.decoder.ErrorCorrectionLevel, java.util.Map):qr_core.common.DecoderResult");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static void decodeAlphanumericSegment(qr_core.common.BitSource r3, java.lang.StringBuilder r4, int r5, boolean r6) throws qr_core.FormatException {
        /*
            int r0 = r4.length()
        L4:
            r1 = 1
            ...
            goto L4
        L28:
            qr_core.FormatException r3 = qr_core.FormatException.getFormatInstance()
            throw r3
        L2d:
            if (r5 != r1) goto L47
            int r5 = r3.available()
        ...
        L72:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: qr_core.qrcode.decoder.DecodedBitStreamParser.decodeAlphanumericSegment(qr_core.common.BitSource, java.lang.StringBuilder, int, boolean):void");
    }
