package qr_core.qrcode.detector;
...
import qr_core.common.GridSampler;
import qr_core.common.PerspectiveTransform;
import qr_core.common.detector.MathUtils;
...
public class Detector {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:43:0x0089, code lost:
        ...
        return qr_core.common.detector.MathUtils.distance(r5, r6, r1, r4);
     */
    ...
    */
    private float sizeOfBlackWhiteBlackRun(int r18, int r19, int r20, int r21) {
        ...
        L57:
            ...
            r19 = r7
        L5c:
            qr_core.common.BitMatrix r7 = r3.image
            boolean r2 = r7.get(r2, r10)
            if (r0 != r2) goto L6e
            r0 = 2
            if (r15 != r0) goto L6c
            float r0 = qr_core.common.detector.MathUtils.distance(r13, r14, r1, r4)
            return r0
        L6c:
            int r15 = r15 + 1
        L6e:
        ...
        L83:
            if (r15 != r0) goto L8a
            float r0 = qr_core.common.detector.MathUtils.distance(r5, r6, r1, r4)
            return r0
        L8a:
            r0 = 2143289344(0x7fc00000, float:NaN)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: qr_core.qrcode.detector.Detector.sizeOfBlackWhiteBlackRun(int, int, int, int):float");
    }
