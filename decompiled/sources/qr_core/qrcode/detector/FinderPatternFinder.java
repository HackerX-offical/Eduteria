...
public class FinderPatternFinder {
                ...
                while (true) {
                    if (i3 < this.possibleCenters.size()) {
                        ...
                        if (finderPattern.aboutEquals(f2, fCrossCheckVertical, fCrossCheckHorizontal)) {
                            this.possibleCenters.set(i3, finderPattern.combineEstimate(fCrossCheckVertical, fCrossCheckHorizontal, f2));
                            break;
                        }
                        i3++;
                    } else {
    ...
    */
    private qr_core.qrcode.detector.FinderPattern[] selectBestPatterns() throws qr_core.NotFoundException {
        /*
            Method dump skipped, instruction units count: 250
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: qr_core.qrcode.detector.FinderPatternFinder.selectBestPatterns():qr_core.qrcode.detector.FinderPattern[]");
    }
