package qr_core.qrcode.encoder;
...
import qr_core.common.BitArray;
import qr_core.common.ECIEncoderSet;
import qr_core.qrcode.decoder.ErrorCorrectionLevel;
import qr_core.qrcode.decoder.Mode;
import qr_core.qrcode.decoder.Version;
...
final class MinimalEncoder {
    ...
    static Version getVersion(VersionSize versionSize) {
        int i = AnonymousClass1.$SwitchMap$qr_core$qrcode$encoder$MinimalEncoder$VersionSize[versionSize.ordinal()];
        if (i == 1) {
    ...
    static boolean isDoubleByteKanji(char c2) {
        return Encoder.isOnlyDoubleByteKanji(String.valueOf(c2));
    }

    static boolean isAlphanumeric(char c2) {
        return Encoder.getAlphanumericCode(c2) != -1;
    }

    /* JADX INFO: renamed from: qr_core.qrcode.encoder.MinimalEncoder$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$qr_core$qrcode$decoder$Mode;
        static final /* synthetic */ int[] $SwitchMap$qr_core$qrcode$encoder$MinimalEncoder$VersionSize;

        static {
            int[] iArr = new int[Mode.values().length];
            $SwitchMap$qr_core$qrcode$decoder$Mode = iArr;
            try {
                iArr[Mode.KANJI.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$qr_core$qrcode$decoder$Mode[Mode.ALPHANUMERIC.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$qr_core$qrcode$decoder$Mode[Mode.NUMERIC.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$qr_core$qrcode$decoder$Mode[Mode.BYTE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                $SwitchMap$qr_core$qrcode$decoder$Mode[Mode.ECI.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            int[] iArr2 = new int[VersionSize.values().length];
            $SwitchMap$qr_core$qrcode$encoder$MinimalEncoder$VersionSize = iArr2;
            try {
                iArr2[VersionSize.SMALL.ordinal()] = 1;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                $SwitchMap$qr_core$qrcode$encoder$MinimalEncoder$VersionSize[VersionSize.MEDIUM.ordinal()] = 2;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                $SwitchMap$qr_core$qrcode$encoder$MinimalEncoder$VersionSize[VersionSize.LARGE.ordinal()] = 3;
            } catch (NoSuchFieldError unused8) {
            }
        }
    }

    boolean canEncode(Mode mode, char c2) {
        int i = AnonymousClass1.$SwitchMap$qr_core$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
            return isDoubleByteKanji(c2);
        }
        if (i == 2) {
            return isAlphanumeric(c2);
        }
        if (i != 3) {
            return i == 4;
        }
    ...
    static int getCompactedOrdinal(Mode mode) {
        int i;
        if (mode == null || (i = AnonymousClass1.$SwitchMap$qr_core$qrcode$decoder$Mode[mode.ordinal()]) == 1) {
            return 0;
        }
        if (i == 2) {
            return 1;
    ...
    private final class Edge {
        ...
        private Edge(Mode mode, int i, int i2, int i3, Edge edge, Version version) {
            ...
            int i5 = AnonymousClass1.$SwitchMap$qr_core$qrcode$decoder$Mode[mode.ordinal()];
            if (i5 == 1) {
    ...
    final class ResultList {
        ...
        ResultList(Version version, Edge edge) {
            ...
            int i7 = AnonymousClass1.$SwitchMap$qr_core$qrcode$encoder$MinimalEncoder$VersionSize[MinimalEncoder.getVersionSize(version).ordinal()];
            if (i7 == 1) {
                i2 = 9;
            } else if (i7 != 2) {
                i = 27;
        ...
        final class ResultNode {
            ...
            public int getSize(Version version) {
                ...
                int i2 = AnonymousClass1.$SwitchMap$qr_core$qrcode$decoder$Mode[this.mode.ordinal()];
                if (i2 != 1) {
                    if (i2 == 2) {
